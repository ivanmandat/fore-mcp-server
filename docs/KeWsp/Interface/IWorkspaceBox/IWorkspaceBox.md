...
Интерфейс IWorkspaceBox содержит
 свойства и методы компонента среды разработки - [WorkspaceBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/WorkspaceBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveTool](IWorkspaceBox.ActiveTool.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IWorkspaceBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DefaultMenu](IWorkspaceBox.DefaultMenu.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DefaultHandlers](IWorkspaceBox.DefaultHandlers.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayConnectionPoints](IWorkspaceBox.DisplayConnectionPoints.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayFocusFrame](IWorkspaceBox.DisplayFocusFrame.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayGrid](IWorkspaceBox.DisplayGrid.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayIntersections](IWorkspaceBox.DisplayIntersections.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayScrollBars](IWorkspaceBox.DisplayScrollBars.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplaySelections](IWorkspaceBox.DisplaySelections.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](IWorkspaceBox.Source.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [ConvertPtToView](IWorkspaceBox.ConvertPtToView.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetShapeByPt](IWorkspaceBox.GetShapeByPt.htm)
		 Метод GetShapeByPt
