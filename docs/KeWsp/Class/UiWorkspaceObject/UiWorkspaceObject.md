...
Класс UiWorkspaceObject реализует
 компонент среды разработки [UiWorkspaceObject](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiWorkspaceObject.htm),
 предоставляющий доступ к рабочим пространствам, имеющимся в репозитории.


## Свойства объекта класса, унаследованные от [IUiWorkspaceObject](../../Interface/IUiWorkspaceObject/IUiWorkspaceObject.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Workspace](../../Interface/IUiWorkspaceObject/IUiWorkspaceObject.Workspace.htm)
		 Свойство Workspace
		 определяет рабочее пространство репозитория, данные которого будут
		 отображаться в дальнейшем в компоненте [WorkspaceBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/WorkspaceBox.htm).


## Свойства объекта класса, унаследованные от [IUiMetabaseObject](KeFore.chm::/Interface/IUiMetabaseObject/IUiMetabaseObject.htm)
...
## Методы объекта класса, унаследованные от [IUiMetabaseObject](KeFore.chm::/Interface/IUiMetabaseObject/IUiMetabaseObject.htm)
