...
Класс WorkspaceBox реализует
 компонент среды разработки - [WorkspaceBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/WorkspaceBox.htm),
 предназначенный для отображения данных рабочих пространств репозитория.


## Свойства объекта класса, унаследованные от [IWorkspaceBox](../../Interface/IWorkspaceBox/IWorkspaceBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveTool](../../Interface/IWorkspaceBox/IWorkspaceBox.ActiveTool.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IWorkspaceBox/IWorkspaceBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DefaultMenu](../../Interface/IWorkspaceBox/IWorkspaceBox.DefaultMenu.htm)


		 Свойство DefaultMenu
		 определяет признак наличия системного контекстного меню у рабочего
		 пространства и у фигур, расположенных на нем.


		 ![](../../Property_Image.gif)
		 [DefaultHandlers](../../Interface/IWorkspaceBox/IWorkspaceBox.DefaultHandlers.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayConnectionPoints](../../Interface/IWorkspaceBox/IWorkspaceBox.DisplayConnectionPoints.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayFocusFrame](../../Interface/IWorkspaceBox/IWorkspaceBox.DisplayFocusFrame.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayGrid](../../Interface/IWorkspaceBox/IWorkspaceBox.DisplayGrid.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayIntersections](../../Interface/IWorkspaceBox/IWorkspaceBox.DisplayIntersections.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayScrollBars](../../Interface/IWorkspaceBox/IWorkspaceBox.DisplayScrollBars.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplaySelections](../../Interface/IWorkspaceBox/IWorkspaceBox.DisplaySelections.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](../../Interface/IWorkspaceBox/IWorkspaceBox.Source.htm)


		 Свойство Source определяет
		 источник данных для компонента WorkspaceBox.


		 ![](../../Property_Image.gif)
		 [View](../../Interface/IWorkspaceBox/IWorkspaceBox.View.htm)
...
## Свойства объекта класса, унаследованные от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
...
## Методы объекта класса, унаследованные от [IWorkspaceBox](../../Interface/IWorkspaceBox/IWorkspaceBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ConvertPtToView](../../Interface/IWorkspaceBox/IWorkspaceBox.ConvertPtToView.htm)
		 Метод ConvertPtToView
		 позволяет получить координаты точки в рабочем пространстве по
		 экранным координатам точки.


		 ![](../../Sub_Image.gif)
		 [GetShapeByPt](../../Interface/IWorkspaceBox/IWorkspaceBox.GetShapeByPt.htm)
		 Метод GetShapeByPt
		 позволяет получить информацию о фигуре по экранной координате
		 точки, которая находится в пределах фигуры.


## Методы объекта класса, унаследованные от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnAfterMoveCP](WorkspaceBox.OnAfterMoveCP.htm)
		 Метод OnAfterMoveCP
		 реализует событие, происходящее после перемещения одной из конечных
		 точек линии связи.


		 ![](../../Event_Image.gif)
		 [OnBeforeMoveCP](WorkspaceBox.OnBeforeMoveCP.htm)
		 Метод OnBeforeMoveCP
		 реализует событие, происходящее перед перемещением одной из конечных
		 точек линии связи.


		 ![](../../Event_Image.gif)
		 [OnSelectionChanged](WorkspaceBox.OnSelectionChanged.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnShapeChanged](WorkspaceBox.OnShapeChanged.htm)
		 Событие OnShapeChanged
		 наступает после каких-либо изменений, связанных с фигурой рабочего
		 пространства.


## События объекта класса, унаследованные от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
