...
Для отображения данных соответствующих заданным условиям табличной области
 используйте группу параметров «Фильтрация»
...
[![](../../opened.gif)![](../../closed.gif)Оставлять владельцев
 неисключенных элементов](javascript:TextPopup(this))
	...
	При установке флажка родительские элементы неисключённых фильтрацией
...
[![](../../opened.gif)![](../../closed.gif)Скрытие по
 значению атрибутов](javascript:TextPopup(this))
	...
	При установке флажка будут скрыты элементы, для которых настроена
	 [фильтрация по значению атрибутов](Filter.htm#filter).


[![](../../opened.gif)![](../../closed.gif)Настройка фильтрации
 общих измерений](javascript:TextPopup(this))
	...
	Для удаления связи атрибутов нажмите кнопку ![](Delete.png) «Удалить», расположенную около неё.
