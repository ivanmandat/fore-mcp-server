# Добавление комментариев к ячейкам: Форма ввода
...
Для добавления комментариев:
	...
	- Убедитесь, что:
		...
		- у пользователя есть права [права](Admin.chm::/03_Admin/Admin_AdminObjects.htm)
		 на чтение и редактирование.


	- Выберите ячейку в области данных таблицы, не отображающую значения
	 [вычисляемых элементов](../Table/Calculation_Practices.htm)
	 или [итоговых значений](../Work/totals.htm), и:
...
Максимальный размер комментария 4000 символов.
	...
	- Сохраните комментарий, для этого нажмите кнопку ![](b_send.png) «Отправить».


Добавление комментариев доступно для ячеек таблиц, построенных на одном
 кубе. Добавленные комментарии будут доступны для все таблиц, в которых
...
[![](../../opened.gif)![](../../closed.gif)Для открытия
 панели](javascript:TextPopup(this))
	...
	Для открытия панели нажмите кнопку ![](b_comment.png) «Комментарии» боковой панели.


	При просмотре формы кнопка ![](b_comment.png) «Комментарии»
	 доступна если в качестве источника использован [стандартный
...
Для удаления комментариев:
	...
	- выберите ячейку с комментариями, выделите комментарий и нажмите
	 кнопку ![](Delete.png) «Удалить»;


	- выделите комментарий на панели «Комментарий»
	 и нажмите кнопку ![](Delete.png) «Удалить»;
...
[![](../../opened.gif)![](../../closed.gif)Поиск комментария](javascript:TextPopup(this))
	...
	Для поиска комментария нажмите кнопку ![](../Work/b_search_bar_open.png) «Поиск».
...
[![](../../opened.gif)![](../../closed.gif)Настройка отображения](javascript:TextPopup(this))
	...
	Для сортировки и фильтрации комментариев по времени создания нажите
	 кнопку ![](../Work/b_params.png) «Настройки
	 отображения».
...
Операции с комментариями не влияют на активность кнопки ![](../Starting/saveData.png) «Сохранить
 данные».
