# Параметры печати: Формы ввода, веб-приложение
...
[![](../../../opened.gif)![](../../../closed.gif)Выводить
 на печать диапазон](javascript:TextPopup(this))
	...
	В поле «Выводить на печать диапазон»
	 задайте диапазон ячеек с помощью клавиатуры, который необходимо напечатать.
...
[![](../../../opened.gif)![](../../../closed.gif)Сквозные
 строки и сквозные столбцы](javascript:TextPopup(this))
	...
	В полях «Сквозные строки»
	 и «Сквозные столбцы» задайте
	 диапазоны строк и/или столбцов, которые необходимо вывести на каждый
	 печатный лист.
...
[![](../../../opened.gif)![](../../../closed.gif)Последовательность
 вывода страниц](javascript:TextPopup(this))
	...
	Для настройки последовательности вывода страниц на печать выберите
	 в раскрывающемся списке:


		- Налево, затем направо.
		 Страницы формы ввода выводятся на печать в порядке налево, затем
		 направо;


		- Вверх, затем вниз.
		 Страницы формы ввода выводятся на печать в порядке вверх, затем
		 вниз.
	...
	При задании составного диапазона [сквозных
	 ...
	 вывода:
		...
		- если в форме ввода содержится несколько таблиц, по ширине
		 полностью помещающихся на один лист, для таблиц заданы сквозные
		 строки и при выводе таблицы на странице остается свободное место,
		 то следующая за ней таблица будет выведена на той же странице
		 с учётом заданной для нее сквозной строки и с хотя бы одной строкой
		 данных;
		...
		- если в форме ввода содержится несколько таблиц, по высоте
		 полностью помещающихся на один лист, для таблиц заданы сквозные
		 столбцы и при выводе таблицы на странице остается свободное место,
		 то следующая за ней таблица будет выведена на той же странице
		 с учётом заданного для нее сквозного столбца и с хотя бы одним
		 столбцом данных;
...
[![](../../../opened.gif)![](../../../closed.gif)Печатать
 заголовок](javascript:TextPopup(this))
	...
	Для вывода на печать заголовка формы ввода установите флажок «Печатать заголовок».


	Примечание.
	 Заголовок отображается только на первой странице каждого листа формы
	 ввода.


	Настройка заголовка формы ввода выполняется в группе параметров
...
[![](../../../opened.gif)![](../../../closed.gif)Печатать
 лист вместе с отчётом](javascript:TextPopup(this))
	...
	Для вывода на печать текущего листа формы ввода установите флажок
	 «Печатать лист вместе с отчётом».
	 По умолчанию флажок установлен.


	При снятом флажке лист формы ввода не будет выводиться на печать.
	 При этом:


		- при печати формы ввода целиком данный лист не печатается;


		- при [экспорте формы ввода](../../Common/Export.htm)
		 в форматы PDF, RTF данный лист недоступен для экспорта.
...
[![](../../../opened.gif)![](../../../closed.gif)Печать
 верхнего и нижнего колонтитулов](javascript:TextPopup(this))
	...
	При снятом флажке «Печатать верхний
	 колонтитул» или «Печатать
...
После выполнения действий будут настроены параметры
 для [печати](Tuning_ParamPage.htm#print).
