# DashboardDocumentViewerBox: Класс
...
Класс DashboardDocumentViewerBox
 реализует компонент среды разработки - [DashboardDocumentViewerBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DashboardDocumentViewerBox.htm).


## Свойства объекта класса, унаследованные от [IDashboardDocumentViewerBox](../../Interface/IDashboardDocumentViewerBox/IDashboardDocumentViewerBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Dashboard](../../Interface/IDashboardDocumentViewerBox/IDashboardDocumentViewerBox.Dashboard.htm)
