...
Интерфейс IUiDashboard содержит
 свойства и методы компонента среды разработки - [UiDashboard](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiDashboard.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Report](IUiDashboard.Report.htm)
