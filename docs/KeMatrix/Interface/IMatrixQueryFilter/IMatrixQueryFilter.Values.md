...
Values: [IArrayList](ModCollections.chm::/Interface/IArrayList/IArrayList.htm);


## Описание


Свойство Values возвращает динамический
...
При выполнении примера будет открыт куб и получена его матрица с данными
 ...
 из матрицы, в запросе определён фильтр, отбирающий данные с определёнными
 значениями. После выполнения запроса будет получена отметка, которая соответствует
