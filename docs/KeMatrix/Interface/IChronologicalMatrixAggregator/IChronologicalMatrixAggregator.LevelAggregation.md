# IChronologicalMatrixAggregator.LevelAggregation
...
LevelAggregation(Level: [IDimLevel](KeDims.chm::/interface/IDimLevel/IDimLevel.htm)): [IChronologicalMatrixLevelAggregator](../IChronologicalMatrixLevelAggregator/IChronologicalMatrixLevelAggregator.htm);


## Параметры


Level - уровень измерения, для которого необходимо настроить параметры агрегации. Null, если необходимо настроить параметры агрегации для уровней по умолчанию.
...
Свойство LevelAggregation возвращает параметры агрегации для заданного уровня измерения.
