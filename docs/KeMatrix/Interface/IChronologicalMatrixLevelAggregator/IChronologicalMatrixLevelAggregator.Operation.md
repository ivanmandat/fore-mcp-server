# IChronologicalMatrixLevelAggregator.Operation
...
Operation: [ChronologicalAggregatorOperation](../../Enums/ChronologicalAggregatorOperation.htm);


## Описание


Свойство Operation определяет метод агрегации, применяемый для элементов выбранного уровня измерения.
