# IChronologicalMatrixLevelAggregator.UseDefaultLevelAggregation
...
Если свойству установлено значение True, то используются параметры агрегации, установленные в свойстве [LevelAggregation](../IChronologicalMatrixAggregator/IChronologicalMatrixAggregator.LevelAggregation.htm) при значении параметра Null, иначе необходимо определить параметры, используя соответствующие свойства. По умолчанию свойству установлено значение True.
