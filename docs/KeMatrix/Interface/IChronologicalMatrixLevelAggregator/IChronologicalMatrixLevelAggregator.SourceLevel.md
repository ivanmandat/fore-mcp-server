...
SourceLevel: [IDimLevel](KeDims.chm::/interface/IDimLevel/IDimLevel.htm);


## Описание


Свойство SourceLevel определяет уровень измерения, с которого будут браться данные для агрегации.
