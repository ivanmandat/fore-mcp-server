...
Класс TransformDialog реализует
 компонент [TransformDialog](../../../Components/TransformDialog/TransformDialog.htm),
...
PP.initClass(PP.Ufe.Ui.TransformDialog, [PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),PP.Ufe.Ui.EquationPeriodMixin],
 "PP.Ufe.Ui.TransformDialog");
