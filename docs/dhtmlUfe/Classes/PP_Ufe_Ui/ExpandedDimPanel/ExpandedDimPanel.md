...
Класс ExpandedDimPanel реализует
 панель, которая содержит дерево метаданных, поле поиска и кнопку вставки
 формулы.
...
PP.initClass(PP.Ufe.Ui.ExpandedDimPanel, PP.Ufe.Ui.[TransformDialogDimPanel](../TransformDialogDimPanel/TransformDialogDimPanel.htm),
 "PP.Ufe.Ui.ExpandedDimPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ExpandedDimPanel](Constructor_ExpandedDimPanel.htm)
		 Конструктор ExpandedDimPanel
		 создает экземпляр класса ExpandedDimPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getMetaTree](ExpandedDimPanel.getMetaTree.htm)
		 Метод getMetaTree возвращает
		 дерево метаданных измерения компонента [TransformDialog](../TransformDialog/TransformDialog.htm).


		 ![](../../../Sub_Image.gif)
		 [getMetaTreeSelectedNodeData](ExpandedDimPanel.getMetaTreeSelectedNodeData.htm)
		 Метод getMetaTreeSelectedNodeData
		 возвращает данные элемента измерения выделенного в дереве метаданных.
