...
Класс WbkTransformDialog предназначен
 для создания и редактирования формулы элемента измерения рабочей книги.


## Синтаксис


PP.initClass(PP.Ufe.Ui.WbkTransformDialog, [[PP.Ufe.Ui.TransformDialog](../TransformDialog/TransformDialog.htm),PP.Ufe.Ui.EquationPeriodMixin],
 "PP.Ufe.Ui.WbkTransformDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [WbkTransformDialog](Constructor_WbkTransformDialog.htm)
		 Конструктор WbkTransformDialog
		 создает экземпляр класса WbkTransformDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [onTempSerieCreated](WbkTransformDialog.onTempSerieCreated.htm)
		 Метод onTempSerieCreated
		 устанавливает в редакторе выражения ряд данных по умолчанию.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ApplyFormula](WbkTransformDialog.ApplyFormula.htm)
		 Событие ApplyFormula
		 наступает после применения формулы в соответствующем диалоге рабочей
		 книги.


		 ![](../../../Event_Image.gif)
		 [CreateTempSerie](WbkTransformDialog.CreateTempSerie.htm)
		 Событие CreateTempSerie
		 наступает после установки в редакторе выражения ряда данных по
		 умолчанию.
