...
Класс TransformDialogDimPanel
 реализует панели с данными об измерении в компоненте TransformDialog.


## Комментарии


Класс обеспечивает работу с контекстным меню окна создания
 и изменения формулы элемента измерения.


## Синтаксис


PP.initClass(PP.Ufe.Ui.TransformDialogDimPanel,
 PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Ufe.Ui.TransformDialogDimPanel");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [TransformDialogDimPanel](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialogDimPanel/Constructor_TransformDialogDimPanel.htm)
			 Конструктор TransformDialogDimPanel
			 создает экземпляр класса TransformDialogDimPanel.
