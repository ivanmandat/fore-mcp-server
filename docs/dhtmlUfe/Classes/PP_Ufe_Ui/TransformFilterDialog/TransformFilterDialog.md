...
Класс TransformFilterDialog
 реализует окно создания и редактирования фильтров компонента
...
PP.initClass(PP.Ufe.Ui.TransformFilterDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.Ufe.Ui.TransformFilterDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TransformFilterDialog](Constructor_TransformFilterDialog.htm)
		 Конструктор TransformFilterDialog
		 создает экземпляр класса TransformFilterDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getDynamicValue](TransformFilterDialog.getDynamicValue.htm)
		 Метод getDynamicValue
		 возвращает значение динамики фильтра.


		 ![](../../../Sub_Image.gif)
		 [getFilterName](TransformFilterDialog.getFilterName.htm)
		 Метод getFilterName
		 возвращает наименование редактируемого фильтра.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [CloseButtonClicked](TransformFilterDialog.CloseButtonClicked.htm)
		 Событие CloseButtonClicked
		 наступает после нажатия на кнопку закрытия окна редактирования
		 формул.
