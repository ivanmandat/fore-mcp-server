...
Класс MetaTree реализует дерево
 метаданных измерения.


## Синтаксис


PP.initClass(PP.Ufe.Ui.MetaTree, PP.Mb.Ui.[ElsTree](dhtmlMetabase.chm::/Classes/Metabase/ElsTree/ElsTree.htm),
 "PP.Ufe.Ui.MetaTree");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MetaTree](Constructor_MetaTree.htm)
		 Конструктор MetaTree
		 создает экземпляр класса MetaTree.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [DisplayMode](MetaTree.DisplayMode.htm)
		 Свойство DisplayMode
		 определяет режим отображения вершин дерева метаданных.
...
## Методы, унаследованные от класса
