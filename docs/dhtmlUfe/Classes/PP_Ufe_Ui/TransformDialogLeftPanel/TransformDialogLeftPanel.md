...
Класс TransformDialogLeftPanel
 реализует панель компонента [TransformDialog](../../../Components/TransformDialog/TransformDialog.htm),
...
PP.initClass(PP.Ufe.Ui.TransformDialogLeftPanel,
 PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Ufe.Ui.TransformDialogLeftPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TransformDialogLeftPanel](Constructor_TransformDialogLeftPanel.htm)
		 Конструктор TransformDialogLeftPanel
		 создает экземпляр класса TransformDialogLeftPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getInsertButton](TransformDialogLeftPanel.getInsertButton.htm)
		 Метод getInsertButton
		 возвращает кнопку левой панели компонента [TransformDialog](../../../Components/TransformDialog/TransformDialog.htm),
		 предназначенную для вставки формулы элемента измерения в редактор
		 выражений компонента [TransformDialog](../../../Components/TransformDialog/TransformDialog.htm).


		 ![](../../../Sub_Image.gif)
		 [getOpenedDataSources](TransformDialogLeftPanel.getOpenedDataSources.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getSummaryExpression](TransformDialogLeftPanel.getSummaryExpression.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ExpressionCreated](TransformDialogLeftPanel.ExpressionCreated.htm)
		 Событие ExpressionCreated
		 наступает после выбора элемента измерения и нажатия на кнопку
		 «Вставить» на левой панели компонента [TransformDialog](../../../Components/TransformDialog/TransformDialog.htm).
