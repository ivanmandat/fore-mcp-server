...
Компонент TransformDialog представляет
 собой окно для создания и редактирования формулы элемента измерения
 экспресс-отчета.
...
Компонент реализован классом [TransformDialog](../../Classes/PP_Ufe_Ui/TransformDialog/TransformDialog.htm).
...
[Пример создания компонента TransformDialog](Example_TransformDialog.htm)
