...
Компонент TermEdit представляет
 собой редактор термов.


Компонент используется для составления уравнений. В области редактирования
 отображается внешнее представление термов, заданное в свойстве [Term.Content](../../Classes/PP_Ufe_Ui/Term/Term.Content.htm).
 Внутреннее представление терма, используемое при вычислениях, определяется
 свойством [Term.Formula](../../Classes/PP_Ufe_Ui/Term/Term.Formula.htm).


## Комментарии


Компонент реализован классом [TermEdit](../../Classes/PP_Ufe_Ui/TermEdit/TermEdit.htm).
 Терм реализован классом [Term](../../Classes/PP_Ufe_Ui/Term/Term.htm).
...
[Пример создания компонента TermEdit](Example_TermEdit.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [TermEdit](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/Constructor_TermEdit.htm)
		 Конструктор TermEdit
		 создает экземпляр компонента TermEdit.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ACStyle](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.ACStyle.htm)
		 Свойство ACStyle определяет
		 стиль термов-подсказок.


		 ![](../../Property_Image.gif)
		 [CaretPos](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.CaretPos.htm)
		 Свойство CaretPos определяет
		 позицию курсора в редакторе термов.


		 ![](../../Property_Image.gif)
		 [CaretPosition](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.CaretPosition.htm)
		 Свойство CaretPosition
		 определяет позицию курсора в редакторе термов.


		 ![](../../Property_Image.gif)
		 [IgnoreTerms](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.IgnoreTerms.htm)
		 Свойство IgnoreTerms
		 определяет термы, которые будут проигнорированы при выводе формулы.


		 ![](../../Property_Image.gif)
		 [Terms](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.Terms.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [addACTerms](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.addACTerms.htm)
		 Метод addACTerms добавляет
		 терм-подсказку в редактор термов.


		 ![](../../Sub_Image.gif)
		 [getCaretMetadata](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getCaretMetadata.htm)
		 Метод getCaretMetadata
		 возвращает данные о курсоре.


		 ![](../../Sub_Image.gif)
		 [getCurrentTermText](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getCurrentTermText.htm)

		 Метод getCurrentTermText
		 возвращает текст терма, в котором в данный момент установлен курсор.


		 ![](../../Sub_Image.gif)
		 [getCursorOffset](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getCursorOffset.htm)

		 Метод getCursorOffset
		 возвращает положение курсора относительно левого верхнего угла
		 компонента.


		 ![](../../Sub_Image.gif)
		 [getCursorPosition](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getCursorPosition.htm)

		 Метод getCursorPosition
		 возвращает строку и столбец текущего положения курсора.


		 ![](../../Sub_Image.gif)
		 [getFormula](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getFormula.htm)
		 Метод getFormula возвращает
		 конечную формулу выражения.


		 ![](../../Sub_Image.gif)
		 [getLength](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getLength.htm)
		 Метод getLength возвращает
		 сумму длин всех термов выражения.


		 ![](../../Sub_Image.gif)
		 [getSelectedTerm](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getSelectedTerm.htm)
		 Метод getSelectedTerm
		 возвращает выделенный терм.


		 ![](../../Sub_Image.gif)
		 [getTerms](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.getTerms.htm)
		 Метод getTerms возвращает
		 массив термов.


		 ![](../../Sub_Image.gif)
		 [insertData](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.insertData.htm)
		 Метод insertData добавляет
		 терм или массив термов в редактор термов.


		 ![](../../Sub_Image.gif)
		 [insertString](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.insertString.htm)
		 Метод insertString
		 добавляет строку с термами в редактор термов.


		 ![](../../Sub_Image.gif)
		 [insertTerm](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.insertTerm.htm)
		 Метод insertTerm добавляет
		 строку или терм в редактор термов.


		 ![](../../Sub_Image.gif)
		 [putCustom](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.putCustom.htm)
		 Метод putCustom добавляет
		 пользовательский терм в редактор термов.


		 ![](../../Sub_Image.gif)
		 [putLiteral](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.putLiteral.htm)
		 Метод putLiteral добавляет
		 литеральный терм в редактор термов.


		 ![](../../Sub_Image.gif)
		 [putTerm](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.putTerm.htm)
		 Метод putTerm добавляет
		 терм в редактор термов.


		 ![](../../Sub_Image.gif)
		 [updateTerms](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.updateTerms.htm)
		 Метод updateTerms обновляет
		 термы в редакторе термов.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [TermsChanged](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TermEdit/TermEdit.TermsChanged.htm)
		 Событие TermsChanged
		 наступает при изменении текста терма из редактора.
