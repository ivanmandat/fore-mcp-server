...
Интерфейс ITabScaleBaseEventArgs
 содержит свойства аргумента события, наступающего при изменении масштаба
 таблицы компонента [LanerBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/LanerBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Scale](ITabScaleBaseEventArgs.Scale.htm)
		 Свойство Scale возвращает
		 масштаб, установленный в таблице.
