...
Интерфейс ITabSheetBox содержит
 свойства и методы компонента среды разработки - [TabSheetBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/TabSheetBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](ITabSheetBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayNumericColumnNames](ITabSheetBox.DisplayNumericColumnNames.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](ITabSheetBox.Source.htm)
