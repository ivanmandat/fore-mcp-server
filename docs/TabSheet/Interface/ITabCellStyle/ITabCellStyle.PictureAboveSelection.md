...
PictureAboveSelection: [TriState](ForeSys.chm::/Enums/TriState.htm);


## Описание


Свойство PictureAboveSelection
 устанавливает растяжение картинки в ячейке.
...
В результате при нажатии на кнопку в ячейку таблицы будет добавлено
 заданное изображение. При изменении размеров ячейки изображение растягивается,
 например:


![](ITabCellStyle_PictureAboveSelection.png)
