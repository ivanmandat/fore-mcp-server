...
SeparateLinkText: [TriState](ForeSys.chm::/Enums/TriState.htm);


## Описание


Свойство SeparateLinkText определяет
 использование отдельного текста для гиперссылки. Используется вместе со
 свойством ITabHyperlink.Text.
