...
UseGlobalSettings: [TriState](ForeSys.chm::/Enums/TriState.htm);


## Описание


Свойство UseGlobalSettings определяет,
 использовать ли глобальные настройки стиля для гиперссылки.
