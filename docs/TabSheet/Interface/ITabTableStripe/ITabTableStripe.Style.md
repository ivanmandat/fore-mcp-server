...
Style: [ITabCellStyle](../ITabCellStyle/ITabCellStyle.htm);
...
Свойство Style определяет стиль
 отображения ячеек для полосы строк (столбцов) в таблице.
...
![](../ITabTableStyle/ITabTableStyle.RowFirstStripe.gif)
