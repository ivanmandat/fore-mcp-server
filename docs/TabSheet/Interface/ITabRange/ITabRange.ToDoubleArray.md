...
ToDoubleArray([SkipNonDoubles: Boolean = false]):
 Array;
...
SkipNonDoubles. Определяет,
 будут ли пропускаться невещественные значения.


## Описание


Метод ToDoubleArray осуществляет
 преобразование диапазона в вещественный массив.


## Комментарии


Параметр SkipNonDoubles определяет
 правило пропуска невещественных значений диапазона. Допустимые значения:
	...
	- False. Значение по умолчанию.
	 На месте элемента с невещественным значением в массиве будет стоять
	 «0».
...
Если свойство [ITabErrorCheckingOptions.EnableChecking](../ITabErrorCheckingOptions/ITabErrorCheckingOptions.EnableChecking.htm)
 ...
 вызове метода ToDoubleArray будут
