...
EntireRows: [ITabRange](ITabRange.htm);


## Описание


Свойство EntireRows возвращает
 диапазон, состоящий только из строк, входящих в текущий диапазон.
...
При нажатии на кнопку в переменной «TRange1» будет содержаться ссылка
 ...
 будет ссылка на диапазон, состоящий из строк, входящих в диапазон «TRange1».
