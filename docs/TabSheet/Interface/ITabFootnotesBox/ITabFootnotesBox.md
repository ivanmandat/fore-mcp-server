...
Интерфейс ITabFootnotesBox содержит
 свойства и методы компонента среды разработки - [TabFootnotesBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/TabFootnotesBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Source](ITabFootnotesBox.Source.htm)
