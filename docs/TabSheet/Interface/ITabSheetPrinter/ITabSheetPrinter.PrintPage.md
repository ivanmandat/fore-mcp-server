...
PrintPage(PageNumber: Integer; Graphics: [IGxGraphics](ModDrawing.chm::/Interface/IGxGraphics/IGxGraphics.htm));


## Параметры


PageNumber - номер выводимой
 страницы.


Graphics - графический контекст,
 в который будет выведена таблица.


## Описание


Метод PrintPage осуществляет
 вывод таблицы в графический контекст.
