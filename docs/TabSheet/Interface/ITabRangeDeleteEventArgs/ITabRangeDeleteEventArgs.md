...
Интерфейс ITabRangeDeleteEventArgs
...
Для работы с аргументами событий, происходящих при добавлении диапазона
 ячеек используйте свойства интерфейса [ITabRangeInsertEventArgs](../ITabRangeInsertEventArgs/ITabRangeInsertEventArgs.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Range](ITabRangeDeleteEventArgs.Range.htm)
		 Свойство Range возвращает
		 параметры диапазона ячеек таблицы.


		 ![](../../Property_Image.gif)
		 [ShiftDirection](ITabRangeDeleteEventArgs.ShiftDirection.htm)
