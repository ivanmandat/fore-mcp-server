...
MaxValueType: [TabFormatValueType](../../Enums/TabFormatValueType.htm);


## Описание


Свойство MaxValueType определяет
 тип условия, по которому устанавливается максимально допустимое значение
