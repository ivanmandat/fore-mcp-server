...
PointType(Index: Integer): [TabFormatValueType](../../Enums/TabFormatValueType.htm);
...
Index -
 индекс правила, по которому осуществляется выбор отображаемой пиктограммы.


## Описание


Свойство PointType определяет
 тип условия, по которому устанавливается значение для указанного правила.
 Актуально, если свойству [Style](ITabFormatValues.Style.htm)
...
[ITabFormatValues](ITabFormatValues.htm) |
 [ITabFormatValues.PointCondition](ITabFormatValues.PointCondition.htm)
