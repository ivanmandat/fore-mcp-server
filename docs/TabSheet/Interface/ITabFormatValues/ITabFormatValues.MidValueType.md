...
MidValueType: [TabFormatValueType](../../Enums/TabFormatValueType.htm);


## Описание


Свойство MidValueType определяет
 тип условия, по которому устанавливается среднее допустимое значение для
 ячеек, попадающих под форматирование.
