...
Свойство PointValue определяет
 условие, по которому устанавливается значение для ячеек, попадающих под
 указанное правило. Актуально, если свойству [Style](ITabFormatValues.Style.htm)
