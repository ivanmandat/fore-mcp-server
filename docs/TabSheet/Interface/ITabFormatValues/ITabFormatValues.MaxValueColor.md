...
MaxValueColor: [IGxColor](ModDrawing.chm::/Interface/IGxColor/IGxColor.htm);


## Описание


Свойство MaxValueColor определяет
 конечный цвет градиента, используемый для оформления ячеек.
