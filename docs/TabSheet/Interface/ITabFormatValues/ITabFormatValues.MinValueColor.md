# ITabFormatValues.MinValueColor
...
MinValueColor: [IGxColor](ModDrawing.chm::/Interface/IGxColor/IGxColor.htm);


## Описание


Свойство MinValueColor определяет
 начальный цвет градиента, используемый для оформления ячеек.
