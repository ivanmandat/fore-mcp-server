...
MidValueColor: [IGxColor](ModDrawing.chm::/Interface/IGxColor/IGxColor.htm);


## Описание


Свойство MidValueColor определяет
 средний цвет градиента либо цвет гистограммы, в зависимости от используемого
 стиля оформления ячеек.


## Комментарии


Назначение данного свойства зависит от значения свойства [Style](ITabFormatValues.Style.htm):


	- Если [Style](ITabFormatValues.Style.htm) = [TabFormatValuesStyle.ThreeColorScale](../../Enums/TabFormatValuesStyle.htm),
	 то данное свойство определяет средний цвет градиента.


	- Если [Style](ITabFormatValues.Style.htm) = [TabFormatValuesStyle.DataBar](../../Enums/TabFormatValuesStyle.htm),
	 то данное свойство определяет цвет гистограммы.
