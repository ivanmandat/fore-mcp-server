...
MinValueType: [TabFormatValueType](../../Enums/TabFormatValueType.htm);


## Описание


Свойство MinValueType определяет
 тип условия, по которому устанавливается минимальное допустимое значение
 для ячеек, попадающих под форматирование.
