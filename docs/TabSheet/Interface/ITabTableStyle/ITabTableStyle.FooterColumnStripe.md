...
FooterColumnStripe: [ITabTableStripe](../ITabTableStripe/ITabTableStripe.htm);


## Описание


Свойство FooterColumnStripe
 возвращает параметры стиля оформления последней полосы строк в таблице.
...
После выполнения примера для выделенной области ячеек(A0:D4) цвет фона
 последней полосы строк будет изменен на красный:


![](ITabTableStyle.FooterColumnStripe.gif)
