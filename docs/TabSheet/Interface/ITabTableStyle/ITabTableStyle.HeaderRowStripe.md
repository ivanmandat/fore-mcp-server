# ITabTableStyle.HeaderRowStripe
...
HeaderRowStripe: [ITabTableStripe](../ITabTableStripe/ITabTableStripe.htm);


## Описание


Свойство HeaderRowStripe возвращает
 параметры стиля оформления заголовков строк в таблице.
...
После выполнения примера для выделенной области ячеек(A0:D4) цвет фона
 заголовков строк будет изменен на красный:
