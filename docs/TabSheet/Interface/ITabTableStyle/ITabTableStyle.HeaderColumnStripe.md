# ITabTableStyle.HeaderColumnStripe
...
HeaderColumnStripe: [ITabTableStripe](../ITabTableStripe/ITabTableStripe.htm);


## Описание


Свойство HeaderColumnStripe
 возвращает параметры стиля оформления заголовков столбцов в таблице.
...
Для выполнения примера предполагается наличие формы, расположенной на
 ...
 с наименованием «UiTabSheet1» и компонента TabSheetBox.
	...
	    TStyle.HeaderColumnStripe.Style := s1;

	End Sub Button1OnClick;


После выполнения примера для выделенной области ячеек(A0:D4) цвет фона
 заголовков столбцов будет изменен на красный:


![](HeaderColumnStripe.gif)
