# ITabTableStyle.ColumnFirstStripe
...
ColumnFirstStripe: [ITabTableStripe](../ITabTableStripe/ITabTableStripe.htm);


## Описание


Свойство ColumnFirstStripe возвращает
 параметры стиля оформления первой полосы столбцов в таблице.
...
Для выполнения примера предполагается наличие формы, расположенной на
 ...
 с наименованием «UiTabSheet1» и компонента TabSheetBox.
	...
	    TStyle.ColumnFirstStripe.Style := s1;

	End Sub Button1OnClick;


После выполнения примера для выделенной области ячеек(A0:D4) цвет фона
 первой полосы столбцов будет изменен на красный:


![](ITabTableStyle.ColumnFirstStripe.gif)
