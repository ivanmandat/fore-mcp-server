# ITabTableStyle.FooterRowStripe
...
FooterRowStripe: [ITabTableStripe](../ITabTableStripe/ITabTableStripe.htm);


## Описание


Свойство FooterRowStripe возвращает
 параметры стиля оформления последней полосы столбцов в таблице.
...
Для выполнения примера предполагается наличие формы, расположенной на
 ...
 с наименованием «UiTabSheet1» и компонента TabSheetBox.
	...
	    TStyle.FooterRowStripe.Width := 1;

	    TStyle.FooterRowStripe.Style := s1;

	End Sub Button1OnClick;


После выполнения примера для выделенной области ячеек(A0:D4) цвет фона
 последней полосы столбцов будет изменен на красный:


![](ITabTableStyle.FooterRowStripe.gif)
