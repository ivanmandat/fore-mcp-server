...
Интерфейс ITabSheetExporter
 содержит свойства и методы для экспорта таблицы.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AutoHeight](ITabSheetExporter.AutoHeight.htm)


		 Свойство AutoHeight
		 определяет, будет ли при экспорте в форматы HTML (*.html) и RTF
		 (*.rtf) использоваться автоподгон высоты строк.


		 ![](../../Property_Image.gif)
		 [BreakIntoLayouts](ITabSheetExporter.BreakIntoLayouts.htm)


		 Свойство BreakIntoLayouts
		 определяет, разбивать ли лист на печатные страницы при экспорте
		 в формат RTF (*.rtf).


		 ![](../../Property_Image.gif)
		 [EmfType](ITabSheetExporter.EmfType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ExportCellImages](ITabSheetExporter.ExportCellImages.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ExportFootnotes](ITabSheetExporter.ExportFootnotes.htm)


		 Свойство ExportFootnotes
		 определяет, будут ли экспортироваться сноски таблицы.


		 ![](../../Property_Image.gif)
		 [ExportFormulas](ITabSheetExporter.ExportFormulas.htm)


		 Свойство ExportFormulas определяет
		 необходимость экспорта формул, содержащихся в таблице.


		 ![](../../Property_Image.gif)
		 [ExportHiddenCells](ITabSheetExporter.ExportHiddenCells.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ExportObjectAsBitmap](ITabSheetExporter.ExportObjectAsBitmap.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ExportObjects](ITabSheetExporter.ExportObjects.htm)


		 Свойство ExportObjects
		 определяет необходимость экспорта объектов таблицы.


		 ![](../../Property_Image.gif)
		 [ExportPalette](ITabSheetExporter.ExportPalette.htm)


		 Свойство ExportPalette
		 определяет необходимость экспорта палитры в XLS (*.xls).


		 ![](../../Property_Image.gif)
		 [Label](ITabSheetExporter.Label.htm)


		 Свойство Label определяет
		 параметры маркировки таблицы.


		 ![](../../Property_Image.gif)
		 [SheetAccess](ITabSheetExporter.SheetAccess.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TabSheet](ITabSheetExporter.TabSheet.htm)
