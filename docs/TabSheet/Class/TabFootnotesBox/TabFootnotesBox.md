...
Класс TabFootnotesBox реализует
 компонент среды разработки - [TabFootnotesBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/TabFootnotesBox.htm).
