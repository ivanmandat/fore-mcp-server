...
Класс TabNotNumberException
 реализует экземпляр исключительной ситуации, возникающей если формула
 содержит ячейки с разными типами данных.
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateEx](../TabNoDataException/TabNoDataException.CreateEx.htm)
