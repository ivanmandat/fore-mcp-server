...
Класс TabNoDataException реализует
 экземпляр исключительной ситуации, возникающей если формула содержит недопустимое
 значение.
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateEx](TabNoDataException.htm)
		 Конструктор CreateEx
		 создает экземпляр ошибки с текстом «#Н/Д».
...
## Статические свойства класса, унаследованные от [IException](ForeSys.chm::/Interface/IException/IException.htm)
