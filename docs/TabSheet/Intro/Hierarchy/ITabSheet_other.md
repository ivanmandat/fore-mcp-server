# Прочие элементы таблицы: иерархия интерфейсов

Прочие элементы таблицы: иерархия интерфейсов
-


# Прочие элементы таблицы


Для настройки прочих элементов таблицы предназначены различные интерфейсы.
...
Прочие элементы таблицы имеют следующую иерархию:
