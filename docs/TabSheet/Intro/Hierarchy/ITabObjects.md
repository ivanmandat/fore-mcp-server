# Объекты на листах таблицы: иерархия интерфейсов

Объекты на листах таблицы: иерархия интерфейсов
-


# Объекты на листах таблицы


Для работы с внешним видом таблицы предназначен интерфейс [ITabObjects](../../Interface/ITabObjects/ITabObjects.htm).
...
Интерфейс [ITabObjects](../../Interface/ITabObjects/ITabObjects.htm)
