...
Класс LongListItem реализует
 компонент [LongListItem](../../Components/LongListItem/LongListItem.htm),
 представляющий собой элемент [сгруппированного
 списка](../../Components/LongListBox/LongListBox.htm).


## Синтаксис


PP.initClass(PP.Ui.LongListItem, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "LongListItem");
