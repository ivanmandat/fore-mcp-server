...
Класс ListItem реализует компонент
 [ListItem](../../Components/ListItem/ListItem.htm), представляющий
 собой элемент [списка](../../Components/ListBox/ListBox.htm).


## Синтаксис


PP.initClass(PP.Ui.ListItem, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "ListItem");
