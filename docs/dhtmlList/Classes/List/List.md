...
Класс List реализует базовые
 свойства и методы для работы с коллекциями.


## Синтаксис


PP.initClass(PP.List, PP.[Object](dhtmlCommon.chm::/Classes/object/object.htm),
 "List");
