...
Компонент ListBox представляет
 собой список.
...
Компонент реализован классом [ListBox](../../Classes/ListBox/ListBox.htm).
...
Элементами списка являются экземпляры компонентов [ListItem](../ListItem/ListItem.htm)
 и [IconListItem](dhtmlUi.chm::/Classes/IconListItem/IconListItem.htm).
 Список может содержать пиктограммы, как показано на рисунке выше. Пиктограммы
 содержатся в файле, адрес которого установлен в параметрах невизуального
 компонента [ImageList](dhtmlUi.chm::/Components/ImageList/ImageList.htm).


[Пример создания компонента ListBox](Example_ListBox.htm).


Список может быть расположен вертикально и горизонтально. Горизонтальный
...
Элементами данного горизонтального списка являются пиктограммы, реализованные
 классом [IconListItem](dhtmlUi.chm::/Classes/IconListItem/IconListItem.htm).


[Пример создания
 горизонтального списка.](../../Classes/ListBox/ListBox.Orientation.htm)


Элементы из одного списка можно переносить в другой список при помощи
 механизма Drag&Drop.


[Пример создания компонента ListBox с механизмом
 Drag&Drop](ListBoxExample.htm).
