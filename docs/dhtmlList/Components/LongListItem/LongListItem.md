...
Компонент LongListItem представляет
 собой элемент [сгруппированного
 списка](../LongListBox/LongListBox.htm).


## Комментарии


Компонент реализован классом [LongListItem](../../Classes/LongListItem/LongListItem.htm).
 Используется при создании компонента [LongListBox](../LongListBox/LongListBox.htm).


## Пример


Компонент LongListItem является
 элементом (строкой) [сгруппированного
 списка](../LongListBox/LongListBox.htm), пример которого расположен на странице «[Пример
 создания компонента LongListBox](../LongListBox/Example_LongListBox.htm)».
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [LongListItem](dhtmlList.chm::/Classes/LongListItem/Constructor_LongListItem.htm)
		 Конструктор LongListItem
		 создает экземпляр компонента [LongListItem](dhtmlList.chm::/Components/LongListItem/LongListItem.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Template](dhtmlList.chm::/Classes/LongListItem/LongListItem.Template.htm)
		 Свойство Template содержит
		 шаблон элемента.
