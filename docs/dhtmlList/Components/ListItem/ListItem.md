...
Компонент ListItem представляет
 собой элемент [списка](../ListBox/ListBox.htm).


## Комментарии


Компонент реализован классом [ListItem](../../Classes/ListItem/ListItem.htm).
 Используется при создании компонента [ListBox](../ListBox/ListBox.htm).


## Пример


Компонент ListItem является
 элементом (строкой) [списка](../ListBox/ListBox.htm), примеры
 которого расположены на страницах «[Пример
 создания компонента ListBox](../ListBox/Example_ListBox.htm)» и «[Пример
 создания компонента ListBox с механизмом Drag&Drop](../ListBox/ListBoxExample.htm)».
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ListItem](dhtmlList.chm::/classes/listitem/constructor_listitem.htm)
		 Конструктор ListItem
		 создает экземпляр компонента [ListItem](dhtmlList.chm::/components/listitem/listitem.htm).
