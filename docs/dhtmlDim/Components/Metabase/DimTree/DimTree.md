...
Компонент реализован классом [DimTree](../../../Classes/Metabase/DimTree/DimTree.htm).


Для доступа к свойствам, методам и событиям базового компонента [TreeList](dhtmlUiTree.chm::/Classes/TreeList/TreeList.htm)
 используйте метод [ProxyControl.getControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.getControl.htm).
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [DimTree](../../../Classes/Metabase/DimTree/Constructor_DimTree.htm)
			 Конструктор DimTree
