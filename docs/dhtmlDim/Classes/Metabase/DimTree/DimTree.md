...
Класс DimTree реализует компонент
 [DimTree](../../../Components/Metabase/DimTree/DimTree.htm),
 представляющий собой дерево, в котором отображаются данные справочника.


## Синтаксис


PP.initClass(PP.Mb.Ui.DimTree, PP.Mb.Ui.[ElsTree](dhtmlMetabase.chm::/Classes/Metabase/ElsTree/ElsTree.htm),
 "PP.Mb.Ui.DimTree", [PP.Mb.Ui.IDimensionControl]);
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [DimTree](Constructor_DimTree.htm)
			 Конструктор DimTree
			 создает экземпляр класса DimTree.
...
## Свойства, унаследованный от класса [ElsTree](dhtmlMetabase.chm::/Classes/Metabase/ElsTree/ElsTree.htm)
...
## Методы, унаследованный от класса [ElsTree](dhtmlMetabase.chm::/Classes/Metabase/ElsTree/ElsTree.htm)
...
[Классы
 для работы с измерением](../../DimClasses.htm)
