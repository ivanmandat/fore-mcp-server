# ILanerSerieDisplayParams.Inversion
...
Inversion: [TsInversion](KeTransform.chm::/Enums/TsInversion.htm)
...
Свойство Inversion определяет
 способ начального преобразования данных.
