...
IsRegistered(Laner: [ILaner](../ILaner/ILaner.htm)):
 Boolean;
...
Допустимые значения:
	...
	- True. Книга зарегистрирована;


	- False. Книга не зарегистрирована.
...
Добавьте ссылки на системные сборки: Express, ExtCtrls, Forms, Laner,
 Tab.
	...
	    If Not pContext.IsRegistered(Laner) Then
...
После выполнения примера рабочая область базы данных временных рядов
 будет зарегистрирована в контексте базы данных временных рядов, если она
 еще там не зарегистрирована.
