# ILanerCalculateSerie.SourceStub
...
SourceStub: [IVariableStub](KeCubes.chm::/Interface/IVariableStub/IVariableStub.htm);


## Описание


Свойство SourceStub возвращает
 данные ряда, как абстрактного источника данных.


## Комментрии


Свойство вернёт значение Null,
 если у ряда отсутствует источник ([ILanerCalculateSerie.Source](ILanerCalculateSerie.Source.htm)).
