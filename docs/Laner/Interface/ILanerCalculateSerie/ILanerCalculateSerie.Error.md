...
Метод Error осуществляет вывод
 ошибок, возникших при расчете ряда.
...
Для выполнения примера предполагается наличие на форме компонентов Button,
 ...
 базы данных временных рядов, в таблице данных которой должно быть более
 одного ряда данных.
...
Добавьте ссылки на системные сборки: Collections, Cubes, Dimensions,
 Express, ExtCtrls, Forms, Laner, Ms, Tab.
...
После выполнения примера будет добавлен новый вычисляемый ряд, представляющий
 собой сумму данных первых двух рядов. В компонент «Memo1» будут выведены
 ошибки, возникшие при расчете.
