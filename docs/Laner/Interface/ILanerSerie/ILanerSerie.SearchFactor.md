...
SearchFactor: [LnSerieFactorSearchResult](../../Enums/LnSerieFactorSearchResult.htm);


## Описание


Метод SearchFactor осуществляет
 поиск в базе данных временных рядов ряда с такими же значениями обязательных
 атрибутов, как и у текущего.
...
Для выполнения примера предполагается наличие на форме компонентов Button,
 ...
 рядов. Перед выполнением примера необходимо выделить в рабочей области
 добавленный ряд, который необходимо сохранить.
...
Добавьте ссылки на системные сборки: Express, ExtCtrls, Forms, Laner,
 Tab, Ui.
	...
	        WinApplication.InformationBox("Определены не все обязательные атрибуты ряда '" +
