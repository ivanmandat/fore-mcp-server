# ILaner.SerieFootnoteAttributes
...
SerieFootnoteAttributes: [ILanerCellAttributes](../ILanerCellAttributes/ILanerCellAttributes.htm);


## Описание


Свойство SerieFootnoteAttributes
 возвращает коллекцию атрибутов, используемых для формирования сносок для
 заголовков рядов.
...
В коллекцию могут быть добавлены атрибуты только с типом [LnAttributeType.Fact](../../Enums/LnAttributeType.htm).
...
В результате выполнения примера для заголовков рядов в рабочей книге
 будут добавлены сноски. Текст сносок будет формироваться по значениям
 атрибута рядов «COUNTRY».
