...
Интерфейс ILanerDerivedSerie
 содержит свойства и методы для работы с дочерними рядами вычисляемого
 ряда.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DerivedType](ILanerDerivedSerie.DerivedType.htm)
		 Свойство DerivedType
		 возвращает тип дочернего ряда.


		 ![](../../Property_Image.gif)
		 [FactorIndex](ILanerDerivedSerie.FactorIndex.htm)
		 Свойство FactorIndex
		 возвращает индекс дочернего ряда, если он является показателем.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateFactor](ILanerDerivedSerie.CreateFactor.htm)
		 Метод CreateFactor
