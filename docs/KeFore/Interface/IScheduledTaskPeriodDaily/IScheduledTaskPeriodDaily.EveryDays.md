# IScheduledTaskPeriodDaily.EveryDays
...
Свойство EveryDays определяет
 интервал между запусками в днях. По умолчанию интервал устанавливается
 в один день.
...
[IScheduledTaskPeriodDaily](IScheduledTaskPeriodDaily.htm)
