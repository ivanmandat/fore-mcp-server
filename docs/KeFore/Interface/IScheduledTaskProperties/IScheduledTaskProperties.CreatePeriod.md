...
CreatePeriod(Type: [ScheduledTaskPeriodType](../../Enums/ScheduledTaskPeriodType.htm)):
 [IScheduledTaskPeriod](../IScheduledTaskPeriod/IScheduledTaskPeriod.htm);


## Параметры


Type - способ задания периода
 выполнения задачи.
...
Метод CreatePeriod создает объект,
 содержащий настройки периода выполнения задачи.
...
Для выполнения примера предполагается наличие в репозитории контейнера
 запланированных задач с идентификатором "TASK_CONTAINER" и модуля
