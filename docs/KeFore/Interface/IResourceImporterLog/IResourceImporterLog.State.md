...
State(Index: Integer): [ResourceImportLogState](../../Enums/ResourceImportLogState.htm);
...
Index.
 Индекс строки ресурсов.


## Описание


Свойство State возвращает статус
 импорта строки ресурсов по ее индексу.
...
[IResourceImporterLog](IResourceImporterLog.htm)
