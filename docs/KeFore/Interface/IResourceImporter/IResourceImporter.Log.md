...
Log: [IResourceImporterLog](../IResourceImporterLog/IResourceImporterLog.htm);


## Описание


Свойство Log возвращает отчет
 о ходе импорта ресурсов.
...
Для выполнения примера предполагается наличие в репозитории ресурсов
 ...
 был экспортирован ресурс «C:\Res.txt».
