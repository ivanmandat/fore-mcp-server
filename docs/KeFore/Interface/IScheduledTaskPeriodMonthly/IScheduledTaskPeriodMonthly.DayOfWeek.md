...
DayOfWeek: [CalendarDayOfWeek](ForeSys.chm::/Enums/CalendarDayOfWeek.htm);


## Описание


Свойство DayOfWeek определяет
 день недели, в который будет производиться расчет задачи.
