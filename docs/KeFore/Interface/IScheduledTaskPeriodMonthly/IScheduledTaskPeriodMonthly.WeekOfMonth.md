...
WeekOfMonth: [CalendarWeekOfMonth](../../Enums/CalendarWeekOfMonth.htm);


## Описание


Свойство WeekOfMonth определяет
 неделю месяца, в которой будет производиться расчет. Актуально, если свойству
 [DayOfWeek](IScheduledTaskPeriodMonthly.DayOfWeek.htm) установлено
 значение, отличное от CalendarDayOfWeek.LocaleDefault.
