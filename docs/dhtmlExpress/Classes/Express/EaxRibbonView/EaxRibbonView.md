...
Класс EaxRibbonView реализует представление [ленты инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxRibbonView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm), "EaxRibbonView", PP.Exp.Ui.IEaxRibbonView);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxRibbonView](dhtmlExpress.chm::/classes/express/eaxribbonview/constructor_eaxribbonview.htm)
		 Конструктор EaxRibbonView
		 создает экземпляр компонента EaxRibbonView.
