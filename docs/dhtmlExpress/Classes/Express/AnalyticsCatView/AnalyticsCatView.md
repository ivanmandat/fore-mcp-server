...
Класс AnalyticsCatView реализует
 представление вкладки «Расширенная аналитика» [ленты
...
PP.initClass(PP.Exp.Ui.AnalyticsCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm),
 "AnalyticsCatView");
...
Класс наследуется классом [PP.Exp.Ui.AnalyticsCategory](../AnalyticsCategory/AnalyticsCategory.htm).
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 AnalyticsCatView
				 Конструктор AnalyticsCatView
				 создает экземпляр класса AnalyticsCatView.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getLegendButton](AnalyticsCatView.getLegendButton.htm)
		 Метод getLegendButton
		 возвращает кнопку легенды валидаций.


		 ![](../../../sub_image.gif)
		 [setPropertyValue](AnalyticsCatView.setPropertyValue.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ModelingGenerated](AnalyticsCatView.ModelingGenerated.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [OnGetDataMiningResult](AnalyticsCatView.OnGetDataMiningResult.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [TimeSeriesGenerated](AnalyticsCatView.TimeSeriesGenerated.htm)
