...
Класс EaxToolBarView
 реализует представление [группы
 кнопок для переключения режима отображения данных](../../../Components/Express/EaxToolBar/EaxToolBar.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxToolBarView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm),
 "EaxToolBarView", [PP.Exp.Ui.IEaxToolBarView]);
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [EaxToolBarView](dhtmlExpress.chm::/classes\express\eaxtoolbarview\constructor_eaxtoolbarview.htm)
				 Конструктор EaxToolBarView
				 создает экземпляр класса EaxToolBarView.
