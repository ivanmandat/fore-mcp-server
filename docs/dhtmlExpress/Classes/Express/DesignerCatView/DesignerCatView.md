...
Класс DesignerCatView реализует
 представление вкладки «Конструктор» [ленты
 инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm).
...
PP.initClass(PP.Exp.Ui.DesignerCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm),
 "DesignerCatView");
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [DesignerCatView](Constructor_DesignerCatView.htm)
				 Конструктор DesignerCatView
				 создает экземпляр класса DesignerCatView.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [DesignerCatView.getContentRendered](DesignerCatView.getContentRendered.htm)
		 Метод getContentRendered
		 определяет, отрисовано ли содержимое вкладки.


		 ![](../../../sub_image.gif)
		 [DesignerCatView.refresh](DesignerCatView.refresh.htm)
		 Метод **refresh**
		 обновляет данные вкладки «Конструктор» на ленте инструментов.


		 ![](../../../sub_image.gif)
		 [DesignerCatView.renderContent](DesignerCatView.renderContent.htm)
		 Метод renderContent
