...
Класс CommonizeDimDilog реализует
 диалог для вынесения частных измерений в общие.


## Синтаксис


PP.initClass(PP.Exp.Ui.CommonizeDimDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "CommonizeDimDialog");


## Комментарии


Класс CommonizeDimDialog реализует
 компонент [CommonizeDimDialog](../../../Components/Express/CommonizeDimDialog/CommonizeDimDialog.htm).
