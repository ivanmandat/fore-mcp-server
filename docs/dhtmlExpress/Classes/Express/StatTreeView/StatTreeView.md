...
Класс StatTreeView реализует [диалог «Статистические характеристики»](../../../Components/Express/StatTreeView/StatTreeView.htm), отображающий дерево со статистическими характеристиками данных экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.StatTreeView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm), "StatTreeView");


## Комментарии


Класс StatTreeView реализует компонент [StatTreeView](StatTreeView.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [StatTreeView](dhtmlExpress.chm::/Classes/Express/StatTreeView/Constructor_StatTreeView.htm)
		 Конструктор StatTreeView
		 создает экземпляр компонента StatTreeView.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes/express/stattreeview/stattreeview.source.htm)
		 Свойство Source
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [adjustColumnWidth](dhtmlExpress.chm::/classes/express/stattreeview/stattreeview.adjustcolumnwidth.htm)
		 Метод adjustColumnWidth
		 подбирает оптимальную ширину колонок в дереве со статистическими
		 характеристиками данных на основе его содержимого.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/classes/express/stattreeview/stattreeview.refresh.htm)
		 Метод refresh
		 обновляет диалог «Статистические характеристики».


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/classes/express/stattreeview/stattreeview.refreshall.htm)
		 Метод refreshAll
		 обновляет все содержимое диалога «Статистические характеристики».


		 ![](../../../sub_image.gif)
		 [setColumnWidth](dhtmlExpress.chm::/classes/express/stattreeview/stattreeview.setcolumnwidth.htm)
		 Метод setColumnWidth
		 устанавливает ширину для указанного столбца в дереве со статистическими
