...
PP.initClass(PP.Exp.Ui.FilterDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "FilterDialog");
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [FilterDialog](Constructor_FilterDialog.htm)
			 Конструктор FilterDialog
			 создает экземпляр класса FilterDialog.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [FilterDialog.Source](FilterDialog.Source.htm)
		 Свойство Source определяет
		 источник данных в диалоге «Фильтр».
