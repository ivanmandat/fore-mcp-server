...
[ExportDialog](dhtmlReport.chm::/Classes/RegularReport/ExportDialog/ExportDialog.htm)
...
Класс **HtmlExportDialog**
 реализует [диалог
 для экспорта экспресс-отчета в файл формата HTML](../../../Components/Express/HtmlExportDialog/HtmlExportDialog.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.HtmlExportDialog, PP.Ui.[ExportDialog](dhtmlReport.chm::/Classes/RegularReport/ExportDialog/ExportDialog.htm),
 "HtmlExportDialog");
...
Класс HtmlExportDialog реализует
 компонент [HtmlExportDialog](../../../Components/Express/HtmlExportDialog/HtmlExportDialog.htm).
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [HtmlExportDialog](Constructor_HtmlExportDialog.htm)
