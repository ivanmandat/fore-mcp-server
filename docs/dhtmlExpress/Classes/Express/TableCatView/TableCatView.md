...
[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm)
...
Класс TableCatView реализует
 представление вкладки «Таблица» [ленты
 инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксисы


PP.initClass(PP.Exp.Ui.TableCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm),
 "TableCatView");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TableCatView](dhtmlExpress.chm::/Classes/Express/TableCatView/Constructor_TableCatView.htm)
		 Конструктор TableCatView создает
		 экземпляр класса TableCatView.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getContentRendered](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getContentRendered.htm)
		 Метод getContentRendered
		 возвращает признак отрисовки элементов вкладки ленты инструментов
		 «Таблица».


		 ![](../../../sub_image.gif)
		 [getPanelsJSON](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getPanelsJSON.htm)
		 Метод getPanelsJSON
		 возвращает панели вкладки «Конструктор» в формате JSON.


		 ![](../../../sub_image.gif)
		 [getTableAnalysisParetoButtonState](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getTableAnalysisParetoButtonState.htm)
		 Метод **getTableAnalysisParetoButtonState**
		 возвращает свойства кнопки «Распределение» в группе «Анализ» на
		 вкладке ленты инструментов «Таблица».


		 ![](../../../sub_image.gif)
		 [getTableAngleButtonState](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getTableAngleButtonState.htm)
		 Метод **getTableAngleButtonState**
		 возвращает свойства кнопки «Поворот таблицы» на вкладке ленты
		 инструментов «Таблица».


		 ![](../../../sub_image.gif)
		 [getTableCFormatButton](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getTableCFormatButton.htm)
		 Метод **getTableCFormatButton**
		 возвращает кнопку «Условное форматирование» на вкладке ленты инструментов
		 «Таблица».


		 ![](../../../sub_image.gif)
		 [getTableNumberCombo](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getTableNumberCombo.htm)
		 Метод getTableNumberCombo
		 возвращает элемент управления форматом числа на вкладке ленты
		 инструментов «Таблица: Конструктор».


		 ![](../../../sub_image.gif)
		 [getTableSparklinesButton](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getTableSparklinesButton.htm)
		 Метод getTableSparklinesButton
		 возвращает кнопку «Линии» вкладки ленты инструментов «Таблица».


		 ![](../../../sub_image.gif)
		 [getTableStyleListBox](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getTableStyleListBox.htm)
		 Метод getTableStyleListBox
		 возвращает список стилей на вкладке ленты инструментов «Таблица:
		 Конструктор».


		 ![](../../../sub_image.gif)
		 [getTableStyleState](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.getTableStyleState.htm)
		 Метод **getTableStyleState**
		 возвращает свойства кнопки «Стиль и оформление» на вкладке ленты
		 инструментов «Таблица».


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.refresh.htm)
		 Метод **refresh**
		 обновляет вкладку ленты инструментов «Таблица» экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshNumber](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.refreshNumber.htm)
		 Метод refreshNumber
		 обновляет элемент управления формата числа.


		 ![](../../../sub_image.gif)
		 [refreshTableCFormatButton](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.refreshTableCFormatButton.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [refreshTableStyleButton](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.refreshTableStyleButton.htm)
		 Метод **refreshTableStyleButton**
		 обновляет из модели кнопку «Стиль и оформление» на вкладке ленты
		 инструментов «Таблица».


		 ![](../../../sub_image.gif)
		 [renderContent](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.renderContent.htm)
		 Метод renderContent
		 отрисовывает элементы вкладки ленты инструментов «Таблица».


		 ![](../../../sub_image.gif)
		 [selectionForPareto](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.selectionForPareto.htm)
		 Метод **selectionForPareto**
		 включает кнопку «Распределение» в зависимости от выделенного в
		 таблице диапазона.


		 ![](../../../sub_image.gif)
		 [setEnabledCFormat](dhtmlExpress.chm::/Classes/Express/TableCatView/TableCatView.setEnabledCFormat.htm)
		 Метод **setEnabledCFormat**
		 управляет доступом к кнопке «Условное форматирование» на вкладке
		 «Таблица» ленты инструментов экспресс-отчета.


## Свойства, унаследованные от класса [EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm)
...
## Методы, унаследованные от класса [EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm)
...
## События, унаследованные от класса [EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm)
