...
[ExpressView](../ExpressView/ExpressView.htm)
...
Класс ExpressBox реализует [контейнер для экспресс-отчетов](../../../Components/Express/ExpressBox/ExpressBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.ExpressBox, PP.Exp.Ui.[ExpressView](../ExpressView/ExpressView.htm), "ExpressBox");
...
## Свойства, унаследованные от [ExpressView](../ExpressView/ExpressView.htm)
...
## Методы, унаследованные от [ExpressView](../ExpressView/ExpressView.htm)
