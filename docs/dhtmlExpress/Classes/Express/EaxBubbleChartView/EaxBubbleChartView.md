...
Класс **EaxBubbleChartView**
 реализует представление [пузырьковой диаграммы
 экспресс-отчета](../EaxBubbleChart/EaxBubbleChart.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxBubbleChartView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 «EaxBubbleChartView», [PP.Exp.Ui.IEaxBubbleChartView, PP.Ui.IDataView]);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxBubbleChartView](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/Constructor_EaxBubbleChartView.htm)
		 Конструктор EaxBubbleChartView
		 создает экземпляр класса EaxBubbleChartView.
