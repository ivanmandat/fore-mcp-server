...
Класс XlsExportDialog
 реализует [диалог
 «Параметры экспорта в XLS»](../../../Components/Express/XlsExportDialog/XlsExportDialog.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.XlsExportDialog, PP.Ui.[ExportDialog](dhtmlReport.chm::/Classes/RegularReport/ExportDialog/ExportDialog.htm),
 "XlsExportDialog");
...
Класс XlsExportDialog реализует
 компонент [XlsExportDialog](../../../Components/Express/XlsExportDialog/XlsExportDialog.htm).
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [XlsExportDialog](Constructor_XlsExportDialog.htm)
