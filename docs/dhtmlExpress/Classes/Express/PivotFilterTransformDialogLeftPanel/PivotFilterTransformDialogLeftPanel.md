# PivotFilterTransformDialogLeftPanel
...
[TransformDialogLeftPanel](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialogLeftPanel/TransformDialogLeftPanel.htm)
...
Класс TransformDialogLeftPanel реализует
 панель компонента [TransformDialog](dhtmlUfe.chm::/Components/TransformDialog/TransformDialog.htm),
 содержащую данные измерения экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.PivotFilterTransformDialogLeftPanel,
 PP.Ui.Panel, "PP.Exp.Ui.PivotFilterTransformDialogLeftPanel");


## Комментарии


Класс PivotFilterTransformDialogLeftPanel
 предзназначен для вызова левой панели компонента редактирования формул
 при задании фильтрации.
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [PivotFilterTransformDialogLeftPanel](Constructor_PivotFilterTransformDialogLeftPanel.htm)
		 Конструктор PivotFilterTransformDialogLeftPanel
		 создает экземпляр компонента PivotFilterTransformDialogLeftPanel.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ActiveElemSelected](PivotFilterTransformDialogLeftPanel.ActiveElemSelected.htm)
		 Событие ActiveElemSelected выделения
		 активного элемента в дереве наступает после загрузки редактора
		 формул.


		 ![](../../../Event_Image.gif)
		 [ExpressionChanged](PivotFilterTransformDialogLeftPanel.ExpressionChanged.htm)
		 Событие ExpressionChanged наступает
		 после изменения выражения в редакторе формул.


		 ![](../../../Event_Image.gif)
		 [SrcTreeDisplayStateChanged](PivotFilterTransformDialogLeftPanel.SrcTreeDisplayStateChanged.htm)
		 Событие SrcTreeDisplayStateChanged наступает
		 после изменения режима отображения дерева в левой панели (отметка\метаданные).


		 ![](../../../Event_Image.gif)
		 [TreeDblClick](PivotFilterTransformDialogLeftPanel.TreeDblClick.htm)
		 Событие TreeDblClick наступает
		 после двойного щелчка по элементу в дереве левой панели.


		 ![](../../../Event_Image.gif)
		 [TreeDragStart](PivotFilterTransformDialogLeftPanel.TreeDragStart.htm)
		 Событие TreeDragStart наступает
		 после начала перетаскивания из дерева в левой панели.


## Методы унаследованные от [TransformDialogLeftPanel](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialogLeftPanel/TransformDialogLeftPanel.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getInsertButton](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialogLeftPanel/TransformDialogLeftPanel.getInsertButton.htm)
		 Метод getInsertButton
		 возвращает кнопку левой панели компонента [TransformDialog](dhtmlUfe.chm::/Components/TransformDialog/TransformDialog.htm),
		 предназначенную для вставки формулы элемента измерения в редактор
		 выражений компонента [TransformDialog](dhtmlUfe.chm::/Components/TransformDialog/TransformDialog.htm).


		 ![](../../../sub_image.gif)
		 [getOpenedDataSources](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialogLeftPanel/TransformDialogLeftPanel.getOpenedDataSources.htm)
		 Метод getOpenedDataSources
		 возвращает объект с информацией об открытых источниках данных,
		 из которых извлекаются данные об элементах измерения.


		 ![](../../../sub_image.gif)
		 [getSummaryExpression](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialogLeftPanel/TransformDialogLeftPanel.getSummaryExpression.htm)
		 Метод getSummaryExpression
		 возвращает выражение, которое вставляется в редактор выражений
		 компонента [TransformDialog](dhtmlUfe.chm::/Components/TransformDialog/TransformDialog.htm).


## События унаследованные от [TransformDialogLeftPanel](dhtmlUf.chm::/Classes/PP_Ufe_Ui/TransformDialogLeftPanel/TransformDialogLeftPanel.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [ExpressionCreated](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialogLeftPanel/TransformDialogLeftPanel.ExpressionCreated.htm)
		 Событие ExpressionCreated
		 наступает после выбора элемента измерения нажатия на кнопку «Вставить»
		 на левой панели компонента [TransformDialog](dhtmlUfe.chm::/Components/TransformDialog/TransformDialog.htm).
