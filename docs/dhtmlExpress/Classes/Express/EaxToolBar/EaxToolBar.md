...
[EaxToolBarView](../EaxToolBarView/EaxToolBarView.htm)
...
Класс EaxToolBar реализует [группу кнопок для переключения режима отображения данных](../../../Components/Express/EaxToolBar/EaxToolBar.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxToolBar, PP.Exp.Ui.[EaxToolBarView](../EaxToolBarView/EaxToolBarView.htm), "EaxToolBar");


## Комментарии


Класс EaxToolBar реализует компонент [EaxToolBar](../../../Components/Express/EaxToolBar/EaxToolBar.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxToolBar](dhtmlExpress.chm::/classes\express\eaxtoolbar\constructor_eaxtoolbar.htm)
		 Конструктор EaxToolBar
		 создает экземпляр компонента EaxToolBar.


## Свойства, унаследованные от класса [EaxToolBarView](../EaxToolBarView/EaxToolBarView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [IsRadio](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.isradio.htm)
		 Свойство IsRadio
		 определяет, включен ли режим переключения кнопок.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.source.htm)
		 Свойство Source
		 определяет источник данных для компонента.


## Методы, унаследованные от класса [EaxToolBarView](../EaxToolBarView/EaxToolBarView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getCurrentState](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.getcurrentstate.htm)
		 Метод getCurrentState
		 возвращает текущее состояние группы кнопок, используемых для переключения
		 режима отображения данных.


		 ![](../../../sub_image.gif)
		 [getItems](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.getitems.htm)
		 Метод getItems
		 возвращает массив кнопок, используемых для переключения режима
		 отображения данных.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.refresh.htm)
		 Метод refresh
		 обновляет указанную кнопку в группе других кнопок, используемых
		 для переключения режима отображения данных.


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.refreshall.htm)
		 Метод refreshAll
		 обновляет всю группу кнопок, используемых для переключения режима
		 отображения данных.


		 ![](../../../sub_image.gif)
		 [setActiveObject](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.setactiveobject.htm)
		 Метод setActiveObject
		 активирует указанный объект.


## События, унаследованные от класса [EaxToolBarView](../EaxToolBarView/EaxToolBarView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [MetadataChanged](dhtmlExpress.chm::/Classes/Express/EaxToolBarView/EaxToolBarView.MetadataChanged.htm)
		 Событие MetadataChanged наступает
		 при изменении данных в представлении группы кнопок, используемых
		 для переключения режима отображения данных.


		 ![](../../../Event_Image.gif)
		 [ObjectStateChanged](dhtmlExpress.chm::/classes\express\eaxtoolbarview\eaxtoolbarview.objectstatechanged.htm)
