# EaxDimensionTree.HierarchyEdited
...
HierarchyEdited: function (sender, args);
...
Событие HierarchyEdited наступает
 после редактирования иерархии.
...
// Зададим событие
TreeV.HierarchyEdited.add(
function (sender, args) {
    console.log("Событие HierarchyEdited");
});
В результате выполнения примера было добавлено событие HierarchyEdited.
