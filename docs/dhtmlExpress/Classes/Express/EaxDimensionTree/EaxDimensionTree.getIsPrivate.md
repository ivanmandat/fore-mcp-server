...
Метод getIsPrivate определяет,
 построено ли дерево измерений на частном измерении.
...
// Определим, построено ли дерево на частном измерении
TreeV.getIsPrivate();
В результате выполнения примера было определено, построено ли дерево
 измерений на частном измерении.
