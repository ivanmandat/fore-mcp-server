# EaxDimensionTree.FormulaChanged
...
Событие FormulaChanged наступает
 после изменения формулы элемента.
...
// Зададим событие
TreeV.FormulaChanged.add(
function (sender, args) {
    console.log("Событие FormulaChanged");
});
В результате выполнения примера было задано событие FormulaChanged.
