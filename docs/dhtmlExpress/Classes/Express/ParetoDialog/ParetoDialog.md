...
Класс Pareto**Dialog** реализует
 [диалог
 для настройки распределения данных по Парето](../../../Components/Express/ParetoDialog/ParetoDialog.htm).


## Синтаксис


PP.initClass(PP.Ui.ParetoDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "ParetoDialog");
...
Класс ParetoDialog реализует
 компонент [ParetoDialog](../../../Components/Express/ParetoDialog/ParetoDialog.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ParetoDialog](dhtmlExpress.chm::/Classes/Express/ParetoDialog/Constructor_ParetoDialog.htm)
		 Конструктор ParetoDialog
		 создает экземпляр компонента ParetoDialog.
