...
Класс FilterLinkAttrDialog реализует
 диалог фильтрации по связям атрибутов.


![](FilterLinkAttrDialog.png)


## Синтаксис


PP.initClass(PP.Exp.Ui.FilterLinkAttrDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "FilterLinkAttrDialog");
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [FilterLinkAttrDialog](Constructor_FilterLinkAttrDialog.htm)
...
## Свойства
			 ...
			 ![](../../../Property_Image.gif)
			 [Source](FilterLinkAttrDialog.Source.htm)
			 Свойство Source
			 позволяет задать источник экспресс-отчета.
