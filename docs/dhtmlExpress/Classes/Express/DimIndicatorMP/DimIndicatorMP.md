...
[NavigationItem](dhtmlCommon.chm::/Classes/navigationitem/navigationitem.htm)


[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm)


[EaxDimBarMasterPanel](../EaxDimBarMasterPanel/EaxDimBarMasterPanel.htm)
...
Класс DimIndicatorMP реализует вкладку измерения индикаторов «Показатели» на [панели свойств](../../../Components/Express/EaxPropertyBar/EaxPropertyBar.htm) экспресс-отчета.


## Комментарии


Вкладка «Показатели», реализуемая классом DimIndicatorMP, может выглядеть следующим образом:


![](../../../DimIndicatorMP.png)


Данная вкладка доступна в случае, если открыта вкладка «Карта» или «пузырьковая диаграмма».


## Синтаксис


PP.initClass(PP.Exp.Ui.DimIndicatorMP, PP.Exp.Ui.[EaxDimBarMasterPanel](../EaxDimBarMasterPanel/EaxDimBarMasterPanel.htm), "DimIndicatorMP");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [DimIndicatorMP](dhtmlExpress.chm::/classes/express/dimindicatormp/constructor_dimindicatormp.htm)
		 Конструктор DimIndicatorMP
		 создает экземпляр класса DimIndicatorMP.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [IndicatorElements](dhtmlExpress.chm::/classes/express/dimindicatormp/dimindicatormp.indicatorelements.htm)
		 Свойство IndicatorElements
		 задает список индикаторов, определяющих способ отображения
		 данных в рабочей области экспресс-отчета и отображаемых в меню
		 при выборе измерений на вкладке панели свойств «Показатели».
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getPropertyName](dhtmlExpress.chm::/classes/express/dimindicatormp/dimindicatormp.getpropertyname.htm)
		 Метод getPropertyName
		 возвращает тип элемента управления, отображаемого в данный момент
		 в рабочей области экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [showIndicator](dhtmlExpress.chm::/classes/express/dimindicatormp/dimindicatormp.showindicator.htm)
		 Метод showIndicator
		 разворачивает вкладку "Показатели" и фокусируется на
		 элементе измерения, на котором сейчас установлен индикатор.


## Свойства, унаследованные от класса [EaxDimBarMasterPanel](../EaxDimBarMasterPanel/EaxDimBarMasterPanel.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [BatchMode](dhtmlExpress.chm::/Classes/Express/EaxDimBarMasterPanel/EaxDimBarMasterPanel.BatchMode.htm)
		 Свойство BatchMode
		 определяет, отправляются ли запросы серверу в пакете данных.


		 ![](../../../Property_Image.gif)
		 [CountDimsInPos](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/eaxdimbarmasterpanel.countdimsinpos.htm)
		 Свойство CountDimsInPos
		 задает и возвращает количество измерений в занимаемой позиции.


		 ![](../../../Property_Image.gif)
		 [DimServiceMenuItems](dhtmlExpress.chm::/Classes/Express/EaxDimBarMasterPanel/EaxDimBarMasterPanel.DimServiceMenuItems.htm)
		 Свойство DimServiceMenuItems
		 содержит пользовательские элементы меню измерения.


		 ![](../../../Property_Image.gif)
		 [IndexPosition](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/eaxdimbarmasterpanel.indexposition.htm)
		 Свойство IndexPosition
		 устанавливает и возвращает индекс позиции, в которой размещается
		 измерение.


		 ![](../../../Property_Image.gif)
		 [PvtPosition](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/eaxdimbarmasterpanel.pvtposition.htm)
		 Свойство PvtPosition
		 устанавливает и определяет положение измерения.


## Методы, унаследованные от класса [EaxDimBarMasterPanel](../EaxDimBarMasterPanel/EaxDimBarMasterPanel.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [clearFilter](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/eaxdimbarmasterpanel.clearfilter.htm)
		 Метод clearFilter
		 сбрасывает фильтр с дерева на панелях в мастере управления
		 отметкой.


		 ![](../../../sub_image.gif)
		 [getDimTreeView](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/eaxdimbarmasterpanel.getdimtreeview.htm)
		 Метод getDimTreeView
		 возвращает дерево измерения на данной панели мастера управления
		 отметкой.


		 ![](../../../sub_image.gif)
		 [getSource](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/eaxdimbarmasterpanel.getsource.htm)
		 Метод getSource
		 возвращает источник данных панели в мастере управления отметкой.


		 ![](../../../sub_image.gif)
		 [refreshMenuItems](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/eaxdimbarmasterpanel.refreshmenuitems.htm)
		 Метод refreshMenuItems
		 обновляет пункты меню для заголовка панели в мастере управления
		 отметкой.


		 ![](../../../sub_image.gif)
		 [refreshSelection](dhtmlExpress.chm::/Classes/Express/EaxDimBarMasterPanel/EaxDimBarMasterPanel.refreshSelection.htm)
		 Метод refreshSelection
		 обновляет отметки на панели измерения.


## Свойства, унаследованные от класса [MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [CanDisable](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.CanDisable.htm)
		 Свойство CanDisable
		 определяет, можно ли деактивировать панель мастера.


		 ![](../../../Property_Image.gif)
		 [GroupName](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.GroupName.htm)
		 Свойство GroupName
		 определяет имя группы панелей мастера.


## Методы, унаследованные от класса [MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getContentDomNode](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.getContentDomNode.htm)
		 Метод getContentDomNode
		 возвращает DOM-вершину, в которой содержится панель мастера.


		 ![](../../../sub_image.gif)
		 [isVisible](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.isVisible.htm)
		 Метод isVisible возвращает
		 видимость панели мастера.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.refresh.htm)
		 Метод refresh обновляет
		 панель мастера.


## Свойства, унаследованные от класса [NavigationItem](dhtmlCommon.chm::/Classes/navigationitem/navigationitem.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Caption](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.Caption.htm)
		 Свойство Caption устанавливает
		 и возвращает заголовок вкладки.


		 ![](../../../Property_Image.gif)
		 [HeaderControl](dhtmlCommon.chm::/classes/navigationitem/navigationitem.headercontrol.htm)
		 Свойство HeaderControl
		 устанавливает элемент управления, который отображается в заголовке
		 [вкладки](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.htm).


		 ![](../../../Property_Image.gif)
		 [IsHeaderControlVisible](dhtmlCommon.chm::/classes/navigationitem/navigationitem.isheadercontrolvisible.htm)
		 Свойство IsHeaderControlVisible
		 определяет, отображается ли в заголовке вкладки элемент управления.


		 ![](../../../Property_Image.gif)
		 [Title](dhtmlCommon.chm::/classes/navigationitem/navigationitem.title.htm)
		 Свойство Title устанавливает
		 заголовок вкладки.


## Методы, унаследованные от класса [NavigationItem](dhtmlCommon.chm::/Classes/navigationitem/navigationitem.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [addHeaderClass](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.addHeaderClass.htm)
		 Метод addHeaderClass
		 добавляет css-класс к DOM-вершине вкладки.


		 ![](../../../sub_image.gif)
		 [collapse](dhtmlCommon.chm::/classes/navigationitem/navigationitem.collapse.htm)
		 Метод collapse сворачивает
		 панель.


		 ![](../../../sub_image.gif)
		 [expand](dhtmlCommon.chm::/classes/navigationitem/navigationitem.expand.htm)
		 Метод expand разворачивает
		 панель.


		 ![](../../../sub_image.gif)
		 [getContentSize](dhtmlCommon.chm::/classes/navigationitem/navigationitem.getcontentsize.htm)
		 Метод getContentSize
		 возвращает размеры содержимого панели.


		 ![](../../../sub_image.gif)
		 [getHeightOfCDomNode](dhtmlCommon.chm::/classes/navigationitem/navigationitem.getheightofcdomnode.htm)
		 Метод getHeightOfCDomNode
		 возвращает высоту DOM-вершины вкладки.


		 ![](../../../sub_image.gif)
		 [getIsCollapsed](dhtmlCommon.chm::/classes/navigationitem/navigationitem.getiscollapsed.htm)
		 Метод getIsCollapsed
		 возвращает признак того, что панель закрыта.


		 ![](../../../sub_image.gif)
		 [getIsRendered](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.getIsRendered.htm)
		 Метод getIsRendered
		 возвращает признак отрисовки вкладки.


		 ![](../../../sub_image.gif)
		 [getScrollBox](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.getScrollBox.htm)
		 Метод getScrollBox
		 возвращает область прокрутки вкладки.


		 ![](../../../sub_image.gif)
		 [hideScrolls](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.hideScrolls.htm)
		 Метод hideScrolls скрывает
		 полосы прокрутки вкладки.


		 ![](../../../sub_image.gif)
		 [showScrolls](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.showScrolls.htm)
		 Метод showScrolls отображает
		 полосы прокрутки вкладки.


		 ![](../../../sub_image.gif)
		 [updateScrolls](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.updateScrolls.htm)
		 Метод updateScrolls
		 обновляет полосы прокрутки вкладки.


## События, унаследованные от класса [NavigationItem](dhtmlCommon.chm::/Classes/navigationitem/navigationitem.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [Collapsing](dhtmlCommon.chm::/classes/navigationitem/navigationitem.collapsing.htm)
		 Событие Collapsing наступает
		 при закрытии вкладки.


		 ![](../../../Event_Image.gif)
		 [Disposing](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.Disposing.htm)
		 Событие Disposing наступает
		 после уничтожения вкладки.


		 ![](../../../Event_Image.gif)
		 [EnableChanged](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.EnableChanged.htm)
		 Событие EnableChanged
		 наступает после изменения доступности вкладки.


		 ![](../../../Event_Image.gif)
		 [Expanding](dhtmlCommon.chm::/classes/navigationitem/navigationitem.expanding.htm)
		 Событие Expanding наступает
		 при открытии вкладки.


		 ![](../../../Event_Image.gif)
		 [Toggled](dhtmlCommon.chm::/classes/navigationitem/navigationitem.toggled.htm)
		 Событие Toggled наступает
		 по окончании разворачивания/сворачивания вкладки.


		 ![](../../../Event_Image.gif)
		 [Toggling](dhtmlCommon.chm::/classes/navigationitem/navigationitem.toggling.htm)
		 Событие Toggling наступает
		 при разворачивании и сворачивании вкладки.


		 ![](../../../Event_Image.gif)
		 [VisibleChanged](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.VisibleChanged.htm)
		 Событие VisibleChanged
		 наступает после изменения видимости вкладки.


		 ![](../../../Event_Image.gif)
		 [VisibleChanging](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.VisibleChanging.htm)
		 Событие VisibleChanging
		 наступает во время изменения видимости вкладки.
