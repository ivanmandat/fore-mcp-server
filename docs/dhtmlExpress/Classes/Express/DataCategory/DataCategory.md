...
[DataCatView](../DataCatView/DataCatView.htm)
...
Класс DataCategory реализует вкладку «Данные» на [ленте инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.DataCategory, PP.Exp.Ui.[DataCatView](../DataCatView/DataCatView.htm), "DataCategory");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [DataCategory](dhtmlExpress.chm::/Classes/Express/DataCategory/Constructor_DataCategory.htm)
		 Конструктор DataCategory
		 создает экземпляр класса DataCategory.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Service](dhtmlExpress.chm::/Classes/Express/DataCategory/DataCategory.Service.htm)
		 Свойство Service
		 задает сервис для вкладки «Данные» на ленте инструментов экспресс-отчета.


## Методы, унаследованные от класса [DataCatView](../DataCatView/DataCatView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/DataCatView/DataCatView.refresh.htm)
		 Метод refresh
		  обновляет компонент.


		 ![](../../../sub_image.gif)
		 [getDataEditCancerButton](dhtmlTS.chm::/Classes/TimeSeries/DataCatView/DataCatView.getDataEditCancelButton.htm)
		 Метод getDataEditCancerButton
		 возвращает кнопку «Отменить изменения».


		 ![](../../../sub_image.gif)
		 [getDataEditSaveButton](dhtmlTS.chm::/Classes/TimeSeries/DataCatView/DataCatView.getDataEditSaveButton.htm)
		 Метод getDataEditSaveButton
		 возвращает кнопку «Сохранить изменения».
