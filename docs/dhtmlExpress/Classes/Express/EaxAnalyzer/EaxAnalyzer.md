...
PP.initClass(PP.Exp.EaxAnalyzer, PP.Mb.[Object](dhtmlMetabase.chm::/Classes/Metabase/Object/Object.htm),
 "EaxAnalyzer", PP.Exp.IStatistics);
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [EaxAnalyzer](dhtmlExpress.chm::/Classes\Express\EaxAnalyzer\Constructor_EaxAnalyzer.htm)
				 Конструктор **EaxAnalyzer**
				 создает экземпляр класса **EaxAnalyzer**.
