...
Класс **ParametersDialog** реализует [диалог «Параметры»](../../../Components/Express/ParametersDialog/ParametersDialog.htm) для настройки параметров экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.ParametersDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "ParametersDialog");


## Комментарии


Класс ParametersDialog реализует компонент [ParametersDialog](../../../Components/Express/ParametersDialog/ParametersDialog.htm).
