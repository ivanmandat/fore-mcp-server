...
Класс ChartCatView реализует
 представление вкладки «Диаграмма» [ленты
...
PP.initClass(PP.Exp.Ui.ChartCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm),
 "ChartCatView");
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [ChartCatView](dhtmlExpress.chm::/classes/express/chartcatview/constructor_chartcatview.htm)
				 Конструктор ChartCatView
				 создает экземпляр класса ChartCatView.
