...
[EaxMapView](../EaxMapView/EaxMapView.htm)
...
Класс EaxMapBox представляет собой [контейнер для карты экспресс-отчета](../../../Components/Express/EaxMapBox/EaxMapBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxMapBox, PP.Exp.Ui.[EaxMapView](../EaxMapView/EaxMapView.htm), "EaxMapBox");
...
## Свойства, унаследованные от класса [EaxMapView](../EaxMapView/EaxMapView.htm)
...
## Методы, унаследованные от класса [EaxMapView](../EaxMapView/EaxMapView.htm)
...
## События, унаследованные от класса [EaxMapView](../EaxMapView/EaxMapView.htm)
