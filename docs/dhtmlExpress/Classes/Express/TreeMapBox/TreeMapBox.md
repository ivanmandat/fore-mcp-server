# TreeMapBox: класс DHTML-компонента
...
Класс TreeMapBox реализует [контейнер для плоского дерева](TreeMapBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.TreeMapBox, [[PP.Ui.SourceView](dhtmlUi.chm::/Classes/SourceView/SourceView.htm), PP.Ui.BaseMView, PP.Exp.Ui.EaxStatisticsMixin], "PP.Exp.Ui.TreeMapBox", [PP.Exp.Ui.IEaxTreeMapView]);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TreeMapBox](dhtmlExpress.chm::/Classes/Express/TreeMapBox/Constructor_TreeMapBox.htm)
		 Конструктор TreeMapBox
		 создаёт экземпляр компонента [TreeMapBox](dhtmlExpress.chm::/Components/Express/TreeMapBox/TreeMapBox.htm).
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [LegendPosition](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.LegendPosition.htm)
		 Свойство LegendPosition
		 определяет расположение легенды плоского дерева.


		 ![](../../../Property_Image.gif)
		 [Service](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.Service.htm)
		 Метод Service определяет
		 сервис для работы с контейнером плоского дерева.


		 ![](../../../Property_Image.gif)
		 [StatisticsWindow](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.StatisticsWindow.htm)
		 Свойство StatisticsWindow
		 определяет для контейнера плоского дерева окно «Статистические
		 характеристики».
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [clearInstance](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.clearInstance.htm)
		 Метод clearInstance
		 удаляет плоское дерево из контейнера.


		 ![](../../../sub_image.gif)
		 [getInstance](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.getInstance.htm)
		 Метод getInstance возвращает
		 экземпляр плоского дерева.


		 ![](../../../sub_image.gif)
		 [getLegends](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.getLegends.htm)
		 Метод getLegends возвращает
		 объект с легендами плоского дерева.


		 ![](../../../sub_image.gif)
		 [getSizeVisual](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.getSizeVisual.htm)
		 Метод getSizeVisual
		 возвращает настройки сопоставления данных контейнера плоского
		 дерева размерам его элементов.


		 ![](../../../sub_image.gif)
		 [getState](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.getState.htm)
		 Метод getState возвращает
		 настройки контейнера для плоского дерева.


		 ![](../../../sub_image.gif)
		 [isLoaded](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.isLoaded.htm)
		 Метод isLoaded определяет,
		 загружен ли контейнер для плоского дерева.


		 ![](../../../sub_image.gif)
		 [refreshView](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.refreshView.htm)
		 Метод refreshView обновляет
		 контейнер для плоского дерева в соответствии с указанными настройками.


		 ![](../../../sub_image.gif)
		 [showStatisticsWindow](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.showStatisticsWindow.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Refreshed](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.Refreshed.htm)
		 Событие Refreshed генерируется
		 после обновления контейнера для плоского дерева.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlExpress.chm::/Classes/Express/TreeMapBox/TreeMapBox.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при запросе метаданных для контейнера плоского дерева.
