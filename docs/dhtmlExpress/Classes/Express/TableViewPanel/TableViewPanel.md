...
Класс TableViewPanel реализует вкладку «Вид», входящую в состав [панели свойств экспресс-отчета](../../../Components/Express/EaxPropertyBar/EaxPropertyBar.htm).


## Комментарии


Вкладка «Вид», реализуемая классом TableViewPanel, может выглядеть следующим образом:
...
PP.initClass(PP.Exp.Ui.TableViewPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "TableViewPanel");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TableViewPanel](dhtmlExpress.chm::/classes/express/tableviewpanel/constructor_tableviewpanel.htm)
		 Конструктор TableViewPanel
		 создает экземпляр класса TableViewPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes/express/tableviewpanel/tableviewpanel.source.htm)
		 Свойство Source
		 определяет источник данных для вкладки "Вид".
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getAutoFitState](dhtmlExpress.chm::/classes/express/tableviewpanel/tableviewpanel.getautofitstate.htm)
		 Метод getAutoFitState
		 возвращает состояние элемента управления "Автоподгонка ячеек"
		 на панели.


		 ![](../../../sub_image.gif)
		 [getHeadersState](dhtmlExpress.chm::/classes/express/tableviewpanel/tableviewpanel.getheadersstate.htm)
		 Метод getHeadersState
		 возвращает состояние элемента управления "Разметка (заголовки
		 столбцов и строк)" на панели.


		 ![](../../../sub_image.gif)
		 [getHierarchiesState](dhtmlExpress.chm::/classes/express/tableviewpanel/tableviewpanel.gethierarchiesstate.htm)
		 Метод getHierarchiesState
		 возвращает состояние элемента управления "Отображение иерархий"
		 на панели.


		 ![](../../../sub_image.gif)
		 [getSortingState](dhtmlExpress.chm::/classes/express/tableviewpanel/tableviewpanel.getsortingstate.htm)
		 Метод getSortingState
		 возвращает состояние элемента управления "Способ сортировки"
		 на панели.


		 ![](../../../sub_image.gif)
		 [getTableStyleState](dhtmlExpress.chm::/classes/express/tableviewpanel/tableviewpanel.gettablestylestate.htm)
		 Метод getTableStyleState
		 возвращает состояние элемента управления "Стиль оформления"
		 на панели.
