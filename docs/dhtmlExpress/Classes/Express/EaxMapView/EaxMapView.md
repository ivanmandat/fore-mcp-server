...
Класс EaxMapView реализует представление [контейнера карты экспресс-отчета](../../../Components/Express/EaxMapBox/EaxMapBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxMapView, [PP.Ui.SourceView, PP.Ui.BaseMView, PP.Exp.Ui.EaxStatisticsMixin], "EaxMapView", [PP.Exp.Ui.IEaxMapView]);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxMapView](dhtmlExpress.chm::/Classes/Express/EaxMapView/Constructor_EaxMapView.htm)
		 Конструктор EaxMapView
		 создает экземпляр класса EaxMapView.
