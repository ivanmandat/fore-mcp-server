...
Класс AnalysisPanel реализует
 панель «Анализ», входящую в состав [панели
 свойств](../../../Components/Express/EaxPropertyBar/EaxPropertyBar.htm) экспресс-отчета.


## Комментарий


Панель «Анализ», реализуемая классом AnalysisPanel,
...
PP.initClass(PP.Exp.Ui.AnalysisPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "AnalysisPanel");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [AnalysisPanel](dhtmlExpress.chm::/classes\express\analysispanel\constructor_analysispanel.htm)
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/Classes/Express/AnalysisPanel/AnalysisPanel.Source.htm)
		 Свойство Source
		 определяет источник данных для панели анализа.
