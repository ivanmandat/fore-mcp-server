...
Класс StatisticsWindow
 реализует окно [диалога
 «Статистические характеристики»](../../../Components/Express/StatisticsWindow/StatisticsWindow.htm), отображающего дерево со статистическими
 характеристиками данных экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.StatisticsWindow, PP.Ui.[Window](dhtmlUi.chm::/Components/Window/Window.htm),
 "StatisticsWindow", PP.IView);


## Комментарии


Класс StatisticsWindow реализует
 компонент [StatisticsWindow](../../../Components/Express/StatisticsWindow/StatisticsWindow.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [StatisticsWindow](dhtmlExpress.chm::/classes/express/statisticswindow/constructor_statisticswindow.htm)
		 Конструктор StatisticsWindow
		 создает экземпляр компонента StatisticsWindow.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/classes/express/statisticswindow/statisticswindow.refresh.htm)
		 Метод refresh
		 обновляет окно диалога «Статистические характеристики», отображающего
		 дерево со статистическими характеристиками данных экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/classes/express/statisticswindow/statisticswindow.refreshall.htm)
		 Метод refreshAll
		 обновляет все содержимое окна диалога «Статистические характеристики»,
		 отображающего дерево со статистическими характеристиками данных
		 экспресс-отчета.
