...
Класс **EaxGridView** реализует
 представление контейнера для [электронной
 таблицы](../../../Components/Express/EaxGrid/EaxGrid.htm) в рабочей области экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxGridView, [[PP.Mb.Ui.GridView](dhtmlMetabase.chm::/Classes/Metabase/GridView/GridView.htm),
 PP.Exp.Ui.EaxStatisticsMixin], "PP.Exp.Ui.EaxGridView", [PP.Exp.Ui.IEaxGridView]);
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [EaxGridView](dhtmlExpress.chm::/classes\express\eaxgridview\constructor_eaxgridview.htm)
				 Конструктор **EaxGridView**
				 создает экземпляр класса **EaxGridView**.
