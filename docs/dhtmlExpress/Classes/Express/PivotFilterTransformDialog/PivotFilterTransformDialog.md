...
Класс PivotFilterTransformDialog
 реализует панель компонента [TransformDialog](dhtmlUfe.chm::/Components/TransformDialog/TransformDialog.htm),
 представляющий собой окно для создания и редактирования формул
 фильтрации.
...
PP.initClass(PP.Exp.Ui.PivotFilterTransformDialog,
 PP.Ui.Panel, "PP.Exp.Ui.PivotFilterTransformDialog");
...
Класс PivotFilterTransformDialog
 реализует диалог фильтрации по формуле.


В веб-приложении использование фильтрации по формуле доступно без возможности
 редактирования формулы и задания [фильтрации](UiAnalyticalArea.chm::/Working_with_table_data/Filtering.htm)
 через флажок «Скрывать по формуле».
 Все настройки передаются из настольного приложения. Если задать фильтрацию
 по формуле в настольном приложении, то в веб-приложении можно только снять
 флажок «Скрывать по формуле».
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [PivotFilterTransformDialog](Constructor_PivotFilterTransformDialog.htm)
		 Конструктор PivotFilterTransformDialog
		 создает экземпляр класса PivotFilterTransformDialog.
