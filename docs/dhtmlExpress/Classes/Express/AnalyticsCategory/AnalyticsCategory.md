...
[AnalyticsCatView](../AnalyticsCatView/AnalyticsCatView.htm)
...
Класс AnalyticsCatView реализует
 вкладку «Расширенная аналитика» [ленты
...
PP.initClass(PP.Exp.Ui.AnalyticsCategory, PP.Exp.Ui.[AnalyticsCatView](../AnalyticsCatView/AnalyticsCatView.htm),
 "AnalyticsCategory");
...
Класс можно получить используя метод [getAnalyticsCategory](../EaxRibbonView/EaxRibbonView.getAnalyticsCategory.htm)
 класса [EaxRibbon](../EaxRibbon/EaxRibbon.htm).
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 AnalyticsCategory
				 Конструктор AnalyticsCategory
				 создает экземпляр класса AnalyticsCategory.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getLegendButton](../AnalyticsCatView/AnalyticsCatView.getLegendButton.htm)
		 Метод getLegendButton
		 возвращает кнопку легенды валидаций.


		 ![](../../../sub_image.gif)
		 [setPropertyValue](../AnalyticsCatView/AnalyticsCatView.setPropertyValue.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ModelingGenerated](../AnalyticsCatView/AnalyticsCatView.ModelingGenerated.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [OnGetDataMiningResult](../AnalyticsCatView/AnalyticsCatView.OnGetDataMiningResult.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [TimeSeriesGenerated](../AnalyticsCatView/AnalyticsCatView.TimeSeriesGenerated.htm)
