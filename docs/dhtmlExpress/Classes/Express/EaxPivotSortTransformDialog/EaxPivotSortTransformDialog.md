...
[Descriptor](dhtmlMetabase.chm::/Classes/Metabase/Descriptor/Descriptor.htm)


[PP.Mb.Object](dhtmlMetabase.chm::/Classes/Metabase/Object/Object.htm)


[EaxAnalyzer](../EaxAnalyzer/EaxAnalyzer.htm)
...
Класс EaxPivotSortTransformDialog
 реализует диалог сортировки таблицы экспресс-отчета по формуле.
...
Класс EaxPivotSortTransformDialog
 реализует окно «[Редактор выражения](UiNav.chm::/GUI/ExpressionEditor.htm)»
 для редактирования [сортировки](UiAnalyticalArea.chm::/Working_with_table_data/Sorting_table_data.htm)
 таблицы «По формуле».
...
PP.initClass(PP.Exp.EaxPivotSortTransformDialog,
 PPP.Exp.Ui.EaxDimTransformDialog, "EaxPivotSortTransformDialog");
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [EaxPivotSortTransformDialog](Constructor_EaxPivotSortTransformDialog.htm)
				 Конструктор **EaxPivotSortTransformDialog**
				 создает экземпляр класса **EaxPivotSortTransformDialog**.


## Свойства, унаследованные от класса [EaxAnalyzer](../EaxAnalyzer/EaxAnalyzer.htm)
...
## Методы, унаследованные от класса [EaxAnalyzer](../EaxAnalyzer/EaxAnalyzer.htm)
