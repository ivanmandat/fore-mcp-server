...
Класс EaxDimBarMasterPanel
 реализует панель измерения в [мастере
...
Панель измерения, расположенная в [мастере
 управления отметкой](../../../Components/Express/EaxDimBarMaster/EaxDimBarMaster.htm) и реализованная классом EaxDimBarMasterPanel,
 может выглядеть следующим образом (на примере территориального измерения):
...
PP.initClass(PP.Exp.Ui.EaxDimBarMasterPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "EaxDimBarMasterPanel");
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [EaxDimBarMasterPanel](dhtmlExpress.chm::/classes/express/eaxdimbarmasterpanel/constructor_eaxdimbarmasterpanel.htm)
				 Конструктор EaxDimBarMasterPanel
				 создает экземпляр класса EaxDimBarMasterPanel.
