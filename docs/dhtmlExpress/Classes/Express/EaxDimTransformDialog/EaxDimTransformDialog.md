...
Класс EaxDimTransformDialog реализует
 компонент [TransformDialog](dhtmlUfe.chm::/Components/TransformDialog/TransformDialog.htm),
 представляющий собой окно для создания и редактирования формулы
 элемента измерения экспресс-отчёта.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxDimTransformDialog, PP.Ui.Panel,
 "PP.Exp.Ui.EaxDimTransformDialog");
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [TransformDialog](dhtmlUfe.chm::/Classes/PP_Ufe_Ui/TransformDialog/Constructor_TransformDialog.htm)
			 Конструктор TransformDialog
			 создаёт экземпляр компонента TransformDialog.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getTransformationsText](EaxDimTransformDialog.getTransformationsText.htm)
