# BubbleTreeBox: класс DHTML-компонента
...
Класс BubbleTreeBox реализует
 [контейнер
 для пузырькового дерева](../../../Components/Express/BubbleTreeBox/BubbleTreeBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.BubbleTreeBox, [[PP.Ui.SourceView](dhtmlUi.chm::/Classes/SourceView/SourceView.htm),
 PP.Ui.BaseMView, PP.Exp.Ui.EaxStatisticsMixin], "PP.Exp.Ui.BubbleTreeBox",
 [PP.Exp.Ui.IEaxBubbleTreeView]);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [BubbleTreeBox](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/Constructor_BubbleTreeBox.htm)
		 Конструктор BubbleTreeBox
		 создаёт экземпляр компонента [BubbleTreeBox](dhtmlExpress.chm::/Components/Express/BubbleTreeBox/BubbleTreeBox.htm).
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [LegendPosition](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.LegendPosition.htm)
		 Свойство LegendPosition
		 определяет расположение легенды пузырькового дерева.


		 ![](../../../Property_Image.gif)
		 [Service](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.Service.htm)
		 Свойство Service определяет
		 сервис для работы с контейнером пузырькового дерева.


		 ![](../../../Property_Image.gif)
		 [StatisticsWindow](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.StatisticsWindow.htm)
		 Свойство StatisticsWindow
		 определяет для контейнера пузырькового дерева окно «Статистические
		 характеристики».
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [clearInstance](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.clearInstance.htm)
		 Метод clearInstance
		 удаляет пузырьковое дерево из контейнера.


		 ![](../../../sub_image.gif)
		 [getAreMetricsOn](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.getAreMetricsOn.htm)
		 Метод getAreMetricsOn
		 определяет наличие измерения метрик у визуализатора.


		 ![](../../../sub_image.gif)
		 [getInstance](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.getInstance.htm)
		 Метод getInstance возвращает
		 экземпляр пузырькового дерева.


		 ![](../../../sub_image.gif)
		 [getLegends](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.getLegends.htm)
		 Метод getLegends возвращает
		 объект с легендами пузырькового дерева.


		 ![](../../../sub_image.gif)
		 [getSizeVisual](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.getSizeVisual.htm)
		 Метод getSizeVisual
		 возвращает настройки сопоставления данных контейнера пузырькового
		 дерева размерам его элементов.


		 ![](../../../sub_image.gif)
		 [getState](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.getState.htm)
		 Метод getState возвращает
		 настройки контейнера для пузырькового дерева.


		 ![](../../../sub_image.gif)
		 [isLoaded](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.isLoaded.htm)
		 Метод isLoaded определяет,
		 загружен ли контейнер для пузырькового дерева.


		 ![](../../../sub_image.gif)
		 [refreshView](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.refreshView.htm)
		 Метод refreshView обновляет
		 контейнер для пузырькового дерева в соответствии с указанными
		 настройками.


		 ![](../../../sub_image.gif)
		 [showStatisticsWindow](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.showStatisticsWindow.htm)
		 Метод showStatisticsWindow
		 отображает окно «Статистические характеристики».
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Refreshed](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.Refreshed.htm)
		 Событие Refreshed генерируется
		 после обновления контейнера для пузырькового дерева.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlExpress.chm::/Classes/Express/BubbleTreeBox/BubbleTreeBox.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при запросе метаданных для контейнера пузырькового
		 дерева.
