...
[EaxGridView](../EaxGridView/EaxGridView.htm)
...
Класс EaxGrid реализует
 контейнер для [электронной
...
PP.initClass(PP.Exp.Ui.EaxGrid, [PP.Exp.Ui.EaxGridView](../EaxGridView/EaxGridView.htm),
 "EaxGrid");
...
## Свойства, унаследованные от класса [EaxGridView](../EaxGridView/EaxGridView.htm)
...
## Методы, унаследованные от класса [EaxGridView](../EaxGridView/EaxGridView.htm)
...
## События, унаследованные от класса [EaxGridView](../EaxGridView/EaxGridView.htm)
