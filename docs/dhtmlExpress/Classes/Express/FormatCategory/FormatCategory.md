...
[FormatCatView](../FormatCatView/FormatCatView.htm)
...
Класс FormatCategory реализует
 вкладку «Формат» [ленты
...
PP.initClass(PP.Exp.Ui.FormatCategory, PP.Exp.Ui.[FormatCatView](../FormatCatView/FormatCatView.htm), "FormatCategory");


## Комментарии


Вкладка ленты инструментов «Формат» доступна, если активна таблица.
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [FormatCategory](Constructor_FormatCategory.htm)
				 Конструктор FormatCategory
				 создает экземпляр класса FormatCategory.


## Методы, унаследованные от класса [FormatCatView](../FormatCatView/FormatCatView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getBordersAndFillColorControls](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.getBordersAndFillColorControls.htm)
		 Метод getBordersAndFillColorControls
		 возвращает панель с элементами управления границей и заливкой.


		 ![](../../../sub_image.gif)
		 [getContentRendered](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.getContentRendered.htm)
		 Метод getContentRendered
		 возвращает признак отрисовки содержимого вкладки «Формат».


		 ![](../../../sub_image.gif)
		 [getCurrentFormatControls](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.getCurrentFormatControls.htm)
		 Метод getCurrentFormatControls
		 возвращает раскрывающийся список выбора элемента таблицы и кнопку
		 «формат».


		 ![](../../../sub_image.gif)
		 [getFontBox](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.getFontBox.htm)
		 Метод getFontBox возвращает
		 элемент управления настройками текста.


		 ![](../../../sub_image.gif)
		 [getSelectPartCombo](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.getSelectPartCombo.htm)
		 Метод getSelectPartCombo
		 возвращает раскрывающийся список выбора элемента таблицы.


		 ![](../../../sub_image.gif)
		 [getSlaveCategoriesPanels](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.getSlaveCategoriesPanels.htm)
		 Метод getSlaveCategoriesPanels
		 возвращает дочерние панели вкладки «Конструктор».


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.refresh.htm)
		 Метод **refresh**
		 обновляет данные вкладки «Формат» на ленте инструментов экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshTextNBordersNFillColor](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.refreshTextNBordersNFillColor.htm)
		 Метод refreshTextNBordersNFillColor
		 устанавливает актуальные значения элементам управления границей
		 и заливкой.


		 ![](../../../sub_image.gif)
		 [renderContent](dhtmlExpress.chm::/Classes/Express/FormatCatView/FormatCatView.renderContent.htm)
		 Метод renderContent
