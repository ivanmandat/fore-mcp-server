...
Класс DataCatView реализует представление вкладки «Данные» [ленты инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.DataCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm), "DataCatView");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [DataCatView](dhtmlExpress.chm::/classes/express/DataCatView/constructor_DataCatView.htm)
		 Конструктор DataCatView
		 создает экземпляр класса DataCatView.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getContentRendered](dhtmlExpress.chm::/Classes/Express/DataCatView/DataCatView.getContentRendered.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/DataCatView/DataCatView.refresh.htm)
		 Метод refresh
		 обновляет представление вкладки «Данные» на ленте инструментов
		 экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [renderContent](dhtmlExpress.chm::/Classes/Express/DataCatView/DataCatView.renderContent.htm)
		 Метод renderContent
		 отрисовывает элементы вкладки ленты инструментов «Данные».


		 ![](../../../sub_image.gif)
		 [setEnabledSaveButton](dhtmlExpress.chm::/Classes/Express/DataCatView/DataCatView.setEnabledSaveButton.htm)
		 Метод setEnabledSaveButton
		 управляет доступностью кнопок из группы «Данные» на одноименной
		 вкладке ленты инструментов экспресс-отчёта.
