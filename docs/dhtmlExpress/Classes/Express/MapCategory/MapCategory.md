...
[MapCatView](../MapCatView/MapCatView.htm)
...
Класс MapCategory реализует вкладку «Карта» на [ленте инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.MapCategory, PP.Exp.Ui.[MapCatView](../MapCatView/MapCatView.htm) , "MapCategory", [PP.Ui.IPropertyView]);


## Комментарии


Вкладка ленты инструментов «Карта» доступна, если активна карта.
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [MapCategory](dhtmlExpress.chm::/Classes/Express/MapCategory/Constructor_MapCategory.htm)
		 Конструктор MapCategory
		 создает экземпляр класса MapCategory.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Service](dhtmlExpress.chm::/Classes/Express/MapCategory/MapCategory.Service.htm)
		 Свойство Service
		 задает сервис для вкладки «Карта» на ленте инструментов экспресс-отчета.


## Свойства, унаследованные от класса [MapCatView](../MapCatView/MapCatView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Options](dhtmlExpress.chm::/Classes/Express/MapCatView/MapCatView.Options.htm)
		 Свойство Options
		 задает настройки для вкладки «Карта» на ленте инструментов экспресс-отчета.


## Методы, унаследованные от класса [MapCatView](../MapCatView/MapCatView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/MapCatView/MapCatView.refresh.htm)
		 Метод refresh
		 обновляет вкладку «Карта» на ленте инструментов экспресс-отчета.
