...
Класс EaxDimBarPrivateMP
 реализует панель частных измерений в [мастере
 управления отметкой](../../../Components/Express/EaxDimBarMaster/EaxDimBarMaster.htm).


## Комментарии


Панель частных измерений, реализованная классом EaxDimBarPrivateMP
 доступна, когда для экспресс-отчёта задано несколько источников данных.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxDimBarPrivateMP, PP.Exp.Ui.[EaxDimBarMasterPanel](../EaxDimBarMasterPanel/EaxDimBarMasterPanel.htm),
 "EaxDimBarPrivateMP");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxDimBarPrivateMP](dhtmlExpress.chm::/classes/express/eaxdimbarprivatemp/constructor_eaxdimbarprivatemp.htm)
		 Конструктор EaxDimBarPrivateMP
		 создает экземпляр класса EaxDimBarPrivateMP.
...
## Методы
		 ...
		 ![](../../../Property_Image.gif)
		 [getFixedDims](dhtmlExpress.chm::/Classes/Express/EaxDimBarPrivateMP/EaxDimBarPrivateMP.getFixedDims.htm)
		 Метод getFixedDims
		 возвращает массив частных измерений в мастере управления отметкой,
		 которые могут быть вынесены в общие измерения.
