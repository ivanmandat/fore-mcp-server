...
[TitleCatView](../TitleCatView/TitleCatView.htm)
...
Класс TitleCategory реализует вкладку «Заголовок» на [ленте инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.TitleCategory, PP.Exp.Ui.[TitleCatView](../TitleCatView/TitleCatView.htm), "TitleCategory");


## Комментарии


Вкладка ленты инструментов «Заголовок» доступна, если активен заголовок экспресс-отчета.
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TitleCategory](dhtmlExpress.chm::/Classes/Express/TitleCategory/Constructor_TitleCategory.htm)
		 Конструктор TitleCategory
		 создает экземпляр класса TitleCategory.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Service](dhtmlExpress.chm::/Classes/Express/TitleCategory/TitleCategory.Service.htm)
		 Свойство Service
		 задает сервис для вкладки «Заголовок» на ленте инструментов экспресс-отчета.


## События


## Методы, унаследованные от класса [TitleCatView](../TitleCatView/TitleCatView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getContentRendered](dhtmlExpress.chm::/Classes/Express/TitleCatView/TitleCatView.getContentRendered.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getDimSelTitleMenu](dhtmlExpress.chm::/Classes/Express/TitleCatView/TitleCatView.getDimSelTitleMenu.htm)
		 Метод getDimSelTitleMenu
		 возвращает меню кнопки «Отметка по измерению» вкладки ленты инструментов
		 «Заголовок».


		 ![](../../../sub_image.gif)
		 [getInsertDateTimeMenu](dhtmlExpress.chm::/Classes/Express/TitleCatView/TitleCatView.getInsertDateTimeMenu.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/TitleCatView/TitleCatView.refresh.htm)
		 Метод refresh
		 обновляет вкладку ленты инструментов «Заголовок» экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [renderContent](dhtmlExpress.chm::/Classes/Express/TitleCatView/TitleCatView.renderContent.htm)
		 Метод renderContent
		 отрисовывает элементы вкладки ленты инструментов «Заголовок».
