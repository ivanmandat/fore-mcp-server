...
[TableCatView](../TableCatView/TableCatView.htm)
...
Класс TableCategory реализует вкладку «Таблица» на [ленте инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.TableCategory, PP.Exp.Ui.[TableCatView](../TableCatView/TableCatView.htm), "TableCategory");


## Комментарии


Вкладка ленты инструментов «Таблица» доступна, если активна таблица.
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TableCategory](dhtmlExpress.chm::/Classes/Express/TableCategory/Constructor_TableCategory.htm)
		 Конструктор TableCategory
		 создает экземпляр класса TableCategory.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Service](dhtmlExpress.chm::/Classes/Express/TableCategory/TableCategory.Service.htm)
		 Свойство Service
		 задает сервис для вкладки «Таблица» на ленте инструментов экспресс-отчета.


## Методы, унаследованные от класса [TableCatView](../TableCatView/TableCatView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getStyleListBoxItems](dhtmlTS.chm::/Classes/TimeSeries/TableCatView/TableCatView.getStyleListBoxItems.htm)
		 Метод getTableStyleListBoxItems
		 возвращает список стилей ячейки на вкладке ленты инструментов
		 «Таблица».


		 ![](../../../sub_image.gif)
		 [getTableAnalysisButtonAngle](dhtmlTS.chm::/Classes/TimeSeries/TableCatView/TableCatView.getTableAnalysisButtonAngle.htm)
		 Метод getTableAnalysisButtonAngle
		 возвращает кнопку «Поворот таблицы» на ленте инструментов рабочей
		 книги.


		 ![](../../../sub_image.gif)
		 [getTableAnalysisButtonLayout](dhtmlTS.chm::/Classes/TimeSeries/TableCatView/TableCatView.getTableAnalysisButtonLayout.htm)
		 Метод getTableAnalysisButtonLayout
		 возвращает кнопку «Разметка» на ленте инструментов рабочей
		 книги.


		 ![](../../../sub_image.gif)
		 [getTableCondFormatButton](dhtmlTS.chm::/Classes/TimeSeries/TableCatView/TableCatView.getTableCondFormatButton.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getTableStyleState](dhtmlTS.chm::/Classes/TimeSeries/TableCatView/TableCatView.getTableStyleState.htm)
		 Метод getTableStyleState возвращает
		 текущие настройки стиля таблицы в рабочей книге.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/TableCatView/TableCatView.refresh.htm)
		 Метод refresh обновляет вкладку «Таблица» на ленте
		 инструментов рабочей книги.


		 ![](../../../sub_image.gif)
		 [renderContent](dhtmlTS.chm::/Classes/TimeSeries/TableCatView/TableCatView.renderContent.htm)
		 Метод renderContent отрисовывает
		 элементы вкладки «Таблица» на ленте инструментов рабочей книги.
