...
Класс EaxParameterView
 реализует представление [контейнера
...
PP.initClass(PP.Exp.Ui.EaxParameterView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "EaxParameterView");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxParameterView](dhtmlExpress.chm::/Classes/Express/EaxParameterView/Constructor_EaxParameterView.htm)
		 Конструктор EaxParameterView
		 создает экземпляр класса EaxParameterView
		 .
