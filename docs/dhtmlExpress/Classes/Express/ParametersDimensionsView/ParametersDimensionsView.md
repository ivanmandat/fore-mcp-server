...
Класс ParametersDimensionsView реализует [вкладку «Измерения»](../../../Components/Express/ParametersDimensionsView/ParametersDimensionsView.htm) у [диалога «Параметры»](../../../Components/Express/ParametersDialog/ParametersDialog.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.ParametersDimensionsView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "ParametersDimensionsView", PP.IView);


## Комментарии


Класс ParametersDimensionsView реализует компонент [ParametersDimensionsView](../../../Components/Express/ParametersDimensionsView/ParametersDimensionsView.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ParametersDimensionsView](dhtmlExpress.chm::/classes/express/parametersdimensionsview/constructor_parametersdimensionsview.htm)
		 Конструктор ParametersDimensionsView
		 создает экземпляр класса ParametersDimensionsView.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [GroupName](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.groupname.htm)
		 Свойство GroupName
		 устанавливает название группы, к которой относится вкладка «Измерения»
		 у диалога «Параметры».


		 ![](../../../Property_Image.gif)
		 [Name](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.name.htm)
		 Свойство Name
		 устанавливает новое название для вкладки «Измерения» у диалога
		 «Параметры».
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getCurrentState](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.getcurrentstate.htm)
		 Метод getCurrentState
		 возвращает текущее состояние настроек вкладки «Измерения» у диалога
		 «Параметры».


		 ![](../../../sub_image.gif)
		 [getInitState](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.getinitstate.htm)
		 Метод getInitState
		 возвращает начальное состояние настроек вкладки «Измерения» у
		 диалога «Параметры».


		 ![](../../../sub_image.gif)
		 **[getPropChangedObjects](dhtmlExpress.chm::/Classes/Express/ParametersDataSource/ParametersDataSource.getPropChangedObjects.htm)**
		 Метод getPropChangedObjects
		 возвращает изменения вкладки «Измерения» у диалога «Параметры».


		 ![](../../../sub_image.gif)
		 [getSectionId](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.getsectionid.htm)
		 Метод getSectionId
		 возвращает ключ вкладки «Измерения» у диалога «Параметры».


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.refresh.htm)
		 Метод refresh
		 обновляет вкладку «Измерения» у диалога «Параметры».


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.refreshall.htm)
		 Метод refreshAll
		 обновляет все содержимое вкладки «Измерения» у диалога «Параметры».


		 ![](../../../sub_image.gif)
		 [setSource](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.setsource.htm)
		 Метод setSource
		 устанавливает источник данных для компонента.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ControlChanged](dhtmlExpress.chm::/classes/express/parametersdimensionsview/parametersdimensionsview.controlchanged.htm)
		 Событие ControlChanged
		 наступает при изменении свойств компонента.
