...
Класс **ChartMarkerMenu**
 реализует меню, которое вызывается при нажатии на кнопку «Маркеры» на
 вкладке ленты инструментов «Диаграмма».


## Синтаксис


PP.initClass(PP.Exp.Ui.ChartMarkerMenu, PP.Ui.[Menu](dhtmlUi.chm::/Classes/Menu/Menu.htm),
 "PP.Exp.Ui.ChartMarkerMenu");
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Marker](dhtmlExpress.chm::/Classes/Express/ChartMarkerMenu/ChartMarkerMenu.Marker.htm)
		 Свойство Marker определяет
		 типа маркера, выбранного в меню.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [clearSelection](dhtmlExpress.chm::/Classes/Express/ChartMarkerMenu/ChartMarkerMenu.clearSelection.htm)
		 Метод clearSelection
		 обнуляет выбор элемента в меню кнопки «Маркеры».


		 ![](../../../sub_image.gif)
		 [getChartMarkerListBox](dhtmlExpress.chm::/Classes/Express/ChartMarkerMenu/ChartMarkerMenu.getChartMarkerListBox.htm)
		 Метод getChartMarkerListBox
		 возвращает список доступных маркеров.


		 ![](../../../sub_image.gif)
		 [getSelectedIndex](dhtmlExpress.chm::/Classes/Express/ChartMarkerMenu/ChartMarkerMenu.getSelectedIndex.htm)
		 Метод getSelectedIndex
		 возвращает индекс выбранного в меню маркера.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [MarkerChanged](dhtmlExpress.chm::/Classes/Express/ChartMarkerMenu/ChartMarkerMenu.MarkerChanged.htm)
		 Событие Marker**Changed**
		 наступает при изменении типа маркера.
