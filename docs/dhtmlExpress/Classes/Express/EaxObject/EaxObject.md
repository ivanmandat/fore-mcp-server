...
Класс EaxObject реализует базовый
 класс визуальных объектов [экспресс-отчета](../../../Components/Express/ExpressBox/ExpressBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxObject, [[PP.Mb.Ui.SourceView](dhtmlUi.chm::/Classes/SourceView/SourceView.htm),
 PP.Mb.Ui.BaseMView, PP.Exp.Ui.EaxStatisticsMixin], "EaxObject",
 [PP.Exp.Ui.IEaxObject]);
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getDVSynchronizable](dhtmlExpress.chm::/Classes/Express/EaxObject/EaxObject.getDVSynchronizable.htm)
		 Метод getDVSynchronizable
		 содержит отсылку на экземпляр визуализатора экспресс-отчета.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [SelectionChanged](dhtmlExpress.chm::/Classes/Express/EaxObject/EaxObject.SelectionChanged.htm)
		 Событие SelectionChanged
		 наступает после изменения выделения элементов визуализатора экспресс-отчета.
