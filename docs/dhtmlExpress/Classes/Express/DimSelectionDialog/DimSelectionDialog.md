...
Класс DimSelectionDialog реализует
 диалог для отображения и изменения текущей отметки.


## Синтаксис


PP.initClass(PP.Exp.Ui.DimSelectionDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "DimSelectionDialog");
...
Класс DimSelectionDialog реализует
 компонент [DimSelectionDialog](../../../Components/Express/DimSelectionDialog/DimSelectionDialog.htm).
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [DimSelectionDialog](Constructor_DimSelectionDialog.htm)
