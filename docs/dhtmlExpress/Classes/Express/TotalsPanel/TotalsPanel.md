...
Класс TotalsPanel реализует вкладку «Итоги», входящую в состав [панели свойств](../../../Components/Express/EaxPropertyBar/EaxPropertyBar.htm) экспресс-отчета.


## Комментарии


Вкладка «Итоги», которую реализует класс TotalsPanel, может выглядеть следующим образом:
...
PP.initClass(PP.Exp.Ui.TotalsPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "TotalsPanel");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TotalsPanel](dhtmlExpress.chm::/classes/express/totalspanel/constructor_totalspanel.htm)
		 Конструктор TotalsPanel
		 создает экземпляр класса TotalsPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes/express/totalspanel/totalspanel.source.htm)
		 Свойство Source
		 определяет источник данных для панели.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getState](dhtmlExpress.chm::/classes/express/totalspanel/totalspanel.getstate.htm)
		 Метод getState
		 возвращает объект со значениями элементов управления типа "флажок"
		 на вкладке "Итоги" в json-формате.
