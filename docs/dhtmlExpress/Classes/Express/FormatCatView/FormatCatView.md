...
Класс FormatCatView реализует
 представление вкладки «Формат» [ленты
...
PP.initClass(PP.Exp.Ui.FormatCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm),
 "FormatCatView");
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [FormatCatView](Constructor_FormatCatView.htm)
				 Конструктор FormatCatView
				 создает экземпляр класса FormatCatView.
