...
[ChartCatView](../ChartCatView/ChartCatView.htm)
...
PP.initClass(PP.Exp.Ui.ChartCategory, PP.Exp.Ui.[ChartCatView](../ChartCatView/ChartCatView.htm), "ChartCategory",
 [PP.Ui.IPropertyView]);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ChartCategory](dhtmlExpress.chm::/classes\express\chartcategory\constructor_chartcategory.htm)
...
## Методы, унаследованные от класса [ChartCatView](../ChartCatView/ChartCatView.htm)
...
## События, унаследованные от класса [ChartCatView](../ChartCatView/ChartCatView.htm)
