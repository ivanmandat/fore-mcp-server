...
Класс DataSourceParamsPanel реализует вкладку «Параметры источников данных» для настройки параметров источников данных, входящую в состав [панели свойств](../../../Components/Express/EaxPropertyBar/EaxPropertyBar.htm) экспресс-отчета.


## Комментарии


Вкладка «Параметры источников данных», реализованная классом DataSourceParamsPanel, может выглядеть следующим образом:
...
PP.initClass(PP.Exp.Ui.DataSourceParamsPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "DataSourceParamsPanel");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [DataSourceParamsPanel](dhtmlExpress.chm::/classes/express/datasourceparamspanel/constructor_datasourceparamspanel.htm)
		 Конструктор DataSourceParamsPanel
		 создает экземпляр класса DataSourceParamsPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [DestsSectionVisible](dhtmlExpress.chm::/classes/express/datasourceparamspanel/datasourceparamspanel.destssectionvisible.htm)
		 Свойство DestsSectionVisible
		 задаёт видимость вкладки "Параметры источников данных"
		 на панели свойств экспресс-отчета.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [setSource](dhtmlExpress.chm::/classes/express/datasourceparamspanel/datasourceparamspanel.setsource.htm)
		 Метод setSource
		 устанавливает источник данных для вкладки "Параметры источников
		 данных".
