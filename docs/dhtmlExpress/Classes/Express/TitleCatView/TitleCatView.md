...
Класс TitleCatView реализует представление вкладки «Заголовок» [ленты инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.TitleCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm), "TitleCatView");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TitleCatView](dhtmlExpress.chm::/Classes/Express/TitleCatView/Constructor_TitleCatView.htm)
		 Конструктор TitleCatView
		 создает экземпляр класса TitleCatView.
