...
[EaxModeSelectorView](../EaxModeSelectorView/EaxModeSelectorView.htm)
...
Класс EaxModeSelector реализует [кнопку для выбора режима отображения представлений данных](../../../Components/Express/EaxModeSelector/EaxModeSelector.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxModeSelector, PP.Exp.Ui.[EaxModeSelectorView](../EaxModeSelectorView/EaxModeSelectorView.htm), "EaxModeSelector");


## Комментарии


Класс EaxModeSelector реализует компонент [EaxModeSelector](../../../Components/Express/EaxModeSelector/EaxModeSelector.htm).
...
## Свойства, унаследованные от класса [EaxModeSelectorView](../EaxModeSelectorView/EaxModeSelectorView.htm)
...
## Методы, унаследованные от класса [EaxModeSelectorView](../EaxModeSelectorView/EaxModeSelectorView.htm)
...
## События, унаследованные от класса [EaxModeSelectorView](../EaxModeSelectorView/EaxModeSelectorView.htm)
