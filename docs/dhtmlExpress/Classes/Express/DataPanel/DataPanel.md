...
Класс DataPanel реализует вкладку «Данные», входящую в состав [панели свойств экспресс-отчета](../../../Components/Express/EaxPropertyBar/EaxPropertyBar.htm).


## Комментарии


Вкладка «Данные», реализуемая классом DataPanel, представлена на следующем рисунке:
...
PP.initClass(PP.Exp.Ui.DataPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "DataPanel");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [DataPanel](dhtmlExpress.chm::/classes/express/datapanel/constructor_datapanel.htm)
		 Конструктор DataPanel
		 создает экземпляр класса DataPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes/express/datapanel/datapanel.source.htm)
		 Свойство Source
		 определяет источник данных для вкладки «Данные».
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getDataViewState](dhtmlExpress.chm::/classes/express/datapanel/datapanel.getdataviewstate.htm)
		 Метод getDataViewState
		 возвращает объект со значениями, определяемыми элементами управления
		 в разделе «Преобразовать данные» на вкладке «Данные».


		 ![](../../../sub_image.gif)
		 [getFilterState](dhtmlExpress.chm::/classes/express/datapanel/datapanel.getfilterstate.htm)
		 Метод getFilterState
		 возвращает объект со значениями, определяемыми элементами управления
		 в разделе «Фильтровать по значениям таблицы» на вкладке «Данные».


		 ![](../../../sub_image.gif)
		 [getHighlightState](dhtmlExpress.chm::/Classes/Express/DataPanel/DataPanel.getHighlightState.htm)
		 Метод getHighlightState
		 возвращает минимальное и максимальное значения подсветки элементов
		 измерения.


		 ![](../../../sub_image.gif)
		 [getPivotState](dhtmlExpress.chm::/classes/express/datapanel/datapanel.getpivotstate.htm)
		 Метод getPivotState
		 возвращает объект со значениями, определяемыми элементами управления
		 в разделе «Агрегировать данные в фикс. измерениях» на вкладке
		 «Данные».


		 ![](../../../sub_image.gif)
		 [getRankState](dhtmlExpress.chm::/classes/express/datapanel/datapanel.getrankstate.htm)
		 Метод getRankState
		 возвращает объект со значениями, определяемыми элементами управления
		 в разделе «Отобразить как ранги» на вкладке «Данные».


		 ![](../../../sub_image.gif)
		 [getState](dhtmlExpress.chm::/classes/express/datapanel/datapanel.getstate.htm)
		 Метод getState
		 возвращает объект со значениями, определяемыми элементами управления
		 в разделах «Фильтровать по значениям таблицы» и «Агрегировать
		 данные в фикс. измерениях» на вкладке «Данные».
