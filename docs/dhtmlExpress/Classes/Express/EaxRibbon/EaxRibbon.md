...
[EaxRibbonView](../EaxRibbonView/EaxRibbonView.htm)
...
Класс EaxRibbon реализует [ленту инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxRibbon, PP.Exp.Ui.[EaxRibbonView](../EaxRibbonView/EaxRibbonView.htm), "EaxRibbon");
...
## Свойства, унаследованные от класса [EaxRibbonView](../EaxRibbonView/EaxRibbonView.htm)
...
## Методы, унаследованные от класса [EaxRibbonView](../EaxRibbonView/EaxRibbonView.htm)
...
## События, унаследованные от класса [EaxRibbonView](../EaxRibbonView/EaxRibbonView.htm)
