...
Класс MapCatView реализует
 представление вкладки «Карта» [ленты
...
PP.initClass(PP.Exp.Ui.MapCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm),
 "MapCatView");
...
Вкладка «Карта» доступна, если в рабочую область экспресс-отчета загружена
 карта.
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [MapCatView](dhtmlExpress.chm::/Classes/Express/MapCatView/Constructor_MapCatView.htm)
				 Конструктор MapCatView
				 создает экземпляр класса MapCatView.
