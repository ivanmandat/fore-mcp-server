...
Класс ViewCatView реализует вкладку «Вид» [ленты инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.ViewCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm), "ViewCatView");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ViewCatView](dhtmlExpress.chm::/Classes/Express/ViewCatView/Constructor_ViewCatView.htm)
		 Конструктор ViewCatView
		 создает экземпляр класса ViewCatView.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getContentRendered](dhtmlExpress.chm::/Classes/Express/ViewCatView/ViewCatView.getContentRendered.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/ViewCatView/ViewCatView.refresh.htm)
		 Метод refresh
		 обновляет вкладку «Вид» ленты инструментов экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [renderContent](dhtmlExpress.chm::/Classes/Express/ViewCatView/ViewCatView.renderContent.htm)
		 Метод renderContent
		 отрисовывает элементы вкладки ленты инструментов «Вид».


		 ![](../../../sub_image.gif)
		 [setVisiblePropBar](dhtmlExpress.chm::/Classes/Express/ViewCatView/ViewCatView.setVisiblePropBar.htm)
		 Метод setVisiblePropBar
		 управляет состоянием кнопки «Боковая панель» на вкладке ленты
		 инструментов «Вид» - нажимает её и отжимает.
