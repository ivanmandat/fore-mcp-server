# EaxCategoryView.getTableCFormatButtonMenu
...
getTableCFormatButtonMenu();


## Описание


Метод getTableCFormatButtonMenu** возвращает меню «Условное форматирование» на ленте инструментов экспресс-отчета.
...
![](../../../EaxCategoryView.getTableCFormatButtonMenu.jpg)
