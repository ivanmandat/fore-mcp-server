...
Класс EaxCategoryView - базовый класс для всех категорий [панели инструментов экспресс-отчета](../../../Components/Express/EaxRibbon/EaxRibbon.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxCategoryView, PP.Ui.[RibbonCategory](dhtmlRibbon.chm::/Classes/ribboncategory/ribboncategory.htm), "EaxCategoryView", [PP.Exp.Ui.IEaxView, PP.Ui.IMasterView]);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxCategoryView](dhtmlExpress.chm::/classes/express/eaxcategoryview/constructor_eaxcategoryview.htm)
		 Конструктор EaxCategoryView
		 создает экземпляр класса EaxCategoryView.
