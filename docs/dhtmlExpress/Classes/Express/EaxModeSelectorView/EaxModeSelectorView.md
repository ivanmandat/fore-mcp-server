...
Класс EaxModeSelectorView
 реализует представление [кнопки
 для выбора режима отображения представлений данных](../../../Components/Express/EaxModeSelector/EaxModeSelector.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxModeSelectorView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm),
 "EaxModeSelectorView", [PP.Exp.Ui.IEaxModeSelectorView]);
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [EaxModeSelectorView](Constructor_EaxModeSelectorView.htm)
				 Конструктор EaxModeSelectorView
				 создает экземпляр класса EaxModeSelectorView.
