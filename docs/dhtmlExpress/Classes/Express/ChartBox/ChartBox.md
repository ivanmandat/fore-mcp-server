...
[EaxChartView](../EaxChartView/EaxChartView.htm)
...
Класс ChartBox реализует [контейнер для диаграммы экспресс-отчета](../../../Components/Express/ChartBox/ChartBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.ChartBox, PP.Exp.Ui.[EaxChartView](../EaxChartView/EaxChartView.htm), «ChartBox»);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ChartBox](dhtmlExpress.chm::/classes/express/chartbox/constructor_chartbox.htm)
		 Конструктор ChartBox
		 создает экземпляр компонента ChartBox.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getService](dhtmlExpress.chm::/classes/express/chartbox/chartbox.getservice.htm)
		 Метод getService
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [MetadataChanged](dhtmlExpress.chm::/classes/express/chartbox/chartbox.metadatachanged.htm)
		 Событие MetadataChanged
		 наступает после изменения метаданных диаграммы экспресс-отчета.


## Свойства, унаследованные от класса [EaxChartView](../EaxChartView/EaxChartView.htm)
...
## Методы, унаследованные от класса [EaxChartView](../EaxChartView/EaxChartView.htm)
...
## События, унаследованные от класса [EaxChartView](../EaxChartView/EaxChartView.htm)
