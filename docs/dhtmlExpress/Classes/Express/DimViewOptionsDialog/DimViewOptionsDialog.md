...
Класс DimViewOptionsDialog реализует [диалог для настройки размещения измерений](../../../Components/Express/DimViewOptionsDialog/DimViewOptionsDialog.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.DimViewOptionsDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "DimViewOptionsDialog");


## Комментарии


Класс DimViewOptionsDialog реализует компонент [DimViewOptionsDialog](DimViewOptionsDialog.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [DimViewOptionDialog](dhtmlExpress.chm::/Classes/Express/DimViewOptionsDialog/Constructor_DimViewOptionsDialog.htm)
		 Конструктор DimViewOptionDialog
		 создает экземпляр компонента DimViewOptionDialog.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [ActiveDimMeta](dhtmlExpress.chm::/Classes/Express/DimViewOptionsDialog/DimViewOptionsDialog.ActiveDimMeta.htm)
		 Свойство ActiveDimMeta
		 задает текущее измерение в диалоге «Настройка размещения».


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/Classes/Express/DimViewOptionsDialog/DimViewOptionsDialog.Source.htm)
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getCurrentState](dhtmlExpress.chm::/Classes/Express/DimViewOptionsDialog/DimViewOptionsDialog.getCurrentState.htm)
		 Метод getCurrentState
		 возвращает текущее состояние свойств диалога для настройки размещения
		 измерений.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/DimViewOptionsDialog/DimViewOptionsDialog.refresh.htm)
		 Метод refresh
		 обновляет диалог для настройки размещения измерений.


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/Classes/Express/DimViewOptionsDialog/DimViewOptionsDialog.refreshAll.htm)
		 Метод refreshAll
		 обновляет все содержимое диалога для настройки размещения
		 измерений.


		 ![](../../../sub_image.gif)
		 [setCheckedAllAttributes](dhtmlExpress.chm::/Classes/Express/DimViewOptionsDialog/DimViewOptionsDialog.setCheckedAllAttributes.htm)
		 Метод setCheckedAllAttributes
		 отмечает все атрибуты текущего измерения в диалоге для настройки
