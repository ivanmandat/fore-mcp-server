...
Класс EaxDimBarView реализует представление [панели измерений](../../../Components/Express/EaxDimBar/EaxDimBar.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxDimBarView, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "EaxDimBarView", PP.Exp.Ui.IEaxView);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxDimBarView](dhtmlExpress.chm::/classes/express/eaxdimbarview/constructor_eaxdimbarview.htm)
		 Конструктор EaxDimBarView
		 создает экземпляр класса EaxDimBarView.
