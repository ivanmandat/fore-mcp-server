...
Класс ParametersDataSource реализует [вкладку «Параметры источника данных»](../../../Components/Express/ParametersDataSource/ParametersDataSource.htm) у [диалога «Параметры»](../ParametersDialog/ParametersDialog.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.ParametersDataSource, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.Exp.Ui.ParametersDataSource");


## Комментарии


Класс ParametersDataSource реализует компонент [ParametersDataSource](../../../Components/Express/ParametersDataSource/ParametersDataSource.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ParametersDataSource](dhtmlExpress.chm::/Classes/Express/ParametersDataSource/Constructor_ParametersDataSource.htm)
		 Конструктор ParametersDataSource
		 создает экземпляр компонента ParametersDataSource.
