...
Класс EaxDataView реализует представление [контейнера для рабочей области](../../../Components/Express/EaxDataBox/EaxDataBox.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxDataView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "EaxDataView", PP.Exp.Ui.IEaxDataView);
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxDataView](dhtmlExpress.chm::/Classes/Express/EaxDataView/Constructor_EaxDataView.htm)
		 Конструктор EaxDataView
		 создает экземпляр класса EaxDataView.
