...
Класс ReadonlyCatView реализует вкладку «Главная» [ленты инструментов](../../../Components/Express/EaxRibbon/EaxRibbon.htm) в случае, если экспресс-отчет открыт в режиме просмотра.


## Комментарии


Вкладка ленты инструментов «Главная» у экспресс-отчета, открытого в режиме просмотра, может выглядеть следующим образом:
...
PP.initClass(PP.Exp.Ui.ReadonlyCatView, PP.Exp.Ui.[EaxCategoryView](../EaxCategoryView/EaxCategoryView.htm), "ReadonlyCatView");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ReadonlyCatView](dhtmlExpress.chm::/Classes/Express/ReadonlyCatView/Constructor_ReadonlyCatView.htm)
		 Конструктор ReadonlyCatView
		 создает экземпляр класса ReadonlyCatView.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/ReadonlyCatView/ReadonlyCatView.refresh.htm)
		 Метод refresh
		 обновляет вкладку ленты инструментов «Главная» в режиме просмотра
		 экспресс-отчета.
