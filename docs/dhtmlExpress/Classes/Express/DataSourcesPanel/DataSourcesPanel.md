...
Класс DataSourcesPanel реализует вкладку «Источники данных», входящую в состав [панели свойств](../../../Components/Express/EaxPropertyBar/EaxPropertyBar.htm) экспресс-отчета.


## Комментарии


Вкладка «Источники данных», реализуемая классом DataSourcesPanel, может выглядеть следующим образом:
...
PP.initClass(PP.Exp.Ui.DataSourcesPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "DataSourcesPanel");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [DataSourcesPanel](dhtmlExpress.chm::/classes/express/datasourcespanel/constructor_datasourcespanel.htm)
		 Конструктор DataSourcesPanel
		 создает экземпляр класса DataSourcesPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [OpenMode](dhtmlExpress.chm::/classes/express/datasourcespanel/datasourcespanel.openmode.htm)
		 Свойство OpenMode
		 определяет режим извлечения куба.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes/express/datasourcespanel/datasourcespanel.source.htm)
		 Свойство Source
		 определяет источник данных для вкладки "Источники данных".
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getCurrentState](dhtmlExpress.chm::/Classes/Express/DataSourcesPanel/DataSourcesPanel.getCurrentState.htm)
		 Метод getCurrentState
		 возвращает массив ключей объектов репозитория, которые выбраны
		 в качестве источника данных для экспресс-отчета.
