...
[EaxDimBarView](../EaxDimBarView/EaxDimBarView.htm)
...
Класс EaxDimBar реализует
 [панель измерений
 экспресс-отчета](../../../Components/Express/EaxDimBar/EaxDimBar.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxDimBar, PP.Exp.Ui.[EaxDimBarView](../EaxDimBarView/EaxDimBarView.htm),
 "EaxDimBar");
...
Класс EaxDimBar реализует
 компонент [EaxDimBar](../../../Components/Express/EaxDimBar/EaxDimBar.htm).
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxDimBar](dhtmlExpress.chm::/classes\express\eaxdimbar\constructor_eaxdimbar.htm)
		 Конструктор EaxDimBar
		 создает экземпляр компонента EaxDimBar.


## Свойства, унаследованные от класса [EaxDimBarView](../EaxDimBarView/EaxDimBarView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [EnableDragDim](dhtmlExpress.chm::/classes/express/eaxdimbarview/eaxdimbarview.enabledragdim.htm)
		 Свойство EnableDragDim
		 определяет, можно ли перемещать измерения.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes/express/eaxdimbarview/eaxdimbarview.source.htm)
		 Свойство Source
		 определяет источник данных для панели измерений.


## Методы, унаследованные от класса [EaxDimBarView](../EaxDimBarView/EaxDimBarView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [clearDims](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.clearDims.htm)

		 Метод **clearDims**
		 пересоздает измерения на панели измерений экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [getCurrentState](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.getCurrentState.htm)

		 Метод getCurrentState
		 возвращает информацию об измерениях - ключ и позицию.


		 ![](../../../sub_image.gif)
		 [getDimComboView](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.getDimComboView.htm)

		 Метод getDimComboView
		 возвращает представление раскрывающегося списка указанного измерения.


		 ![](../../../sub_image.gif)
		 [getDimTreeView](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.getDimTreeView.htm)

		 Метод getDimTreeView
		 возвращает представление дерева измерений.


		 ![](../../../sub_image.gif)
		 [moveDim](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.moveDim.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.refreshAll.htm)

		 Метод refreshAll
		 обновляет все содержимое панели измерения экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshSelections](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.refreshSelections.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [updateVisibilityDims](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.updateVisibilityDims.htm)

		 Метод updateVisibilityDims
		 обновляет визуальное отображение панели измерений в соответствие
		 с состоянием модели данных.


## События, унаследованные от класса [EaxDimBarView](../EaxDimBarView/EaxDimBarView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [DimensionMoved](dhtmlExpress.chm::/classes/express/eaxdimbarview/eaxdimbarview.dimensionmoved.htm)
		 Событие DimensionMoved
		 наступает при перемещении измерения на панели измерений экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlExpress.chm::/classes/express/eaxdimbarview/eaxdimbarview.requestmetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике панели измерений.


		 ![](../../../Event_Image.gif)
		 [MetadataChanged](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.MetadataChanged.htm)
		 Событие MetadataChanged
		 наступает после изменения данных в панели измерений экспресс-отчета.
