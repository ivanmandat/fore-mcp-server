...
Класс EaxBubbleChart реализует [представление данных «пузырьковая диаграмма»](../../../Components/Express/EaxBubbleChart/EaxBubbleChart.htm) экспресс-отчета.


## Синтаксис


PP.initClass(PP.Exp.Ui.EaxBubbleChart, PP.Exp.Ui.[EaxBubbleChartView](../EaxBubbleChartView/EaxBubbleChartView.htm), "EaxBubbleChart");
...
## Свойства, унаследованные от класса [EaxBubbleChartView](../EaxBubbleChartView/EaxBubbleChartView.htm)
...
## Методы, унаследованные от класса [EaxBubbleChartView](../EaxBubbleChartView/EaxBubbleChartView.htm)
...
## События, унаследованные от класса [EaxBubbleChartView](../EaxBubbleChartView/EaxBubbleChartView.htm)
