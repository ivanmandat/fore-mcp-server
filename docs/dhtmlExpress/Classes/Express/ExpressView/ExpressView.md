...
Класс **ExpressView** реализует представление [контейнера для экспресс-отчетов](../../../Components/Express/ExpressBox/ExpressBox.htm).


## Синтаксис


PP.initClass(PP.Exp.Ui.ExpressView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "ExpressView", PP.Exp.Ui.IExpressView);
...
## Конструкторы
		 ...
		 ![](../../../sub_image.gif)
		 [ExpressView](dhtmlExpress.chm::/classes/express/expressview/constructor_expressview.htm)
		 Конструктор **ExpressView**
		 создает экземпляр класса **ExpressView**.
