...
Компонент DimSelectionDialog
 реализует диалог для отображения и изменения текущей отметки.
...
Компонент DimSelectionDialog
 реализован классом [DimSelectionDialog](../../../Classes/Express/DimSelectionDialog/DimSelectionDialog.htm).
...
[Пример создания компонента
 DimSelectionDialog](DimSelectionDialog_Example.htm)
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [DimSelectionDialog](../../../Classes/Express/DimSelectionDialog/Constructor_DimSelectionDialog.htm)
				 Конструктор DimSelectionDialog
				 создает экземпляр компонента DimSelectionDialog.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/Classes/Express/DimSelectionDialog/DimSelectionDialog.Source.htm)
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/Classes/Express/DimSelectionDialog/DimSelectionDialog.refreshAll.htm)
		 Метод **refreshAll**
		 обновляет все содержимое диалога для отображения и изменения текущей
		 отметки.
