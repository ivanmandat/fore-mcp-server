...
Компонент HtmlExportDialog**
 реализует диалог для экспорта экспресс-отчета в файл формата HTML.
...
Компонент **HtmlExportDialog**
 реализован классом [HtmlExportDialog](../../../Classes/Express/HtmlExportDialog/HtmlExportDialog.htm).
...
[Пример создания компонента HtmlExportDialog](HtmlExportDialog_Example.htm)
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [HtmlExportDialog](../../../Classes/Express/HtmlExportDialog/Constructor_HtmlExportDialog.htm)
