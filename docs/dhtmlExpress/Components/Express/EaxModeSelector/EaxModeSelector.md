...
Компонент EaxModeSelector
 реализует кнопку для выбора режима отображения представлений данных.


## Комментарии


Компонент EaxModeSelectorреализован
 классом [EaxModeSelector](../../../Classes/Express/EaxModeSelector/EaxModeSelector.htm).


При помощи метода getControl
 можно изменять свойства компонента PP.Ui.[RibbonButton](dhtmlRibbon.chm::/Classes/RibbonButton/RibbonButton.htm).


## Пример


Компонент EaxModeSelector может
 иметь следующий вид:
...
[Пример создания компонента EaxModeSelector](EaxModeSelector_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxModeSelector](dhtmlExpress.chm::/classes/express/eaxmodeselector/constructor_eaxmodeselector.htm)
		 Конструктор EaxModeSelector
		 создает экземпляр компонента EaxModeSelector.


## Свойства, унаследованные от класса [EaxModeSelectorView](../../../Classes/Express/EaxModeSelectorView/EaxModeSelectorView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [ModeSelectorState](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.modeselectorstate.htm)
		 Событие ModeSelectorChanged
		 устанавливает и возвращает выбранный режим отображения представлений
		 данных.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.source.htm)
		 Свойство Source
		 определяет источник данных кнопки для выбора режима отображения
		 представлений данных.


## Методы, унаследованные от класса [EaxModeSelectorView](../../../Classes/Express/EaxModeSelectorView/EaxModeSelectorView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [GetCurrentViewMode](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.getcurrentviewmode.htm)
		 Метод GetCurrentViewMode
		 возвращает текущий режим отображения представлений данных.


		 ![](../../../sub_image.gif)
		 [IsViewModeAvailable](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.isviewmodeavailable.htm)
		 Метод IsViewModeAvailable
		 определяет, доступен ли указанный режим отображения представлений
		 данных.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.refresh.htm)
		 Метод refresh
		 обновляет кнопку для выбора режима отображения представлений данных.


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.refreshall.htm)
		 Метод refreshAll
		 обновляет все содержимое кнопки для выбора режима отображения
		 представлений данных.


## События, унаследованные от класса [EaxModeSelectorView](../../../Classes/Express/EaxModeSelectorView/EaxModeSelectorView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [BeforeViewModeChanged](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.beforeviewmodechanged.htm)
		 Событие BeforeViewModeChanged
		 наступает перед сменой режима отображения представлений данных.


		 ![](../../../Event_Image.gif)
		 [ModeSelectorChanged](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.modeselectorchanged.htm)
		 Событие ModeSelectorChanged
		 ...
		 ![](../../../Event_Image.gif)
		 [ViewModeChanged](dhtmlExpress.chm::/classes\express\eaxmodeselectorview\eaxmodeselectorview.viewmodechanged.htm)
