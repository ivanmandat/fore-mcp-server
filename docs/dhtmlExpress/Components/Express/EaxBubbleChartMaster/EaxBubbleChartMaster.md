...
Компонент BubbleChartMaster
 реализует мастер управления пузырьковой диаграммой экспресс-отчета.


## Комментарии


Компонент BubbleChartMaster реализован
 классом [BubbleChartMaster](../../../Classes/Express/EaxBubbleChartMaster/EaxBubbleChartMaster.htm).


Мастер управления пузырьковой диаграммой экспресс-отчета, расположенный
 на [панели свойств экспресс-отчета](../EaxPropertyBar/EaxPropertyBar.htm).
...
![](EaxBibbleChartMaster.png)


Вкладки «Размер» и «Цветовой индикатор» являются активными в случае,
 если для какого-либо показателя экспресс-отчета выбрано соответствующее
 измерение - «Размер» и «Цвет»:


![](EaxBubbleChartMaster1.png)


Пример создания компонента рассмотрен на странице «[Пример
 создания компонента BubbleChart](../EaxBubbleChart/EaxBubbleChart_Example.htm)».
