...
Компонент StatTreeView
 реализует диалог «Статистические характеристики», отображающий дерево
 со статистическими характеристиками данных экспресс-отчета.
...
Компонент StatTreeView
 реализован классом [StatTreeView](../../../Classes/Express/StatTreeView/StatTreeView.htm).
...
[Пример создания компонента StatTreeView](StatTreeView_Example.htm)
