...
Компонент GaugeBox реализует
 контейнер для [спидометра](dhtmlGauge.chm::/Components/Speedometer/Speedometer.htm).


## Комментарии


Компонент GaugeBox реализован
 классом [GaugeBox](../../../Classes/Express/GaugeBox/GaugeBox.htm).


## Пример


Компонент GaugeBox вместе со
 спидометром может иметь следующий вид:


![](GaugeBox.png)


[Пример использования компонента GaugeBox](GaugeBox_Example.htm)
