...
Компонент EaxToolBar
 реализует группу кнопок для переключения режима отображения данных.


## Комментарии


Компонент EaxToolBar реализован
 классом [EaxToolBar](../../../Classes/Express/EaxToolBar/EaxToolBar.htm).


## Пример


Компонент EaxToolBar может иметь
 следующий вид:
...
[Пример создания компонента EaxToolBar](EaxToolBar_Example.htm)
...
## Свойства, унаследованные от класса [EaxToolBarView](../../../Classes/Express/EaxToolBarView/EaxToolBarView.htm)
...
## Методы, унаследованные от класса [EaxToolBarView](../../../Classes/Express/EaxToolBarView/EaxToolBarView.htm)
...
## События, унаследованные от класса [EaxToolBarView](../../../Classes/Express/EaxToolBarView/EaxToolBarView.htm)
