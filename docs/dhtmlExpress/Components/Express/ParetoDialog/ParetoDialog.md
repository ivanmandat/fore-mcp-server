...
Компонент ParetoDialog**
 реализует диалог для настройки распределения данных по Парето.


## Комментарии


Компонент Pareto**Dialog**
 реализован классом [ParetoDialog](../../../Classes/Express/ParetoDialog/ParetoDialog.htm).
...
[Пример создания компонента ParetoDialog](ParetoDialog_Example.htm)
