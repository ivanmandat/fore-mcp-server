...
Компонент EaxBubbleChart
 реализует представление данных «пузырьковая диаграмма» экспресс-отчета.


## Комментарии


Компонент EaxBubbleChartреализован
 классом [EaxBubbleChart](../../../Classes/Express/EaxBubbleChart/EaxBubbleChart.htm).


## Пример


Компонент EaxBubbleChartможет
 иметь следующий вид:
...
[Пример создания компонента EaxBubbleChart](EaxBubbleChart_Example.htm)


[Пример совместного
 размещения EaxPropertyBar и EaxBubbleChart](EaxBubbleChart-EaxPropertyBar_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxBubbleChart](dhtmlExpress.chm::/Classes/Express/EaxBubbleChart/Constructor_EaxBubbleChart.htm)
		 Конструктор EaxBubbleChart
		 создает экземпляр компонента EaxBubbleChart.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getService](dhtmlExpress.chm::/Classes/Express/EaxBubbleChart/EaxBubbleChart.getService.htm)
		 Метод getService
		 возвращает объект сервиса для работы с экспресс-отчетом.


## Свойства, унаследованные от класса [EaxBubbleChartView](../../../Classes/Express/EaxBubbleChartView/EaxBubbleChartView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Instance](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.Instance.htm)
		 Свойство Instance
		 содержит экземпляр пузырьковой диаграммы экспресс-отчета.


		 ![](../../../Property_Image.gif)
		 [LegendPosition](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.LegendPosition.htm)
		 Свойство LegendPosition
		 определяет расположение легенды пузырьковой диаграммы.


		 ![](../../../Property_Image.gif)
		 [Options](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.Options.htm)
		 Свойство Options
		 содержит настройки представления пузырьковой диаграммы экспресс-отчета.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.Source.htm)
		 Свойство Source
		 определяет источник данных для компонента.


## Методы, унаследованные от класса [EaxBubbleChartView](../../../Classes/Express/EaxBubbleChartView/EaxBubbleChartView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [addBubbleSettings](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.addBubbleSettings.htm)
		 Метод addBubbleSettings
		 добавляет настройки пузырьковой диаграммы экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [clearInstance](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.clearInstance.htm)
		 Метод clearInstance
		 удаляет экземпляр пузырьковой диаграммы экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [getState](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.getState.htm)
		 Метод getState возвращает
		 настройки представления пузырьковой диаграммы в экспресс-отчёте.


		 ![](../../../sub_image.gif)
		 [getViewMode](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.getViewMode.htm)
		 Метод getViewMode
		 возвращает значение флага «Режим просмотра» для пузырьковой диаграммы экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [isLoaded](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.isLoaded.htm)
		 Метод isLoaded
		 возвращает признак того, что пузырьковая диаграмма экспресс-отчета загружена.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.refresh.htm)
		 Метод refresh
		 обновляет пузырьковую диаграмму экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.refreshAll.htm)
		 Метод refreshAll
		 обновляет все содержимое пузырьковой диаграммы экспресс-отчета.


## События, унаследованные от класса [EaxBubbleChartView](../../../Classes/Express/EaxBubbleChartView/EaxBubbleChartView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [DataChanged](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.DataChanged.htm)
		 Событие DataChanged
		 наступает после изменения данных пузырьковой диаграммы экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает после изменения свойств пузырьковой диаграммы экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [Refreshed](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.Refreshed.htm)
		 Событие Refreshed наступает
		 после отрисовки пузырьковой диаграммы экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.RequestMetadata.htm)
