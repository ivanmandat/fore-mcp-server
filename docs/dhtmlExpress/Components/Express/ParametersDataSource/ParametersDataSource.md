...
Компонент ParametersDataSource
 реализует вкладку «Параметры источника данных» диалога «Параметры».
...
Компонент ParametersDataSource
 реализован классом [ParametersDataSource](../../../Classes/Express/ParametersDataSource/ParametersDataSource.htm).
...
![](ParametersDataSource.png)


Пример создания компонента ParametersDataSource
