...
Компонент ExpressBox
 представляет собой контейнер для экспресс-отчетов.
...
Компонент ExpressBox
 реализован классом [ExpressBox](../../../Classes/Express/ExpressBox/ExpressBox.htm).
...
Компонент включает в себя панель инструментов, боковую панель и область
 данных.


[Пример
 создания компонента ExpressBox](ExpressBox_Example.htm)
...
## Конструкторы
		 ...
		 ![](../../../sub_image.gif)
		 [ExpressBox](dhtmlExpress.chm::/classes\express\expressbox\constructor_expressbox.htm)
		 Конструктор ExpressBox
		 создает экземпляр компонента ExpressBox.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getService](dhtmlExpress.chm::/classes/express/expressbox/expressbox.getservice.htm)
		 Метод getService**
		 возвращает сервис для работы с экспресс-отчетами.


## Свойства, унаследованные от [ExpressView](../../../Classes/Express/ExpressView/ExpressView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/classes/express/expressview/expressview.source.htm)
		 Свойство **Source**
		 определяет источник данных для экспресс-отчета.


		 ![](../../../Property_Image.gif)
		 [ViewMode](dhtmlExpress.chm::/classes/express/expressview/expressview.viewmode.htm)
		 Свойство **ViewMode**
		 определяет, открыт ли экспресс-отчёт в режиме просмотра.


## Методы, унаследованные от [ExpressView](../../../Classes/Express/ExpressView/ExpressView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [getDataView](dhtmlExpress.chm::/classes/express/expressview/expressview.getdataview.htm)
		 Метод getDataView
		 возвращает представление области данных экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [getPropertyBarView](dhtmlExpress.chm::/classes/express/expressview/expressview.getpropertybarview.htm)
		 Метод getPropertyBarView
		 возвращает представление панели свойств.


		 ![](../../../sub_image.gif)
		 [getRibbonView](dhtmlExpress.chm::/classes/express/expressview/expressview.getribbonview.htm)
		 Метод getRibbonView
		 возвращает представление ленты инструментов экспресс-отчета


		 ![](../../../sub_image.gif)
		 [getSlidePanelView](dhtmlExpress.chm::/classes/express/expressview/expressview.getslidepanelview.htm)
		 Метод **getSlidePanelView**
		 возвращает представление элемента управления, состоящего из трех
		 связанных панелей - Header,
		 Details и View.


		 ![](../../../sub_image.gif)
		 [getSlidePanelViewToolBar](dhtmlExpress.chm::/classes/express/expressview/expressview.getslidepanelviewtoolbar.htm)
		 Метод getSlidePanelViewToolBar
		 возвращает панель инструментов, предназначенную для смены мастеров
		 в панели свойств экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/classes/express/expressview/expressview.refresh.htm)
		 Метод refresh
		 обновляет указанные элементы экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/classes/express/expressview/expressview.refreshall.htm)
		 Метод refreshAll
		 обновляет все элементы экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [removeAllEvents](dhtmlExpress.chm::/classes/express/expressview/expressview.removeallevents.htm)
		 Метод removeAllEvents
		 удаляет все обработчики событий у экспресса-отчета по заданному
		 контексту.


		 ![](../../../sub_image.gif)
		 [resetTitle](dhtmlExpress.chm::/classes/express/expressview/expressview.resettitle.htm)
		 Метод resetTitle
		 сбрасывает заголовок на панели Header,
		 входящей в состав боковой панели экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [setSlidePanelViewToolBarMode](dhtmlExpress.chm::/classes/express/expressview/expressview.setslidepanelviewtoolbarmode.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [setTitle](dhtmlExpress.chm::/classes/express/expressview/expressview.settitle.htm)
		 Метод setTitle
		 устанавливает заголовок на панели Header,
		 входящей в состав боковой панели экспресс-отчета.


## Свойства, унаследованные от [Control](dhtmlUi.chm::/Classes/control/control.htm)
...
## Методы, унаследованные от [Control](dhtmlUi.chm::/Classes/control/control.htm)
