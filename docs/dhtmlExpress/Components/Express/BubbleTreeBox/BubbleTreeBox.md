...
Компонент BubbleTreeBox реализует
 контейнер для [пузырькового
 дерева](../../../Classes/Express/BubbleTreeBox/BubbleTreeBox.htm).


## Комментарии


Компонент BubbleTreeBox реализован
 классом [BubbleTreeBox](../../../Classes/Express/BubbleTreeBox/BubbleTreeBox.htm).
...
[Пример использования компонента
 BubbleTreeBox](BubbleTreeBox_Example.htm)
