...
Компонент EaxParameterBox
 реализует контейнер для параметра экспресс-отчета.


## Комментарии


Компонент EaxParameterBox реализован
 классом [EaxParameterBox](../../../Classes/Express/EaxParameterBox/EaxParameterBox.htm).
 Размещается на вкладке «Параметры источников данных» у панели свойств
 и отображается в случае наличия параметров у экспресс-отчета.


## Пример


Компонент EaxParameterBox может
 иметь следующий вид:
...
[Пример создания компонента EaxParameterBox](EaxParameterBox_Example.htm)
...
## Свойства, унаследованные от класса [EaxParameterView](../../../Classes/Express/EaxParameterView/EaxParameterView.htm)
...
## Методы, унаследованные от класса [EaxParameterView](../../../Classes/Express/EaxParameterView/EaxParameterView.htm)
...
## События, унаследованные от класса [EaxParameterView](../../../Classes/Express/EaxParameterView/EaxParameterView.htm)
