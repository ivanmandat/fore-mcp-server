...
Компонент XlsExportDialog**
 реализует диалог «Параметры экспорта в XLS».
...
Компонент **XlsExportDialog**
 реализован классом [XlsExportDialog](../../../Classes/Express/XlsExportDialog/XlsExportDialog.htm).
...
[Пример создания компонента XlsExportDialog](XlsExportDialog_Example.htm)
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [XlsExportDialog](../../../Classes/Express/XlsExportDialog/Constructor_XlsExportDialog.htm)
