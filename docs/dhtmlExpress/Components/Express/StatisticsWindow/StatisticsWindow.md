...
Компонент tatisticsWindow
 реализует окно диалога «Статистические характеристики», отображающего
...
Компонент StatisticsWindow
 реализован классом [StatisticsWindow](../../../Classes/Express/StatisticsWindow/StatisticsWindow.htm).
...
[Пример создания компонента StatisticsWindow](StatisticsWindow_Example.htm)
