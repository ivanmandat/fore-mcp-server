...
Компонент CommonizeDimDialog
 реализует настройки вынесения частных измерений в общие.
...
Компонент CommonizeDimDialog
 реализован классом [CommmonizeDimDialog](../../../Classes/Express/CommonizeDimDialog/CommonizeDimDialog.htm).


Для получения компонента необходим экспресс-отчёт, построенный на нескольких
 источниках данных. Вызывается из контекстного меню для частных измерений
 на компоненте [EaxDimBarMaster](../EaxDimBarMaster/EaxDimBarMaster.htm).
