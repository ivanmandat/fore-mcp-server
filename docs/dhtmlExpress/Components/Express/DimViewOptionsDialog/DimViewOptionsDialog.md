...
Компонент DimViewOptionsDialog
 реализует диалог для настройки размещения измерений.
...
Компонент DimViewOptionsDialog
 реализован классом [DimViewOptionsDialog](../../../Classes/Express/DimViewOptionsDialog/DimViewOptionsDialog.htm).
...
[Пример создания компонента
 DimViewOptionsDialog](DimViewOptionsDialog_Example.htm)
