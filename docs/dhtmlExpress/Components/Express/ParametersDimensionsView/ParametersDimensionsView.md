...
Компонент ParametersDimensionsView
 реализует вкладку «Измерения» у диалога «Параметры».
...
Компонент ParametersDimensionsView
 реализован классом [ParametersDimensionsView](../../../Classes/Express/ParametersDimensionsView/ParametersDimensionsView.htm).
...
![](ParametersDimensionsView.png)


Пример создания компонента ParametersDimensionsView
 приведен на странице «[Пример
 создания компонента ParametersDialog](../ParametersDialog/ParametersDialog_Example.htm)».
