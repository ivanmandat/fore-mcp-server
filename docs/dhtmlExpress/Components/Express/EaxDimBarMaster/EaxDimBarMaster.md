...
Компонент EaxDimBarMaster
 реализует мастер управления отметкой в измерениях.


## Комментарии


Компонент EaxDimBarMaster реализован
 классом [EaxDimBarMaster](../../../Classes/Express/EaxDimBarMaster/EaxDimBarMaster.htm).
...
[Пример создания компонента EaxDimBarMaster](EaxDimBarMaster_Example.htm)
