...
Компонент EaxDimBar реализует
 панель измерений экспресс-отчета.


## Комментарии


Компонент EaxDimBar реализован
 классом [EaxDimBar](../../../Classes/Express/EaxDimBar/EaxDimBar.htm).


## Пример


Компонент EaxDimBar может
 иметь следующий вид:
...
[Пример создания компонента EaxDimBar](EaxDimBar_Example.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [DataChanged](dhtmlExpress.chm::/Classes/Express/EaxDimBarView/EaxDimBarView.MetadataChanged.htm)
		 Событие DataChanged
		 наступает после изменения данных в панели измерений экспресс-отчета.


## Свойства, унаследованные от класса [EaxDimBarView](../../../Classes/Express/EaxDimBarView/EaxDimBarView.htm)
...
## Методы, унаследованные от класса [EaxDimBarView](../../../Classes/Express/EaxDimBarView/EaxDimBarView.htm)
...
## События, унаследованные от класса [EaxDimBarView](../../../Classes/Express/EaxDimBarView/EaxDimBarView.htm)
