...
Компонент EaxMapBox представляет
 собой контейнер для карты экспресс-отчета.


## Комментарии


Компонент EaxMapBoxреализован
 классом [EaxMapBox](../../../Classes/Express/EaxMapBox/EaxMapBox.htm).


## Пример


Компонент EaxMapBox может иметь
 следующий вид:
...
[Пример совместного размещения EaxPropertyBar
 и EaxMapBox](EaxMapBox_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [EaxMapBox](dhtmlExpress.chm::/Classes/Express/EaxMapBox/Constructor_EaxMapBox.htm)
		 Конструктор EaxMapBox
		 создает экземпляр компонента EaxMapBox.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getService](dhtmlExpress.chm::/Classes/Express/EaxMapBox/EaxMapBox.getService.htm)
		 Метод getService
		 возвращает объект сервиса для работы с экспресс-отчетом.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [MetadataChanged](dhtmlExpress.chm::/Classes/Express/EaxMapBox/EaxMapBox.MetadataChanged.htm)
		 Событие MetadataChanged наступает
		 после изменения данных пузырьковой диаграммы экспресс-отчета.


## Свойства, унаследованные от класса [EaxMapView](../../../Classes/Express/EaxMapView/EaxMapView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [IsLegendHeaderClickable](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.IsLegendHeaderClickable.htm)
		 Свойство IsLegendHeaderClickable содержит
		 признак того, что заголовок легенды карты экспресс-отчета представлен
		 в виде гиперссылки.


		 ![](../../../Property_Image.gif)
		 [LegendPosition](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.LegendPosition.htm)
		 Свойство LegendPosition
		 определяет расположение легенды карты.


		 ![](../../../Property_Image.gif)
		 [MapType](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.MapType.htm)
		 Свойство MapType определяет
		 тип карты экспресс-отчета.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.Source.htm)
		 Свойство Source
		 определяет источник данных для пузырьковой диаграммы экспресс-отчета.


		 ![](../../../Property_Image.gif)
		 [UseZoomOnWheel](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.UseZoomOnWheel.htm)
		 Свойство UseZoomOnWheel
		 содержит признак использования колесика мыши для масштабирования
		 карты экспресс-отчета.


## Методы, унаследованные от класса [EaxMapView](../../../Classes/Express/EaxMapView/EaxMapView.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [addMapSettings](dhtmlExpress.chm::/Classes\Express\EaxMapView\EaxMapView.refreshView.htm)
		 Метод addMapSettings
		 добавляет настройки к карте экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [getState](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartView/EaxBubbleChartView.getState.htm)
		 Метод getState возвращает
		 настройки представления карты в экспресс-отчёте.


		 ![](../../../sub_image.gif)
		 [getInstance](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.getInstance.htm)
		 Метод getInstance
		 возвращает экземпляр карты экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [getMapSettings](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.getMapSettings.htm)
		 Метод getMapSettings
		 возвращает настройки карты экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [getSilverlightInstance](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.getSilverlightInstance.htm)
		 Метод getSilverlightInstance
		 возвращает экземпляр Silverlight-объекта.


		 ![](../../../sub_image.gif)
		 [getViewMode](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.getViewMode.htm)
		 Метод getViewMode
		 возвращает значение флага «Режим просмотра» для экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [isLoaded](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.isLoaded.htm)
		 Метод isLoaded
		 возвращает признак того, что карта экспресс-отчета загружена.


		 ![](../../../sub_image.gif)
		 [isSLAvailable](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.isSLAvailable.htm)
		 Метод isSLAvailable
		 определяет, доступен ли Silverlight-объект у карты экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [onDropDownStateChanged](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.onDropDownStateChanged.htm)
		 Метод onDropDownStateChanged
		 переключает Silverlight-карту на изображение SVG-карты с целью
		 отображения раскрывающихся списков поверх неё.


		 ![](../../../sub_image.gif)
		 [refresh](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.refresh.htm)
		 Метод refresh
		 обновляет указанное свойство диаграммы экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshAll](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.refreshAll.htm)
		 Метод refreshAll
		 обновляет все элементы карты экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [refreshView](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.refreshView.htm)
		 Метод refreshView добавляет
		 настройки к карте экспресс-отчета.


		 ![](../../../sub_image.gif)
		 [setTopobase](dhtmlExpress.chm::/Classes/Express/EaxMapView/EaxMapView.setTopobase.htm)
		 Метод setTopobase
		 устанавливает топооснову для карты экспресс-отчета.


## События, унаследованные от класса [EaxMapView](../../../Classes/Express/EaxMapView/EaxMapView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [DrillUp](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.drillup.htm)
		 Событие DrillUp
		 наступает при возврате на верхний уровень в карте экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [GoogleLoadError](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.googleloaderror.htm)
		 Событие GoogleLoadError
		 наступает при ошибке загрузки карты Google.


		 ![](../../../Event_Image.gif)
		 [MapTypeChanged](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.maptypechanged.htm)
		 Событие MapTypeChanged
		 наступает после изменения типа карты экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [MetadataChanged](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.metadatachanged.htm)
		 Событие MetadataChanged
		 наступает при изменении настроек карты экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.propertychanged.htm)
		 Событие PropertyChanged
		 наступает после выбора пункта «Настройки» в контекстном меню карты
		 экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [RegionClick](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.regionclick.htm)
		 Событие RegionClick
		 наступает после выбора региона на карте экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [Rendered](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.rendered.htm)
		 Событие Rendered
		 наступает после отрисовки карты экспресс-отчета.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlExpress.chm::/classes/express/eaxmapview/eaxmapview.requestmetadata.htm)
