...
Компонент TreeMapBox реализует
 контейнер для [плоского
 дерева](dhtmlBubbleTree.chm::/Classes/TreeMap/TreeMap.htm).


## Комментарии


Компонент TreeMapBox реализован
 классом [TreeMapBox](../../../Classes/Express/TreeMapBox/TreeMapBox.htm).


## Пример


[Пример использования компонента TreeMapBox](TreeMapBox_Example.htm)
