...
Компонент TitleBox
 реализует контейнер для заголовка экспресс-отчета.


## Комментарии


Компонент TitleBox реализован
 классом [TitleBox](../../../Classes/Express/TitleBox/TitleBox.htm).


## Пример


Компонент TitleBox может иметь
 следующий вид:
...
Пример создания компонента TitleBox
 приведен на странице «Пример
 создания компонента EaxTitleMaster».
