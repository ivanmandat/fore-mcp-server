...
WorkspaceToView(Position: [IGxPointF](ModDrawing.chm::/Interface/IGxPointF/IGxPointF.htm)):
...
Метод WorkspaceToView возвращает
 координату отображения, которая соответствует заданной координате рабочего
 пространства.
...
Добавьте ссылки на системные сборки: Andy, Drawing, Workspace.
	...
	    PointF := New GxPointF.Create(1, 10);
...
После выполнения примера будет изменено смещение центра отображения
