...
GetShapeByPt(Position: [IGxPointF](ModDrawing.chm::/Interface/IGxPointF/IGxPointF.htm)):
...
Position. Точка отображения.


## Описание


Метод GetShapeByPt получает
 объект по заданной координате.
...
Добавьте ссылки на системные сборки: Andy, Drawing, Workspace.
	...
	    PointF := New GxPointF.Create(10, 10);
...
После выполнения примера, в случае если в данной точке отображения находится
 объект, то он будет выделен.
