...
TextMarginTop: Double;


## Описание


Свойство TextMarginTop определяет
 отступ текста сверху. При отрицательных значениях отступ определяется
