...
Свойство PictureProportional
 позволяет сохранить пропорции изображения при изменении размера объекта.
...
Если значение свойства True,
 то пропорции будут сохранены, при значении False
...
После выполнения примера при изменении размера объекта размер изображения
 будет масштабироваться с сохранением пропорций.
