...
PictureMarginBottom: Double;


## Описание


Свойство PictureMarginBottom
 определяет отступ изображения от нижнего края элемента управления.
...
После выполнения примера будет настроен отступ изображения от нижнего
 края объекта.
