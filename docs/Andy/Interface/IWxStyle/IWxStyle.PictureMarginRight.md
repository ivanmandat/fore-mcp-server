...
Свойство PictureMarginRight
 определяет отступ изображения от правого края элемента управления.
...
После выполнения примера будет настроен отступ изображения от правого
 края объекта.
