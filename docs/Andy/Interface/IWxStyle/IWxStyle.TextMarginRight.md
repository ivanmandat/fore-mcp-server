...
TextMarginRight: Double;


## Описание


Свойство TextMarginRight определяет
 отступ текста справа. При отрицательных значениях отступ определяется
