# Настройка нумерации: Регламентный отчёт, веб-приложение
...
Для включения и настройки нумерации используйте панель «[Размещение](Layout.htm)».
...
Для настройки нумерации нажмите кнопку ![](../../Source/display_params.png) «Настройка»
