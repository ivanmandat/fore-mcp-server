	 ...
	 отображения» выполните следующие действия:
		...
		- через панель параметров:
			...
			- Нажмите кнопку ![](parameters.png) «Параметры»
			 панели инструментов и выберите тип области «Данные»/«Ячейки» в раскрывающемся
			...
			- Нажмите кнопку ![](../../Reports/b_params.png) «Настроить» в поле «Настройка редактора ячейки»
		...
		- через рабочую область:
			...
			- Выполните команду контекстного
			 меню ![](../../Reports/OperationReport/b_format.png) «Оформление» для ячеек или
			 в раскрывающемся списке команды ![](../../Reports/OperationReport/b_format.png) «Оформление» выберите тип
			 области данные/измерение/уровень/элемент.


			- Нажмите кнопку ![](../../Reports/b_params.png) «Настроить» в поле «Настройка редактора ячейки»
			 в группе настроек «Специальный
			 формат». Для ячеек группа настроек «Специальный
			 формат» находится на вкладке «Настройки».
...
Примечание.
 ...
 списка недоступен.
	...
	На листе отчёта работа с раскрывающемся списком доступна:
...
Для удобства работы с календарным справочником в редакторе типа «[Раскрывающийся
 список справочника](Display_Settings.htm#dimension)» используйте календарь с настраиваемым диапазоном
 дат.
...
[Настройка оформления](Format.htm) |
 [Оформление отчёта](../Work/UiReport_Table_WorkStyle.htm)
