# Просмотр истории изменений значений в ячейке: Регламентный отчёт, веб-приложение
...
[![](../../../opened.gif)![](../../../closed.gif)Для открытия
 панели](javascript:TextPopup(this))
	...
	При просмотре отчёта кнопка ![](b_history.png) «История
...
Записи формируются при [редактировании
 и сохранении](../../Reports/OperationReport/Work_with_data.htm#edit) значений в ячейку.
...
[![](../../../opened.gif)![](../../../closed.gif)Настройка отображения](javascript:TextPopup(this))
	...
	Для сортировки и фильтрации записей по времени создания нажите кнопку
	 ![](../../Reports/b_params.png) «Настройки
	 отображения».
