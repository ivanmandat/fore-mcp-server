# Xnpv: Регламентный отчёт, веб-приложение
...
Возвращает чистую приведённую стоимость для денежных потоков, которые
...
## Пример
		 ...
		 2086,65
		 Величина чистой приведённой денежных потоков исходя из ставки
