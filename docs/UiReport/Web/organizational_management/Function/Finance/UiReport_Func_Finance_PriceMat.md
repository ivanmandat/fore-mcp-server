# PriceMat: Регламентный отчёт, веб-приложение
...
где:
	...
	- B. Количество дней в году, зависит от используемого
	 базиса;


	- DSM. Количество дней от даты расчёта до
	 даты погашения;


	- DIM. Количество дней от даты выпуска до
	 даты погашения;


	- A. Количество дней от даты выпуска до даты
	 расчёта.
...
## Пример
		 ...
		 97,79
		 Цена за 100 рублей номинальной стоимости ценных бумаг, по
		 которым процент выплачивается в срок погашения, в соответствии
