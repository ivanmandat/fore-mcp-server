# CoupNcd: Регламентный отчёт, веб-приложение
...
Возвращает число, представляющее следующую дату купона после даты расчёта.
...
## Пример
		 ...
		 1)
		 01.06.2008
		 Дата следующего купона от даты соглашения, в соответствии
