# CoupDays: Регламентный отчёт, веб-приложение
...
CoupDay(Settlement, Maturity, Frequency[, Basis])
...
Возвращает число дней в периоде купона, который содержит дату расчёта.
...
## Пример
		 ...
		 =CoupDays("01.01.2008", "01.06.2008",
		 4)
		 90
		 Количество дней в периоде купона, содержащем дату расчёта,
		 в соответствии со следующими условиями:
			...
			- ежеквартальные выплаты по купонам;
