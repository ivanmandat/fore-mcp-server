# Rank: Регламентный отчёт, веб-приложение
...
AscendingOrder. Способ упорядочения:
	...
	- True. Ранг числа определяется
	 так, как если бы массив был отсортированным в порядке убывания;


	- False. Ранг числа определяется
	 так, как если бы массив был отсортированным в порядке возрастания.
