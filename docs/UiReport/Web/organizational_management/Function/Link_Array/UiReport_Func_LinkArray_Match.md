# Match: Регламентный отчёт, веб-приложение
...
MatchType. Необязательный параметр.
 ...
 в диапазоне ячеек. Может принимать значения:
	...
	- 1 или опущен. Функция
	 находит наибольшее значение, которое меньше или равно искомому значению,
	 при этом диапазон ячеек должен быть упорядочен по возрастанию. Значение
	 по умолчанию;


	- 0. Функция находит первое
	 значение, равное искомому значению, при этом диапазон ячеек может
	 быть не упорядочен;


	- -1. Функция находит
	 наименьшее значение, которое больше или равно искомому значению, при
	 этом диапазон ячеек должен быть упорядочен по убыванию.
