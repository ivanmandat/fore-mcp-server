# Настройки панели инструментов: Регламентный отчёт, веб-приложение
...
По умолчанию панель инструментов содержит системные вкладки и кнопки
 для построения и настройки отчёта:
...
[![](../../opened.gif)![](../../closed.gif)Сворачивание/восстановление
 панели](javascript:TextPopup(this))
	...
	Для сворачивания/восстановления панели инструментов нажмите кнопку
	 ![](../Table/Work/b_previous.png) «Свернуть»
	 / ![](../Table/Work/b_next.png) «Развернуть»
...
[![](../../opened.gif)![](../../closed.gif)Прокрутка кнопок](javascript:TextPopup(this))
	...
	Если какие-то кнопки не помещаются на экран, то они скрываются.
	 Для использования скрытых кнопок нажмите кнопку ![](../Source/controls_edit.png) «Показать» на панели инструментов,
...
[![](../../opened.gif)![](../../closed.gif)Для открытия
 окна](javascript:TextPopup(this))
	...
	Выполните команду ![](../Reports/b_params.png) «Настроить
	 панель инструментов» контекстного меню [панели
	 инструментов](Starting.htm#structure_window).
...
Режимы настройки панели инструментов:
	...
	- Режим просмотра.
	 ...
	 только в режиме просмотра. При наведении на системные вкладки и кнопки,
	 доступные только в режиме просмотра, отображается подсказка.
...
[![](../../opened.gif)![](../../closed.gif)Добавление вкладки](javascript:TextPopup(this))
	...
	Вкладки, которые не содержат кнопок, остаются недоступными для использования
	 до добавления хотя бы одной кнопки.
...
[![](../../opened.gif)![](../../closed.gif)Добавление
 пользовательской кнопки](javascript:TextPopup(this))
	...
	![](../Reports/Button/button_panel_common.png)


		- Выполните [настройку
		 пользовательской кнопки](../Reports/Button/Button.htm).
	...
	В результате выполненных действий пользовательская кнопка будет
	 ...
	 кнопка добавится в конец списка выбранной вкладки.
...
[![](../../opened.gif)![](../../closed.gif)Добавление разделителя](javascript:TextPopup(this))
	...
	В результате выполненных действий разделитель будет добавлен после
	 выбранного элемента. Если кнопка не была выбрана, выбрано несколько
	 кнопок, то добавление разделителя будет недоступно.
...
[![](../../opened.gif)![](../../closed.gif)Редактирование
 элемента](javascript:TextPopup(this))
	...
	Для изменения наименования элемента панели инструментов:
		...
		- Выполните одно из действий:
			...
			- нажмите кнопку ![](../Reports/OperationReport/b_edit.png)
			 «Редактировать»;


			- выполните команду ![](../Reports/OperationReport/b_edit.png) «Редактировать»
...
[![](../../opened.gif)![](../../closed.gif)Изменение положения
 элемента](javascript:TextPopup(this))
	...
	Разделители можно перемещать между пользовательскими вкладками и
	 в пределах одной вкладки.
	...
	Для настройки отображения элементов панели инструментов выполните
	 действия:
		...
		- Выполните одно из действий:
			...
			- для отображения элемента только в режиме «Отображать
			 скрытые элементы»:
				...
				- выполните команду ![](b_hide.png) «Скрыть»
				 контекстного меню выбранного элемента;
			...
			- для отображения элемента во всех режимах:
				...
				- выполните команду ![](b_show.png) «Показать»
				 контекстного меню выбранного элемента.
