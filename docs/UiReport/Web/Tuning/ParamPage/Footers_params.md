# Колонтитулы на странице: Регламентный отчёт, веб-приложение
...
После выполнения действий будут настроены колонтитулы
 на странице для [печати](UiReport_Tuning_ParamPage.htm#print).


Примечание.
 При настройке колонтитулов учитывайте особенности [экспорта
 отчёта](../../Reports/OperationReport/UiReport_Reports_Operation_Export.htm#export_features) в различные форматы.
...
[Начало
 ...
 отчёта под печать](UiReport_Tuning_ParamPage.htm) | [Работа
