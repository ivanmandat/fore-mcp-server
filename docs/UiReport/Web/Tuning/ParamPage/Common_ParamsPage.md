# Общие параметры страницы: Регламентный отчёт, веб-приложение
...
Для общих параметров страницы отчёта доступна [быстрая](UiReport_Tuning_ParamPage.htm#quick_setup)
 и [расширенная](UiReport_Tuning_ParamPage.htm#advanced_setup)
 настройка.
...
Примечание.
 Данный параметр нумерации влияет только на [колонтитулы](../../../Desktop/Tuning/ParamPage/UiReport_Tuning_ParamPage_3.htm)
...
После выполнения действий будут настроены общие
 параметры страницы для [печати](UiReport_Tuning_ParamPage.htm#print).
