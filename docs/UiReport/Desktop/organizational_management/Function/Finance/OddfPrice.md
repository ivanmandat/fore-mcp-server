# OddfPrice: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции OddfPrice выглядит
 следующим образом:
...
[![](../../../../opened.gif)![](../../../../closed.gif)Нерегулярный
 короткий первый купон](javascript:TextPopup(this))
	...
	где:
		...
		- DSC. Количество
		 дней от даты расчета до даты следующего купона;
		...
		- N. Количество оплачиваемых
		 купонов между датой расчета и датой погашения. Если это число
 ...
 длинный первый купон](javascript:TextPopup(this))
	...
	где:
		...
		- Nq. Количество полных периодов квазикупонов
		 от даты расчета до первого купона.
...
## Пример
		 ...
		 200, 4, 3)
		 146,11р.
		 Цена за 100 рублей номинальной стоимости ценных бумаг для нерегулярного
		 первого периода на следующих условиях:
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 │ [Финансовые
 функции](UiReport_Func_Finance.htm) │ [IFinance.OddfPrice](MathLib.chm::/Interface/IFinance/IFinance.OddfPrice.htm)
