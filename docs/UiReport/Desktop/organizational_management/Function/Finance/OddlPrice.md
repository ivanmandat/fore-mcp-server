# OddlPrice: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции OddlPrice выглядит
 следующим образом:
...
## Пример
		 ...
		 197,21р.
		 Цена за 100 рублей нарицательной стоимости ценных бумаг для
		 нерегулярного последнего периода купона на следующих условиях:


			- дата расчета за ценные бумаги 07.02.2008;
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 │ [Финансовые
 функции](UiReport_Func_Finance.htm) │ [IFinance.OddlPrice](MathLib.chm::/Interface/IFinance/IFinance.OddlPrice.htm)
