# CoupDays: Регламентный отчёт, настольное приложение
...
## Пример
		 ...
		 4)
		 90
		 Количество дней в периоде купона, содержащем дату расчета,
...
[Мастер
 ...
 │ [IFinance.CoupDays](MathLib.chm::/Interface/IFinance/IFinance.CoupDays.htm)
