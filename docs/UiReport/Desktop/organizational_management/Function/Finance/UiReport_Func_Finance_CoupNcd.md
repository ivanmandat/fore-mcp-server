# CoupNcd: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции CoupNcd выглядит следующим
 образом:
...
Возвращает число, представляющее следующую дату купона после даты расчета.
...
## Пример
		 ...
		 =CoupNcd("01.01.2008", "01.06.2008",
		 1)
		 01.06.2008
		 Дата следующего купона от даты соглашения, в соответствии со
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 ...
 | [IFinance.CoupNcd](MathLib.chm::/Interface/IFinance/IFinance.CoupNcd.htm)
