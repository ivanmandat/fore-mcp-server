# CoupDayBs: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции CoupDayBs выглядит
 следующим образом:
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 ...
 │ [IFinance.CoupDayBs](MathLib.chm::/Interface/IFinance/IFinance.CoupDayBs.htm)
