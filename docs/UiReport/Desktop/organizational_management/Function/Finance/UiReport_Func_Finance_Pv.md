# Pv: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции Pv выглядит следующим
 образом:
...
Приведенная (нынешняя) стоимость представляет собой общую сумму, которая
...
## Пример
		 ...
		 -3003,40
		 Приведенная (к текущему моменту) стоимость инвестиции, в соответствии
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 ...
 │ [IFinance.Pv](MathLib.chm::/Interface/IFinance/IFinance.Pv.htm)
