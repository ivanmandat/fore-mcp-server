# MDuration: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции MDuration выглядит
 следующим образом:
...
## Пример
		 ...
		 0.28, 0.82, 4, 3)
		 1,4979
		 Модифицированная продолжительность Маколея на следующих условиях:
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 │ [Финансовые
 функции](UiReport_Func_Finance.htm) │ [IFinance.MDuration](MathLib.chm::/Interface/IFinance/IFinance.MDuration.htm)
