# CoupNum: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции CoupNum выглядит следующим
 образом:
...
Возвращает количество купонов, которые могут быть оплачены между датой
 расчета и сроком погашения, округленное до ближайшего целого количества
 купонов.
...
## Пример
		 ...
		 условиями:
			...
			- дата расчета указана в ячейке A0, 01.01.2007;
