# TBillYield: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции TBillYield выглядит
 следующим образом:
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 ...
 │ [IFinance.TBillYield](MathLib.chm::/Interface/IFinance/IFinance.TBillYield.htm)
