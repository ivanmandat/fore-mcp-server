# Ceiling: Регламентный отчёт, настольное приложение
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 для функции Ceiling выглядит следующим
 образом:
...
[Мастер функций](../../UiReport_Organizational_master_function.htm)
 ...
 [IMath.Ceiling](MathLib.chm::/Interface/IMath/IMath.Ceiling.htm)
  │
 [IMath.CeilingI](MathLib.chm::/Interface/IMath/IMath.CeilingI.htm)
