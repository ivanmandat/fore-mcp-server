# JavaInvoke: Регламентный отчёт, настольное приложение
...
ClassName. Наименование Java-класса
...
Примечание.
 ...
 с [правилами формирования сигнатур](https://docs.oracle.com/javase/8/docs/technotes/guides/jni/spec/jniTOC.html).
...
Примечание.
 Перед использованием функции убедитесь, что выполнена [интеграция](uinav.chm::/02_Navigator/CommonSettings/Integration.htm#java)
