...
Компонент ParallelCoordinates
 представляет собой диаграмму с параллельными координатами.


## Комментарии


Компонент реализован классом [ParallelCoordinates](../../Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.htm).


Диаграмма с параллельными координатами предназначена для визуального
 представления данных в n-мерном
 пространстве. В данной диаграмме отображается n-ое
 количество параллельных линий, являющихся вертикальными и равноудалёнными.
 Точка в n-мерном пространстве представлена в виде ломаной с вершинами
 на параллельных осях. Координаты точки соответствуют положению вершин
 на каждой оси.


Компонент позволяет настраивать [область
 построения](../../Classes/ParallelCoordinates/PCArea/PCArea.htm), [вертикальные
 оси](../../Classes/ParallelCoordinates/PCAxis/PCAxis.htm) и [линии](../../Classes/ParallelCoordinates/PCLine/PCLine.htm)
 диаграммы с параллельными координатами.
...
![](../../Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.FilterActiveEffects.png)


[Пример создания компонента
 ParallelCoordinates](Example_ParallelCoordinates.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ParallelCoordinates](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/Constructor_ParallelCoordinates.htm)
		 Конструктор ParallelCoordinates
		 создает экземпляр компонента [ParallelCoordinates](dhtmlChart.chm::/Components/ParallelCoordinates/ParallelCoordinates.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Axes](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.Axes.htm)
		 Свойство Axes определяет
		 оси диаграммы.


		 ![](../../Property_Image.gif)
		 [Axis](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.Axis.htm)
		 Свойство Axis определяет
		 шаблон настроек для осей диаграммы.


		 ![](../../Property_Image.gif)
		 [AxisDragEnabled](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.AxisDragEnabled.htm)
		 Свойство AxisDragEnabled
		 определяет, можно ли перемещать оси диаграммы.


		 ![](../../Property_Image.gif)
		 [AxisSelectionEnabled](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.AxisSelectionEnabled.htm)
		 Свойство AxisSelectionEnabled
		 определяет, можно ли выделять оси диаграммы.


		 ![](../../Property_Image.gif)
		 [ChartArea](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.ChartArea.htm)
		 Свойство ChartArea
		 определяет область рисования диаграммы.


		 ![](../../Property_Image.gif)
		 [FilterActiveEffects](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.FilterActiveEffects.htm)
		 Свойство FilterActiveEffects
		 определяет эффекты для линий диаграммы, входящих в диапазон
		 фильтрации.


		 ![](../../Property_Image.gif)
		 [FilterInactiveEffects](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.FilterInactiveEffects.htm)
		 Свойство FilterInactiveEffects
		 определяет эффекты для линий диаграммы, не входящих в диапазон
		 фильтрации.


		 ![](../../Property_Image.gif)
		 [FiltrationEnabled](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.FiltrationEnabled.htm)
		 Свойство FiltrationEnabled
		 определяет, включена ли фильтрация линий диаграммы.


		 ![](../../Property_Image.gif)
		 [Line](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.Line.htm)
		 Свойство Line определяет
		 шаблон настроек для линий диаграммы.


		 ![](../../Property_Image.gif)
		 [Lines](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.Lines.htm)
		 Свойство Lines определяет
		 линии диаграммы.


		 ![](../../Property_Image.gif)
		 [LinesColors](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.LinesColors.htm)
		 Свойство LinesColors
		 определяет цвета линий.


		 ![](../../Property_Image.gif)
		 [RenderToCanvas](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.RenderToCanvas.htm)
		 Свойство RenderToCanvas
		 определяет, куда будет выводиться диаграмма.


		 ![](../../Property_Image.gif)
		 [SelectedAxis](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.SelectedAxis.htm)
		 Свойство SelectedAxis
		 определяет выделенную ось диаграммы.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getColorVisual](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.getColorVisual.htm)
		 Метод getColorVisual
		 определяет описание показателя, данные из которого применяются
		 для заливки линий диаграммы после выделения оси.


		 ![](../../Sub_Image.gif)
		 [getInstance](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.getInstance.htm)
		 Метод getInstance возвращает
		 экземпляр диаграммы.


		 ![](../../Sub_Image.gif)
		 [getState](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.getState.htm)
		 Метод getState возвращает
		 объект, описывающий состояние диаграммы.


		 ![](../../Sub_Image.gif)
		 [getTooltipColor](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.getTooltipColor.htm)
		 Метод getTooltipColor
		 возвращает цвет границы всплывающей подсказки заданной линии.


		 ![](../../Sub_Image.gif)
		 [hoverItems](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.hoverItems.htm)
		 Метод hoverItems подсвечивает
		 заданные линии диаграммы на указанном временном интервале.


		 ![](../../Sub_Image.gif)
		 [isLoaded](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.isLoaded.htm)
		 Метод isLoaded проверяет,
		 загружена ли диаграмма.


		 ![](../../Sub_Image.gif)
		 [refreshView](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.refreshView.htm)
		 Метод refreshView обновляет
		 отображение диаграммы.


		 ![](../../Sub_Image.gif)
		 [requestRenderFrame](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.requestRenderFrame.htm)
		 Метод requestRenderFrame
		 отправляет запрос на перерисовку диаграммы.


		 ![](../../Sub_Image.gif)
		 [selectItems](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.selectItems.htm)
		 Метод hoverItems устанавливает
		 выделение заданным линиям диаграммы.


		 ![](../../Sub_Image.gif)
		 [setService](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.setService.htm)
		 Метод setService предназначен
		 для установки сервиса диаграмме.


		 ![](../../Sub_Image.gif)
		 [setSource](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.setSource.htm)
		 Метод setSource предназначен
		 для установки источника данных диаграмме.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ItemsHovered](dhtmlChart.chm::/Classes/ParallelCoordinates/ParallelCoordinates/ParallelCoordinates.ItemsHovered.htm)
		 Событие ItemsHovered
		 наступает после наведения курсора на линию диаграммы.
...
## События, унаследованные от [Control](dhtmlUi.chm::/Classes/control/control.htm)
