...
Компонент TreeGantDiagram представляет
 собой ленточную диаграмму Ганта с деревом элементов.


## Комментарии


Компонент TreeGantDiagram реализован
 классом [TreeGantDiagram](../../Classes/TreeGantDiagram/TreeGantDiagram.htm).


Диаграмма позволяет отобразить продолжительность события на временном
 участке.


Левая часть компонента состоит из дерева элементов, правая часть из
 диаграммы Ганта.
...
[Пример создания компонента TreeGantDiagram](TreeGantExample.htm)
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DTimelineEndTime](../../Classes/TreeGantDiagram/TreeGantDiagram.DTimelineEndTime.htm)
		 Свойство DTimelineEndTime
		 определяет конец временного отрезка диаграммы.


		 ![](../../Property_Image.gif)
		 [DTimelineStartTime](../../Classes/TreeGantDiagram/TreeGantDiagram.DTimelineStartTime.htm)
		 Свойство DTimelineStartTime
		 определяет начало временного отрезка диаграммы.


		 ![](../../Property_Image.gif)
		 [TColumns](../../Classes/TreeGantDiagram/TreeGantDiagram.TColumns.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [clear](../../Classes/TreeGantDiagram/TreeGantDiagram.clear.htm)
		 Метод clear очищает
		 компонент от загруженных данных.


		 ![](../../Sub_Image.gif)
		 [getDiagram](../../Classes/TreeGantDiagram/TreeGantDiagram.getDiagram.htm)
		 Метод getDiagram возвращает
		 диаграмму Ганта.


		 ![](../../Sub_Image.gif)
		 [getSplitter](../../Classes/TreeGantDiagram/TreeGantDiagram.getSplitter.htm)
		 Метод getSplitter возвращает
		 разделитель.


		 ![](../../Sub_Image.gif)
		 [getTreeList](../../Classes/TreeGantDiagram/TreeGantDiagram.getTreeList.htm)
		 Метод getTreeList возвращает
		 дерево элементов.


		 ![](../../Sub_Image.gif)
		 [loadFrom](../../Classes/TreeGantDiagram/TreeGantDiagram.loadFrom.htm)
		 Метод loadFrom загружает
		 данные в компонент.


		 ![](../../Sub_Image.gif)
		 [setTimeStep](../../Classes/TreeGantDiagram/TreeGantDiagram.setTimeStep.htm)
...
[Компоненты диаграмм](../Components.htm)
