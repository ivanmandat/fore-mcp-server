...
Компонент GantDiagram представляет
 собой ленточную диаграмму Ганта.


## Комментарии


Компонент GantDiagram реализован
 классом [GantDiagram](../../Classes/GantDiagram/GantDiagram.htm).
...
Компонент GantDiagram используется
 в правой части компонента [TreeGantDiagram](../TreeGantDiagram/TreeGantDiagram.htm).
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 GantDiagram
			 Конструктор GantDiagram
			 создает экземпляр компонента GantDiagram.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [setShowStartTimeLabel](../../Classes/GantDiagram/GantDiagram.setShowStartTimeLabel.htm)
		 Метод setShowStartTimeLabel
		 устанавливает признак отображения начального времени диаграммы.


		 ![](../../Sub_Image.gif)
		 [setTimeAxisShift](../../Classes/GantDiagram/GantDiagram.setTimeAxisShift.htm)
		 Метод setTimeAxisShift
		 устанавливает сдвиг диаграммы относительно шкалы времени.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [HintShowing](../../Classes/GantDiagram/GantDiagram.HintShowing.htm)
		 Событие HintShowing
		 генерируется при отображении подсказки.


		 ![](../../Event_Image.gif)
		 [LineClick](../../Classes/GantDiagram/GantDiagram.LineClick.htm)
		 Событие LineClick генерируется
		 при щелчке по элементу диаграммы.


		 ![](../../Event_Image.gif)
		 [LineHovered](../../Classes/GantDiagram/GantDiagram.LineHovered.htm)
		 Событие LineHovered
		 генерируется при наведении на элемент диаграммы.
