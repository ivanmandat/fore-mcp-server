...
Компонент ChartMaster представляет
 собой мастер для настройки диаграмм.


## Комментарии


Компонент реализован классом [ChartMaster](../../Classes/ChartMaster/ChartMaster.htm).


[NavigationBar](dhtmlCommon.chm::/Classes/NavigationBar/NavigationBar.htm)
 - базовый компонент для ChartMaster.
...
[Пример совместного размещения
 ChartMaster и ChartBox](ChartMaster_and_ChartBox.htm)
...
## Свойства, унаследованные от класса [ChartMasterFoundation](../../Classes/ChartMasterFoundation/ChartMasterFoundation.htm)
...
## События, унаследованные от класса [ChartMasterFoundation](../../Classes/ChartMasterFoundation/ChartMasterFoundation.htm)
