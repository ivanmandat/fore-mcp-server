...
[ChartMasterFoundation](../ChartMasterFoundation/ChartMasterFoundation.htm)
...
Класс **ChartMaster** реализует
 компонент [ChartMaster](../../Components/ChartMaster/ChartMaster.htm),
 представляющий собой мастер для настройки диаграммы.


## Синтаксис


PP.initClass(PP.Ui.ChartMaster, PP.Ui.ChartMasterFoundation,
 "PP.Ui.ChartMaster", [PP.Ui.IMasterView]);
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [ChartMaster](dhtmlChart.chm::/Classes/ChartMaster/Constructor_ChartMaster.htm)
			 Конструктор ChartMaster
			 создает экземпляр класса ChartMaster.


## Свойства, унаследованные от класса [ChartMasterFoundation](../ChartMasterFoundation/ChartMasterFoundation.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Chart](dhtmlChart.chm::/Classes/ChartMasterFoundation/ChartMasterFoundation.Chart.htm)
		 Свойство **Chart**
		 определяет диаграмму, на которую будут действовать настройки мастера.


		 ![](../../Property_Image.gif)
		 [DataView](dhtmlChart.chm::/Classes/ChartMasterFoundation/ChartMasterFoundation.DataView.htm)
		 Свойство **DataView**
		 определяет представление данных «Диаграмма» экспресс-отчета, на
		 которую будут действовать настройки мастера.


		 ![](../../Property_Image.gif)
		 [Options](dhtmlChart.chm::/Classes/ChartMasterFoundation/ChartMasterFoundation.Options.htm)
		 Свойство **Options**
		 определяет объект с настройками диаграммы.


## События, унаследованные от класса [ChartMasterFoundation](../ChartMasterFoundation/ChartMasterFoundation.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [PropertyChanged](dhtmlChart.chm::/Classes/ChartMasterFoundation/ChartMasterFoundation.PropertyChanged.htm)
		 Событие **PropertyChanged**
		 наступает при изменении настроек мастера диаграммы.
