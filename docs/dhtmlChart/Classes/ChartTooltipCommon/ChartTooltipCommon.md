...
Класс **ChartTooltipCommon**
 реализует страницу «Подсказки» в [мастере
...
Страница «Подсказки» в мастере для настройки диаграммы выглядит следующим
 образом:


![](ChartTooltipCommon.png)


## Синтаксис


PP.initClass(PP.Ui.ChartTooltipCommon, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.ChartTooltipCommon");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 ChartTooltipCommon
			 Конструктор ChartTooltipCommon
			 создает экземпляр класса ChartTooltipCommon.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [refreshHeaderControl](ChartTooltipCommon.refreshHeaderControl.htm)
		 Свойство refreshHeaderControl
		 обновляет элемент управления в заголовке страницы «Подсказки».
