...
Класс **ChartLabel** определяет
 собой текстовую метку.


## Синтаксис


PP.initClass(PP.Ui.ChartLabel, [PP.Ui.PlacedControlBase](dhtmlGraphicBase.chm::/Classes/PlacedControlBase/PlacedControlBase.htm),
 "PP.Ui.ChartLabel");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [ChartLabel](dhtmlChart.chm::/Classes\ChartLabel\Constructor_ChartLabel.htm)
			 Конструктор ChartLabel
			 создает экземпляр класса ChartLabel.
