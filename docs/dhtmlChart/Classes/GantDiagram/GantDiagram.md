...
Класс GantDiagram реализует
 ленточную диаграмму Ганта.


## Комментарии


Класс реализует компонент [GantDiagram](../../Components/GantDiagram/GantDiagram.htm).
 Линии представлены классом [GantLine](../GantLine/GantLine.htm).


Используется в компоненте [TreeGantDiagram](../../Components/TreeGantDiagram/TreeGantDiagram.htm).
...
PP.initClass(PP.Ui.GantDiagram, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.GantDiagram");
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [setShowStartTimeLabel](GantDiagram.setShowStartTimeLabel.htm)
		 Метод setShowStartTimeLabel
		 устанавливает признак отображения начального времени диаграммы.


		 ![](../../Sub_Image.gif)
		 [setTimeAxisShift](GantDiagram.setTimeAxisShift.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [HintShowing](GantDiagram.HintShowing.htm)
		 Событие HintShowing
		 генерируется при отображении подсказки.


		 ![](../../Event_Image.gif)
		 [LineClick](GantDiagram.LineClick.htm)
		 Событие LineClick генерируется
		 при щелчке по элементу диаграммы.


		 ![](../../Event_Image.gif)
		 [LineHovered](GantDiagram.LineHovered.htm)
		 Событие LineHovered
