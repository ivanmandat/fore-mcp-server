...
Класс SerieCommon реализует
 вкладку для работы с рядами данных.


## Комментарии


Для получения данной панели в запущенном веб-приложении включите отображение
...
chartMaster.getItem(PP.Ui.SerieCommon);
// -> PP.Ui.SerieCommon{_ImagePath: "../build/img/", _manualTextInitialized: false, _GroupName: "", _Events: Object…}

## Синтаксис


PP.initClass(PP.Ui.SerieCommon, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.SerieCommon");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 SerieCommon
			 Конструктор SerieCommon
			 создает экземпляр класса SerieCommon.
