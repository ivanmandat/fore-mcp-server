...
Класс ChartPlotArea предназначен
 для работы с областью построения диаграммы.


## Синтаксис


PP.initClass(PP.Ui.ChartPlotArea, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.ChartPlotArea");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ChartPlotArea](Constuctor_ChartPlotArea.htm)
		 Конструктор ChartPlotArea
		 создает экземпляр класса ChartPlotArea.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getContext](ChartPlotArea.getContext.htm)
		 Метод getContext возвращает
		 контекст рисования.


		 ![](../../../Sub_Image.gif)
		 [redraw](ChartPlotArea.redraw.htm)
