...
Класс LevelCommon реализует
 вкладку для работы с линией уровня.


## Комментарии


Для получения данной вкладки в запущенном веб-приложении включите отображение
 диаграммы и выполните в консоли следующий код:
...
chartMaster = panel.getChartMaster()
// Получим нужную вкладку
chartMaster.getItem(PP.Ui.LevelCommon);
// -> PP.Ui.LevelCommon {_ImagePath: "../build/img/", _manualTextInitialized: false, _GroupName: "", _Events: Object…}

## Синтаксис


PP.initClass(PP.Ui.LevelCommon, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.LevelCommon");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 LevelCommon
			 Конструктор LevelCommon
			 создает экземпляр класса LevelCommon.
