...
[Control](dhtmlReport.chm::/Classes/RegularReport/Control/Control.htm)


[PlacedControlBase](dhtmlGraphicBase.chm::/Classes/PlacedControlBase/PlacedControlBase.htm)


[ChartLabel](../../ChartLabel/ChartLabel.htm)


[ChartTooltipBase](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.htm)
...
Класс ChartTooltip реализует
 всплывающую подсказку [диаграммы](../Chart/Chart.htm).


## Синтаксис


PP.initClass(PP.Ui.ChartTooltip, PP.Ui.[ChartTooltipBase](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.htm),
 "PP.Ui.ChartTooltip");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ChartTooltipBase](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltip/ChartTooltip.htm)
		 Конструктор ChartTooltip
		 создает экземпляр класса ChartTooltip.


## Свойства, унаследованные от класса [ChartTooltipBase](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.htm)
...
## Методы, унаследованные от класса [ChartTooltipBase](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.htm)
...
## Свойства, унаследованные от класса [ChartLabel](../../ChartLabel/ChartLabel.htm)
