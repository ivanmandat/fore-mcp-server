# ChartCanvasAxis.MinorTickLength
...
Свойство MinorTickLength определяет
 длину промежуточных линий делений оси.
...
Значение свойства задается в пикселях.
...
console.log(settings.MinorTickLength);
