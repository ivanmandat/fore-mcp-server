# ChartCanvasAxis.EditModeContetx
...
EditModeContetx: CanvasRenderingContext2D;


## Описание


Свойство EditModeContetx определяет
 контекст рисования применяемый в режиме редактирования.
...
console.log(settings.EditModeContetx);
