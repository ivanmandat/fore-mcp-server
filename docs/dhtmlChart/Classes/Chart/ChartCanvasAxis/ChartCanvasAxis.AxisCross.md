...
Свойство AxisCross определяет,
 начинается ли ось с деления.
...
Допустимые значения:
	...
	- "Betweenticks".
	 Ось начинается с отступа;


	- "Ontick".
	 Ось начинается с деления.
...
console.log(settings.AxisCross);
