# ChartCanvasAxis.BottomIntervals
...
BottomIntervals: Number;


## Описание


Свойство BottomIntervals определяет
 отступ снизу.
...
Свойство задается в делениях оси.
...
console.log(settings.BottomIntervals);
