...
Класс AxisCommon реализует вкладку
 для работы с осями.
...
chartMaster.getItem(PP.Ui.AxisCommon);
// -> PP.Ui.AxisCommon{_ImagePath: "../build/img/", _manualTextInitialized: false, _GroupName: "", _Events: Object…}

## Синтаксис


PP.initClass(PP.Ui.AxisCommon, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.AxisCommon");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 AxisCommon
			 Конструктор AxisCommon
			 создает экземпляр класса AxisCommon.
