...
Класс ChartMasterFoundation
 - базовый класс для [мастера
 диаграммы](../../Components/ChartMaster/ChartMaster.htm).


## Синтаксис


PP.initClass(PP.Ui.ChartMasterFoundation, PP.Ui.[Master](dhtmlUi.chm::/Classes/Master/Master.htm), "ChartMasterFoundation",
 [PP.Ui.IMasterView]);
