...
Класс PCArea реализует область
 рисования диаграммы с параллельными координатами.


## Синтаксис


PP.initClass(PP.Ui.PCArea, PP.Ui.[PlacedControlBase](dhtmlGraphicBase.chm::/Classes/PlacedControlBase/PlacedControlBase.htm),
 "PP.Ui.PCArea");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [PCArea](Constructor_PCArea.htm)
		 Конструктор PCArea
		 создает экземпляр класса PCArea.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [AxesLayer](PCArea.AxesLayer.htm)
		 Свойство AxesLayer
		 определяет слой осей области рисования диаграммы.


		 ![](../../../Property_Image.gif)
		 [Chart](PCArea.Chart.htm)
		 Свойство Chart устанавливает
		 диаграмму, данные которой будут отрисовываться на области.


		 ![](../../../Property_Image.gif)
		 [Footer](PCArea.Footer.htm)
		 Свойство Footer устанавливает
		 нижний колонтитул области отрисовки диаграммы.


		 ![](../../../Property_Image.gif)
		 [Header](PCArea.Header.htm)
		 Свойство Header устанавливает
		 верхний колонтитул области отрисовки диаграммы.


		 ![](../../../Property_Image.gif)
		 [LabelsLayer](PCArea.LabelsLayer.htm)
		 Свойство LabelsLayer
		 определяет слой меток области рисования диаграммы.


		 ![](../../../Property_Image.gif)
		 [LinesLayer](PCArea.LinesLayer.htm)
		 Свойство LinesLayer
		 определяет слой линий области рисования диаграммы.


		 ![](../../../Property_Image.gif)
		 [PaperArea](PCArea.PaperArea.htm)
		 Свойство PaperArea
		 определяет прямоугольник, ограничивающий область рисования.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getPaper](PCArea.getPaper.htm)
		 Метод getPaper возвращает
		 лист, на котором рисуются элементы диаграммы.
