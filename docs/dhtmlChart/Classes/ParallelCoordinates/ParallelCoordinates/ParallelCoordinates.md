...
Класс ParallelCoordinates реализует
 компонент [ParallelCoordinates](../../../Components/ParallelCoordinates/ParallelCoordinates.htm),
 представляющий собой диаграмму с параллельными координатами.


## Синтаксис


PP.initClass(PP.Ui.ParallelCoordinates, PP.Ui.[DataVisualizer](dhtmlUi.chm::/Classes/DataVisualizer/DataVisualizer.htm),
 'PP.Ui.ParallelCoordinates', [PP.Ui.IDataView, PP.Ui.IDVSynchronizable]);
