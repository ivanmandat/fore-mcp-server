...
Класс RatingChartSerie предназначен
 для работы с рядом данных рейтинговой диаграммы.


## Синтаксис


PP.initClass(PP.Ui.RatingChartSerie, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.RatingChartSerie");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 RatingChartSerie
			 Конструктор RatingChartSerie
			 создает экземпляр класса RatingChartSerie.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Chart](RatingChartSerie.Chart.htm)
		 Свойство Chart определяет
		 рейтинговую диаграмму.


		 ![](../../Property_Image.gif)
		 [Index](RatingChartSerie.Index.htm)
		 Свойство Index возвращает
		 текущий номер ряда данных.


		 ![](../../Property_Image.gif)
		 [IndexBrush](RatingChartSerie.IndexBrush.htm)
		 Свойство IndexBrush
		 определяет цвет заливки фона номера ряда данных.


		 ![](../../Property_Image.gif)
		 [IsSelected](RatingChartSerie.IsSelected.htm)
		 Свойство IsSelected
		 определяет, выделен ли ряд данных.


		 ![](../../Property_Image.gif)
		 [LineBrush](RatingChartSerie.LineBrush.htm)
		 Свойство LineBrush
		 определяет цвет заливки ряда данных при положительных значениях.


		 ![](../../Property_Image.gif)
		 [Move](RatingChartSerie.Move.htm)
		 Свойство Move возвращает
		 изменение позиции ряда данных в рейтинге.


		 ![](../../Property_Image.gif)
		 [Name](RatingChartSerie.Name.htm)
		 Свойство Name определяет
		 наименование ряда данных.


		 ![](../../Property_Image.gif)
		 [NegativeLineBrush](RatingChartSerie.NegativeLineBrush.htm)
		 Свойство NegativeLineBrush
		 определяет цвет заливки ряда данных при отрицательных значениях.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [animateGraph](RatingChartSerie.animateGraph.htm)
		 Метод animateGraph
		 отрисовывает промежуточный шаг анимации ряда данных.


		 ![](../../Sub_Image.gif)
		 [animatePosition](RatingChartSerie.animatePosition.htm)
		 Метод animatePosition
		 отрисовывает промежуточный шаг анимации изменения позиции ряда
		 данных.


		 ![](../../Sub_Image.gif)
		 [draw](RatingChartSerie.draw.htm)
		 Метод draw перерисовывает
		 ряд данных.


		 ![](../../Sub_Image.gif)
		 [getToolTipValues](RatingChartSerie.getToolTipValues.htm)
		 Метод getToolTipValues
		 возвращает всплывающую подсказку ряда данных.


		 ![](../../Sub_Image.gif)
		 [resetAsAggregated](RatingChartSerie.resetAsAggregated.htm)
		 Метод resetAsAggregated
		 обнуляет значения ряда данных.


		 ![](../../Sub_Image.gif)
		 [updateAsAggregated](RatingChartSerie.updateAsAggregated.htm)
		 Метод updateAsAggregated
		 суммирует значения ряда данных со значениями другого ряда.


		 ![](../../Sub_Image.gif)
		 [updateData](RatingChartSerie.updateData.htm)
		 Метод updateData обновляет
