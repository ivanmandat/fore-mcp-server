...
Класс TreeGantDiagram реализует
 ленточную диаграмму Ганта с деревом элементов.


## Комментарии


Класс реализует компонент [TreeGantDiagram](../../Components/TreeGantDiagram/TreeGantDiagram.htm).


Компонент TreeGantDiagram может
 иметь следующий вид:


![](../../Components/TreeGantDiagram/GantDiagramm.png)


Левая часть компонента реализована деревом [PP.Ui.TreeList](dhtmlUiTree.chm::/dhtmlUiTree/Classes/TreeList/TreeList.htm).


Правая часть компонента реализована диаграммой [PP.Ui.GantDiagram](../GantDiagram/GantDiagram.htm).


Пример использования диаграммы приведен на странице «[Пример
...
PP.initClass(PP.Ui.TreeGantDiagram, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.TreeGantDiagram");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 TreeGantDiagram
			 Конструктор TreeGantDiagram
			 создает экземпляр компонента TreeGantDiagram.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DTimelineEndTime](TreeGantDiagram.DTimelineEndTime.htm)
		 Свойство DTimelineEndTime
		 определяет конец временного отрезка диаграммы.


		 ![](../../Property_Image.gif)
		 [DTimelineStartTime](TreeGantDiagram.DTimelineStartTime.htm)
		 Свойство DTimelineStartTime
		 определяет начало временного отрезка диаграммы.


		 ![](../../Property_Image.gif)
		 [TColumns](TreeGantDiagram.TColumns.htm)
		 Свойство TColumns определяет
		 колонки для дерева диаграммы Ганта.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [clear](TreeGantDiagram.clear.htm)
		 Метод clear очищает
		 компонент от загруженных данных.


		 ![](../../Sub_Image.gif)
		 [getDiagram](TreeGantDiagram.getDiagram.htm)
		 Метод getDiagram возвращает
		 диаграмму Ганта.


		 ![](../../Sub_Image.gif)
		 [getSplitter](TreeGantDiagram.getSplitter.htm)
		 Метод getSplitter возвращает
		 компонент «[Разделитель](dhtmlUi.chm::/Components/Splitter/Splitter.htm)».


		 ![](../../Sub_Image.gif)
		 [getTreeList](TreeGantDiagram.getTreeList.htm)
		 Метод getTreeList возвращает
		 компонент «[Дерево
		 элементов](dhtmlUiTree.chm::/Components/TreeList/TreeList.htm)».


		 ![](../../Sub_Image.gif)
		 [loadFrom](TreeGantDiagram.loadFrom.htm)
		 Метод loadFrom загружает
		 данные в компонент.


		 ![](../../Sub_Image.gif)
		 [setTimeStep](TreeGantDiagram.setTimeStep.htm)
		 Метод setTimeStep устанавливает
		 шаг шкалы времени в диаграмме Ганта.
