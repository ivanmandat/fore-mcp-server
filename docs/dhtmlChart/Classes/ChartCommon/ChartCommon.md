...
Класс **ChartCommon** реализует
 страницу «Диаграмма» в [мастере
 для настройки диаграммы](../../Components/ChartMaster/ChartMaster.htm).


## Комментарии


Страница «Диаграмма» в мастере для настройки диаграммы выглядит следующим
 образом:
...
PP.initClass(PP.Ui.ChartCommon, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.ChartCommon");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [ChartCommon](dhtmlChart.chm::/Classes/ChartCommon/Constructor_ChartCommon.htm)
			 Конструктор ChartCommon
			 создает экземпляр класса ChartCommon.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ShowUnsupportedTypes](dhtmlChart.chm::/Classes/ChartCommon/ChartCommon.ShowUnsupportedTypes.htm)
		 Свойство **ShowUnsupportedTypes**
		 определяет, отображены ли в списке типов диаграммы неподдерживаемые
		 типы.
