...
Класс **RatingChart** реализует
 [рейтинговую диаграмму](../../Components/RatingChart/RatingChart.htm).


## Синтаксис


PP.initClass(PP.Ui.RatingChart, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.RatingChart");
