...
Класс **RatingChartHeader**
 реализует строку заголовков рейтинговой диаграммы.


## Синтаксис


PP.initClass(PP.Ui.RatingChartHeader, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.RatingChartHeader");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 **RatingChartHeader**
			 Конструктор **RatingChartHeader**
			 создает экземпляр класса **RatingChartHeader**.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Chart](RatingChartHeader.Chart.htm)
		 Свойство Chart определяет
		 рейтинговую диаграмму.


		 ![](../../Property_Image.gif)
		 [ExpandLastColumn](RatingChartHeader.ExpandLastColumn.htm)
		 Свойство ExpandLastColumn
		 определяет, будет ли последний столбец с текстом перекрывать следующий
		 столбец при нехватке места.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [draw](RatingChartHeader.draw.htm)
		 Метод draw перерисовывает
		 строку заголовков.


		 ![](../../Sub_Image.gif)
		 [getVisibleDataColumnWidth](RatingChartHeader.getVisibleDataColumnWidth.htm)
		 Метод getVisibleDataColumnWidth
		 возвращает ширину заголовка указанного столбца значений рейтинговой
		 диаграммы.


		 ![](../../Sub_Image.gif)
		 [getVisibleIndexColumnWidth](RatingChartHeader.getVisibleIndexColumnWidth.htm)
		 Метод getVisibleIndexColumnWidth
		 возвращает ширину заголовка столбца с номерами рядов данных.


		 ![](../../Sub_Image.gif)
		 [getVisibleMoveColumnWidth](RatingChartHeader.getVisibleMoveColumnWidth.htm)
		 Метод getVisibleMoveColumnWidth
		 возвращает ширину заголовка столбца изменения позиций рядов данных.


		 ![](../../Sub_Image.gif)
		 [getVisibleNameColumnWidth](RatingChartHeader.getVisibleNameColumnWidth.htm)
		 Метод getVisibleNameColumnWidth
		 возвращает ширину заголовка столбца наименований рядов данных.
