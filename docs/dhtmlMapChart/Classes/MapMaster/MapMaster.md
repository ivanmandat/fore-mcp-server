...
Класс MapMaster реализует компонент
 [MapMaster](../../Components/MapMaster/MapMaster.htm), представляющий
 собой мастер для работы с картой.


## Синтаксис


PP.initClass(PP.Ui.MapMaster,
 PP.Ui.[Master](dhtmlUi.chm::/Classes/Master/Master.htm),
 "PP.Ui.MapMaster", PP.Ui.IMasterView);
