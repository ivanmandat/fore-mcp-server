...
Класс
 **MapMaster.Visual3DPanel реализует
 панель «Индикатор объема» [мастера
...
Вернуть экземпляр класса MapMaster.AreaVisualPanel
 из мастера карты можно при помощи метода [MapMaster.getVisual3DPanel](../MapMaster/MapMaster.getVisual3DPanel.htm).


## Синтаксис


PP.initClass(PP.Ui.MapMaster.Visual3DPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapMaster.Visual3DPanel", PP.Ui.INotifySettingsChanged);
...
## События
			 ...
			 ![](../../Event_Image.gif)
			 [SettingChanged](MapMaster.Visual3DPanel.SettingChanged.htm)
			 **Событие
			 SettingChanged**
			 наступает при изменении настроек на панели мастера.


## Свойства, унаследованные от класса
 [MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm)
