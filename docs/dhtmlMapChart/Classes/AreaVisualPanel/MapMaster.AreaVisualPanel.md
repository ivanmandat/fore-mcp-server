...
Класс MapMaster.AreaVisualPanel
 реализует панель «Цвет» [мастера
...
Вернуть экземпляр класса MapMaster.AreaVisualPanel
 из мастера карты можно при помощи метода [MapMaster.getAreaVisualPanel](../MapMaster/MapMaster.getAreaVisualPanel.htm).
...
PP.initClass(PP.Ui.MapMaster.AreaVisualPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapMaster.AreaVisualPanel", PP.Ui.INotifySettingsChanged);
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [MapChart](dhtmlMapChart.chm::/Classes/AreaVisualPanel/MapMaster.AreaVisualPanel.MapChart.htm)
		 Свойство MapChart**
		 определяет карту, на которую будут действовать настройки на вкладке
		 «Цветовой индикатор».
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [SettingChanged](dhtmlMapChart.chm::/Classes/AreaVisualPanel/MapMaster.AreaVisualPanel.SettingChanged.htm)
		 Событие **SettingChanged**
		 наступает при изменении настроек панели.
