...
Класс MapSizeLegendPanel представляет
 собой панель «Легенда объёма» в [мастере
 для работы с картой](../MapMaster/MapMaster.htm).


## Комментарии


Панель «Легенда объёма» в мастере для работы с картой может выглядеть
 следующим образом:


![](MapSizeLegendPanel.png)


## Синтаксис


PP.initClass(PP.Ui.MapSizeLegendPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapSizeLegendPanel ", PP.Ui.INotifySettingsChanged);
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [MapSizeLegendPanel](Constructor_MapSizeLegendPanel.htm)
			 Конструктор MapSizeLegendPanel
			 создает экземпляр класса MapSizeLegendPanel.
