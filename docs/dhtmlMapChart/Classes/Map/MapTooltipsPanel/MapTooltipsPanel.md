...
Класс MapTooltipsPanel предназначен
 для создания панели мастера для работы с всплывающими подсказками.


## Синтаксис


PP.initClass(PP.Ui.MapTooltipsPanel, PP.Ui.VisualizerMasterTooltips,
 "PP.Ui.MapTooltipsPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 MapTooltipsPanel
		 Конструктор MapTooltipsPanel
		 создает экземпляр класса MapTooltipsPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [AutoMaskCheckboxVisible](MapTooltipsPanel.AutoMaskCheckboxVisible.htm)
