...
Класс MapTopobaseMeta представляет собой метаданные топоосновы карты.


## Синтаксис


PP.initClass(PP.MapTopobaseMeta, [PP.Object](dhtmlCommon.chm::/Classes/object/object.htm), "PP.MapTopobaseMeta");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapTopobaseMeta](dhtmlMapChart.chm::/Classes/Map/MapTopobaseMeta/Constructor_MapTopobaseMeta.htm)
		 Конструктор MapTopobaseMeta
		 создает экземпляр класса MapTopobaseMeta.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Attribute](dhtmlMapChart.chm::/Classes/Map/MapTopobaseMeta/MapTopobaseMeta.Attribute.htm)
		 Свойство Attribute
		 определяет атрибут для метаданных топоосновы карты.


		 ![](../../../Property_Image.gif)
		 [Geo](dhtmlMapChart.chm::/Classes/Map/MapTopobaseMeta/MapTopobaseMeta.Geo.htm)
		 Свойство Geo определяет
		 массив объектов связи географических координат с координатами
		 топоосновы.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getAttributeData](dhtmlMapChart.chm::/Classes/Map/MapTopobaseMeta/MapTopobaseMeta.getAttributeData.htm)
		 Метод getAttributeData
		 возвращает объект данных атрибута по наименованию атрибута и идентификатору
		 объекта.


		 ![](../../../Sub_Image.gif)
		 [getAttributeDataValue](dhtmlMapChart.chm::/Classes/Map/MapTopobaseMeta/MapTopobaseMeta.getAttributeDataValue.htm)
		 Метод getAttributeDataValue
		 возвращает значение объекта данных атрибута по наименованию атрибута
		 и идентификатору объекта.


		 ![](../../../Sub_Image.gif)
		 [parseFromXml](dhtmlMapChart.chm::/Classes/Map/MapTopobaseMeta/MapTopobaseMeta.parseFromXml.htm)
		 Метод parseFromXml
		 выполняет анализ данных указанного DOM-элемента или строки.


		 ![](../../../Sub_Image.gif)
		 [setGeoItem](dhtmlMapChart.chm::/Classes/Map/MapTopobaseMeta/MapTopobaseMeta.setGeoItem.htm)
		 Метод setGeoItem устанавливает
		 объект связи географических координат с координатами топоосновы
		 карты.
...
[Классы для работы с DHTML-картой](../Map_Classes.htm)
