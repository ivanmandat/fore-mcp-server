...
Класс MapLabel реализует подписи
 данных.
...
Подписи данных могут быть настроены для [слоя](../../../Components/MapChart/xml_specification/MapChart/MapLayers/Layers_exmpl.htm)
 или для [области](../../../Components/MapChart/xml_specification/MapChart/MapShapes/MapShapes_exmpl.htm)
 карты.
...
PP.initClass(PP.MapLabel, PP.Ui.ChartSVGLabel, "PP.MapLabel");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setBorderColor](MapLabel.setBorderColor.htm)
		 Метод setBorderColor
		 устанавливает цвет границы подписи данных.
