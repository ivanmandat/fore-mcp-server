...
Класс MapMarker предназначен
 для работы с меткой на карте.


## Синтаксис


PP.initClass(PP.MapMarker, [PP.MapVisualItem](../MapVisualItem/MapVisualItem.htm),
 "PP.MapMarker");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapMarker](Constructor_MapMarker.htm)
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getToolTipColor](MapMarker.getToolTipColor.htm)
