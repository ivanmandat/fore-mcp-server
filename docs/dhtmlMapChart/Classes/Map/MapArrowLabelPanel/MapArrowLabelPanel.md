...
Класс MapArrowLabelPanel предназначен
 для работы с настройками [подписей
...
PP.initClass(PP.Ui.MapArrowLabelPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapArrowLabelPanel", PP.Ui.INotifySettingsChanged);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapArrowLabelPanel](Constructor_MapArrowLabelPanel.htm)
		 Конструктор MapArrowLabelPanel
		 создает экземпляр класса MapArrowLabelPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [AreMetricsOn](MapArrowLabelPanel.AreMetricsOn.htm)
		 Свойство AreMetricsOn определяет
		 признак использования метрик в панели мастера.
