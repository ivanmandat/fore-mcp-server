...
Класс MapBarVisualPanel предназначен
 для создания панели мастера для работы со столбиковым показателем.
...
PP.initClass(PP.Ui.MapBarVisualPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapBarVisualPanel", PP.Ui.INotifySettingsChanged);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapBarVisualPanel](Constructor_MapBarVisualPanel.htm)
		 Конструктор MapBarVisualPanel
		 создает экземпляр класса MapBarVisualPanel.
