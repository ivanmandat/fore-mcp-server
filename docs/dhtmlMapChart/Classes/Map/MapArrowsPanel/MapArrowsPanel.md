...
Класс MapArrowsPanel предназначен
 для создания панели мастера для работы со стрелками на карте.


## Синтаксис


PP.initClass(PP.Ui.MapArrowsPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapArrowsPanel", PP.Ui.INotifySettingsChanged);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapArrowsPanel](Constructor_MapArrowsPanel.htm)
		 Конструктор MapArrowsPanel
		 создает экземпляр класса MapArrowsPanel.
