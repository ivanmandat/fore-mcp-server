...
[MapContentMilestone](../MapContentMilestone/MapContentMilestone.htm)
...
Класс MapImageMilestone реализует
...
PP.initClass(PP.MapImageMilestone, PP.[MapContentMilestone](../MapContentMilestone/MapContentMilestone.htm),
 "MapImageMilestone");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapImageMilestone](Constructor_MapImageMilestone.htm)
		 Конструктор MapImageMilestone
		 реализует экземпляр класса MapImageMilestone.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Height](MapImageMilestone.Height.htm)
		 Свойство Height устанавливает
		 высоту изображения.


		 ![](../../../Property_Image.gif)
		 [Source](MapImageMilestone.Source.htm)
		 Свойство Source устанавливает
		 путь к файлу с изображением.


		 ![](../../../Property_Image.gif)
		 [Width](MapImageMilestone.Width.htm)
		 Свойство Width устанавливает
		 ширину изображения.


## Свойства, унаследованные от класса [MapContentMilestone](../MapContentMilestone/MapContentMilestone.htm)
