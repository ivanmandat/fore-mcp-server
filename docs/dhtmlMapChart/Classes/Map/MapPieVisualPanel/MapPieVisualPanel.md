...
Класс MapPieVisualPanel предназначен
 для создания панели мастера для работы с круговым показателем.


## Синтаксис


PP.initClass(PP.Ui.MapBarVisualPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapPieVisualPanel", PP.Ui.INotifySettingsChanged);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapPieVisualPanel](Constructor_MapPieVisualPanel.htm)
		 Конструктор MapPieVisualPanel
		 создает экземпляр класса MapPieVisualPanel.
