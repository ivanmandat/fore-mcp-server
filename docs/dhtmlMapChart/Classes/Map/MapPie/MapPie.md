...
Класс MapPie предназначен для
 работы с круговым показателем.


## Синтаксис


PP.initClass(PP.MapPie, [PP.MapVisualItem](../MapVisualItem/MapVisualItem.htm),
 "PP.MapPie");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapPie](Constructor_MapPie.htm)
		 Конструктор MapPie создаёт
		 экземпляр класса MapPie.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [BorderThickness](MapPie.BorderThickness.htm)
		 Свойство BorderThickness
		 устанавливает толщину границы секторов в пикселях.


		 ![](../../../Property_Image.gif)
		 [HideNoData](MapPie.HideNoData.htm)
		 Свойство HideNoData
		 определяет, требуется ли скрывать сектора с нулевым значением.


		 ![](../../../Property_Image.gif)
		 [IsProportional](MapPie.IsProportional.htm)
		 Свойство IsProportional
		 определяет, равны ли углы секторов круговой диаграммы между собой.


		 ![](../../../Property_Image.gif)
		 [LeastAnglePart](MapPie.LeastAnglePart.htm)
		 Свойство LeastAnglePart
		 определяет размер сектора с минимальным значением в градусах.


		 ![](../../../Property_Image.gif)
		 [LeastRadiusPart](MapPie.LeastRadiusPart.htm)
		 Свойство LeastRadiusPart
		 определяет радиус сектора с минимальным значением в градусах.


		 ![](../../../Property_Image.gif)
		 [MaxPiesCount](MapPie.MaxPiesCount.htm)
		 Свойство MaxPiesCount
		 определяет максимальное количество сегментов в круговом показателе.


		 ![](../../../Property_Image.gif)
		 [StartAngle](MapPie.StartAngle.htm)
		 Свойство StartAngle
		 определяет угол поворота первого сектора кругового показателя.


		 ![](../../../Property_Image.gif)
		 [UseInvertedAngles](MapPie.UseInvertedAngles.htm)
		 Свойство UseInvertedAngles
		 определяет признак того, инвертирован ли угол поворота первого
		 сегмента кругового показателя.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getToolTipColor](MapPie.getToolTipColor.htm)
		 Метод getToolTipColor
		 возвращает цвет границы всплывающей подсказки.


		 ![](../../../Sub_Image.gif)
		 [isMeta](MapPie.isMeta.htm)
		 Метод isMeta возвращает
		 признак наличия нескольких сопоставлений данных у кругового показателя.
