...
Класс MapMarkerVisualPanel предназначен
 для создания панели мастера для работы с маркерами на карте.


## Синтаксис


PP.initClass(PP.Ui.MapMarkerVisualPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapMarkerVisualPanel", PP.Ui.INotifySettingsChanged);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapMarkerVisualPanel](Constructor_MapMarkerVisualPanel.htm)
		 Конструктор MapMarkerVisualPanel
		 создает экземпляр класса MapMarkerVisualPanel.
