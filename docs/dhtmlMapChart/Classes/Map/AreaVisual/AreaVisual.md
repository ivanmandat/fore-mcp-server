...
Класс AreaVisual реализует территориальный
 показатель.
...
PP.initClass(PP.AreaVisual, [PP.Visual](dhtmlGraphicBase.chm::/Classes/PP/Visual/Visual.htm),
 'PP.AreaVisual');
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [AreaVisual](Constructor_AreaVisual.htm)
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [ColorMapping](AreaVisual.ColorMapping.htm)
		 Свойство ColorMappings
		 определяет настройки сопоставления данных цвету заливки элементов
		 территориального показателя.


		 ![](../../../Property_Image.gif)
		 [HeightMapping](AreaVisual.HeightMapping.htm)
		 Свойство HeightMapping
		 определяет настройки сопоставления данных высоте элементов территориального
		 показателя.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getFirstDataSource](AreaVisual.getFirstDataSource.htm)
		 Метод getFirstDataSource
		 возвращает источник для первого сопоставления данных территориального
		 показателя.
