...
Класс MapArrowVisualPanel предназначен
 для создания панели мастера для работы со стрелкой на карте.


## Синтаксис


PP.initClass(PP.Ui.MapArrowVisualPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapArrowVisualPanel", PP.Ui.INotifySettingsChanged);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapArrowVisualPanel](Constructor_MapArrowVisualPanel.htm)
		 Конструктор MapArrowVisualPanel
		 создает экземпляр класса MapArrowVisualPanel.
