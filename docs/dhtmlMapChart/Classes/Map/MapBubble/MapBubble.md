...
Класс MapBubble предназначен
 для работы с пузырьковым показателем.


## Синтаксис


PP.initClass(PP.MapBubble, [PP.MapVisualItem](../MapVisualItem/MapVisualItem.htm),
 "PP.MapBubble");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapBubble](Constructor_MapBubble.htm)
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [LeastSizePart](MapBubble.LeastSizePart.htm)
		 Свойство LeastSizePart
		 определяет диаметр пузырька с минимальным значением.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getToolTipColor](MapBubble.getToolTipColor.htm)
