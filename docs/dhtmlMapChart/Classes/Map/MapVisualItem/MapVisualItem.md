...
Класс MapVisualItem предназначен
 для работы с показателем области слоя карты.


## Комментарии


Для областей слоя карты доступны следующие показатели:


	- [BarVisual](../BarVisual/BarVisual.htm).
	 Столбиковый показатель;


	- [MapBubble](../MapBubble/MapBubble.htm).
	 Пузырьковый показатель;


	- [MapPie](../MapPie/MapPie.htm).
	 Круговой показатель.
...
PP.initClass(PP.MapVisualItem, [PP.Object](dhtmlCommon.chm::/Classes/object/object.htm),
 "PP.MapVisualItem");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MapVisualItem](Constructor_MapVisualItem.htm)
		 Конструктор MapVisualItem
		 создает экземпляр класса MapVisualItem.
