...
Элемент MapFilledArrow содержит
 описание стрелки с заливкой. Cтрелка с заливкой - экземпляр класса
 [MapFilledArrow](../../../../../Classes/Map/MapFilledArrow/MapFilledArrow.htm).


[Пример настройки стрелок](Arrow_exmpl.htm)


## Атрибуты элемента <MapFilledArrow>
