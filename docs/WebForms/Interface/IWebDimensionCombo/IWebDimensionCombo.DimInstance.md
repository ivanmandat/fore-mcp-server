...
Для выполнения примера в репозитории предполагается наличие справочника
 ...
 на ней компонента DimensionCombo с наименованием DimensionCombo1. Указанная
...
При запуске веб-формы к компоненту DimensionCombo1 будет подключен указанный
...
[IWebDimensionCombo](IWebDimensionCombo.htm)
