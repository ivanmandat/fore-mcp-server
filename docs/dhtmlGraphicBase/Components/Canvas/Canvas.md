...
Канва (canvas) - это элемент в HTML 5, предназначенный для создания
 растрового двумерного изображения при помощи программирования (обычно
 на языке JavaScript).


Компонент реализован классом [Canvas](../../Classes/Canvas/Canvas.htm).


## Пример


[Пример создания компонента Canvas](Example_Canvas.htm)
...
## Конструктор
		 ...
		 ![](../../sub_image.gif)
		 [Canvas](dhtmlGraphicBase.chm::/Classes/Canvas/Constructor_Canvas.htm)
		 Конструктор Canvas
		 создает экземпляр компонента [Canvas](dhtmlGraphicBase.chm::/Components/Canvas/Canvas.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [GlobalOpacity](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.GlobalOpacity.htm)
		 Свойство GlobalOpacity
		 устанавливает глобальную прозрачность элементам канвы.


		 ![](../../Property_Image.gif)
		 [StrokeDashArray](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.StrokeDashArray.htm)
		 Свойство StrokeDashArray
		 устанавливает способ отображения линий на канве.


		 ![](../../Property_Image.gif)
		 [StrokeWidth](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.StrokeWidth.htm)
		 Свойство StrokeWidth
		 устанавливает толщину границ элементов канвы.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [beginPath](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.beginPath.htm)
		 Метод beginPath инициализирует
		 начало отрисовки полилинии.


		 ![](../../sub_image.gif)
		 [clear](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.clear.htm)
		 Метод clear очищает
		 канву.


		 ![](../../sub_image.gif)
		 [drawCircle](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.drawCircle.htm)
		 Метод drawCircle рисует
		 окружность на канве.


		 ![](../../sub_image.gif)
		 [drawLine](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.drawLine.htm)
		 Метод drawLine рисует
		 линию на канве.


		 ![](../../sub_image.gif)
		 [drawPoly](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.drawPoly.htm)
		 Метод drawPoly рисует
		 полилинию на канве.


		 ![](../../sub_image.gif)
		 [drawRect](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.drawRect.htm)
		 Метод drawLine рисует
		 прямоугольник на канве.


		 ![](../../sub_image.gif)
		 [endPath](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.endPath.htm)
		 Метод endPath заканчивает
		 отрисовку полилинии.


		 ![](../../sub_image.gif)
		 [flush](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.flush.htm)
		 Метод flush вызывается
		 после отрисовки элементов на канве для их отображения.


		 ![](../../sub_image.gif)
		 [getContext](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.getContext.htm)
		 Метод getContext возвращает
		 контекст канвы.


		 ![](../../sub_image.gif)
		 [setBounds](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.setBounds.htm)
		 Метод setBounds устанавливает
		 границы канвы.


		 ![](../../sub_image.gif)
		 [setFillStyle](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.setFillStyle.htm)
		 Метод setFillStyle
		 устанавливает стиль заливки элементов канвы.


		 ![](../../sub_image.gif)
		 [setStrokeStyle](dhtmlGraphicBase.chm::/Classes/Canvas/Canvas.setStrokeStyle.htm)
		 Метод setStrokeStyle
		 устанавливает стиль границ элементов канвы.
