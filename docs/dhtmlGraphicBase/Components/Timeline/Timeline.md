...
Компонент Timeline представляет
 собой временную шкалу.


## Комментарии


Компонент Timelineреализован
 классом [Timeline](../../Classes/Timeline/Timeline.htm).


Временная шкала используется в компонентах [BubbleChart](dhtmlBubbleChart.chm::/Components/BubbleChart/BubbleChart.htm),
 [BubbleTree](dhtmlBubbleTree.chm::/Components/BubbleTree/BubbleTree.htm),
 [RatingChart](dhtmlChart.chm::/Components/RatingChart/RatingChart.htm),
...
[Пример создания компонента Timeline](Timeline_Example.htm)
