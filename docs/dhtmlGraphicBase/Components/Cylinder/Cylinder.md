...
Компонент Cylinder представляет
 собой цилиндр.
...
Компонент Cylinder реализован
 классом [Cylinder](../../Classes/Cylinder/Cylinder/Cylinder.htm).


Компонент предназначен для визуального представления значения метрики.
 Для отображения значений используются [оси
 цилиндра](../../Classes/Cylinder/CylinderGaugeAxis/CylinderGaugeAxis.htm), у которых можно установить [максимальное
 и минимальное значения](../../Classes/Cylinder/CylinderGaugeAxis/CylinderGaugeAxis.setValuesByMinAndMax.htm), [автоматически
 рассчитать метки шкалы](../../Classes/Cylinder/CylinderGaugeAxis/CylinderGaugeAxis.autoCalcLabels.htm), поменять [стиль
 основных](../../Classes/Cylinder/CylinderGaugeAxis/CylinderGaugeAxis.MajorTickStyle.htm) и стиль [проимежуточных
 меток](../../Classes/Cylinder/CylinderGaugeAxis/CylinderGaugeAxis.MinorTickStyle.htm), задать [режим
 построения меток](../../Classes/Cylinder/CylinderGaugeAxis/CylinderGaugeAxis.ValuesMode.htm) и установить [пользовательские
 значения](../../Classes/Cylinder/CylinderGaugeAxis/CylinderGaugeAxis.Values.htm).


Компонент содержит[
 линию тренда](../../Classes/Cylinder/CylinderTrend/CylinderTrend.htm), у которой можно установить [цвет](../../Classes/Cylinder/CylinderTrend/CylinderTrend.Color.htm),
 [длину](../../Classes/Cylinder/CylinderTrend/CylinderTrend.Length.htm),
 [стиль
 линии](../../Classes/Cylinder/CylinderTrend/CylinderTrend.LineStyle.htm) и [стиль
 метки](../../Classes/Cylinder/CylinderTrend/CylinderTrend.LabelStyle.htm).


Для управления заголовком цилиндра присутствует класс [CylinderHeader](../../Classes/Cylinder/CylinderHeader/CylinderHeader.htm).


## Пример


Компонент Cylinder может иметь
 следующий вид:
...
[Пример создания компонента Cylinder](Cylinder_Example.htm)
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [Cylinder](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Constructor_Cylinder.htm)
			 Конструктор Cylinder создает
			 экземпляр класса Cylinder.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AnimationDuration](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.AnimationDuration.htm)
		 Свойство AnimationDuration
		 определяет длительность воспроизведения анимации цилиндра.


		 ![](../../Property_Image.gif)
		 [Axis](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.Axis.htm)
		 Свойство Axis определяет
		 ось цилиндра.


		 ![](../../Property_Image.gif)
		 [CylinderHeaderStyle](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.CylinderHeaderStyle.htm)
		 Свойство CylinderHeaderStyle
		 определяет стиль заголовка цилиндра.


		 ![](../../Property_Image.gif)
		 [FlaskHeight](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.FlaskHeight.htm)
		 Свойство FlaskHeight
		 определяет высоту цилиндра.


		 ![](../../Property_Image.gif)
		 [FlaskWidth](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.FlaskWidth.htm)
		 Свойство FlaskWidth
		 определяет ширину цилиндра.


		 ![](../../Property_Image.gif)
		 [Header](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.Header.htm)
		 Свойство Header определяет
		 заголовок цилиндра.


		 ![](../../Property_Image.gif)
		 [IsFlat](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.IsFlat.htm)
		 Свойство IsFlat определяет
		 признак объемности цилиндра.


		 ![](../../Property_Image.gif)
		 [IsRelativeDimensions](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.IsRelativeDimensions.htm)
		 Свойство IsRelativeDimensions
		 определяет, являются ли внутренние размеры элементов цилиндра
		 относительными.


		 ![](../../Property_Image.gif)
		 [Orientation](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.Orientation.htm)
		 Свойство Orientation
		 определяет ориентацию цилиндра.


		 ![](../../Property_Image.gif)
		 [Trends](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.Trends.htm)
		 Свойство Trends определяет
		 массив линий тренда цилиндра.


		 ![](../../Property_Image.gif)
		 [UseAnimation](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.UseAnimation.htm)
		 Свойство UseAnimation
		 определяет признак использования анимации при отображении цилиндра.


		 ![](../../Property_Image.gif)
		 [Values](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.Values.htm)
		 Свойство Values определяет
		 массив значений цилиндра.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [draw](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.draw.htm)
		 Метод draw отрисовывает
		 цилиндр.


		 ![](../../sub_image.gif)
		 [getSVGNode](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.getSVGNode.htm)
		 Метод getSVGNode возвращает
		 SVG-элемент, предназначенный для отрисовки цилиндра.


		 ![](../../sub_image.gif)
		 [redraw](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.redraw.htm)
		 Метод redraw перерисовывает
		 цилиндр.


		 ![](../../sub_image.gif)
		 [redrawValues](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.redrawValues.htm)
		 Метод redrawValues
		 перерисовывает значения оси цилиндра.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Loaded](dhtmlGraphicBase.chm::/Classes/Cylinder/Cylinder/Cylinder.Loaded.htm)
		 Событие Loaded**
		 наступает после загрузки цилиндра.
