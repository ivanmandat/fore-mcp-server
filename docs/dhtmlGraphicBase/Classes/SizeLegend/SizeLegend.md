...
Класс SizeLegend реализует
 легенду, предназначенную для описания размеров элементов визуализатора.


## Комментарии


Легенда может выглядеть следующим образом:
...
PP.initClass(PP.Ui.SizeLegend, [PP.Ui.LegendBase](../LegendBase/LegendBase.htm),
 "PP.Ui.SizeLegend");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [SizeLegend](dhtmlGraphicBase.chm::/classes\SizeLegend\constructor_SizeLegend.htm)
			 Конструктор SizeLegend**
			 создает экземпляр класса **SizeLegend**.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Marker](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.Marker.htm)
		 Свойство Marker
		 определяет форму маркеров легенды.


		 ![](../../Property_Image.gif)
		 [MarkerBorderThickness](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MarkerBorderThickness.htm)
		 Свойство MarkerBorderThickness
		 определяет толщину границ маркеров.


		 ![](../../Property_Image.gif)
		 [MarkerColor](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MarkerColor.htm)
		 Свойство MarkerColor определяет
		 цвет маркеров.


		 ![](../../Property_Image.gif)
		 [MarkerSpacing](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MarkerSpacing.htm)
		 Свойство MarkerSpacing определяет
		 отступ маркеров друг от друга.


		 ![](../../Property_Image.gif)
		 [MaxRadius](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MaxRadius.htm)
		 Свойство MaxRadius определяет
		 максимальный радиус маркера.


		 ![](../../Property_Image.gif)
		 [MaxValue](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MaxValue.htm)
		 ...
		 Свойство MaxValueFormat определяет
		 формат записи максимального значения маркера.


		 ![](../../Property_Image.gif)
		 [MinRadius](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MinRadius.htm)
		 Свойство MinRadius определяет
		 минимальный радиус маркера.


		 ![](../../Property_Image.gif)
		 [MinValue](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MinValue.htm)
		 Свойство MinValue определяет
		 минимальное значение маркера.


		 ![](../../Property_Image.gif)
		 [MinValueFormat](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.MinValueFormat.htm)
		 Свойство MinValueFormat определяет
		 формат записи максимального значения маркера.


		 ![](../../Property_Image.gif)
		 [TextSpacing](dhtmlGraphicBase.chm::/Classes/SizeLegend/SizeLegend.TextSpacing.htm)
		 Свойство TextSpacing определяет
		 отступ текста от маркеров.
