...
Класс Timeline** реализует [временную
 шкалу](../../Components/Timeline/Timeline.htm).


## Синтаксис


PP.initClass(PP.Ui.Timeline, PP.Ui.PlacedControlBase,
 "PP.Ui.Timeline");
...
## Конструктор
				 ...
				 ![](../../sub_image.gif)
				 [Timeline](dhtmlGraphicBase.chm::/Classes/Timeline/Constructor_Timeline.htm)
				 Конструктор Timeline
				 создает экземпляр класса Timeline.
...
## Свойства
		 ...
		 Свойство **CurrentStep** устанавливает и возвращает индекс
		 текущего шага анимации.


		 ![](../../Property_Image.gif)
		 [DelayDuration](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.DelayDuration.htm)
		 Свойство **DelayDuration** устанавливает и возвращает длительность
		 ...
		 ![](../../Property_Image.gif)
		 [LastIndexAsInitial](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.LastIndexAsInitial.htm)
		 ...
		 Свойство ReturnToInitialState
		 устанавливает признак возврата временной шкалы в начальное состояние.


		 ![](../../Property_Image.gif)
		 [ScrollSpeed](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.ScrollSpeed.htm)
		 Свойство **ScrollSpeed**
		 устанавливает скорость прокрутки временной шкалы.


		 ![](../../Property_Image.gif)
		 [StepDuration](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.StepDuration.htm)
		 Свойство StepDuration
		 устанавливает и возвращает длительность шага анимации в миллисекундах.


		 ![](../../Property_Image.gif)
		 [StepsNames](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.StepsNames.htm)
		 Свойство **StepsNames**
		 устанавливает и возвращает массив наименований шагов анимации.


		 ![](../../Property_Image.gif)
		 [StepsVisibility](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.StepsVisibility.htm)
		 Свойство **StepsVisibility**
		 устанавливает и возвращает массив признаков видимости шагов анимации.


		 ![](../../Property_Image.gif)
		 [TickIndex](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.TickIndex.htm)
		 Свойство **TickIndex**
		 устанавливает и возвращает индекс текущего шага анимации.


		 ![](../../Property_Image.gif)
		 [Ticks](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.Ticks.htm)
		 Свойство **Ticks**
		 устанавливает и возвращает массив наименований шагов анимации.


		 ![](../../Property_Image.gif)
		 [ValueChangedWithTimeout](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.ValueChangedWithTimeout.htm)
		 Свойство ValueChangedWithTimeout
		 устанавливает и возвращает признак того, что текущий шаг временной
		 шкалы изменяется по истечению времени.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [addTick](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.addTick.htm)
		 Метод addTick добавляет
		 шаг в шкалу времени.


		 ![](../../sub_image.gif)
		 [beginUpdate](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.beginUpdate.htm)
		 Метод beginUpdate отключает
		 перерисовку временной шкалы до тех пор, пока не будет вызван метод
		 [endUpdate](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.endUpdate.htm).


		 ![](../../sub_image.gif)
		 [endUpdate](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.endUpdate.htm)
		 Метод endUpdate включает
		 перерисовку временной шкалы и обновляет её.


		 ![](../../sub_image.gif)
		 [getIsStarted](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.getIsStarted.htm)

		 Метод **getIsStarted**
		 возвращает признак того, что воспроизведение анимации запущено.


		 ![](../../sub_image.gif)
		 [pause](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.pause.htm)

		 Метод **pause**
		 приостанавливает воспроизведение анимации временной шкалы.


		 ![](../../sub_image.gif)
		 [play](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.play.htm)
		 ...
		 ![](../../sub_image.gif)
		 [refresh](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.refresh.htm)
		 Метод **refresh**
		 обновляет временную шкалу.


		 ![](../../sub_image.gif)
		 [removeTick](dhtmlGraphicBase.chm::/Classes/Timeline/TimeLine.removeTick.htm)
		 Метод removeTick удаляет
		 шаг из временной шкалы по имени или индексу.


		 ![](../../sub_image.gif)
		 [resume](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.resume.htm)

		 Метод **resume**
		 продолжает воспроизведение анимации временной школы после её [приостановки](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.pause.htm).


		 ![](../../sub_image.gif)
		 [stop](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.stop.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Finished](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.Finished.htm)

		 Событие **Finished**
		 наступает при завершении воспроизведения анимации временной шкалы.


		 ![](../../Event_Image.gif)
		 [Paused](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.Paused.htm)

		 Событие **Paused**
		 наступает при наступлении паузы воспроизведения анимации временной
		 шкалы.


		 ![](../../Event_Image.gif)
		 [Started](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.Started.htm)

		 Событие **Started**
		 наступает при запуске воспроизведения анимации временной шкалы.


		 ![](../../Event_Image.gif)
		 [TicksChanged](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.TicksChanged.htm)
		 Событие TicksChanged
		 наступает после изменения шагов временной шкалы.


		 ![](../../Event_Image.gif)
		 [TicksChanging](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.TicksChanging.htm)
		 Событие TicksChanging
		 наступает во время изменения шагов временной шкалы.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlGraphicBase.chm::/Classes/Timeline/Timeline.ValueChanged.htm)
