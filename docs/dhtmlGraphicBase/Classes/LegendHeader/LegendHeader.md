...
Класс LegendHeader реализует
 верхний текст легенды.


## Синтаксис


PP.initClass(PP.Ui.LegendHeader, [PP.Ui.ChartLabel](dhtmlChart.chm::/Classes/ChartLabel/ChartLabel.htm),
 "PP.Ui.LegendHeader");
...
## Конструктор
				 ...
				 ![](../../sub_image.gif)
				 [LegendHeader](dhtmlGraphicBase.chm::/Classes/LegendHeader/Constructor_LegendHeader.htm)
				 Конструктор LegendHeader
				 создает экземпляр класса LegendHeader.
