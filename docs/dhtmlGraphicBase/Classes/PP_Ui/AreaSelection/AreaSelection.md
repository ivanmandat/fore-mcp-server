...
PP.initClass(PP.Ui.AreaSelection, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.AreaSelection");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [AreaSelection](Constructor_AreaSelection.htm)
		 Конструктор AreaSelection
		 создает экземпляр класса AreaSelection.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Aspect](AreaSelection.Aspect.htm)
		 Свойство Aspect устанавливает
		 отношение ширины рамки выделения к ее высоте.


		 ![](../../../Property_Image.gif)
		 [CornerSize](AreaSelection.CornerSize.htm)
		 Свойство CornerSize определяет
		 размер уголков рамки выделения в режиме [PP.Ui.AreaSelectionType.Cornered](../../../Enums/AreaSelectionType.htm).


		 ![](../../../Property_Image.gif)
		 [MinSize](AreaSelection.MinSize.htm)
		 Свойство MinSize определяет
		 минимальное значение ширины или высоты рамки, при котором выделение
		 отображается.


		 ![](../../../Property_Image.gif)
		 [Path](AreaSelection.Path.htm)
		 Свойство Path определяет
		 форму рамки выделения в режиме [PP.Ui.AreaSelectionType.FreeForm](../../../Enums/AreaSelectionType.htm).


		 ![](../../../Property_Image.gif)
		 [Type](AreaSelection.Type.htm)
		 Свойство Type определяет
		 форму рамки выделения.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [end](AreaSelection.end.htm)
		 Метод end завершает отрисовку рамки выделения.


		 ![](../../../sub_image.gif)
		 [start](AreaSelection.start.htm)
		 Метод start начинает
		 отрисовку рамки выделения.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [MouseMove](AreaSelection.MouseMove.htm)
		 Событие MouseMove наступает
...
[PP.Ui](dhtml.chm::/Classes/Classes_library.htm)
