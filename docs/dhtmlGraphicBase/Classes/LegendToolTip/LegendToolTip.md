...
Класс LegendToolTip реализует
 всплывающую подсказу легенды.


## Синтаксис


PP.initClass(PP.Ui.LegendToolTip, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.LegendToolTip");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [LegendToolTip](dhtmlGraphicBase.chm::/Classes/LegendToolTip/Constructor_LegendToolTip.htm)
			 Конструктор LegendToolTip
			 создает экземпляр класса LegendToolTip.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [LTRB](dhtmlGraphicBase.chm::/Classes/LegendToolTip/LegendToolTip.LTRB.htm)
		 Свойство LTRB
		 определяет поворот всплывающей подсказки.


		 ![](../../Property_Image.gif)
		 [MaskText](dhtmlGraphicBase.chm::/Classes/LegendToolTip/LegendToolTip.MaskText.htm)
		 Свойство MaskText
		 определяет маску текста всплывающей подсказки.


		 ![](../../Property_Image.gif)
		 [Padding](dhtmlGraphicBase.chm::/Classes/LegendToolTip/LegendToolTip.Padding.htm)
		 Свойство Padding
		 определяет поля всплывающей подсказки.


		 ![](../../Property_Image.gif)
		 [TextWrapping](dhtmlGraphicBase.chm::/Classes/LegendToolTip/LegendToolTip.TextWrapping.htm)
		 Свойство TextWrapping
		 определяет перенос текста элементов всплывающей подсказки.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [draw](dhtmlGraphicBase.chm::/Classes/LegendToolTip/LegendToolTip.draw.htm)
		 Метод draw отрисовывает
		 всплывающую подсказку.


		 ![](../../sub_image.gif)
		 [setCoords](dhtmlGraphicBase.chm::/Classes/LegendToolTip/LegendToolTip.setCoords.htm)
		 Метод setCoords
		 устанавливает новое положение подсказки по указанным координатам.


		 ![](../../sub_image.gif)
		 [setMargin](dhtmlGraphicBase.chm::/Classes/LegendToolTip/LegendToolTip.setMargin.htm)
		 Метод setMargin устанавливает
		 отступы элемента подсказки.
