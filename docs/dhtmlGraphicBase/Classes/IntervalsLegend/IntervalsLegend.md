...
[PlacedControlBase](../PlacedControlBase/PlacedControlBase.htm)


[LegendBase](../LegendBase/LegendBase.htm)


[ColorLegendBase](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.htm)
...
Класс IntervalsLegend реализует
 легенду визуализатора, имеющую интервалы.


## Синтаксис


PP.initClass(PP.Ui.IntervalsLegend, [PP.Ui.ColorLegendBase](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.htm),
 "PP.Ui.IntervalsLegend");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [IntervalsLegend](Constructor_IntervalsLegend.htm)
			 Конструктор IntervalsLegend
			 создает экземпляр класса IntervalsLegend.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AllowMultipleSelection](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.AllowMultipleSelection.htm)
		 Свойство AllowMultipleSelection
		 определяет возможность множественной отметки элементов легенды.


		 ![](../../Property_Image.gif)
		 [AutoColumnsCount](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.AutoColumnsCount.htm)
		 Свойство AutoColumnsCount
		 определяет автоматический расчет количества столбцов элементов
		 легенды.


		 ![](../../Property_Image.gif)
		 [CellAutoColor](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.CellAutoColor.htm)
		 Свойство CellAutoColor определяет
		 цвет шрифта элементов легенды.


		 ![](../../Property_Image.gif)
		 [CellBorder](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.CellBorder.htm)
		 Свойство CellBorder
		 определяет рамку элементов легенды.


		 ![](../../Property_Image.gif)
		 [CellPadding](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.CellPadding.htm)
		 Свойство CellPadding
		 определяет поля элементов легенды.


		 ![](../../Property_Image.gif)
		 [CellSpacing](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.CellSpacing.htm)
		 Свойство CellSpacing
		 определяет отступы между элементами легенды.


		 ![](../../Property_Image.gif)
		 [ColorApplying](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.ColorApplying.htm)
		 Свойство ColorApplying
		 определяет режим цветовой визуализации интервальной легенды.


		 ![](../../Property_Image.gif)
		 [ColumnsCount](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.ColumnsCount.htm)
		 Свойство ColumnsCount
		 определяет количество столбцов элементов легенды.


		 ![](../../Property_Image.gif)
		 [CurrentPage](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.CurrentPage.htm)
		 Свойство CurrentPage определяет текущую
		 страницу легенды.


		 ![](../../Property_Image.gif)
		 [Descending](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.Descending.htm)
		 Свойство Descending
		 определяет признак сортировки элементов легенды по убыванию.


		 ![](../../Property_Image.gif)
		 [IncludeEquals](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.IncludeEquals.htm)
		 Свойство IncludeEquals
		 определяет признак необходимости отображения элементов легенды
		 "ровно".


		 ![](../../Property_Image.gif)
		 [Items](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.ColorsNames.htm)
		 Свойство Items определяет
		 сопоставления названий элементов цветам элементов легенды.


		 ![](../../Property_Image.gif)
		 [ItemsOrder](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.ItemsOrder.htm)
		 Свойство ItemsOrder определяет
		 порядок отображения элементов в легенде.


		 ![](../../Property_Image.gif)
		 [Marker](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.Marker.htm)
		 Свойство Marker
		 определяет форму маркеров элементов легенды.


		 ![](../../Property_Image.gif)
		 [MarkersAtRight](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.MarkersAtRight.htm)
		 Свойство MarkersAtRight
		 определяет признак отображения маркеров элементов легенды справа
		 от текста.


		 ![](../../Property_Image.gif)
		 [MaxHeaderWidth](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.MaxHeaderWidth.htm)
		 Свойство MaxHeaderWidth задает
		 максимальную ширину верхнего и нижнего текста легенды в процентах.


		 ![](../../Property_Image.gif)
		 [MaxHeight](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.MaxHeight.htm)
		 Свойство MaxHeight
		 задает максимальную высоту легенды в процентах.


		 ![](../../Property_Image.gif)
		 [MaxWidth](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.MaxWidth.htm)
		 Свойство MaxWidth задает
		 максимальную ширину легенды в процентах.


		 ![](../../Property_Image.gif)
		 [Mode](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.Mode.htm)
		 Свойство Mode
		 определяет режим отображения элементов легенды.


		 ![](../../Property_Image.gif)
		 [PageMode](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.PageMode.htm)
		 Свойство PageMode определяет
		 режим разбиения элементов легенды на страницы.


		 ![](../../Property_Image.gif)
		 [TextHorizontalAlignment](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.TextHorizontalAlignment.htm)
		 Свойство TextHorizontalAlignment
		 определяет горизонтальное выравнивание текста элементов легенды.


		 ![](../../Property_Image.gif)
		 [TextSpacing](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.TextSpacing.htm)
		 Свойство TextSpacing
		 определяет отступ текста элемента легенды от маркера.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [getColumnCount](IntervalsLegend.getColumnCount.htm)
		 Метод getColumnCount
		 возвращает количество столбцов легенды.


		 ![](../../sub_image.gif)
		 [getSelectedItemsIndexes](IntervalsLegend.getSelectedItemsIndexes.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ItemHovered](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.ItemHovered.htm)
		 Событие ItemHovered наступает
		 при наведении указателя мыши на элемент легенды.


		 ![](../../Event_Image.gif)
		 [Selected](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.Selected.htm)
		 Событие Selected наступает
		 после выделения элемента легенды.


		 ![](../../Event_Image.gif)
		 [Selecting](dhtmlGraphicBase.chm::/Classes/IntervalsLegend/IntervalsLegend.Selecting.htm)
		 Событие Selecting наступает
		 при выделении элемента легенды.


## Свойства, унаследованные от класса [ColorLegendBase](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveEffects](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.ActiveEffects.htm)
		 Свойство ActiveEffects
		 определяет массив эффектов, применяемых к активным элементам шкалы.
		 ...
		 ![](../../Property_Image.gif)
		 [DoHighlight](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.DoHighlight.htm)
		 ...
		 Свойство EqualFormat
		 определяет формат записи интервалов с конкретным значением.
		 ...
		 ![](../../Property_Image.gif)
		 [HighlightBrush](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.HighlightBrush.htm)
		 Свойство HighlightBrush
		 определяет кисть для подсветки элементов визуализатора.


		 ![](../../Property_Image.gif)
		 [HighlightItemColor](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.HighlightItemColor.htm)
		 Свойство HighlightItemColor
		 устанавливает цвет маркера и подписи подсвеченного элемента легенды.


		 ![](../../Property_Image.gif)
		 [HoverMode](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.HoverMode.htm)
		 Свойство HoverMode
		 определяет режим активации подсветки элементов легенды.


		 ![](../../Property_Image.gif)
		 [InactiveEffects](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.InactiveEffects.htm)
		 Свойство InactiveEffects
		 определяет массив эффектов, применяемых к неактивным элементам
		 шкалы.
		 ...
		 ![](../../Property_Image.gif)
		 [NoDataPosition](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.NoDataPosition.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [NoDataVisible](dhtmlUi.chm::/Classes/ColorLegendBase/ColorLegendBase.NoDataVisible.htm)
		 Свойство NoDataVisible
		 определяет признак видимости элемента, соответствующего отсутствующим
		 данным в визуализаторе.


## Свойства, унаследованные от класса [LegendBase](../LegendBase/LegendBase.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ContentAlignment](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.ContentAlignment.htm)
		 Свойство ContentAlignment
		 определяет выравнивание содержимого легенды.


		 ![](../../Property_Image.gif)
		 [Footer](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.Footer.htm)
		 Свойство Footer
		 определяет нижний текст легенды.


		 ![](../../Property_Image.gif)
		 [FooterLine](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.FooterLine.htm)
		 Свойство FooterLine
		 определяет линию рядом с нижним текстом легенды.


		 ![](../../Property_Image.gif)
		 [Format](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.Format.htm)
		 Свойство Format
		 определяет формат значений элементов легенды по умолчанию.


		 ![](../../Property_Image.gif)
		 [Header](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.Header.htm)
		 Свойство Header
		 определяет верхний текст легенды.


		 ![](../../Property_Image.gif)
		 [HeaderLine](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.HeaderLine.htm)
		 Свойство HeaderLine
		 определяет линию рядом с верхним текстом легенды.


		 ![](../../Property_Image.gif)
		 [IsOuter](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.IsOuter.htm)
		 Свойство IsOuter определяет
		 признак того, что легенда будет рисоваться извне.


		 ![](../../Property_Image.gif)
		 [IsOverlap](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.IsOverlap.htm)
		 Свойство IsOverlap
		 определяет признак перекрытия легендой рабочей области визуализатора.


		 ![](../../Property_Image.gif)
		 [Scale](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.Scale.htm)
		 Свойство Scale определяет
		 шкалу легенды визуализатора.


		 ![](../../Property_Image.gif)
		 [TextWrapping](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.TextWrapping.htm)
		 Свойство TextWrapping
		 определяет перенос текста.


		 ![](../../Property_Image.gif)
		 [Type](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.Type.htm)
		 Свойство Type
		 определяет тип легенды.


		 ![](../../Property_Image.gif)
		 [Visibility](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.Visibility.htm)
		 Свойство Visibility
		 определяет видимость легенды.


## События, унаследованные от класса [LegendBase](../LegendBase/LegendBase.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [HeaderClicked](dhtmlGraphicBase.chm::/Classes/LegendBase/LegendBase.HeaderClicked.htm)
		 Событие HeaderClicked наступает
		 после нажатия на верхний текст диаграммы.


## Свойства, унаследованные от класса [PlacedControlBase](../PlacedControlBase/PlacedControlBase.htm)
...
## Методы, унаследованные от класса [PlacedControlBase](../PlacedControlBase/PlacedControlBase.htm)
