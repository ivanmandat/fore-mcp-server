...
Класс MapMaster.LegendPanel**
 реализует панель «Легенда» [мастера
...
Вернуть экземпляр класса MapMaster.AreaVisualPanel
 из мастера карты можно при помощи метода [MapMaster.getLegendPanel](dhtmlMapChart.chm::/Classes/MapMaster/MapMaster.getLegendPanel.htm).


## Синтаксис


PP.initClass(PP.Ui.MapMaster.LegendPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.MapMaster.LegendPanel", PP.Ui.INotifySettingsChanged);
...
## События
			 ...
			 ![](../../Event_Image.gif)
			 [SettingChanged](MapMaster.LegendPanel.SettingChanged.htm)
			 **Событие
			 SettingChanged**
			 наступает при изменении настроек на панели мастера.
