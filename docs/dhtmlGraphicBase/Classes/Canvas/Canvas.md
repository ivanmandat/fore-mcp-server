...
PP.initClass(PP.Ui.Canvas, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.Canvas");
...
Класс Canvas реализует компонент
 [Canvas](../../Components/Canvas/Canvas.htm), представляющий
 собой канву для отрисовки элементов.
