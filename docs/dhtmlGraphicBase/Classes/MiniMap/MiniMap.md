...
Класс MiniMap реализует панель
...
PP.initClass(PP.Ui.MiniMap, PP.Ui.[PlacedControlBase](../PlacedControlBase/PlacedControlBase.htm),
 "PP.Ui.MiniMap");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [MiniMap](dhtmlGraphicBase.chm::/Classes/MiniMap/Constructor_MiniMap.htm)
			 Конструктор MiniMap
			 создает экземпляр класса MiniMap.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ButtonsHeight](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.ButtonsHeight.htm)
		 Свойство ButtonsHeight
		 содержит высоту кнопок панели управления масштабом.


		 ![](../../Property_Image.gif)
		 [Control](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.Control.htm)
		 Свойство Control содержит
		 управляющий элемент, к которому привязана панель управления масштабом.


		 ![](../../Property_Image.gif)
		 [FrameStyle](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.FrameStyle.htm)
		 Свойство FrameStyle
		 содержит стиль области, в которой отображается видимая часть.


		 ![](../../Property_Image.gif)
		 [KeepInitialBounds](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.KeepInitialBounds.htm)
		 Свойство KeepInitialBounds
		 определяет сохранение начальных границ карты.


		 ![](../../Property_Image.gif)
		 [KeepProportions](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.KeepProportions.htm)
		 Свойство KeepProportions
		 определяет сохранение соотношений сторон изображения при изменении
		 ширины, высоты или после получения нового изображения.


		 ![](../../Property_Image.gif)
		 [ShowButtons](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.ShowButtons.htm)
		 Свойство ShowButtons
		 определяет отображение кнопок панели управления масштабом.


		 ![](../../Property_Image.gif)
		 [ShowMap](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.ShowMap.htm)
		 Свойство ShowMap определяет
		 отображение карты.
...
## Методы
		 ...
		 ![](../../Property_Image.gif)
		 [getResetButton](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.getResetButton.htm)
		 Метод getResetButton
		 возвращает кнопку сброса.


		 ![](../../Property_Image.gif)
		 [getViewArea](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.getViewArea.htm)
		 Метод getViewArea возвращает
		 прямоугольник видимой области.


		 ![](../../Property_Image.gif)
		 [getZoomInButton](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.getZoomInButton.htm)
		 Метод getZoomInButton
		 возвращает кнопку увеличения масштаба.


		 ![](../../Property_Image.gif)
		 [getZoomOutButton](dhtmlGraphicBase.chm::/Classes/MiniMap/MiniMap.getZoomOutButton.htm)
		 Метод getZoomOutButton
		 возвращает кнопку уменьшения масштаба.
