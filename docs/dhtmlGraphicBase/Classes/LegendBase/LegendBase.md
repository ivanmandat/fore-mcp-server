...
PP.initClass(PP.Ui.LegendBase, [PP.Ui.PlacedControlBase](../PlacedControlBase/PlacedControlBase.htm),
 "PP.Ui.LegendBase");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [LegendBase](dhtmlGraphicBase.chm::/Classes/LegendBase/Constructor_LegendBase.htm)
			 Конструктор LegendBase
			 создает экземпляр класса LegendBase.
