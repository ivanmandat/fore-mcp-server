...
Класс PlacedControlBase реализует
 базовый класс визуальных элементов управления.


## Синтаксис


PP.initClass(PP.Ui.PlacedControlBase, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.PlacedControlBase");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [PlacedControlBase](dhtmlGraphicBase.chm::/Classes/PlacedControlBase/Constructor_PlacedControlBase.htm)
			 Конструктор PlacedControlBase
			 создает экземпляр класса PlacedControlBase
