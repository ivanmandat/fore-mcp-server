...
Класс CylinderGaugeAxis предназначен
 для работы с осью цилиндра.


## Синтаксис


PP.initClass(PP.Ui.CylinderGaugeAxis, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.CylinderGaugeAxis");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [CylinderGaugeAxis](Constructor_CylinderGaugeAxis.htm)
		 Конструктор CylinderGaugeAxis
		 создает экземпляр класса CylinderGaugeAxis.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [AxisUnits](CylinderGaugeAxis.AxisUnits.htm)
		 Свойство AxisUnits
		 определяет единицу измерения оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [Labels](CylinderGaugeAxis.Labels.htm)
		 Свойство Labels определяет
		 подписи для основных делений оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [LabelsMode](CylinderGaugeAxis.LabelsMode.htm)
		 Свойство LabelsMode
		 определяет режим подписей оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [LabelStyle](CylinderGaugeAxis.LabelStyle.htm)
		 Свойство LabelStyle
		 определяет стиль подписей оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [MajorTicksCount](CylinderGaugeAxis.getMajorTicksCount.htm)
		 Свойство MajorTicksCount
		 определяет количество основных делений оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [MajorTickStyle](CylinderGaugeAxis.MajorTickStyle.htm)
		 Свойство MajorTickStyle определяет
		 стиль основных делений оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [Max](CylinderGaugeAxis.Max.htm)
		 Свойство Max определяет
		 максимальное значение оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [Min](CylinderGaugeAxis.getMin.htm)
		 Свойство Min определяет
		 минимальное значение оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [MinorTicksStep](CylinderGaugeAxis.MinorTicksStep.htm)
		 Свойство MinorTicksStep
		 определяет шаг между промежуточными делениями в единицах оси.


		 ![](../../../Property_Image.gif)
		 [MinorTickStyle](CylinderGaugeAxis.MinorTickStyle.htm)
		 Свойство MinorTickStyle определяет
		 стиль промежуточных делений оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [ParentCylinder](CylinderGaugeAxis.ParentCylinder.htm)
		 Свойство ParentCylinder определяет
		 цилиндр, к которому принадлежит данная ось.


		 ![](../../../Property_Image.gif)
		 [Position](CylinderGaugeAxis.Position.htm)
		 Свойство Position определяет
		 позицию оси относительно цилиндра.


		 ![](../../../Property_Image.gif)
		 [ShowMajorTicks](CylinderGaugeAxis.ShowMajorTicks.htm)
		 Свойство ShowMajorTicks
		 определяет признак отображения основных делений оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [ShowMinorTicks](CylinderGaugeAxis.ShowMinorTicks.htm)
		 Свойство ShowMinorTicks
		 определяет признак отображения промежуточных делений оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [ShowUnitsForEachValue](CylinderGaugeAxis.ShowUnitsForEachValue.htm)
		 Свойство ShowUnitsForEachValue
		 определяет признак того, следует ли отображать единицу измерения
		 для каждого основного деления оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [Values](CylinderGaugeAxis.Values.htm)
		 Свойство Values определяет
		 массив значений оси цилиндра.


		 ![](../../../Property_Image.gif)
		 [ValuesMode](CylinderGaugeAxis.ValuesMode.htm)
		 Свойство ValuesMode
		 определяет режим построения делений оси.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [autoCalcLabels](CylinderGaugeAxis.autoCalcLabels.htm)
		 Метод autoCalcLabels
		 возвращает массив автоматически рассчитанных подписей оси цилиндра.


		 ![](../../../sub_image.gif)
		 [calcValuesByMode](CylinderGaugeAxis.calcValuesByMode.htm)
		 Метод calcValuesByMode
		 возвращает значения оси цилиндра, соответствующие режиму построения
		 её делений.


		 ![](../../../sub_image.gif)
		 [clear](CylinderGaugeAxis.clear.htm)
		 Метод clear очищает
		 ось цилиндра.


		 ![](../../../sub_image.gif)
		 [draw](CylinderGaugeAxis.draw.htm)
		 Метод draw отрисовывает
		 ось цилиндра.


		 ![](../../../sub_image.gif)
		 [getMajorTicks](CylinderGaugeAxis.getMajorTicks.htm)
		 Метод getMajorTicks
		 возвращает массив основных делений оси цилиндра.


		 ![](../../../sub_image.gif)
		 [getMinorTicks](CylinderGaugeAxis.getMinorTicks.htm)
		 Метод getMinorTicks возвращает
		 массив промежуточных делений оси цилиндра.


		 ![](../../../sub_image.gif)
		 [getLabelset](CylinderGaugeAxis.getLabelset.htm)
		 Метод getLabelset возвращает
		 массив подписей для основных делений оси цилиндра.


		 ![](../../../sub_image.gif)
		 [getUnit](CylinderGaugeAxis.getUnit.htm)
		 Метод getUnit возвращает единицу
		 измерения оси цилиндра.


		 ![](../../../sub_image.gif)
		 [getValuePoint](CylinderGaugeAxis.getValuePoint.htm)
		 Метод getValuePoint
		 возвращает точку, в которой расположено значение оси цилиндра.


		 ![](../../../sub_image.gif)
		 [redraw](CylinderGaugeAxis.redraw.htm)
		 Метод redraw перерисовывает
		 ось цилиндра.


		 ![](../../../sub_image.gif)
		 [setValuesByMinAndMax](CylinderGaugeAxis.setValuesByMinAndMax.htm)
		 Метод setValuesByMinAndMax
		 устанавливает количество основных делений, а также минимальное
		 и максимальное значения оси цилиндра.
