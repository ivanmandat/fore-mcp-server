...
Класс CylinderGaugeValue предназначен
 для работы со значением цилиндра.


## Синтаксис


PP.initClass(PP.Ui.CylinderGaugeValue, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.CylinderGaugeValue");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [CylinderGaugeValue](Constructor_CylinderGaugeValue.htm)
		 Конструктор CylinderGaugeValue
		 создает экземпляр класса CylinderGaugeValue.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Fill](CylinderGaugeValue.Fill.htm)
		 Свойство Fill определяет
		 заливку значения цилиндра.


		 ![](../../../Property_Image.gif)
		 [ParentAxis](CylinderGaugeValue.ParentAxis.htm)
		 Свойство ParentAxis
		 определяет ось цилиндра, которой принадлежит данное значение.


		 ![](../../../Property_Image.gif)
		 [StartValue](CylinderGaugeValue.StartValue.htm)
		 Свойство StartValue
		 определяет координату нижнего основания цилиндра.


		 ![](../../../Property_Image.gif)
		 [UpFill](CylinderGaugeValue.UpFill.htm)
		 Свойство UpFill определяет
		 заливку основания цилиндра.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [checkValue](CylinderGaugeValue.checkValue.htm)
		 Метод checkValue корректирует
		 значение цилиндра.


		 ![](../../../sub_image.gif)
		 [draw](CylinderGaugeValue.draw.htm)
		 Метод draw отрисовывает
		 значение цилиндра.


		 ![](../../../sub_image.gif)
		 [getColumn](CylinderGaugeValue.getColumn.htm)
		 Метод getColumn возвращает
		 боковую поверхность значения цилиндра.


		 ![](../../../sub_image.gif)
		 [getEventNode](CylinderGaugeValue.getEventNode.htm)
		 Метод getEventNode
		 возвращает DOM-элемент, соответствующий цилиндру.


		 ![](../../../sub_image.gif)
		 [getUp](CylinderGaugeValue.getUp.htm)
		 Метод getUp возвращает
		 основание цилиндра.


		 ![](../../../sub_image.gif)
		 [getUpGlare](CylinderGaugeValue.getUpGlare.htm)
		 Метод getUpGlare возвращает
		 основание цилиндра с градиентной заливкой.


		 ![](../../../sub_image.gif)
		 [redraw](CylinderGaugeValue.redraw.htm)
