...
[ChartSVGLabel](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartSVGLabel/ChartSVGLabel.htm)
...
Класс CylinderHeader предназначен
 для работы с заголовком цилиндра.


## Синтаксис


PP.initClass(PP.Ui.CylinderHeader, [PP.Ui.ChartSVGLabel](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartSVGLabel/ChartSVGLabel.htm),
 "PP.Ui.CylinderHeader");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [CylinderHeader](Constructor_CylinderHeader.htm)
		 Конструктор CylinderHeader
		 создает экземпляр класса CylinderHeader.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [HorizontalAlign](CylinderHeader.HorizontalAlign.htm)
		 Свойство HorizontalAlign
		 определяет горизонтальное выравнивание заголовка относительно
		 цилиндра.


		 ![](../../../Property_Image.gif)
		 [ParentCylinder](CylinderHeader.ParentCylinder.htm)
		 Свойство ParentCylinder
		 определяет цилиндр, которому принадлежит данный заголовок.


		 ![](../../../Property_Image.gif)
		 [Shadow](CylinderHeader.Shadow.htm)
		 Свойство Shadow определяет
		 тень заголовка цилиндра.


		 ![](../../../Property_Image.gif)
		 [VerticalAlign](CylinderHeader.VerticalAlign.htm)
		 Свойство VerticalAlign
		 определяет вертикальное выравнивание заголовка относительно
		 цилиндра.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [redraw](CylinderHeader.redraw.htm)
