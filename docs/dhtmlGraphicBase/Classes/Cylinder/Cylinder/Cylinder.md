...
Класс Cylinder предназначен
 для работы с цилиндром.


## Комментарии


Класс Cylinder реализует компонент
 [Cylinder](../../../Components/Cylinder/Cylinder.htm). Компонент
 Cylinder предназначен для визуального
 представления значения метрики.


## Синтаксис


PP.initClass(PP.Ui.Cylinder, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.Cylinder");
