...
Класс AxisTick предназначен
 для работы с делением оси.


## Синтаксис


PP.initClass(PP.Ui.AxisTick, PP.Ui.Control, "PP.Ui.AxisTick");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [AxisTick](Constructor_AxisTick.htm)
		 Конструктор AxisTick
		 создает деление оси.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [clear](AxisTick.clear.htm)
		 Метод clear удаляет
		 деление оси.


		 ![](../../../sub_image.gif)
		 [redraw](AxisTick.redraw.htm)
		 Метод redraw устанавливает
		 атрибуты SVG-элемента соответственно свойствам деления оси.


		 ![](../../../sub_image.gif)
		 [setPosition](AxisTick.setPosition.htm)
		 Метод setPosition устанавливает
		 позицию деления оси.


		 ![](../../../sub_image.gif)
		 [setTickStyle](AxisTick.setTickStyle.htm)
		 Метод setTickStyle
		 устанавливает стиль деления оси.
