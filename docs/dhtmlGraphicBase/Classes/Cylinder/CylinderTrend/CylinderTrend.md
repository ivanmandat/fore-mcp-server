...
Класс CylinderTrend предназначен
 для работы с линией тренда цилиндра.


## Синтаксис


PP.initClass(PP.Ui.CylinderTrend, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.CylinderTrend");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [CylinderTrend](Constructor_CylinderTrend.htm)
		 Конструктор CylinderTrend
		 создает экземпляр класса CylinderTrend.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Color](CylinderTrend.Color.htm)
		 Свойство Color определяет
		 цвет линии тренда.


		 ![](../../../Property_Image.gif)
		 [LabelStyle](CylinderTrend.LabelStyle.htm)
		 Свойство LabelStyle
		 определяет стиль подписи линии тренда.


		 ![](../../../Property_Image.gif)
		 [Length](CylinderTrend.Length.htm)
		 Свойство Length определяет
		 длину линии тренда.


		 ![](../../../Property_Image.gif)
		 [LineStyle](CylinderTrend.LineStyle.htm)
		 Свойство LineStyle
		 определяет стиль линии тренда цилиндра.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [draw](CylinderTrend.draw.htm)
		 Метод draw отрисовывает
		 линию тренда.


		 ![](../../../sub_image.gif)
		 [getLabel](CylinderTrend.getLabel.htm)
		 Метод getLabel возвращает
		 подпись линии тренда.


		 ![](../../../sub_image.gif)
		 [redraw](CylinderTrend.redraw.htm)
