...
ADFStat:[IUnitRootTestStatistic](../IUnitRootTestStatistic/IUnitRootTestStatistic.htm);


## Описание


Свойство ADFStat возвращает
 значение статистики [расширенного
 теста Дики-Фуллера](Lib.chm::/05_Statistics/AugmentDickeyFullerTest.htm).


## Комментарии


Для получения статистических характеристик используйте свойство [ISmAugmentDickeyFullerTest.SummaryStatistics](ISmAugmentDickeyFullerTest.SummaryStatistics.htm).
...
        Debug.WriteLine("===Статистика расширенного теста Дики-Фуллера===");

        Debug.WriteLine("Значение статистики: " + ADF.ADFStat.Statistic.ToString);

        Debug.WriteLine("Значение вероятности: " + ADF.ADFStat.Probability.ToString);
...
После выполнения примера в окно консоли будут выведены результаты расчета
 расширенного теста Дики-Фуллера.
