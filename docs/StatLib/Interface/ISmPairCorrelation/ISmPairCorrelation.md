...
Интерфейс ISmPairCorrelation
 определяет параметры расчета парных коэффициентов корреляции.
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [BalancedSample](ISmPairCorrelation.BalancedSample.htm)
		 ...
		 ![](../../Property.gif)
		 [Data](ISmPairCorrelation.Data.htm)
		 ...
		 ![](../../Property.gif)
		 [MissingData](ISmPairCorrelation.MissingData.htm)
		 ...
		 ![](../../Property.gif)
		 [PairCorrelationMatrix](ISmPairCorrelation.PairCorrelationMatrix.htm)
		 ...
		 ![](../../Property.gif)
		 [Weights](ISmPairCorrelation.Weights.htm)
...
[Интерфейсы сборки Stat](../Interfaces.htm)
 | [Парный
 коэффициент корреляции](Lib.chm::/05_Statistics/UiModelling_CoeffCorr.htm)
