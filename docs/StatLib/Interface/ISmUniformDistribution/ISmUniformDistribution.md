...
Интерфейс ISmUniformDistribution
 позволяет генерировать выборку псевдослучайных чисел из непрерывного равномерного
 распределения на интервале [a, b].
...
Непрерывное равномерное распределение на интервале [a, b]
 характеризуется постоянной функцией плотности вероятности на этом отрезке
 и равной нулю вне его.
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [A](ISmUniformDistribution.A.htm)
		 ...
		 ![](../../Property.gif)
		 [B](ISmUniformDistribution.B.htm)
...
[Интерфейсы сборки Stat](../Interfaces.htm)
 | [Равномерное
 распределение](Lib.chm::/05_Statistics/Distribution/Lib_UniformDistribution.htm)
