# ISmOmittedVariablesTest.SummaryStatistics
...
После выполнения примера в окно консоли будут выведены значения теста
 Фишера, статистические характеристики и ряд остатков.
