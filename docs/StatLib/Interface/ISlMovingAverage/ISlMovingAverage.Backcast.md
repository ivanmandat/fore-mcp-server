...
Свойство Backcast определяет признак использования ретрополяции при оценивании коэффициентов скользящего среднего.


## Комментарии


По умолчанию ретрополяция используется.
