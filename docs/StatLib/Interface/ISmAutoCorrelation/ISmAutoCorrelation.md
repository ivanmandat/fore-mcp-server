...
Интерфейс ISmAutoCorrelation
 определяет параметры автокорреляционного анализа.
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [AutoCorrelationFunction](ISmAutoCorrelation.AutoCorrelationFunction.htm)
		 ...
		 ![](../../Property.gif)
		 [DifferenceOrder](ISmAutoCorrelation.DifferenceOrder.htm)
		 ...
		 ![](../../Property.gif)
		 [LagOrder](ISmAutoCorrelation.LagOrder.htm)
		 ...
		 ![](../../Property.gif)
		 [MissingData](ISmAutoCorrelation.MissingData.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelPeriod](ISmAutoCorrelation.ModelPeriod.htm)
		 ...
		 ![](../../Property.gif)
		 [PartialAutoCorrelationFunction](ISmAutoCorrelation.PartialAutoCorrelationFunction.htm)
		 ...
		 ![](../../Property.gif)
		 [Probability](ISmAutoCorrelation.Probability.htm)


		 Свойство Probability
		 возвращает вероятность для [Q-статистики
		 Льюнг-Бокса](ISmAutoCorrelation.QStatistics.htm).


		 ![](../../Property.gif)
		 [QStatistics](ISmAutoCorrelation.QStatistics.htm)
		 ...
		 ![](../../Property.gif)
		 [Serie](ISmAutoCorrelation.Serie.htm)
		 ...
		 ![](../../Property.gif)
		 [StandardError](ISmAutoCorrelation.StandardError.htm)
