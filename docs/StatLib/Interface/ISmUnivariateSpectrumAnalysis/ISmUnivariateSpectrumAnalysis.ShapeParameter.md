...
Свойство ShapeParameter определяет
 параметр формы.
...
Значение берется из диапазона [0, 1]. Данный параметр необходимо
 задавать, только если свойство [LagWindow](ISmUnivariateSpectrumAnalysis.LagWindow.htm)
 имеет значение Trapezoidal.
...
Нижний доверительный предел: 4.18369602811466


Верхний доверительный предел: 1.65595523982114


Полоса пропускания: -2.52774078829352


Число степеней свободы: 6.92801335957536
