# IChowTestLinRegress.ModelCoefficients
...
Использование свойства приведено в примере для [ISmChowTest.ConfidenceLevel](../ISmChowTest/ISmChowTest.ConfidenceLevel.htm).
