...
Интерфейс ISmBetaDistribution
 позволяет генерировать выборку псевдослучайных чисел из бета-распределения
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [A](ISmBetaDistribution.A.htm)


		 Свойство A определяет
		 значение параметра α распределения случайной величины.


		 ![](../../Property.gif)
		 [B](ISmBetaDistribution.B.htm)


		 Свойство B определяет
		 значение параметра β распределения случайной величины.
...
[Интерфейсы сборки Stat](../Interfaces.htm)
 | [Бета-распределение](Lib.chm::/05_Statistics/Distribution/Lib_BetaDistribution.htm)
