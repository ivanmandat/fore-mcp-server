# ISmEngleGrangerTest.AutoRegressionOrder
...
Свойство актуально, если [ISmEngleGrangerTest.UseAutomaticAROrderSelection](ISmEngleGrangerTest.UseAutomaticAROrderSelection.htm) = False, т.е. рассчитывается
 модель с заданным лагом.
...
    can[08] := 7061;    can[09] := 7180;    can[10] := 7132;    can[11] := 7137;

    can[12] := 7473;    can[13] := 7722;    can[14] := 8088;    can[15] := 8516;

    can[16] := 8941;    can[17] := 9064;    can[18] := 9380;    can[19] := 9746;

    can[20] := 9907;    can[21] := 10333;   can[22] := 10863;   can[23] := 11693;
...
    eg.UseAutomaticAROrderSelection := False;

    eg.AutoRegressionOrder:= 1;
...
[ISmEngleGrangerTest](ISmEngleGrangerTest.htm)
