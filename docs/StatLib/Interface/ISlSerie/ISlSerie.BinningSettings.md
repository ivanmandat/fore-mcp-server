...
BinningSettings: [IBinningSettings](../IBinningSettings/IBinningSettings.htm);
...
Для получения результатов выполнения процедуры Binning используйте свойство
 [ISlSerie.Categories](ISlSerie.Categories.htm).


## Пример


Добавьте ссылки на системные сборки: MathFin, Stat.
...
В результате выполнения примера будет выполнено заполнение пропусков
 в значениях ряда с помощью дерева решений. Для разбивки объясняемого ряда
 на категории будет использована процедура Binning.
