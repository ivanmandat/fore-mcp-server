...
Интерфейс ISmDickeyFullerGLSTest
...
Тест возвращает статистику обобщенного теста Дики-Фуллера.
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [AutomaticAROrderSelectionSettings](ISmDickeyFullerGLSTest.AutomaticAROrderSelectionSettings.htm)
		 Свойство AutomaticAROrderSelectionSettings
		 определяет параметры автоподбора лага.


		 ![](../../Property.gif)
		 [AutoRegressionOrder](ISmDickeyFullerGLSTest.AutoRegressionOrder.htm)
		 Свойство AutoRegressionOrder
		 определяет лаг.


		 ![](../../Property.gif)
		 [DFGLSStat](ISmDickeyFullerGLSTest.DFGLSStat.htm)
		 Свойство DFGLSStat
		 возвращает значение статистики обобщенного теста Дики-Фуллера.


		 ![](../../Property.gif)
		 [Equation](ISmDickeyFullerGLSTest.Equation.htm)
		 Свойство Equation
		 определяет тип модели, рассматриваемой в тесте.


		 ![](../../Property.gif)
		 [MissingData](ISmDickeyFullerGLSTest.MissingData.htm)
		 Свойство MissingData
		 возвращает метод обработки пропусков.


		 ![](../../Property.gif)
		 [ModelCoefficients](ISmDickeyFullerGLSTest.ModelCoefficients.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelPeriod](ISmDickeyFullerGLSTest.ModelPeriod.htm)
		 Свойство ModelPeriod
		 возвращает параметры периода идентификации.


		 ![](../../Property.gif)
		 [Serie](ISmDickeyFullerGLSTest.Serie.htm)
		 Свойство Serie
		 возвращает тестируемый ряд.


		 ![](../../Property.gif)
		 [SummaryStatistics](ISmDickeyFullerGLSTest.SummaryStatistics.htm)
		 ...
		 ![](../../Property.gif)
		 [TestedSeries](ISmDickeyFullerGLSTest.TestedSeries.htm)
		 Свойство TestedSeries
		 определяет тип проверяемого ряда.


		 ![](../../Property.gif)
		 [UseAutomaticAROrderSelection](ISmDickeyFullerGLSTest.UseAutomaticAROrderSelection.htm)
