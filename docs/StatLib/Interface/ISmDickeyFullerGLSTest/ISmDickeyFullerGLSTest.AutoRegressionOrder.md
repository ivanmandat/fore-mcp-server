# ISmDickeyFullerGLSTest.AutoRegressionOrder
...
Свойство актуально, если [ISmDickeyFullerGLSTest.UseAutomaticAROrderSelection](ISmDickeyFullerGLSTest.UseAutomaticAROrderSelection.htm) = False,
 т.е. рассчитывается модель с заданным лагом.
...
    DFGLS.UseAutomaticAROrderSelection := False;

    // Порядок авторегрессии

    DFGLS.AutoRegressionOrder := 9;
