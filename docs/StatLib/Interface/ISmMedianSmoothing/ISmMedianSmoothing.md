...
Интерфейс ISmMedianSmoothing
 определяет параметры медианного сглаживания.
...
Основное достоинство процедур медианного сглаживания – устойчивость
 к наличию выбросов.
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [Fitted](ISmMedianSmoothing.Fitted.htm)
		 Свойство Fitted возвращает
		 модельный ряд.


		 ![](../../Property.gif)
		 [MissingData](ISmMedianSmoothing.MissingData.htm)
		 Свойство MissingData
		 определяет параметры обработки пропусков.


		 ![](../../Property.gif)
		 [ModelPeriod](ISmMedianSmoothing.ModelPeriod.htm)
		 Свойство ModelPeriod
		 определяет параметры периода идентификации.


		 ![](../../Property.gif)
		 [Residuals](ISmMedianSmoothing.Residuals.htm)
		 Свойство Residuals
		 возвращает ряд остатков.


		 ![](../../Property.gif)
		 [Serie](ISmMedianSmoothing.Serie.htm)
		 Свойство Serie определяет
		 параметры исходного ряда.


		 ![](../../Property.gif)
		 [SummaryStatistics](ISmMedianSmoothing.SummaryStatistics.htm)
		 Свойство SummaryStatistics
		 возвращает статистические характеристики.


		 ![](../../Property.gif)
		 [Width](ISmMedianSmoothing.Width.htm)
