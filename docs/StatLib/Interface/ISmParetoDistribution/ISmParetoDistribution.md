...
Интерфейс ISmParetoDistribution
 определяет параметры распределения Парето.
...
Считается, что случайная величина X
 имеет распределение Парето с параметрами k
 и a.
...
[Интерфейсы сборки Stat](../Interfaces.htm)
 | [Распределение
 Парето](Lib.chm::/05_Statistics/Distribution/Lib_ParetoDistribution.htm)
