...
Для задания объясняющих рядов используйте свойство [ISmRedundantVariablesTest.Explanatories](ISmRedundantVariablesTest.Explanatories.htm).
...
В результате выполнения примера в окно консоли будут выведены результаты
 расчетов тестов Фишера и хи-квадрат, модельный ряд, ряд остатков и статистические
 характеристики.
...
[ISmRedundantVariablesTest](ISmRedundantVariablesTest.htm)
