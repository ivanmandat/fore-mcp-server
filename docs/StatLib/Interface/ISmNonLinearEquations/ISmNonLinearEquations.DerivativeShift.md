...
Свойство DerivativeShift определяет
 приращение аргумента (в долях) для вычисления частных производных в методе
 Ньютона.
...
В примере составлена система нелинейных уравнений и заданы параметры
 ее решения методом Ньютона:


	- приращение аргумента - «0,6»;


	- частота вычисления якобиана - каждая пятая итерация;


	- способ вычисления следующего приближения - обратная
	 матрица.
