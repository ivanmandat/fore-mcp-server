...
Интерфейс ISmElliotRothenbergStockTest предназначен
 для работы с параметрами теста Эллиота-Розенберга-Стока (point optimal).
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [AutoRegressionOrder](ISmElliotRothenbergStockTest.AutoRegressionOrder.htm)
		 ...
		 ![](../../Property.gif)
		 [Equation](ISmElliotRothenbergStockTest.Equation.htm)
		 ...
		 ![](../../Property.gif)
		 [ERSStat](ISmElliotRothenbergStockTest.ERSStat.htm)
		 ...
		 ![](../../Property.gif)
		 [F0](ISmElliotRothenbergStockTest.F0.htm)
		 ...
		 ![](../../Property.gif)
		 [F0SpectrumEstimation](ISmElliotRothenbergStockTest.F0SpectrumEstimation.htm)
		 ...
		 ![](../../Property.gif)
		 [MissingData](ISmElliotRothenbergStockTest.MissingData.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelPeriod](ISmElliotRothenbergStockTest.ModelPeriod.htm)
		 ...
		 ![](../../Property.gif)
		 [Serie](ISmElliotRothenbergStockTest.Serie.htm)
		 ...
		 ![](../../Property.gif)
		 [TestedSeries](ISmElliotRothenbergStockTest.TestedSeries.htm)
