...
Свойство Output возвращает массив
 строк, содержащий выходной файл, формируемый внешними программами x11ss.exe
 и x11q2.exe.
...
Выходной файл формируется программой:


	- x11ss.exe, если выбран месячный период сезонности ([ISmCensus2.SeasonalComponentCycleType](ISmCensus2.SeasonalComponentCycleType.htm) = SeasonalityCycleType.Month);


	- x11q2.exe, если выбран квартальный период сезонности ([ISmCensus2.SeasonalComponentCycleType](ISmCensus2.SeasonalComponentCycleType.htm) = SeasonalityCycleType.Quater).
...
Добавьте ссылки на системные сборки: Io, Stat.
	...
	                TextW.WriteLnString(Census2.Output[i]);
...
После выполнения примера будет сформирован выходной файл, содержащий
