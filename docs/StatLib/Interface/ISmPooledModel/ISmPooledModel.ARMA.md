...
Порядок AR не может быть использован для модели со случайными эффектами,
 т.е. если [ISmPooledModel.CrossSection](ISmPooledModel.CrossSection.htm) = [PooledModelCrossSectionType](../../Enums/PooledModelCrossSectionType.htm).RandomEffect.
