# ISmExponentialSmoothing.AutoSearch
...
AutoSearch: [IExponentialSmoothingAutoSearch](../IExponentialSmoothingAutoSearch/IExponentialSmoothingAutoSearch.htm);


## Описание


Свойство AutoSearch определяет
...
После выполнения примера в окно консоли будут выведены значения подобранных
 параметров и модельный ряд.
