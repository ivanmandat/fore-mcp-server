...
Свойство ARRootsIm возвращает
 значения мнимой части характеристических корней AR процесса.
...
Для получения значений действительной части характеристических корней
 AR процесса используйте свойство [ISlARMA.ARRootsRe](ISlARMA.ARRootsRe.htm).
