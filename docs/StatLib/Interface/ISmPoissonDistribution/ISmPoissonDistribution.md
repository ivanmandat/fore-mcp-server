...
Интерфейс ISmPoissonDistribution
 позволяет генерировать выборку псевдослучайных целых чисел из дискретного
 распределения Пуассона с заданной интенсивностью событий.
...
Распределение Пуассона - это дискретное распределение, являющееся одним
 ...
 распределения](Lib.chm::/05_Statistics/Distribution/Lib_BinomialDistribution.htm).
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [Lambda](ISmPoissonDistribution.Lambda.htm)
...
[Интерфейсы сборки Stat](../Interfaces.htm)
 | [Распределение
 Пуассона](Lib.chm::/05_Statistics/Distribution/Lib_PoissonDistribution.htm)
