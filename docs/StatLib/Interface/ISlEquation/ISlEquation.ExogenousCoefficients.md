# ISlEquation.ExogenousCoefficients
...
ExogenousCoefficients: [ICoefficients](../ICoefficients/ICoefficients.htm);


## Описание


Свойство ExogenousCoefficients
 возвращает коэффициенты экзогенных переменных.
...
Для выполнения примера добавьте ссылку на системную сборку Stat.
	...
	            Debug.Write("коэффициент " + i.ToString + ": ");

	            For j := 0 To VarModel.Equations.Item(i).ExogenousCoefficients.Estimate.Length-1 Do

	                d := VarModel.Equations.Item(i).ExogenousCoefficients.Estimate[j];
...
После выполнения примера в окно консоли будут выведены коэффициенты
 экзогенных переменных для каждого имеющегося уравнения векторной авторегрессии:


Выполнение модуля начато


коэффициент 0: 0.201808934581311,


коэффициент 1: 0.344863144796117,


=== среднее остатков ===


0, -7.18022132978628e-13


1, -8.13758417375778e-13
