...
Интерфейс ISmNgPerronTest предназначен
...
Тест возвращает модифицированную статистику Эллиота-Розенберга-Стока,
 модифицированную статистику Бхаргава и модифицированные статистики Филлипса-Перрона.
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [AutoRegressionOrder](ISmNgPerronTest.AutoRegressionOrder.htm)
		 ...
		 ![](../../Property.gif)
		 [Equation](ISmNgPerronTest.Equation.htm)
		 ...
		 ![](../../Property.gif)
		 [F0SpectrumEstimation](ISmNgPerronTest.F0SpectrumEstimation.htm)
		 ...
		 ![](../../Property.gif)
		 [MissingData](ISmNgPerronTest.MissingData.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelPeriod](ISmNgPerronTest.ModelPeriod.htm)
		 ...
		 ![](../../Property.gif)
		 [MPTStat](ISmNgPerronTest.MPTStat.htm)
		 ...
		 ![](../../Property.gif)
		 [MSBStat](ISmNgPerronTest.MSBStat.htm)
		 ...
		 ![](../../Property.gif)
		 [MZaStat](ISmNgPerronTest.MZaStat.htm)
		 ...
		 ![](../../Property.gif)
		 [MZtStat](ISmNgPerronTest.MZtStat.htm)
		 ...
		 ![](../../Property.gif)
		 [Serie](ISmNgPerronTest.Serie.htm)
		 ...
		 ![](../../Property.gif)
		 [TestedSeries](ISmNgPerronTest.TestedSeries.htm)
