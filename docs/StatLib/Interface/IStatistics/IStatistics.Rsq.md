...
Метод Rsq возвращает квадрат
 коэффициента корреляции Пирсона (r^2).
...
        Debug.WriteLine("Квадрат коэффициента Пирсона: " + d0.ToString);
...
В результате выполнения примера в окно консоли будет выведен квадрат
