...
Интерфейс IDataMining предназначен
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [Dependent](IDataMining.Dependent.htm)
		 Свойство Dependent
		 возвращает объясняемый ряд.


		 ![](../../Property.gif)
		 [Explanatories](IDataMining.Explanatories.htm)
		 Свойство Explanatories
		 возвращает коллекцию признаков для классификации.


		 ![](../../Property.gif)
		 [FilledDependent](IDataMining.FilledDependent.htm)
