...
Outliers11ao: [ISlOutliers](../ISlOutliers/ISlOutliers.htm);


## Описание


Свойство OutliersX11ao возвращает
 список аддитивных выбросов, учитываемых на шаге Х11.
...
        Debug.WriteLine("=== Спектральные частоты SP2 ===");
...
        Debug.WriteLine("=== Спектральные плотности SP2 ===");
...
В результате выполнения примера будет создана модель X12, в окно консоли
 будут выведены:
	...
	- спектральные частоты и плотности SP2.
