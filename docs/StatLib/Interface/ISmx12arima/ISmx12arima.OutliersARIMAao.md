...
OutliersARIMAao: [ISlOutliers](../ISlOutliers/ISlOutliers.htm);


## Описание


Свойство OutliersARIMAao возвращает
 список аддитивных выбросов, учитываемых на шаге ARIMA.
...
     // Использовать поправки, только если необходимо
...
        Debug.WriteLine("=== Сезонная компонента ===");
