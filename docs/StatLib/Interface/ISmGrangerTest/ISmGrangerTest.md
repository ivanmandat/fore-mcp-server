...
Интерфейс ISmGrangerTest определяет
 параметры теста Гранжера.
...
## Свойства
		 ...
		 ![](../../Property.gif)
		 [ConfidenceLevel](ISmGrangerTest.ConfidenceLevel.htm)
		 ...
		 ![](../../Property.gif)
		 [MissingData](ISmGrangerTest.MissingData.htm)
		 ...
		 ![](../../Property.gif)
		 [PValueMatrix](ISmGrangerTest.PValueMatrix.htm)


		 Свойство PValueMatrix
		 возвращает матрицу вероятностей.


		 ![](../../Property.gif)
		 [ResValueMatrix](ISmGrangerTest.ResValueMatrix.htm)


		 Свойство ResValueMatrix
		 возвращает матрицу результатов о наличии или отсутствии обусловленности
		 по Гранжеру.


		 ![](../../Property.gif)
		 [TStatMatrix](ISmGrangerTest.TStatMatrix.htm)


		 Свойство TStatMatrix
		 возвращает матрицу статистик Фишера.
...
[Интерфейсы сборки Stat](../Interfaces.htm)
 | [Тест
 Гранжера](Lib.chm::/05_Statistics/UiModelling_GrangerTest.htm)
