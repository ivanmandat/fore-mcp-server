# ISmWhiteHeteroskedasticityTest.Fitted
...
Добавьте ссылку на системную сборку Stat.
	...
	    // Задаем параметры константы модели
...
В результате выполнения примера в окне консоли будут выведены результаты
 расчетов теста хи-квадрат и модельный ряд.
