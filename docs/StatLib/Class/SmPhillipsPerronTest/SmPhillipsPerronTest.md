...
Класс SmPhillipsPerronTest предназначен
 для работы с параметрами теста Филлипса-Перрона.


## Комментарии


Тест возвращает статистику Филлипса-Перрона.


## Свойства, унаследованные от [ISmPhillipsPerronTest](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.htm)
		 ...
		 ![](../../Property.gif)
		 [AutoRegressionOrder](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.AutoRegressionOrder.htm)
		 Свойство AutoRegressionOrder
		 определяет лаг.


		 ![](../../Property.gif)
		 [Equation](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.Equation.htm)
		 Свойство Equation
		 определяет тип модели, рассматриваемой в тесте.


		 ![](../../Property.gif)
		 [F0](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.F0.htm)
		 Свойство F0 возвращает
		 значение скорректированной дисперсии остатков.


		 ![](../../Property.gif)
		 [F0SpectrumEstimation](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.F0SpectrumEstimation.htm)
		 ...
		 ![](../../Property.gif)
		 [MissingData](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.MissingData.htm)
		 Свойство MissingData
		 возвращает метод обработки пропусков.


		 ![](../../Property.gif)
		 [ModelCoefficients](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.ModelCoefficients.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelPeriod](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.ModelPeriod.htm)
		 Свойство ModelPeriod
		 возвращает параметры периода идентификации.


		 ![](../../Property.gif)
		 [PPStat](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.PPStat.htm)
		 Свойство PPStat
		 возвращает значение статистики теста Филлипса-Перрона.


		 ![](../../Property.gif)
		 [S0](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.S0.htm)
		 Свойство S0 возвращает
		 значение дисперсии остатков.


		 ![](../../Property.gif)
		 [Serie](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.Serie.htm)
		 Свойство Serie
		 возвращает тестируемый ряд.


		 ![](../../Property.gif)
		 [SummaryStatistics](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.SummaryStatistics.htm)
		 ...
		 ![](../../Property.gif)
		 [TestedSeries](../../Interface/ISmPhillipsPerronTest/ISmPhillipsPerronTest.TestedSeries.htm)
