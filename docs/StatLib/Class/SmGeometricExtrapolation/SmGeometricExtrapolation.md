...
Класс SmGeometricExtrapolation
 реализует алгоритм геометрической экстраполяции.


## Свойства, унаследованные от [ISmGeometricExtrapolation](../../Interface/ISmGeometricExtrapolation/ISmGeometricExtrapolation.htm)
		 ...
		 ![](../../Property.gif)
		 [Fitted](../../Interface/ISmGeometricExtrapolation/ISmGeometricExtrapolation.Fitted.htm)
		 Свойство Fitted возвращает
		 модельный ряд.


		 ![](../../Property.gif)
		 [Forecast](../../Interface/ISmGeometricExtrapolation/ISmGeometricExtrapolation.Forecast.htm)
		 Свойство Forecast определяет
		 параметры прогнозного ряда.


		 ![](../../Property.gif)
		 [MissingData](../../Interface/ISmGeometricExtrapolation/ISmGeometricExtrapolation.MissingData.htm)
		 Свойство MissingData
		 определяет параметры обработки пропусков.


		 ![](../../Property.gif)
		 [ModelPeriod](../../Interface/ISmGeometricExtrapolation/ISmGeometricExtrapolation.ModelPeriod.htm)
		 Свойство ModelPeriod
		 определяет параметры периода идентификации.


		 ![](../../Property.gif)
		 [Residuals](../../Interface/ISmGeometricExtrapolation/ISmGeometricExtrapolation.Residuals.htm)
		 Свойство Residuals
		 возвращает ряд остатков.


		 ![](../../Property.gif)
		 [Serie](../../Interface/ISmGeometricExtrapolation/ISmGeometricExtrapolation.Serie.htm)
