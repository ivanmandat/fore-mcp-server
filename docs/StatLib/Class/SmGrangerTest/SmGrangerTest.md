...
Класс SmGrangerTest реализует алгоритм теста Гранжера. Тест Гранжера предназначен для проверки причинно-следственной зависимости временных рядов.


## Свойства, унаследованные от [ISmGrangerTest](../../Interface/ISmGrangerTest/ISmGrangerTest.htm)
 ...
 ![](../../Property.gif)
 [ConfidenceLevel](../../Interface/ISmGrangerTest/ISmGrangerTest.ConfidenceLevel.htm)
 Свойство ConfidenceLevel определяет уровень значимости.


 ![](../../Property.gif)
 [Data](../../Interface/ISmGrangerTest/ISmGrangerTest.Data.htm)
 Свойство Data определяет матрицу исходных данных.


 ![](../../Property.gif)
 [Lag](../../Interface/ISmGrangerTest/ISmGrangerTest.Lag.htm)
 Свойство Lag определяет лаг.


 ![](../../Property.gif)
 [MissingData](../../Interface/ISmGrangerTest/ISmGrangerTest.MissingData.htm)
 Свойство MissingData определяет метод обработки пропусков.


 ![](../../Property.gif)
 [PValueMatrix](../../Interface/ISmGrangerTest/ISmGrangerTest.PValueMatrix.htm)
 Свойство PValueMatrix возвращает матрицу вероятностей.


 ![](../../Property.gif)
 [ResValueMatrix](../../Interface/ISmGrangerTest/ISmGrangerTest.ResValueMatrix.htm)
 Свойство ResValueMatrix возвращает матрицу результатов о наличии или отсутствии обусловленности по Гранжеру.


 ![](../../Property.gif)
 [TStatMatrix](../../Interface/ISmGrangerTest/ISmGrangerTest.TStatMatrix.htm)
 Свойство TStatMatrix возвращает матрицу статистик Фишера.
