...
Класс SmQuantileRegression реализует
...
Квантильная регрессия - непараметрический метод статистического исследования.
 Квантильная регрессия широко применяется в эконометрике, в финансовых
 и биомедицинских исследованиях, при изучении окружающей среды и других
 прикладных областях.


## Свойства, унаследованные от [ISmQuantileRegression](../../Interface/ISmQuantileRegression/ISmQuantileRegression.htm)
		 ...
		 ![](../../Property.gif)
		 [CovarianceMatrix](../../Interface/ISmQuantileRegression/ISmQuantileRegression.CovarianceMatrix.htm)
		 ...
		 ![](../../Property.gif)
		 [Explained](../../Interface/ISmQuantileRegression/ISmQuantileRegression.Explained.htm)
		 ...
		 ![](../../Property.gif)
		 [Explanatories](../../Interface/ISmQuantileRegression/ISmQuantileRegression.Explanatories.htm)
		 ...
		 ![](../../Property.gif)
		 [Fitted](../../Interface/ISmQuantileRegression/ISmQuantileRegression.Fitted.htm)
		 ...
		 ![](../../Property.gif)
		 [Forecast](../../Interface/ISmQuantileRegression/ISmQuantileRegression.Forecast.htm)
		 ...
		 ![](../../Property.gif)
		 [MaxIteration](../../Interface/ISmQuantileRegression/ISmQuantileRegression.MaxIteration.htm)
		 ...
		 ![](../../Property.gif)
		 [MissingData](../../Interface/ISmQuantileRegression/ISmQuantileRegression.MissingData.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelCoefficients](../../Interface/ISmQuantileRegression/ISmQuantileRegression.ModelCoefficients.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelPeriod](../../Interface/ISmQuantileRegression/ISmQuantileRegression.ModelPeriod.htm)
		 ...
		 ![](../../Property.gif)
		 [QRegStatistics](../../Interface/ISmQuantileRegression/ISmQuantileRegression.QRegStatistics.htm)
		 ...
		 ![](../../Property.gif)
		 [Quantile](../../Interface/ISmQuantileRegression/ISmQuantileRegression.Quantile.htm)
		 ...
		 ![](../../Property.gif)
		 [Residuals](../../Interface/ISmQuantileRegression/ISmQuantileRegression.Residuals.htm)
		 ...
		 ![](../../Property.gif)
		 [SummaryStatistics](../../Interface/ISmQuantileRegression/ISmQuantileRegression.SummaryStatistics.htm)
