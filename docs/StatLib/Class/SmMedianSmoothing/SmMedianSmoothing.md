...
Класс SmMedianSmoothing реализует
 алгоритм медианного сглаживания.


## Свойства, унаследованные от [ISmMedianSmoothing](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.htm)
		 ...
		 ![](../../Property.gif)
		 [Fitted](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.Fitted.htm)
		 Свойство Fitted возвращает
		 модельный ряд.


		 ![](../../Property.gif)
		 [MissingData](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.MissingData.htm)
		 Свойство MissingData
		 определяет параметры обработки пропусков.


		 ![](../../Property.gif)
		 [ModelPeriod](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.ModelPeriod.htm)
		 Свойство ModelPeriod
		 определяет параметры периода идентификации.


		 ![](../../Property.gif)
		 [Residuals](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.Residuals.htm)
		 Свойство Residuals
		 возвращает ряд остатков.


		 ![](../../Property.gif)
		 [Serie](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.Serie.htm)
		 Свойство Serie определяет
		 параметры исходного ряда.


		 ![](../../Property.gif)
		 [SummaryStatistics](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.SummaryStatistics.htm)
		 Свойство SummaryStatistics
		 возвращает статистические характеристики.


		 ![](../../Property.gif)
		 [Width](../../Interface/ISmMedianSmoothing/ISmMedianSmoothing.Width.htm)
...
[Классы сборки Stat](../StatClass.htm) |
 [Медианное
 сглаживание](Lib.chm::/02_Time_series_analysis/UiModelling_median_smoothing.htm)
