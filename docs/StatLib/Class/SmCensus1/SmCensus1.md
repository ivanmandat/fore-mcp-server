...
Класс SmCensus1 реализует метод
 Census I, который производит разложение исходного ряда на сезонную составляющую,
 тренд-циклическую и нерегулярную компоненты.


## Свойства, унаследованные от [ISmCensus1](../../Interface/ISmCensus1/ISmCensus1.htm)
		 ...
		 ![](../../Property.gif)
		 [CenterMovingAverage](../../Interface/ISmCensus1/ISmCensus1.CenterMovingAverage.htm)
		 Свойство CenterMovingAverage
		 определяет необходимость центрирования скользящего среднего.


		 ![](../../Property.gif)
		 [Irregula](../../Interface/ISmCensus1/ISmCensus1.Irregula.htm)
		 Свойство Irregula возвращает
		 нерегулярную компоненту.


		 ![](../../Property.gif)
		 [MissingData](../../Interface/ISmCensus1/ISmCensus1.MissingData.htm)
		 Свойство MissingData
		 определяет параметры обработки пропусков.


		 ![](../../Property.gif)
		 [ModelPeriod](../../Interface/ISmCensus1/ISmCensus1.ModelPeriod.htm)
		 Свойство ModelPeriod
		 определяет параметры периода идентификации.


		 ![](../../Property.gif)
		 [MovingAverage](../../Interface/ISmCensus1/ISmCensus1.MovingAverage.htm)
		 Свойство MovingAverage
		 возвращает сглаженный ряд.


		 ![](../../Property.gif)
		 [RatioDifferences](../../Interface/ISmCensus1/ISmCensus1.RatioDifferences.htm)
		 Свойство RatioDifferences
		 возвращает отношение/разность.


		 ![](../../Property.gif)
		 [Seasonal](../../Interface/ISmCensus1/ISmCensus1.Seasonal.htm)
		 Свойство Seasonal возвращает
		 сезонную составляющую.


		 ![](../../Property.gif)
		 [SeasonalAdjustment](../../Interface/ISmCensus1/ISmCensus1.SeasonalAdjustment.htm)
		 Свойство SeasonalAdjustment
		 возвращает сезонную корректировку.


		 ![](../../Property.gif)
		 [SeasonalComponent](../../Interface/ISmCensus1/ISmCensus1.SeasonalComponent.htm)
		 Свойство SeasonalComponent
		 определяет параметры сезонной составляющей.


		 ![](../../Property.gif)
		 [Serie](../../Interface/ISmCensus1/ISmCensus1.Serie.htm)
		 Свойство Serie определяет
		 объясняемый ряд.


		 ![](../../Property.gif)
		 [TrendCycle](../../Interface/ISmCensus1/ISmCensus1.TrendCycle.htm)
		 Свойство TrendCycle
