...
Класс SmDickeyFullerGLSTest
 предназначен для работы с параметрами обобщенного теста Дики-Фуллера.


## Комментарии


Обобщенный тест возвращает статистику Дики-Фуллера.


## Свойства, унаследованные от [ISmDickeyFullerGLSTest](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.htm)
		 ...
		 ![](../../Property.gif)
		 [AutomaticAROrderSelectionSettings](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.AutomaticAROrderSelectionSettings.htm)
		 Свойство AutomaticAROrderSelectionSettings
		 определяет параметры автоподбора лага.


		 ![](../../Property.gif)
		 [AutoRegressionOrder](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.AutoRegressionOrder.htm)
		 Свойство AutoRegressionOrder
		 определяет лаг.


		 ![](../../Property.gif)
		 [DFGLSStat](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.DFGLSStat.htm)
		 Свойство DFGLSStat
		 возвращает значение статистики обобщенного теста Дики-Фуллера.


		 ![](../../Property.gif)
		 [Equation](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.Equation.htm)
		 Свойство Equation
		 определяет тип модели, рассматриваемой в тесте.


		 ![](../../Property.gif)
		 [MissingData](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.MissingData.htm)
		 Свойство MissingData
		 возвращает метод обработки пропусков.


		 ![](../../Property.gif)
		 [ModelCoefficients](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.ModelCoefficients.htm)
		 ...
		 ![](../../Property.gif)
		 [ModelPeriod](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.ModelPeriod.htm)
		 Свойство ModelPeriod
		 возвращает параметры периода идентификации.


		 ![](../../Property.gif)
		 [Serie](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.Serie.htm)
		 Свойство Serie
		 возвращает тестируемый ряд.


		 ![](../../Property.gif)
		 [SummaryStatistics](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.SummaryStatistics.htm)
		 ...
		 ![](../../Property.gif)
		 [TestedSeries](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.TestedSeries.htm)
		 Свойство TestedSeries
		 определяет тип проверяемого ряда.


		 ![](../../Property.gif)
		 [UseAutomaticAROrderSelection](../../Interface/ISmDickeyFullerGLSTest/ISmDickeyFullerGLSTest.UseAutomaticAROrderSelection.htm)
