# Страница «Управляющие измерения»: Виртуальный куб
...
Примечание.
 Если в нескольких источниках виртуального куба управляющими и управляемыми
 измерениями являются совпадающие измерения, то передаётся объединённая
 отметка в управление измерениями в виртуальном кубе.


При нажатии кнопки ![](../Master_Calculation/b_clear.png) «Очистить»
 для выделенного управляемого параметра будут очищены управляющее измерение
 и выражение.


Примечание.
 Если управление параметрическим измерением не задано, то оно будет наследоваться
 автоматически от куба-источника. Для работоспособности настраиваемых параметров
 управления требуется, чтобы управляющие измерения присутствовали в структуре
 каждого куба-источника.
...
Окно редактора выражения для настройки параметра управляющего измерения
 виртуального куба в веб-приложении имеет вид:
