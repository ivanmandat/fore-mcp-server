# Страница «Управление параметрами»: Вычисляемый куб
...
Примечание.
 Управление параметрами вложенных объектов доступно, если для куба созданы
 параметры на странице «[Параметры](parameters.htm)».


	 Веб-приложение Настольное приложение


		![](ManageParameters_web.png)


		![](page%20manage%20par.png)
