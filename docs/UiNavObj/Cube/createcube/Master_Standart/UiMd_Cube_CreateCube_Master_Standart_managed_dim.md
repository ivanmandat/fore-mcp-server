# Страница «Управляющие измерения»: Стандартный куб
...
При нажатии кнопки ![](../Master_Calculation/b_clear.png) «Очистить» для выделенного управляемого
 параметра будут очищены управляющее измерение и выражение.
...
[![](../../../Opened.gif)![](../../../Closed.gif)Вставка операндов](javascript:TextPopup(this))
	...
	Примечание.
	 Если куб предполагается использовать в качестве [приёмника](calculationalgorithm.chm::/Web/Calculation_block/Master_calculation_block_page_consumer.htm)
	 или [источника](calculationalgorithm.chm::/Web/Calculation_block/Page_Sources.htm)
	 данных для [алгоритмов
	 расчёта](calculationalgorithm.chm::/Purpose.htm),
	 то для корректного расчёта формулы необходимо учитывать, что в расчёт
	 формулы значений для операндов с типами First
	 и Last может быть передан
	 массив значений атрибута всех элементов, имеющихся в отметке управляющего
	 измерения, аналогично функции All.
