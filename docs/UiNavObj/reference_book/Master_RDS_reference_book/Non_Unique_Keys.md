# Страница «Неуникальные ключи»: Справочник НСИ
...
В появившемся окне «Свойства
 ...
 НСИ](Non_Unique_Keys.htm#add)/[составного
 справочника НСИ](../Master_Composite_Table_reference_book/Non_Unique_Keys.htm#add) внесите требуемые изменения.
