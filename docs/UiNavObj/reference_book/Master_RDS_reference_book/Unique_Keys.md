# Страница «Уникальные ключи»: Справочник НСИ
...
В появившемся диалоге «Свойства
 ...
 НСИ](Unique_Keys.htm#add)/[составного
 справочника НСИ](../Master_Composite_Table_reference_book/Unique_Keys.htm#add) внесите требуемые изменения.
