# Страница «База данных»: Справочник НСИ
...
На странице «База данных» в
 ...
 настольном приложении выбирается база данных для хранения данных справочника
 НСИ.
...
Для сброса отметки выбранной базы данных:
	...
	- в веб-приложении нажмите кнопку ![](../Master_Composite_Table_reference_book/b_delete_web.png) «Очистить»;
