...
Справочник предназначен для структурированного представления элементов
 ...
 могут изменяться во времени, то есть иметь несколько версий. Для создания
 справочника НСИ требуется БД для хранения данных справочника. Справочник
...
Важно. [Справочник
 НСИ](../../Cube/CreateCube/Master_Standart/UiMd_Cube_CreateCube_Master_Standart_2.htm) для хранения вложений создается при настройке стандартного куба
 и заполняется автоматически. Создание и редактирование такого справочника
 вручную недопустимо.


Мастер справочника НСИ отличается в веб-приложении и настольном приложении.
...
[![](../../Opened.gif)![](../../Closed.gif)Создание
 справочника НСИ](javascript:TextPopup(this))
	...
	Для создания справочника НСИ в [навигаторе
 ...
 справочника.
	...
	- [Группы элементов](../look-and-feel_Reference_book/UiMd_reference_book_look-and-feel_Group.htm). Определяются
	 ...
	 Переход на страницу доступен после сохранения настроек справочника;
			...
			- [Альтернативные
			 иерархии](../look-and-feel_Reference_book/Use_AlterHier_ForRefBook.htm). Устанавливаются связи для сопоставления
			 элементов исходного и альтернативного справочников. Переход
			 на страницу доступен после сохранения настроек справочника.
		...
		В мастере доступны страницы:
			...
			- [Базовые
			 свойства](base_settings.htm). Задаются наименование,
			 идентификатор и примечание;


			- Тип
			 справочника. Выбирается тип создаваемого справочника:
			 табличный, календарный, вычисляемый, справочник НСИ, составной
			 справочник НСИ;
...
Настройка структуры справочника НСИ отличается в веб-приложении и настольном
 приложении:


	- в веб-приложении настройка выполняется при [создании](#add_rds)
	 нового справочника НСИ с помощью мастера и может изменяться при редактировании
	 существующего справочника НСИ;


	- в настольном приложении настройка выполняется только при [редактировании](../Work/Work_Dictionary.htm#edit) существующего
	 справочника НСИ на вкладке «Описание»:
...
Для настройки структуры справочника
 выполните шаги:
	...
	- [Создайте связи](Link.htm), если требуется.
	...
	- [Создайте схемы импорта/экспорта](Import.htm),
	...
	- [Управляйте параметрами
	 вложенных элементов](Manage_Nested_Object_Parameters.htm), если требуется. Доступно только
	 в настольном приложении.


	- [Управляйте субъектами доступа](Access_Subjects.htm),
	 если требуется.


	- [Замените предустановленный вид диалога](Element_Card.htm),
	 если требуется. Доступно только в настольном приложении.
...
Для работы со справочником НСИ обратитесь
 к разделу «[Работа со справочником](../Work/Work_Dictionary.htm)».
...
[Создание
 справочников](../Create.htm) | [Составной
