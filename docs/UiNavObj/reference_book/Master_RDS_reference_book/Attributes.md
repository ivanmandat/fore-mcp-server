# Страница «Атрибуты»: Справочник НСИ
 ...
 которые будет иметь каждый элемент справочника.
	 ...
	 Веб-приложение Настольное приложение
		...
		При установке флажка «[Переводить
		 справочник на другие языки](base_settings.htm#translate_dictionary)» пиктограмма атрибутов типа
		 «Строка» и «Длинный
...
Атрибуты бывают следующих типов:
	...
	- Системные. Обязательные
	 атрибуты справочника НСИ, которые нельзя удалять. При создании справочника
	 НСИ на странице «Атрибуты»
...
Примечание.
 ...
 формировать [значение по
 формуле](Attributes/Attribute.htm#calc_values).
		...
		- Мандатный доступ (MANDATORYACCESS).
		 Атрибут добавляется автоматически при установке флажка «[Элементы
		 имеют мандатные права доступа](base_settings.htm#mandatory_access_permissions)».


На странице «Атрибуты»
 все системные атрибуты выделены зеленым цветом. В зависимости от параметров,
 указанных на странице «[Описание](Master_RDS.htm#structure)»,
 набор системных атрибутов может измениться;
	...
	- Пользовательские. Атрибуты
	 справочника, которые создаются пользователем:
		...
		- [Обычные](Attributes/Attribute.htm).
		 Используются для создания полей справочника;


		- [Заимствованные](Attributes/Imported_Attribute.htm).
...
Для добавления атрибута справочника:
	...
	- в веб-приложении:
		...
		- выполните команду «Добавить >
		 ...
		 атрибута](Attributes/Attribute.htm)»;


		- выполните команду «Добавить >
		 Заимствованный атрибут» для создания заимствованного атрибута.
		 Будет открыто окно «[Свойства
		 заимствованного атрибута](Attributes/Imported_Attribute.htm)»;
...
В появившемся окне «[Свойства
 атрибута](Attributes/Attribute.htm)» или «[Свойства
 заимствованного атрибута](Attributes/Imported_Attribute.htm)» внесите требуемые изменения.
...
Будет запрошено подтверждение о выполняемом действии. Для удаления атрибута,
 участвующего в [параметре](Parameters.htm),
 [уникальном](Unique_Keys.htm)
 или [неуникальном
 ключе](Non_Unique_Keys.htm), сначала нужно удалить параметр или ключ.
...
Также для атрибутов справочника можно настроить [разграничение
 прав доступа](Attributes/Access_Permissions.htm).
