# Страница «Параметры»: Справочник НСИ
...
Примечание.
 ...
 могут изменяться во времени](base_settings.htm#change_in_time)» на странице «[Базовые настройки](base_settings.htm)».
...
Задайте свойства параметра:
	...
	- Атрибут.
	 ...
	 и заимствованных атрибутов](Attributes.htm).
...
В появившемся окне «[Свойства
 параметра](Parameters.htm#add)» внесите требуемые изменения.
