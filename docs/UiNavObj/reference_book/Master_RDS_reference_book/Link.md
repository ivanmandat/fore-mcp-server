...
На странице «Связи» в веб-приложении
 ...
 другими справочниками НСИ. Создание связей необходимо:


	- для создания [заимствованных
	 атрибутов](Attributes/Imported_Attribute.htm);
...
Связи между атрибутами можно создавать в пустом и не в пустом справочнике.
 При создании связей в непустом справочнике необходимо удостовериться,
 что все значения связываемого атрибута пустые. В противном случае построить
 связь не удастся.
...
Для редактирования свойств выбранной связи:
	...
	- в веб-приложении измените свойства в соответствующих столбцах
	 ...
	 привязки](Link_Property.htm#add)» внесите требуемые изменения;
