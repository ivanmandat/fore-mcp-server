# Страница «Уровни»: Составной справочник НСИ
...
Если использовать данный справочник в качестве измерения куба, то можно
 ...
 для получения значений для континента в целом.
	 ...
	 приложение
		...
		![](level_composite_web.png)


		![](Level_composite_desktop.png)
...
![](../Master_RDS_reference_book/new_level.png)
...
В появившемся окне «Переименовать
 ...
 НСИ](../Master_RDS_reference_book/Level.htm#add)/[составного
 справочника НСИ](Level.htm#add).
