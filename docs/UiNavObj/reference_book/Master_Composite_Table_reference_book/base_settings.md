# Страница «Базовые настройки»: Составной справочник НСИ
...
На странице «Базовые настройки»
 ...
 примечание и выполняется настройка структуры составного справочника НСИ.
 В настольном приложении настройка структуры составного справочника НСИ
 доступна только после создания справочника.
...
[![](../../Opened.gif)![](../../Closed.gif)Элементы
 могут изменяться во времени](javascript:TextPopup(this))
	...
	![](../Master_RDS_reference_book/date_web.png)


	После установки флажка на вкладке «[Элементы
	 составного справочника](../Work/Work_Dictionary.htm#composite_rds)» будет создан параметр «Дата
	...
	После установки флажка становятся доступными следующие опции:
		...
		- Ручное формирование
		 ...
		 на вкладке «Элементы составного
		 справочника» для элементов [версионного
...
После установки флажка в список атрибутов справочника будут добавлены
 четыре [обязательных
 атрибута](Attributes.htm), позволяющие настраивать права доступа для элементов справочника.


Список субъектов доступа формируется на странице «[Субъекты
 доступа](Access_Subjects.htm)».
...
Если в [редакторе
 ...
 флажок «[Элементы
 имеют атрибутные права доступа](base_settings.htm#abac)» для применения политик и правил
...
[![](../../Opened.gif)![](../../Closed.gif)Запретить
 добавление дубликатов из источников](javascript:TextPopup(this))


	По умолчанию флажок снят, при этом один и тот же элемент из
	 справочника-источника в справочник может быть добавлен неограниченное
	 число раз. При установленном флажке каждый элемент справочника-источника
	 может быть добавлен в справочник только один раз.


	Примечание.
	 В настольном приложении флажок называется «Разрешить
	 добавление дубликатов из источников».
