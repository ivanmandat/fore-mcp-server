# Страница «Субъекты доступа»: Составной справочник НСИ
...
Субъекты доступа - субъекты безопасности, для которых в дальнейшем будут
 настраиваться [права
 доступа к элементам](../Work/Access_Elements.htm) и [атрибутам](../Master_RDS_reference_book/Attributes.htm)
...
Примечание.
 ...
 2048 субъектам.
	...
	Веб-приложение Настольное приложение
		...
		![](subject_composite_desktop.png)


		Если на вкладке «[Описание](Master_CompositeTable.htm#structure)»
...
Примечание.
 Рекомендуется не удалять субъекты, а [заменять](../Master_RDS_reference_book/Access_Subjects.htm#replace)
