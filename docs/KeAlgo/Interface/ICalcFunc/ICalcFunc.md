...
Интерфейс ICalcFunc предназначен
 для работы с [блоком
 функций](CalculationAlgorithm.chm::/Desktop/Function_Block/Function_Block.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Assembly](ICalcFunc.Assembly.htm)
		 Свойство Assembly определяет
		 модуль с функцией или сборку, содержащую модуль с функцией.


		 ![](../../Property_Image.gif)
		 [ErrorInfo](ICalcFunc.ErrorInfo.htm)
		 Свойство ErrorInfo
		 возвращает информацию об ошибке.


		 ![](../../Property_Image.gif)
		 [IsValid](ICalcFunc.IsValid.htm)
		 Свойство IsValid возвращает
		 признак корректности параметров функции.


		 ![](../../Property_Image.gif)
		 [Procedure](ICalcFunc.Procedure.htm)
		 Свойство Procedure
		 определяет пользовательскую функцию.


		 ![](../../Property_Image.gif)
		 [SimpleParamValues](ICalcFunc.SimpleParamValues.htm)
		 Свойство SimpleParamValues
		 определяет дополнительные значения параметров функции.
