...
Интерфейс IUserDimBlock содержит
 свойства структуры блока вычисляемого справочника.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Indexes](IUserDimBlock.Indexes.htm)
		 Свойство Indexes возвращает
		 объект, содержащий коллекцию индексов блока вычисляемого справочника.
