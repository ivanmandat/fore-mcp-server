# IStandardDimRecursiveBlock.StartWith
...
StartWith: [IExpression](ForeSys.chm::/Interface/IExpression/IExpression.htm);


## Описание


Свойство StartWith возвращает
 объект, содержащий условие для верхнего уровня блока справочника.
