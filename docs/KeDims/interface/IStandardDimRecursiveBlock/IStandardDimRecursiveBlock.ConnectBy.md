# IStandardDimRecursiveBlock.ConnectBy
...
ConnectBy(IndexAttribute: [IStandardDimIndexAttribute](../IStandardDimIndexAttribute/IStandardDimIndexAttribute.htm)):
...
IndexAttribute. Атрибут индекса, для которого устанавливается
 условие.
...
Свойство ConnectBy возвращает
 объект, содержащий условие для атрибута индекса рекурсии.
