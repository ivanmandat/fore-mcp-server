# IStandardDimRecursiveBlock.ConnectByWhere
...
ConnectByWhere: [IExpression](ForeSys.chm::/Interface/IExpression/IExpression.htm);


## Описание


Свойство ConnectByWhere возвращает
 объект, содержащий условие для фильтрации элементов рекурсивных уровней
 справочника. Данное свойство доступно только через Fore.
...
После выполнения примера в справочнике будет создан новый рекурсивный
 ...
 равным "0". Элементы рекурсивных уровней будут отфильтрованы
 по значениям поля "Id". Отображаться будут элементы имеющие
 значение в диапазоне "100-1000".
