...
Интерфейс IDimListSelectionPrimitive
 содержит свойства примитива, снимающего/устанавливающего отметку у элементов
 справочника по списку.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Selection](IDimListSelectionPrimitive.Selection.htm)
		 Свойство Selection
		 определяет отметку элементов примитива, которую необходимо установить/снять
		 при построении схемы отметки справочника.
