...
Where: [IExpression](ForeSys.chm::/Interface/IExpression/IExpression.htm);
...
Свойство Where возвращает условие
 фильтрации всех элементов блока табличного справочника.
...
После выполнения примера в справочнике будет создан новый рекурсивный
 ...
 равным "0". Отображаться будут элементы имеющие значение поля
 "Id" в диапазоне "0-30".
