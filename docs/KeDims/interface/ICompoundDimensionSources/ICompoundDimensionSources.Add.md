...
Add(Key: Integer): [ICompoundDimensionSource](../ICompoundDimensionSource/ICompoundDimensionSource.htm);
...
После выполнения примера, измерение фактов виртуального куба будет определено
 как составной справочник. В данное измерение будут включены справочники
