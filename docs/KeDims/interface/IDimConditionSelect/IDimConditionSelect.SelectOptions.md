# IDimConditionSelect.SelectOptions
...
SelectOptions: [ConditionSelectOptions](../../Enums/ConditionSelectOptions.htm);


## Описание


Свойство SelectOptions определяет
 параметры поиска.
...
[IDimConditionSelect](IDimConditionSelect.htm)
