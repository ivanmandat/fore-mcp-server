# IDimChildrenWithParentGroupPrimitive
...
Интерфейс IDimChildrenWithParentGroupPrimitive
 содержит свойства примитива группы элементов, оставляющего дочерние элементы
 c родителями.
