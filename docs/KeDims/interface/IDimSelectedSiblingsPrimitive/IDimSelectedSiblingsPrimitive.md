...
Интерфейс IDimSelectedSiblingsPrimitive
 содержит свойства примитива, осуществляющего установку/снятие отметки
 у элементов, расположенных на том же уровне, на котором расположен отмеченный
 элемент справочника.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Selection](IDimSelectedSiblingsPrimitive.Selection.htm)
		 Свойство Selection
		 определяет отметку элементов примитива.
