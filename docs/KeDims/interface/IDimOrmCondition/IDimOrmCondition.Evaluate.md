...
Evaluate(Element: [IDimElement](../IDimElement/IDimElement.htm)): Boolean;
...
Метод Evaluate возвращает True, в случае если элемент измерения удовлетворяет условиям, в противном случае - False.
