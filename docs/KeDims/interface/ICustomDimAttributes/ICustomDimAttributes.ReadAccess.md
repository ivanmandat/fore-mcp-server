...
ReadAccess: [ICustomDimAttribute](../ICustomDimAttribute/ICustomDimAttribute.htm);
...
Свойство ReadAccess определяет
 атрибут, который используется для ограничения прав на чтение значений
...
После выполнения примера в окно консоли будет выведен ключ атрибута,
 ограничивающего права на чтение записей измерения, если он установлен.
