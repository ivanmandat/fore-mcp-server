# IDynamicInstance.AttributeValue
...
AttributeValue(Element: Integer; Attribute: [IDimAttributeInstance](../IDimAttributeInstance/IDimAttributeInstance.htm)):
 Variant;
...
Свойство AttributeValue определяет
 значение атрибута элемента справочника.
...
        Dim.AttributeValue(Element, AttrsInst.Item(0)));
...
        Dim.DisplayValue(Element, AttrsInst.Item(0)));
