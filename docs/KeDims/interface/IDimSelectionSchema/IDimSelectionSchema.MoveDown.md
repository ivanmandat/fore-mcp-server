...
Метод MoveDown осуществляет
 перемещение примитива, индекс которого передается посредством параметра
 Index, на одну позицию вниз.
...
После выполнения примера первый примитив первой схемы отметки справочника,
 будет перемещен на одну позицию вниз. Идентификатор справочника - «TAB_DIM».
