...
Метод Remove осуществляет удаление
 примитива схемы отметки, индекс которого передается посредством параметра
 Index.
...
## Пример
	...
	            DimSelSchema.Remove(DimSelSchema.Count-1);
...
После выполнения примера из первой схемы отметки справочника, будет
 удален последний примитив. Идентификатор справочника - «TAB_DIM».
