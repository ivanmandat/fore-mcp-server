...
WriteAccess: [IDimAttribute](../IDimAttribute/IDimAttribute.htm);
...
Свойство WriteAccess возвращает
 объект, содержащий атрибут справочника, ограничивающий права на изменение
 данных по этому элементу в OLAP.
