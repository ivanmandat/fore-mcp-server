# ICalendarDimension.IncludeDays
...
Свойство IncludeDays определяет, будет ли присутствовать уровень «Дни» в календарном справочнике.
...
После выполнения примера в календарном справочнике будет включен уровень «Дни».
