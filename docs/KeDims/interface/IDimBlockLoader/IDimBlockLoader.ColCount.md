...
Свойство ColCount возвращает
 количество столбцов в загрузчике, в которых содержатся данные. Количество
 столбцов соответствует количеству атрибутов, созданных в справочнике.
...
Данный пример является макросом для вычисляемого справочника. Справочник
 ...
 - количество столбцов в загрузчике, в которых находятся данные.
