# Создание шага «Ручное действие»: Настольное приложение

Создание шага «Ручное действие»: Настольное приложение
-


# Создание шага «Ручное действие»


	Шаг «Ручное действие» предназначен
	 для описания задач, выполнение которых подразумевает действия человека
	 без использования каких-либо автоматизированных механизмов выполнения.
	 Например, подписание договора или разгрузка товара.


	Для создания шага откройте мастер шага ручного действия.
...
[![](../../../opened.gif)![](../../../closed.gif)Для открытия
 мастера](javascript:TextPopup(this))
	...
	Настройка шага «Ручное действие» состоит
	 из следующих действий:
		...
		- [Настройка параметров
		 описания шага](Manual_Task.htm#base_settings).


		- [Настройка событий, выполняемых
		 при запуске выполнения шага или после его завершения](Manual_Task.htm#events).
...
## Настройка параметров описания шага
	...
	Задайте параметры:
		...
		- Роль
		 ...
		 ответственных за выполнение шага при исполнении процесса.
...
Срок выполнения шагов влияет на срок выполнения
 ...
 процесса](../Start_Process.htm);
	...
	Примечание.
	 Во время [выполнения
	 шага](../../MonitoringProcess/Manual_mode.htm) вышеуказанные параметры будут отображены в окне «Информация
	 о шаге ручного действия», которое открывается при выполнении
	 команды «[Открыть
	 связанный объект](../../MonitoringProcess/Manual_mode.htm#open_linked_object)».
