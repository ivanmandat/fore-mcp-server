# Перезапуск экземпляров подпроцесса: Настольное приложение
...
Если шаг «[Вызов
 ...
 подпроцесса:
	...
	- Выделите в дереве процессов или в рабочей области подпроцесс
	 и нажмите на кнопку ![](../Process/button_execute_step.png) «Завершить».
...
Для задания параметров запуска подпроцесса
 ...
 разбивки](../Process/StepsProcess/Subprocess.htm#splitting_parameter), для которых были запущены экземпляры подпроцесса:


![](Restart_Subprocesses.png)
