# Создание шага «Ввод данных»: Веб-приложение
...
# Создание шага «Ввод данных»
	...
	Для создания шага по вводу определённого набора данных:
		...
		- Выделите этап процесса или
		 шаг этапа и выберите шаг ![](b_create_def.png) «Ввод
		 данных» из раскрывающегося списка кнопки ![](b_create_def.png) «Ввод
		 данных». Кнопка выбора шага имеет вид последнего выбранного
		 шага.


		- В рабочей области выделите
		 созданный шаг «Ввод данных»
		 и нажмите кнопку ![](../b_settings.png) «Настройки»
		 на [панели инструментов](../../Starting/Starting.htm#legend_web).
		 Будет открыта панель параметров «Ввод
		 данных» для настройки шага;
	...
	Настройка шага «Ввод данных»
	 состоит из следующих действий:
		...
		- [Настройка базовых
		 свойств и параметров описания шага](Data_Entry.htm#base_settings).
		...
		- [Настройка действий, выполняемых
		 при наступлении события](Data_Entry.htm#events).
...
## Настройка базовых свойств и параметров
	...
	Задайте параметры:
		...
		- Передать
		 права редактирования. Установите флажок для предоставления
		 динамического права на чтение и запись в сегмент данных пользователю
		 или группе пользователей, указанным в раскрывающемся списке «Пользователь». Выбранные пользователи
		 должны содержаться в объекте полномочий, указанном в раскрывающемся
...
## Настройка связи параметров формы ввода/отчёта
	...
	Для каждого статичного поля, в котором отображается наименование
	 ...
	 и формы ввода/отчёта, должны иметь идентичную структуру или [связаны
...
## Настройка действий, выполняемых при наступлении
	...
	Для настройки событий, выполняемых автоматически, используйте вкладку
	 «События» [панели
	 параметров](../../Starting/Starting.htm#legend_web) шага:


	![](dataentry_events.png)
