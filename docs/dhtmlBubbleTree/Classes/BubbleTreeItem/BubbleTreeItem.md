...
Класс **BubbleTreeItem**
 реализует элемент [пузырькового
 дерева](../../Components/BubbleTree/BubbleTree.htm).


## Синтаксис


PP.initClass(PP.Ui.BubbleTreeItem, [PP.Ui.TreeItem](dhtmlUiTree.chm::/Classes/TreeItem/TreeItem.htm),
 "PP.Ui.BubbleTreeItem");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [BubbleTreeItem](Constructor_BubbleTreeItem.htm)
			 Конструктор **BubbleTreeItem**
			 создаёт экземпляр класса **BubbleTreeItem**.
...
## Свойства
		 ...
		 ![](../../property_image.gif)
		 [Color](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.Color.htm)
		 Свойство **Color**
		 определяет цвет элемента пузырькового дерева.


		 ![](../../property_image.gif)
		 [Size](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.Size.htm)
		 Свойство **Size**
		 определяет размер элемента пузырькового дерева.


		 ![](../../property_image.gif)
		 [Values](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.Values.htm)
		 Свойство **Values**
		 определяет значения настроек элемента пузырькового дерева.


		 ![](../../property_image.gif)
		 [Text](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.text.htm)
		 Свойство **Text**
		 определяет значение настройки текста элемента пузырькового дерева.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [animationStep](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.animationStep.htm)
		 Метод **animationStep**
		 рассчитывает кадр анимации элемента пузырькового дерева.


		 ![](../../sub_image.gif)
		 [draw](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.draw.htm)
		 Метод **draw** перерисовывает
		 элемент пузырькового дерева.


		 ![](../../sub_image.gif)
		 [drawTooltips](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.drawTooltips.htm)
		 Метод drawTooltips
		 отрисовывает всплывающую подсказку элемента пузырькового дерева.


		 ![](../../sub_image.gif)
		 [getNeighbors](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.getNeighbors.htm)
		 Метод **getNeighbors**
		 возвращает соседние элементы текущего элемента пузырькового дерева.


		 ![](../../sub_image.gif)
		 [getRadius](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.getRadius.htm)
		 Метод **getRadius**
		 возвращает радиус элемента пузырькового дерева.


		 ![](../../sub_image.gif)
		 [setRotationDirection](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.setRotationDirection.htm)
		 Метод **setRotationDirection**
		 задает направление вращения элемента пузырькового дерева.


		 ![](../../sub_image.gif)
		 [updateContent](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.updateContent.htm)
		 Метод **updateContent**
		 обновляет текстовое содержимое элемента пузырькового дерева.


		 ![](../../sub_image.gif)
		 [updateTooltip](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTreeItem.updateTooltip.htm)
		 Метод **updateTooltip**
		 обновляет объект всплывающей подсказки элемента пузырькового дерева.


		 ![](../../sub_image.gif)
		 [updateTooltipSettings](dhtmlBubbleTree.chm::/Classes/BubbleTreeItem/BubbleTree.updateTooltipSettings.htm)
		 Метод **updateTooltipSettings**
		 обновляет настройки всплывающей подсказки элемента пузырькового
		 дерева и его потомков.
