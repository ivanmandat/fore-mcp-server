...
[TreeDataVisualizer](dhtmlUiTree.chm::/Classes/TreeDataVisualizer/TreeDataVisualizer.htm)
...
Класс **BubbleTree** реализует
 [пузырьковое дерево](../../Components/BubbleTree/BubbleTree.htm).


## Синтаксис


PP.initClass(PP.Ui.BubbleTree, [PP.Ui.TreeDataVisualizer](dhtmlUiTree.chm::/Classes/TreeDataVisualizer/TreeDataVisualizer.htm),
 "PP.Ui.BubbleTree");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [BubbleTree](dhtmlBubbleTree.chm::/Classes/BubbleTree/Constructor_BubbleTree.htm)
			 Конструктор **BubbleTree**
			 создаёт экземпляр класса **BubbleTree**.
...
## Свойства
		 ...
		 ![](../../property_image.gif)
		 [Alignment](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.Alignment.htm)
		 Свойство **Alignment**
		 определяет ориентацию пузырькового дерева.


		 ![](../../property_image.gif)
		 [BubbleMinSize](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.BubbleMinSize.htm)
		 Свойство **BubbleMinSize**
		 определяет минимальный размер пузырька у пузырькового дерева.


		 ![](../../property_image.gif)
		 [BubbleStyle](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.BubbleStyle.htm)
		 Свойство **BubbleStyle**
		 определяет стиль пузырька у пузырькового дерева.


		 ![](../../property_image.gif)
		 [ColorVisual](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.ColorVisual.htm)
		 Свойство **ColorVisual**
		 определяет описание показателя, данные из которого применяются
		 для заливки элементов пузырькового дерева.


		 ![](../../property_image.gif)
		 [InnerLabelsStyle](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.InnerLabelsStyle.htm)
		 Свойство **InnerLabelsStyle**
		 определяет стиль подписей элементов пузырькового дерева.


		 ![](../../property_image.gif)
		 [ItemsTooltipStyle](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.ItemsTooltipStyle.htm)
		 Свойство **ItemsTooltipStyle**
		 определяет стиль всплывающей подсказки элементов пузырькового
		 дерева.


		 ![](../../property_image.gif)
		 [LabelAutoColor](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.LabelAutoColor.htm)
		 Свойство LabelAutoColor
		 определяет, будет ли цвет текста элементов пузырькового дерева
		 рассчитываться автоматически.


		 ![](../../property_image.gif)
		 [OrbitsPen](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.OrbitsPen.htm)
		 Свойство **OrbitsPen**
		 определяет стиль орбит пузырькового дерева.


		 ![](../../property_image.gif)
		 [OuterLabelsStyle](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.OuterLabelsStyle.htm)
		 Свойство **OuterLabelsStyle**
		 определяет стиль значений элементов пузырькового дерева.


		 ![](../../property_image.gif)
		 [SideBubbleMinSize](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.SideBubbleMinSize.htm)
		 Свойство **SideBubbleMinSize**
		 определяет минимальный размер соседних пузырьков пузырькового
		 дерева.


		 ![](../../property_image.gif)
		 [SizeVisual](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.SizeVisual.htm)
		 Свойство **SizeVisual**
		 **определяет о**писание
		 показателя, данные из которого применяются для расчета размера
		 элементов пузырькового дерева.


		 ![](../../property_image.gif)
		 [TextVisual](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.TextVisual.htm)
		 Свойство **TextVisual**
		 **определяет о**писание
		 показателя, данные из которого применятся к подписям элементов пузырькового
		 дерева.


		 ![](../../property_image.gif)
		 [ToolTipDelay](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.ToolTipDelay.htm)
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [fireItemsHovered](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.fireItemsHovered.htm)
		 Метод fireItemsHovered вызывает
		 событие [ItemsHovered](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.ItemsHovered.htm)
		 для указанного объекта.


		 ![](../../sub_image.gif)
		 [getAlign](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getAlign.htm)
		 Метод **getAlign**
		 возвращает коэффициенты ориентации пузырькового дерева.


		 ![](../../sub_image.gif)
		 [getCenter](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getCenter.htm)
		 Метод **getCenter**
		 возвращает координаты центра пузырькового дерева.


		 ![](../../sub_image.gif)
		 [getColorOptions](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getColorOptions.htm)
		 Метод **getColorOptions**
		 возвращает настройки для панели цвета в формате настроек мастера.


		 ![](../../sub_image.gif)
		 [getFreeArea](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getFreeArea.htm)
		 Метод **getFreeArea**
		 возвращает свободную область пузырькового дерева, в которой располагаются
		 элементы.


		 ![](../../sub_image.gif)
		 [getLegendOptions](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getLegendOptions.htm)
		 Метод **getLegendOptions**
		 возвращает настройки для панели легенды в формате настроек мастера.


		 ![](../../sub_image.gif)
		 [getSizeLegendOptions](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getSizeLegendOptions.htm)
		 ...
		 ![](../../sub_image.gif)
		 [getSizeOptions](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getSizeOptions.htm)
		 Метод **getSizeOptions**
		 возвращает настройки для панели цвета в формате настроек мастера.


		 ![](../../sub_image.gif)
		 [getState](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.getState.htm)
		 Метод **getState**
		 возвращает настройки компонента в формате настроек мастера.


		 ![](../../sub_image.gif)
		 [hoverItems](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.hoverItems.htm)
		 Метод hoverItems устанавливает
		 наведение указателя на элементы пузырькового дерева.


		 ![](../../sub_image.gif)
		 [isPointOut](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.isPointOut.htm)
		 Метод **isPointOut**
		 возвращает признак нахождения точки с указанными координатами
		 вне границ пузырькового дерева.


		 ![](../../sub_image.gif)
		 [selectItem](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.selectItem.htm)
		 Метод selectItem выделяет
		 указанный элемент пузырькового дерева.


		 ![](../../sub_image.gif)
		 [selectItems](dhtmlBubbleTree.chm::/Classes/BubbleTree/BubbleTree.selectItems.htm)
		 Метод selectItems выделяет
		 указанные элементы пузырькового дерева.
...
## События
		 ...
		 ![](../../event_image.gif)
		 [ItemsHovered](BubbleTree.ItemsHovered.htm)
		 Событие ItemsHovered наступает
		 при наведении указателя на элемент пузырькового дерева.
