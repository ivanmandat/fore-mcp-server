...
Класс **ChartBreadcrumb**
 реализует цепочку навигации по уровням элементов иерархических диаграмм.
...
Класс **ChartBreadcrumb**
 используется компонентами [BubbleTree](../../Components/BubbleTree/BubbleTree.htm)
 и [TreeMap](../../Components/TreeMap/TreeMap.htm).


## Синтаксис


PP.initClass(PP.Ui.ChartBreadcrumb, PP.Ui.PlacedControlBase,
 "PP.Ui.ChartBreadcrumb");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [ChartBreadcrumb](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumb/Constructor_ChartBreadcrumb.htm)
			 Конструктор **ChartBreadcrumb**
			 создаёт экземпляр класса **ChartBreadcrumb**.
...
## Свойства
		 ...
		 ![](../../property_image.gif)
		 [ItemStyle](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumb/ChartBreadcrumb.ItemStyle.htm)
		 Свойство **ItemStyle**
		 определяет стиль элементов цепочки навигации.


		 ![](../../property_image.gif)
		 [Model](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumb/ChartBreadcrumb.Model.htm)
		 Свойство **Model**
		 определяет модель данных цепочки навигации.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [update](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumb/ChartBreadcrumb.update.htm)
		 Метод **update**
		 обновляет цепочку навигации по уровням элементов диаграммы.
...
## События
		 ...
		 ![](../../event_image.gif)
		 [ItemClicked](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumb/ChartBreadcrumb.ItemClicked.htm)
		 Событие ItemClicked
		 наступает при окончании нажатия кнопки мыши на элемент цепочки
		 навигации.


		 ![](../../event_image.gif)
		 [ItemClicking](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumb/ChartBreadcrumb.ItemClicking.htm)
		 Событие ItemClicking наступает
		 при нажатии на элемент цепочки навигации.
