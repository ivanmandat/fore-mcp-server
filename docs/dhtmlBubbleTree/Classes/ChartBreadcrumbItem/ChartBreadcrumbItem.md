...
Класс **ChartBreadcrumbItem**
 реализует элемент цепочки навигации по уровням элементов [плоского
 дерева](../../Components/TreeMap/TreeMap.htm).


## Синтаксис


PP.initClass(PP.Ui.ChartBreadcrumbItem, PP.Ui.PlacedControlBase,
 "PP.Ui.ChartBreadcrumbItem");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [ChartBreadcrumbItem](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumbItem/Constructor_ChartBreadcrumbItem.htm)
			 Конструктор **ChartBreadcrumbItem** создаёт экземпляр
			 класса **ChartBreadcrumbItem**.
...
## Свойства
		 ...
		 ![](../../property_image.gif)
		 [Caption](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumbItem/ChartBreadcrumbItem.Caption.htm)
		 Свойство **Caption**
		 определяет текстовое содержимое элемента цепочки навигации.


		 ![](../../property_image.gif)
		 [LastItem](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumbItem/ChartBreadcrumbItem.LastItem.htm)
		 Свойство **LastItem**
		 определяет, является ли текущий элемент цепочки навигации её последним
		 элементом.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [updateLabel](dhtmlBubbleTree.chm::/Classes/ChartBreadcrumbItem/ChartBreadcrumbItem.updateLabel.htm)
		 Метод **updateLabel**
		 обновляет текстовую метку элемента цепочки навигации.
