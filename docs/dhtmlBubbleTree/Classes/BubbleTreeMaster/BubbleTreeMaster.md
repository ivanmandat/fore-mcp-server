...
Класс **BubbleTreeMaster**
 реализует [мастер
 пузырькового дерева](../../Components/BubbleTreeMaster/BubbleTreeMaster.htm).


## Синтаксис


PP.initClass(PP.Ui.BubbleTreeMaster, [PP.Ui.TreeChartMaster](dhtmlUiTree.chm::/Classes/TreeChartMaster/TreeChartMaster.htm),
 "PP.Ui.BubbleTreeMaster", [PP.Ui.IMasterView]);
