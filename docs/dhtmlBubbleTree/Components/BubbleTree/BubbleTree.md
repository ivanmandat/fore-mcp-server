...
Компонент BubbleTree реализован
 классом [BubbleTree](../../Classes/BubbleTree/BubbleTree.htm).


## Пример


Компонент BubbleTree может иметь
 следующий вид:
...
[Пример создания компонента BubbleTree](BubbleTree_Example.htm)
