...
Компонент TreeMapMaster представляет
 собой мастер [плоского дерева](../TreeMap/TreeMap.htm).


## Комментарии


Компонент TreeMapMaster реализован
 классом [TreeMapMaster](../../Classes/TreeMapMaster/TreeMapMaster.htm).


## Пример


Компонент TreeMapMaster имеет
 следующий вид:
...
[Пример размещения компонентов
 TreeMapMaster и TreeMap](TreeMapMaster_and_TreeMap.htm).
