...
Компонент BubbleTreeMaster представляет
 собой мастер [пузырькового дерева](../BubbleTree/BubbleTree.htm).


## Комментарии


Компонент BubbleTreeMaster реализован
 классом [BubbleTreeMaster](../../Classes/BubbleTreeMaster/BubbleTreeMaster.htm).


## Пример


Компонент BubbleTreeMaster имеет
 следующий вид:


![](BubbleTreeMaster.png)


[Пример размещения компонентов
 BubbleTreeMaster и BubbleTree](BubbleTreeMaster_and_BubbleTree.htm).
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [BubbleTreeMaster](dhtmlBubbleTree.chm::/Classes/BubbleTreeMaster/Constructor_BubbleTreeMaster.htm)
			 Конструктор BubbleTreeMaster
			 создаёт экземпляр класса BubbleTreeMaster.
