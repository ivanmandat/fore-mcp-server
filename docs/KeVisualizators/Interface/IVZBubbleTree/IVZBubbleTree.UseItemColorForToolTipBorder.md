# IVZBubbleTree.UseItemColorForToolTipBorder
...
Для выполнения примера предполагается наличие экспресс-отчёта с идентификатором
 EXP, который содержит пузырьковое дерево.


Добавьте ссылки на системные
 сборки: Express, Metabase, Vizualizators.


В примере отключается зависимость границ всплывающих подсказок от цвета
 элемента:
	...
	    // Отключаем отображение границ всплывающей подсказки цветом элемента
