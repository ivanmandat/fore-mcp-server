# Просмотр целевой функции: Блок линейной оптимизации, веб-приложение
...
Для просмотра целевой функции:
	...
	- нажмите кнопку ![](../Work/b_function.png) «Показать
	 внешний вид целевой функции» в мастере редактирования блока
	 линейной оптимизации. Кнопка доступна, начиная со страницы «[Целевая
...
Для просмотра информации об элементе щёлкните по нему. Информация будет
 отражена в поле «Значение переменной»
 в виде:
