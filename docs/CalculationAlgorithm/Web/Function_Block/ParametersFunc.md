# Добавление параметров: Блок функции, веб-приложение
...
Параметры позволяют динамически управлять расчётом блока. Обратите внимание,
 что параметры будут переданы в функцию в том порядке, в котором они следуют
 в мастере редактирования блока функции.


Добавление параметров блока функции выполняется на странице «Параметры»
