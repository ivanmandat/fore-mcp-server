# Добавление параметров: Блок агрегации, веб-приложение
...
Параметры позволяют динамически управлять расчётом блока. Также их можно
 ...
 фильтрации данных приёмника](Aggregation_block_Receiver.htm#filter).


Добавление параметров блока агрегации выполняется на странице «Параметры» в [мастере
