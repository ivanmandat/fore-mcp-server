# Добавление параметров: Блок агрегации, настольное приложение
...
Параметры позволяют динамически управлять расчётом блока. Также их можно
 использовать для настройки фильтрации данных приёмника.


Добавление параметров блока агрегации выполняется на странице «Параметры» в мастере редактирования
 блока агрегации:
