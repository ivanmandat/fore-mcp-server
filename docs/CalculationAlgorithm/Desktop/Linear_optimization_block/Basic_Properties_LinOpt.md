# Настройка базовых свойств: Блок линейной оптимизации, настольное приложение
...
Настройка базовых свойств блока линейной оптимизации выполняется на
 странице «Базовые свойства» в
 мастере редактирования блока линейной оптимизации:
