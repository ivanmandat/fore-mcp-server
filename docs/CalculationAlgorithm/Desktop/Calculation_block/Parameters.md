# Добавление параметров: Блок расчёта, настольное приложение
...
Параметры позволяют динамически управлять расчётом блока. Также их можно
 использовать для создания формул расчёта блока, настройки фильтрации данных
 приёмника и фильтрации по данным источника.
...
[![](../../Opened.gif)![](../../Closed.gif)Изменение порядка
 следования параметров](javascript:TextPopup(this))
	...
	Для изменения порядка следования выделенного параметра используйте
	 кнопки ![](b_param_up.png) и ![](b_param_down.png).
