# Настройка базовых свойств: Блок расчёта, настольное приложение
...
Настройка базовых свойств блока расчёта выполняется на странице «Базовые свойства» в мастере редактирования
 блока расчёта:
