# Добавление атрибутов субъекту безопасности
...
Добавление атрибутов субъекту осуществляется двумя способами:


	- при [создании
	 пользовательских атрибутов](Admin.chm::/04_SecurityPolicy/Creating_attributes.htm) в менеджере безопасности;


	- в среде разработки с помощью сборки ABAC.


Рассмотрим пример добавления атрибутов пользователям и группам пользователей
 с помощью сборки ABAC.
