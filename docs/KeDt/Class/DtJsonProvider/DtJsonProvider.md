...
Класс DtJsonProvider реализует
 источник данных, осуществляющий импорт данных из JSON-файла.


## Свойства, унаследованные от [IDtJsonProvider](../../Interface/IDtJsonProvider/IDtJsonProvider.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [File](../../Interface/IDtJsonProvider/IDtJsonProvider.File.htm)


		 Свойство File определяет
		 путь и наименование JSON-файла, из которого импортируются данные.


		 ![](../../Property_Image.gif)
		 [Query](../../Interface/IDtJsonProvider/IDtJsonProvider.Query.htm)


		 Свойство Query определяет
		 JSONPath-запрос, в соответствии с которым будут отбираться импортируемые
		 данные.
