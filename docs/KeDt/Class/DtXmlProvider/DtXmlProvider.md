...
Класс DtXmlProvider реализует
 объект, осуществляющий импорт данных в файлы в формате XML.


## Комментарии


Объект данного класса может применяться для прямого импорта данных,
 представленных в формате XML, а также используется при настройке объекта
 задачи Etl - [Импорт
 из XML](UiETL.chm::/Desktop/03_ETLObjects/02_Inputs/UiEtl_Inputs_XML.htm).


## Свойства, унаследованные от [IDtXmlProvider](../../Interface/IDtXmlProvider/IDtXmlProvider.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [File](../../Interface/IDtXmlProvider/IDtXmlProvider.File.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FormatType](../../Interface/IDtXmlProvider/IDtXmlProvider.FormatType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [XPath](../../Interface/IDtXmlProvider/IDtXmlProvider.XPath.htm)
