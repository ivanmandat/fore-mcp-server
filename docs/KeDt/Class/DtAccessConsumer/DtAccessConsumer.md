...
Класс DtAccessConsumer реализует
 объект, осуществляющий экспорт данных в таблицы, хранящиеся в базах данных
 Microsoft Access.
...
Объект данного класса может применяться для прямого экспорта массива
 данных в таблицы Microsoft Access, а также используется при настройке
 объекта задачи Etl - [Экспорт
 в Access](UiETL.chm::/Desktop/03_ETLObjects/03_Outputs/Access/UiEtl_Outputs_Access.htm).


## Свойства, унаследованные от [IDtAccessConsumer](../../Interface/IDtAccessConsumer/IDtAccessConsumer.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [File](../../Interface/IDtAccessConsumer/IDtAccessConsumer.File.htm)


		 Свойство File определяет
		 наименование файла базы данных Access, в таблицы которой будет
		 производиться экспорт данных.


		 ![](../../Property_Image.gif)
		 [Table](../../Interface/IDtAccessConsumer/IDtAccessConsumer.Table.htm)


		 Свойство Table определяет
		 наименование таблицы, в которую будет производиться экспорт данных.
