...
Класс DtXmlConsumer реализует
 объект, осуществляющий экспорт данных в файлы в формате XML.
...
Объект данного класса может применяться для прямого экспорта массива
 данных в текстовый файл в формате XML, а также используется при настройке
 объекта задачи Etl - [Экспорт
 в XML](UiETL.chm::/Desktop/03_ETLObjects/03_Outputs/XML/UiEtl_outputs_XML.htm).


## Свойства, унаследованные от [IDtXmlConsumer](../../Interface/IDtXmlConsumer/IDtXmlConsumer.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DataNodeName](../../Interface/IDtXmlConsumer/IDtXmlConsumer.DataNodeName.htm)


		 Свойство DataNodeName
		 определяет наименование вершины с данными.


		 ![](../../Property_Image.gif)
		 [File](../../Interface/IDtXmlConsumer/IDtXmlConsumer.File.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FormatType](../../Interface/IDtXmlConsumer/IDtXmlConsumer.FormatType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RootNodeName](../../Interface/IDtXmlConsumer/IDtXmlConsumer.RootNodeName.htm)


		 Свойство RootNodeName
		 определяет наименование корневой вершины.
