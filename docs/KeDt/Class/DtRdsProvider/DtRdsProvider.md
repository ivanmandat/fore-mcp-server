...
Класс DtRdsProvider реализует
 источник данных, осуществляющий импорт данных из справочника НСИ.


## Свойства, унаследованные от [IDtRdsProvider](../../Interface/IDtRdsProvider/IDtRdsProvider.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Dataset](../../Interface/IDtRdsProvider/IDtRdsProvider.Dataset.htm)
