...
Класс DtUserProviderEx предназначен
 для получения данных с помощью пользовательского алгоритма.
...
## Свойства, унаследованные от [IDtUserProviderEx](../../Interface/IDtUserProviderEx/IDtUserProviderEx.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CustomObject](../../Interface/IDtUserProviderEx/IDtUserProviderEx.CustomObject.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CustomProvider](../../Interface/IDtUserProviderEx/IDtUserProviderEx.CustomProvider.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Macro](../../Interface/IDtUserProviderEx/IDtUserProviderEx.Macro.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Module](../../Interface/IDtUserProviderEx/IDtUserProviderEx.Module.htm)
