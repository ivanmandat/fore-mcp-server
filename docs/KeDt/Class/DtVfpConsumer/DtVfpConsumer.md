...
Класс DtVfpConsumer реализует
 объект, осуществляющий экспорт данных в таблицы Visual Foxpro.
...
Объект данного класса может применяться для прямого экспорта массива
 данных в таблицы Visual Foxpro, а также используется при настройке объекта
 задачи Etl - [Экспорт
 в Visual Foxpro](UiETL.chm::/Desktop/03_ETLObjects/03_Outputs/Visual_FoxPro/UiEtl_Outputs_VisualFoxPro.htm).


## Свойства, унаследованные от [IDtVfpConsumer](../../Interface/IDtVfpConsumer/IDtVfpConsumer.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Path](../../Interface/IDtVfpConsumer/IDtVfpConsumer.Path.htm)
		 Свойство Path определяет
		 путь к базе данных или каталогу со свободными таблицами Viasual
		 Foxpro.


		 ![](../../Property_Image.gif)
		 [Table](../../Interface/IDtVfpConsumer/IDtVfpConsumer.Table.htm)
