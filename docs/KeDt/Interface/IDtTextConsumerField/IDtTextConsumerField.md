...
Интерфейс IDtTextConsumerField
 содержит свойства поля приёмника данных, необходимые при работе с файлами,
 данные в которых расположены в фиксированных позициях.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [FixedLength](IDtTextConsumerField.FixedLength.htm)


		 Свойство FixedLength
		 определяет длину поля в символах.
