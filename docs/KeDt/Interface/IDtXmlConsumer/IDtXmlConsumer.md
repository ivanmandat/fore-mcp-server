...
Интерфейс IDtXmlConsumer содержит
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DataNodeName](IDtXmlConsumer.DataNodeName.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FormatType](IDtXmlConsumer.FormatType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RootNodeName](IDtXmlConsumer.RootNodeName.htm)
