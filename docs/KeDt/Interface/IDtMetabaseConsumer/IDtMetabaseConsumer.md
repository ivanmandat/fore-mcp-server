...
Интерфейс IDtMetabaseConsumer
 содержит свойства и методы приёмника данных - [Приёмник
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CatchAddRecordException](IDtMetabaseConsumer.CatchAddRecordException.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Dataset](IDtMetabaseConsumer.Dataset.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [KeyFieldNames](IDtMetabaseConsumer.KeyFieldNames.htm)
