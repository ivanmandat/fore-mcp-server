...
Интерфейс IDtRdsConsumer содержит
 свойства приёмника данных, осуществляющего экспорт данных в справочник
 НСИ.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AddCrossVersions](IDtRdsConsumer.AddCrossVersions.htm)
