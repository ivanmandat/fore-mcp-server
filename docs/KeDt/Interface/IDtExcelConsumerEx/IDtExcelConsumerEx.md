...
Интерфейс IDtExcelConsumerEx
 предназначен для выгрузки данных в приёмник Excel (формат *.xlsx).
...
Преимущества IDtExcelConsumerEx
 по сравнению с [IDtExcelConsumer](../IDtExcelConsumer/IDtExcelConsumer.htm):
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [File](IDtExcelConsumerEx.File.htm)
		 Свойство File определяет
		 полное наименование файла, в который будут выгружены данные.


		 ![](../../Property_Image.gif)
		 [ForceFullCalculation](IDtExcelConsumerEx.ForceFullCalculation.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HasHeader](IDtExcelConsumerEx.HasHeader.htm)
		 Свойство HasHeader
		 ...
		 ![](../../Property_Image.gif)
		 [Sheet](IDtExcelConsumerEx.Sheet.htm)
		 Свойство Sheet
