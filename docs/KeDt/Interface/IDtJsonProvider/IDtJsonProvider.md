...
Интерфейс IDtJsonProvider содержит
 свойства и методы источника данных - [Импорт
 из Json](UiETL.chm::/Desktop/03_ETLObjects/02_Inputs/Inputs_JSON.htm).
...
Использование данного типа приёмника актуально только при работе в задаче
 ...
 с типом [EtlObjectType.PlainDataJsonProvider](KeEtl.chm::/Enums/EtlObjectType.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Query](IDtJsonProvider.Query.htm)
