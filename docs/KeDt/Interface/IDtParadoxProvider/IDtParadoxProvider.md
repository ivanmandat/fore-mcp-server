...
Интерфейс IDtParadoxProvider
 содержит свойства и методы источника данных - [Импорт
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DriverVersion](IDtParadoxProvider.DriverVersion.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Path](IDtParadoxProvider.Path.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Query](IDtParadoxProvider.Query.htm)
