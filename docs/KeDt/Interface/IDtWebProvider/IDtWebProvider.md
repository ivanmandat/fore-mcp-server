...
Интерфейс IDtWebProvider содержит
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [HasHeader](IDtWebProvider.HasHeader.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TableAttributeName](IDtWebProvider.TableAttributeName.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TableAttributeValue](IDtWebProvider.TableAttributeValue.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TableIdentificationType](IDtWebProvider.TableIdentificationType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TableNumber](IDtWebProvider.TableNumber.htm)
