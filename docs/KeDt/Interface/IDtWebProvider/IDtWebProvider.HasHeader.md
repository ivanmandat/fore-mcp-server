...
Свойство HasHeader определяет
 признак импорта заголовков полей из первой строки таблицы.
...
По умолчанию свойству установлено значение True,
 при этом из первой строки таблицы будут импортироваться заголовки полей.
 Если свойству установить значение False,
 то первая строка будет расцениваться как строка с данными.
