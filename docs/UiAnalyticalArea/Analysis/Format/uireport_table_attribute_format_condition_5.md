# Форматировать ячейки с уникальными/повторяющимися значениями
...
Данный тип условия форматирования предназначен для форматирования ячеек,
 содержащих уникальные или повторяющиеся значения.


Например, в таблице отформатированы повторяющиеся значения:


![](Format_Cells_Unique_Values.png)


Для настройки форматирования ячеек, содержащих уникальные и повторяющиеся
 значения, используйте вкладку «Условное
 форматирование» на боковой панели или диалог «Параметры
...
[![](../../opened.gif)![](../../closed.gif)Для открытия
 диалога](javascript:TextPopup(this))
	...
	Вкладка Диалог
		...
		![](Panel_Format_Cells_Unique_Values.png)


		![](Conditional_Format_ValueUnique.gif)
...
Задайте следующие настройки:
	...
	- Форматировать ячейки.
	 Выберите тип форматируемых значений: уникальные или повторяющиеся;
