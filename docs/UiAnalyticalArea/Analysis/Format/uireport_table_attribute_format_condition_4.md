# Форматировать ячейки со значениями больше/меньше среднего
...
Данный тип условия форматирования предназначен для форматирования ячеек,
 содержащих значения больше или меньше среднего.


Например, в таблице отформатированы значения выше среднего:


![](Format_Cells_Greater_Average.png)


Для настройки форматирования ячеек, содержащих значения больше или меньше
 среднего, используйте вкладку «Условное
...
[![](../../opened.gif)![](../../closed.gif)Для открытия
 диалога](javascript:TextPopup(this))
	...
	Вкладка Диалог
		...
		![](Panel_Format_Cells_Greater_Average.png)


		![](Conditional_Format_Average.gif)
...
Задайте следующие настройки:
	...
	- Форматировать ячейки.
	 Выберите тип форматируемых значений: больше или меньше среднего;
