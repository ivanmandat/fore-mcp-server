...
SetTreeMapResult SetTreeMap(TreeMapId tTreeMap,
 SetTreeMapArg tArg)
...
Для выполнения операции укажите в поле tTreeMap
 моникёр плоского дерева, а в поле tArg.meta
 обновленные настройки, которые необходимо применить. Моникёр может быть
 сформирован на базе моникёра экспресс-отчета по следующему правилу: «Моникёр открытого экземпляра экспресс-отчета»!TreeMap.


Настройки, которые могут быть изменены и указаны в поле tArg.meta.md,
 можно получить с помощью операции [GetTreeMap](GetTreeMap.htm).
...
Ниже приведен пример использования операции SetTreeMap
 для изменения настроек плоского дерева. В запросе передается моникёр плоского
 дерева и обновлённые настройки.
...
[![](../../minus.gif)](../../#)<SetTreeMap xmlns="**http://www.fsight.ru/PP.SOM.Som**">
...
[![](../../minus.gif)](../../#)<SetTreeMapResult xmlns="**http://www.fsight.ru/PP.SOM.Som**" xmlns:q1="**http://www.fsight.ru/PP.SOM.Som**" xmlns:xsi="**http://www.w3.org/2001/XMLSchema-instance**">
[![](../../minus.gif)](../../#)<id xmlns="****">
...
public static SetTreeMapResult SetTreeMapNewSettings(EaxId moniker, System.Xml.XmlElement settings)
{
    ...
    // Изменяем настройки плоского дерева
