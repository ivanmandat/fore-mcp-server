...
SetBubbleTreeResult SetBubbleTree(BubbleTreeId tBubbleTree,
 SetBubbleTreeArg tArg)
...
Операция SetBubbleTree изменяет
...
Для выполнения операции укажите в поле tBubbleTree
 моникёр пузырькового дерева, а в поле tArg.meta
 обновленные настройки, которые необходимо применить. Моникёр может быть
 сформирован на базе моникёра экспресс-отчета по следующему правилу: «Моникёр открытого экземпляра экспресс-отчета»!BubbleTree».


Настройки, которые могут быть изменены и указаны в поле tArg.meta.md,
 можно получить с помощью операции [GetBubbleTree](GetBubbleTree.htm).


Если после изменения необходимо получить обновленные настройки, то укажите
 поле tArg.metaGet.
...
Ниже приведен пример использования операции SetBubbleTree
 для изменения настроек пузырькового дерева. В запросе передается моникёр
 пузырькового дерева и обновлённые настройки.
...
[![](../../minus.gif)](../../#)<SetBubbleTree xmlns="**http://www.fsight.ru/PP.SOM.Som**">
...
[![](../../minus.gif)](../../#)<SetBubbleTreeResult xmlns="**http://www.fsight.ru/PP.SOM.Som**" xmlns:q1="**http://www.fsight.ru/PP.SOM.Som**" xmlns:xsi="**http://www.w3.org/2001/XMLSchema-instance**">
[![](../../minus.gif)](../../#)<id xmlns="****">
...
public static SetBubbleTreeResult SetBubbleTreeNewSettings(EaxId moniker, System.Xml.XmlElement settings)
{
    ...
    var tSet = new SetBubbleTree()
    {
        tArg = new SetBubbleTreeArg()
        {
            ...
            {
                //Новые настройки пузырькового дерева
                md = settings
            },
    ...
    // Изменяем настройки пузырькового дерева
