# Настройка параметров метода «Фильтр Ходрика-Прескотта»
...
Ниже приведен пример использования операции [SetMs](../SetMs.htm) для изменения параметров уравнения.
 ...
 Ходрика-Прескотта» и шаблон получения измененных данных. В результате
...
[![](../../../minus.gif)](../../../#)<tMs xmlns="****">
  <id>DGJIJLPNFDNBFOAEPHJKNFCLMDKEDKMEGLBBPNKPFCNCIKCH!M!S!CJHIPGPPNFDNBFOAEAMLGHACNALFGFIDELLBIBKBJDCCCKHHM</id>  </tMs>
...
  <missingData />
  <smoothingParameter>100</smoothingParameter>  <smoothingParameterMode>EditDirectly</smoothingParameterMode>  </hodrickPrescottFilter>
  </method>
  </it>
  </its>
  </formulas>
...
[![](../../../minus.gif)](../../../#)<id xmlns="****">
  <id>DGJIJLPNFDNBFOAEPHJKNFCLMDKEDKMEGLBBPNKPFCNCIKCH!M!S!CJHIPGPPNFDNBFOAEAMLGHACNALFGFIDELLBIBKBJDCCCKHHM</id>  </id>
...
  </missingData>
  <smoothingParameter>100</smoothingParameter>  <smoothingParameterMode>EditDirectly</smoothingParameterMode>  <power>2</power>  <smSmoothingParameter>NaN</smSmoothingParameter>[![](../../../minus.gif)](../../../#)<explained>
[![](../../../minus.gif)](../../../#)<slice>
 ...
 "SetMs" :
  {
   "tMs" :
    {
     "id" : "DGJIJLPNFDNBFOAEPHJKNFCLMDKEDKMEGLBBPNKPFCNCIKCH!M!S!CJHIPGPPNFDNBFOAEAMLGHACNALFGFIDELLBIBKBJDCCCKHHM"
    },
   "tArg" :
    {
     "pattern" :
...
public static MsItem SetMsHpf(MsId ms, ulong modelKey, ulong eqKey)
{
    //  vars.its.Length
...
                                                    new TsFormula()
                                                    {
                                                        kind = TsFormulaKind.HodrickPrescottFilter,
                                                        method = new TsMethod()
                                                        {   // Задаем параметры метода «Фильтр Ходрика-Прескотта»
                                                            hodrickPrescottFilter = new TsHodrickPrescottFilterMethod()
                                                            {
                                                                // Задаём метод обработки пропусков
                                                                missingData = new StatMissingData(){},
                                                                // Задаём параметры периода цикличности
                                                                smoothingParameter = 100,
                                                                smoothingParameterMode = HPSmoothingParameterModeType.EditDirectly,
                                                                power = null
                                                            }
                                                        }
                                                    }
