# Настройка параметров метода «Заполнение пропусков»
...
Ниже приведен пример использования операции [SetMs](../SetMs.htm) для изменения параметров уравнения.
 ...
 выполнения операции, настройки уравнения для метода «Заполнение
 пропусков» и шаблон получения измененных данных. В результате выполнения
...
[![](../../../minus.gif)](../../../#)<tMs xmlns="****">
  <id>IJPOPNPKEFNBFOAEHGALDHACAFNECPBECKCAONAHDFAAJCIH!M!S!CLBFKJOPKEFNBFOAEBGMCEJOOEPAEHFAEDKJLHOGDAEPJDEDE</id>  </tMs>
...
[![](../../../minus.gif)](../../../#)<its>
[![](../../../minus.gif)](../../../#)<Item>
  <k>5</k>  <type>Model</type>[![](../../../minus.gif)](../../../#)<model>
[![](../../../minus.gif)](../../../#)<transform>
[![](../../../minus.gif)](../../../#)<formulas>
[![](../../../minus.gif)](../../../#)<its>
[![](../../../minus.gif)](../../../#)<it>
  <k>0</k>  <kind>FillGaps</kind>[![](../../../minus.gif)](../../../#)<method>
[![](../../../minus.gif)](../../../#)<fillGaps>
[![](../../../minus.gif)](../../../#)<missingData>
  <method>NPointsAverage</method>  <methodParameter>6</methodParameter>  </missingData>
  </fillGaps>
  </method>
  </it>
  </its>
...
[![](../../../minus.gif)](../../../#)<id xmlns="****">
  <id>IJPOPNPKEFNBFOAEHGALDHACAFNECPBECKCAONAHDFAAJCIH!M!S!CLBFKJOPKEFNBFOAEBGMCEJOOEPAEHFAEDKJLHOGDAEPJDEDE</id>  </id>
...
  </Item>
[![](../../../minus.gif)](../../../#)<Item>
  <k>5</k>  <id>OBJ5</id>  <n>MyOutputVavable|A[t] = A0 + A1*MyInputVavable|A[t], (От родителя)-(От родителя)</n>  <vis>1</vis>  <type>Model</type>  <excluded>0</excluded>  <graphMeta />
[![](../../../minus.gif)](../../../#)<model>
[![](../../../minus.gif)](../../../#)<transform>
...
[![](../../../minus.gif)](../../../#)<missingData>
  <specifiedVector />
  <method>NPointsAverage</method>  <methodParameter>6</methodParameter>  <specifiedValue>0</specifiedValue>[![](../../../minus.gif)](../../../#)<specifiedTerm>
 ...
 "SetMs" :
  {
   "tMs" :
    {
     "id" : "IJPOPNPKEFNBFOAEHGALDHACAFNECPBECKCAONAHDFAAJCIH!M!S!CLBFKJOPKEFNBFOAEBGMCEJOOEPAEHFAEDKJLHOGDAEPJDEDE"
    },
   "tArg" :
    {
     "pattern" :
               ...
               "Item" :
                [
                  ...
                  },
                  {
                   "k" : "5",
                   "id" : "OBJ5",
                   "n" : "MyOutputVavable|A[t] = A0 + A1*MyInputVavable|A[t], (От родителя)-(От родителя)",
                   "vis" : "1",
                   "type" : "Model",
                   "excluded" : "0",
                   "graphMeta" : "",
...
public static MsItem SetMsFillGaps(MsId ms, ulong modelKey, ulong eqKey)
...
                                                    new TsFormula()
                                                    {
                                                        kind = TsFormulaKind.FillGaps,
                                                        method = new TsMethod()
                                                        {   // Задаём параметры расчёта метода
                                                            fillGaps = new TsFillGapsMethod()
                                                                {
                                                                    missingData = new StatMissingData()
                                                                    {
                                                                        method = StatMissingDataMethod.NPointsAverage,
                                                                        methodParameter = 6
                                                                    }
                                                                }
                                                        }
