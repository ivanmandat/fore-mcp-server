# Настройка параметров уравнения, использующего метод накопления
...
Ниже приведен пример использования операции [SetMs](../SetMs.htm) для изменения параметров уравнения.
 ...
 выполнения операции, настройки уравнения для метода накопления и шаблон
 получения измененных данных. В результате выполнения операция возвращает
 модель, содержащую измененное уравнение.
...
[![](../../../minus.gif)](../../../#)<tMs xmlns="****">
  <id>GGHGACACBFNBFOAEMFNMMKEDKGIBFLDEILHPAIPAIGDPILBL!M!S!CCMDOKCACBFNBFOAEGJCNODICOFHJCEFEEKDPKBHCEJMNMOLC</id>  </tMs>
...
[![](../../../minus.gif)](../../../#)<its>
[![](../../../minus.gif)](../../../#)<it>
  <k>0</k>  <kind>Cumulative</kind>[![](../../../minus.gif)](../../../#)<method>
[![](../../../minus.gif)](../../../#)<cumulative>
  <type>Min</type>  </cumulative>
  </method>
  </it>
  </its>
  </formulas>
...
[![](../../../minus.gif)](../../../#)<id xmlns="****">
  <id>GGHGACACBFNBFOAEMFNMMKEDKGIBFLDEILHPAIPAIGDPILBL!M!S!CCMDOKCACBFNBFOAEGJCNODICOFHJCEFEEKDPKBHCEJMNMOLC</id>  </id>
 ...
 "SetMs" :
  {
   "tMs" :
    {
     "id" : "GGHGACACBFNBFOAEMFNMMKEDKGIBFLDEILHPAIPAIGDPILBL!M!S!CCMDOKCACBFNBFOAEGJCNODICOFHJCEFEEKDPKBHCEJMNMOLC"
    },
   "tArg" :
    {
     "pattern" :
...
public static MsId SetMsCum(MsId ms, ulong modelKey, ulong eqKey)
...
                                                    new TsFormula()
                                                    {
                                                        kind = TsFormulaKind.Cumulative,
                                                        method = new TsMethod()
                                                        {   // Задаём параметры расчёта метода
                                                            cumulative = new TsCumulativeMethod()
                                                                {type = TsCumulativeMethodType.Min}
                                                        }
                                                    }
                                                }
                                            }
