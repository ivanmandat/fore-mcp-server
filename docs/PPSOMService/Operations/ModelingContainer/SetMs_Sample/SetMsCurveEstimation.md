# Настройка параметров метода «Подбор вида зависимости»
...
Ниже приведен пример использования операции [SetMs](../SetMs.htm) для изменения параметров уравнения.
 ...
 выполнения операции, настройки уравнения для метода «Подбор
 вида зависимости» и шаблон получения измененных данных. В результате
...
[![](../../../minus.gif)](../../../#)<tMs xmlns="****">
  <id>JCFNHBHLPMMBFOAECLAJEGIKCOPLJBPEEIEENGBLMELKEFFA!M!S!CLFIBDCHLPMMBFOAENPOKMAKFENHCGDBEFKBHDPIBKFHCEBLF</id>  </tMs>
...
  <criterion>R2</criterion>[![](../../../minus.gif)](../../../#)<dependenceFormIncluded>
...
  <missingData />
  <confidenceLevel>0.96</confidenceLevel>  <value>0</value>  </curveEstimation>
  </method>
  </it>
  </its>
  </formulas>
...
[![](../../../minus.gif)](../../../#)<id xmlns="****">
  <id>JCFNHBHLPMMBFOAECLAJEGIKCOPLJBPEEIEENGBLMELKEFFA!M!S!CLFIBDCHLPMMBFOAENPOKMAKFENHCGDBEFKBHDPIBKFHCEBLF</id>  </id>
...
  </missingData>
  <confidenceLevel>0.96</confidenceLevel>  <value>0</value>[![](../../../minus.gif)](../../../#)<explained>
[![](../../../minus.gif)](../../../#)<slice>
 ...
 "SetMs" :
  {
   "tMs" :
    {
     "id" : "JCFNHBHLPMMBFOAECLAJEGIKCOPLJBPEEIEENGBLMELKEFFA!M!S!CLFIBDCHLPMMBFOAENPOKMAKFENHCGDBEFKBHDPIBKFHCEBLF"
    },
   "tArg" :
    {
     "pattern" :
...
public static MsItem SetMsCurveEstimation(MsId ms, ulong modelKey, ulong eqKey)
{
...
                                                                confidenceLevel = 0.96,
                                                                // Задаем критерий оценки
                                                                criterion = StatDependenceCriterionType.R2,
...
                                                                    StatDependenceType.Logarithmic
                                                                },
...
[SetMs: Операция](../SetMs.htm)
 | [Расчёт метода «Подбор
 вида зависимости»](../GetMs_Sample/GetMsCurveEstimation.htm)
