...
Ниже приведен пример использования операции [GetMs](../GetMs.htm) для возобновления расчёта модели.
...
  <calcAction>Resume</calcAction>  <calculationState />
  </problemCalculation>
...
  <problemCalculationKey>3</problemCalculationKey>  <useScenarios>1</useScenarios>  <readOnly>0</readOnly>  </problemMd>
  </item>
  </meta>
  </GetMsResult>
  </soapenv:Body>
