...
Ниже приведен пример использования операции [GetMs](../GetMs.htm) для запуска расчёта модели. В
 запросе передаются: экземпляр открытого контейнера моделирования, шаблон
...
  <calcAction>Run</calcAction>  <calculationState />
  </problemCalculation>
...
  <isSuspend>0</isSuspend>  <saveZeros>1</saveZeros>  <overwriteSameValues>0</overwriteSameValues>  </calculation>
  <problemCalculationKey>1</problemCalculationKey>  <useScenarios>1</useScenarios>  <readOnly>0</readOnly>  </problemMd>
  </item>
  </meta>
  </GetMsResult>
  </soapenv:Body>
