# Удаление пользователя: Операция SetMbSec
...
Ниже приведён пример использования операции [SetMbSec](../SetMbSec.htm)
 для удаления пользователя репозитория. В запросе передаётся удаляемый
 пользователь. В ответе приходит обновленный список пользователей репозитория.
...
[![](../../../minus.gif)](../../../#)<pattern>
  <users>Remove</users>  </pattern>
[![](../../../minus.gif)](../../../#)<meta>
[![](../../../minus.gif)](../../../#)<users>
[![](../../../minus.gif)](../../../#)<its>
[![](../../../minus.gif)](../../../#)<it>
  <k>197730</k>  <id>NEWREPOADMIN</id>  <n>NewRepoAdmin</n>  <vis>true</vis>  <type>User</type>[![](../../../minus.gif)](../../../#)<sid>
  <sid>PS-1-197730</sid>  <type>User</type>  </sid>
[![](../../../minus.gif)](../../../#)<data>
  <isNT>false</isNT>  <isExternal>false</isExternal>  <isBuiltin>false</isBuiltin>[![](../../../minus.gif)](../../../#)<user>
  <mustChangePasswordAtNextLogon>true</mustChangePasswordAtNextLogon>  <cannotChangePassword>false</cannotChangePassword>  <lockedState>NotLocked</lockedState>  <manageDBGrants>true</manageDBGrants>  <maxLogonSessions>3</maxLogonSessions>  <lastLoginStamp>1899-12-30T00:00:00</lastLoginStamp>  <hasAccessToRepository>true</hasAccessToRepository>  <isAdmin>false</isAdmin>  <isIsa>false</isIsa>  <isRoled>false</isRoled>  <changePassStamp>2020-03-23T04:07:00</changePassStamp>  <autoRun />
  <temporaryAge>0</temporaryAge>  <eternalPass>false</eternalPass>  <certificate />
  </user>
  </data>
  </it>
  </its>
...
public static SetMbSecResult DeleteUser(string mb, MbSubject user)
{
    ...
    var setMbSec = new SetMbSec()
    {
        tArg = new SetMbSecArg()
        {
            ...
            //Метаданные, в которых указывается удаляемый пользователь
            meta = new MbSecMd()
            {
