# Получение информации о пользователях: Операция GetMbSec
...
Ниже приведен пример использования операции [GetMbSec](../GetMbSec.htm)
 для получения информации о пользователях, которые созданы в менеджере
 безопасности репозитория. В запросе передается моникёр соединения с репозиторием.
 В ответе приходит информация о пользователях.
...
[![](../../../minus.gif)](../../../#)<pattern>
  <users>Get</users>[![](../../../minus.gif)](../../../#)<user>
  <data>true</data>  <memberOf>Get</memberOf>  </user>
  </pattern>
  </tArg>
  </GetMbSec>
  </s:Body>
