...
Интерфейс IRdsPredefinedBinding
 содержит свойства привязки системных атрибутов табличных справочник НСИ.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [PredefinedType](IRdsPredefinedBinding.PredefinedType.htm)


		 Свойство PredefinedType
		 определяет системный атрибут справочника, которому соответствует
		 данная привязка.
