...
Lookup: [IRdsAttribute](IRdsAttribute.htm);


## Описание


Свойство Lookup определяет заимствованный
 атрибут справочника, с которым установлена связь [Link](IRdsAttribute.Link.htm).
