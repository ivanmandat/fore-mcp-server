# IRdsCompoundDictionary.Sources
...
Sources: [IRdsCompoundDictionarySources](../IRdsCompoundDictionarySources/IRdsCompoundDictionarySources.htm);
...
Свойство Sources возвращает
 коллекцию справочников, являющихся источниками данных для данного составного
 справочника НСИ.
