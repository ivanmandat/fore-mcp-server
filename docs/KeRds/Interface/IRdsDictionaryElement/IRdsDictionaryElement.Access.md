...
Access(Attribute: [RdsAccessAttribute](../../Enums/RdsAccessAttribute.htm)):
 Integer;
...
Attribute. Вид атрибута доступа,
 по которому необходимо узнать метку безопасности.


## Описание


Свойство Access возвращает метку
 безопасности, установленную по указанному атрибуту доступа для текущего
 элемента.
...
Метка безопасности возвращается в десятичном виде. Данное свойство используется,
 если доступ распределен для 32 или менее субъектов безопасности.
