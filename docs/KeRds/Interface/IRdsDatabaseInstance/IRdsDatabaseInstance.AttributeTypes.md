...
AttributeTypes: [IRdsAttributeTypeFolder](../IRdsAttributeTypeFolder/IRdsAttributeTypeFolder.htm);


## Описание


Свойство AttributeTypes возвращает
 содержимое корневой папки справочника типов атрибутов репозитория НСИ.
