...
AccessAccess: [IRdsAttribute](../IRdsAttribute/IRdsAttribute.htm);


## Описание


Свойство AccessAccess возвращает
...
Данный атрибут имеет строковый тип данных, не может содержать пустые
 ...
 атрибута - "ACCESSACCESS". Данный атрибут доступен, если свойству
 ...
 которых будет присутствовать право на изменение прав доступа к элементам
 справочника.
...
Для выполнения примера предполагается наличие репозитория НСИ - "NSI_1",
 ...
 включено управление правами доступа к элементам.
	...
	    j := Attrs.AccessAccess.Key; // ключ атрибута
