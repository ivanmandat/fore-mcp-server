# IMetaAttribute.CollectionAttributes
...
CollectionAttributes: [IMetaAttributes](../IMetaAttributes/IMetaAttributes.htm);
...
Свойство CollectionAttributes
 возвращает коллекцию атрибутов системной таблицы, хранящей значения множественного
 атрибута.
...
После выполнения примера в справочник, содержащий информацию о показателях
 ...
 с наименованием «Новый атрибут». Данный атрибут является ссылкой на справочник
 и поддерживает множественные значения. Также будет создана системная таблица
 для хранения множественных значений.
