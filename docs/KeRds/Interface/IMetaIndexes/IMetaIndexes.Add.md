...
Add: [IMetaIndex](../IMetaIndex/IMetaIndex.htm);
...
После выполнения примера в репозитории будет создана база данных временных
 рядов «OBJ_FC». Для измерения показателей будет создан уникальный индекс,
 состоящий из обязательных пользовательских атрибутов «COUNTRY» и «INDICATOR».


См. также:


[IMetaIndexes](IMetaIndexes.htm)
