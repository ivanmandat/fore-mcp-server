# IRdsDictionaryElementsLookup.LookupList
...
LookupList: [IRdsDictionaryElementList](../IRdsDictionaryElementList/IRdsDictionaryElementList.htm);


## Описание


Метод LookupList осуществляет
 поиск и возвращает массив, содержащий элементы, удовлетворяющие условиям
 поиска.
