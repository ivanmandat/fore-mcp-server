# IMetaDictionaryLookup.WhereRevisionBetween
...
First - минимальное искомое
 значение атрибута.


Last - максимальное искомое
 значение атрибут.
...
Метод WhereRevisionBetween осуществляет
 поиск между двумя значениями атрибута, указанного в свойстве [RevisionAttribute](IMetaDictionaryLookup.RevisionAttribute.htm)
...
Для выполнения примера предполагается наличие в репозитории базы данных
 ...
 атрибуты показателя с идентификаторами COUNTRY, UNIT и REV.
...
После выполнения примера в окно консоли будут выведены ключи показателей,
 ...
 равняется «512», а значение атрибутов «UNIT» и «REV» находится в диапазоне
 от «60» до «66».
