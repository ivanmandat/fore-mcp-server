# IMetaDictionaryLookup.WhereRevisionKey
...
Свойство WhereRevisionKey определяет
 искомое значение атрибута, указанного в свойстве [RevisionAttribute](IMetaDictionaryLookup.RevisionAttribute.htm)
 или [RevisionAttributes](IMetaDictionaryLookup.RevisionAttributes.htm)
 (учитывается только первое наименование атрибута в коллекции).
