...
Add(Name: String): [IRdsAttributeTypeFolder](../IRdsAttributeTypeFolder/IRdsAttributeTypeFolder.htm);
...
Метод Add осуществляет создание
 новой папки, наименование которой передается посредством параметар Name.
...
[IRdsAttributeTypeFolders](IRdsAttributeTypeFolders.htm)
