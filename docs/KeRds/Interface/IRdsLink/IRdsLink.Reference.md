...
Reference: [IRdsAttribute](../IRdsAttribute/IRdsAttribute.htm);


## Описание


Свойство Reference определяет
 атрибут справочника, с которым осуществляется связь. В качестве данного
 атрибута должен быть установлен атрибут [Key](../IRdsAttributes/IRdsAttributes.Key.htm)
 справочника, с которым осуществляется связь.
