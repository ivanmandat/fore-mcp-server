...
Item(Index: Integer): [IRdsAttributeInstance](../IRdsAttributeInstance/IRdsAttributeInstance.htm);
...
Свойство Item возвращает атрибут
 справочника, индекс которого передается посредством параметра Index.
...
После выполнения примера в консоль среды разработки будет выведен список
 ...
 указано наличие прав на чтение и запись для текущего пользователя.


См. также:


[IRdsAttributesInstance](IRdsAttributesInstance.htm)
