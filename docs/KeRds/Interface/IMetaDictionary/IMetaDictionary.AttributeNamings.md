# IMetaDictionary.AttributeNamings
...
AttributeNamings: [IMetaAttributeNamings](../IMetaAttributeNamings/IMetaAttributeNamings.htm);


## Описание


Свойство AttributeNamings возвращает
 коллекцию наименований атрибутов.


## Комментарии


Символ-разделитель наименований атрибутов определяет свойство [IMetaAttributeNamings.NamingDelimiter](../IMetaAttributeNamings/IMetaAttributeNamings.NamingDelimiter.htm).
