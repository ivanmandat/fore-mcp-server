...
CreateData: [IRdsDictionaryElementData](../IRdsDictionaryElementData/IRdsDictionaryElementData.htm);


## Описание


Метод CreateData создает объект,
 содержащий данные элемента справочника НСИ.
...
После выполнения примера будет создан объект, содержащий данные элемента.
 На базе этих данных будет создан новый элемент.
