...
Types: [IRdsAttributeTypes](../IRdsAttributeTypes/IRdsAttributeTypes.htm);


## Описание


Свойство Types возвращает коллекцию
 типов атрибутов, содержащихся в данной папке.
