# IMetaAttributesSet.CreateSubset
...
CreateSubset(Attributes: String; Operation: [SubsetOperation](../../Enums/SubsetOperation.htm)):
 [IMetaAttributesSubset](../IMetaAttributesSubset/IMetaAttributesSubset.htm);
...
Attributes - идентификаторы
 атрибутов, которые должны войти в набор. Идентификаторы перечисляются
 через знак «;».


Operation - операция построения
 набора атрибутов.
...
Метод CreateSubset создает набор
 атрибутов.
