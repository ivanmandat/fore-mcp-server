...
Интерфейс IRdsDictionaryBox
 содержит свойства и методы компонента среды разработки - [RdsDictionaryBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/RdsDictionaryBox.htm).


## Иерархия наследования


           [IComponent](ModForms.chm::/01_Interface/IComponent/IComponent.htm)


           [IControl](ModForms.chm::/01_Interface/IControl/IControl.htm)
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AdjustWidthOnlyVisible](IRdsDictionaryBox.AdjustWidthOnlyVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IRdsDictionaryBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CanElementDown](IRdsDictionaryBox.CanElementDown.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CanElementLevelUp](IRdsDictionaryBox.CanElementLevelUp.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CanElementUp](IRdsDictionaryBox.CanElementUp.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Columns](IRdsDictionaryBox.Columns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FindResultsMenu](IRdsDictionaryBox.FindResultsMenu.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FocusedElement](IRdsDictionaryBox.FocusedElement.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HighlightTrack](IRdsDictionaryBox.HighlightTrack.htm)


		 Свойство HighlightTrack
		 определяет, подсвечивать ли элемент при наведении указателя
		 мыши.


		 ![](../../Property_Image.gif)
		 [RootImageIndex](IRdsDictionaryBox.RootImageIndex.htm)


		 Свойство RootImageIndex
		 определяет индекс пиктограммы для корневого элемента компонента.


		 ![](../../Property_Image.gif)
		 [SelectionMode](IRdsDictionaryBox.SelectionMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHeaderButton](IRdsDictionaryBox.ShowHeaderButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHints](IRdsDictionaryBox.ShowHints.htm)


		 Свойство ShowHints
		 определяет, будут ли отображаться всплывающие подсказки при задержке
		 мыши над элементами компонента [RdsDictionaryBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/RdsDictionaryBox.htm).


		 ![](../../Property_Image.gif)
		 [Source](IRdsDictionaryBox.Source.htm)


		 Свойство Source определяет
		 источник данных для компонента [RdsDictionaryBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/RdsDictionaryBox.htm).


## Свойства, унаследованные от [IControl](ModForms.chm::/01_Interface/IControl/IControl.htm)
...
## Свойства, унаследованные от [IComponent](ModForms.chm::/01_Interface/IComponent/IComponent.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [AddElement](IRdsDictionaryBox.AddElement.htm)


		 Метод AddElement вызывает
		 стандартный диалог создания нового элемента справочника НСИ.


		 ![](../../Sub_Image.gif)
		 [CanCopy](IRdsDictionaryBox.CanCopy.htm)
		 Метод CanCopy
		 возвращает признак доступности копирования элемента в буфер обмена.


		 ![](../../Sub_Image.gif)
		 [ClearElements](IRdsDictionaryBox.ClearElements.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [CanPaste](IRdsDictionaryBox.CanPaste.htm)
		 Метод CanPaste возвращает
		 признак доступности вставки элемента из буфера обмена.


		 ![](../../Sub_Image.gif)
		 [Copy](IRdsDictionaryBox.Copy.htm)
		 Метод Copy копирует
		 выделенный элемент в буфер обмена.


		 ![](../../Sub_Image.gif)
		 [Cut](IRdsDictionaryBox.Cut.htm)


		 Метод Cut
		 перемещает выбранный элемент справочника в буфер обмена.


		 ![](../../Sub_Image.gif)
		 [EditElement](IRdsDictionaryBox.EditElement.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [FindElement](IRdsDictionaryBox.FindElement.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [MoveElementDown](IRdsDictionaryBox.MoveElementDown.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [MoveElementLevelUp](IRdsDictionaryBox.MoveElementLevelUp.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [MoveElementUp](IRdsDictionaryBox.MoveElementUp.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Paste](IRdsDictionaryBox.Paste.htm)
		 Метод Paste вставляет
		 элемент из буфера обмена.


		 ![](../../Sub_Image.gif)
		 [RefreshElements](IRdsDictionaryBox.RefreshElements.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [RemoveElement](IRdsDictionaryBox.RemoveElement.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [RenameElement](IRdsDictionaryBox.RenameElement.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ShowFindDialog](IRdsDictionaryBox.ShowFindDialog.htm)
...
## Методы, унаследованные от [IControl](ModForms.chm::/01_Interface/IControl/IControl.htm)
