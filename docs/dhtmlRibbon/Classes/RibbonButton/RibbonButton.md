...
[Button](dhtmlUi.chm::/Classes/button/button.htm)
...
PP.initClass(PP.Ui.RibbonButton, PP.Ui.[Button](dhtmlUi.chm::/Classes/button/button.htm),
 "RibbonButton");
...
Класс RibbonButton реализует
 компонент [RibbonButton](../../Components/RibbonButton/RibbonButton.htm),
 представляющий собой кнопку [ленты
 приложения](../../Components/Ribbon/Ribbon.htm).
