...
Класс RibbonCategory реализует
 компонент [RibbonCategory](../../Components/RibbonCategory/RibbonCategory.htm),
 представляющий собой вкладку [ленты
 инструментов](../../Components/Ribbon/Ribbon.htm).


## Синтаксис


PP.initClass(PP.Ui.RibbonCategory, PP.Ui.[TabItem](dhtmlUi.chm::/Classes/tabitem/tabitem.htm),
 "RibbonCategory");
