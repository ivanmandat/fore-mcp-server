...
Класс Ribbon реализует компонент
 [Ribbon](../../Components/Ribbon/Ribbon.htm), представляющий
 собой ленту инструментов, компонент, объединяющий в себе функциональность
 главного меню и [панели
 инструментов](dhtmlUi.chm::/Classes/toolbar/toolbar.htm).


## Синтаксис


PP.initClass(PP.Ui.Ribbon, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "Ribbon");
