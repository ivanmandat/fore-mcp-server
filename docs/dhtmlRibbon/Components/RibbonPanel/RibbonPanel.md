...
Компонент RibbonPanel представляет
 собой панель [вкладки](../../Classes/RibbonCategory/RibbonCategory.htm)
 [ленты приложения](../../Classes/Ribbon/Ribbon.htm).


Панель может быть добавлена на вкладку при помощи метода [RibbonCategory.addPanel](../../Classes/RibbonCategory/RibbonCategory.addPanel.htm)
 или из JSON в поле "Panels".


Заголовок панели устанавливается при помощи свойства [Caption](../../Classes/RibbonPanel/RibbonPanel.Caption.htm).
 На панель может быть добавлена кнопка
 запуска при помощи свойства [LaunchButton](../../Classes/RibbonPanel/RibbonPanel.LaunchButton.htm).


На вкладке располагаются элементы управления. Они могут быть добавлены
 при помощи метода [RibbonPanel.addControl](../../Classes/RibbonPanel/RibbonPanel.addControl.htm)
 или из JSON в поле "Elements".


## Комментарии


Компонент реализован классом [RibbonPanel](../../Classes/RibbonPanel/RibbonPanel.htm).
...
В данном примере на [вкладке](../RibbonCategory/RibbonCategory.htm)
 с заголовком «Main» расположена панель с заголовком «Insert». В правом
 нижнем углу находится [кнопка
 запуска](../../Classes/RibbonPanel/RibbonPanel.LaunchButton.htm). На панели расположены две кнопки.


[Пример добавления панели
 из JSON](../Ribbon/Example_Ribbon_JSON.htm)


[Пример добавления панели из API](../Ribbon/Example_Ribbon.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [RibbonPanel](dhtmlRibbon.chm::/classes/ribbonpanel/constructor_ribbonpanel.htm)
		 Конструктор RibbonPanel создает
		 экземпляр компонента RibbonPanel.
...
## Свойства
		 ...
		 ![](../../property_image.gif)
		 [Caption](dhtmlRibbon.chm::/classes/ribbonpanel/ribbonpanel.caption.htm)
		 Свойство Caption устанавливает
		 заголовок панели.


		 ![](../../property_image.gif)
		 [LaunchButton](dhtmlRibbon.chm::/classes/ribbonpanel/ribbonpanel.launchbutton.htm)
		 Свойство LaunchButton
		 устанавливает кнопку запуска для панели.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [addControl](dhtmlRibbon.chm::/classes/ribbonpanel/ribbonpanel.addcontrol.htm)
		 Метод addControl добавляет
		 элемент управления на панель.


		 ![](../../Sub_Image.gif)
		 [getControls](dhtmlRibbon.chm::/classes/ribbonpanel/ribbonpanel.getcontrols.htm)
		 Метод getControls возвращает
		 массив элементов управления, расположенных на панели.


		 ![](../../Sub_Image.gif)
		 [getLaunchButton](dhtmlRibbon.chm::/classes/ribbonpanel/ribbonpanel.getlaunchbutton.htm)
		 Метод getLaunchButton
		 возвращает кнопку запуска.
