...
Компонент RibbonButton представляет
 собой кнопку ленты приложения.


## Комментарии


Компонент реализован классом [RibbonButton](../../Classes/RibbonButton/RibbonButton.htm)


Особенность компонента RibbonButton
 заключается в том, что границы компонента становятся видимыми только при
 наведении курсора и при нажатии на кнопку.


## Пример компонента RibbonButton


Компоненты RibbonButton обычно
 входят в состав компонента [Ribbon](../Ribbon/Ribbon.htm):


![](RB_1.gif)


Данный пример - фрагмент ленты приложения. На вкладке «Home» расположено
 несколько компонентов RibbonButton.


[Пример создания компонента RibbonButton](RibbonButtonExample.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [RibbonButton](dhtmlRibbon.chm::/classes/ribbonbutton/consructor_ribbonbutton.htm)
		 Конструктор RibbonButton
		 создает экземпляр компонента RibbonButton.


## Свойства, унаследованные от класса [Button](dhtmlUi.chm::/Classes/Button/Button.htm)
...
Примечание.
 Для свойства [UseWrapping](dhtmlUi.chm::/Classes/Button/Button.UseWrapping.htm)
 по умолчанию установлено значение true.


## Методы, унаследованные от класса [Button](dhtmlUi.chm::/Classes/Button/Button.htm)
