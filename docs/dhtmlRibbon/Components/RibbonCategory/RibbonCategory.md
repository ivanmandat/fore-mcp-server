...
Компонент RibbonCategory представляет
 собой вкладку [ленты приложения](../Ribbon/Ribbon.htm).


Вкладку можно добавить на ленту приложения при помощи метода [Ribbon.addCategory](../../Classes/Ribbon/Ribbon.addCategory.htm).
 В JSON-объекте массив вкладок добавляется в поле "Categories".


Содержимое вкладки открывается при нажатии по заголовку. Текст заголовка
 вкладки устанавливается в свойстве [Caption](../../Classes/RibbonCategory/RibbonCategory.Caption.htm).


На вкладке располагаются панели. Добавить панели можно при помощи метода
 [addPanel](../../Classes/RibbonCategory/RibbonCategory.addPanel.htm)
 или в поле "Panels"
 из JSON.


Вкладки бывают обычные и контекстные. Контекстные вкладки отображаются
 по мере необходимости. Они объединяются в группы при помощи свойства [GroupName](../../Classes/RibbonCategory/RibbonCategory.GroupName.htm).


## Комментарии


Компонент реализован классом [RibbonCategory](../../Classes/RibbonCategory/RibbonCategory.htm).
...
В данном примере лента приложения включает в себя 3 вкладки: обычную
 вкладку с [заголовком](../../Classes/RibbonCategory/RibbonCategory.Caption.htm)
 «Главная» и две контекстных вкладки с заголовками «Текст» и «Стиль», объединенные
 в группу с [наименованием](../../Classes/RibbonCategory/RibbonCategory.GroupName.htm)
 «Ячейки:». На вкладке «Главная» расположена одна панель.


[Пример добавление вкладки
 на ленту приложения из JSON](../Ribbon/Example_Ribbon_JSON.htm)


[Пример добавления вкладки на
 ленту приложения из API](../Ribbon/Example_Ribbon.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [RibbonCategory](dhtmlRibbon.chm::/classes/ribboncategory/constructor_ribboncategory.htm)
		 Конструктор RibbonCategory
		 создает экземпляр компонента RibbonCategory.
