...
Класс GxImage реализует графическое
 изображение.
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateFromClipboard](GxImage.CreateFromClipboard.htm)
		 Конструктор CreateFromClipboard
		 создает изображение на основе содержимого буфера обмена.


		 ![](../../Sub_Image.gif)
		 [CreateFromFile](GxImage.CreateFromFile.htm)
		 Конструктор CreateFromFile
		 создает новое изображение на основе указанного файла.


		 ![](../../Sub_Image.gif)
		 [CreateFromStream](GxImage.CreateFromStream.htm)
		 Конструктор CreateFromStream
		 создает новое изображение на основе содержимого потока.
