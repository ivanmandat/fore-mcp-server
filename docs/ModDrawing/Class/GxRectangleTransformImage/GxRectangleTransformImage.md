...
Класс GxRectangleTransformImage
 реализует изображение, содержащее фиксированные области.
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateFromClipboard](GxRectangleTransformImage.CreateFromClipboard.htm)
		 Конструктор CreateFromClipboard
		 создает изображение с фиксированными областями на основе
		 содержимого буфера обмена.


		 ![](../../Sub_Image.gif)
		 [CreateFromFile](GxRectangleTransformImage.CreateFromFile.htm)
		 Конструктор CreateFromFile
		 создает новое изображение с фиксированными областями на основе
		 файла, указанного в параметре FileName.


		 ![](../../Sub_Image.gif)
		 [CreateFromStream](GxRectangleTransformImage.CreateFromStream.htm)
		 Конструктор CreateFromStream
		 создает новое изображение, содержащее фиксированные области, на
		 основе содержимого потока.
...
## Свойства объекта класса, унаследованные от [IGxRectangleTransformImage](../../Interface/IGxRectangleTransformImage/IGxRectangleTransformImage.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Margins](../../Interface/IGxRectangleTransformImage/IGxRectangleTransformImage.Margins.htm)
		 Свойство Margins определяет
		 параметры фиксированных отступов графического изображения.


## Свойства объекта класса, унаследованные от [IGxTransformImage](../../Interface/IGxTransformImage/IGxTransformImage.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Unit](../../Interface/IGxTransformImage/IGxTransformImage.Unit.htm)
