...
Класс GxMetafile реализует метафайл
 Windows.
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateFromClipboard](GxMetafile.CreateFromClipboard.htm)
		 Конструктор CreateFromClipboard
		 создает метафайл Windows на основе содержимого буфера обмена.


		 ![](../../Sub_Image.gif)
		 [CreateFromFile](GxMetafile.CreateFromFile.htm)
		 Конструктор CreateFromFile
		 создает новый метафайл Windows на основе файла, указанного в параметре
		 FileName.


		 ![](../../Sub_Image.gif)
		 [CreateFromStream](GxMetafile.CreateFromStream.htm)
		 Конструктор CreateFromStream
		 создает новый метафайл на основе указанного потока данных.
