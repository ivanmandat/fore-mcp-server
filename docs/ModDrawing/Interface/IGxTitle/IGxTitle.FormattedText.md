...
Свойство FormattedText определяет
 текст заголовка, предназначенный для представления в формате RTF.


## Комментарии


Информация о работе с RTF-редактором представлена в статье «[Использование
...
В результате выполнения примера в окно консоли выведется текст заголовка
 отчета на языке разметки HTML, в экспресс-отчете выведется
 новый текст заголовка в формате RTF.
