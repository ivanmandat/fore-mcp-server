...
ExpandS(Size: [IGxSizeF](IGxSizeF.htm));


## Параметры


Size. Размер, на который осуществляется увеличение.
...
Метод ExpandS осуществляет увеличение
 текущего вещественного размера на размер, передаваемый посредством входного
 параметра.
...
При выполнении примера будут созданы два вещественных размера. Первый
 ...
 и высоту. Затем первый размер будет увеличен на величину второго размера.
