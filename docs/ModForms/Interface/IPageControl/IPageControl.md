...
Интерфейс IPageControl содержит
 свойства и методы компонента среды разработки - [PageControl](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/PageControl.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveSheet](IPageControl.ActiveSheet.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Images](IPageControl.Images.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MultiLine](IPageControl.MultiLine.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RaggedRight](IPageControl.RaggedRight.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ScrollOpposite](IPageControl.ScrollOpposite.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TabPosition](IPageControl.TabPosition.htm)
