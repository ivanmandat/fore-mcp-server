...
Интерфейс IDateTimePicker содержит
 свойства и методы компонента среды разработки - [DateTimePicker](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/DateTimePicker.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Kind](IDateTimePicker.Kind.htm)
		 Свойство Kind определяет,
		 что должен отображать компонент: дату или время.


		 ![](../../Property_Image.gif)
		 [ShowCheckbox](IDateTimePicker.ShowCheckbox.htm)
		 Свойство ShowCheckBox
		 определяет, будет ли отображаться флажок в области компонента.


## Свойства, унаследованные от [ICommonCalendar](../ICommonCalendar/ICommonCalendar.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Reset](IDateTimePicker.Reset.htm)
