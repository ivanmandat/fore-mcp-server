...
Интерфейс IIntegerEdit содержит
 свойства и методы компонента среды разработки - [IntegerEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/IntegerEdit.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AllowEmpty](IIntegerEdit.AllowEmpty.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CorrectOnExit](IIntegerEdit.CorrectOnExit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxValue](IIntegerEdit.MaxValue.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MinValue](IIntegerEdit.MinValue.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ThousandSeparator](IIntegerEdit.ThousandSeparator.htm)
