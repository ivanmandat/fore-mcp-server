...
Интерфейс ISearchEdit содержит
 свойства и методы компонента среды разработки - [SearchEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/SearchEdit.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Timeout](ISearchEdit.Timeout.htm)
