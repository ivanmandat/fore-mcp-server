...
Интерфейс IRibbonSeparator содержит свойства элемента управления ленты - Разделитель.
...
Данный компонент используется для визуального разделения элементов управления, расположенных на одной панели и сгруппированных по функциональному назначению.


Пример использования разделителя приведен в описании метода [IRibbonPanels.Add](../IRibbonPanels/IRibbonPanels.Add.htm).
