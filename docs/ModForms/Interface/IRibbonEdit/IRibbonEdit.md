...
Интерфейс IRibbonEdit содержит
 свойства элемента управления ленты - Редактор текста.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ImageIndex](IRibbonEdit.ImageIndex.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [InnerWidth](IRibbonEdit.InnerWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SearchMode](IRibbonEdit.SearchMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SearchPrompt](IRibbonEdit.SearchPrompt.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TextAlign](IRibbonEdit.TextAlign.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TextValue](IRibbonEdit.TextValue.htm)
