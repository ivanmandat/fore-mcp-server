...
Интерфейс ITermEdit содержит
 свойства и методы компонентов среды разработки [TermEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TermEdit.htm)
 и [TermEditEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TermEditEx.htm),
 а также производных от них компонентов.
...
## Иерархия наследования
 ...
           [ICustomEdit](../ICustomEdit/ICustomEdit.htm)
...
Компоненты [TermEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TermEdit.htm)
 и [TermEditEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TermEditEx.htm)
 являются базовыми для следующих компонентов:


	- [CalcCubeFormulaEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/CalcCubeFormulaEdit.htm)
	 и [CalcCubeFormulaEditEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/CalcCubeFormulaEditEx.htm);


	- [ExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ExpressionEdit.htm)
	 и [ExpressionEditEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ExpressionEditEx.htm);


	- [MetaAttributesEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MetaAttributesEdit.htm).
...
## Свойства, унаследованные от [ICustomEdit](../ICustomEdit/ICustomEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoSelect](../ICustomEdit/ICustomEdit.AutoSelect.htm)
		 Свойство AutoSelect
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../ICustomEdit/ICustomEdit.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [CanUndo](../ICustomEdit/ICustomEdit.CanUndo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CharacterCasing](../ICustomEdit/ICustomEdit.CharacterCasing.htm)
		 Свойство CharacterCasing
		 определяет регистр вводимых символов компонента.


		 ![](../../Property_Image.gif)
		 [HideSelection](../ICustomEdit/ICustomEdit.HideSelection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxLength](../ICustomEdit/ICustomEdit.MaxLength.htm)
		 Свойство MaxLength
		 определяет максимальную длину вводимого текста.


		 ![](../../Property_Image.gif)
		 [Modified](../ICustomEdit/ICustomEdit.Modified.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ReadOnly](../ICustomEdit/ICustomEdit.ReadOnly.htm)
		 Свойство ReadOnly определяет,
		 может ли пользователь изменять текст компонента.


		 ![](../../Property_Image.gif)
		 [SelLength](../ICustomEdit/ICustomEdit.SelLength.htm)
		 Свойство SelLength
		 определяет количество символов, выделенных в тексте компонента.


		 ![](../../Property_Image.gif)
		 [SelStart](../ICustomEdit/ICustomEdit.SelStart.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelText](../ICustomEdit/ICustomEdit.SelText.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [BeginUpdate](ITermEdit.BeginUpdate.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [EndUpdate](ITermEdit.EndUpdate.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [PutCustom](ITermEdit.PutCustom.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [PutLiteral](ITermEdit.PutLiteral.htm)
...
## Методы, унаследованные от [ICustomEdit](../ICustomEdit/ICustomEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Clear](../ICustomEdit/ICustomEdit.Clear.htm)
		 Метод Clear удаляет
		 весь текст, содержащийся в компоненте.


		 ![](../../Sub_Image.gif)
		 [ClearSelection](../ICustomEdit/ICustomEdit.ClearSelection.htm)
		 Метод ClearSelection
		 удаляет весь текст, который был выделен в компоненте.


		 ![](../../Sub_Image.gif)
		 [ClearUndo](../ICustomEdit/ICustomEdit.ClearUndo.htm)
		 Метод ClearUndo используется
		 для фиксации изменений свойства [Text](../IControl/IControl.Text.htm).


		 ![](../../Sub_Image.gif)
		 [CopyToClipboard](../ICustomEdit/ICustomEdit.CopyToClipboard.htm)
		 Метод CopyToClipboard
		 осуществляет копирование выделенных данных в буфер обмена.


		 ![](../../Sub_Image.gif)
		 [CutToClipboard](../ICustomEdit/ICustomEdit.CutToClipboard.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [PasteFromClipboard](../ICustomEdit/ICustomEdit.PasteFromClipboard.htm)
		 Метод PasteFormClipboard
		 осуществляет вставку данных из буфера обмена.


		 ![](../../Sub_Image.gif)
		 [SelectAll](../ICustomEdit/ICustomEdit.SelectAll.htm)
		 Метод SelectAll осуществляет
		 выделение текста компонента.


		 ![](../../Sub_Image.gif)
		 [Undo](../ICustomEdit/ICustomEdit.Undo.htm)
