...
Интерфейс IRibbonPaletteButton
 содержит свойства элемента управления ленты - Кнопка для вызова комбинированного
 меню.
...
Комбинированное меню условно можно разделить на две группы:


	- Основные графические кнопки;
...
Основные графические кнопки
 используют изображения, загруженные из ресурсов, либо изображения компонента,
 установленного в свойстве [Images](IRibbonPaletteButton.Images.htm).
 При обращении к основным графическим кнопкам во время работы событие [OnChange](../IBaseRibbonElement/IBaseRibbonElement.OnChange.htm)
 будет генерироваться для родительского элемента управления. Для проверки,
 какая именно графическая кнопка была использована, предназначено свойство
 [SelectedItem](IRibbonPaletteButton.SelectedItem.htm).


Список дополнительных элементов управления
 формируется в коллекции [SubItems](../IRibbonButton/IRibbonButton.SubItems.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ButtonMode](IRibbonPaletteButton.ButtonMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ColumnCount](IRibbonPaletteButton.ColumnCount.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Groups](IRibbonPaletteButton.Groups.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IconWidth](IRibbonPaletteButton.IconWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Images](IRibbonPaletteButton.Images.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ResizeList](IRibbonPaletteButton.ResizeList.htm)
