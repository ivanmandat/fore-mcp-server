...
Интерфейс ITreeControl содержит
 базовые свойства и методы компонентов, отображающих ветвящиеся иерархические
 структуры.
...
Интерфейс является базовым для следующих компонентов среды разработки:


	- [TreeList](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TreeList.htm);


	- [TreeCombo](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TreeCombo.htm);


	- [MetabaseTreeCombo](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MetabaseTreeCombo.htm);


	- [MetabaseTreeList](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MetabaseTreeList.htm);


	- [MetaAttributesTreeList](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MetaAttributesTreeList.htm).


Данные компоненты реализуют ряд событий, список которых представлен
 в данном разделе.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AdjustWidthOnlyVisible](ITreeControl.AdjustWidthOnlyVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoCheckParent](ITreeControl.AutoCheckParent.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](ITreeControl.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Checkboxes](ITreeControl.Checkboxes.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ColumnClick](ITreeControl.ColumnClick.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Columns](ITreeControl.Columns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DropTargetNode](ITreeControl.DropTargetNode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [EnableFindDialog](ITreeControl.EnableFindDialog.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FindMode](ITreeControl.FindMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FocusedNode](ITreeControl.FocusedNode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [GridLines](ITreeControl.GridLines.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HeaderMenu](ITreeControl.HeaderMenu.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HideSelection](ITreeControl.HideSelection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HighlightTrack](ITreeControl.HighlightTrack.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HotTrack](ITreeControl.HotTrack.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HotTrackAutoExpand](ITreeControl.HotTrackAutoExpand.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Images](ITreeControl.Images.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [InnerRoot](ITreeControl.InnerRoot.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Locked](ITreeControl.Locked.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ReadOnly](ITreeControl.ReadOnly.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RowSelect](ITreeControl.RowSelect.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Selected](ITreeControl.Selected.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Selection](ITreeControl.Selection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelectionMode](ITreeControl.SelectionMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowButtons](ITreeControl.ShowButtons.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowColumnHeaders](ITreeControl.ShowColumnHeaders.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHeaderButton](ITreeControl.ShowHeaderButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHints](ITreeControl.ShowHints.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowLines](ITreeControl.ShowLines.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SortColumn](ITreeControl.SortColumn.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Sorted](ITreeControl.Sorted.htm)


		 Свойство Sorted определяет
		 возможность сортировки по столбцу, указанному в свойстве [SortColumn](ITreeControl.SortColumn.htm).


		 ![](../../Property_Image.gif)
		 [SortType](ITreeControl.SortType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [StateImages](ITreeControl.StateImages.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [HitTest](ITreeControl.HitTest.htm)
