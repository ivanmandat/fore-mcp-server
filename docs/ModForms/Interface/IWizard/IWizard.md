...
Интерфейс IWizard содержит свойства
 и методы компонента среды разработки - [Wizard](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Wizard.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActivePage](IWizard.ActivePage.htm)
