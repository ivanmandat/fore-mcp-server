...
Интерфейс IFrame содержит свойства
 и методы компонента среды разработки - [Frame](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Frame.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [MetabaseObject](IFrame.MetabaseObject.htm)
