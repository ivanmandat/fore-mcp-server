...
Интерфейс IPPButtonGroup содержит
 свойства и методы компонента среды разработки - [PPButtonGroup](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPButtonGroup.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AllowAllUp](IPPButtonGroup.AllowAllUp.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Count](IPPButtonGroup.Count.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Clear](IPPButtonGroup.Clear.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Insert](IPPButtonGroup.Insert.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Remove](IPPButtonGroup.Remove.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [RemoveByIndex](IPPButtonGroup.RemoveByIndex.htm)
