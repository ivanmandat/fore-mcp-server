...
Интерфейс IWebBrowserBox содержит
 свойства и методы компонента среды разработки - [WebBrowserBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/WebBrowserBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IWebBrowserBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [DocumentText](IWebBrowserBox.DocumentText.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [OleObject](IWebBrowserBox.OleObject.htm)
		 Свойство OleObject
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Navigate](IWebBrowserBox.Navigate.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Refresh](IWebBrowserBox.Refresh.htm)
