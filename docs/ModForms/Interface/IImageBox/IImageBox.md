...
Интерфейс IImageBox содержит
 свойства и методы компонента среды разработки - [ImageBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ImageBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AutoSize](IImageBox.AutoSize.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Transparent](IImageBox.Transparent.htm)
		 Свойство Transparent
		 определяет, будет ли фон изображения отображаться прозрачным.


		 ![](../../Property_Image.gif)
		 [TransparentColor](IImageBox.TransparentColor.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [LoadImageFromStream](IImageBox.LoadImageFromStream.htm)
