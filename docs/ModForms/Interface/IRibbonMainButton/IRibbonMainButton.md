...
Интерфейс IRibbonMainButton
 содержит свойства для работы с кнопкой приложения, расположенной на ленте.
...
Кнопка приложения - это большая
 кнопка, расположенная в верхнем левом углу ленты. При нажатии на данную
 кнопку выводится [главное
 меню](../IRibbon/IRibbon.MainCategory.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Buttons](IRibbonMainButton.Buttons.htm)
		 Свойство Buttons возвращает
		 коллекцию кнопок, которые будут доступны в главном меню.


		 ![](../../Property_Image.gif)
		 [ColorStyle](IRibbonMainButton.ColorStyle.htm)
		 Свойство ColorStyle
		 определяет стиль графического оформления кнопки приложения.


		 ![](../../Property_Image.gif)
		 [Image](IRibbonMainButton.Image.htm)
		 Свойство Image определяет
		 фоновое изображение, которое будет отображено в области кнопки
		 приложения.
