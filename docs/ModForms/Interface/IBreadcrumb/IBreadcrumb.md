...
Интерфейс IBreadcrumb содержит
 свойства и методы компонента среды разработки - [Breadcrumb](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Breadcrumb.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AutoScroll](IBreadcrumb.AutoScroll.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IBreadcrumb.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DeleteButton](IBreadcrumb.DeleteButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ScrollLeft](IBreadcrumb.ScrollLeft.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ScrollRight](IBreadcrumb.ScrollRight.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [StartDownButton](IBreadcrumb.StartDownButton.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [BeginUpdate](IBreadcrumb.BeginUpdate.htm)


		 Метод BeginUpdate останавливает
		 перерисовку связанных компонентов.


		 ![](../../Sub_Image.gif)
		 [EndUpdate](IBreadcrumb.EndUpdate.htm)


		 Метод EndUpdate возобновляет перерисовку
		 связанных компонентов.


		 ![](../../Sub_Image.gif)
		 [HitTest](IBreadcrumb.HitTest.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [LoadState](IBreadcrumb.LoadState.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [SaveState](IBreadcrumb.SaveState.htm)
