...
Интерфейс IPPSwitchButton содержит
 свойства и методы кнопки компонента [PPButtonGroup](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPButtonGroup.htm).
...
## Иерархия наследования
 ...
           [IPPButton](../IPPButton/IPPButton.htm)
