...
Интерфейс IListBox содержит
 свойства и методы компонента среды разработки - [ListBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/ListBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IListBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Columns](IListBox.Columns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IntegralHeight](IListBox.IntegralHeight.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TabWidth](IListBox.TabWidth.htm)
		 Свойство TabWidth определяет
		 ширину символа табуляции.


		 ![](../../Property_Image.gif)
		 [TopIndex](IListBox.TopIndex.htm)
