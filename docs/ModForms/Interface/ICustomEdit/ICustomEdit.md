...
Интерфейс ICustomEdit содержит
 базовые свойства и методы компонентов среды разработки, поддерживающих
 ввод и редактирование данных. Данные компоненты реализуют событие на изменение
 введенных данных.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AutoSelect](ICustomEdit.AutoSelect.htm)
		 Свойство AutoSelect
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](ICustomEdit.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [CanUndo](ICustomEdit.CanUndo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CharacterCasing](ICustomEdit.CharacterCasing.htm)
		 Свойство CharacterCasing
		 определяет регистр вводимых символов компонента.


		 ![](../../Property_Image.gif)
		 [HideSelection](ICustomEdit.HideSelection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxLength](ICustomEdit.MaxLength.htm)
		 Свойство MaxLength
		 определяет максимальную длину вводимого текста.


		 ![](../../Property_Image.gif)
		 [Modified](ICustomEdit.Modified.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelText](ICustomEdit.SelText.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ICustomEdit.OnChange.htm)
		 Событие OnChange наступает
		 после изменений свойства [Text](../IControl/IControl.Text.htm)
