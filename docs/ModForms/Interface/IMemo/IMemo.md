...
Интерфейс IMemo содержит свойства
 и методы компонента среды разработки - [Memo](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Memo.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ScrollBars](IMemo.ScrollBars.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WantReturns](IMemo.WantReturns.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [GetCharPos](IMemo.GetCharPos.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetLinePos](IMemo.GetLinePos.htm)
