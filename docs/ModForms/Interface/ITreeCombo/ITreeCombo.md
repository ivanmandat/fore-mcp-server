...
Интерфейс ITreeCombo содержит
 свойства и методы компонента среды разработки - [TreeCombo](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TreeCombo.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AnimationType](ITreeCombo.AnimationType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoUpdateInfo](ITreeCombo.AutoUpdateInfo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CancelOnEscape](ITreeCombo.CancelOnEscape.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CloseOnClick](ITreeCombo.CloseOnClick.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CloseOnEnter](ITreeCombo.CloseOnEnter.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CustomMultiselectText](ITreeCombo.CustomMultiselectText.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CustomMultiselectTextTemplate](ITreeCombo.CustomMultiselectTextTemplate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FilterStyle](ITreeCombo.FilterStyle.htm)
		 Свойство FilterStyle
		 определяет режим построения дерева отфильтрованных элементов.


		 ![](../../Property_Image.gif)
		 [FindEditVisible](ITreeCombo.FindEditVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowEditImage](ITreeCombo.ShowEditImage.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowSystemHints](ITreeCombo.ShowSystemHints.htm)
...
## Свойства, унаследованные от [ITreeControl](../ITreeControl/ITreeControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AdjustWidthOnlyVisible](../ITreeControl/ITreeControl.AdjustWidthOnlyVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoCheckParent](../ITreeControl/ITreeControl.AutoCheckParent.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../ITreeControl/ITreeControl.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Checkboxes](../ITreeControl/ITreeControl.Checkboxes.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ColumnClick](../ITreeControl/ITreeControl.ColumnClick.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Columns](../ITreeControl/ITreeControl.Columns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DropTargetNode](../ITreeControl/ITreeControl.DropTargetNode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [EnableFindDialog](../ITreeControl/ITreeControl.EnableFindDialog.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FindMode](../ITreeControl/ITreeControl.FindMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FocusedNode](../ITreeControl/ITreeControl.FocusedNode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [GridLines](../ITreeControl/ITreeControl.GridLines.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HeaderMenu](../ITreeControl/ITreeControl.HeaderMenu.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HideSelection](../ITreeControl/ITreeControl.HideSelection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HighlightTrack](../ITreeControl/ITreeControl.HighlightTrack.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HotTrack](../ITreeControl/ITreeControl.HotTrack.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HotTrackAutoExpand](../ITreeControl/ITreeControl.HotTrackAutoExpand.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Images](../ITreeControl/ITreeControl.Images.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [InnerRoot](../ITreeControl/ITreeControl.InnerRoot.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Locked](../ITreeControl/ITreeControl.Locked.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Nodes](../ITreeControl/ITreeControl.Nodes.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ReadOnly](../ITreeControl/ITreeControl.ReadOnly.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RowSelect](../ITreeControl/ITreeControl.RowSelect.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Selected](../ITreeControl/ITreeControl.Selected.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Selection](../ITreeControl/ITreeControl.Selection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelectionMode](../ITreeControl/ITreeControl.SelectionMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowButtons](../ITreeControl/ITreeControl.ShowButtons.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowColumnHeaders](../ITreeControl/ITreeControl.ShowColumnHeaders.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHeaderButton](../ITreeControl/ITreeControl.ShowHeaderButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHints](../ITreeControl/ITreeControl.ShowHints.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowLines](../ITreeControl/ITreeControl.ShowLines.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SortColumn](../ITreeControl/ITreeControl.SortColumn.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Sorted](../ITreeControl/ITreeControl.Sorted.htm)


		 Свойство Sorted определяет
		 возможность сортировки по столбцу, указанному в свойстве [SortColumn](../ITreeControl/ITreeControl.SortColumn.htm).


		 ![](../../Property_Image.gif)
		 [SortType](../ITreeControl/ITreeControl.SortType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [StateImages](../ITreeControl/ITreeControl.StateImages.htm)
...
## Свойства, унаследованные от [IControl](../IControl/IControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Align](../IControl/IControl.Align.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AllowDrag](../IControl/IControl.AllowDrag.htm)
		 Свойство AllowDrag
		 определяет возможность взять у компонента перетаскиваемый объект.


		 ![](../../Property_Image.gif)
		 [AllowDrop](../IControl/IControl.AllowDrop.htm)
		 Свойство AllowDrop
		 ...
		 ![](../../Property_Image.gif)
		 [Anchors](../IControl/IControl.Anchors.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Brush](../IControl/IControl.Brush.htm)
		 Свойство Brush определяет
		 кисть, используемую для заливки области компонента.


		 ![](../../Property_Image.gif)
		 [ClientHeight](../IControl/IControl.ClientHeight.htm)
		 Свойство ClientHeight
		 определяет высоту клиентской области компонента.


		 ![](../../Property_Image.gif)
		 [ClientWidth](../IControl/IControl.ClientWidth.htm)
		 Свойство ClientWidth
		 определяет ширину клиентской области компонента.


		 ![](../../Property_Image.gif)
		 [Color](../IControl/IControl.Color.htm)
		 Свойство Color определяет
		 цвет фона компонента.


		 ![](../../Property_Image.gif)
		 [Cursor](../IControl/IControl.Cursor.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Enabled](../IControl/IControl.Enabled.htm)
		 Свойство Enabled определяет
		 доступность компонента для пользователя.


		 ![](../../Property_Image.gif)
		 [Focused](../IControl/IControl.Focused.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Hint](../IControl/IControl.Hint.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HintTimeout](../IControl/IControl.HintTimeout.htm)
		 Свойство HintTimeout
		 определяет время отображения всплывающей подсказки.


		 ![](../../Property_Image.gif)
		 [Left](../IControl/IControl.Left.htm)
		 Свойство Left определяет
		 координату левого края компонента в пикселях.


		 ![](../../Property_Image.gif)
		 [Parent](../IControl/IControl.Parent.htm)
		 Свойство Parent определяет
		 родительский компонент.


		 ![](../../Property_Image.gif)
		 [ParentColor](../IControl/IControl.ParentColor.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ParentFont](../IControl/IControl.ParentFont.htm)
		 Свойство ParentFont
		 ...
		 ![](../../Property_Image.gif)
		 [ParentShowHint](../IControl/IControl.ParentShowHint.htm)
		 Свойство ParentShowHint
		 определяет условие отображения всплывающей подсказки.


		 ![](../../Property_Image.gif)
		 [PopupMenu](../IControl/IControl.PopupMenu.htm)
		 Свойство PopupMenu
		 ...
		 ![](../../Property_Image.gif)
		 [Scrolls](../IControl/IControl.Scrolls.htm)
		 Свойство Scrolls возвращает
		 параметры полос прокрутки компонента.


		 ![](../../Property_Image.gif)
		 [ShowHint](../IControl/IControl.ShowHint.htm)
...
## Методы, унаследованные от [ITreeControl](../ITreeControl/ITreeControl.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [AdjustWidth](../ITreeControl/ITreeControl.AdjustWidth.htm)
		 Метод AdjustWidth осуществляет
		 автоматический подгон ширины колонки с учетом её содержимого.


		 ![](../../Sub_Image.gif)
		 [GetItemAt](../ITreeControl/ITreeControl.GetItemAt.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [HitTest](../ITreeControl/ITreeControl.HitTest.htm)
...
## Методы, унаследованные от [IControl](../IControl/IControl.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ClientToScreen](../IControl/IControl.ClientToScreen.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [SetFocus](../IControl/IControl.SetFocus.htm)
