...
При установке свойству значения True производится отмена установленной отметки и сворачивание списка, при установке False - установленная отметка не отменяется.
