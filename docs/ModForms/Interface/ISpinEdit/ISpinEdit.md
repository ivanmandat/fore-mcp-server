...
Интерфейс ISpinEdit содержит
 свойства и методы компонента среды разработки - [SpinEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/SpinEdit.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [EditorReadOnly](ISpinEdit.EditorReadOnly.htm)
