...
Интерфейс IWizardSplash содержит
 свойства и методы компонента среды разработки - [WizardSplash](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/WizardSplash.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Background](IWizardSplash.Background.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Wizard](IWizardSplash.Wizard.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Refresh](IWizardSplash.Refresh.htm)
