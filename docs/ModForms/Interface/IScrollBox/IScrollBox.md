...
Интерфейс IScrollBox содержит
 свойства и методы компонента среды разработки [ScrollBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ScrollBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IScrollBox.BorderStyle.htm)


		 Свойство BorderStyle
		 определяет стиль границы компонента [ScrollBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ScrollBox.htm).


		 ![](../../Property_Image.gif)
		 [HScrollPos](IScrollBox.HScrollPos.htm)


		 Свойство HScrollPos
		 возвращает значение, представляющее текущее положение ползунка
		 горизонтальной полосы прокрутки.


		 ![](../../Property_Image.gif)
		 [VScrollPos](IScrollBox.VScrollPos.htm)
