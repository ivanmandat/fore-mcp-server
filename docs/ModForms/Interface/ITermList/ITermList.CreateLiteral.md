...
CreateLiteral(Text: String): [ITerm](../ITerm/ITerm.htm);
...
Литеральный терм отличается от пользовательского терма возможностью
 редактирования, т.е. есть возможность редактировать текст внутри литерального
 терма, и нельзя выделить фрагмент текста внутри пользовательского терма.
