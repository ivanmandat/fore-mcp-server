...
Интерфейс ILabel содержит свойства
 и методы компонента среды разработки - [Label](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Label.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](ILabel.Alignment.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Transparent](ILabel.Transparent.htm)
