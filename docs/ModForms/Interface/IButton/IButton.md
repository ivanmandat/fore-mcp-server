...
Интерфейс IButton содержит свойства и методы компонента среды разработки - [Button](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Button.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CancelButton](IButton.CancelButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DefaultButton](IButton.DefaultButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ModalResult](IButton.ModalResult.htm)
