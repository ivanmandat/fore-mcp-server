...
Интерфейс IMaskEdit содержит
 свойства и методы компонента среды разработки - [MaskEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MaskEdit.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [InputTemplate](IMaskEdit.InputTemplate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaskEnabled](IMaskEdit.MaskEnabled.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [PlaceholderChar](IMaskEdit.PlaceholderChar.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ValidChars](IMaskEdit.ValidChars.htm)
