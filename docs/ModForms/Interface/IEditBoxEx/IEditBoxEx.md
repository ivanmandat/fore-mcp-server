...
Интерфейс IEditBoxEx содержит
 свойства и методы компонентов, являющихся модернизированными редакторами,
 предназначенными для ввода определенных значений. К данным компонентам
 относятся: [SpinEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/SpinEdit.htm),
 [IntegerEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/IntegerEdit.htm),
 [FloatEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/FloatEdit.htm).
