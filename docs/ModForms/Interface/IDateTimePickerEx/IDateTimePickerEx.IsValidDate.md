...
Value - значение даты и времени, которое необходимо проверить на возможность установки в качестве значения для компонента [DateTimePickerEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/DateTimePickerEx.htm).
