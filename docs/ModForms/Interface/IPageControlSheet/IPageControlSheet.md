...
Интерфейс IPageControlSheet
 содержит свойства и методы страницы компонента [PageControl](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/PageControl.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ImageIndex](IPageControlSheet.ImageIndex.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [PageControl](IPageControlSheet.PageControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SheetIndex](IPageControlSheet.SheetIndex.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TabVisible](IPageControlSheet.TabVisible.htm)
