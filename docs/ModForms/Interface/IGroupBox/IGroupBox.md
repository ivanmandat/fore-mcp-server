...
Интерфейс IGroupBox содержит
 свойства и методы компонента среды разработки - [GroupBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/GroupBox.htm).
