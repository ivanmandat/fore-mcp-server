...
Интерфейс IRibbonProgressBar
 содержит свойства элемента управления ленты - Индикатор процесса.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [InnerWidth](IRibbonProgressBar.InnerWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Maximum](IRibbonProgressBar.Maximum.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Minimum](IRibbonProgressBar.Minimum.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Mode](IRibbonProgressBar.Mode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Value](IRibbonProgressBar.Value.htm)
