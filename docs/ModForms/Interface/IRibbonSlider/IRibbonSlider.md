...
Интерфейс IRibbonSlider содержит
 свойства элемента управления ленты - Ползунок.
...
Данный элемент управления предназначен для визуального редактирования
 значений, путем перемещения бегунка.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [InnerWidth](IRibbonSlider.InnerWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Maximum](IRibbonSlider.Maximum.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Minimum](IRibbonSlider.Minimum.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Orientation](IRibbonSlider.Orientation.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [VisibleButtons](IRibbonSlider.VisibleButtons.htm)
