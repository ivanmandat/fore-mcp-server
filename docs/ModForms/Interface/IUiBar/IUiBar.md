...
Интерфейс IUiBar содержит базовые
 свойства и методы встраиваемых компонентов.
...
Встраиваемые компоненты могут располагаться как в области формы, так
 и в виде отдельного окна.


Интерфейс является базовым для следующих интерфейсов:


	- [IReportFormulaBar](KeReport.chm::/Interface/IReportFormulaBar/IReportFormulaBar.htm);


	- [IToolbar](../IToolbar/IToolbar.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AllowUndock](IUiBar.AllowUndock.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ExclusiveRow](IUiBar.ExclusiveRow.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Dock](IUiBar.Dock.htm)
		 Метод Dock осуществляет
		 привязку компонента к форме.


		 ![](../../Sub_Image.gif)
		 [DockLeftOf](IUiBar.DockLeftOf.htm)
