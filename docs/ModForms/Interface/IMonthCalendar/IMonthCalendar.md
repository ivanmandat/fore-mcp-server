...
Интерфейс IMonthCalendar содержит свойства и методы компонента среды разработки - [MonthCalendar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MonthCalendar.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BeginDate](IMonthCalendar.BeginDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IMonthCalendar.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [EndDate](IMonthCalendar.EndDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FirstDayOfWeek](IMonthCalendar.FirstDayOfWeek.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IsValidDate](IMonthCalendar.IsValidDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MultiSelect](IMonthCalendar.MultiSelect.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowToday](IMonthCalendar.ShowToday.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowTodayCircle](IMonthCalendar.ShowTodayCircle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WeekNumbers](IMonthCalendar.WeekNumbers.htm)
