...
Интерфейс IBannerBar содержит
 свойства и методы компонента среды разработки - [BannerBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/BannerBar.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DockPosition](IBannerBar.DockPosition.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MetabaseObject](IBannerBar.MetabaseObject.htm)
