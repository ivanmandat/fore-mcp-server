...
Интерфейс ICheckBox содержит свойства и методы компонента среды разработки - [CheckBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/CheckBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](ICheckBox.Alignment.htm)
