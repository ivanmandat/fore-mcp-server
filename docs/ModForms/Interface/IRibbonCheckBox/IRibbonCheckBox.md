...
Интерфейс IRibbonCheckBox содержит
 свойства элемента управления ленты - Флажок.
...
Флажок обычно используется для включения/отключения каких-либо опций
 в приложении.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Checked](IRibbonCheckBox.Checked.htm)
