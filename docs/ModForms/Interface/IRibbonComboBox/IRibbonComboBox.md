...
Интерфейс IRibbonComboBox содержит
 свойства элемента управления ленты - Комбинированный список.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AutoComplete](IRibbonComboBox.AutoComplete.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DropDownCount](IRibbonComboBox.DropDownCount.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SearchMode](IRibbonComboBox.SearchMode.htm)
		 Свойство SearchMode
