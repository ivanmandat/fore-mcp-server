...
Интерфейс IOleDocumentBox содержит
 свойства и методы компонента среды разработки - [OleDocumentBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/OleDocumentBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IOleDocumentBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [EnableDocumentEvents](IOleDocumentBox.EnableDocumentEvents.htm)
		 Свойство EnableDocumentEvents
		 определяет, будет ли генерироваться событие [OnOleDocumentEvent](../../Class/OleDocumentBox/OleDocumentBox.OnOleDocumentEvent.htm).


		 ![](../../Property_Image.gif)
		 [OleObject](IOleDocumentBox.OleObject.htm)
		 Свойство OleObject
		 ...
		 ![](../../Property_Image.gif)
		 [UserMode](IOleDocumentBox.UserMode.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateFromFile](IOleDocumentBox.CreateFromFile.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateObject](IOleDocumentBox.CreateObject.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [DestroyObject](IOleDocumentBox.DestroyObject.htm)
