...
Интерфейс INavigationBar содержит
 свойства и методы компонента среды разработки - [NavigationBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/NavigationBar.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActivePad](INavigationBar.ActivePad.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Border](INavigationBar.Border.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [BeginUpdate](INavigationBar.BeginUpdate.htm)
		 Метод BeginUpdate отключает
		 перерисовку содержимого компонента.


		 ![](../../Sub_Image.gif)
		 [EndUpdate](INavigationBar.EndUpdate.htm)
