...
Интерфейс IProgressBar содержит
 свойства и методы компонента среды разработки - [ProgressBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ProgressBar.htm).
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [StepBy](IProgressBar.StepBy.htm)
