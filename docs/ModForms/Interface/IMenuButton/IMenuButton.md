...
Интерфейс IMenuButton содержит
 свойства и методы компонента среды разработки - [MenuButton](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MenuButton.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [RightArrow](IMenuButton.RightArrow.htm)
		 Свойство RightArrow
		 ...
		 ![](../../Property_Image.gif)
		 [StayPressed](IMenuButton.StayPressed.htm)
