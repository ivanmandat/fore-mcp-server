...
Интерфейс IHyperlink содержит
 свойства и методы компонента среды разработки - [Hyperlink](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Hyperlink.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AlwaysUnderlined](IHyperlink.AlwaysUnderlined.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HoverColor](IHyperlink.HoverColor.htm)
...
## Свойства, унаследованные от [ILabel](../ILabel/ILabel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](../ILabel/ILabel.Alignment.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoSize](../ILabel/ILabel.AutoSize.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Layout](../ILabel/ILabel.Layout.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Transparent](../ILabel/ILabel.Transparent.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WordWrap](../ILabel/ILabel.WordWrap.htm)
