...
Интерфейс IStatusBar содержит
 свойства и методы компонента среды разработки - [StatusBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/StatusBar.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [SimplePane](IStatusBar.SimplePane.htm)
		 Свойство SimplePane
		 определяет возможность создания нескольких панелей.


		 ![](../../Property_Image.gif)
		 [SizeGrip](IStatusBar.SizeGrip.htm)
