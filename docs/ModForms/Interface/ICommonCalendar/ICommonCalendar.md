...
Интерфейс ICommonCalendar содержит
 базовые свойства и методы календарей.
...
## Событие
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ICommonCalendar.OnChange.htm)
