...
Интерфейс IEditBox содержит
 свойства и методы компонента среды разработки - [EditBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/EditBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [PasswordChar](IEditBox.PasswordChar.htm)
