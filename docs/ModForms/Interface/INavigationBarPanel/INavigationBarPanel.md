...
Интерфейс INavigationBarPanel
 содержит свойства и методы для работы с панелью, которая связана с вкладкой
...
Параметры панели могут быть получены в свойстве [INavigationBarPad.Content](../INavigationBarPad/INavigationBarPad.Content.htm).
 Панель является фреймом для формы с элементами управления.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Constraints](INavigationBarPanel.Constraints.htm)


		 Свойство Constraints
		 определяет минимальный размер содержимого вкладки.


		 ![](../../Property_Image.gif)
		 [MetabaseObject](INavigationBarPanel.MetabaseObject.htm)


		 Свойство MetabaseObject
		 определяет идентификатор формы, содержимое которое будет отображено
		 в области панели.
