...
Интерфейс IRibbon содержит свойства
 и методы компонента среды разработки [Ribbon](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Ribbon.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveCategory](IRibbon.ActiveCategory.htm)
		 Свойство ActiveCategory
		 определяет активную вкладку ленты.


		 ![](../../Property_Image.gif)
		 [Categories](IRibbon.Categories.htm)
		 Свойство Categories
		 возвращает коллекцию вкладок, доступных на ленте.


		 ![](../../Property_Image.gif)
		 [Contexts](IRibbon.Contexts.htm)
		 Свойство Contexts возвращает
		 коллекцию контекстных вкладок.


		 ![](../../Property_Image.gif)
		 [CustomDefaultMenuItem](IRibbon.CustomDefaultMenuItem.htm)


		 Свойство CustomDefaultMenuItem
		 возвращает наименование новой команды контекстного меню ленты
		 инструментов.


		 ![](../../Property_Image.gif)
		 [Elements](IRibbon.Elements.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Hidden](IRibbon.Hidden.htm)
		 Свойство Hidden определяет
		 признак скрытости ленты.


		 ![](../../Property_Image.gif)
		 [Images](IRibbon.Images.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MainButton](IRibbon.MainButton.htm)
		 Свойство MainButton
		 возвращает параметры кнопки приложения, используемой для вызова
		 главного меню.


		 ![](../../Property_Image.gif)
		 [MainCategory](IRibbon.MainCategory.htm)
		 Свойство MainCategory
		 возвращает параметры главного меню ленты.


		 ![](../../Property_Image.gif)
		 [QuickAccessToolbar](IRibbon.QuickAccessToolbar.htm)
		 Свойство QuickAccessToolbar
		 возвращает параметры панели быстрого доступа.


		 ![](../../Property_Image.gif)
		 [Resources](IRibbon.Resources.htm)
		 Свойство Resources
		 ...
		 ![](../../Property_Image.gif)
		 [TabElements](IRibbon.TabElements.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [SaveToXML](IRibbon.SaveToXML.htm)
