...
Point: [IPoint](../IPoint/IPoint.htm);


## Описание


Свойство Point возвращает точку
 в области компонента [Control](IPopupMenuEventArgs.Control.htm),
 в которой было вызвано контекстное меню.
