...
Интерфейс IRibbonRadioButton
 содержит свойства элемента управления ленты - Переключатель.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Checked](IRibbonRadioButton.Checked.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [GroupIndex](IRibbonRadioButton.GroupIndex.htm)
