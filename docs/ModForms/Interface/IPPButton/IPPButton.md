...
Интерфейс IPPButton содержит
 свойства и методы компонента среды разработки - [PPButton](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPButton.htm).
