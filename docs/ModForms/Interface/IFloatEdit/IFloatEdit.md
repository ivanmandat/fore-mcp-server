...
Интерфейс IFloatEdit содержит
 свойства и методы компонента среды разработки - [FloatEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/FloatEdit.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AllowEmpty](IFloatEdit.AllowEmpty.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CorrectOnExit](IFloatEdit.CorrectOnExit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxValue](IFloatEdit.MaxValue.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MinValue](IFloatEdit.MinValue.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Precision](IFloatEdit.Precision.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [StepSize](IFloatEdit.StepSize.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ThousandSeparator](IFloatEdit.ThousandSeparator.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TrailingZeros](IFloatEdit.TrailingZeros.htm)
