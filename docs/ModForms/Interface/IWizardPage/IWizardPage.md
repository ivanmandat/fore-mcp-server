...
Интерфейс IWizardPage содержит
 свойства и методы страницы компонента [Wizard](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Wizard.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Description](IWizardPage.Description.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [PageIndex](IWizardPage.PageIndex.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowDescription](IWizardPage.ShowDescription.htm)


		 Свойство ShowDescription
		 определяет видимость заголовка и [описания](IWizardPage.Description.htm)
		 страницы мастера.
