...
Интерфейс IPanel содержит свойства
 и методы компонента среды разработки - [Panel](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Panel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](IPanel.Alignment.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BevelInner](IPanel.BevelInner.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BevelOuter](IPanel.BevelOuter.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BevelWidth](IPanel.BevelWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IPanel.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderWidth](IPanel.BorderWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FullRepaint](IPanel.FullRepaint.htm)
