...
Класс SpinEdit реализует компонент
 среды разработки [SpinEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/SpinEdit.htm),
 представляющий собой комбинацию однострочного поля редактирования и кнопок
 SpinUp и SpinDown.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnSpinDown](SpinEdit.OnSpinDown.htm)
		 Событие OnSpinDown
		 ...
		 ![](../../Event_Image.gif)
		 [OnSpinUp](SpinEdit.OnSpinUp.htm)
