...
Класс PPRadioButton реализует компонент среды разработки - [PPRadioButton](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPRadioButton.htm).
...
## События, унаследованные от [RadioButton](../RadioButton/RadioButton.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](../RadioButton/RadioButton.OnChange.htm)
