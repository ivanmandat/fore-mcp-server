...
Класс Frame реализует компонент
 среды разработки [Frame](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Frame.htm),
 предоставляющий возможность отображения части дополнительной формы на
 текущей форме.


## Свойства, унаследованные от [IFrame](../../Interface/IFrame/IFrame.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Form](../../Interface/IFrame/IFrame.Form.htm)


		 Свойство Form возвращает
		 параметры формы, загруженной в компонент.


		 ![](../../Property_Image.gif)
		 [MetabaseObject](../../Interface/IFrame/IFrame.MetabaseObject.htm)


		 Свойство MetabaseObject
		 определяет идентификатор объекта репозитория, который будет подгружен
		 на место, обозначенное фреймом, во время выполнения данной формы.
