...
Класс PPButtonGroup реализует
 компонент среды разработки - [PPButtonGroup](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPButtonGroup.htm).


## Свойства объекта класса, унаследованные от [IPPButtonGroup](../../Interface/IPPButtonGroup/IPPButtonGroup.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AllowAllUp](../../Interface/IPPButtonGroup/IPPButtonGroup.AllowAllUp.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Count](../../Interface/IPPButtonGroup/IPPButtonGroup.Count.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Item](../../Interface/IPPButtonGroup/IPPButtonGroup.Item.htm)
...
## Методы объекта класса, унаследованные от [IPPButtonGroup](../../Interface/IPPButtonGroup/IPPButtonGroup.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Add](../../Interface/IPPButtonGroup/IPPButtonGroup.Add.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Clear](../../Interface/IPPButtonGroup/IPPButtonGroup.Clear.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Insert](../../Interface/IPPButtonGroup/IPPButtonGroup.Insert.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Remove](../../Interface/IPPButtonGroup/IPPButtonGroup.Remove.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [RemoveByIndex](../../Interface/IPPButtonGroup/IPPButtonGroup.RemoveByIndex.htm)
