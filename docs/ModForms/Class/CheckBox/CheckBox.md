...
Класс CheckBox реализует компонент
 среды разработки [CheckBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/CheckBox.htm),
 используемый для включения и выключения каких-либо опций, или для индикации
 состояния.


## Свойства, унаследованные от [ICheckBox](../../Interface/ICheckBox/ICheckBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](../../Interface/ICheckBox/ICheckBox.Alignment.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AllowGrayed](../../Interface/ICheckBox/ICheckBox.AllowGrayed.htm)


		 Свойство AllowGrayed
		 определяет, будет ли в компоненте возможность установить промежуточное
		 состояние.


		 ![](../../Property_Image.gif)
		 [Checked](../../Interface/ICheckBox/ICheckBox.Checked.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [State](../../Interface/ICheckBox/ICheckBox.State.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](CheckBox.OnChange.htm)


		 Событие OnChange наступает
		 при изменении отметки флажка компонента.
