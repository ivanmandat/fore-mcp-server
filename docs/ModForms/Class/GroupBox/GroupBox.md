...
Класс GroupBox реализует компонент
 среды разработки [GroupBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/GroupBox.htm),
 представляющий собой контейнер для других компонентов.
