...
Класс OleDocumentBox реализует
 компонент среды разработки [OleDocumentBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/OleDocumentBox.htm),
 используемый для работы с COM-объектами.


## Свойства, унаследованные от [IOleDocumentBox](../../Interface/IOleDocumentBox/IOleDocumentBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IOleDocumentBox/IOleDocumentBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [EnableDocumentEvents](../../Interface/IOleDocumentBox/IOleDocumentBox.EnableDocumentEvents.htm)
		 Свойство EnableDocumentEvents
		 определяет, будет ли генерироваться событие [OnOleDocumentEvent](OleDocumentBox.OnOleDocumentEvent.htm).


		 ![](../../Property_Image.gif)
		 [OleObject](../../Interface/IOleDocumentBox/IOleDocumentBox.OleObject.htm)
		 Свойство OleObject
		 возвращает объект, загруженный в [OleDocumentBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/OleDocumentBox.htm).


		 ![](../../Property_Image.gif)
		 [UserMode](../../Interface/IOleDocumentBox/IOleDocumentBox.UserMode.htm)
...
## Методы, унаследованные от [IOleDocumentBox](../../Interface/IOleDocumentBox/IOleDocumentBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateFromFile](../../Interface/IOleDocumentBox/IOleDocumentBox.CreateFromFile.htm)


		 Метод CreateFromFile
		 создает и помещает в компонент COM-объект, позволяющий работать
		 с файлом, путь к которому передается в качестве входного параметра.


		 ![](../../Sub_Image.gif)
		 [CreateObject](../../Interface/IOleDocumentBox/IOleDocumentBox.CreateObject.htm)


		 Метод CreateObject
		 создает и помещает в компонент экземпляр указанного COM-объекта.


		 ![](../../Sub_Image.gif)
		 [DestroyObject](../../Interface/IOleDocumentBox/IOleDocumentBox.DestroyObject.htm)


		 Метод DestroyObject
		 удаляет из компонента созданный COM-объект.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnOleDocumentEvent](OleDocumentBox.OnOleDocumentEvent.htm)
		 Событие OnOleDocumentEvent
		 наступает, если происходит какое либо событие у объекта, загруженного
		 в компонент OleDocumentBox.
