...
Класс MenuButton реализует компонент
 среды разработки [MenuButton](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MenuButton.htm),
 представляющий собой кнопку с всплывающим меню.


## Свойства, унаследованные от [IMenuButton](../../Interface/IMenuButton/IMenuButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Menu](../../Interface/IMenuButton/IMenuButton.Menu.htm)
		 Свойства Menu определяет
		 пользовательское меню, которое будет отображаться при нажатии
		 на кнопку.


		 ![](../../Property_Image.gif)
		 [RightArrow](../../Interface/IMenuButton/IMenuButton.RightArrow.htm)
		 Свойство RightArrow
		 определяет направление стрелок и соответственно расположение всплывающего
		 списка.


		 ![](../../Property_Image.gif)
		 [StayPressed](../../Interface/IMenuButton/IMenuButton.StayPressed.htm)
		 Свойство StayPressed
		 определяет, будет ли нажата кнопка до момента закрытия всплывающего
		 меню.
