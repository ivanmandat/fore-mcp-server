...
Класс WebBrowserBox реализует
 компонент среды разработки [WebBrowserBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/WebBrowserBox.htm),
 используемый для загрузки и отображения веб-страниц.


## Свойства, унаследованные от [IWebBrowserBox](../../Interface/IWebBrowserBox/IWebBrowserBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IWebBrowserBox/IWebBrowserBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [DocumentText](../../Interface/IWebBrowserBox/IWebBrowserBox.DocumentText.htm)
		 Свойство DocumentText
		 определяет HTML код страницы, загруженной в компоненте [WebBrowserBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/WebBrowserBox.htm).


		 ![](../../Property_Image.gif)
		 [OleObject](../../Interface/IWebBrowserBox/IWebBrowserBox.OleObject.htm)
		 Свойство OleObject
		 возвращает веб-страницу, загруженную в компонент, в виде OLE-объекта.
...
## Методы, унаследованные от [IWebBrowserBox](../../Interface/IWebBrowserBox/IWebBrowserBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Navigate](../../Interface/IWebBrowserBox/IWebBrowserBox.Navigate.htm)
		 Метод Navigate осуществляет
		 загрузку в [WebBrowserBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/WebBrowserBox.htm)
		 Web-страницу, адрес которой передается в качестве входного параметра.


		 ![](../../Sub_Image.gif)
		 [Refresh](../../Interface/IWebBrowserBox/IWebBrowserBox.Refresh.htm)
		 Метод Refresh осуществляет
		 обновление загруженной Web-страницы.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeNavigate2](WebBrowserBox.OnBeforeNavigate2.htm)
		 Событие OnBeforeNavigate2
		 наступает перед тем, как будет совершен переход к какой-либо Web-странице.


		 ![](../../Event_Image.gif)
		 [OnDocumentComplete](WebBrowserBox.OnDocumentComplete.htm)
		 Событие OnDocumentComplete
		 наступает после завершения загрузки Web-страницы.


		 ![](../../Event_Image.gif)
		 [OnNavigateComplete2](WebBrowserBox.OnNavigateComplete2.htm)
		 Событие OnNavigateComplete2
		 наступает после завершения перехода к новой Web-странице.
