...
Класс PageControlSheet реализует
 страницу компонента [PageControl](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/PageControl.htm).


## Свойства, унаследованные от [IPageControlSheet](../../Interface/IPageControlSheet/IPageControlSheet.htm)
