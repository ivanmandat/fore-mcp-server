...
Класс ListBox реализует компонент
 [ListBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/ListBox.htm),
 используемый для отображения списка строк.
