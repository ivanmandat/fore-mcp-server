...
Класс RibbonGroup реализует
 элемент ленты - Группа элементов.


## Свойства объекта класса, унаследованные от [IRibbonGroup](../../Interface/IRibbonGroup/IRibbonGroup.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Elements](../../Interface/IRibbonGroup/IRibbonGroup.Elements.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Images](../../Interface/IRibbonGroup/IRibbonGroup.Images.htm)
