...
Класс ImageBox реализует компонент
 среды разработки [ImageBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ImageBox.htm),
 предназначенный для загрузки изображений.


## Свойства, унаследованные от [IImageBox](../../Interface/IImageBox/IImageBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoSize](../../Interface/IImageBox/IImageBox.AutoSize.htm)
		 Свойство AutoSize определяет,
		 будет ли автоматически устанавливаться размер окна компонента
		 в соответствии с размером изображения.


		 ![](../../Property_Image.gif)
		 [Center](../../Interface/IImageBox/IImageBox.Center.htm)
		 Свойство Center определяет
		 расположение картинки в окне компонента.


		 ![](../../Property_Image.gif)
		 [Image](../../Interface/IImageBox/IImageBox.Image.htm)
		 Свойство Image определяет
		 изображение, отображаемое компонентом.


		 ![](../../Property_Image.gif)
		 [Proportional](../../Interface/IImageBox/IImageBox.Proportional.htm)
		 Свойство Proportional
		 определяет соблюдение пропорций изображения в окне компонента.


		 ![](../../Property_Image.gif)
		 [Stretch](../../Interface/IImageBox/IImageBox.Stretch.htm)
		 Свойство Stretch определяет,
		 будет ли производиться автоподгон размеров изображения под размеры
		 компонента.


		 ![](../../Property_Image.gif)
		 [Transparent](../../Interface/IImageBox/IImageBox.Transparent.htm)
		 Свойство Transparent
		 определяет, будет ли фон изображения отображаться прозрачным.


		 ![](../../Property_Image.gif)
		 [TransparentColor](../../Interface/IImageBox/IImageBox.TransparentColor.htm)
		 Свойство TransparentColor
		 определяет цвет для прозрачности изображения.
...
## Методы, унаследованные от [IImageBox](../../Interface/IImageBox/IImageBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [LoadImageFromStream](../../Interface/IImageBox/IImageBox.LoadImageFromStream.htm)


		 Метод LoadImageFromStream
		 осуществляет загрузку изображения из потока.
