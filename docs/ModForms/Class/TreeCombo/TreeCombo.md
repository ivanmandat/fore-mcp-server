...
Класс TreeCombo реализует компонент
 среды разработки [TreeCombo](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TreeCombo.htm),
 используемый для отображения ветвящихся иерархических структур в виде
 комбинированных списков.


## Свойства, унаследованные от [ITreeCombo](../../Interface/ITreeCombo/ITreeCombo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AnimationType](../../Interface/ITreeCombo/ITreeCombo.AnimationType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoUpdateInfo](../../Interface/ITreeCombo/ITreeCombo.AutoUpdateInfo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CancelOnEscape](../../Interface/ITreeCombo/ITreeCombo.CancelOnEscape.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CloseOnClick](../../Interface/ITreeCombo/ITreeCombo.CloseOnClick.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CloseOnEnter](../../Interface/ITreeCombo/ITreeCombo.CloseOnEnter.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CustomMultiselectText](../../Interface/ITreeCombo/ITreeCombo.CustomMultiselectText.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CustomMultiselectTextTemplate](../../Interface/ITreeCombo/ITreeCombo.CustomMultiselectTextTemplate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Dropped](../../Interface/ITreeCombo/ITreeCombo.Dropped.htm)
		 Свойство Dropped возвращает
		 видимость раскрывающегося списка.


		 ![](../../Property_Image.gif)
		 [DroppedListHeight](../../Interface/ITreeCombo/ITreeCombo.DroppedListHeight.htm)
		 Свойство DroppedListHeight
		 определяет высоту раскрывающегося списка компонента.


		 ![](../../Property_Image.gif)
		 [DroppedListWidth](../../Interface/ITreeCombo/ITreeCombo.DroppedListWidth.htm)
		 Свойство DroppedListWidth
		 определяет ширину раскрывающегося списка компонента.


		 ![](../../Property_Image.gif)
		 [DroppedPopupMenu](../../Interface/ITreeCombo/ITreeCombo.DroppedPopupMenu.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FilterStyle](../../Interface/ITreeCombo/ITreeCombo.FilterStyle.htm)
		 Свойство FilterStyle
		 определяет режим построения дерева отфильтрованных элементов.


		 ![](../../Property_Image.gif)
		 [FindEditVisible](../../Interface/ITreeCombo/ITreeCombo.FindEditVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowEditImage](../../Interface/ITreeCombo/ITreeCombo.ShowEditImage.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowSystemHints](../../Interface/ITreeCombo/ITreeCombo.ShowSystemHints.htm)
...
## Свойства, унаследованные от [ITreeControl](../../Interface/ITreeControl/ITreeControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AdjustWidthOnlyVisible](../../Interface/ITreeControl/ITreeControl.AdjustWidthOnlyVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoCheckParent](../../Interface/ITreeControl/ITreeControl.AutoCheckParent.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/ITreeControl/ITreeControl.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Checkboxes](../../Interface/ITreeControl/ITreeControl.Checkboxes.htm)


		 Свойство Checkboxes
		 определяет признак наличия флажков у элементов компонента.


		 ![](../../Property_Image.gif)
		 [ColumnClick](../../Interface/ITreeControl/ITreeControl.ColumnClick.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Columns](../../Interface/ITreeControl/ITreeControl.Columns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DropTargetNode](../../Interface/ITreeControl/ITreeControl.DropTargetNode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [EnableFindDialog](../../Interface/ITreeControl/ITreeControl.EnableFindDialog.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FindMode](../../Interface/ITreeControl/ITreeControl.FindMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FocusedNode](../../Interface/ITreeControl/ITreeControl.FocusedNode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [GridLines](../../Interface/ITreeControl/ITreeControl.GridLines.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HeaderMenu](../../Interface/ITreeControl/ITreeControl.HeaderMenu.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HideSelection](../../Interface/ITreeControl/ITreeControl.HideSelection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HighlightTrack](../../Interface/ITreeControl/ITreeControl.HighlightTrack.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HotTrack](../../Interface/ITreeControl/ITreeControl.HotTrack.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HotTrackAutoExpand](../../Interface/ITreeControl/ITreeControl.HotTrackAutoExpand.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Images](../../Interface/ITreeControl/ITreeControl.Images.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [InnerRoot](../../Interface/ITreeControl/ITreeControl.InnerRoot.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Locked](../../Interface/ITreeControl/ITreeControl.Locked.htm)


		 Свойство Locked определяет
		 возможность изменения отметки и редактирования текста элементов
		 в компоненте.


		 ![](../../Property_Image.gif)
		 [Nodes](../../Interface/ITreeControl/ITreeControl.Nodes.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ReadOnly](../../Interface/ITreeControl/ITreeControl.ReadOnly.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RowSelect](../../Interface/ITreeControl/ITreeControl.RowSelect.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Selected](../../Interface/ITreeControl/ITreeControl.Selected.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Selection](../../Interface/ITreeControl/ITreeControl.Selection.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelectionMode](../../Interface/ITreeControl/ITreeControl.SelectionMode.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowButtons](../../Interface/ITreeControl/ITreeControl.ShowButtons.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowColumnHeaders](../../Interface/ITreeControl/ITreeControl.ShowColumnHeaders.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHeaderButton](../../Interface/ITreeControl/ITreeControl.ShowHeaderButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowHints](../../Interface/ITreeControl/ITreeControl.ShowHints.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowLines](../../Interface/ITreeControl/ITreeControl.ShowLines.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SortColumn](../../Interface/ITreeControl/ITreeControl.SortColumn.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Sorted](../../Interface/ITreeControl/ITreeControl.Sorted.htm)


		 Свойство Sorted определяет
		 возможность сортировки по столбцу, указанному в свойстве [SortColumn](../../Interface/ITreeControl/ITreeControl.SortColumn.htm).


		 ![](../../Property_Image.gif)
		 [SortType](../../Interface/ITreeControl/ITreeControl.SortType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [StateImages](../../Interface/ITreeControl/ITreeControl.StateImages.htm)
...
## Свойства, унаследованные от [IControl](../../Interface/IControl/IControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Align](../../Interface/IControl/IControl.Align.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AllowDrag](../../Interface/IControl/IControl.AllowDrag.htm)
		 Свойство AllowDrag
		 определяет возможность взять у компонента перетаскиваемый объект.


		 ![](../../Property_Image.gif)
		 [AllowDrop](../../Interface/IControl/IControl.AllowDrop.htm)
		 Свойство AllowDrop
		 ...
		 ![](../../Property_Image.gif)
		 [Anchors](../../Interface/IControl/IControl.Anchors.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Brush](../../Interface/IControl/IControl.Brush.htm)
		 Свойство Brush определяет
		 кисть, используемую для заливки области компонента.


		 ![](../../Property_Image.gif)
		 [ClientHeight](../../Interface/IControl/IControl.ClientHeight.htm)
		 Свойство ClientHeight
		 определяет высоту клиентской области компонента.


		 ![](../../Property_Image.gif)
		 [ClientWidth](../../Interface/IControl/IControl.ClientWidth.htm)
		 Свойство ClientWidth
		 определяет ширину клиентской области компонента.


		 ![](../../Property_Image.gif)
		 [Color](../../Interface/IControl/IControl.Color.htm)
		 Свойство Color определяет
		 цвет фона компонента.


		 ![](../../Property_Image.gif)
		 [Cursor](../../Interface/IControl/IControl.Cursor.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Enabled](../../Interface/IControl/IControl.Enabled.htm)
		 Свойство Enabled определяет
		 доступность компонента для пользователя.


		 ![](../../Property_Image.gif)
		 [Focused](../../Interface/IControl/IControl.Focused.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Font](../../Interface/IControl/IControl.Font.htm)
		 Свойство Font определяет
		 параметры шрифта, используемого при отображении текста в компоненте.


		 ![](../../Property_Image.gif)
		 [Height](../../Interface/IControl/IControl.Height.htm)
		 Свойство Height определяет
		 высоту компонента в пикселях.


		 ![](../../Property_Image.gif)
		 [HelpContext](../../Interface/IControl/IControl.HelpContext.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Hint](../../Interface/IControl/IControl.Hint.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HintTimeout](../../Interface/IControl/IControl.HintTimeout.htm)
		 Свойство HintTimeout
		 определяет время отображения всплывающей подсказки.


		 ![](../../Property_Image.gif)
		 [Left](../../Interface/IControl/IControl.Left.htm)
		 Свойство Left определяет
		 координату левого края компонента в пикселях.


		 ![](../../Property_Image.gif)
		 [Parent](../../Interface/IControl/IControl.Parent.htm)
		 Свойство Parent определяет
		 родительский компонент.


		 ![](../../Property_Image.gif)
		 [ParentColor](../../Interface/IControl/IControl.ParentColor.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ParentFont](../../Interface/IControl/IControl.ParentFont.htm)
		 Свойство ParentFont
		 ...
		 ![](../../Property_Image.gif)
		 [ParentShowHint](../../Interface/IControl/IControl.ParentShowHint.htm)
		 Свойство ParentShowHint
		 определяет условие отображения всплывающей подсказки.


		 ![](../../Property_Image.gif)
		 [PopupMenu](../../Interface/IControl/IControl.PopupMenu.htm)
		 Свойство PopupMenu
		 ...
		 ![](../../Property_Image.gif)
		 [Scrolls](../../Interface/IControl/IControl.Scrolls.htm)
		 Свойство Scrolls возвращает
		 параметры полос прокрутки компонента.


		 ![](../../Property_Image.gif)
		 [ShowHint](../../Interface/IControl/IControl.ShowHint.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TabOrder](../../Interface/IControl/IControl.TabOrder.htm)
		 Свойство TabOrder определяет
		 позицию компонента в последовательности табуляции.


		 ![](../../Property_Image.gif)
		 [TabStop](../../Interface/IControl/IControl.TabStop.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Text](../../Interface/IControl/IControl.Text.htm)
		 Свойство Text определяет
		 строку, идентифицирующую компонент для пользователя.


		 ![](../../Property_Image.gif)
		 [Top](../../Interface/IControl/IControl.Top.htm)
		 Свойство Top определяет
		 координату верхнего края компонента в пикселях.


		 ![](../../Property_Image.gif)
		 [Visible](../../Interface/IControl/IControl.Visible.htm)
		 Свойство Visible определяет
		 видимость компонента во время выполнения формы.


		 ![](../../Property_Image.gif)
		 [Width](../../Interface/IControl/IControl.Width.htm)
...
## Методы, унаследованные от [ITreeCombo](../../Interface/ITreeCombo/ITreeCombo.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [AdjustDroppedListWidth](../../Interface/ITreeCombo/ITreeCombo.AdjustDroppedListWidth.htm)
		 Метод AdjustDroppedListWidth
		 осуществляет подгонку ширины раскрывающегося списка компонента.


		 ![](../../Sub_Image.gif)
		 [DropDown](../../Interface/ITreeCombo/ITreeCombo.DropDown.htm)
		 Метод DropDown осуществляет
		 разворачивание комбинированного списка.


		 ![](../../Sub_Image.gif)
		 [RollUp](../../Interface/ITreeCombo/ITreeCombo.RollUp.htm)
		 Метод RollUp осуществляет
		 свертывание комбинированного списка.


		 ![](../../Sub_Image.gif)
		 [UpdateInfo](../../Interface/ITreeCombo/ITreeCombo.UpdateInfo.htm)
		 Метод UpdateInfo осуществляет
		 обновление информации об отметке элементов, отображаемой в редакторе
		 компонента.


## Методы, унаследованные от [ITreeControl](../../Interface/ITreeControl/ITreeControl.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [AdjustWidth](../../Interface/ITreeControl/ITreeControl.AdjustWidth.htm)
		 Метод AdjustWidth осуществляет
		 автоматический подгон ширины колонки с учетом её содержимого.


		 ![](../../Sub_Image.gif)
		 [GetItemAt](../../Interface/ITreeControl/ITreeControl.GetItemAt.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [HitTest](../../Interface/ITreeControl/ITreeControl.HitTest.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Sort](../../Interface/ITreeControl/ITreeControl.Sort.htm)
		 Метод Sort осуществляет
		 сортировку элементов указанного столбца в заданном направлении.


		 ![](../../Sub_Image.gif)
		 [SortDefault](../../Interface/ITreeControl/ITreeControl.SortDefault.htm)
		 Метод SortDefault осуществляет
		 сортировку элементов в компоненте по возрастанию.


## Методы, унаследованные от [IControl](../../Interface/IControl/IControl.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ClientToScreen](../../Interface/IControl/IControl.ClientToScreen.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [DoDragDrop](../../Interface/IControl/IControl.DoDragDrop.htm)
		 Метод DoDragDrop позволяет
		 начать операцию перетаскивания.


		 ![](../../Sub_Image.gif)
		 [GetImage](../../Interface/IControl/IControl.GetImage.htm)
		 Метод GetImage возвращает
		 графическое изображение компонента со всеми дочерними компонентами.


		 ![](../../Sub_Image.gif)
		 [ScreenToClient](../../Interface/IControl/IControl.ScreenToClient.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [SetFocus](../../Interface/IControl/IControl.SetFocus.htm)
...
## События, унаследованные от [ITreeControl](../../Interface/ITreeControl/ITreeControl.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeginSearch](../../Interface/ITreeControl/ITreeControl.OnBeginSearch.htm)
		 Событие OnBeginSearch
		 наступает в момент начала поиска элементов в компоненте.


		 ![](../../Event_Image.gif)
		 [OnAdded](../../Interface/ITreeControl/ITreeControl.OnAdded.htm)
		 Событие OnAdded наступает
		 при добавлении нового элемента.


		 ![](../../Event_Image.gif)
		 [OnChecked](../../Interface/ITreeControl/ITreeControl.OnChecked.htm)
		 Событие OnChecked наступает
		 после изменения состояния флажка у элемента.


		 ![](../../Event_Image.gif)
		 [OnChecking](../../Interface/ITreeControl/ITreeControl.OnChecking.htm)
		 Событие OnChecking
		 наступает перед изменением состояния флажка у элемента.


		 ![](../../Event_Image.gif)
		 [OnCollapsed](../../Interface/ITreeControl/ITreeControl.OnCollapsed.htm)
		 Событие OnCollapsed
		 наступает после свертывания иерархии потомков вершины дерева.


		 ![](../../Event_Image.gif)
		 [OnCollapsing](../../Interface/ITreeControl/ITreeControl.OnCollapsing.htm)
		 Событие OnCollapsing
		 наступает перед свертыванием иерархии потомков вершины дерева.


		 ![](../../Event_Image.gif)
		 [OnColumnClick](../../Interface/ITreeControl/ITreeControl.OnColumnClick.htm)
		 Событие OnColumnClick
		 наступает при щелчке кнопкой мыши по заголовку столбца компонента.


		 ![](../../Event_Image.gif)
		 [OnCompareItems](../../Interface/ITreeControl/ITreeControl.OnCompareItems.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnDeleting](../../Interface/ITreeControl/ITreeControl.OnDeleting.htm)
		 Событие OnDeleting
		 наступает при удалении элемента.


		 ![](../../Event_Image.gif)
		 [OnEdited](../../Interface/ITreeControl/ITreeControl.OnEdited.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnEditing](../../Interface/ITreeControl/ITreeControl.OnEditing.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnExpanded](../../Interface/ITreeControl/ITreeControl.OnExpanded.htm)
		 Событие OnExpanded
		 наступает после развертывания иерархии потомков вершины дерева.


		 ![](../../Event_Image.gif)
		 [OnExpanding](../../Interface/ITreeControl/ITreeControl.OnExpanding.htm)
		 Событие OnExpanding
		 ...
		 ![](../../Event_Image.gif)
		 [OnFocusedChanged](../../Interface/ITreeControl/ITreeControl.OnFocusedChanged.htm)
		 Событие OnFocusedChanged
		 наступает после передачи фокуса другой вершине компонента.


		 ![](../../Event_Image.gif)
		 [OnFocusedChanging](../../Interface/ITreeControl/ITreeControl.OnFocusedChanging.htm)
		 Событие OnFocusedChanging
		 наступает перед передачей фокуса другой вершине компонента.


		 ![](../../Event_Image.gif)
		 [OnGetHint](../../Interface/ITreeControl/ITreeControl.OnGetHint.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnGetNodeImage](../../Interface/ITreeControl/ITreeControl.OnGetNodeImage.htm)
		 Событие OnGetNodeImage
		 используется при определении изображения возле элемента дерева.


		 ![](../../Event_Image.gif)
		 [OnGetNodeStateImage](../../Interface/ITreeControl/ITreeControl.OnGetNodeStateImage.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnHover](../../Interface/ITreeControl/ITreeControl.OnHover.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnSearch](../../Interface/ITreeControl/ITreeControl.OnSearch.htm)
		 Событие OnSearch наступает
		 после окончания поиска элементов в компоненте.


		 ![](../../Event_Image.gif)
		 [OnSelected](../../Interface/ITreeControl/ITreeControl.OnSelected.htm)
		 Событие OnSelected
		 наступает после установки отметки у вершины.


		 ![](../../Event_Image.gif)
		 [OnSelecting](../../Interface/ITreeControl/ITreeControl.OnSelecting.htm)
		 Событие OnSelecting
		 наступает перед попыткой установить отметку у вершины.


		 ![](../../Event_Image.gif)
		 [OnSelectionChanged](../../Interface/ITreeControl/ITreeControl.OnSelectionChanged.htm)
		 Событие OnSelectionChanged
		 наступает при изменении отметки у вершины компонента.


		 ![](../../Event_Image.gif)
		 [OnUnselected](../../Interface/ITreeControl/ITreeControl.OnUnselected.htm)
		 Событие OnUnselected
		 наступает после снятия отметки у вершины.


		 ![](../../Event_Image.gif)
		 [OnUnselecting](../../Interface/ITreeControl/ITreeControl.OnUnselecting.htm)
		 Событие OnUnselecting
		 наступает перед попыткой снять отметку у элемента.


## События, унаследованные от [IControl](../../Interface/IControl/IControl.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeginDrag](../../Interface/IControl/IControl.OnBeginDrag.htm)
		 Событие OnBeginDrag
		 ...
		 ![](../../Event_Image.gif)
		 [OnClick](../../Interface/IControl/IControl.OnClick.htm)
		 Событие OnClick наступает,
		 если пользователь щёлкнул в области компонента.


		 ![](../../Event_Image.gif)
		 [OnControlMove](../../Interface/IControl/IControl.OnControlMove.htm)
		 Событие OnControlMove
		 наступает при перемещении компонента.


		 ![](../../Event_Image.gif)
		 [OnControlResize](../../Interface/IControl/IControl.OnControlResize.htm)
		 Событие OnControlResize
		 наступает при изменении размеров у компонента.


		 ![](../../Event_Image.gif)
		 [OnDblClick](../../Interface/IControl/IControl.OnDblClick.htm)
		 Событие OnDblClick
		 наступает, если пользователь дважды щёлкнул в области компонента.


		 ![](../../Event_Image.gif)
		 [OnDragDrop](../../Interface/IControl/IControl.OnDragDrop.htm)
		 Событие OnDragDrop
		 ...
		 ![](../../Event_Image.gif)
		 [OnDragEnter](../../Interface/IControl/IControl.OnDragEnter.htm)
		 Событие OnDragEnter
		 ...
		 ![](../../Event_Image.gif)
		 [OnDragLeave](../../Interface/IControl/IControl.OnDragLeave.htm)
		 Событие OnDragLeave
		 ...
		 ![](../../Event_Image.gif)
		 [OnDragOver](../../Interface/IControl/IControl.OnDragOver.htm)
		 Событие OnDragOver
		 ...
		 ![](../../Event_Image.gif)
		 [OnKeyPress](../../Interface/IControl/IControl.OnKeyPress.htm)
		 Событие OnKeyPress
		 ...
		 ![](../../Event_Image.gif)
		 [OnKeyPreview](../../Interface/IControl/IControl.OnKeyPreview.htm)
		 Событие OnKeyPreview
		 наступает перед каждым событием, связанным с нажатием клавиш.


		 ![](../../Event_Image.gif)
		 [OnKeyUp](../../Interface/IControl/IControl.OnKeyUp.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnMouseDown](../../Interface/IControl/IControl.OnMouseDown.htm)
		 Событие OnMouseDown
		 ...
		 ![](../../Event_Image.gif)
		 [OnMouseWheel](../../Interface/IControl/IControl.OnMouseWheel.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnVScroll](../../Interface/IControl/IControl.OnVScroll.htm)
