...
Класс PPPageControl реализует компонент среды разработки - [PPPageControl](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPPageControl.htm).
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](../PageControl/PageControl.OnChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnChanging](../PageControl/PageControl.OnChanging.htm)
