...
Класс Label реализует компонент
 среды разработки [Label](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Label.htm),
 предназначенный для создания надписей на форме.
