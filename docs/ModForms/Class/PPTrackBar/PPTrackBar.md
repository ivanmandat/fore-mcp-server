...
Класс PPTrackBar реализует компонент среды разработки - [PPTrackBar](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPTrackBar.htm).
...
## События, унаследованные от [TrackBar](../TrackBar/TrackBar.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](../TrackBar/TrackBar.OnChange.htm)
