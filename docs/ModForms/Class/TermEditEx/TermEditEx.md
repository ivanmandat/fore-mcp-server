...
Класс TermEditEx реализует компонент
 среды разработки [TermEditEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TermEditEx.htm),
 представляющий собой редактор выражений, имеющий ряд модификаций.


## Свойства, унаследованные от [ITermEdit](../../Interface/ITermEdit/ITermEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [EnableHyperlinks](../../Interface/ITermEdit/ITermEdit.EnableHyperlinks.htm)
		 Свойство EnableHyperlinks
		 определяет возможность отображения выражения в виде гиперссылки.


		 ![](../../Property_Image.gif)
		 [Formula](../../Interface/ITermEdit/ITermEdit.Formula.htm)
		 Свойство Formula определяет
		 формулу выражения.


		 ![](../../Property_Image.gif)
		 [Hyperlink](../../Interface/ITermEdit/ITermEdit.Hyperlink.htm)
		 Свойство Hyperlink
		 определяет признак отображения указанного выражения в виде гиперссылки.


		 ![](../../Property_Image.gif)
		 [Terms](../../Interface/ITermEdit/ITermEdit.Terms.htm)
		 Свойство Terms возвращает
		 коллекцию выражений компонента.


		 ![](../../Property_Image.gif)
		 [WantReturns](../../Interface/ITermEdit/ITermEdit.WantReturns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WantTabs](../../Interface/ITermEdit/ITermEdit.WantTabs.htm)
		 Свойство WantTabs определяет
		 возможность вставки в редактируемый текст символа табуляции.


		 ![](../../Property_Image.gif)
		 [WordWrap](../../Interface/ITermEdit/ITermEdit.WordWrap.htm)
		 Свойство WordWrap определяет,
		 будут ли переноситься на новую строку слова, длина которых
		 превышает длину компонента.
...
## Методы, унаследованные от [ITermEdit](../../Interface/ITermEdit/ITermEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [BeginUpdate](../../Interface/ITermEdit/ITermEdit.BeginUpdate.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [EndUpdate](../../Interface/ITermEdit/ITermEdit.EndUpdate.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [PutCustom](../../Interface/ITermEdit/ITermEdit.PutCustom.htm)


		 Метод PutCustom осуществляет
		 вставку пользовательского выражения в указанную позицию.


		 ![](../../Sub_Image.gif)
		 [PutLiteral](../../Interface/ITermEdit/ITermEdit.PutLiteral.htm)


		 Метод PutLiteral осуществляет
		 размещение литерального выражения в указанную позицию.


		 ![](../../Sub_Image.gif)
		 [PutTerm](../../Interface/ITermEdit/ITermEdit.PutTerm.htm)


		 Метод PutTerm осуществляет
		 вставку выражения в указанную позицию.


		 ![](../../Sub_Image.gif)
		 [Reparse](../../Interface/ITermEdit/ITermEdit.Reparse.htm)
...
## События, унаследованные от [TermEdit](../TermEdit/TermEdit.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnHyperlink](../TermEdit/TermEdit.OnHyperlink.htm)
		 Событие OnHyperlink
		 наступает при щелчке по термовой гиперссылке.


		 ![](../../Event_Image.gif)
		 [OnParseTerm](../TermEdit/TermEdit.OnParseTerm.htm)
		 Событие OnParseTerm
		 возникает во время преобразования текста редактора в термы (выражения)
		 и знаки операции.


## События, унаследованные от [ICustomEdit](../../Interface/ICustomEdit/ICustomEdit.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](../../Interface/ICustomEdit/ICustomEdit.OnChange.htm)
		 Событие OnChange наступает
		 после изменений свойства [Text](../../Interface/IControl/IControl.Text.htm)
