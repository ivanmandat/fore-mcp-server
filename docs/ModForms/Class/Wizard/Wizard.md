...
Класс Wizard реализует компонент
 среды разработки [Wizard](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Wizard.htm),
 используемый для создания мастеров.


## Свойства, унаследованные от [IWizard](../../Interface/IWizard/IWizard.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActivePage](../../Interface/IWizard/IWizard.ActivePage.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Buttons](../../Interface/IWizard/IWizard.Buttons.htm)


		 Свойство Buttons возвращает
		 коллекцию кнопок, осуществляющих навигацию по страницам мастера.


		 ![](../../Property_Image.gif)
		 [Pages](../../Interface/IWizard/IWizard.Pages.htm)


		 Свойство Pages возвращает
		 коллекцию страниц мастера.


		 ![](../../Property_Image.gif)
		 [Splash](../../Interface/IWizard/IWizard.Splash.htm)


		 Свойство Splash возвращает
		 общую заставку мастера.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnCancel](Wizard.OnCancel.htm)
		 Событие OnCancel наступает
		 после нажатия на кнопку "Отмена".


		 ![](../../Event_Image.gif)
		 [OnFinish](Wizard.OnFinish.htm)
		 Событие OnFinish наступает
