...
Класс WizardSplash реализует
 компонент среды разработки [WizardSplash](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/WizardSplash.htm),
 представляющий собой общую заставку мастера, отображающую ссылки на страницы
 мастера.


## Свойства, унаследованные от [IWizardSplash](../../Interface/IWizardSplash/IWizardSplash.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Background](../../Interface/IWizardSplash/IWizardSplash.Background.htm)


		 Свойство Background
		 позволяет определить фон компонента [WizardSplash](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/WizardSplash.htm).


		 ![](../../Property_Image.gif)
		 [Image](../../Interface/IWizardSplash/IWizardSplash.Image.htm)


		 Свойство Image позволяет
		 определить изображение, которое будет помещаться в общую заставку
		 мастера.


		 ![](../../Property_Image.gif)
		 [Wizard](../../Interface/IWizardSplash/IWizardSplash.Wizard.htm)


		 Свойство Wizard определяет
		 компонент-владелец данной заставки мастера.
...
## Методы, унаследованные от [IWizardSplash](../../Interface/IWizardSplash/IWizardSplash.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Refresh](../../Interface/IWizardSplash/IWizardSplash.Refresh.htm)
