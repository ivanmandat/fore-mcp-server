...
Класс Hyperlink реализует компонент
 среды разработки [Hyperlink](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Hyperlink.htm),
 позволяющий создавать гиперссылки на форме.


## Свойства, унаследованные от [IHyperlink](../../Interface/IHyperlink/IHyperlink.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AlwaysUnderlined](../../Interface/IHyperlink/IHyperlink.AlwaysUnderlined.htm)


		 Свойство AlwaysUnderlined
		 определяет признак наличия у гиперссылки подчеркивающей линии.


		 ![](../../Property_Image.gif)
		 [HoverColor](../../Interface/IHyperlink/IHyperlink.HoverColor.htm)


		 Свойство HoverColor
		 определяет цвет, которым будет подсвечиваться гиперссылка при
		 наведении на нее курсора мыши.


## Свойства, унаследованные от [ILabel](../../Interface/ILabel/ILabel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](../../Interface/ILabel/ILabel.Alignment.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoSize](../../Interface/ILabel/ILabel.AutoSize.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Layout](../../Interface/ILabel/ILabel.Layout.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Transparent](../../Interface/ILabel/ILabel.Transparent.htm)


		 Свойство Transparent
		 определяет признак прозрачности компонента.


		 ![](../../Property_Image.gif)
		 [WordWrap](../../Interface/ILabel/ILabel.WordWrap.htm)
