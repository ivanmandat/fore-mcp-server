...
Класс RadioButton реализует
 компонент среды разработки [RadioButton](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/RadioButton.htm),
 представляющий собой переключатель, используемый в группе с другими переключателями
 для выбора одного из возможных значений.


## Свойства, унаследованные от [IRadioButton](../../Interface/IRadioButton/IRadioButton.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](../../Interface/IRadioButton/IRadioButton.Alignment.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Checked](../../Interface/IRadioButton/IRadioButton.Checked.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](RadioButton.OnChange.htm)
