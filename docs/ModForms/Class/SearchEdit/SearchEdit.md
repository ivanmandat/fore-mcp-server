...
Класс SearchEdit реализует компонент
 среды разработки - [SearchEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/SearchEdit.htm).


## Свойства объекта класса, унаследованные от [ISearchEdit](../../Interface/ISearchEdit/ISearchEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Timeout](../../Interface/ISearchEdit/ISearchEdit.Timeout.htm)
		 Свойство Timeout определяет
		 допустимое время поиска.


## Свойства объекта класса, унаследованные от [IEditBox](../../Interface/IEditBox/IEditBox.htm)
...
## Свойства объекта класса, унаследованные от [ICustomEdit](../../Interface/ICustomEdit/ICustomEdit.htm)
...
## Свойства объекта класса, унаследованные от [IControl](../../Interface/IControl/IControl.htm)
...
## Свойства объекта класса, унаследованные от [IComponent](../../Interface/IComponent/IComponent.htm)
...
## Методы объекта класса, унаследованные от [ISearchEdit](../../Interface/ISearchEdit/ISearchEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Search](../../Interface/ISearchEdit/ISearchEdit.Search.htm)
		 Метод Search запускает
		 процесс поиска.


## Методы объекта класса, унаследованные от [ICustomEdit](../../Interface/ICustomEdit/ICustomEdit.htm)
...
## Методы объекта класса, унаследованные от [IControl](../../Interface/IControl/IControl.htm)
...
## События объекта класса
		 ...
		 ![](../../Event_Image.gif)
		 [OnSearch](SearchEdit.OnSearch.htm)
		 Событие OnSearch наступает
		 после старта поиска по истечению заданного времени поиска.
