...
Класс TrackBar реализует компонент
 среды разработки [TrackBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TrackBar.htm),
 представляет собой элемент управления, значение в котором изменяется с
 помощью ползунка.


## Свойства объекта класса, унаследованные от [ITrackBar](../../Interface/ITrackBar/ITrackBar.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/ITrackBar/ITrackBar.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Frequency](../../Interface/ITrackBar/ITrackBar.Frequency.htm)
		 Свойство Frequency
		 ...
		 ![](../../Property_Image.gif)
		 [Position](../../Interface/ITrackBar/ITrackBar.Position.htm)
		 Свойство Position определяет
		 текущее положение ползунка.


		 ![](../../Property_Image.gif)
		 [SelEnd](../../Interface/ITrackBar/ITrackBar.SelEnd.htm)
		 Свойство SelEnd задает
		 конечную позицию выделения.


		 ![](../../Property_Image.gif)
		 [SelStart](../../Interface/ITrackBar/ITrackBar.SelStart.htm)
		 Свойство SelStart задает
		 начальную позицию выделения.


		 ![](../../Property_Image.gif)
		 [SliderVisible](../../Interface/ITrackBar/ITrackBar.SliderVisible.htm)
		 Свойство SliderVisible
		 определяет, будет ли видимым указатель компонента.


		 ![](../../Property_Image.gif)
		 [ThumbLength](../../Interface/ITrackBar/ITrackBar.ThumbLength.htm)
		 Свойство ThumbLength
		 определяет длину указателя.


		 ![](../../Property_Image.gif)
		 [TickMarks](../../Interface/ITrackBar/ITrackBar.TickMarks.htm)
		 Свойство TickMarks
		 определяет способ нанесения меток.


		 ![](../../Property_Image.gif)
		 [TickStyle](../../Interface/ITrackBar/ITrackBar.TickStyle.htm)
		 Свойство TickStyle
...
## Методы объекта класса, унаследованные от [ITrackBar](../../Interface/ITrackBar/ITrackBar.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [SetTick](../../Interface/ITrackBar/ITrackBar.SetTick.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](TrackBar.OnChange.htm)
