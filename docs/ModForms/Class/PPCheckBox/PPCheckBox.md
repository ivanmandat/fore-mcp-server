...
Класс PPCheckBox реализует компонент среды разработки - [PPCheckBox](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPCheckBox.htm).
...
## События, унаследованные от [CheckBox](../CheckBox/CheckBox.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](../CheckBox/CheckBox.OnChange.htm)
