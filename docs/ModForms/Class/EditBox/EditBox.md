...
Класс EditBox реализует компонент
 среды разработки [EditBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/EditBox.htm),
 представляющий собой однострочный редактор текста.
