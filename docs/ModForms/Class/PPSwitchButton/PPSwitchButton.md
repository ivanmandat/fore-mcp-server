...
Класс PPSwitchButton реализует
 кнопку, используемую компонентом [PPButtonGroup](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPButtonGroup.htm).


## Свойства объекта класса, унаследованные от [IPPSwitchButton](../../Interface/IPPSwitchButton/IPPSwitchButton.htm)
