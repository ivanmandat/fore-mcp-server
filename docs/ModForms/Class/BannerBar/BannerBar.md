...
Класс BannerBar реализует компонент
 среды разработки [BannerBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/BannerBar.htm)
 используемый для создания заголовка формы (баннера).


## Свойства, унаследованные от [IBannerBar](../../Interface/IBannerBar/IBannerBar.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DockPosition](../../Interface/IBannerBar/IBannerBar.DockPosition.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Form](../../Interface/IBannerBar/IBannerBar.Form.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MetabaseObject](../../Interface/IBannerBar/IBannerBar.MetabaseObject.htm)
