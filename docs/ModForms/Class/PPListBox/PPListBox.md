...
Класс PPListBox реализует компонент
 среды разработки [PPListBox](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPListBox.htm).


## Свойства, унаследованные от [IListBox](../../Interface/IListBox/IListBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IListBox/IListBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Columns](../../Interface/IListBox/IListBox.Columns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IntegralHeight](../../Interface/IListBox/IListBox.IntegralHeight.htm)
		 Свойство IntegralHeight
		 определяет, будет ли отображаться элемент списка, если он
		 полностью не помещается в окно компонента, путем подгонки высоты
		 компонента.


		 ![](../../Property_Image.gif)
		 [ItemHeight](../../Interface/IListBox/IListBox.ItemHeight.htm)
		 Свойство ItemHeight
		 определяет высоту элементов (строк) списка.


		 ![](../../Property_Image.gif)
		 [ItemIndex](../../Interface/IListBox/IListBox.ItemIndex.htm)
		 Свойство ItemIndex
		 определяет индекс последнего выделенного элемента в компоненте.


		 ![](../../Property_Image.gif)
		 [Items](../../Interface/IListBox/IListBox.Items.htm)
		 Свойство Items определяет
		 список строк компонента.


		 ![](../../Property_Image.gif)
		 [MultiSelect](../../Interface/IListBox/IListBox.MultiSelect.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelCount](../../Interface/IListBox/IListBox.SelCount.htm)
		 Свойство SelCount возвращает
		 количество выделенных элементов.


		 ![](../../Property_Image.gif)
		 [Selected](../../Interface/IListBox/IListBox.Selected.htm)
		 Свойство Selected возвращает
		 признак наличия отметки у указанного элемента.


		 ![](../../Property_Image.gif)
		 [Sorted](../../Interface/IListBox/IListBox.Sorted.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TabWidth](../../Interface/IListBox/IListBox.TabWidth.htm)
		 Свойство TabWidth определяет
		 ширину символа табуляции.


		 ![](../../Property_Image.gif)
		 [TopIndex](../../Interface/IListBox/IListBox.TopIndex.htm)
...
## События, унаследованные от [ListBox](../ListBox/ListBox.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](../ListBox/ListBox.OnChange.htm)


		 Событие OnChange наступает
		 при изменении в компоненте последнего выделенного элемента.
