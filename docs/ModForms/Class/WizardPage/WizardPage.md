...
Класс WizardPage реализует страницу
 компонента [Wizard](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Wizard.htm).


## Свойства объекта класса, унаследованные от [IWizardPage](../../Interface/IWizardPage/IWizardPage.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Description](../../Interface/IWizardPage/IWizardPage.Description.htm)


		 Свойство Description
		 определяет описание страницы мастера.


		 ![](../../Property_Image.gif)
		 [PageIndex](../../Interface/IWizardPage/IWizardPage.PageIndex.htm)


		 Свойство PageIndex
		 определяет индекс страницы мастера.


		 ![](../../Property_Image.gif)
		 [ShowDescription](../../Interface/IWizardPage/IWizardPage.ShowDescription.htm)


		 Свойство ShowDescription
		 определяет видимость заголовка и [описания](../../Interface/IWizardPage/IWizardPage.Description.htm)
		 страницы мастера.
...
## События объекта класса
		 ...
		 ![](../../Event_Image.gif)
		 [OnBack](WizardPage.OnBack.htm)


		 Событие OnBack наступает
		 после нажатия на кнопку "Назад".


		 ![](../../Event_Image.gif)
		 [OnGetLeaveAllowed](WizardPage.OnGetLeaveAllowed.htm)


		 Событие OnGetLeaveAllowed
		 наступает при попытке перейти на другую страницу мастера.


		 ![](../../Event_Image.gif)
		 [OnNext](WizardPage.OnNext.htm)


		 Событие OnNext наступает
		 после нажатия на кнопку "Далее".


		 ![](../../Event_Image.gif)
		 [OnPageAccessible](WizardPage.OnPageAccessible.htm)


		 Событие OnPageAccessible
		 наступает при проверке страницы на доступность.


		 ![](../../Event_Image.gif)
		 [OnSetActive](WizardPage.OnSetActive.htm)


		 Событие OnSetActive
		 наступает при активации страницы мастера.
