...
Класс PageControl реализует
 компонент среды разработки [PageControl](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/PageControl.htm),
 предоставляющий многостраничную панель, которая позволяет экономить пространство
 окна приложения, размещая на одном и том же месте страницы разного содержания.


## Свойства, унаследованные от [IPageControl](../../Interface/IPageControl/IPageControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveSheet](../../Interface/IPageControl/IPageControl.ActiveSheet.htm)


		 Свойство ActivePage
		 определяет активную страницу компонента.


		 ![](../../Property_Image.gif)
		 [Images](../../Interface/IPageControl/IPageControl.Images.htm)


		 Свойство Images определяет
		 компонент, изображения которого будут использоваться в данном
		 компоненте.


		 ![](../../Property_Image.gif)
		 [MultiLine](../../Interface/IPageControl/IPageControl.MultiLine.htm)


		 Свойство MultiLine
		 определяет, будут ли вкладки для страниц компонента размещаться
		 в несколько рядов, если они не помещаются в один ряд.


		 ![](../../Property_Image.gif)
		 [Pages](../../Interface/IPageControl/IPageControl.Pages.htm)


		 Свойство Pages возвращает
		 коллекцию страниц компонента.


		 ![](../../Property_Image.gif)
		 [RaggedRight](../../Interface/IPageControl/IPageControl.RaggedRight.htm)


		 Свойство RaggedRight
		 определяет возможность изменения ширины заголовков вкладок для
		 выравнивания их по правому краю компонента.


		 ![](../../Property_Image.gif)
		 [ScrollOpposite](../../Interface/IPageControl/IPageControl.ScrollOpposite.htm)


		 Свойство ScrollOpposite
		 определяет способ перемещения вкладок при размещении их в несколько
		 рядов.


		 ![](../../Property_Image.gif)
		 [Style](../../Interface/IPageControl/IPageControl.Style.htm)


		 Свойство Style определяет
		 стиль вкладок страниц компонента.


		 ![](../../Property_Image.gif)
		 [TabPosition](../../Interface/IPageControl/IPageControl.TabPosition.htm)


		 Свойство TabPosition
		 определяет место расположения заголовков вкладок компонента.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](PageControl.OnChange.htm)


		 Событие OnChange наступает
		 после выбора другой вкладки.


		 ![](../../Event_Image.gif)
		 [OnChanging](PageControl.OnChanging.htm)


		 Событие OnChanging
		 наступает в момент перехода с одной вкладки на другую.
