...
Класс Panel реализует компонент
 среды разработки [Panel](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Panel.htm),
 представляющий собой панель, которая служит контейнером, объединяющим
 группу управляющих компонентов, компонентов ввода и отображения информации,
 а также других контейнеров.


## Свойства, унаследованные от [IPanel](../../Interface/IPanel/IPanel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](../../Interface/IPanel/IPanel.Alignment.htm)


		 Свойство Alignment
		 определяет выравнивание текста в области компонента по горизонтали.


		 ![](../../Property_Image.gif)
		 [BevelInner](../../Interface/IPanel/IPanel.BevelInner.htm)


		 Свойство BevelInner
		 определяет вид внутренней рамки компонента.


		 ![](../../Property_Image.gif)
		 [BevelOuter](../../Interface/IPanel/IPanel.BevelOuter.htm)


		 Свойство BevelOuter
		 определяет вид наружной рамки компонента.


		 ![](../../Property_Image.gif)
		 [BevelWidth](../../Interface/IPanel/IPanel.BevelWidth.htm)


		 Свойство BevelWidth
		 определяет ширину фаски, создающей эффект объемности рамок.


		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IPanel/IPanel.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderWidth](../../Interface/IPanel/IPanel.BorderWidth.htm)


		 Свойство BorderWidth
		 определяет расстояние между наружной и внутренней рамками компонента.


		 ![](../../Property_Image.gif)
		 [FullRepaint](../../Interface/IPanel/IPanel.FullRepaint.htm)


		 Свойство FullRepaint
		 определяет способ перерисовки панели при изменении размеров панели.
