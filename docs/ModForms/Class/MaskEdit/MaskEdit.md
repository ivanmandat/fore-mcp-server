...
Класс MaskEdit реализует компонент
 среды разработки [MaskEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MaskEdit.htm),
 используемый для ввода данных в соответствии с установленным шаблоном.


## Свойства, унаследованные от [IMaskEdit](../../Interface/IMaskEdit/IMaskEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [InputTemplate](../../Interface/IMaskEdit/IMaskEdit.InputTemplate.htm)


		 Свойство InputTemplate
		 определяет шаблон, в соответствии с которым будут вводиться данные
		 в редактор компонента.


		 ![](../../Property_Image.gif)
		 [Mask](../../Interface/IMaskEdit/IMaskEdit.Mask.htm)


		 Свойство Mask определяет
		 маску поля ввода, указывающую доступные данные при вводе.


		 ![](../../Property_Image.gif)
		 [MaskEnabled](../../Interface/IMaskEdit/IMaskEdit.MaskEnabled.htm)


		 Свойство MaskEnabled
		 определяет, будет ли компонент работать в режиме ввода данных
		 в соответствии с установленным шаблоном и маской ввода.


		 ![](../../Property_Image.gif)
		 [PlaceholderChar](../../Interface/IMaskEdit/IMaskEdit.PlaceholderChar.htm)


		 Свойство PlaceholderChar
		 определяет символ, используемый в шаблоне для указания позиций,
		 предназначенных для ввода данных.


		 ![](../../Property_Image.gif)
		 [ValidChars](../../Interface/IMaskEdit/IMaskEdit.ValidChars.htm)


		 Свойство ValidChars
		 определяет набор символов, которые пользователь может вводить
		 в поле ввода.
