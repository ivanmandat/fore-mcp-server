...
Класс TermEdit реализует компонент
 среды разработки [TermEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/TermEdit.htm),
 представляющий собой редактор выражений.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnHyperlink](TermEdit.OnHyperlink.htm)
		 Событие OnHyperlink
		 наступает при щелчке по термовой гиперссылке.


		 ![](../../Event_Image.gif)
		 [OnParseTerm](TermEdit.OnParseTerm.htm)
		 Событие OnParseTerm
