...
Класс Bevel реализует компонент
 среды разработки [Bevel](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Bevel.htm),
 используемый для выделения групп элементов или отделения их друг от друга.


## Свойства, унаследованные от [IBevel](../../Interface/IBevel/IBevel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Shape](../../Interface/IBevel/IBevel.Shape.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Style](../../Interface/IBevel/IBevel.Style.htm)


		 Свойство Style определяет
		 стиль оформления компонента.
