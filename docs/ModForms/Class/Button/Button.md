...
Класс Button реализует компонент
 среды разработки [Button](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Button.htm), представляющий
 собой стандартную кнопку Windows.
