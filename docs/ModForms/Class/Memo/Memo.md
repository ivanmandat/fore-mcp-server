...
Класс Memo реализует компонент
 среды разработки [Memo](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/Memo.htm),
 представляющий собой многострочный текстовый редактор.


## Свойства, унаследованные от [IMemo](../../Interface/IMemo/IMemo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](../../Interface/IMemo/IMemo.Alignment.htm)


		 Свойство Alignment
		 определяет выравнивание текста внутри поля компонента.


		 ![](../../Property_Image.gif)
		 [Lines](../../Interface/IMemo/IMemo.Lines.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ScrollBars](../../Interface/IMemo/IMemo.ScrollBars.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WantReturns](../../Interface/IMemo/IMemo.WantReturns.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WantTabs](../../Interface/IMemo/IMemo.WantTabs.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WordWrap](../../Interface/IMemo/IMemo.WordWrap.htm)
...
## Методы, унаследованные от [IMemo](../../Interface/IMemo/IMemo.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetCharPos](../../Interface/IMemo/IMemo.GetCharPos.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetLinePos](../../Interface/IMemo/IMemo.GetLinePos.htm)
