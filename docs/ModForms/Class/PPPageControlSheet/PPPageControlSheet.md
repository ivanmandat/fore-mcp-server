...
Класс PPPageControlSheet реализует
 страницу компонента [PPPageControl](UiDevEnv.chm::/02_Components_constructor_forms/04_PPControls/PPPageControl.htm).


## Свойства объекта класса, унаследованные от [IPageControlSheet](../../Interface/IPageControlSheet/IPageControlSheet.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ImageIndex](../../Interface/IPageControlSheet/IPageControlSheet.ImageIndex.htm)


		 Свойство ImageIndex
		 определяет индекс изображения, отображаемого в заголовке вкладки
		 страницы.


		 ![](../../Property_Image.gif)
		 [PageControl](../../Interface/IPageControlSheet/IPageControlSheet.PageControl.htm)


		 Свойство PageControl
		 возвращает объект-родитель.


		 ![](../../Property_Image.gif)
		 [SheetIndex](../../Interface/IPageControlSheet/IPageControlSheet.SheetIndex.htm)


		 Свойство SheetIndex
		 определяет индекс текущей страницы в коллекции.


		 ![](../../Property_Image.gif)
		 [TabVisible](../../Interface/IPageControlSheet/IPageControlSheet.TabVisible.htm)


		 Свойство TabVisible
		 определяет признак видимости данной вкладки страницы.
