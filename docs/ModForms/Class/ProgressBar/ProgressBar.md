...
Класс ProgressBar реализует
 компонент среды разработки [ProgressBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ProgressBar.htm),
 используемый для индикации процесса выполнения какой-либо задачи.


## Свойства, унаследованные от [IProgressBar](../../Interface/IProgressBar/IProgressBar.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IProgressBar/IProgressBar.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Max](../../Interface/IProgressBar/IProgressBar.Max.htm)
		 Свойство Max определяет
		 максимальное значение для индикатора выполнения.


		 ![](../../Property_Image.gif)
		 [Min](../../Interface/IProgressBar/IProgressBar.Min.htm)
		 Свойство Min определяет
		 минимальное значение для индикатора выполнения.


		 ![](../../Property_Image.gif)
		 [Orientation](../../Interface/IProgressBar/IProgressBar.Orientation.htm)
		 Свойство Orientation
		 определяет ориентацию индикатора компонента.


		 ![](../../Property_Image.gif)
		 [Position](../../Interface/IProgressBar/IProgressBar.Position.htm)
		 Свойство Position определяет
		 текущее положения индикатора выполнения.


		 ![](../../Property_Image.gif)
		 [Smooth](../../Interface/IProgressBar/IProgressBar.Smooth.htm)
		 Свойство Smooth определяет
		 вид индикатора.


		 ![](../../Property_Image.gif)
		 [StepSize](../../Interface/IProgressBar/IProgressBar.StepSize.htm)
		 Свойство StepSize определяет
		 величину, на которую будет смещен индикатор при вызове метода
		 [StepIt](../../Interface/IProgressBar/IProgressBar.StepIt.htm).
...
## Методы, унаследованные от [IProgressBar](../../Interface/IProgressBar/IProgressBar.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [StepBy](../../Interface/IProgressBar/IProgressBar.StepBy.htm)
		 Метод StepBy осуществляет
		 изменение позиции индикатора на величину, указанную во входном
		 параметре.


		 ![](../../Sub_Image.gif)
		 [StepIt](../../Interface/IProgressBar/IProgressBar.StepIt.htm)
		 Метод StepIt осуществляет
		 изменение позиции индикатора на величину, установленную в свойстве
		 [StepSize](../../Interface/IProgressBar/IProgressBar.StepSize.htm).
