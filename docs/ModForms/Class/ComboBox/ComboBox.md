...
Класс ComboBox предоставляет
 компонент среды разработки [ComboBox](UiDevEnv.chm::/02_Components_constructor_forms/01_Standart_Components/ComboBox.htm),
 реализующий комбинированный список, позволяющий выбрать имеющиеся значения,
 либо ввести значение вручную.


## Свойства, унаследованные от [IComboBox](../../Interface/IComboBox/IComboBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DropDownCount](../../Interface/IComboBox/IComboBox.DropDownCount.htm)


		 Свойство DropDownCount
		 определяет максимальное число элементов, одновременно отображаемых
		 в раскрывающемся списке.


		 ![](../../Property_Image.gif)
		 [DroppedDown](../../Interface/IComboBox/IComboBox.DroppedDown.htm)


		 Свойство DroppedDown
		 возвращает True, если
		 раскрывающийся список компонента находится в развернутом виде.


		 ![](../../Property_Image.gif)
		 [ItemCount](../../Interface/IComboBox/IComboBox.ItemCount.htm)


		 Свойство ItemCount
		 возвращает количество строк раскрывающегося списка.


		 ![](../../Property_Image.gif)
		 [ItemHeight](../../Interface/IComboBox/IComboBox.ItemHeight.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ItemIndex](../../Interface/IComboBox/IComboBox.ItemIndex.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Items](../../Interface/IComboBox/IComboBox.Items.htm)


		 Свойство Items определяет
		 коллекцию строк раскрывающегося списка.


		 ![](../../Property_Image.gif)
		 [MaxLength](../../Interface/IComboBox/IComboBox.MaxLength.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelLength](../../Interface/IComboBox/IComboBox.SelLength.htm)


		 Свойство SelLength
		 определяет длину выделенного текста в компоненте в символах.


		 ![](../../Property_Image.gif)
		 [SelStart](../../Interface/IComboBox/IComboBox.SelStart.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelText](../../Interface/IComboBox/IComboBox.SelText.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Sorted](../../Interface/IComboBox/IComboBox.Sorted.htm)


		 Свойство Sorted определяет,
		 будут ли строки в раскрывающемся списке автоматически сортироваться
		 в алфавитном порядке.


		 ![](../../Property_Image.gif)
		 [Style](../../Interface/IComboBox/IComboBox.Style.htm)


		 Свойство Style определяет
		 стиль работы компонента.
...
## Методы, унаследованные от [IComboBox](../../Interface/IComboBox/IComboBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ClearEdit](../../Interface/IComboBox/IComboBox.ClearEdit.htm)
		 Метод ClearEdit осуществляет
		 очистку поля редактирования компонента.


		 ![](../../Sub_Image.gif)
		 [SelectAll](../../Interface/IComboBox/IComboBox.SelectAll.htm)
		 Метод SelectAll осуществляет
		 выделение всего текста в строке редактирования компонента.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ComboBox.OnChange.htm)
		 Событие OnChange наступает
		 при изменении текста в окне редактора компонента.


		 ![](../../Event_Image.gif)
		 [OnDropDown](ComboBox.OnDropDown.htm)
		 Событие OnDropDown
		 наступает при раскрытии комбинированного списка.


		 ![](../../Event_Image.gif)
		 [OnItemSelect](ComboBox.OnItemSelect.htm)
		 Событие OnItemSelect
		 наступает во время выбора элемента из списка.
