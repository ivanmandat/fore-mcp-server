...
Класс StatusBar реализует компонент
 среды разработки [StatusBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/StatusBar.htm),
 используемый для создания панелей состояния.


## Свойства, унаследованные от [IStatusBar](../../Interface/IStatusBar/IStatusBar.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Images](../../Interface/IStatusBar/IStatusBar.Images.htm)
		 ...
		 изображения которого будут отображаться в панелях компонента [StatusBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/StatusBar.htm).


		 ![](../../Property_Image.gif)
		 [Panes](../../Interface/IStatusBar/IStatusBar.Panes.htm)
		 Свойство Panes возвращает
		 коллекцию панелей компонента [StatusBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/StatusBar.htm).


		 ![](../../Property_Image.gif)
		 [SimplePane](../../Interface/IStatusBar/IStatusBar.SimplePane.htm)
		 Свойство SimplePane
		 определяет возможность создания нескольких панелей.


		 ![](../../Property_Image.gif)
		 [SizeGrip](../../Interface/IStatusBar/IStatusBar.SizeGrip.htm)
		 Свойство SizeGrip определяет,
		 будет ли в компоненте [StatusBar](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/StatusBar.htm)
		 отображаться кнопка изменения размеров окна.
