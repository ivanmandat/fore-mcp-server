...
Класс DBListBox реализует компонент
 среды разработки [DBListBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBListBox.htm),
 используемый для редактирования и отображения данных в виде списка строк
 равной величины.


## Свойства, унаследованные от [IDBListBox](../../Interface/IDBListBox/IDBListBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DataField](../../Interface/IDBListBox/IDBListBox.DataField.htm)
		 Свойство DataField
		 определяет имя поля в источнике данных, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [DataSource](../../Interface/IDBListBox/IDBListBox.DataSource.htm)
		 Свойство DataSource
		 ...
		 с набором данных, который содержит поле [DataField](../../Interface/IDBListBox/IDBListBox.DataField.htm).


		 ![](../../Property_Image.gif)
		 [Field](../../Interface/IDBListBox/IDBListBox.Field.htm)
		 Свойство Field возвращает
		 параметры поля, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [ReadOnly](../../Interface/IDBListBox/IDBListBox.ReadOnly.htm)
