...
Событие наступает во время построения дерева для каждого элемента, отображаемого
 в дереве, кроме папок и всех элементов, которым в событии [MetabaseTreeList.OnIsFolderElem](MetabaseTreeList.OnIsFolderElem.htm)
...
Для выполнения примера предполагается наличие формы и расположенного
 ...
 события OnIsBrowseableElem установлена
 данная процедура.
