...
Событие наступает во время построения дерева для каждой папки, а также
 для элементов, которым в событии [OnIsFolderElem](MetabaseTreeList.OnIsFolderElem.htm)
...
Примечание.
 Событие актуально, если свойству [IMetabaseTreeList.DelayedFill](../../Interface/IMetabaseTreeList/IMetabaseTreeList.DelayedFill.htm)
