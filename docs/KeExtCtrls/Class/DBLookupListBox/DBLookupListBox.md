...
Класс DBLookupListBox реализует
 компонент среды разработки [DBLookupListBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupListBox.htm),
 позволяющий редактировать данные используя значения, сформированные из
 элементов другого набора данных и представленные в виде списка строк.


## Свойства, унаследованные от [IDBLookupListBox](../../Interface/IDBLookupListBox/IDBLookupListBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IDBLookupListBox/IDBLookupListBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента [DBLookupListBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupListBox.htm).


		 ![](../../Property_Image.gif)
		 [RowCount](../../Interface/IDBLookupListBox/IDBLookupListBox.RowCount.htm)
		 Свойство RowCount определяет
		 количество отображаемых строк компонента [DBLookupListBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupListBox.htm).


		 ![](../../Property_Image.gif)
		 [SelectedItem](../../Interface/IDBLookupListBox/IDBLookupListBox.SelectedItem.htm)
		 Свойство SelectedItem
		 возвращает наименование выделенной строки компонента [DBLookupListBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupListBox.htm).
