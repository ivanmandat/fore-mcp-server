...
Класс UiTable реализует компонент
 среды разработки [UiTable](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiTable.htm),
 предоставляющий доступ к таблицам, хранящимся в базе данных.


## Свойства, унаследованные от [IUiTable](../../Interface/IUiTable/IUiTable.htm)
