...
Класс DBEditBox реализует компонент
 среды разработки [DBEditBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBEditBox.htm),
 представляющий собой однострочный редактор данных, связанный с полем источника
 данных.


## Свойства, унаследованные от [IDBEditBox](../../Interface/IDBEditBox/IDBEditBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DataField](../../Interface/IDBEditBox/IDBEditBox.DataField.htm)
		 Свойство DataField
		 определяет имя поля источника данных, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [DataSource](../../Interface/IDBEditBox/IDBEditBox.DataSource.htm)
		 Свойство DataSource
		 указывает источник данных, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [Field](../../Interface/IDBEditBox/IDBEditBox.Field.htm)
