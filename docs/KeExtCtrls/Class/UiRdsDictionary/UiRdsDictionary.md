...
Класс UiRdsDictionary реализует
 компонент среды разработки [UiRdsDictionary](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiRdsDictionary.htm),
 предоставляющий доступа к данным справочников НСИ.


## Свойства, унаследованные от [IUiRdsDictionary](../../Interface/IUiRdsDictionary/IUiRdsDictionary.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FetchAll](../../Interface/IUiRdsDictionary/IUiRdsDictionary.FetchAll.htm)
		 Свойство FetchAll определяет,
		 загружать ли в кеш значения системных и пользовательских атрибутов
		 справочника НСИ вместе.


		 ![](../../Property_Image.gif)
		 [Object](../../Interface/IUiRdsDictionary/IUiRdsDictionary.Object.htm)
