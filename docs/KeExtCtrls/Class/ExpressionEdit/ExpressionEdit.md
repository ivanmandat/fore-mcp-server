...
Класс ExpressionEdit реализует
 компонент среды разработки [ExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ExpressionEdit.htm).
