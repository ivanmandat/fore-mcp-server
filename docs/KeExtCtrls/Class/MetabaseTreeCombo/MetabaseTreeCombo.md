...
Класс MetabaseTreeCombo реализует
 компонент среды разработки [MetabaseTreeCombo](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MetabaseTreeCombo.htm),
 используемый для отображения дерева объектов репозитория в виде раскрывающегося
 списка.


## Свойства, унаследованные от [IMetabaseTreeCombo](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CheckedObjects](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.CheckedObjects.htm)
		 Свойство CheckedObjects
		 возвращает коллекцию описаний объектов, флаги которых отмечены
		 в компоненте.


		 ![](../../Property_Image.gif)
		 [DelayedFill](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.DelayedFill.htm)
		 Свойство DelayedFill
		 определяет режим построения дерева объектов в компоненте.


		 ![](../../Property_Image.gif)
		 [DisplayMode](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.DisplayMode.htm)
		 Свойство DisplayMode
		 определяет режим отображения объектов в дереве компонента.


		 ![](../../Property_Image.gif)
		 [Filters](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.Filters.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Metabase](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.Metabase.htm)
		 Свойство Metabase определяет
		 репозиторий, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [Root](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.Root.htm)
		 Свойство Root определяет
		 корневой каталог, содержимое которого будет отображаться в компоненте.


		 ![](../../Property_Image.gif)
		 [SelectedObjects](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.SelectedObjects.htm)
		 Свойство SelectedObjects
		 возвращает коллекцию описаний объектов, выделенных в компоненте.


		 ![](../../Property_Image.gif)
		 [ShowEmptyFolders](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.ShowEmptyFolders.htm)
		 Свойство ShowEmptyFolders
		 определяет признак отображения пустых папок.


		 ![](../../Property_Image.gif)
		 [ShowInternalObjects](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.ShowInternalObjects.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowShortCuts](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.ShowShortCuts.htm)
		 Свойство ShowShortCuts
		 определяет признак отображения ярлыков в дереве элементов компонента.


## Свойства, унаследованные от [ITreeCombo](ModForms.chm::/Interface/ITreeCombo/ITreeCombo.htm)
		 ...
		 определяет тип анимации, применяемый при разворачивании дерева
		 компонента.
		 ...
		 определяет, будет ли производиться автоматическое обновление данных
		 при их изменении.
...
## Методы, унаследованные от [IMetabaseTreeCombo](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [FindByDescriptor](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.FindByDescriptor.htm)
		 Метод FindByDescriptor
		 осуществляет поиск вершины в дереве компонента по описанию объекта
		 репозитория.


		 ![](../../Sub_Image.gif)
		 [FindItemByKey](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.FindItemByKey.htm)
		 Метод FindItemByKey
		 ...
		 ![](../../Sub_Image.gif)
		 [GetItemObject](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.GetItemObject.htm)
		 Метод GetItemObject
		 ...
		 ![](../../Sub_Image.gif)
		 [SelectElem](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.SelectElem.htm)
		 Метод SelectElem осуществляет
		 отметку вершины дерева, соответствующей указанному объекту репозитория.


		 ![](../../Sub_Image.gif)
		 [SelectElemKey](../../Interface/IMetabaseTreeCombo/IMetabaseTreeCombo.SelectElemKey.htm)
		 Метод SelectElemKey
		 осуществляет отметку вершины дерева, соответствующей объекту репозитория
		 с указанным ключом.


## Методы, унаследованные от [ITreeCombo](ModForms.chm::/Interface/ITreeCombo/ITreeCombo.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnCheckToAddElem](MetabaseTreeCombo.OnCheckToAddElem.htm)
		 Событие OnCheckToAddElem
		 наступает при добавлении элементов в дерево.


		 ![](../../Event_Image.gif)
		 [OnGetElementPopup](MetabaseTreeCombo.OnGetElementPopup.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnIsBrowseableElem](MetabaseTreeCombo.OnIsBrowseableElem.htm)
		 Событие OnIsBrowseableElem
		 предназначено для установки признака отображения элемента в дереве.


		 ![](../../Event_Image.gif)
		 [OnIsDynamicElem](MetabaseTreeCombo.OnIsDynamicElem.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnIsEmptyFolder](MetabaseTreeCombo.OnIsEmptyFolder.htm)
		 Событие OnIsEmptyFolder
		 предназначено для установки признака пустой папки.


		 ![](../../Event_Image.gif)
		 [OnIsFolderElem](MetabaseTreeCombo.OnIsFolderElem.htm)
		 Событие OnIsFolderElem
		 предназначено для установки признака папки у элементов, отображаемых
		 в дереве компонента.


## События, унаследованные от [TreeCombo](ModForms.chm::/Class/TreeCombo/TreeCombo.htm)
...
## События, унаследовано от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
