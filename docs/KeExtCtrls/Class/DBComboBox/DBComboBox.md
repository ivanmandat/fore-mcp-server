...
Класс DBComboBox реализует компонент
 среды разработки [DBComboBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBComboBox.htm),
 предназначенный для отображения и редактирования данных в виде комбинированного
 списка.


## Свойства, унаследованные от [IDBComboBox](../../Interface/IDBComboBox/IDBComboBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DataField](../../Interface/IDBComboBox/IDBComboBox.DataField.htm)
		 Свойство DataField
		 определяет имя поля в источнике данных, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [DataSource](../../Interface/IDBComboBox/IDBComboBox.DataSource.htm)
		 Свойство DataSource
		 связывает компонент [DBComboBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBComboBox.htm)
		 с набором данных, который содержит поле [DataField](../../Interface/IDBComboBox/IDBComboBox.DataField.htm).


		 ![](../../Property_Image.gif)
		 [Field](../../Interface/IDBComboBox/IDBComboBox.Field.htm)
		 Свойство Field возвращает
		 параметры поля, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [ReadOnly](../../Interface/IDBComboBox/IDBComboBox.ReadOnly.htm)
		 Свойство ReadOnly определяет,
		 будет ли пользователь иметь возможность изменять значение поля
		 текущей записи.


## Свойства, унаследованные от [IComboBox](ModForms.chm::/Interface/IComboBox/IComboBox.htm)
		 ...
		 комбинированный список компонента находится в развернутом виде.
		 ...
		 будут ли строки в комбинированном списке автоматически сортироваться
		 ...
		 стиль отображения комбинированного списка.
...
## Методы, унаследованные от [IComboBox](ModForms.chm::/Interface/IComboBox/IComboBox.htm)
		 ...
		 очистку поля редактирования комбинированного списка.


		 ![](../../Sub_Image.gif)
		 [SelectAll](ModForms.chm::/Interface/IComboBox/IComboBox.SelectAll.htm)
		 Метод SelectAll осуществляет
		 выделение всего текста в строке редактирования комбинированного
		 списка.
...
## События, унаследованные от [ComboBox](ModForms.chm::/Class/ComboBox/ComboBox.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ModForms.chm::/Classes/ComboBox/ComboBox.OnChange.htm)
		 Событие OnChange наступает
		 при изменении текста в окне редактора компонента.


		 ![](../../Event_Image.gif)
		 [OnDropDown](ModForms.chm::/Classes/ComboBox/ComboBox.OnDropDown.htm)
		 Событие OnDropDown
		 наступает при раскрытии комбинированного списка.


		 ![](../../Event_Image.gif)
		 [OnItemSelect](ModForms.chm::/Classes/ComboBox/ComboBox.OnItemSelect.htm)
