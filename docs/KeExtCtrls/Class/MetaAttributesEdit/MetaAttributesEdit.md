...
Класс MetaAttributesEdit реализует
 компонент среды разработки [MetaAttributesEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MetaAttributesEdit.htm),
 предназначенный для создания выражений на основе рядов базы данных временных
 рядов.


## Свойства, унаследованные от [IMetaAttributesEdit](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.Expression.htm)
		 Свойство Expression
		 определяет выражение, которое связано с компонентом.


		 ![](../../Property_Image.gif)
		 [RevisionsDimension](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.RevisionsDimension.htm)
		 Свойство RevisionsDimension
		 определяет справочник ревизий, из которого осуществляется загрузка
		 данных по атрибуту «Ревизия» в подстановки компонента.
...
## Методы, унаследованные от [IMetaAttributesEdit](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [AddAttribute](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.AddAttribute.htm)
		 Метод AddAttribute
		 осуществляет добавление значений указанного атрибута в подстановки
		 компонента.


		 ![](../../Sub_Image.gif)
		 [ClearAttributes](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.ClearAttributes.htm)
		 Метод ClearAttributes
		 осуществляет удаление значений всех атрибутов из подстановок компонента.


		 ![](../../Sub_Image.gif)
		 [GetAttributeCount](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.GetAttributeCount.htm)
		 Метод GetAttributeCount
		 возвращает количество атрибутов, значения которых добавлены в
		 список подстановок компонента.


		 ![](../../Sub_Image.gif)
		 [RemoveAttribute](../../Interface/IMetaAttributesEdit/IMetaAttributesEdit.RemoveAttribute.htm)
		 Метод RemoveAttribute
		 осуществляет удаление значений указанного атрибута из списка подстановок
		 компонента.
...
## События, унаследовано от [TermEdit](ModForms.chm::/Class/TermEdit/TermEdit.htm)
		 ...
		 Событие OnHyperlink
		 наступает при щелчке по гиперссылке терма.
