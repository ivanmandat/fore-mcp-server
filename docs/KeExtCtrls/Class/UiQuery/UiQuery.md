...
Класс UiQuery реализует компонент
 среды разработки [UiQuery](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiQuery.htm),
 используемый для доступа к данным с использованием SQL-запросов.


## Свойства, унаследованные от [IUiQuery](../../Interface/IUiQuery/IUiQuery.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Database](../../Interface/IUiQuery/IUiQuery.Database.htm)
		 Свойство Database определяет
		 БД репозитория, в которой хранятся источники данных.


		 ![](../../Property_Image.gif)
		 [ParamCheck](../../Interface/IUiQuery/IUiQuery.ParamCheck.htm)
		 Свойство ParamCheck
		 определяет, будет ли заново генерироваться список параметров запроса,
		 если свойства [SQL](../../Interface/IUiQuery/IUiQuery.SQL.htm)
		 и [Database](../../Interface/IUiQuery/IUiQuery.Database.htm)
		 изменились в процессе выполнения программы.


		 ![](../../Property_Image.gif)
		 [Params](../../Interface/IUiQuery/IUiQuery.Params.htm)
		 Свойство Params определяет
		 коллекцию параметров запроса.


		 ![](../../Property_Image.gif)
		 [SQL](../../Interface/IUiQuery/IUiQuery.SQL.htm)
		 Свойство SQL определяет
		 текст SQL-запроса к базе данных.
