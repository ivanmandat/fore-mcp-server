...
Класс CalcCubeFormulaEdit реализует
 компонент среды разработки [CalcCubeFormulaEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/CalcCubeFormulaEdit.htm),
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnFormatCoord](CalcCubeFormulaEdit.OnFormatCoord.htm)
