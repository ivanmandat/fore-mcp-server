...
Класс MetabaseObjectParamsBox
 реализует компонент среды разработки - [MetabaseObjectParamsBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MetabaseObjectParamsBox.htm).


## Свойства объекта класса, унаследованные от [IMetabaseObjectParamsBox](../../Interface/IMetabaseObjectParamsBox/IMetabaseObjectParamsBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Object](../../Interface/IMetabaseObjectParamsBox/IMetabaseObjectParamsBox.Object.htm)
		 Свойство Object определяет
		 объект репозитория, работа с параметрами которого осуществляется
		 в компоненте.
