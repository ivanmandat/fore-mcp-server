...
Класс UiMetabaseDataset реализует
 компонент среды разработки [UiMetabaseDataset](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiMetabaseDataset.htm),
 предоставляющий доступ к реляционным источникам данных репозитория.


## Свойства, унаследованные от [IUiMetabaseDataset](../../Interface/IUiMetabaseDataset/IUiMetabaseDataset.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Dataset](../../Interface/IUiMetabaseDataset/IUiMetabaseDataset.Dataset.htm)
