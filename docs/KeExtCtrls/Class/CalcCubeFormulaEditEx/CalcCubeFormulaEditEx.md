...
Класс CalcCubeFormulaEditEx
 реализует компонент среды разработки [CalcCubeFormulaEditEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/CalcCubeFormulaEditEx.htm),
 используемый для составления и редактирования формул вычисляемого куба
 и имеющий изменения в реализации.


## Свойства объекта класса, унаследованные от [ICalcCubeFormulaEdit](../../Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Cube](../../Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.Cube.htm)
		 Свойство Cube определяет
		 куб, который является источником данных.


## Свойства объекта класса, унаследованные от [IExpressionEdit](../../Interface/IExpressionEdit/IExpressionEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](../../Interface/IExpressionEdit/IExpressionEdit.Expression.htm)
		 Свойство Expression
		 определяет выражение, расположенное в компоненте.


## Свойства объекта класса, унаследованные от [ITermEdit](ModForms.chm::/Interface/ITermEdit/ITermEdit.htm)
...
## Свойства объекта класса, унаследованные от [ICustomEdit](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.htm)
		 ...
		 позицию, начиная с которой, осуществляется выделение текста в
		 компоненте.
...
## Методы объекта класса, унаследованные от [ICalcCubeFormulaEdit](../../Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [PutCoord](../../Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.PutCoord.htm)
		 Метод PutCoord позволяет
		 поместить в редактор терм, соответствующий указанной координате
		 куба.


## Методы объекта класса, унаследованные от [IExpressionEdit](../../Interface/IExpressionEdit/IExpressionEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [UpdateExpression](../../Interface/IExpressionEdit/IExpressionEdit.UpdateExpression.htm)
		 Метод UpdateExpression
		 обновляет выражение.


## Методы объекта класса, унаследованные от [ITermEdit](ModForms.chm::/Interface/ITermEdit/ITermEdit.htm)
...
## Методы объекта класса, унаследованные от [ICustomEdit](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.htm)
...
## События, унаследованные от [CalcCubeFormulaEdit](../CalcCubeFormulaEdit/CalcCubeFormulaEdit.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnFormatCoord](../CalcCubeFormulaEdit/CalcCubeFormulaEdit.OnFormatCoord.htm)
		 Событие OnFormatCoord
		 возникает при создании терма, соответствующего координате куба.


## События, унаследованные от [TermEdit](ModForms.chm::/Classes/TermEdit/TermEdit.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnHyperlink](ModForms.chm::/Classes/TermEdit/TermEdit.OnHyperlink.htm)
		 Событие OnHyperlink
		 наступает при щелчке по термовой гиперссылке.


		 ![](../../Event_Image.gif)
		 [OnParseTerm](ModForms.chm::/Classes/TermEdit/TermEdit.OnParseTerm.htm)
		 Событие OnParseTerm
		 возникает во время преобразования текста редактора в термы (выражения)
		 и знаки операции.


## События, унаследованные от [ICustomEdit](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.htm)
