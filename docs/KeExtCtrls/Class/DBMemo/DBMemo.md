...
Класс DBMemo реализует компонент
 среды разработки [DBMemo](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBMemo.htm),
 позволяющий отображать и редактировать данные в многострочном текстовом
 редакторе.


## Свойства, унаследованные от [IDBMemo](../../Interface/IDBMemo/IDBMemo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DataField](../../Interface/IDBMemo/IDBMemo.DataField.htm)
		 Свойство DataField
		 определяет имя поля источника данных, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [DataSource](../../Interface/IDBMemo/IDBMemo.DataSource.htm)
		 Свойство DataSource
		 указывает источник данных, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [Field](../../Interface/IDBMemo/IDBMemo.Field.htm)
		 Свойство Field возвращает
		 параметры поля, с которым связан компонент.


## Свойства, унаследованные от [IMemo](ModForms.chm::/Interface/IMemo/IMemo.htm)
		 ...
		 Свойство ScrollBars
		 определяет наличие полос прокрутки текста в поле компонента Memo.
		 ...
		 возможность вставки в редактируемый текст символа возврата каретки.
...
## Методы, унаследованные от [IMemo](ModForms.chm::/Interface/IMemo/IMemo.htm)
