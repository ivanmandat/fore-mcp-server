...
Класс GlobalImageList реализует
 компонент среды разработки [GlobalImageList](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/GlobalImageList.htm),
 позволяющий загружать и хранить коллекцию пиктограмм в документах репозитория.


## Свойства, унаследованные от [IGlobalImageList](../../Interface/IGlobalImageList/IGlobalImageList.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Document](../../Interface/IGlobalImageList/IGlobalImageList.Document.htm)
		 Свойство Document определяет
		 документ репозитория, являющийся источником изображения для компонента.


## Свойства, унаследованные от [IImageList](ModForms.chm::/Interface/IImageList/IImageList.htm)
		 ...
		 графическое изображение указанной пиктограммы.
...
## Методы, унаследованные от [IImageList](ModForms.chm::/Interface/IImageList/IImageList.htm)
