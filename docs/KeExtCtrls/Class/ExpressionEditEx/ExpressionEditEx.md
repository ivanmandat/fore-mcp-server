...
Класс ExpressionEditEx реализует
 компонент среды разработки [ExpressionEditEx](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ExpressionEditEx.htm).


## Свойства, унаследованные от [IExpressionEdit](../../Interface/IExpressionEdit/IExpressionEdit.htm)
...
## Методы, унаследованные от [IExpressionEdit](../../Interface/IExpressionEdit/IExpressionEdit.htm)
