...
Класс DBLookupComboBox реализует
 компонент среды разработки [DBLookupComboBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupComboBox.htm),
 позволяющий редактировать данные используя значения, сформированные из
 элементов другого набора данных и представленные в виде комбинированного
 списка.


## Свойства, унаследованные от [IDBLookupComboBox](../../Interface/IDBLookupComboBox/IDBLookupComboBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DropDownRows](../../Interface/IDBLookupComboBox/IDBLookupComboBox.DropDownRows.htm)
		 Свойство DropDownRows
		 определяет количество отображаемых элементов комбинированного
		 списка.


		 ![](../../Property_Image.gif)
		 [ListVisible](../../Interface/IDBLookupComboBox/IDBLookupComboBox.ListVisible.htm)
		 Свойство ListVisible
		 возвращает значение видимости элементов комбинированного списка.


## Свойства, унаследованные от [IDBLookupControl](../../Interface/IDBLookupControl/IDBLookupControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DataField](../../Interface/IDBLookupControl/IDBLookupControl.DataField.htm)
		 Свойство DataField
		 определяет поле источника данных, которое будет отображаться данным
		 компонентом.


		 ![](../../Property_Image.gif)
		 [DataSource](../../Interface/IDBLookupControl/IDBLookupControl.DataSource.htm)
		 Свойство DataSource
		 связывает компонент группы «Доступ к данным» с набором данных,
		 который содержит поле [DataField](../../Interface/IDBLookupControl/IDBLookupControl.DataField.htm).


		 ![](../../Property_Image.gif)
		 [Field](../../Interface/IDBLookupControl/IDBLookupControl.Field.htm)
		 Свойство Field возвращает
		 параметры поля, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [KeyField](../../Interface/IDBLookupControl/IDBLookupControl.KeyField.htm)
		 Свойство KeyField определяет
		 поле из набора данных [ListSource](../../Interface/IDBLookupControl/IDBLookupControl.ListSource.htm),
		 значение которого должно соответствовать значению поля [DataField](../../Interface/IDBLookupControl/IDBLookupControl.DataField.htm).


		 ![](../../Property_Image.gif)
		 [KeyValue](../../Interface/IDBLookupControl/IDBLookupControl.KeyValue.htm)
		 Свойство KeyValue определяет
		 значение ключевого поля в активной строке источника данных.


		 ![](../../Property_Image.gif)
		 [ListField](../../Interface/IDBLookupControl/IDBLookupControl.ListField.htm)
		 Свойство ListField
		 ...
		 ![](../../Property_Image.gif)
		 [ListSource](../../Interface/IDBLookupControl/IDBLookupControl.ListSource.htm)
		 Свойство ListSource
		 определяет источник данных для компонента поиска, то есть источник,
		 содержащий поля [KeyField](../../Interface/IDBLookupControl/IDBLookupControl.KeyField.htm)
		 и [ListField](../../Interface/IDBLookupControl/IDBLookupControl.ListField.htm).


		 ![](../../Property_Image.gif)
		 [ReadOnly](../../Interface/IDBLookupControl/IDBLookupControl.ReadOnly.htm)
		 Свойство ReadOnly определяет
		 возможность редактирования данных компонента.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnCloseUp](DBLookupComboBox.OnCloseUp.htm)
		 Событие OnCloseUp наступает
		 при сворачивании списка компонента [DBLookupComboBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupComboBox.htm).


		 ![](../../Event_Image.gif)
		 [OnDropDown](DBLookupComboBox.OnDropDown.htm)
		 Событие OnDropDown
		 наступает при разворачивании списка компонента [DBLookupComboBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupComboBox.htm).
