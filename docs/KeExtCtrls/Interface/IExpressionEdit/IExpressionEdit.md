...
Интерфейс IExpressionEdit содержит
 свойства и методы компонентов среды разработки [ExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/ExpressionEdit.htm)
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](IExpressionEdit.Expression.htm)
		 Свойство Expression
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [UpdateExpression](IExpressionEdit.UpdateExpression.htm)
