...
Интерфейс IDBLookupListBox содержит
 свойства и методы компонента среды разработки - [DBLookupListBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DBLookupListBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IDBLookupListBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RowCount](IDBLookupListBox.RowCount.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelectedItem](IDBLookupListBox.SelectedItem.htm)
...
## Свойства, унаследованные от [IDBLookupControl](../IDBLookupControl/IDBLookupControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DataField](../IDBLookupControl/IDBLookupControl.DataField.htm)
		 Свойство DataField
		 ...
		 ![](../../Property_Image.gif)
		 [DataSource](../IDBLookupControl/IDBLookupControl.DataSource.htm)
		 Свойство DataSource
		 связывает компонент группы «Доступ к данным» с набором данных,
		 который содержит поле [DataField](../IDBLookupControl/IDBLookupControl.DataField.htm).


		 ![](../../Property_Image.gif)
		 [Field](../IDBLookupControl/IDBLookupControl.Field.htm)
		 Свойство Field возвращает
		 параметры поля, с которым связан компонент.


		 ![](../../Property_Image.gif)
		 [KeyField](../IDBLookupControl/IDBLookupControl.KeyField.htm)
		 Свойство KeyField определяет
		 поле из набора данных [ListSource](../IDBLookupControl/IDBLookupControl.ListSource.htm),
		 значение которого должно соответствовать значению поля [DataField](../IDBLookupControl/IDBLookupControl.DataField.htm).


		 ![](../../Property_Image.gif)
		 [KeyValue](../IDBLookupControl/IDBLookupControl.KeyValue.htm)
		 Свойство KeyValue определяет
		 значение ключевого поля в активной строке источника данных.


		 ![](../../Property_Image.gif)
		 [ListField](../IDBLookupControl/IDBLookupControl.ListField.htm)
		 Свойство ListField
		 ...
		 ![](../../Property_Image.gif)
		 [ListSource](../IDBLookupControl/IDBLookupControl.ListSource.htm)
		 Свойство ListSource
		 определяет источник данных для компонента поиска, то есть источник,
		 содержащий поля [KeyField](../IDBLookupControl/IDBLookupControl.KeyField.htm)
		 и [ListField](../IDBLookupControl/IDBLookupControl.ListField.htm).


		 ![](../../Property_Image.gif)
		 [ReadOnly](../IDBLookupControl/IDBLookupControl.ReadOnly.htm)
