# IDataGridBeforeCellChangeEventArgs
...
Интерфейс IDataGridBeforeCellChangeEventArgs
 содержит свойства аргумента события, наступающего перед присвоением ячейке
 нового значения.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Value](IDataGridBeforeCellChangeEventArgs.Value.htm)
		 Свойство Value определяет
		 значение, которое будет присвоено ячейке.
