...
FindById(Id: String): [IMetaAttributeSetting](../IMetaAttributeSetting/IMetaAttributeSetting.htm);
...
Метод FindById осуществляет
 поиск параметров атрибута по идентификатору.
...
[IMetaAttributeSettings](IMetaAttributeSettings.htm)
