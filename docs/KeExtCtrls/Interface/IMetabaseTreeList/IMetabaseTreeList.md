...
Интерфейс IMetabaseTreeList
 содержит свойства и методы компонента среды разработки - [MetabaseTreeList](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MetabaseTreeList.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CheckedObjects](IMetabaseTreeList.CheckedObjects.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowShortCuts](IMetabaseTreeList.ShowShortCuts.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [FindByDescriptor](IMetabaseTreeList.FindByDescriptor.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [FindItemByKey](IMetabaseTreeList.FindItemByKey.htm)
		 Метод FindItemByKey
		 ...
		 ![](../../Sub_Image.gif)
		 [GetItemObject](IMetabaseTreeList.GetItemObject.htm)
		 Метод GetItemObject
