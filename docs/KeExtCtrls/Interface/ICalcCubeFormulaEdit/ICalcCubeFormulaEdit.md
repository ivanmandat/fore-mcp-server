...
Интерфейс ICalcCubeFormulaEdit
 содержит свойства и методы компонента среды разработки [CalcCubeFormulaEdit](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/CalcCubeFormulaEdit.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Cube](ICalcCubeFormulaEdit.Cube.htm)
		 Свойство Cube определяет
		 куб, который является источником данных.


## Свойства, унаследованные от [IExpressionEdit](../IExpressionEdit/IExpressionEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](../IExpressionEdit/IExpressionEdit.Expression.htm)
		 Свойство Expression
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [PutCoord](ICalcCubeFormulaEdit.PutCoord.htm)
		 Метод PutCoord позволяет
		 поместить в редактор терм, соответствующий указанной координате
		 куба.


## Методы, унаследованные от [IExpressionEdit](../IExpressionEdit/IExpressionEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [UpdateExpression](../IExpressionEdit/IExpressionEdit.UpdateExpression.htm)
