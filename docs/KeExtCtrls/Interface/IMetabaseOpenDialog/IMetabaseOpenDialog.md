...
Интерфейс IMetabaseOpenDialog
 содержит свойства и методы компонента среды разработки - [MetabaseOpenDialog](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/MetabaseOpenDialog.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [MultiSelect](IMetabaseOpenDialog.MultiSelect.htm)
		 Свойство MultiSelect
		 определяет признак выбора в диалоге нескольких объектов.


## Свойства, унаследованные от [IMetabaseDialog](../IMetabaseDialog/IMetabaseDialog.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FilterIndex](../IMetabaseDialog/IMetabaseDialog.FilterIndex.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Filters](../IMetabaseDialog/IMetabaseDialog.Filters.htm)
		 Свойство Filters возвращает
		 коллекцию фильтров, используемых в диалоге.


		 ![](../../Property_Image.gif)
		 [FolderFilters](../IMetabaseDialog/IMetabaseDialog.FolderFilters.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [InitialFolder](../IMetabaseDialog/IMetabaseDialog.InitialFolder.htm)
		 Свойство InitialFolder
		 определяет исходный каталог.


		 ![](../../Property_Image.gif)
		 [Object](../IMetabaseDialog/IMetabaseDialog.Object.htm)
		 Свойство Object возвращает
		 описание выбранного объекта репозитория.


		 ![](../../Property_Image.gif)
		 [Objects](../IMetabaseDialog/IMetabaseDialog.Objects.htm)
		 Свойство Objects возвращает
		 коллекцию выбранных объектов репозитория.


		 ![](../../Property_Image.gif)
		 [Root](../IMetabaseDialog/IMetabaseDialog.Root.htm)
		 Свойство Root определяет
		 корневой каталог для диалога.


		 ![](../../Property_Image.gif)
		 [Title](../IMetabaseDialog/IMetabaseDialog.Title.htm)
...
## Методы, унаследованные от [IMetabaseDialog](../IMetabaseDialog/IMetabaseDialog.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Execute](../IMetabaseDialog/IMetabaseDialog.Execute.htm)
