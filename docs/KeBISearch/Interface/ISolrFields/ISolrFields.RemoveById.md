...
Метод RemoveById удаляет поле
 из коллекции по идентификатору и возвращает признак удачного удаления.
...
Метод RemoveById используется
 если из конфигурационного файла были удалены какие-либо пользовательские
 поля, но они еще не были удалены из настроек поискового сервиса.
