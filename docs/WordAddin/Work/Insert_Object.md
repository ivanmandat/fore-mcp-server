# Добавление объекта или отчёта из репозитория: Foresight Add-in for Word
...
# Добавление объекта или отчёта из репозитория
	...
	Примечание.
	 Вставка карты доступна, если в отчете присутствуют другие объекты.
			...
			- [Выражение](Insert_Object.htm#expression).
	...
	Закончив добавлять отчёт или объекты в документ, перейдите к шагу:
		...
		- [Работа с объектом или отчётом
		 из репозитория](ObjectsWork.htm);
	...
	Окно содержит две области:
		...
		- Область
		 ...
		 и разделена на категории:
			...
			- Фиксированные.
			 Измерения, элементы которого зафиксированы и не отображаются
			 в таблице;
	...
	Настройка измерения включает:
		...
		- Тип измерения. Указан
		 пиктограммой:
			...
			- ![](Table/Dim_Calend.png). Календарное измерение;


			- ![](Table/Dim_Dict.png). Измерение, основанное на справочнике;


			- ![](Table/Dim_MDMTableDictionary.png). Измерение, основанное на справочнике
			 НСИ;


		- Параметры измерения.
		 Для настройки параметров измерения нажмите кнопку ![](Table/Dim_Params.png). Будет открыт диалог
...
### Особенности вставки таблицы
	...
	Если на панели «Объекты отчета»
	 выделена диаграмма, то при нажатии на кнопку ![](Table/b_table.png)
...
### Особенности вставки диаграммы
	...
	Если на панели «Объекты отчета»
	 выделена таблица, то при нажатии на кнопку ![](Table/b_chart.png) «Диаграмма» вставляется диаграмма
...
## Вставка карты
	...
	Для вставки карты нажмите кнопку ![](Map/b_Map.png)«Карта», расположенную в группе «Вставка»
...
## Удаление объекта
	...
	Для удаления объекта:
		...
		- выделите элемент, соответствующий объекту, на панели «[Объекты отчета](ObjectsWork.htm)»
		 и выполните команду «Удалить»
