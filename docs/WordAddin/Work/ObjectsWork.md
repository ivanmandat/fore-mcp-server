# Работа с объектом или отчётом из репозитория: Foresight Add-in for Word
...
## Общие операции
	...
	При работе с объектами и отчётами из репозитория доступны операции:
		...
		- Настройка связи с источником
		 ...
		 данных нажмите кнопку ![](b_Unbind.png) «Отвязать от источника», расположенную
		 в группе «Отчёт» на вкладке
		...
		- Экспорт. Для экспорта
		 отчета нажмите кнопку ![](b_Export.png)
		 «Экспорт», расположенную в группе «Отчет»
...
## Работа с объектами
	...
	При добавлении в документ объектов отчёта работа с ними ведётся
	...
	[![](../Opened.gif)![](../Closed.gif)Для отображения
	 панели](javascript:TextPopup(this))
		...
		Для отображения/скрытия панели используйте кнопку ![](../Interface/b_ReportObjects.png)
		 «Объекты отчета», расположенную в группе «Вид» на
 вкладке «FORESIGHT»
 ленты инструментов.
	...
	Для таблиц и [выражений](ObjectsWork.htm#expression)
	 доступна настройка формата отображаемых значений. Для настройки формата
	 используйте кнопки, расположенные в группе «Формат
	 числа» на вкладке «FORESIGHT» ленты инструментов.


	При работе с объектами доступны стандартные операции Microsoft Word:
	...
	Закончив работать с объектами отчёта перейдите в шагу:
...
### Работа с таблицей
	...
	[![](../Opened.gif)![](../Closed.gif)Настройка
	 параметров таблицы](javascript:TextPopup(this))
		...
		Будет отображен диалог «Вставка».
...
### Работа с выражением
	...
	Выражение - элемент отчета,
	 ...
	 пользователем. Пример выражения в тексте отчета:
	...
	[![](../Opened.gif)![](../Closed.gif)Редактирование
	 выражения](javascript:TextPopup(this))
		...
		В зависимости от типа выражения будет отображен диалог «[Вставка
		 значений из](Insert_Object.htm#expression_insert)» или «[Значение](Insert_Object.htm#expression_insertvalue)».
