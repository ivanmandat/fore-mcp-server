...
Интерфейс IMetabaseUpdateDeleteObjectNode
 содержит свойства, определяющие параметры объекта обновления - [Удаление
 объекта](UpdManager.chm::/CreateUpdate/Admin_CreateUpdate_AddDel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BoundType](IMetabaseUpdateDeleteObjectNode.BoundType.htm)
		 Свойство BoundType
		 определяет тип обновления.


		 ![](../../Property_Image.gif)
		 [Object](IMetabaseUpdateDeleteObjectNode.Object.htm)
		 Свойство Object определяет
		 дескриптор объекта, который необходимо удалить при применении
		 обновления.


		 ![](../../Property_Image.gif)
		 [ObjectClass](IMetabaseUpdateDeleteObjectNode.ObjectClass.htm)
		 Свойство ObjectClass
		 определяет класс удаляемых объектов.


		 ![](../../Property_Image.gif)
		 [ObjectId](IMetabaseUpdateDeleteObjectNode.ObjectId.htm)
		 Свойство ObjectId определяет
		 идентификатор удаляемого при обновлении объекта.


		 ![](../../Property_Image.gif)
		 [ObjectKey](IMetabaseUpdateDeleteObjectNode.ObjectKey.htm)
		 Свойство ObjectKey
		 определяет ключ удаляемого при обновлении объекта.
