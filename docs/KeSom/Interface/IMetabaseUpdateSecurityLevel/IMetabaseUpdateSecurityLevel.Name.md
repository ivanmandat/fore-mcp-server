# IMetabaseUpdateSecurityLevel.Name
...
Свойство Name возвращает наименование уровня безопасности.
...
[IMetabaseUpdateSecurityLevel](IMetabaseUpdateSecurityLevel.htm)
