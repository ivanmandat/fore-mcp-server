...
FlushInstanceById(Id: String; Values: [IMetabaseObjectParamValues](../IMetabaseObjectParamValues/IMetabaseObjectParamValues.htm)):
 Boolean;
...
Метод FlushInstanceById очищает
 кеш объекта репозитория по его идентификатору и заданным значениям параметров.
