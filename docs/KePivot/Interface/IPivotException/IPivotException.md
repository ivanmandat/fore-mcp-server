...
Интерфейс IPivotException содержит
 свойства и методы для получения информации об ошибке, которая произошла
 в таблице.
...
Последнюю произошедшую ошибку можно получить в свойстве [IPivot.LastException](../IPivot/IPivot.LastException.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ExceptionType](IPivotException.ExceptionType.htm)
		 Свойство ExceptionType
		 возвращает тип возникшей ошибки.
