...
Интерфейс IPivotDimensionLevelProperties
 используется для работы со свойствами уровня измерения.
...
Интерфейс является промежуточным между:


	- [IPivotDimension](../IPivotDimension/IPivotDimension.htm)
	 и [IPivotDimensionLevelPropertiesCommon](../IPivotDimensionLevelPropertiesCommon/IPivotDimensionLevelPropertiesCommon.htm);


	- [IPivotDimensionLevel](../IPivotDimensionLevel/IPivotDimensionLevel.htm)
	 и [IPivotDimensionLevelPropertiesCommon](../IPivotDimensionLevelPropertiesCommon/IPivotDimensionLevelPropertiesCommon.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Namings](IPivotDimensionLevelProperties.Namings.htm)
		 Свойство Namings возвращает
		 коллекцию наименований элементов.


		 ![](../../Property_Image.gif)
		 [Numbering](IPivotDimensionLevelProperties.Numbering.htm)
		 Свойство Numbering
