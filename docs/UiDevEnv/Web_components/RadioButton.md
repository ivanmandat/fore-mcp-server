# RadioButton: Компонент веб-форм
...
## Иерархия наследования
 ...
           [IWebRadioButton](WebForms.chm::/Interface/IWebRadioButton/IWebRadioButton.htm)


           [WebRadioButton](WebForms.chm::/Class/WebRadioButton/WebRadioButton.htm)


## Описание


Компонент RadioButton реализует
 переключатели, которые используется для выбора единственного варианта
...
Компонент имеет различный набор свойств, доступных в режиме дизайнера
 и режиме выполнения веб-формы.
	 ...
	 События
			...
			- [Checked](WebForms.chm::/Interface/IWebRadioButton/IWebRadioButton.Checked.htm).
		...
		Компонент имеет событие onChange,
		 в котором может отслеживаться состояние переключателя. При установке
		 у какого-либо переключателя свойству checked
		 значения True, у остальных
		 переключателей свойству будет автоматически установлено значение
		 False.
