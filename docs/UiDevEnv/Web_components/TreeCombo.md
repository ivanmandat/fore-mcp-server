...
## Иерархия наследования
 ...
           [IWebTreeCombo](WebForms.chm::/Interface/IWebTreeCombo/IWebTreeCombo.htm)


           [WebTreeCombo](WebForms.chm::/Class/WebTreeCombo/WebTreeCombo.htm)


## Описание


Компонент TreeCombo реализует
 комбинированный список, отображающий древовидную структуру элементов.
