...
## Иерархия наследования
 ...
           [IWebCheckBox](WebForms.chm::/Interface/IWebCheckBox/IWebCheckBox.htm)


           [WebCheckBox](WebForms.chm::/Class/WebCheckBox/WebCheckBox.htm)


## Описание


Компонент CheckBox реализует
 флажок, который позволяет включать или выключать какие-либо опции или
 используется для индикации состояния различных настроек.
...
Компонент имеет различный набор свойств, доступных в режиме дизайнера
 и режиме выполнения веб-формы.
	 ...
	 События
			...
			- allowIndeterminate.
			 Признак возможности установить промежуточное состояние флажка;
			...
			- state. Состояние
			 флажка с учётом наличия промежуточного состояния;
			...
			- [Checked](WebForms.chm::/Interface/IWebCheckBox/IWebCheckBox.Checked.htm).
			 Признак выбора флажка;
			...
			- [State](WebForms.chm::/Interface/IWebCheckBox/IWebCheckBox.State.htm).
		...
		Компонент имеет событие onChange,
		 в котором может отслеживаться состояние флажка.
