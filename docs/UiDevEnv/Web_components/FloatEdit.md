...
## Иерархия наследования
 ...
           [IWebFloatEdit](WebForms.chm::/Interface/IWebFloatEdit/IWebFloatEdit.htm)


           [WebFloatEdit](WebForms.chm::/Class/WebFloatEdit/WebFloatEdit.htm)


## Описание


Компонент FloatEdit предназначен
 для ввода вещественных значений в заданном диапазоне.
...
Компонент имеет различный набор свойств, доступных в режиме дизайнера
 и режиме выполнения веб-формы.
	 ...
	 События
			...
			- precision. Количество
			 разрядов, отображаемых после запятой. По умолчанию установлена
			 точность 2 знака после запятой. Максимальная точность - 12
			...
			- showPrecisionZeros.
			 Признак отображения незначащих нулей после запятой. По умолчанию
			 установлено значение True,
			 при этом незначащие нули отображаются. При значении False незначащие нули будут
			 скрываться;
			...
			- [MaxValue](WebForms.chm::/Interface/IWebFloatEdit/IWebFloatEdit.MaxValue.htm).
			 Максимальное значение числа, которое можно установить в компоненте;


			- [MinValue](WebForms.chm::/Interface/IWebFloatEdit/IWebFloatEdit.MinValue.htm).
			...
			- [Valid](WebForms.chm::/Interface/IWebFloatEdit/IWebFloatEdit.Valid.htm).
			 Признак корректности указанного в компоненте значения;


			- [Value](WebForms.chm::/Interface/IWebFloatEdit/IWebFloatEdit.Value.htm).
