# DimensionTree: Компонент веб-форм
...
## Иерархия наследования
 ...
           [IWebDimensionTree](WebForms.chm::/Interface/IWebDimensionTree/IWebDimensionTree.htm)


           [WebDimensionTree](WebForms.chm::/Class/WebDimensionTree/WebDimensionTree.htm)


## Описание


Компонент DimensionTree реализует
 список элементов справочника репозитория.
...
Компонент имеет различный набор свойств, доступных в режиме дизайнера
 и режиме выполнения веб-формы.
	 ...
	 События
			...
			- [DimInstance](WebForms.chm::/Interface/IWebDimensionTree/IWebDimensionTree.DimInstance.htm).
			...
			- [Selection](WebForms.chm::/Interface/IWebDimensionTree/IWebDimensionTree.Selection.htm).
