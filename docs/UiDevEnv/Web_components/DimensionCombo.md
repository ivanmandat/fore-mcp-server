# DimensionCombo: Компонент веб-форм
...
## Иерархия наследования
 ...
           [IWebDimensionCombo](WebForms.chm::/Interface/IWebDimensionCombo/IWebDimensionCombo.htm)


           [WebDimensionCombo](WebForms.chm::/Class/WebDimensionCombo/WebDimensionCombo.htm)


## Описание


Компонент DimensionCombo реализует
 раскрывающийся список элементов справочника репозитория.
...
Компонент имеет различный набор свойств, доступных в режиме дизайнера
 и режиме выполнения веб-формы.
	 ...
	 События
			...
			- displayAttribute.
			 Атрибут справочника, значения которого будут отображаться
			 в качестве наименований элементов;
			...
			- mobj. Составное
			 свойство, в котором задаётся ключ справочника, отображаемого
			 в компоненте;
			...
			- searchEnable.
			 Признак отображения в компоненте строки поиска элементов;


			- selectionMode.
			 Режим отметки в компоненте;
			...
			- [DimInstance](WebForms.chm::/Interface/IWebDimensionCombo/IWebDimensionCombo.DimInstance.htm).
			...
			- [Selection](WebForms.chm::/Interface/IWebDimensionCombo/IWebDimensionCombo.Selection.htm).
			 Отметка элементов справочника в компоненте;
		...
		Компонент имеет событие onSelectionChange,
		 в котором может отслеживаться изменение отметки элементов.
