...
## Иерархия наследования
 ...
           [IComboBox](ModForms.chm::/Interface/IComboBox/IComboBox.htm)


           [ComboBox](ModForms.chm::/Class/ComboBox/ComboBox.htm)


## Описание


Компонент ComboBox представляет собой комбинированный список, объединяющий функции компонентов [ListBox](ListBox.htm) и [EditBox](EditBox.htm).
...
Отличие компонента ComboBox от схожего по функциям компонента [ListBox](ListBox.htm) заключается в следующем:
...
-
ComboBox может быть как развернутым, так и свернутым ([ListBox](ListBox.htm) всегда развернут);
...
Основное свойство компонента - [Items](ModForms.chm::/Interface/IComboBox/IComboBox.Items.htm). Заполнить данный список можно во время разработки (проектирования) формы, для этого следует нажать кнопку с многоточием около свойства в окне «Инспектор объектов» либо в контекстном меню компонента выбрать пункт «Элементы».


Основное событие компонента [OnChange](ModForms.chm::/Class/ComboBox/ComboBox.OnChange.htm) наступает при изменении текста в окне редактирования в результате прямого редактирования или в результате выбора из списка.


Стиль отображения компонента определяется свойством [Style](ModForms.chm::/Interface/IComboBox/IComboBox.Style.htm).


Выбор пользователя или введенный им текст можно определить по значению свойства [Text](ModForms.chm::/Interface/IControl/IControl.Text.htm).


Индекс выбранного пользователем элемента можно определить по значению свойства [ItemIndex](ModForms.chm::/Interface/IComboBox/IComboBox.ItemIndex.htm).
...
## Свойства компонента ComboBox
 ...
 ![](../../Property_Image.gif)
 [DropDownCount](ModForms.chm::/Interface/IComboBox/IComboBox.DropDownCount.htm)
 Свойство DropDownCount определяет максимальное число элементов, одновременно отображаемых в раскрывающемся списке.


 ![](../../Property_Image.gif)
 [DroppedDown](ModForms.chm::/Interface/IComboBox/IComboBox.DroppedDown.htm)
 Свойство DroppedDown возвращает True, если раскрывающийся список компонента находится в развернутом виде.
 ...
 Свойство ItemCount возвращает количество строк раскрывающегося списка.


 ![](../../Property_Image.gif)
 [ItemHeight](ModForms.chm::/Interface/IComboBox/IComboBox.ItemHeight.htm)
 Свойство ItemHeight возвращает высоту элементов (строк) раскрывающегося списка.


 ![](../../Property_Image.gif)
 [ItemIndex](ModForms.chm::/Interface/IComboBox/IComboBox.ItemIndex.htm)
 Свойство ItemIndex определяет индекс выбранного элемента списка.


 ![](../../Property_Image.gif)
 [Items](ModForms.chm::/Interface/IComboBox/IComboBox.Items.htm)
 Свойство Items определяет коллекцию строк раскрывающегося списка.
 ...
 ![](../../Property_Image.gif)
 [MaxLength](ModForms.chm::/Interface/IComboBox/IComboBox.MaxLength.htm)
 ...
 ![](../../Property_Image.gif)
 [SelLength](ModForms.chm::/Interface/IComboBox/IComboBox.SelLength.htm)
 Свойство SelLength определяет количество символов, выделенных в тексте компонента.


 ![](../../Property_Image.gif)
 [SelStart](ModForms.chm::/Interface/IComboBox/IComboBox.SelStart.htm)
 Свойство SelStart определяет позицию, в которой расположен курсор и начинается выделение текста в компоненте.


 ![](../../Property_Image.gif)
 [SelText](ModForms.chm::/Interface/IComboBox/IComboBox.SelText.htm)
 ...
 Свойство Sorted определяет, будут ли строки в раскрывающемся списке автоматически сортироваться в алфавитном порядке.


 ![](../../Property_Image.gif)
 [Style](ModForms.chm::/Interface/IComboBox/IComboBox.Style.htm)
 Свойство Style определяет стиль отображения раскрывающегося списка.
...
## Методы компонента ComboBox
 ...
 ![](../../Sub_Image.gif)
 [ClearEdit](ModForms.chm::/Interface/IComboBox/IComboBox.ClearEdit.htm)
 Метод ClearEdit осуществляет очистку поля редактирования компонента.
 ...
 ![](../../Sub_Image.gif)
 [SelectAll](ModForms.chm::/Interface/IComboBox/IComboBox.SelectAll.htm)
 Метод SelectAll осуществляет выделение всего текста в строке редактирования компонента.
...
## События компонента ComboBox
 ...
 ![](../../Event_Image.gif)
 [OnChange](ModForms.chm::/Class/ComboBox/ComboBox.OnChange.htm)
 Событие OnChange наступает при изменении текста в окне редактора компонента.
 ...
 ![](../../Event_Image.gif)
 [OnDropDown](ModForms.chm::/Class/ComboBox/ComboBox.OnDropDown.htm)
 Событие OnDropDown наступает при появлении раскрывающегося списка.
 ...
 ![](../../Event_Image.gif)
 [OnItemSelect](ModForms.chm::/Class/ComboBox/ComboBox.OnItemSelect.htm)
 Событие OnItemSelect наступает во время выбора элемента из списка.
