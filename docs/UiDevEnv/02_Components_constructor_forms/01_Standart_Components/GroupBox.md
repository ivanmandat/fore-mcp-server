...
## Иерархия наследования
 ...
           [GroupBox](ModForms.chm::/Class/GroupBox/GroupBox.htm)


## Описание


Компонент GroupBox представляет собой контейнер для размещения элементов управления или других компонентов-контейнеров, обладающий рамкой и надписью.


## Работа с компонентом


Компонент предназначен для объединения элементов управления, таких как [RadioButton](RadioButton.htm), [CheckBox](CheckBox.htm) и т.д. В отличии от компонента [Panel](Panel.htm), компонент GroupBox не имеет широких возможностей задания различных стилей оформления, и используется для выделения на форме группы функционально объединенных компонентов.
