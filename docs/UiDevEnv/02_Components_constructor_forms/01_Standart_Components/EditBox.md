...
## Иерархия наследования
 ...
           [EditBox](ModForms.chm::/Class/EditBox/EditBox.htm)
...
## События компонента EditBox
 ...
 Событие OnChange наступает после изменений свойства Text компонента редактирования.
