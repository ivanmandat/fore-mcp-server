...
## Иерархия наследования
 ...
           [Memo](ModForms.chm::/Class/Memo/Memo.htm)


## Описание


Компонент Memo представляет
 собой многострочный текстовый редактор.


## Работа с компонентом


Компонент Memo выполняет функции
 большинства текстовых редакторов, имеет «горячие клавиши»  для быстрого
 редактирования:
