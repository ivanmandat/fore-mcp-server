...
## Иерархия наследования
 ...
           [ISplitter](ModForms.chm::/Interface/ISplitter/ISplitter.htm)


           [Splitter](ModForms.chm::/Class/Splitter/Splitter.htm)


## Описание


Компонент Splitter предназначен для разделения формы на области, размеры которых можно изменять в процессе работы.


## Работа с компонентом


Визуально компонент представляет собой небольшую вертикальную или горизонтальную полосу и располагается между компонентами, выравненными по одной из границ формы, и компонентами заполняющими остальное пространство. В свойстве [Style](ModForms.chm::/Interface/ISplitter/ISplitter.Style.htm) задается стиль отображения компонента при изменении размеров связанных компонентов.


Компонент Splitter является контейнером и может содержать другие элементы управления.
...
## Свойства компонента Splitter
 ...
 ![](../../Property_Image.gif)
 [AutoSnap](ModForms.chm::/Interface/ISplitter/ISplitter.AutoSnap.htm)
 Свойство AutoSnap определяет, будет ли автоматически осуществляться привязка компонента Splitter к контейнеру, в котором располагаются элементы управления.


 ![](../../Property_Image.gif)
 [Beveled](ModForms.chm::/Interface/ISplitter/ISplitter.Beveled.htm)
 Свойство Beveled определяет, будет ли отображаться рамка для компонента.
 ...
 ![](../../Property_Image.gif)
 [MinSize](ModForms.chm::/Interface/ISplitter/ISplitter.MinSize.htm)
 Свойство MinSize определяет минимальное расстояние, которое должно оставаться между компонентом Splitter и краем контейнера, в котором расположены элементы управления.
 ...
 ![](../../Property_Image.gif)
 [Style](ModForms.chm::/Interface/ISplitter/ISplitter.Style.htm)
 Свойство Style определяет стиль отображения компонента при перемещении.
...
## События компонента Splitter
 ...
 ![](../../Event_Image.gif)
 [OnCanResize](ModForms.chm::/Class/Splitter/Splitter.OnCanResize.htm)
 Событие OnCanResize наступает при изменении размеров компонентов, привязанных к компоненту Splitter.
 ...
 ![](../../Event_Image.gif)
 [OnMoved](ModForms.chm::/Class/Splitter/Splitter.OnMoved.htm)
 Событие OnMoved наступает при перемещении компонента Splitter.
