...
## Иерархия наследования
 ...
           [IFrame](ModForms.chm::/Interface/IFrame/IFrame.htm)


           [Frame](ModForms.chm::/Class/Frame/Frame.htm)
...
При вставке компонента будет выдан запрос на выбор формы, которая в
 ...
 формы необходимо определить значение свойства [MetabaseObject](ModForms.chm::/Interface/IFrame/IFrame.MetabaseObject.htm).
 Доступ к параметрам формы, отображаемой во фрейме, осуществляется посредством
 свойства [Form](ModForms.chm::/Interface/IFrame/IFrame.Form.htm).
...
Во время выполнения формы игнорируются такие свойства компонента Frame, как [Hint](ModForms.chm::/Interface/IControl/IControl.Hint.htm),
 ...
 этого компонента/формы. Исключением является событие [OnKeyPreview](ModForms.chm::/Interface/IControl/IControl.OnKeyPreview.htm),
