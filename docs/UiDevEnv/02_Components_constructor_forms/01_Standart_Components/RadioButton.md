...
## Иерархия наследования
 ...
           [RadioButton](ModForms.chm::/Class/RadioButton/RadioButton.htm)
...
Из переключателей, объединенных в группу (достигается путем использования
 таких компонентов, как [GroupBox](GroupBox.htm), [Panel](Panel.htm)
...
Свойство Text компонента содержит
 ...
 Как и в других компонентах ([Button](Button.htm),
...
Главное свойство компонента [Checked](modforms.chm::/Interface/IRadioButton/IRadioButton.Checked.htm)
 ...
 то его свойству [Checked](modforms.chm::/Interface/IRadioButton/IRadioButton.Checked.htm)
