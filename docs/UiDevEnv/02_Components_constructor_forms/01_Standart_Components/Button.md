...
## Иерархия наследования
 ...
           [Button](ModForms.chm::/Class/Button/Button.htm)


## Описание


Компонент Button реализует стандартную кнопку Windows.


В основном компонент Button используется для инициирования каких-либо событий.


Основное событие кнопки - [OnClick](ModForms.chm::/Interface/IControl/IControl.OnClick.htm), возникающее при щелчке на данную кнопку. В обработчике этого события записывают набор операторов, которые должны выполниться при щелчке пользователя на кнопке. Более широкие возможности по настройке внешнего вида содержит компонент [ImageButton](../02_Additional_components/ImageButton.htm).
...
## Свойства компонента Button
 ...
 Свойство CancelButton определяет, будет ли обрабатываться событие [OnClick](ModForms.chm::/Interface/IControl/IControl.OnClick.htm) при нажатии клавиши ESC.
 ...
 Свойство DefaultButton определяет, что нажатие пользователем клавиши ENTER будет эквивалентно нажатию на данную кнопку.
 ...
 Свойство ModalResult определяет результат, возвращаемый после нажатия кнопки на модальной форме при закрытии этой формы.
 ...
 Свойство PopupMenu определяет контекстное меню, которое будет появляться при щелчке дополнительной кнопки мыши на компоненте.
