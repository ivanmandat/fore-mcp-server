...
## Иерархия наследования
 ...
           [ICheckBox](ModForms.chm::/Interface/ICheckBox/ICheckBox.htm)


           [CheckBox](ModForms.chm::/Class/CheckBox/CheckBox.htm)


## Описание


Компонент CheckBox реализует флажок, который позволяет включать или выключать какие-либо опции или используется для индикации состояния различных настроек.


## Работа с компонентом


При каждом щелчке пользователя на компоненте CheckBox его состояние меняется, проходя в общем случае через три значения:


-
Отмеченное. Появляется галочка на белом фоне;


-
Промежуточное. Появляется прямоугольник, сигнализирующий о неопределенности состояния флажка;


-
Неотмеченное. Пустое окно.


Промежуточное состояние допускается только в случае, если свойству [AllowGrayed](ModForms.chm::/Interface/ICheckBox/ICheckBox.AllowGrayed.htm) установлено значение True. Если [AllowGrayed](ModForms.chm::/Interface/ICheckBox/ICheckBox.AllowGrayed.htm) = False (значение по умолчанию), то допускаются только два состояния: Отмечен и Неотмечен.


Основное событие компонента - [OnChange](ModForms.chm::/Class/CheckBox/CheckBox.OnChange.htm), наступающее при смене состояния флажка компонента. В обработчике данного события можно анализировать свойства компонента [Checked](ModForms.chm::/Interface/ICheckBox/ICheckBox.Checked.htm) и [State](ModForms.chm::/Interface/ICheckBox/ICheckBox.State.htm), которые уже приняли новые значения.
...
[Alignment](ModForms.chm::/Interface/ICheckBox/ICheckBox.Alignment.htm)
...
[AllowGrayed](ModForms.chm::/Interface/ICheckBox/ICheckBox.AllowGrayed.htm)
...
[Checked](ModForms.chm::/Interface/ICheckBox/ICheckBox.Checked.htm)
...
[State](ModForms.chm::/Interface/ICheckBox/ICheckBox.State.htm)
...
[OnChange](ModForms.chm::/Class/CheckBox/CheckBox.OnChange.htm)


 Событие OnChange наступает при изменении состояния отметки компонента CheckBox.
