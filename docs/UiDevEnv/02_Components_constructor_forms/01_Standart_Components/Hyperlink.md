...
## Иерархия наследования
 ...
           [IHyperlink](ModForms.chm::/Interface/IHyperlink/IHyperlink.htm)


           [Hyperlink](ModForms.chm::/Class/Hyperlink/Hyperlink.htm)


## Описание


Компонент Hyperlink позволяет размещать надписи на форме, при наведении на которые они подсвечиваются определенным цветом. В основном используется для создания гиперссылкок.


## Пример


![](Hyperlink_Sample.gif)


## Свойства компонента Hyperlink
 ...
 Свойство Alignment определяет выравнивание текста надписи внутри поля компонента.
 ...
 ![](../../Property_Image.gif)
 [AlwaysUnderlined](ModForms.chm::/Interface/IHyperlink/IHyperlink.AlwaysUnderlined.htm)
 Свойство AlwaysUnderlined определяет признак наличия у гиперссылки подчеркивающей линии.
 ...
 Свойство AutoSize определяет, будет ли автоматически устанавливаться высота компонента в соответствии с высотой символов текста.
 ...
 ![](../../Property_Image.gif)
 [HoverColor](ModForms.chm::/Interface/IHyperlink/IHyperlink.HoverColor.htm)
 Свойство HoverColor определяет цвет, которым будет подсвечиваться гиперссылка, при наведении на нее курсора мыши.
 ...
 Свойство PopupMenu определяет контекстное меню, которое будет появляться появляться по щелчку дополнительной кнопки мыши на компоненте.
 ...
 Свойство Transparent определяет признак прозрачности компонента.
 ...
 Свойство WordWrap определяет, будут ли переноситься слова длинной надписи, превышающие длину компонента, на новую строку.


## Методы компонента Hyperlink
