...
## Иерархия наследования
 ...
           [IPanel](modforms.chm::/Interface/IPanel/IPanel.htm)


           [Panel](ModForms.chm::/Class/Panel/Panel.htm)


## Описание


Компонент Panel представляет
 собой панель, которая служит контейнером (родительским компонентом), объединяющим
 группу управляющих компонентов, компонентов ввода и отображения информации,
 а также других компонентов-контейнеров, например [GroupBox](GroupBox.htm).
...
## Свойства компонента Panel
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](ModForms.chm::/Interface/IPanel/IPanel.Alignment.htm)
		 Свойство Alignment
		 ...
		 ![](../../Property_Image.gif)
		 [BevelIner](ModForms.chm::/Interface/IPanel/IPanel.BevelInner.htm)
		 Свойство BevelInner
		 определяет вид внутренней рамки компонента.


		 ![](../../Property_Image.gif)
		 [BevelOuter](ModForms.chm::/Interface/IPanel/IPanel.BevelOuter.htm)
		 Свойство BevelOuter
		 определяет вид наружной рамки компонента.


		 ![](../../Property_Image.gif)
		 [BevelWidth](ModForms.chm::/Interface/IPanel/IPanel.BevelWidth.htm)
		 Свойство BevelWidth
		 определяет ширину фаски, создающей эффект объемности рамок.


		 ![](../../Property_Image.gif)
		 [BorderStyle](ModForms.chm::/Interface/IPanel/IPanel.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [BorderWidth](ModForms.chm::/Interface/IPanel/IPanel.BorderWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FullRepaint](ModForms.chm::/Interface/IPanel/IPanel.FullRepaint.htm)
