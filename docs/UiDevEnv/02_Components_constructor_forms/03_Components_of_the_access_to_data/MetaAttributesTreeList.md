# MetaAttributesTreeList: Компонент
...
## Иерархия наследования
 ...
           [IMetaAttributesTreeList](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.htm)


           [MetaAttributesTreeList](KeExtCtrls.chm::/Class/MetaAttributesTreeList/MetaAttributesTreeList.htm)


## Описание


Компонент MetaAttributesTreeList
 предназначен для отображения списка показателей, содержащихся в базе данных
 временных рядов.
...
Для подключения компонента необходимо в свойстве [Rubricator](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.Rubricator.htm)
 указать базу данных временных рядов, показатели которой будут отображаться
 в компоненте.


Также компонент MetaAttributesTreeList
 может использоваться вместе с компонентом [MetaAttributesBreadcrumb](MetaAttributesBreadcrumb.htm).
 Для этого необходимо в свойстве [Breadcrumb](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.Breadcrumb.htm)
 установить соответствующий компонент. После установки свойства [Breadcrumb](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.Breadcrumb.htm)
 текущий компонент автоматически будет подключен к базе данных временных
 рядов, на которую настроен подключаемый компонент [MetaAttributesBreadcrumb](MetaAttributesBreadcrumb.htm).
 Список показателей, выбранных в компоненте [MetaAttributesBreadcrumb](MetaAttributesBreadcrumb.htm),
 будет представлен в компоненте MetaAttributesTreeList
 в виде дерева.


Для настройки оформления содержимого компонента существует ряд свойств,
 реализованных в интерфейсе [IMetaAttributesTreeList](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.htm).
 Для фильтрации показателей, отображаемых в дереве, в свойстве [UserConditions](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.UserConditions.htm)
 можно задать ряд условий.
...
В компоненте предусмотрены следующие виды поиска:
	...
	- При помощи диалога поиска, который вызывается при
	 нажатии сочетания клавиш CTRL+F. После ввода текста и нажатия клавиши
	 ENTER либо кнопки «Найти далее»
	 будет осуществляться поиск. Поиск осуществляется циклически по всей
	 иерархии элементов. Если диалог поиска вызывался и был закрыт, то
	 в дереве элементов при нажатии клавиши F3 будет осуществляться поиск
	 элемента с наименованием, введенным в диалоге поиска. Также в диалоге
	 доступен поиск по частям не только одного, но и нескольких слов. Для
	 этого искомые сочетания символов разделяются пробелом. Порядок слов
	 в наименовании элементов при поиске не учитывается.
...
При удачном поиске курсор будет фокусироваться на найденном элементе.
 ...
 отметку осуществляется выделением с использованием клавиши ПРОБЕЛ
 либо выделением с помощью мыши при зажатой клавише CTRL.
...
В режиме выполнения формы для сортировки данных по какому-либо столбцу
 ...
 будут отсортированы по возрастанию значений. Повторные нажатия будут вызывать
 смену направления сортировки.
...
## Свойства, унаследованные от [IMetaAttributesTreeList](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Breadcrumb](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.Breadcrumb.htm)
		 Свойство Breadcrumb
		 определяет компонент [MetaAttributesBreadcrumb](MetaAttributesBreadcrumb.htm),
		 с которым связан данный компонент.


		 ![](../../Property_Image.gif)
		 [Dictionary](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.Dictionary.htm)
		 Свойство Dictionary
		 определяет справочник, на который настраивается компонент.


		 ![](../../Property_Image.gif)
		 [LightWeight](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.LightWeight.htm)
		 Свойство LightWeight
		 определяет, загружать ли показатели динамически.


		 ![](../../Property_Image.gif)
		 [LoadExtent](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.LoadExtent.htm)
		 Свойство LoadExtent
		 определяет ограничение на количество выводимых рядов в компоненте.


		 ![](../../Property_Image.gif)
		 [Rubricator](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.Rubricator.htm)
		 Свойство Rubricator
		 ...
		 ![](../../Property_Image.gif)
		 [RubricatorInstance](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.RubricatorInstance.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowCounts](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.ShowCounts.htm)
		 Свойство ShowCounts
		 ...
		 ![](../../Property_Image.gif)
		 [ShowEmptyFolders](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.ShowEmptyFolders.htm)
		 Свойство ShowEmptyFolders
		 определяет признак отображения пустых папок в дереве показателей.


		 ![](../../Property_Image.gif)
		 [ShowLeafFactors](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.ShowLeafFactors.htm)
		 Свойство ShowLeafFactors
		 определяет, отображать ли элементы дерева.


		 ![](../../Property_Image.gif)
		 [ShowTotal](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.ShowTotal.htm)
		 Свойство ShowTotal
		 определяет, отображать ли корневую вершину дерева.


		 ![](../../Property_Image.gif)
		 [SortFolderAlone](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.SortFolderAlone.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TotalCaption](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.TotalCaption.htm)
		 Свойство TotalCaption
		 определяет заголовок корневой вершины дерева элементов.


		 ![](../../Property_Image.gif)
		 [UserConditions](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.UserConditions.htm)
...
## Методы, унаследованнные от [IMetaAttributesTreeList](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [DeleteNodes](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.DeleteNodes.htm)
		 Метод DeleteNodes удаляет
		 указанные элементы из компонента.


		 ![](../../Sub_Image.gif)
		 [EditAttributes](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.EditAttributes.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetNodesMembers](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.GetNodesMembers.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetSelectedMembers](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.GetSelectedMembers.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetSelectedNodes](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.GetSelectedNodes.htm)
		 Метод GetSelectedNodes
		 возвращает массив элементов, отмеченных в компоненте.


		 ![](../../Sub_Image.gif)
		 [Rebuild](KeExtCtrls.chm::/Interface/IMetaAttributesTreeList/IMetaAttributesTreeList.Rebuild.htm)
...
## Методы, унаследованные от [ITreeList](ModForms.chm::/Interface/ITreeList/ITreeList.htm)
		 ...
		 инициализирует диалог поиска элементов компонента [TreeList](../02_Additional_components/TreeList.htm).
...
## События, унаследованные от [ITreeControl](ModForms.chm::/Interface/ITreeControl/ITreeControl.htm)
		 ...
		 после изменения состояния флага у элемента.


		 ![](../../Event_Image.gif)
		 [OnChecking](ModForms.chm::/Interface/ITreeControl/ITreeControl.OnChecking.htm)
		 Событие OnChecking
		 наступает перед изменением состояния флага у элемента.
