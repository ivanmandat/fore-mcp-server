# WorkbookDocumentViewerBox: Компонент
...
## Иерархия наследования
 ...
           [IWorkbookDocumentViewerBox](KeExpress.chm::/Interface/IWorkbookDocumentViewerBox/IWorkbookDocumentViewerBox.htm)


           [WorkbookDocumentViewerBox](KeExpress.chm::/Class/WorkbookDocumentViewerBox/WorkbookDocumentViewerBox.htm)


## Описание


Компонент WorkbookDocumentViewerBox
 предназначен для работы с рабочими книгами репозитория.


## Комментарии


В отличии от компонентов [LanerBox](LanerBox.htm), [LanerResultsBox](LanerResultsBox.htm)
 и других, которые позволяют отобразить какую-либо одну часть рабочей книги,
 текущий компонент WorkbookDocumentViewerBox
 отображает всю рабочую область: вкладки листов рабочей книги, заголовки,
...
Для работы компонента необходимо в свойстве [Analyzer](KeExpress.chm::/Interface/IWorkbookDocumentViewerBox/IWorkbookDocumentViewerBox.Analyzer.htm) задать источник
 данных, подключенный к рабочей книге. В качестве значения свойства указывается
 компонент [UiErAnalyzer](UiErAnalyzer.htm).
 Если к указываемому [UiErAnalyzer](UiErAnalyzer.htm)
 подключен компонент WorkbookConfigurationPanel,
 то его содержимое будет динамически меняться в зависимости от того, какой
 визуализатор выбран в компоненте WorkbookDocumentViewerBox.


## Пример


![](WorkbookDocumentViewerBox_Sample.gif)


## Свойства компонента WorkbookDocumentViewerBox
		 ...
		 ![](../../Property_Image.gif)
		 [FactorsTreeVisible](KeExpress.chm::/Interface/IWorkbookDocumentViewerBox/IWorkbookDocumentViewerBox.FactorsTreeVisible.htm)


		 Свойство FactorsTreeVisible
		 определяет признак отображения дополнительных элементов управления
...
## Методы компонента WorkbookDocumentViewerBox
