...
## Иерархия наследования
 ...
           [IEaxMapBox](KeExpress.chm::/Interface/IEaxMapBox/IEaxMapBox.htm)


           [EaxMapBox](KeExpress.chm::/Class/EaxMapBox/EaxMapBox.htm)


## Описание


Компонент EaxMapBox предназначен
 для отображения карт экспресс-отчета формата *.svg.


## Комментарии


Компонент EaxMapBox является
 аналогом [MapBox](MapBox.htm),
 но для отрисовки использует технологию WPF. EaxMapBox
 позволяет отображать карты формата *.svg в двухмерном и трехмерном режимах.
 Также, если в качестве источника указан экспресс-отчет, в котором есть
 календарное измерение, то в EaxMapBox
 будет отображена шкала времени.


## Работа с компонентом


Для работы компонента необходимо в свойстве [Source](KeExpress.chm::/Interface/IEaxMapBox/IEaxMapBox.Source.htm) задать
 источник данных, предоставляющий карту. В качестве значения свойства указывается
 компонент [UiEaxMap](UiEaxMap.htm)
 или [UiErAnalyzer](UiErAnalyzer.htm).


## Пример


![](EaxMapBox_Sample.gif)
...
## События компонента
		 ...
		 ![](../../Event_Image.gif)
		 [OnTerritoryClick](KeExpress.chm::/Class/EaxMapBox/EaxMapBox.OnTerritoryClick.htm)


		 Событие OnTerritoryClick наступает
		 при щелчке кнопкой мыши по какому-либо региону карты.
