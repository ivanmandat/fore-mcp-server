...
## Иерархия наследования
 ...
           [IErAnalyzerTitle](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.htm)


           [ErAnalyzerTitle](KeExpress.chm::/Class/ErAnalyzerTitle/ErAnalyzerTitle.htm)


## Описание


Компонент ErAnalyzerTitle предназначен
 для отображения заголовка экспресс-отчета.


## Работа с компонентом


После размещения компонента на форме необходимо в свойстве [Object](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.Object.htm)
 указать источник, связывающий с экспресс-отчетом, заголовок которого будет
 отображен в компоненте. В качестве значения свойства [Object](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.Object.htm)
...
![](ErAnalyzerTitle_Sample.gif)


## Свойства компонента ErAnalyzerTitle
		 ...
		 ![](../../Property_Image.gif)
		 [AutoEndEdit](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.AutoEndEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoHeight](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.AutoHeight.htm)
		 Свойство AutoHeight
		 ...
		 ![](../../Property_Image.gif)
		 [Object](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.Object.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [VerticalAlignment](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.VerticalAlignment.htm)
...
## Методы компонента ErAnalyzerTitle
		 ...
		 ![](../../Sub_Image.gif)
		 [EndEdit](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.EndEdit.htm)
		 Метод EndEdit выводит
		 компонент из режима редактирования с сохранение всех изменений.
		 ...
		 ![](../../Sub_Image.gif)
		 [ShowFontDialog](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.ShowFontDialog.htm)
		 Метод ShowFontDialog
		 вызывает диалог настройки шрифта для заголовка.


		 ![](../../Sub_Image.gif)
		 [StartEdit](KeExpress.chm::/Interface/IErAnalyzerTitle/IErAnalyzerTitle.StartEdit.htm)
		 Метод StartEdit переводит
		 заголовок в режим редактирования.


## События компонента ErAnalyzerTitle
