...
## Иерархия наследования
 ...
           [IModelBox](KeMs.chm::/Interface/IModelBox/IModelBox.htm)


           [ModelBox](KeMs.chm::/Class/ModelBox/ModelBox.htm)


## Описание


Компонент ModelBox предназначен
 для отображения панелей настройки моделей, созданных в контейнере моделирования.


## Работа с компонентом


Для работы компонента необходимо в свойстве [Model](KeMs.chm::/Interface/IModelBox/IModelBox.Model.htm)
 задать источник данных, предоставляющий модель. В качестве значения свойства
 указывается компонент [UiModel](UiModel.htm). Используя свойство
 [Pads](KeMs.chm::/Interface/IModelBox/IModelBox.Pads.htm),
 можно получить доступ к коллекции панелей и определить их параметры.
...
## Свойства компонента ModelBox
		 ...
		 ![](../../Property_Image.gif)
		 [IsDirty](KeMs.chm::/Interface/IModelBox/IModelBox.IsDirty.htm)


		 Свойство IsDirty возвращает
		 признак того, изменена ли модель, отображаемая компонентом.


		 ![](../../Property_Image.gif)
		 [Model](KeMs.chm::/Interface/IModelBox/IModelBox.Model.htm)


		 Свойство Model определяет
		 компонент [UiModel](UiModel.htm),
		 ...
		 ![](../../Property_Image.gif)
		 [ParametersSelectionSet](KeMs.chm::/Interface/IModelBox/IModelBox.ParametersSelectionSet.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ResultsViewScenario](KeMs.chm::/Interface/IModelBox/IModelBox.ResultsViewScenario.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ResultsViewSelectionSet](KeMs.chm::/Interface/IModelBox/IModelBox.ResultsViewSelectionSet.htm)
...
## Методы компонента ModelBox
		 ...
		 ![](../../Sub_Image.gif)
		 [Execute](KeMs.chm::/Interface/IModelBox/IModelBox.Execute.htm)


		 Метод Execute выполняет
		 расчёт модели и обновляет компонент ModelBox.


		 ![](../../Sub_Image.gif)
		 [Export](KeMs.chm::/Interface/IModelBox/IModelBox.Export.htm)


		 Метод Export экспортирует
		 модель, отображаемую в компоненте, в регламентный отчет.
		 ...
		 ![](../../Sub_Image.gif)
		 [SaveObject](KeMs.chm::/Interface/IModelBox/IModelBox.SaveObject.htm)


		 Метод SaveObject осуществляет
		 сохранение изменений, внесенных в параметры модели, отображаемой
		 в компоненте.
...
## События компонента ModelBox
		 ...
		 ![](../../Event_Image.gif)
		 [OnEditObject](KeMs.chm::/Class/ModelBox/ModelBox.OnEditObject.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnUpdate](KeMs.chm::/Class/ModelBox/ModelBox.OnUpdate.htm)
