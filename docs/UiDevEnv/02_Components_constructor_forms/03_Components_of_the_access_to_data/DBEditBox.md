...
## Иерархия наследования
 ...
           [IDBEditBox](KeExtCtrls.chm::/Interface/IDBEditBox/IDBEditBox.htm)


           [DBEditBox](KeExtCtrls.chm::/Class/DBEditBox/DBEditBox.htm)


## Описание


Компонент DBEditBox - связанный
 с данными аналог компонента [EditBox](../01_Standart_Components/EditBox.htm).
 Компонент DBEditBox позволяет
 отображать и редактировать данные полей различных типов. Преобразование
 значения поля в строку текста, отображаемую в компоненте, производится
 автоматически.
...
![](DBEditBox_Sample1.gif)


После запуска формы:


![](DBEditBox_Sample2.gif)


## Свойства компонента DBEditBox
