# EaxConfigurationPanel: Компонент
...
## Иерархия наследования
 ...
           [IEaxConfigurationPanel](KeExpress.chm::/Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.htm)


           [EaxConfigurationPanel](KeExpress.chm::/Class/EaxConfigurationPanel/EaxConfigurationPanel.htm)


## Описание


Компонент EaxConfigurationPanel
 предназначен для отображения боковой панели экспресс-отчета.


## Комментарии


Для работы компонента необходимо в инспекторе объектов в свойстве Analyzer указать компонент [UiErAnalyzer](UiErAnalyzer.htm).


Компонент позволяет добавлять дополнительные группы вкладок, помимо
 трех системных групп, реализованных специально для экспресс-отчетов.


## Пример


![](EaxConfigurationPanel_Sample.gif)


## Свойства компонента EaxConfigurationPanel
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveCategory](KeExpress.chm::/Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.ActiveCategory.htm)


		 Свойство ActiveCategory
		 определяет активную группу вкладок.
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](KeExpress.chm::/Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.Analyzer.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Categories](KeExpress.chm::/Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.Categories.htm)


		 Свойство Categories
		 возвращает коллекцию групп вкладок боковой панели экспресс-отчета.
...
## Методы компонента EaxConfigurationPanel
...
## События компонента EaxConfigurationPanel
		 ...
		 ![](../../Event_Image.gif)
		 [OnActivePadChanged](KeExpress.chm::/Class/EaxConfigurationPanel/EaxConfigurationPanel.OnActivePadChanged.htm)


		 Событие OnActivePadChanged
		 наступает при активации какой-либо вкладки компонента.
		 ...
		 Событие OnBeginDrag для
		 компонента наступает, когда пользователь начинает перетаскивать
		 ...
		 Событие OnDragDrop для
		 компонента наступает, когда пользователь отпускает над ним перетаскиваемый
		 объект.
		 ...
		 Событие OnDragOver для
		 компонента наступает, когда пользователь протаскивает над ним
		 ...
		 ![](../../Event_Image.gif)
		 [OnInternalWidgetChange](KeExpress.chm::/Class/EaxConfigurationPanel/EaxConfigurationPanel.OnInternalWidgetChange.htm)


		 Событие OnInternalWidgetChange
		 наступает при изменении каких-либо настроек текущего активного
		 объекта.
		 ...
		 наступает, если компонент находится в фокусе при вращении
		 колеса мыши.
