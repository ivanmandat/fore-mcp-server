# WorkbookConfigurationPanel: Компонент
...
## Иерархия наследования
 ...
           [IWorkbookConfigurationPanel](KeExpress.chm::/Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.htm)


           [WorkbookConfigurationPanel](KeExpress.chm::/Class/WorkbookConfigurationPanel/WorkbookConfigurationPanel.htm)
...
Компонент WorkbookConfigurationPanel
 предназначен для отображения боковой панели, с помощью которой можно управлять
 параметрами рабочей книги базы данных временных рядов.


## Работа с компонентом


Для работы компонента необходимо в свойстве [Analyzer](KeExpress.chm::/Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.Analyzer.htm) задать
 источник данных, подключенный к рабочей книге. В качестве значения свойства
 указывается компонент [UiErAnalyzer](UiErAnalyzer.htm).
 Если к указываемому [UiErAnalyzer](UiErAnalyzer.htm)
 подключен компонент [WorkbookDocumentViewerBox](WorkbookDocumentViewerBox.htm),
 то доступные группы вкладок и набор настроек на вкладках будет динамически
 меняться в зависимости от того, какой элемент выделе в компоненте [WorkbookDocumentViewerBox](WorkbookDocumentViewerBox.htm).


## Пример


![](WorkbookConfigurationPanel_Sample.png)


## Свойства компонента WorkbookConfigurationPanel
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveCategory](KeExpress.chm::/Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.ActiveCategory.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Categories](KeExpress.chm::/Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.Categories.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Context](KeExpress.chm::/Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.Context.htm)
...
## Методы компонента WorkbookConfigurationPanel
...
## События компонента WorkbookConfigurationPanel
