...
## Иерархия наследования
 ...
           [IDescStatsBox](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.htm)


           [DescStatsBox](KeMs.chm::/Class/DescStatsBox/DescStatsBox.htm)


## Описание


Компонент DescStatsBox представляет
 панель, содержащую настройки, необходимые для расчета [описательных
...
Для работы компонента необходимо в свойстве [ModelSpace](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.ModelSpace.htm)
 определить контейнер, содержащий необходимые переменные моделирования.
 Добавление в компонент переменных, для которых будет производиться расчет
 [описательных
 статистик](UiModelling.chm::/2_Container_of_Modeling/2_3_Work_object/2_3_5_Descriptive_Value/uimodelling_work_object_descriptive.htm), осуществляется соответствующей кнопкой «Добавить» на панели «Набор
 переменных» либо с помощью метода [AddVariableStub](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.AddVariableStub.htm).
 Расчет производится автоматически для всех добавляемых переменных. При
 необходимости можно изменить состояние любой панели компонента и количество
 отображаемых панелей, используя соответствующие свойства [Expanded](kems.chm::/Interface/IMsMultiPadPad/IMsMultiPadPad.Expanded.htm)
 и [CanShow](KeMs.chm::/Interface/IMsMultiPadPad/IMsMultiPadPad.CanShow.htm).
 Список панелей компонента доступен в свойстве [Pads](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.Pads.htm).


Подробное описание всех настроек, используемых при расчете, представлено
 в разделе «[Описательные статистики](UiModelling.chm::/2_Container_of_Modeling/2_3_Work_object/2_3_5_Descriptive_Value/uimodelling_work_object_descriptive.htm)».


## Пример


![](DescStatsBox_Sample.gif)


## Свойства компонента DescStatsBox
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](Map.chm::/Interface/IMapBox/IMapBox.BorderStyle.htm)
...
## Методы компонента DescStatsBox
		 ...
		 ![](../../Sub_Image.gif)
		 [AddVariableStub](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.AddVariableStub.htm)
		 Метод AddVariableStub
		 осуществляет добавление указанной переменной в список переменных
		 компонента.


		 ![](../../Sub_Image.gif)
		 [AddVariableStubFixedSlice](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.AddVariableStubFixedSlice.htm)
		 Метод AddVariableStubFixedSlice
		 осуществляет добавление в компонент переменной с указанием отметки
		 по ее дополнительным измерениям.


		 ![](../../Sub_Image.gif)
		 [ClearVariables](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.ClearVariables.htm)
		 Метод ClearVariables
		 осуществляет очистку списка переменных компонента.
		 ...
		 ![](../../Sub_Image.gif)
		 [RemoveByIndex](KeMs.chm::/Interface/IDescStatsBox/IDescStatsBox.RemoveByIndex.htm)
		 Метод RemoveByIndex
		 осуществляет удаление указанной переменной.
...
## События компонента DescStatsBox
