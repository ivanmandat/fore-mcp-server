...
## Иерархия наследования
 ...
           [IMetaAttributesEdit](KeExtCtrls.chm::/Interface/IMetaAttributesEdit/IMetaAttributesEdit.htm)


           [MetaAttributesEdit](KeExtCtrls.chm::/Class/MetaAttributesEdit/MetaAttributesEdit.htm)


## Описание


Компонент MetaAttributesEdit
 представляет собой редактор выражений, составленных на основе рядов, содержащихся
...
Принципиальным отличием компонента от других компонентов для составления
 выражений ([CalcCubeFormulaEdit](../02_Additional_components/CalcCubeFormulaEdit.htm),
 [ExpressionEdit](../02_Additional_components/ExpressionEdit.htm),
 [TermEdit](../02_Additional_components/TermEdit.htm)) является
 наличие реализованной технологии IntelliSense, позволяющей быстро составлять
 сложные выражения. Для работы компонента необходимо свойство [Expression](KeExtCtrls.chm::/Interface/IMetaAttributesEdit/IMetaAttributesEdit.Expression.htm)
 связать с выражением, которое необходимо отредактировать с использованием
 рядов базы данных временных рядов. Для использования рядов в выражениях
 необходимо загрузить значения атрибутов, из которых в последствии будут
 составляться наименования рядов. Для загрузки используется метод [AddAttribute](KeExtCtrls.chm::/Interface/IMetaAttributesEdit/IMetaAttributesEdit.AddAttribute.htm).
...
После этого в список подстановок IntelliSense будут загружены наименования
 доступных функций и значения атрибутов. Наименования рядов будут формироваться
 из значений всех добавленных атрибутов. Порядок формирования определяется
 порядком добавления атрибутов. Для вызова IntelliSense используется сочетание
 клавиш CTRL+ПРОБЕЛ. Также список появляется автоматически при
 наборе текста в компоненте.


## Пример


![](MetaAttributesEdit_Sample.gif)


## Свойства компонента MetaAttributesEdit
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](KeExtCtrls.chm::/Interface/IMetaAttributesEdit/IMetaAttributesEdit.Expression.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RevisionsDimension](KeExtCtrls.chm::/Interface/IMetaAttributesEdit/IMetaAttributesEdit.RevisionsDimension.htm)
...
## Методы компонента MetaAttributesEdit
...
## События компонента MetaAttributesEdit
