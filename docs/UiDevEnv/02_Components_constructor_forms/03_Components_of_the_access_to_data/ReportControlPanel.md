...
## Иерархия наследования
 ...
           [IReportControlPanel](KeReport.chm::/Interface/IReportControlPanel/IReportControlPanel.htm)
...
Компонент ReportControlPanel предназначен для отображения панели элементов управления регламентного отчета.


## Работа с компонентом


Для работы компонента необходимо в свойстве [Object](KeReport.chm::/Interface/IReportControlPanel/IReportControlPanel.Object.htm) задать источник данных, предоставляющий регламентный отчет. В качестве значения свойства указывается компонент [UiReport](UiReport.htm).


## Пример


![](ReportControlPanel_Sample.gif)


## Свойства компонента ReportControlPanel
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](KeReport.chm::/Interface/IReportControlPanel/IReportControlPanel.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Object](KeReport.chm::/Interface/IReportControlPanel/IReportControlPanel.Object.htm)
		 Свойство Object определяет
		 компонент [UiReport](UiReport.htm)
		 , который будет использоваться в качестве источника данных.


		 ![](../../Property_Image.gif)
		 [Orientation](KeReport.chm::/Interface/IReportControlPanel/IReportControlPanel.Orientation.htm)
		 Свойство Orientation
		 определяет способ расположения элементов управления в компоненте.
		 ...
		 ![](../../Property_Image.gif)
		 [Report](KeReport.chm::/Interface/IReportControlPanel/IReportControlPanel.Report.htm)
		 Свойство Report определяет
		 регламентный отчет, реализуемый интерфейсом [IPrxReport](KeReport.chm::/Interface/IPrxReport/IPrxReport.htm)
		 .
...
## Методы компонента ReportControlPanel
...
## События компонента ReportControlPanel
