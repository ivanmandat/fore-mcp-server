...
## Иерархия наследования
 ...
           [IDBLookupControl](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.htm)


           [IDBLookupComboBox](KeExtCtrls.chm::/Interface/IDBLookupComboBox/IDBLookupComboBox.htm)


           [DBLookupComboBox](KeExtCtrls.chm::/Class/DBLookupComboBox/DBLookupComboBox.htm)


## Описание


Компонент DBLookupComboBox позволяет
 задавать значение некоторого поля одного набора данных путём выбора соответствующего
 значения из списка, сформированного из элементов другого набора данных.
 Данные отображаются посредством стандартного компонента [ComboBox](../01_Standart_Components/ComboBox.htm).


Список в DBLookupComboBox формируется
 из подходящих элементов поискового набора [ListSource](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListSource.htm).
 Выбор в списке устанавливает значение поля в наборе данных [DataSource](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.DataSource.htm).
 Обычно в списках отображаются значения тех полей ([ListField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListField.htm)),
 которые наилучшим образом описывают реальное значение поля ([DataField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.DataField.htm)).


Если свойство [DataField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.DataField.htm) в компоненте
 DBLookupListBox указывает на поле
 поиска, то зависимость между значением поля и списком поиска устанавливается
 автоматически. Если [DataField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.DataField.htm)
 указывает на поле, не являющееся полем поиска, то зависимость задается
 явно с помощью установки свойств [ListField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListField.htm),
 [ListSource](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListSource.htm).
...
## Свойства компонента DBLookupComboBox
		 ...
		 ![](../../Property_Image.gif)
		 [DropDownRows](KeExtCtrls.chm::/Interface/IDBLookupComboBox/IDBLookupComboBox.DropDownRows.htm)
		 Свойство DropDownRows
		 определяет количество отображаемых элементов раскрывающегося списка.
		 ...
		 ![](../../Property_Image.gif)
		 [KeyField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.KeyField.htm)
		 Свойство KeyField определяет
		 поле из набора данных [ListSource](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListSource.htm)
		 , значение которого должно соответствовать значению поля [DataField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.DataField.htm)
		 .


		 ![](../../Property_Image.gif)
		 [KeyValue](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.KeyValue.htm)
		 Свойство KeyValue определяет
		 значение ключевого поля в активной строке источника данных.
		 ...
		 ![](../../Property_Image.gif)
		 [ListField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListField.htm)
		 Свойство ListField
		 определяет одно или несколько полей, значения которых отображаются
		 в данном компоненте.
		 ...
		 [ListSource](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListSource.htm)
		 Свойство ListSource
		 определяет источник данных для компонента поиска, то есть источник,
		 содержащий поля [KeyField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.KeyField.htm)
		 и [ListField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.ListField.htm)
		 .


		 ![](../../Property_Image.gif)
		 [ListVisible](KeExtCtrls.chm::/Interface/IDBLookupComboBox/IDBLookupComboBox.ListVisible.htm)
		 Свойство ListVisible
		 возвращает значение видимости элементов раскрывающегося списка.
...
## События компонента DBLookupComboBox
		 ...
		 ![](../../Event_Image.gif)
		 [OnCloseUp](KeExtCtrls.chm::/Class/DBLookupComboBox/DBLookupComboBox.OnCloseUp.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnDropDown](KeExtCtrls.chm::/Class/DBLookupComboBox/DBLookupComboBox.OnDropDown.htm)
		 Событие OnDropDown
