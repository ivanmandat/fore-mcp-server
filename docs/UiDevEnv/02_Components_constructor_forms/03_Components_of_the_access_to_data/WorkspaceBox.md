...
## Иерархия наследования
 ...
           [IWorkspaceBox](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.htm)


           [WorkspaceBox](KeWsp.chm::/Class/WorkspaceBox/WorkspaceBox.htm)


## Описание


Компонент WorkspaceBox позволяет
 отображать на форме рабочее пространство.


## Работа с компонентом


Для работы компонента необходимо в свойстве [Source](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.Source.htm)
 задать источник данных, предоставляющий рабочее пространство. В качестве
 значения свойства указывается компонент [UiWorkspace](UiWorkspace.htm)
 или [UiWorkspaceObject](UiWorkspaceObject.htm).


Используя свойства с префиксом Display,
 можно определить различные параметры отображения рабочего пространства.
 В свойстве [ActiveTool](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.ActiveTool.htm)
 задается текущий инструмент рабочего пространства. Свойство [View](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.View.htm)
 возвращает объект, позволяющий произвести дополнительные настройки отображения.


## Пример


![](WorkspaceBox_Sample.gif)


## Свойства компонента WorkspaceBox
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveTool](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.ActiveTool.htm)
		 Свойство ActivTool
		 определяет активный инструмент рабочего пространства.
		 ...
		 ![](../../Property_Image.gif)
		 [DefaultHandlers](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DefaultHandlers.htm)
		 Свойство DefaultHandlers
		 определяет возможность выполнения установленного по умолчанию
		 действия над фигурой рабочего пространства.


		 ![](../../Property_Image.gif)
		 [DefaultMenu](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DefaultMenu.htm)
		 Свойство DefaultMenu
		 определяет признак наличия системного контекстного меню у
		 рабочего пространства и у фигур, расположенных на нем.


		 ![](../../Property_Image.gif)
		 [DisplayConnectionPoints](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DisplayConnectionPoints.htm)
		 Свойство DisplayConnectionsPoint
		 определяет признак отображения точек соединения.


		 ![](../../Property_Image.gif)
		 [DisplayFocusFrame](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DisplayFocusFrame.htm)
		 Свойство DisplayFokusFrame
		 определяет признак отображения фокуса.


		 ![](../../Property_Image.gif)
		 [DisplayGrid](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DisplayGrid.htm)
		 Свойство DisplayGrid
		 определяет признак отображения сетки на рабочем пространстве.


		 ![](../../Property_Image.gif)
		 [DisplayIntersections](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DisplayIntersections.htm)
		 Свойство DisplayIntersections
		 определяет признак отображения пересечений.


		 ![](../../Property_Image.gif)
		 [DisplayScrollBars](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DisplayScrollBars.htm)
		 Свойство DisplayScrollBar
		 определяет признак отображения полос прокрутки рабочего пространства.


		 ![](../../Property_Image.gif)
		 [DisplaySelections](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.DisplaySelections.htm)
		 Свойство DisplaySelections
		 определяет признак отображения выделения объектов на рабочем пространстве.
		 ...
		 ![](../../Property_Image.gif)
		 [Source](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.Source.htm)
		 Свойство Source определяет
		 наименование компонента [UiWorkspace](UiWorkspace.htm) или [UiWorkspaceObject](UiWorkspaceObject.htm)
		 , являющегося источником данных для компонента.
		 ...
		 ![](../../Property_Image.gif)
		 [View](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.View.htm)
		 Свойство View возвращает
		 параметры отображения объектов рабочего пространства.
		 ...
		 ![](../../Property_Image.gif)
		 [Width](ModForms.chm::/Interface/IControl/IControl.Width.htm)[Width](../../../ModForms/Interface/IControl/IControl.Width.htm)
		 Свойство Width определяет
		 ширину компонента.


## Методы компонента WorkspaceBox
		 ...
		 ![](../../Sub_Image.gif)
		 [ConvertPtToView](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.ConvertPtToView.htm)
		 Метод ConvertPtToView
		 позволяет получить координаты точки в рабочем пространстве по
		 экранной координате.
		 ...
		 ![](../../Sub_Image.gif)
		 [GetShapeByPt](KeWsp.chm::/Interface/IWorkspaceBox/IWorkspaceBox.GetShapeByPt.htm)
		 Метод GetShapeByPt
		 позволяет получить информацию о фигуре по экранной координате
...
## События компонента WorkspaceBox
		 ...
		 ![](../../Event_Image.gif)
		 [OnAfterMoveCP](KeWsp.chm::/Class/WorkspaceBox/WorkspaceBox.OnAfterMoveCP.htm)
		 Событие OnAfterMoveCP
		 наступает после перемещения одной из конечных точек линии связи.


		 ![](../../Event_Image.gif)
		 [OnBeforeMoveCP](KeWsp.chm::/Class/WorkspaceBox/WorkspaceBox.OnBeforeMoveCP.htm)
		 Событие OnBeforeMoveCP
		 наступает перед перемещением одной из конечных точек линии связи.
		 ...
		 ![](../../Event_Image.gif)
		 [OnSelectionChanged](KeWsp.chm::/Class/WorkspaceBox/WorkspaceBox.OnSelectionChanged.htm)
		 Событие OnSelectionChanged
		 наступает при изменении фокуса, у какого-либо объекта рабочего
		 пространства.


		 ![](../../Event_Image.gif)
		 [OnShapeChanged](KeWsp.chm::/Class/WorkspaceBox/WorkspaceBox.OnShapeChanged.htm)
		 Событие OnShapeChanged
		 наступает после каких-либо изменений, связанных с фигурой рабочего
		 пространства.
