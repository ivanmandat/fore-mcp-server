...
## Иерархия наследования
 ...
           [ILanerResultsBox](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.htm)


           [LanerResultsBox](KeExpress.chm::/Class/LanerResultsBox/LanerResultsBox.htm)


## Описание


Компонент LanerResultsBox предназначен
 для просмотра диаграмм и рассчитанных статистических характеристик, а
 также для настройки параметров различных методов преобразования, которые
 могут применяться для рядов данных в рабочей книге базы данных временных
 рядов.
...
Для работы компонента необходимо в инспекторе объектов в свойстве Object установить источник данных.
 В качестве источника данных может выступать любой компонент [UiErAnalyzer](UiErAnalyzer.htm),
 расположенный на форме.


Используя различные свойства и методы, описание которых представлено
 в описании интерфейса [ILanerResultsBox](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.htm),
 осуществляется настройка внешнего вида компонента.


## Пример


![](LanerResultsBox_Sample.gif)


## Свойства компонента LanerResultsBox
		 ...
		 ![](../../Property_Image.gif)
		 [ContainerVisible](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.ContainerVisible.htm)

		 Свойство ContainerVisible
		 определяет, отображать ли указанную панель.
		 ...
		 ![](../../Property_Image.gif)
		 [DerivedSerieVisible](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.DerivedSerieVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [NoShowErrors](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.NoShowErrors.htm)
		 Свойство NoShowErrors
		 определяет, будет ли скрыта информация об ошибках.
		 ...
		 ![](../../Property_Image.gif)
		 [Results](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.Results.htm)
		 Свойство Results возвращает
		 набор объектов, предназначенных для работы со вкладками на панели
		 ...
		 ![](../../Property_Image.gif)
		 [UserForm](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.UserForm.htm)
		 Свойство UserForm определяет
		 идентификатор пользовательской формы, подключаемой вместо одной
		 из стандартных панелей компонента.


		 ![](../../Property_Image.gif)
		 [UserFormControl](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.UserFormControl.htm)[l](../../../KeExpress/Interface/ILanerResultsBox/ILanerResultsBox.UserFormControl.htm)
		 Свойство UserFormControl
		 возвращает параметры подключенной пользовательской формы.


		 ![](../../Property_Image.gif)
		 [UserFormReplacePanel](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.UserFormReplacePanel.htm)
		 Свойство UserFormReplacePanel
		 определяет стандартную панель, вместо которой будет подключена
...
## Методы компонента LanerResultsBox
		 ...
		 ![](../../Sub_Image.gif)
		 [LoadFromStream](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.LoadFromStream.htm)
		 Метод LoadFromStream
		 загружает параметры отображения компонента из потока.


		 ![](../../Sub_Image.gif)
		 [Refresh](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.Refresh.htm)
		 Метод Refresh обновляет
		 панели компонента.


		 ![](../../Sub_Image.gif)
		 [SaveToStream](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.SaveToStream.htm)
		 Метод SaveToStream
		 сохраняет параметры отображения компонента в поток.
		 ...
		 ![](../../Sub_Image.gif)
		 [SetUserForm](KeExpress.chm::/Interface/ILanerResultsBox/ILanerResultsBox.SetUserForm.htm)
		 Метод SetUserForm подключает
		 пользовательскую форму вместо одной из стандартных панелей компонента.


## События компонента LanerResultsBox
		 ...
		 если пользователь щёлкнулв области компонента.


		 ![](../../Event_Image.gif)
		 [OnCopyStatistics](KeExpress.chm::/Class/LanerResultsBox/LanerResultsBox.OnCopyStatistics.htm)
		 Событие OnCopyStatistics
		 наступает при копировании данных со вкладки «Статистические
		 характеристики» на панели «Результаты
		 вычислений» компонента.
