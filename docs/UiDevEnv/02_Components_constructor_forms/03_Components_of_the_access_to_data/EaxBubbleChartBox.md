...
## Иерархия наследования
 ...
           [IEaxBubbleChartBox](KeExpress.chm::/Interface/IEaxBubbleChartBox/IEaxBubbleChartBox.htm)


           [EaxBubbleChartBox](KeExpress.chm::/Class/EaxBubbleChartBox/EaxBubbleChartBox.htm)


## Описание


Компонент EaxBubbleChartBox
 предназначен для отображения пузырьковой диаграммы экспресс-отчета.


## Комментарии


В качестве источников для EaxBubbleChartBox
 используйте компоненты [UiErAnalyzer](UiErAnalyzer.htm)
 и [UiEaxBubbleChart](UiEaxBubbleChart.htm).


## Работа с компонентом


Для работы компонента задайте в свойстве [Source](KeExpress.chm::/Interface/IEaxBubbleChartBox/IEaxBubbleChartBox.Source.htm) источник данных
 [UiErAnalyzer](UiErAnalyzer.htm),
 предоставляющий пузырьковую диаграмму.


## Пример


![](EaxBubbleChartBox_Sample.gif)


## Свойства компонента EaxBubbleChartBox
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](KeExpress.chm::/Interface/IEaxBubbleChartBox/IEaxBubbleChartBox.BorderStyle.htm)
		 ...
		 будет ли появляться всплывающая подсказка при задержке курсора
		 мыши над компонентом.


		 ![](../../Property_Image.gif)
		 [Source](KeExpress.chm::/Interface/IEaxBubbleChartBox/IEaxBubbleChartBox.Source.htm)
		 Свойство Source определяет
		 источник данных для компонента [EaxBubbleChartBox](EaxBubbleChartBox.htm).
...
## Методы компонента EaxBubbleChartBox
...
## События компонента EaxBubbleChartBox
