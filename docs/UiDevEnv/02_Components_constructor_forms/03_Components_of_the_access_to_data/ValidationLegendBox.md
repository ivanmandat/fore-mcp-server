...
## Иерархия наследования
 ...
           [IValidationLegendBox](KeExpress.chm::/Interface/IValidationLegendBox/IValidationLegendBox.htm)


           [ValidationLegendBox](KeExpress.chm::/Class/ValidationLegendBox/ValidationLegendBox.htm)


## Описание


Компонент ValidationLegendBox
 предназначен для отображения списка правил валидаций, которые применены
 в рабочей книге.
...
Для работы компонента необходимо в свойстве [Analyzer](KeExpress.chm::/Interface/IValidationLegendBox/IValidationLegendBox.Analyzer.htm)
 указать компонент [UiErAnalyzer](UiErAnalyzer.htm), который
 связан с рабочей книгой. В коде формы для рабочей книги должны быть применены
 необходимые правила валидации и составлен [диагностический
 отчет](KeExpress.chm::/Interface/IEaxAnalyzeCore/IEaxAnalyzeCore.DiagnosticReport.htm). Пример кода, который может быть использован
 для применения правил валидации:
...
![](ValidationLegendBox_Sample.gif)


## Свойства компонента ValidationLegendBox
...
## Методы компонента ValidationLegendBox
...
## События компонента ValidationLegendBox
