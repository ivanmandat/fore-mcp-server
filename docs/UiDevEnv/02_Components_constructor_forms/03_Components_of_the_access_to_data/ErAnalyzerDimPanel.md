...
## Иерархия наследования
 ...
           [IErAnalyzerDimPanel](KeExpress.chm::/Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.htm)


           [ErAnalyzerDimPanel](KeExpress.chm::/Class/ErAnalyzerDimPanel/ErAnalyzerDimPanel.htm)


## Описание


Компонент ErAnalyzerDimPanel
 предназначен для отображения панели измерений экспресс-отчета.


## Работа с компонентом


После размещения компонента на форме необходимо в свойстве [Object](KeExpress.chm::/Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.Object.htm)
 указать источник, связывающий с экспресс-отчетом, измерения которого будут
 отображены в компоненте. В качестве значения свойства [Object](KeExpress.chm::/Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.Object.htm)
 должен быть указан компонент [UiErAnalyzer](UiErAnalyzer.htm).
 Изменение положения измерений и установка отметки элементов в измерениях
 производится аналогично экспресс-отчету как объекту репозитория. После
 изменения отметки элементов экспресс-отчет рассчитывается автоматически.


## Пример


![](ErAnalyzerDimPanel_Sample.gif)


## Свойства компонента ErAnalyzerDimPanel
		 ...
		 ![](../../Property_Image.gif)
		 [ErAnalyzer](KeExpress.chm::/Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.ErAnalyzer.htm)
		 Свойство ErAnalyzer
		 определяет экспресс-отчет, реализуемый интерфейсом [IEaxAnalyzer](KeExpress.chm::/Interface/IEaxAnalyzer/IEaxAnalyzer.htm),
		 являющийся источником данных для панели измерений.


		 ![](../../Property_Image.gif)
		 [FixedStructure](KeExpress.chm::/Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.FixedStructure.htm)
		 Свойство FixedStructure
		 определяет, будет ли в панели измерений фиксированная структура
		 измерений куба.
		 ...
		 Свойство Left
		 определяет координату левого края компонента в пикселях.
		 ...
		 ![](../../Property_Image.gif)
		 [Object](KeExpress.chm::/Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.Object.htm)
		 Свойство Object определяет
		 компонент [UiErAnalyzer](UiErAnalyzer.htm)
		 , который будет использоваться как источник данных.


		 ![](../../Property_Image.gif)
		 [Orientation](KeExpress.chm::/Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.Orientation.htm)
		 Свойство Orientation
		 определяет способ расположения измерений в компоненте.
		 ...
		 ![](../../Property_Image.gif)
		 [Source](KeExpress.chm::/Interface/IEaxMapBox/IEaxMapBox.Source.htm)
...
## Методы компонента ErAnalyzerDimPanel
...
## События компонента ErAnalyzerDimPanel
		 ...
		 Событие OnControlMove наступает
		 при перемещении компонента.
		 ...
		 Событие OnControlResize наступает
		 при изменении размеров у компонента.
		 ...
		 наступает, когда пользователь отпускает над ним перетаскиваемый
		 объект.
		 ...
		 Событие OnDragEnter наступает,
		 когда перетаскиваемый объект входит в границы данного компонента.
		 ...
		 Событие OnDragLeave наступает,
		 когда перетаскиваемый объект выходит за границы данного компонента.
		 ...
		 наступает, когда пользователь протаскивает над ним перетаскиваемый
		 объект.
		 ...
		 Событие OnEnter наступает в момент
		 получения фокуса компонентом.
		 ...
		 Событие OnHScroll наступает при
		 изменении положения ползунка горизонтальной полосы прокрутки.
		 ...
		 Событие OnKeyDown наступает, если
		 компонент находится в фокусе и производится нажатие на клавиатуру.
		 ...
		 компонент находится в фокусе, при отпускании пользователем любой,
		 ...
		 если указатель находится в области компонента и была нажата любая
		 кнопка мыши.
		 ...
		 Событие OnMouseUp наступает при
		 отпускании кнопки мыши, когда указатель находится в области компонента.
		 ...
		 если компонент находится в фокусе при вращении колеса мыши.
		 ...
		 Событие OnVScroll наступает при
		 изменении положения ползунка вертикальной полосы прокрутки.
