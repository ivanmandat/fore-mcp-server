...
## Иерархия наследования
 ...
           [IPCABox](KeMs.chm::/Interface/IPCABox/IPCABox.htm)


           [PCABox](KeMs.chm::/Class/PCABox/PCABox.htm)


## Описание


Компонент PCABox предоставляет
 панель, содержащую настройки, необходимые для расчета [метода
...
Для работы компонента необходимо в свойстве [ModelSpace](KeMs.chm::/Interface/IPCABox/IPCABox.ModelSpace.htm)
 определить контейнер, содержащий необходимые переменные моделирования.
 Добавление в компонент переменных, на основе которых производится расчет
 [метода
 главных компонент](UiModelling.chm::/2_Container_of_Modeling/2_3_Work_object/2_3_7_MethPrinComp/uimodelling_work_object_MethPrinComp.htm), осуществляется соответствующей кнопкой
 «Добавить» на панели «Набор переменных» либо с помощью метода [AddVariableStub](KeMs.chm::/Interface/IPCABox/IPCABox.AddVariableStub.htm).
 Расчет производится автоматически с учетом всех добавляемых переменных.
 При необходимости можно изменить состояние любой панели компонента и количество
 ...
 Список панелей компонента доступен в свойстве [Pads](KeMs.chm::/Interface/IPCABox/IPCABox.Pads.htm).
...
## Методы компонента PCABox
		 ...
		 ![](../../Sub_Image.gif)
		 [ExtractResults](KeMs.chm::/Interface/IPCABox/IPCABox.ExtractResults.htm)
		 Метод ExtractResults
		 инициализирует процесс выгрузки результатов расчета метода главных
		 компонент.
