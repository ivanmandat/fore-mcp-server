...
## Иерархия наследования
 ...
           [IDBLookupListBox](KeExtCtrls.chm::/Interface/IDBLookupListBox/IDBLookupListBox.htm)


           [DBLookupListBox](KeExtCtrls.chm::/Class/DBLookupListBox/DBLookupListBox.htm)


## Описание


Компонент DBLookupListBox позволяет
 ...
 Данные отображаются посредством стандартного компонента [ListBox](../01_Standart_Components/ListBox.htm).


Список в DBLookupListBox формируется
...
Если свойство [DataField](KeExtCtrls.chm::/Interface/IDBLookupControl/IDBLookupControl.DataField.htm)
 в компоненте DBLookupListBox указывает
 на поле поиска, то зависимость между значением поля и списком поиска устанавливается
...
## Свойства компонента DBLookupListBox
		 ...
		 ![](../../Property_Image.gif)
		 [RowCount](KeExtCtrls.chm::/Interface/IDBLookupListBox/IDBLookupListBox.RowCount.htm)
		 Свойство RowCount определяет
		 количество отображаемых строк компонента.
...
## Методы компонента DBLookupListBox
...
## События компонента DBLookupListBox
