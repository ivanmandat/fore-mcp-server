...
## Иерархия наследования
 ...
           [IChartBox](Chart.chm::/Interface/IChartBox/IChartBox.htm)


           [ChartBox](Chart.chm::/Class/ChartBox/ChartBox.htm)


## Описание


Компонент ChartBox предназначен для отображения диаграмм.


## Работа с компонентом


Источником данных для ChartBox могут являться компоненты [UiChart](UiChart.htm), [UiErAnalyzer](UiErAnalyzer.htm).


Примечание. Если для нескольких компонентов ChartBox источником данных является один и тот же объект, то выделение компонентов диаграммы, отображение подсказок и т.д. происходит некорректно. Поэтому следует для каждого компонента ChartBox использовать отдельный источник данных.
...
## Свойства компонента ChartBox
		 ...
		 ![](../../Property_Image.gif)
		 [Chart](Chart.chm::/Interface/IChartBox/IChartBox.Chart.htm)
		 Свойство Chart определяет
		 диаграмму, отображаемую в компоненте.
		 ...
		 ![](../../Property_Image.gif)
		 [Source](Chart.chm::/Interface/IChartBox/IChartBox.Source.htm)
