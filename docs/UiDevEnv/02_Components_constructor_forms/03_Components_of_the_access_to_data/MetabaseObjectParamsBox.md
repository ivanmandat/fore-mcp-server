# MetabaseObjectParamsBox: Компонент

MetabaseObjectParamsBox: Компонент
-


# MetabaseObjectParamsBox
...
## Иерархия наследования
 ...
           [IMetabaseObjectParamsBox](KeExtCtrls.chm::/Interface/IMetabaseObjectParamsBox/IMetabaseObjectParamsBox.htm)


           [MetabaseObjectParamsBox](KeExtCtrls.chm::/Class/MetabaseObjectParamsBox/MetabaseObjectParamsBox.htm)


## Описание


Компонент MetabaseObjectParamsBox реализует редактор параметров объекта репозитория.


## Работа с компонентом


Компонент позволяет редактировать список параметров и их настройки для какого-либо объекта репозитория. Для работы компонента задайте в инспекторе объектов свойство [Object](KeExtCtrls.chm::/Interface/IMetabaseObjectParamsBox/IMetabaseObjectParamsBox.Object.htm). При запуске формы объект автоматически будет открыт на редактирование. Для настройки списка параметров используйте кнопки «Добавить», «Удалить» и «Редактировать». После редактирования параметров для сохранения внесенных изменений в прикладном коде для заданного объекта необходимо вызвать метод [Save](KeSom.chm::/Interface/IMetabaseObject/IMetabaseObject.Save.htm).


## Пример


![](MetabaseObjectParamsBox_Sample.gif)


## Свойства компонента MetabaseObjectParamsBox
...
## Методы компонента MetabaseObjectParamsBox
...
## События компонента MetabaseObjectParamsBox
