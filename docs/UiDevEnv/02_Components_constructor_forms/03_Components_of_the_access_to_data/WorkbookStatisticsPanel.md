# WorkbookStatisticsPanel: Компонент

WorkbookStatisticsPanel: Компонент
-


# WorkbookStatisticsPanel
...
## Иерархия наследования
 ...
           [IWorkbookStatisticsPanel](KeExpress.chm::/Interface/IWorkbookStatisticsPanel/IWorkbookStatisticsPanel.htm)


           [WorkbookStatisticsPanel](KeExpress.chm::/Class/WorkbookStatisticsPanel/WorkbookStatisticsPanel.htm)


## Описание


Компонент WorkbookStatisticsPanel
 предназначен для отображения панели статистик, рассчитанных для рядов
 в рабочей книге.
...
Для работы компонента необходимо в свойстве [Analyzer](KeExpress.chm::/Interface/IWorkbookStatisticsPanel/IWorkbookStatisticsPanel.Analyzer.htm)
 задать источник данных, подключенный к рабочей книге. В качестве значения
 свойства указывается компонент [UiErAnalyzer](UiErAnalyzer.htm).
 Если к указываемому [UiErAnalyzer](UiErAnalyzer.htm)
 подключен компонент [LanerBox](LanerBox.htm),
 то расчет статистик будет происходить по выделенным в нем данным, иначе
 расчет происходит по данным всех рядов, добавленных в рабочую книгу.


## Пример


![](WorkbookStatisticsPanel_Sample.gif)


## Свойства компонента WorkbookStatisticsPanel
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](KeExpress.chm::/Interface/IWorkbookStatisticsPanel/IWorkbookStatisticsPanel.Analyzer.htm)
...
## Методы компонента WorkbookStatisticsPanel
...
## События компонента WorkbookStatisticsPanel
