...
## Иерархия наследования
 ...
           [IBevel](ModForms.chm::/Interface/IBevel/IBevel.htm)


           [Bevel](ModForms.chm::/Class/Bevel/Bevel.htm)


## Описание


Компонент Bevel используется для визуального выделения групп элементов или отделения их друг от друга.


## Работа с компонентом


Компонент Bevel не является контейнером для других компонентов. Визуально он всегда отображается на заднем плане. После вставки компонента на форму в свойстве [Shape](ModForms.chm::/Interface/IBevel/IBevel.Shape.htm) выберите фигуру, которая будет отображена в компоненте.
...
## Свойства компонента Bevel
 ...
 ![](../../Property_Image.gif)
 [Shape](ModForms.chm::/Interface/IBevel/IBevel.Shape.htm)
 Свойство Shape определяет внешний вид компонента.
 ...
 ![](../../Property_Image.gif)
 [Style](ModForms.chm::/Interface/IBevel/IBevel.Style.htm)
 Свойство Style определяет стиль компонента.
