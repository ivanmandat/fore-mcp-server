...
## Иерархия наследования
 ...
           [MonthCalendar](ModForms.chm::/Class/MonthCalendar/MonthCalendar.htm)


## Описание


Компонент MonthCalendar реализует
 развернутый календарь, позволяющий редактировать значение даты. В календаре
 поддерживаются даты в диапазоне 01.01.1601-31.12.9999.
...
Язык, используемый для отображения текста различных элементов компонента,
 зависит от региональных настроек, установленных в операционной системе.


Используя свойство [Colors](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.Colors.htm)
 можно изменить оформление различных элементов календаря.


Примечание.
 Изменение цветового оформления календаря не доступно в операционной системе
 Windows 7 при использовании темы оформления Aero и в более поздних операционных
 системах.
...
![](MonthCalendar_Sample.gif)


## Свойства, унаследованные от [IMonthCalendar](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.htm)
...
## Свойства, унаследованные от [ICommonCalendar](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.htm)
...
## События, унаследованные от [ICommonCalendar](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.htm)
