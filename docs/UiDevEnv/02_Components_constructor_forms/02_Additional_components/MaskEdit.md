...
## Иерархия наследования
 ...
           [IMaskEdit](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.htm)


           [MaskEdit](ModForms.chm::/Class/MaskEdit/MaskEdit.htm)


## Описание


Компонент MaskEdit представляет собой специализированный редактор, предназначенный для ввода данных, соответствующих некоторому шаблону.


## Работа с компонентом


Шаблон задается в свойстве [InputTemplate](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.InputTemplate.htm). Маска, определяющая доступные данные при вводе, задается в свойстве [Mask](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.Mask.htm). Для работы компонента в соответствии с установленным шаблоном и маской необходимо свойству [MaskEnabled](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.MaskEnabled.htm) установить значение True. Доступ к введенному значению осуществляется посредством свойства [Text](ModForms.chm::/Interface/IControl/IControl.Text.htm).


## Пример


В режиме дизайнера формы, после настройки компонентов:


![](MaskEdit_Sample1.gif)


После запуска формы и ввода значений:


 ![](MaskEdit_Sample2.gif)


## Свойства компонента MaskEdit
 ...
 Свойство AutoSelect определяет, будет ли выделяться текст компонента, при получении компонентом фокуса.
 ...
 ![](../../Property_Image.gif)
 [InputTemplate](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.InputTemplate.htm)
 Свойство InputTemplate определяет шаблон, в соответствии с которым будут вводиться данные в редактор компонента.
 ...
 ![](../../Property_Image.gif)
 [Mask](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.Mask.htm)
 Свойство Mask определяет маску поля ввода, указывающую доступные данные при вводе.


 ![](../../Property_Image.gif)
 [MaskEnabled](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.MaskEnabled.htm)
 Свойство MaskEnabled определяет, будет ли компонент работать в режиме ввода данных в соответствии с установленным шаблоном и маской ввода.
 ...
 Свойство PasswordChar определяет символ, который замещает фактические символы, вводимые пользователем.


 ![](../../Property_Image.gif)
 [PlaceholderChar](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.PlaceholderChar.htm)
 Свойство PlaceholderChar определяет символ, используемый в шаблоне для указания позиций, предназначенных для ввода данных.
 ...
 ![](../../Property_Image.gif)
 [ValidChars](ModForms.chm::/Interface/IMaskEdit/IMaskEdit.ValidChars.htm)
 Свойство ValidChars определяет набор символов, которые пользователь может вводить в поле ввода.
