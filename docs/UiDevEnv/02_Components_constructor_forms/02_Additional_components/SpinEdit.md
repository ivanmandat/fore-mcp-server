...
## Иерархия наследования
 ...
           [SpinEdit](ModForms.chm::/Class/SpinEdit/SpinEdit.htm)


## Описание


Компонент SpinEdit представляет собой комбинацию однострочного поля редактирования и кнопок для изменения значения.


## Работа с компонентом


Компонент позволяет отображать и редактировать различные данные (текстовые и числовые). В отличие от других редакторов ([FloatEdit](FloatEdit.htm), [IntegerEdit](IntegerEdit.htm)), которые изменяют значения с заданным шагом, в компоненте SpinEdit шаг и результирующее значение определяются по алгоритму пользователя. Данный алгоритм должен быть реализован в обработчиках событий [OnSpinDown](ModForms.chm::/Class/SpinEdit/SpinEdit.OnSpinDown.htm) и [OnSpinUp](ModForms.chm::/Class/SpinEdit/SpinEdit.OnSpinUp.htm). В указанных обработчиках результирующее значение должно быть установлено в свойстве [Text](ModForms.chm::/Interface/IControl/IControl.Text.htm) компонента.
...
## События компонента SpinEdit
 ...
 Событие OnSpinDown происходит непосредственно при нажатии кнопки SpinDown в поле редактирования.


 ![](../../Event_Image.gif)
 [OnSpinUp](ModForms.chm::/Class/SpinEdit/SpinEdit.OnSpinUp.htm)
 Событие OnSpinUp происходит непосредственно при нажатии кнопки SpinUp в поле редактирования.
