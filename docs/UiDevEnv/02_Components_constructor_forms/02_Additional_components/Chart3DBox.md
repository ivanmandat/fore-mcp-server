...
## Иерархия наследования
 ...
           [IChart3DBox](Chart.chm::/Interface/IChart3DBox/IChart3DBox.htm)


           [Chart3DBox](Chart.chm::/Class/Chart3DBox/Chart3DBox.htm)


## Описание


Компонент Chart3DBox предназначен для отображения трехмерных сцен.


## Работа с компонентом


Построение изображений на трехмерной схеме осуществляется посредством языка Fore. Доступ ко всем объектам осуществляется через свойства [Scene](Chart.chm::/Interface/IChart3DBox/IChart3DBox.Scene.htm).


Для изменения ракурса системы координат необходимо в области компонента зажать кнопку мыши и перемещая мышь выбрать необходимый вид. Изменение масштаба осуществляется при прокрутке колеса мыши, либо если при нажатой клавише SHIFT осуществлять перемещение мыши вверх/вниз.


Для фигур, представляющих собой плоскость сечения, предусмотрена возможность перемещения с помощью мыши. Для этого необходимо выделить плоскость (программно, либо с помощью мыши). Удерживая клавишу CTRL, переместить мышь вверх/вниз. Перемещение будет осуществляться вдоль оси, расположенной перпендикулярно плоскости сечения.


## Пример


![](Chart3DBox_Sample.gif)


## Свойства компонента Chart3DBox
 ...
 ![](../../Property_Image.gif)
 [BorderStyle](Chart.chm::/Interface/IChart3DBox/IChart3DBox.BorderStyle.htm)
 ...
 ![](../../Property_Image.gif)
 [Scene](Chart.chm::/Interface/IChart3DBox/IChart3DBox.Scene.htm)
 Свойство Scene возвращает интерфейс, реализующий свойства и методы трехмерной сцены.
...
## События компонента Chart3DBox
 ...
 ![](../../Event_Image.gif)
 [OnSeriesDoubleClick](Chart.chm::/Class/Chart3DBox/IChart3DBoxEvents.OnSeriesDoubleClick.htm)
 Событие OnSeriesDoubleClick наступает при двойном щелчке кнопкой мыши по ряду сцены на форме.
