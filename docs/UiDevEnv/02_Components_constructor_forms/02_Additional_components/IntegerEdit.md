...
## Иерархия наследования
 ...
           [IEditBox](ModForms.chm::/Interface/IEditBox/IEditBox.htm)


           [IEditBoxEx](ModForms.chm::/Interface/IEditBoxEx/IEditBoxEx.htm)


           [ISpinEdit](ModForms.chm::/Interface/ISpinEdit/ISpinEdit.htm)


           [IIntegerEdit](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.htm)


           [IntegerEdit](ModForms.chm::/Class/IntegerEdit/IntegerEdit.htm)


## Описание


Компонент IntegerEdit представляет собой однострочный редактор целых чисел.


## Работа с компонентом


Компонент позволяет задавать целочисленные значения в диапазоне [[Integer.MinValue](ForeSys.chm::/Class/Integer/Integer.MinValue.htm); [Integer.MaxValue](ForeSys.chm::/Class/Integer/Integer.MaxValue.htm)]. При необходимости допустимый диапазон можно уменьшить, определив для компонента значения свойств [MinValue](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.MinValue.htm) и [MaxValue](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.MaxValue.htm).


Значение в компонент можно ввести с клавиатуры либо выставить с помощью кнопок. Шаг изменения значения при нажатии кнопок постоянный и равен единице.


При вводе некорректного значения, выходящего за границы допустимого диапазона, после потери компонентом фокуса значение будет скорректировано. Порядок корректировки определяет свойство [CorrectOnExit](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.CorrectOnExit.htm).


## Пример


![](IntegerEdit_Sample.gif)


## Свойства компонента IntegerEdit
...
[AllowEmpty](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.AllowEmpty.htm)


 Свойство AllowEmpty определяет возможность наличия пустого значения в компоненте.
...
[AutoSelect](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.AutoSelect.htm)
 ...
 Свойство AutoSelect определяет, будет ли выделен весь текст компонента, при получении компонентом фокуса.
...
[CanUndo](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.CanUndo.htm)
 ...
 Свойство CanUndo возвращает True, если существует возможность отменить изменения текста в компоненте.
...
[CharacterCasing](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.CharacterCasing.htm)
 ...
 Свойство CharacterCasing определяет регистр вводимых символов компонента.
...
[CorrectOnExit](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.CorrectOnExit.htm)
...
[EditorReadOnly](ModForms.chm::/Interface/ISpinEdit/ISpinEdit.EditorReadOnly.htm)
...
[HideSelection](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.HideSelection.htm)
 ...
 Свойство HideSelection определяет, будет ли выделенный текст компонента оставаться таковым, при передаче фокуса другому компоненту.
...
[MaxValue](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.MaxValue.htm)


 Свойство MaxValue определяет максимальное значение числа, которое можно установить в компоненте.


 ![](../../Property_Image.gif)

[MinValue](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.MinValue.htm)


 Свойство MinValue определяет минимальное значение числа, которое можно установить в компоненте.
...
[Modified](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.Modified.htm)
 ...
 Свойство Modified возвращает True, если производилось изменение текста компонента.
...
[PasswordChar](ModForms.chm::/Interface/IEditBox/IEditBox.PasswordChar.htm)


 Свойств PasswordChar определяет символ, который замещает фактические символы, вводимые пользователем.
...
[ReadOnly](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.ReadOnly.htm)
 ...
 Свойство ReadOnly определяет, может ли пользователь изменять текст компонента.
...
[SelStart](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.SelStart.htm)
 ...
 Свойство SelStart определяет позицию, в которой расположен курсор и начинается выделение текста в компоненте.
...
[SelText](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.SelText.htm)
 ...
 Свойство SelText определяет текст, выделенный в компоненте.
...
[ThousandSeparator](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.ThousandSeparator.htm)


 Свойство ThousandSeparator определяет, будет ли отображаться значение в компоненте с использованием разделителя групп разрядов.
...
[Valid](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.Valid.htm)
...
[Value](ModForms.chm::/Interface/IIntegerEdit/IIntegerEdit.Value.htm)


 Свойство Value определяет текущее значение целого числа, введенного в поле редактирования.
...
[Clear](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.Clear.htm)
 ...
 Метод Clear удаляет весь текст, содержащийся в компоненте.
...
[ClearSelection](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.ClearSelection.htm)
 ...
 Метод ClearSelection удаляет весь текст, который был выделен в компоненте.
...
[ClearUndo](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.ClearUndo.htm)
 ...
 Метод ClearUndo используется для фиксации изменений свойства Text.
...
[CopyToClipboard](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.CopyToClipboard.htm)
 ...
 Метод CopyToClipboard осуществляет копирование выделенных данных в буфер обмена.
...
[CutToClipboard](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.CutToClipboard.htm)
 ...
 Метод CutToClipboard осуществляет вырезание выделенных данных и помещает их в буфер обмена.
...
[PasteFromClipboard](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.PasteFromClipboard.htm)
 ...
 Метод PasteFormClipboard осуществляет вставку данных из буфера обмена.
...
[SelectAll](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.SelectAll.htm)
 ...
 Метод SelectAll осуществляет выделение текста компонента.
...
[Undo](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.Undo.htm)
 ...
 Метод Undo осуществляет отмену последнего изменения текста в компоненте.


## События компонента IntegerEdit
...
[OnChange](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.OnChange.htm)
 ...
 Событие OnChange наступает после изменений свойства Text компонента.
...
[OnSpinDown](ModForms.chm::/Class/SpinEdit/SpinEdit.OnSpinDown.htm)


 Событие OnSpinDown наступает непосредственно при нажатии кнопки SpinDown в поле редактирования.


 ![](../../Event_Image.gif)

[OnSpinUp](ModForms.chm::/Class/SpinEdit/SpinEdit.OnSpinUp.htm)


 Событие OnSpinUp наступает непосредственно при нажатии кнопки SpinUp в поле редактирования.


 ![](../../Event_Image.gif)

[OnValueChange](ModForms.chm::/Class/IntegerEdit/IntegerEdit.OnValueChange.htm)


 Событие OnValueChange происходит при изменении значения в поле редактирования.
