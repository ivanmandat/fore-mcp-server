...
## Иерархия наследования
 ...
           [IExpressionEdit](KeExtCtrls.chm::/Interface/IExpressionEdit/IExpressionEdit.htm)


           [ICalcCubeFormulaEdit](KeExtCtrls.chm::/Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.htm)


           [CalcCubeFormulaEdit](KeExtCtrls.chm::/Class/CalcCubeFormulaEdit/CalcCubeFormulaEdit.htm)


## Описание


Компонент CalcCubeFormulaEdit
 представляет собой редактор формул вычисляемого куба.


## Работа с компонентом


Для работы с компонентом необходимо в свойстве [Cube](KeExtCtrls.chm::/Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.Cube.htm)
 установить вычисляемый куб, на базе координат которого, будут составляться
 выражения. Дальнейшая работа по созданию выражения аналогична работе с
 выражением компонента [TermEdit](TermEdit.htm).


Метод [PutCoord](KeExtCtrls.chm::/Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.PutCoord.htm)
 позволяет создать и добавить в выражение терм, соответствующий указанной
 координате куба. [Текст](ModForms.chm::/Interface/ITerm/ITerm.Text.htm)
 такого терма будет составлен из наименований элементов измерений соответствующих
 [координате](KeCubes.chm::/Interface/ICalculatedCubeInstanceCoord/ICalculatedCubeInstanceCoord.AsString.htm),
 а [формула терма](ModForms.chm::/Interface/ITerm/ITerm.Formula.htm)
 будет соответствовать [внутреннему
 представлению](KeCubes.chm::/Interface/ICalculatedCubeInstanceCoord/ICalculatedCubeInstanceCoord.AsTerm.htm) соответствующей координаты. Конечное выражение, которое
 можно использовать в качестве формулы вычисляемого куба, доступно в свойстве
 [Formula](ModForms.chm::/Interface/ITermEdit/ITermEdit.Formula.htm).


Примечание.
 Отличием компонентов CalcCubeFormulaEdit
 и [CalcCubeFormulaEditEx](CalcCubeFormulaEditEx.htm)
 является их внутренняя реализация.


## Свойства компонента CalcCubeFormulaEdit
		 ...
		 ![](../../Property_Image.gif)
		 [AutoReparsing](ModForms.chm::/Interface/ITermEdit/ITermEdit.AutoReparsing.htm)


		 Свойство AutoReparsing
		 определяет, будет ли производиться автоматическое преобразование
		 текста в термы (выражения) и знаки операции.
		 ...
		 ![](../../Property_Image.gif)
		 [Cube](KeExtCtrls.chm::/Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.Cube.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DirectInput](ModForms.chm::/Interface/ITermEdit/ITermEdit.DirectInput.htm)


		 Свойство DirectInput
		 определяет возможность прямого ввода.
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](KeExtCtrls.chm::/Interface/IExpressionEdit/IExpressionEdit.Expression.htm)
		 ...
		 Свойство Hyperlink
		 определяет, является ли выражение гиперссылкой.
		 ...
		 будут ли переноcиться слова длинной надписи, превышающие длину
		 компонента, на новую строку.


## Методы компонента CalcCubeFormulaEdit
		 ...
		 Метод Clear удаляет
		 все записи, занесенные в поле редактирования.
		 ...
		 ![](../../Sub_Image.gif)
		 [PutCoord](KeExtCtrls.chm::/Interface/ICalcCubeFormulaEdit/ICalcCubeFormulaEdit.PutCoord.htm)


		 Метод PutCoord позволяет
		 поместить в редактор терм, соответствующий указанной координате
		 куба.
		 ...
		 ![](../../Sub_Image.gif)
		 [UpdateExpression](KeExtCtrls.chm::/Interface/IExpressionEdit/IExpressionEdit.UpdateExpression.htm)


		 Метод UpdateExpression
		 обновляет выражение.


## События компонента CalcCubeFormulaEdit
		 ...
		 ![](../../Event_Image.gif)
		 [OnFormatCoord](KeExtCtrls.chm::/Class/CalcCubeFormulaEdit/CalcCubeFormulaEdit.OnFormatCoord.htm)


		 Событие OnFormatCoord
		 возникает при создании терма, соответствующего координате куба.
