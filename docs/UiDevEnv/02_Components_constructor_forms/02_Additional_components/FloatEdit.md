...
## Иерархия наследования
 ...
           [IFloatEdit](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.htm)


           [FloatEdit](ModForms.chm::/Class/FloatEdit/FloatEdit.htm)


## Описание


Компонент FloatEdit представляет
 собой однострочный редактор вещественных чисел.


## Работа с компонентом


Компонент позволяет задавать вещественные значения в диапазоне [[Double.MinValue](ForeSys.chm::/Class/Double/Double.MinValue.htm);
 [Double.MaxValue](ForeSys.chm::/Class/Double/Double.MaxValue.htm)].
 При необходимости допустимый диапазон можно уменьшить, определив для компонента
 значения свойств [MinValue](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.MinValue.htm)
 и [MaxValue](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.MaxValue.htm).


Значение в компонент можно ввести с клавиатуры либо выставить с помощью
 кнопок. Шаг изменения значения при нажатии кнопок задается в свойстве
 [StepSize](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.StepSize.htm).
 Количество разрядов, отображаемых в значениях после запятой, задается
 в свойстве [Precision](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.Precision.htm).


При вводе некорректного значения, выходящего за границы допустимого
 диапазона, после потери компонентом фокуса значение будет скорректировано.
 Порядок корректировки определяет свойство [CorrectOnExit](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.CorrectOnExit.htm).


При наличии фокуса у компонента его значение отображается без разделителей
 разрядов. Значение с разделителями разрядов отображается только при отсутствии
 фокуса.
...
![](FloatEdit_Sample.gif)


## Свойства компонента FloatEdit
		 ...
		 ![](../../Property_Image.gif)
		 [AllowEmpty](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.AllowEmpty.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxValue](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.MaxValue.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MinValue](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.MinValue.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Precision](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.Precision.htm)
		 ...
		 редактирования, при использовании кнопок SpinUp и SpinDown для изменения
		 значения.
		 ...
		 ![](../../Property_Image.gif)
		 [ThousandSeparator](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.ThousandSeparator.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TrailingZeros](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.TrailingZeros.htm)


		 Свойство TrailingZeros
		 определяет признак отображения нулей после запятой, при Precision больше нуля.


		 ![](../../Property_Image.gif)
		 [Valid](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.Valid.htm)


		 Свойство Valid определяет
		 корректность числа, введенного в поле редактирования.


		 ![](../../Property_Image.gif)
		 [Value](ModForms.chm::/Interface/IFloatEdit/IFloatEdit.Value.htm)
...
## События компонента FloatEdit
		 ...
		 Событие OnSpinDown
		 происходит непосредственно при нажатии кнопки SpinDown
		 ...
		 непосредственно при нажатии кнопки SpinUp
		 в поле редактирования.


		 ![](../../Event_Image.gif)
		 [OnValueChange](ModForms.chm::/Class/FloatEdit/FloatEdit.OnValueChange.htm)
