...
## Иерархия наследования
 ...
           [IDateTimePicker](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.htm)


           [DateTimePicker](ModForms.chm::/Class/DateTimePicker/DateTimePicker.htm)


## Описание


Компонент DateTimePicker реализует
...
## Свойства компонента DateTimePicker
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.Alignment.htm)
		 Свойство Alignment
		 ...
		 ![](../../Property_Image.gif)
		 [AllowEmpty](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.AllowEmpty.htm)
		 Свойство AllowEmpty
		 определяет возможность очистки даты нажатием кнопки DELETE.
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Checked](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.Checked.htm)
		 Свойство Checked определяет
		 признак отметки флага компонента.
		 ...
		 ![](../../Property_Image.gif)
		 [DateFormat](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.DateFormat.htm)
		 Свойство DateFormat
		 определяет формат отображения даты в компоненте.


		 ![](../../Property_Image.gif)
		 [DateMode](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.DateMode.htm)
		 Свойство DateMode определяет
		 внешний вид компонента.


		 ![](../../Property_Image.gif)
		 [DroppedDown](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.DroppedDown.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Format](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.Format.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IsEmpty](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.IsEmpty.htm)
		 Свойство IsEmpty возвращает
		 признак изменения даты в компоненте.


		 ![](../../Property_Image.gif)
		 [IsValidDate](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.IsValidDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Kind](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.Kind.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowCheckbox](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.ShowCheckbox.htm)
		 Свойство ShowCheckBox
		 определяет, будет ли отображаться компонент [CheckBox](../01_Standart_Components/CheckBox.htm)
		 в окне компонента.
...
## Методы компонента DateTimePicker
		 ...
		 ![](../../Sub_Image.gif)
		 [Reset](ModForms.chm::/Interface/IDateTimePicker/IDateTimePicker.Reset.htm)
...
## События компонента DateTimePicker
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ModForms.chm::/Class/DateTimePicker/DateTimePicker.OnChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnCloseUp](ModForms.chm::/Class/DateTimePicker/DateTimePicker.OnCloseUp.htm)
		 Событие OnCloseUp наступает
		 после сворачивания листа календаря.
		 ...
		 Событие OnDropDown
		 наступает непосредственно после развертывания листа календаря.
