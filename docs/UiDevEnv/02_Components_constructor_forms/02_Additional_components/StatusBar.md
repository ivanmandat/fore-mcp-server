...
## Иерархия наследования
 ...
           [IStatusBar](ModForms.chm::/Interface/IStatusBar/IStatusBar.htm)


           [StatusBar](ModForms.chm::/Class/StatusBar/StatusBar.htm)


## Описание


Компонент StatusBar предназначен для создания панелей состояния, расположенных в нижней части основной формы.


## Работа с компонентом


Компонент строится из нескольких панелей, а также кнопки изменения размеров окна. Принцип организации панелей следующий:


-
Если компонент имеет только одну панель, то она располагается с левой стороны;


-
Если компонент имеет несколько панелей, то первая панель располагается с левой стороны, а остальные панели ориентированы относительно правой стороны. Панель, созданная раньше, будет располагаться левее остальных.


Используя свойства [ImageIndex](ModForms.chm::/Interface/IStatusBarPane/IStatusBarPane.ImageIndex.htm) и [Text](ModForms.chm::/Interface/IStatusBarPane/IStatusBarPane.Text.htm) можно задать изображение и текст, отображаемые в каждой панели. Изображения должны быть загружены в компонент, заданный в свойстве [Images](ModForms.chm::/Interface/IStatusBar/IStatusBar.Images.htm) компонента StatusBar.


## Пример


![](StatusBar_Sample.gif)


## Свойства компонента StatusBar
 ...
 ![](../../Property_Image.gif)
 [Images](ModForms.chm::/Interface/IStatusBar/IStatusBar.Images.htm)
 Свойство Images определяет компонент [ImageList](ImageList.htm) , изображения которого будут отображаться в панелях компонента StatusBar.
 ...
 ![](../../Property_Image.gif)
 [Panes](ModForms.chm::/Interface/IStatusBar/IStatusBar.Panes.htm)
 Свойство Panes возвращает коллекцию панелей компонента.
 ...
 ![](../../Property_Image.gif)
 [SimplePane](ModForms.chm::/Interface/IStatusBar/IStatusBar.SimplePane.htm)
 Свойство SimplePane определяет возможность создания нескольких панелей.


 ![](../../Property_Image.gif)
 [SizeGrip](ModForms.chm::/Interface/IStatusBar/IStatusBar.SizeGrip.htm)
 Свойство SizeGrip определяет, будет ли в компоненте отображаться кнопка изменения размеров окна.
...
## Методы компонента StatusBar
 ...
 Метод SetFocus устонавливает фокус на данный компонент.


## События компонента StatusBar
