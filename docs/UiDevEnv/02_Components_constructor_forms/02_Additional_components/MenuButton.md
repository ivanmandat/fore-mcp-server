...
## Иерархия наследования
 ...
           [IMenuButton](ModForms.chm::/Interface/IMenuButton/IMenuButton.htm)


           [MenuButton](ModForms.chm::/Class/MenuButton/MenuButton.htm)


## Описание


Компонент MenuButton представляет собой кнопку с всплывающим меню.


## Работа с компонентом


Для работы компонента необходимо в свойстве [Menu](ModForms.chm::/Interface/IMenuButton/IMenuButton.Menu.htm) указать контекстное меню, которое будет отображено при нажатии на кнопку. В список допустимых значений данного свойства входят все компоненты [PopupMenu](../01_Standart_Components/PopupMenu.htm), расположенные на форме.
...
![](MenuButton_Sample1.gif)


После запуска формы и нажатия на кнопку:


 ![](MenuButton_Sample2.gif)


## Свойства компонента MenuButton
 ...
 ![](../../Property_Image.gif)
 [Menu](ModForms.chm::/Interface/IMenuButton/IMenuButton.Menu.htm)
 Свойства Menu определяет пользовательское меню, который будет отображаться при нажатии на кнопку.
 ...
 ![](../../Property_Image.gif)
 [RightArrow](ModForms.chm::/Interface/IMenuButton/IMenuButton.RightArrow.htm)
 ...
 ![](../../Property_Image.gif)
 [StayPressed](ModForms.chm::/Interface/IMenuButton/IMenuButton.StayPressed.htm)
