...
## Иерархия наследования
 ...
           [ISearchEdit](ModForms.chm::/Interface/ISearchEdit/ISearchEdit.htm)


           [SearchEdit](ModForms.chm::/Class/SearchEdit/SearchEdit.htm)


## Описание


Компонент SearchEdit предназначен
 для указания текста, по которому может быть осуществлен поиск.


## Комментарии


Компонент представляет собой редактор текста, аналогичный компоненту
 [EditBox](../01_Standart_Components/EditBox.htm).
 В области компонента реализована кнопка для очистки указанного текста.
 Для запуска процесса поиска вызовите метод [Search](ModForms.chm::/Interface/ISearchEdit/ISearchEdit.Search.htm). Компонент
 не возвращает какой-либо результат поиска, указание в свойстве [Timeout](ModForms.chm::/Interface/ISearchEdit/ISearchEdit.Timeout.htm) предельного
 времени поиска позволяет отследить его превышение. При превышении заданного
 времени для компонента будет сгенерировано событие [OnSearch](ModForms.chm::/Class/SearchEdit/SearchEdit.OnSearch.htm).


Для получения результатов BI-поиска используйте компонент SearchEdit
 в комбинации с компонентом [SearchDataSourcesBox](SearchDataSourcesBox.htm).
...
## Свойства компонента SearchEdit
		 ...
		 ![](../../Property_Image.gif)
		 [Timeout](ModForms.chm::/Interface/ISearchEdit/ISearchEdit.Timeout.htm)
...
## Методы компонента SearchEdit
		 ...
		 ![](../../Sub_Image.gif)
		 [Search](ModForms.chm::/Interface/ISearchEdit/ISearchEdit.Search.htm)
...
## События компонента SearchEdit
		 ...
		 Событие OnKeyDown
		 наступает, если компонент находится в фокусе и производится нажатие
		 на клавиатуру.
		 ...
		 ![](../../Event_Image.gif)
		 [OnSearch](ModForms.chm::/Class/SearchEdit/SearchEdit.OnSearch.htm)
