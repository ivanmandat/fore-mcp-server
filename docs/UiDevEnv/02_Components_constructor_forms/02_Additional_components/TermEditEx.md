...
## Иерархия наследования
 ...
           [TermEditEx](ModForms.chm::/Class/TermEditEx/TermEditEx.htm)


## Описание


Компонент TermEditEx является
 аналогом компонента [TermEdit](TermEdit.htm). Работа с компонентом
 осуществляется аналогично работе с компонентом [TermEdit](TermEdit.htm).


Примечание.
 Отличием компонентов [TermEdit](TermEdit.htm)
 и TermEditEx является их внутренняя
 реализация.


## Свойства компонента TermEditEx
