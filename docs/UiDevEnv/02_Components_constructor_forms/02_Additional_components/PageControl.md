...
## Иерархия наследования
 ...
           [IPageControl](ModForms.chm::/Interface/IPageControl/IPageControl.htm)


           [PageControl](ModForms.chm::/Class/PageControl/PageControl.htm)


## Описание


Компонент PageControl является
 многостраничной панелью, которая позволяет экономить пространство окна
 приложения, размещая на одном и том же месте страницы разного содержания.


## Работа с компонентом


Выбор страницы производится щелчком на соответствующей вкладке либо
 с помощью сочетания клавиш CTRL+TAB (следующая страница), CTRL+SHIFT+TAB
 (предыдущая страница).


Во время проектирования работу со страницами проще всего производить,
 щелкнув на компоненте правой кнопкой мыши и выбрав из контекстного меню
 соответствующий раздел: «Добавить страницу»
 - создать новую страницу, «Удалить страницу»
 - удалить текущую страницу. Каждая создаваемая страница является объектом
 класса [PageControlSheet](ModForms.chm::/Class/PageControlSheet/PageControlSheet.htm).
...
## Свойства компонента PageControl
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveSheet](ModForms.chm::/Interface/IPageControl/IPageControl.ActiveSheet.htm)
		 Свойство ActivePage
		 ...
		 ![](../../Property_Image.gif)
		 [HotTrack](ModForms.chm::/Interface/IPageControl/IPageControl.HotTrack.htm)
		 Свойство HotTrack определяет,
		 отображается ли надпись на вкладке другим цветом, когда над ней
		 перемещается указатель мыши.


		 ![](../../Property_Image.gif)
		 [Images](ModForms.chm::/Interface/IPageControl/IPageControl.Images.htm)
		 Свойство Images определяет
		 наименование компонента [ImageList](ImageList.htm) , изображения
		 которого, будут использоваться в компоненте.
		 ...
		 ![](../../Property_Image.gif)
		 [MultiLine](ModForms.chm::/Interface/IPageControl/IPageControl.MultiLine.htm)
		 Свойство MultiLine
		 ...
		 ![](../../Property_Image.gif)
		 [Pages](ModForms.chm::/Interface/IPageControl/IPageControl.Pages.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [RaggedRight](ModForms.chm::/Interface/IPageControl/IPageControl.RaggedRight.htm)
		 Свойство RaggetRighd
		 определяет возможность изменения ширины вкладок компонента для
		 выравнивания их по правому краю компонента.


		 ![](../../Property_Image.gif)
		 [ScrollOpposite](ModForms.chm::/Interface/IPageControl/IPageControl.ScrollOpposite.htm)
		 ...
		 [Style](ModForms.chm::/Interface/IPageControl/IPageControl.Style.htm)
		 Свойство Style определяет
		 внешний вид вкладок компонента.
		 ...
		 ![](../../Property_Image.gif)
		 [TabPosition](ModForms.chm::/Interface/IPageControl/IPageControl.TabPosition.htm)
		 Свойство TabPosition
		 определяет место расположения вкладок компонента.
...
## События компонента PageControl
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ModForms.chm::/Class/PageControl/PageControl.OnChange.htm)
		 Событие OnChange наступает
		 после выбора другой вкладки.


		 ![](../../Event_Image.gif)
		 [OnChanging](ModForms.chm::/Class/PageControl/PageControl.OnChanging.htm)
		 Событие OnChanging
