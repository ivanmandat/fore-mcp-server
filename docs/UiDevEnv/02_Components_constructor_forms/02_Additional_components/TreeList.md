...
## Иерархия наследования
 ...
           [TreeList](ModForms.chm::/Class/TreeList/TreeList.htm)


## Описание


Компонент TreeList служит для
 отображения ветвящихся иерархических структур, таких как дерево наследования
 объектов. Отметка элементов компонента осуществляется при щелчке, как
 по пиктограмме элемента, так и по самому элементу, либо нажатием клавиши
 «Пробел».
...
При двойном щелчке по разделительной линии колонок будет осуществляться
 ...
 экспандера, флажка, пиктограмма и пиктограмма состояния, текст вершины).
...
При удачном поиске курсор будет фокусироваться на найденном элементе.
 ...
 режима множественной отметки](ModForms.chm::/Interface/ITreeControl/ITreeControl.SelectionMode.htm) добавление элемента в отметку осуществляется
 выделением с использованием клавиши ПРОБЕЛ, либо выделением с помощью
 мыши при зажатой клавише CTRL.
...
Если для компонента свойство [ShowColumnHeaders](ModForms.chm::/Interface/ITreeControl/ITreeControl.ShowColumnHeaders.htm)
 установлено значение True, то
 в режиме выполнения возможна настройка отображения столбцов. Настройка
 производится с помощью контекстного меню, вызываемого для заголовка таблицы.


![](TreelistChooseColumn.gif)
...
## Свойства компонента TreeList
		 ...
		 ![](../../Property_Image.gif)
		 [FilterStyle](ModForms.chm::/Interface/ITreeList/ITreeList.FilterStyle.htm)
		 ...
		 Свойство HeaderMenu
		 определяет контекстное меню, вызываемое при щелчке дополнительной
		 кнопкой мыши на заголовке колонки компонента.
...
## Методы компонента TreeList
		 ...
		 ![](../../Sub_Image.gif)
		 [NodesFilter](ModForms.chm::/Interface/ITreeList/ITreeList.NodesFilter.htm)
