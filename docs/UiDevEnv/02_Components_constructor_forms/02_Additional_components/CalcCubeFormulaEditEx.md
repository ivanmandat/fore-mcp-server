# CalcCubeFormulaEditEx: Компонент
...
## Иерархия наследования
 ...
           [CalcCubeFormulaEditEx](KeExtCtrls.chm::/Class/CalcCubeFormulaEditEx/CalcCubeFormulaEditEx.htm)


## Описание


Компонент CalcCubeFormulaEditEx
 является аналогом компонента [CalcCubeFormulaEdit](CalcCubeFormulaEdit.htm).
 Работа с компонентом осуществляется аналогично работе с компонентом [CalcCubeFormulaEdit](CalcCubeFormulaEdit.htm).


Примечание.
 Отличием компонентов [CalcCubeFormulaEdit](CalcCubeFormulaEdit.htm)
 и CalcCubeFormulaEditEx является
 их внутренняя реализация.


## Свойства компонента CalcCubeFormulaEditEx
...
## Методы компонента CalcCubeFormulaEditEx
...
## События компонента CalcCubeFormulaEditEx
