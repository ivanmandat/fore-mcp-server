...
## Иерархия наследования
 ...
           [IScrollBox](ModForms.chm::/Interface/IScrollBox/IScrollBox.htm)


           [ScrollBox](ModForms.chm::/Class/ScrollBox/ScrollBox.htm)


## Описание


Компонент ScrollBox реализует контейнер для других элементов управления с возможностью прокрутки содержимого.


## Работа с компонентом


После размещения компонента на форме в нем могут быть размещены любые другие элементы управления или контейнеры. При работе формы, если размер компонента ScrollBox изменится таким образом, что его содержимое станет полностью или частично невидимым, то у компонента автоматически появятся полосы прокрутки. Получить параметры полос прокрутки и управлять ими можно, используя свойство [Scrolls](ModForms.chm::/Interface/IControl/IControl.Scrolls.htm).


## Пример


![](ScrollBox_Sample.gif)
...
## Свойства компонента ScrollBox
 ...
 ![](../../Property_Image.gif)
 [BorderStyle](ModForms.chm::/Interface/IScrollBox/IScrollBox.BorderStyle.htm)
 ...
 ![](../../Property_Image.gif)
 [HScrollPos](ModForms.chm::/Interface/IScrollBox/IScrollBox.HScrollPos.htm)
 Свойство HScrollPos возвращает значение, представляющее текущее положение ползунка горизонтальной полосы прокрутки.
 ...
 ![](../../Property_Image.gif)
 [VScrollPos](ModForms.chm::/Interface/IScrollBox/IScrollBox.VScrollPos.htm)
 Свойство VScrollPos возвращает значение, представляющее текущее положение ползунка вертикальной полосы прокрутки.
