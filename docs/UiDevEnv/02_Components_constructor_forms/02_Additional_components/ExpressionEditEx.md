...
## Иерархия наследования
 ...
           [ExpressionEditEx](KeExtCtrls.chm::/Class/ExpressionEditEx/ExpressionEditEx.htm)


## Описание


Компонент ExpressionEditEx является
 аналогом компонента [ExpressionEdit](ExpressionEdit.htm).
 Работа с компонентом осуществляется аналогично работе с компонентом [ExpressionEdit](ExpressionEdit.htm).


Примечание.
 Отличием компонентов [ExpressionEdit](ExpressionEdit.htm)
 и ExpressionEditEx является их
 внутренняя реализация.


## Свойства компонента ExpressionEditEx
...
## Методы компонента ExpressionEditEx
...
## События компонента ExpressionEditEx
