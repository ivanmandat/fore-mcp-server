...
## Иерархия наследования
 ...
           [TermEdit](ModForms.chm::/Class/TermEdit/TermEdit.htm)
...
Компонент TermEdit представляет
 собой редактор выражений, составленных с помощью термов.


## Работа с компонентом


Данный компонент используется при составлении уравнений с использованием
 термов. Терм представляет собой
 текстовый элемент, содержащий в себе ссылку на какой-либо объект. При
 составлении уравнения в области редактирования компонента будут отображаться
 текстовые обозначения, указанные в свойстве [Text](ModForms.chm::/Interface/ITerm/ITerm.Text.htm)
 каждого терма. При вычислениях используется внутреннее представление терма,
 указанное в свойстве [Formula](ModForms.chm::/Interface/ITerm/ITerm.Formula.htm)
 каждого терма. Для термов доступна настройка цвета символов, в том числе
 при использовании терма в виде гиперссылки. Для этого предназначены свойства
 и методы терма: [CustomHyperlinkStyle](ModForms.chm::/Interface/ITerm/ITerm.CustomHyperlinkStyle.htm),
 [Color](ModForms.chm::/Interface/ITerm/ITerm.Color.htm),
 [SetTextColor](ModForms.chm::/Interface/ITerm/ITerm.SetTextColor.htm).


Общее выражение, отображаемое в компоненте, определяется свойством [Text](ModForms.chm::/Interface/IControl/IControl.Text.htm),
 а выражение, по которому будет производиться вычисление (выражение составленное
 на базе внутренних представлений (формул) термов), определяется свойством
 [Formula](ModForms.chm::/Interface/ITermEdit/ITermEdit.Formula.htm).


Для составления выражения необходимо организовать коллекцию термов,
 доступную в свойстве [Terms](ModForms.chm::/Interface/ITermEdit/ITermEdit.Terms.htm).
 Формирование выражения осуществляется путем вставки необходимых термов
 в указанные позиции. Вставка осуществляется с помощью методов [PutCustom](ModForms.chm::/Interface/ITermEdit/ITermEdit.PutCustom.htm),
 [PutLiteral](ModForms.chm::/Interface/ITermEdit/ITermEdit.PutLiteral.htm)
 и [PutTerm](ModForms.chm::/Interface/ITermEdit/ITermEdit.PutTerm.htm).


Примечание.
 Отличием компонентов TermEdit
 и [TermEditEx](TermEditEx.htm)
 является их внутренняя реализация.


## Свойства компонента TermEdit
