...
## Иерархия наследования
 ...
           [IImageBox](ModForms.chm::/Interface/IImageBox/IImageBox.htm)


           [ImageBox](ModForms.chm::/Class/ImageBox/ImageBox.htm)


## Описание


Компонент ImageBox предназначен
...
Для загрузки изображения необходимо выполнить одно из следующих действий:
	...
	- в режиме дизайнера формы дважды щелкнуть по компоненту на форме.


	- в инспекторе объектов нажать кнопку ![](../../Select_Button.gif) свойства
	 [Image](ModForms.chm::/Interface/IImageBox/IImageBox.Image.htm).


	- выполнить команду контекстного меню «Редактировать»
	 для компонента.
...
![](ImageBox_Image_Editor.gif)


При нажатии кнопки «Загрузить»
 будет выведен стандартный диалог выбора файла, который в дальнейшем будет
 отображаться в компоненте. В список доступных изображений входят файлы
 в форматах: *.bmp;*.jpg;*.jpeg;*.jpe;*.jfif;*.gif;*.png;*.tif;*.tiff.
 Если размеры выбранной картинки больше размеров окна редактирования, то
 изображение будет автоматически масштабировано.
...
Флаг «Отображать области» управляет
 отображением красных линий, отделяющих фиксированные области изображения
 от масштабированных. Фиксированные области отображаются в том виде, в
 каком они содержатся в исходном файле. Вся остальная область изображения
 масштабируется в соответствии с размерами компонента ImageBox.
 Размеры фиксированной области задаются в пикселях и ограничены размерами
 загруженного изображения.


Флаг «Растянуть изображение»
 позволяет растянуть загруженное изображение на всю область окна редактирования.


Кнопка «Сохранить» позволяет
 сохранить изображение, загруженное в компонент.
...
## Свойства компонента ImageBox
		 ...
		 ![](../../Property_Image.gif)
		 [AutoSize](ModForms.chm::/Interface/IImageBox/IImageBox.AutoSize.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Center](ModForms.chm::/Interface/IImageBox/IImageBox.Center.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Proportional](ModForms.chm::/Interface/IImageBox/IImageBox.Proportional.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Stretch](ModForms.chm::/Interface/IImageBox/IImageBox.Stretch.htm)
		 Свойство Stretch определяет,
		 будет ли производится автоподгон размеров изображения под размеры
		 компонента.
		 ...
		 ![](../../Property_Image.gif)
		 [Transparent](ModForms.chm::/Interface/IImageBox/IImageBox.Transparent.htm)
		 Свойство Transparent
		 определяет, будет ли фон изображения отображаться прозрачным.


		 ![](../../Property_Image.gif)
		 [TransparentColor](ModForms.chm::/Interface/IImageBox/IImageBox.TransparentColor.htm)
...
## Методы компонента ImageBox
		 ...
		 ![](../../Sub_Image.gif)
		 [LoadImageFromStream](ModForms.chm::/Interface/IImageBox/IImageBox.LoadImageFromStream.htm)
