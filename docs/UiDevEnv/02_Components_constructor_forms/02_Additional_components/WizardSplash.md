...
## Иерархия наследования
 ...
           [IWizardSplash](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.htm)


           [WizardSplash](ModForms.chm::/Class/WizardSplash/WizardSplash.htm)


## Описание


Компонент WizardSplash представляет
 собой общую заставку мастера, отображающую ссылки на страницы мастера.


## Работа с компонентом


После добавления компонента на форму задайте для него свойства [Background](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.Background.htm)
 и [Image](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.Image.htm).
 Данные свойства отвечают за визуальное оформление компонента. Также в
 свойстве [Wizard](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.Wizard.htm)
 необходимо указать мастер, на страницы которого будут созданы ссылки в
 области текущего компонента WizardSplash.


Примечание.
 Базовое свойство [Color](ModForms.chm::/Interface/IControl/IControl.Color.htm)
 для компонента WizardSplash не
 реализовано.
...
## Свойства компонента WizardSplash
		 ...
		 ![](../../Property_Image.gif)
		 [Background](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.Background.htm)


		 Свойство Background
		 позволяет определить фон компонента.
		 ...
		 ![](../../Property_Image.gif)
		 [Image](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.Image.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Wizard](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.Wizard.htm)
...
## Методы компонента WizardSplash
		 ...
		 ![](../../Sub_Image.gif)
		 [Refresh](ModForms.chm::/Interface/IWizardSplash/IWizardSplash.Refresh.htm)
...
## События компонента WizardSplash
