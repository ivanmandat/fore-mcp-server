...
## Иерархия наследования
 ...
           [IUiBar](ModForms.chm::/Interface/IUiBar/IUiBar.htm)


           [IToolBar](ModForms.chm::/Interface/IToolbar/IToolbar.htm)


           [ToolBar](ModForms.chm::/Class/Toolbar/Toolbar.htm)


## Описание


Компонент ToolBar реализует
 стандартную панель инструментов, содержащую кнопки и раскрывающиеся списки.


## Работа с компонентом


Для редактирования списка элементов управления, расположенных на панели
 инструментов, используются команды контекстного меню, вызываемого для
 компонента. Настройка свойств элементов управления осуществляется в инспекторе
 объектов. Все кнопки создаются одинакового размера, для раскрывающихся
 списков можно изменить ширину в свойстве [Width](ModForms.chm::/Interface/IToolbarComboBox/IToolbarComboBox.Width.htm).
 Существует возможность настройки общих свойств для группы кнопок или раскрывающихся
 списков. Для это нужно, удерживая нажатой клавишу CTRL, выделить необходимые
 кнопки (раскрывающиеся списки) и изменить необходимые свойства в инспекторе
 объектов.


При работе с панелью инструментов из прикладного кода список элементов
 управления можно получиться, используя свойство [Controls](ModForms.chm::/Interface/IToolbar/IToolbar.Controls.htm).
 Данная коллекция формируется из экземпляров объектов классов [ToolBarButton](ModForms.chm::/Class/ToolbarButton/ToolbarButton.htm)
 и [ToolbarComboBox](ModForms.chm::/Class/ToolbarComboBox/ToolbarComboBox.htm).


## Горячие клавиши


Для кнопок панели инструментов есть возможность назначить одно или несколько
 сочетаний горячих клавиш. Для назначения горячих клавиш в режиме дизайнера
 формы необходимо выделить кнопку, в инспекторе объектов выделить свойство
 [ShortCut](modforms.chm::/Interface/IToolbarButton/IToolbarButton.ShortCut.htm)
 и нажать требуемое сочетание. Дополнительные сочетания горячих клавиш
 задаются в коллекции [AdditionalShortCuts](modforms.chm::/Interface/IToolbarButton/IToolbarButton.AdditionalShortCuts.htm)
...
## Свойства компонента ToolBar
		 ...
		 ![](../../Property_Image.gif)
		 [AllowClose](ModForms.chm::/Interface/IToolbar/IToolbar.AllowClose.htm)
		 Свойство AllowClose
		 определяет возможность закрытия панели инструментов в случае,
		 когда панель не привязана к форме, а расположена независимо в
		 области формы.
		 ...
		 ![](../../Property_Image.gif)
		 [AllowUndock](ModForms.chm::/Interface/IUiBar/IUiBar.AllowUndock.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Controls](ModForms.chm::/Interface/IToolbar/IToolbar.Controls.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Edge](ModForms.chm::/Interface/IUiBar/IUiBar.Edge.htm)
		 Свойство Edge определяет
		 место расположения панели инструментов на форме.
		 ...
		 ![](../../Property_Image.gif)
		 [ExclusiveRow](ModForms.chm::/Interface/IUiBar/IUiBar.ExclusiveRow.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Floating](ModForms.chm::/Interface/IUiBar/IUiBar.Floating.htm)
		 Свойство Floating возвращает
		 состояние панели инструментов относительно окна формы.
		 ...
		 ![](../../Property_Image.gif)
		 [Id](ModForms.chm::/Interface/IToolbar/IToolbar.Id.htm)
		 Свойство Id определяет
		 уникальный идентификатор панели инструментов.


		 ![](../../Property_Image.gif)
		 [Images](ModForms.chm::/Interface/IToolbar/IToolbar.Images.htm)
		 Свойство Images определяет
		 компонент [ImageList](ImageList.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxHintWidth](ModForms.chm::/Interface/IToolbar/IToolbar.MaxHintWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowCaptions](ModForms.chm::/Interface/IToolbar/IToolbar.ShowCaptions.htm)
...
## Методы компонента ToolBar
		 ...
		 ![](../../Sub_Image.gif)
		 [BeginUpdate](ModForms.chm::/Interface/IToolbar/IToolbar.BeginUpdate.htm)
		 Метод BeginUpdate запрещает
		 перерисовку компонента ToolBar.
		 ...
		 ![](../../Sub_Image.gif)
		 [Dock](ModForms.chm::/Interface/IUiBar/IUiBar.Dock.htm)
		 Метод Dock осуществляет
		 привязку компонента ToolBar к форме.


		 ![](../../Sub_Image.gif)
		 [DockLeftOf](ModForms.chm::/Interface/IUiBar/IUiBar.DockLeftOf.htm)
		 Метод DockLeftOf позволяет
		 осуществить привязку ToolBar к форме, располагая этот компонент
		 слева от объекта, передаваемого в качестве входного параметра.
		 ...
		 ![](../../Sub_Image.gif)
		 [EndUpdate](ModForms.chm::/Interface/IToolbar/IToolbar.EndUpdate.htm)
		 Метод EndUpdate отключает
		 режим запрета перерисовки компонента ToolBar.


		 ![](../../Sub_Image.gif)
		 [Float](ModForms.chm::/Interface/IUiBar/IUiBar.Float.htm)
		 Метод Float осуществляет
		 расположение компонента ToolBar на форме как отдельное окно.
