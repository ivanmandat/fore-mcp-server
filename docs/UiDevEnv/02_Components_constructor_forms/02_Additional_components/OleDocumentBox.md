...
## Иерархия наследования
 ...
           [IOleDocumentBox](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.htm)


           [OleDocumentBox](ModForms.chm::/Class/OleDocumentBox/OleDocumentBox.htm)


## Описание


Компонент OleDocumentBox предназначен
 для загрузки и отображения COM-объектов.


## Работа с компонентом


Для загрузки в компонент какого-либо COM-объекта используйте метод [CreateFromFile](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.CreateFromFile.htm)
 или [CreateObject](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.CreateObject.htm).
 Загрузка из файлов поддерживается для файлов Microsoft Word и Microsoft
 Excel. Доступ к загруженному объекту можно получить, используя свойство
 [OleObject](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.OleObject.htm).
 Дальнейшая работа с объектом осуществляется с помощью методов класса [Variant](ForeSys.chm::/Class/Variant/Variant.htm).


Используя событие [OnOleDocumentEvent](ModForms.chm::/Class/OleDocumentBox/OleDocumentBox.OnOleDocumentEvent.htm)
 компонента OleDocumentBox можно
 обработать какие-либо события, происходящие внутри COM-объекта. Для отслеживания
 внутренних событий COM-объекта необходимо свойству [EnableDocumentEvents](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.EnableDocumentEvents.htm)
...
![](OleDocumentBox_Sample.gif)


## Свойства компонента OleDocumentBox
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [EnableDocumentEvents](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.EnableDocumentEvents.htm)


		 Свойство EnableDocumentEvents
		 определяет, будет ли генерироваться событие [OnOleDocumentEvent](ModForms.chm::/Class/OleDocumentBox/OleDocumentBox.OnOleDocumentEvent.htm)
		 .
		 ...
		 Свойство OleObject
		 возвращает объект, загруженный в компонент.
		 ...
		 ![](../../Property_Image.gif)
		 [UserMode](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.UserMode.htm)


		 Свойство UserMode определяет
		 режим работы с объектом, загруженным в компонент.
...
## Методы компонента OleDocumentBox
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateFromFile](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.CreateFromFile.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateObject](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.CreateObject.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [DestroyObject](ModForms.chm::/Interface/IOleDocumentBox/IOleDocumentBox.DestroyObject.htm)
...
## События компонента OleDocumentBox
		 ...
		 ![](../../Event_Image.gif)
		 [OnOleDocumentEvent](ModForms.chm::/Class/OleDocumentBox/OleDocumentBox.OnOleDocumentEvent.htm)
