...
## Иерархия наследования
 ...
           [ExpressionEdit](KeExtCtrls.chm::/Class/ExpressionEdit/ExpressionEdit.htm)


## Описание


Компонент ExpressionEdit предназначен
...
Для работы компонента необходимо связать свойство [Expression](KeExtCtrls.chm::/Interface/IExpressionEdit/IExpressionEdit.Expression.htm)
 с выражением какого-либо объекта (например, формула вычисляемого поля
 таблицы). Дальнейшая работа по созданию выражения аналогична работе с
 выражением компонента [TermEdit](TermEdit.htm). Все текущие
 изменения будут доступны в свойстве [Text](ModForms.chm::/Interface/IControl/IControl.Text.htm)
 (текст, отображаемый в компоненте) и [Formula](ModForms.chm::/Interface/ITermEdit/ITermEdit.Formula.htm)
 (выражение, по которому производится расчет). Для обновления выражения,
 указанного в свойстве [Expression](KeExtCtrls.chm::/Interface/IExpressionEdit/IExpressionEdit.Expression.htm),
 используется метод [UpdateExpression](KeExtCtrls.chm::/Interface/IExpressionEdit/IExpressionEdit.UpdateExpression.htm).


Примечание.
 Отличием компонентов ExpressionEdit
 и [ExpressionEditEx](ExpressionEditEx.htm)
 является их внутренняя реализация.


## Свойства компонента ExpressionEdit
...
## Методы компонента ExpressionEdit
...
## События компонента ExpressionEdit
		 ...
		 Событие OnHyperlink
		 наступает при щелчке по гиперссылке терма в вырожении.
		 ...
		 Событие OnParseTerm
		 возникает во время преобразования текста редактора в термы и знаки
		 операции.
