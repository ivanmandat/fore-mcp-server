...
## Иерархия наследования
 ...
           [IDecimalEdit](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.htm)


           [DecimalEdit](ModForms.chm::/Class/DecimalEdit/DecimalEdit.htm)


## Описание


Компонент DecimalEdit представляет
 собой однострочный редактор вещественных чисел высокой точности.


## Работа с компонентом


Компонент DecimalEdit является
 аналогом компонента [FloatEdit](FloatEdit.htm)
 и используется для редактирования вещественных чисел. В отличие от [FloatEdit](FloatEdit.htm), DecimalEdit позволяет редактировать
 числа с большой точностью - до 18 знаков после запятой. Точность задается
 в свойстве [Precision](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.Precision.htm). Шаг, на
 который будет изменяться значение при нажатии клавиш UP/DOWN или кнопок
 в компоненте SpinUp/SpinDown, устанавливается в свойстве [StepSize](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.StepSize.htm).


## Пример


![](DecimalEdit_sample.gif)


## Свойства компонента DecimalEdit
		 ...
		 ![](../../Property_Image.gif)
		 [AllowEmpty](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.AllowEmpty.htm)
		 Свойство AllowEmpty
		 ...
		 Свойство AutoSelect
		 определяет, будет ли выделен весь текст компонента, при получении
		 компонентом фокуса.
		 ...
		 Свойство CanUndo
		 возвращает True,
		 если существует возможность отменить изменения текста в компоненте.
		 ...
		 ![](../../Property_Image.gif)
		 [CorrectOnExit](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.CorrectOnExit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxValue](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.MaxValue.htm)
		 Свойство MaxValue
		 ...
		 ![](../../Property_Image.gif)
		 [MinValue](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.MinValue.htm)
		 Свойство MinValue
		 ...
		 Свойство Modified
		 возвращает True,
		 если производилось изменение текста компонента.
		 ...
		 ![](../../Property_Image.gif)
		 [Precision](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.Precision.htm)
		 Свойство Precision
		 ...
		 Свойство ReadOnly
		 определяет, может ли пользователь изменять текст компонента.
		 ...
		 Свойство SelStart
		 определяет позицию, в которой расположен курсор и начинается выделение
		 текста в компоненте.
		 ...
		 Свойство SelText
		 определяет текст, выделенный в компоненте.


		 ![](../../Property_Image.gif)
		 [ShowHint](ModForms.chm::/Interface/IControl/IControl.ShowHint.htm)
		 Свойство ShowHint
		 включает и выключает показ всплывающего окна подсказки для компонента.


		 ![](../../Property_Image.gif)
		 [StepSize](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.StepSize.htm)
		 Свойство StepSize
		 определяет величину, на которую будет изменяться значение введенное
		 в поле редактирования, при использовании кнопок SpinUp и SpinDown для изменения значения.
		 ...
		 ![](../../Property_Image.gif)
		 [ThousandSeparator](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.ThousandSeparator.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TrailingZeros](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.TrailingZeros.htm)
		 Свойство TrailingZeros
		 определяет признак отображения нулей после запятой, при [Precision](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.Precision.htm)
		 больше нуля.


		 ![](../../Property_Image.gif)
		 [Valid](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.Valid.htm)
		 Свойство Valid
		 ...
		 ![](../../Property_Image.gif)
		 [Value](ModForms.chm::/Interface/IDecimalEdit/IDecimalEdit.Value.htm)
...
## Методы компонента DecimalEdit
		 ...
		 Метод Clear
		 удаляет весь текст, содержащийся в компоненте.
		 ...
		 Метод ClearUndo
		 используется для фиксации изменений свойства Text.
		 ...
		 Метод SelectAll
		 осуществляет выделение текста компонента.
		 ...
		 Метод Undo
		 осуществляет отмену последнего изменения текста в компоненте.


## События компонента DecimalEdit
		 ...
		 Событие OnChange
		 наступает после изменений свойства Text компонента.


		 ![](../../Event_Image.gif)
		 [OnClick](ModForms.chm::/Interface/IControl/IControl.OnClick.htm)
		 Событие OnClick
		 наступает, если пользователь щёлкнул в области компонента.
		 ...
		 Событие OnSpinUp
		 происходит непосредственно при нажатии кнопки SpinUp в поле редактирования.


		 ![](../../Event_Image.gif)
		 [OnValueChange](ModForms.chm::/Class/DecimalEdit/DecimalEdit.OnValueChange.htm)
