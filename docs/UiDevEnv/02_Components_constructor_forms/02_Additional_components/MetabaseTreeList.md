...
## Иерархия наследования
 ...
           [IMetabaseTreeList](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.htm)


           [MetabaseTreeList](KeExtCtrls.chm::/Class/MetabaseTreeList/MetabaseTreeList.htm)


## Описание


Компонент MetabaseTreeList предназначен
 для отображения дерева объектов репозитория.
...
По умолчанию в компоненте ничего не отображается. Для установки каталога,
 ...
 [Root](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.Root.htm).
 Список отображаемых объектов можно изменить настроив фильтрацию в свойстве
 [Filters](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.Filters.htm).
...
Основной список свойств и методов данного компонента унаследован от
 [TreeList](TreeList.htm), поэтому и работа с данным компонентом
 аналогична работе с деревом компонента [TreeList](TreeList.htm).
 Методы, используемые для изменения иерархии элементов, в данном компоненте
 не поддерживаются.


Компонент MetabaseTreeList может
 работать в связке с компонентом [MetabaseListView](MetabaseListView.htm),
 при этом в [MetabaseListView](MetabaseListView.htm) будут отображаться
 дочерние объекты того объекта, который выбран в дереве MetabaseTreeList.
 Для связи компонентов: в свойстве [Tree](KeExtCtrls.chm::/Interface/IMetabaseListView/IMetabaseListView.Tree.htm)
 компонента [MetabaseListView](MetabaseListView.htm) укажите
 компонент MetabaseTreeList.
...
В компоненте предусмотрены следующие виды поиска:
	...
	- При помощи диалога поиска, который вызывается при
	 ...
	 ENTER, либо кнопки "Найти далее" будет осуществляться поиск.
	 Поиск осуществляется циклически по всей иерархии элементов. Если диалог
	 поиска вызывался и был закрыт, то в дереве элементов при нажатии клавиши
	 F3 будет осуществляться поиск элемента с наименованием, введенным
	 в диалоге поиска.


При удачном поиске курсор будет фокусироваться на найденном элементе.
 Состояние имеющейся отметки зависит от значения свойства [FindMode](ModForms.chm::/Interface/ITreeControl/ITreeControl.FindMode.htm).
...
В диалоге поиска существует возможность поиска по частям не только одного,
...
В режиме выполнения формы для сортировки данных по какому-либо столбцу
 ...
 CTRL и щёлкнуть по заголовкам необходимых столбцов. Порядок сортировки
...
Колонки, по которым будет осуществляться сортировка, необходимо переместить
 в список выбранных. Кнопки ![](../Button_Ascending.gif) и ![](../Button_Descending.gif)
 используются для изменения направления сортировки по выбранному столбцу.
 Кнопки ![](../Button_Up.gif)
 и ![](../Button_Down.gif) используются для изменения порядка сортировки.
 Колонки, расположенные вверху списка, будут сортироваться в первую очередь.
...
В языке Fore для применения
 ...
 значение отличное от None. Колонка, по данным которой осуществляется сортировка,
 указывается в свойстве [SortColumn](ModForms.chm::/Interface/ITreeControl/ITreeControl.SortColumn.htm).
...
Для настройки фильтрации объектов, отображаемых в дереве компонента,
 необходимо выполнить одно из следующих действий:
	...
	- в [инспекторе
	 объектов](../../01_Development_Environment/03_Windows_of_Development_Environment/Object_Inspector.htm) дважды щелкнуть по свойству [Filters](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.Filters.htm).
...
Для редактирования какого-либо фильтра необходимо выполнить одно из
 следующих действий:
	...
	- дважды щёлкнуть по необходимому фильтру;
...
![](MetabaseTreeList_Sample.gif)


## Свойства компонента MetabaseTreeList
		 ...
		 ![](../../Property_Image.gif)
		 [CheckedObjects](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.CheckedObjects.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DelayedFill](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.DelayedFill.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayMode](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.DisplayMode.htm)
		 ...
		 список изображений, отображаемых рядом с элементами дерева.
		 ...
		 ![](../../Property_Image.gif)
		 [Metabase](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.Metabase.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelectedObjects](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.SelectedObjects.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowEmptyFolders](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.ShowEmptyFolders.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowInternalObjects](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.ShowInternalObjects.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowShortCuts](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.ShowShortCuts.htm)
...
## Методы компонента MetabaseTreeList
		 ...
		 ![](../../Sub_Image.gif)
		 [FindByDescriptor](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.FindByDescriptor.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [FindItemByKey](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.FindItemByKey.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetItemObject](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.GetItemObject.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [SelectElem](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.SelectElem.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [SelectElemKey](KeExtCtrls.chm::/Interface/IMetabaseTreeList/IMetabaseTreeList.SelectElemKey.htm)
		 ...
		 инициализирует диалог поиска элементов компонента.
...
## События компонента MetabaseTreeList
		 ...
		 ![](../../Event_Image.gif)
		 [OnCheckToAddElem](KeExtCtrls.chm::/Class/MetabaseTreeList/MetabaseTreeList.OnCheckToAddElem.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnGetElementPopup](KeExtCtrls.chm::/Class/MetabaseTreeList/MetabaseTreeList.OnGetElementPopup.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnIsBrowseableElem](KeExtCtrls.chm::/Class/MetabaseTreeList/MetabaseTreeList.OnIsBrowseableElem.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnIsDynamicElem](KeExtCtrls.chm::/Class/MetabaseTreeList/MetabaseTreeList.OnIsDynamicElem.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnIsEmptyFolder](KeExtCtrls.chm::/Class/MetabaseTreeList/MetabaseTreeList.OnIsEmptyFolder.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnIsFolderElem](KeExtCtrls.chm::/Class/MetabaseTreeList/MetabaseTreeList.OnIsFolderElem.htm)
