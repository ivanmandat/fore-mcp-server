...
## Иерархия наследования
 ...
           [IGroupBox](ModForms.chm::/Interface/IGroupBox/IGroupBox.htm)


           [PPGroupBox](ModForms.chm::/Class/PPGroupBox/PPGroupBox.htm)


## Описание


Компонент PPGroupBox является
 аналогом компонента [GroupBox](../01_Standart_Components/GroupBox.htm),
...
В отличии от [GroupBox](../01_Standart_Components/GroupBox.htm)
 стиль компонента PPGroupBox не
 зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPGroupBox
 и [GroupBox](../01_Standart_Components/GroupBox.htm) одинаковые.


## Пример


![](PPGroupBox_Sample.gif)


## Свойства компонента PPGroupBox
