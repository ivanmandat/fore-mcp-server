...
## Иерархия наследования
 ...
           [PPTrackBar](ModForms.chm::/Class/PPTrackBar/PPTrackBar.htm)


## Описание


Компонент PPTrackBar является
 аналогом компонента [TrackBar](../02_Additional_components/TrackBar.htm),
...
В отличии от [TrackBar](../02_Additional_components/TrackBar.htm)
 стиль компонента PPTrackBar не
 зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPTrackBar
 и [TrackBar](../02_Additional_components/TrackBar.htm) одинаковые.


## Пример


![](PPTrackBar_Sample.gif)


## Свойства компонента PPTrackBar
		 ...
		 Свойство Frequency
		 определяет коэффициент, определяющий число видимых делении по
		 отношению к числу заданных делении.
...
## Методы компонента PPTrackBar
		 ...
		 Метод SetTick позволяет
		 установить метку в заданном положении.


## События компонента PPTrackBar
