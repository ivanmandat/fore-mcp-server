...
## Иерархия наследования
 ...
           [IPPButton](ModForms.chm::/Interface/IPPButton/IPPButton.htm)


           [PPButton](ModForms.chm::/Class/PPButton/PPButton.htm)


## Описание


Компонент PPButton является
 аналогом компонента [Button](../01_Standart_Components/Button.htm),
...
В отличии от [Button](../01_Standart_Components/Button.htm)
 стиль компонента PPButton не зависит
 от оформления и настроек операционной системы. Функциональные настройки
 и возможности компонентов PPButton
 и [Button](../01_Standart_Components/Button.htm) одинаковые.
...
## Свойства компонента PPButton
		 ...
		 Свойство Align
		 определяет как поведет себя компонент при изменении размеров содержащего
		 ...
		 определяет, будет ли обрабатываться событие [OnClick](ModForms.chm::/Interface/IControl/IControl.OnClick.htm)
		 ...
		 определяет результат, возвращаемый после нажатия кнопки на модальной
		 форме при закрытии этой формы.
