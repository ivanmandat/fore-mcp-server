...
## Иерархия наследования
 ...
           [IRadioButton](ModForms.chm::/Interface/IRadioButton/IRadioButton.htm)


           [PPRadioButton](ModForms.chm::/Class/PPRadioButton/PPRadioButton.htm)


## Описание


Компонент PPRadioButton является
 аналогом компонента [RadioButton](../01_Standart_Components/RadioButton.htm),
...
В отличии от [RadioButton](../01_Standart_Components/RadioButton.htm)
 стиль компонента PPRadioButton
 не зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPRadioButton
 и [RadioButton](../01_Standart_Components/RadioButton.htm)
 одинаковые.
...
![](PPRadioButton_Sample.gif)


## Свойства компонента PPRadioButton
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](ModForms.chm::/Interface/IRadioButton/IRadioButton.Alignment.htm)


		 Свойство Aligment определяет
		 расположение переключателя внутри поля компонента.
		 ...
		 ![](../../Property_Image.gif)
		 [Checked](modforms.chm::/Interface/IRadioButton/IRadioButton.Checked.htm)
...
## Методы компонента PPRadioButton
...
## События компонента PPRadioButton
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ModForms.chm::/Class/RadioButton/RadioButton.OnChange.htm)
