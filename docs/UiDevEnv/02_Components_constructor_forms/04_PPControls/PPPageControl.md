...
## Иерархия наследования
 ...
           [PPPageControl](ModForms.chm::/Class/PPPageControl/PPPageControl.htm)


## Описание


Компонент PPPageControl является
 аналогом компонента [PageControl](../02_Additional_components/PageControl.htm),
...
В отличии от [PageControl](../02_Additional_components/PageControl.htm)
 стиль компонента PPPageControl
 не зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPPageControl
 и [PageControl](../02_Additional_components/PageControl.htm)
 одинаковые.
...
![](PPPageControl_Sample.gif)


## Свойства компонента PPPageControl
...
## Методы компонента PPPageControl
...
## События компонента PPPageControl
