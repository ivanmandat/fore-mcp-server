...
## Иерархия наследования
 ...
           [PPComboBox](ModForms.chm::/Class/ComboBox/ComboBox.htm)


## Описание


Компонент PPComboBox является
 аналогом компонента [ComboBox](../01_Standart_Components/ComboBox.htm),
...
В отличии от [ComboBox](../01_Standart_Components/ComboBox.htm)
 стиль компонента PPComboBox не
 зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPComboBox
 и [ComboBox](../01_Standart_Components/ComboBox.htm)
 одинаковые.
...
![](PPComboBox_Sample.gif)


## Свойства компонента PPComboBox
		 ...
		 возвращает True,
		 если раскрывающийся список компонента находится в развернутом
		 виде.
		 ...
		 Свойство Items
		 определяет коллекцию строк раскрывающегося списка.
		 ...
		 Свойство Sorted
		 определяет, будут ли строки в раскрывающемся списке автоматически
		 сортироваться в алфавитном порядке.
		 ...
		 Свойство Style
		 определяет стиль отображения раскрывающегося списка.
...
## Методы компонента PPComboBox
		 ...
		 Метод ClearEdit
		 осуществляет очистку поля редактирования компонента.
		 ...
		 Метод SelectAll
		 осуществляет выделение всего текста в строке редактирования компонента.
...
## События компонента PPComboBox
		 ...
		 Событие OnChange
		 наступает при изменении текста в окне редактора компонента.
		 ...
		 Событие OnDropDown
		 наступает при появлении раскрывающегося списка.
		 ...
		 Событие OnHScroll
		 наступает при изменение положения ползунка горизонтальной полосы
		 прокрутки.
		 ...
		 Событие OnVScroll
		 наступает при изменение положения ползунка вертикальной полосы
		 прокрутки.
