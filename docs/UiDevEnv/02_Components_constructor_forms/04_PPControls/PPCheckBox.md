...
## Иерархия наследования
 ...
           [PPCheckBox](ModForms.chm::/Class/PPCheckBox/PPCheckBox.htm)


## Описание


Компонент PPCheckBox является
 аналогом компонента [CheckBox](../01_Standart_Components/CheckBox.htm),
...
В отличии от [CheckBox](../01_Standart_Components/CheckBox.htm)
 стиль компонента PPCheckBox не
 зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPCheckBox
 и [CheckBox](../01_Standart_Components/CheckBox.htm) одинаковые.


## Пример


![](PPCheckBox_Sample.gif)


## Свойства компонента PPCheckBox
		 ...
		 определяет возможность установки в компоненте промежуточного состояния.
...
## События компонента PPCheckBox
		 ...
		 при изменении состояния отметки компонента CheckBox.
