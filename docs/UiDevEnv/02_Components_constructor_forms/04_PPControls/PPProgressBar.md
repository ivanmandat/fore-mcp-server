...
## Иерархия наследования
 ...
           [PPProgressBar](ModForms.chm::/Class/PPProgressBar/PPProgressBar.htm)


## Описание


Компонент PPProgressBar является
 аналогом компонента [ProgressBar](../02_Additional_components/ProgressBar.htm),
...
В отличии от [ProgressBar](../02_Additional_components/ProgressBar.htm)
 стиль компонента PPProgressBar
 не зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPProgressBar
 и [ProgressBar](../02_Additional_components/ProgressBar.htm)
 одинаковые.
...
![](PPProgressBar_Sample.gif)


## Свойства компонента PPProgressBar
...
## Методы компонента PPProgressBar
...
## События компонента PPProgressBar
