...
## Иерархия наследования
 ...
           [PPListBox](ModForms.chm::/Class/PPListBox/PPListBox.htm)


## Описание


Компонент PPListBox является
...
В отличии от [ListBox](../01_Standart_Components/ListBox.htm)
 стиль компонента PPListBox не
 зависит от оформления и настроек операционной системы. Функциональные
 настройки и возможности компонентов PPListBox
 и [ListBox](../01_Standart_Components/ListBox.htm) одинаковые.


## Пример


![](PPListBox_Sample.gif)


## Свойства компонента PPListBox
		 ...
		 определяет, будет ли отображаться элемент списка, если он полностью
		 не помещается в окно компонента, путем подгонки высоты компонента.
...
## События компонента PPListBox
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ModForms.chm::/Class/ListBox/ListBox.OnChange.htm)
