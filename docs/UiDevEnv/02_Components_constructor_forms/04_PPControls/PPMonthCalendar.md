...
## Иерархия наследования
 ...
           [ICommonCalendar](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.htm)


           [IMonthCalendar](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.htm)


           [PPMonthCalendar](ModForms.chm::/Class/PPMonthCalendar/PPMonthCalendar.htm)


## Описание


Компонент PPMonthCalendar является
 аналогом компонента [MonthCalendar](../02_Additional_components/MonthCalendar.htm),
 имеющим собственное оформление, стилизованное под оформление продукта
...
В отличии от [MonthCalendar](../02_Additional_components/MonthCalendar.htm)
 стиль компонента PPMonthCalendar
 не зависит от оформления и настроек операционной системы. Функционально
 PPMonthCalendar имеет следующие
 отличия от [MonthCalendar](../02_Additional_components/MonthCalendar.htm):


	- Не поддерживаются свойства [ShowToday](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.ShowToday.htm)
	 и [ShowTodayCircle](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.ShowTodayCircle.htm).


	- Язык, используемый в календаре, зависит от языка, используемого
	 в репозитории, а не от языка локализации операционной системы.


## Пример


![](PPMonthCalendar_Sample.gif)
...
## Свойства компонента MonthCalendar
		 ...
		 ![](../../Property_Image.gif)
		 [BeginDate](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.BeginDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Colors](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.Colors.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [CurrentDate](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.CurrentDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [EndDate](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.EndDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FirstDayOfWeek](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.FirstDayOfWeek.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IsValidDate](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.IsValidDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxDate](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.MaxDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxSelectRange](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.MaxSelectRange.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MinDate](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.MinDate.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MultiSelect](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.MultiSelect.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowToday](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.ShowToday.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ShowTodayCircle](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.ShowTodayCircle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [WeekNumbers](ModForms.chm::/Interface/IMonthCalendar/IMonthCalendar.WeekNumbers.htm)
...
## Методы компонента MonthCalendar
...
## События компонента MonthCalendar
		 ...
		 ![](../../Event_Image.gif)
		 [OnChange](ModForms.chm::/Interface/ICommonCalendar/ICommonCalendar.OnChange.htm)
