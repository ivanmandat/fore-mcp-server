...
## Иерархия наследования
 ...
           [PPMemo](ModForms.chm::/Class/PPMemo/PPMemo.htm)


## Описание


Компонент PPMemo является аналогом
 компонента [Memo](../01_Standart_Components/Memo.htm), имеющим
 собственное оформление, стилизованное под оформление продукта «Форсайт. Аналитическая платформа».


## Комментарии


В отличии от [Memo](../01_Standart_Components/Memo.htm) стиль
 компонента PPMemo не зависит от
 оформления и настроек операционной системы. Функциональные настройки и
 возможности компонентов PPMemo
 и [Memo](../01_Standart_Components/Memo.htm) одинаковые.
