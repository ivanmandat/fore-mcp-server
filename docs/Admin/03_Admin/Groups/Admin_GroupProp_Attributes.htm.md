# Добавление значений атрибутам группы пользователей
...
Атрибуты задаются группе пользователей при выборе [атрибутного
...
Для добавления или редактирования значений добавленным [атрибутам](../../04_SecurityPolicy/Creating_attributes.htm)
 группы пользователей используйте вкладку «Атрибуты»
 на боковой панели «[Свойства](Admin_GroupsCreate.htm#properties)»
 в веб-приложении и в окне «[Свойства
 группы](Admin_GroupsCreate.htm#properties)» настольного приложения.
	...
	Веб-приложение
	 ...
	 приложение
		...
		![](Admin_GroupsAttributes_web.png)


		![](Admin_GroupsAttributes.png)


В таблице отображается список [добавленных
 атрибутов](../../04_SecurityPolicy/Creating_attributes.htm) группы пользователей с заданным наименованием, идентификатором
 и типом данных.
...
Заданные значения атрибутам группы пользователей используйте для дальнейшей
...
[Создание
 и редактирование группы пользователей](Admin_GroupsCreate.htm) | [Создание
