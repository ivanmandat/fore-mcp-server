...
Класс PrxChartView реализует представление диаграммы регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.PrxChartView, PP.Ui.SourceView, "PP.Prx.Ui.PrxChartView", [PP.Prx.Ui.IPrxChartView, PP.Ui.IDataView]);
...
## Свойства
 ...
 ![](../../../Property_Image.gif)
 [ChartType](PrxChartView.ChartType.htm)
 Свойство ChartType определяет тип диаграммы.


 ![](../../../Property_Image.gif)
 [EditMode](PrxChartView.EditMode.htm)
 Свойство EditMode определяет режим редактирования для диаграммы.


 ![](../../../Property_Image.gif)
 [Instance](PrxChartView.Instance.htm)
 Свойство Instance
определяет экземпляр компонента [Chart](dhtmlChart.chm::/Components/Chart/Chart.htm).


 ![](../../../Property_Image.gif)
 [Options](PrxChartView.Options.htm)
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [getViewMode](PrxChartView.getViewMode.htm)
 ...
 ![](../../../Sub_Image.gif)
 [isImage](PrxChartView.isImage.htm)
 Метод isImage определяет, является ли диаграмма изображением.


 ![](../../../Sub_Image.gif)
 [isLoaded](PrxChartView.isLoaded.htm)
 Метод getChart возвращает метаданные диаграммы отчета.


 ![](../../../Sub_Image.gif)
 [refreshJSON](PrxChartView.refreshJSON.htm)
 Метод refreshJSON обновляет диаграмму по JSON.


 ![](../../../Sub_Image.gif)
 [setPointValue](PrxChartView.setPointValue.htm)
 Метод setPointValue устанавливает значение для указанной точки выбранного ряда диаграммы.


 ![](../../../Sub_Image.gif)
 [undoData](PrxChartView.undoData.htm)
 Метод undoData отменяет изменения настроек диаграммы.
...
## События
 ...
 ![](../../../Event_Image.gif)
 [DataChanged](PrxChartView.DataChanged.htm)
 Событие DataChanged наступает при изменении данных диаграммы.


 ![](../../../Event_Image.gif)
 [OptionsChanged](PrxChartView.OptionsChanged.htm)
 Событие OptionsChanged наступает при изменении настроек диаграммы.


 ![](../../../Event_Image.gif)
 [Rendered](PrxChartView.Rendered.htm)
 Событие Rendered наступает после отрисовки диаграммы регламентного отчета.


 ![](../../../Event_Image.gif)
 [RequestMetadata](PrxChartView.RequestMetadata.htm)
 Событие RequestMetadata наступает при запросе метаданных диаграммы.


 ![](../../../Event_Image.gif)
 [SerieClick](PrxChartView.SerieClick.htm)
 Событие SerieClick наступает при нажатии на ряд диаграммы.
