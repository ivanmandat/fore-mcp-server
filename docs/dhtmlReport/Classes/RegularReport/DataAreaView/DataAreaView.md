...
Класс DataAreaView реализует представление области данных регламентного отчета.


## Комментарии


Область данных включает в себя [панель элементов управления](../ControlBarView/ControlBarView.htm) и [таблицу данных](../GridView/GridView.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.DataAreaView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "DataAreaView", PP.Prx.Ui.IView);
