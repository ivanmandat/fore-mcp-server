...
Класс EmfExportDialog реализует [диалог экспорта отчета в формат *.emf](../../../Components/RegularReport/Dialogs/EmfExportDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.EmfExportDialog, PP.Prx.Ui.[ExportDialog](../ExportDialog/ExportDialog.htm), "EmfExportDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [EmfExportDialog](dhtmlReport.chm::/classes/regularreport/emfexportdialog/constructor_emfexportdialog.htm)
		 Метод EmfExportDialog создает
		 экземпля класса EmfExportDialog.
