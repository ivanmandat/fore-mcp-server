...
[DataAreaView](../DataAreaView/DataAreaView.htm)
...
Класс DataArea реализует компонент [DataArea](../../../Components/RegularReport/DataArea/DataArea.htm), который представляет собой область данных регламентного отчета.


## Комментарии


Класс DataArea наследует все свойства, методы и события от класса [DataAreaView](../DataAreaView/DataAreaView.htm), реализующего представление области данных регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.DataArea, PP.Prx.Ui.[DataAreaView](../DataAreaView/DataAreaView.htm), "DataArea");
...
## Свойства, унаследованные от класса [DataAreaView](../DataAreaView/DataAreaView.htm)
...
## Методы, унаследованные от класса [DataAreaView](../DataAreaView/DataAreaView.htm)
...
## События, унаследованные от класса [DataAreaView](../DataAreaView/DataAreaView.htm)
