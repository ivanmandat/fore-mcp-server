...
[ControlBarView](../ControlBarView/ControlBarView.htm)
...
Класс ControlBar реализует компонент [ControlBar](../../../Components/RegularReport/ControlBar/ControlBar.htm), представляющий собой панель элементов управления регламентного отчета.


## Комментарии


Класс ControlBar наследует все свойства и методы от класса [ControlBarView](../ControlBarView/ControlBarView.htm), реализующего представление панели элементов управления регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.ControlBar, PP.Prx.Ui.[ControlBarView](../ControlBarView/ControlBarView.htm), "ControlBar");
...
## Свойства, унаследованные от класса [ControlBarView](../ControlBarView/ControlBarView.htm)
...
## Методы, унаследованные от класса [ControlBarView](../ControlBarView/ControlBarView.htm)
...
## События, унаследованные от класса [ControlBarView](../ControlBarView/ControlBarView.htm)
