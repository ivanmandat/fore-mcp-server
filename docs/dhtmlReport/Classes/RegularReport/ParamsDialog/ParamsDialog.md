...
Класс ParamsDialog реализует диалог для установки значений параметров отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.ParamsDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.Prx.Ui.ParamsDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ParamsDialog](dhtmlReport.chm::/Classes/RegularReport/ParamsDialog/Constructor_ParamsDialog.htm)
		 Конструктор ParamsDialog
		 для изменения значений параметров отчета.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Params](dhtmlReport.chm::/Classes/RegularReport/ParamsDialog/ParamsDialog.Params.htm)
		 Класс ParamsDialog
		 реализует диалог для установки значений параметров отчета.
