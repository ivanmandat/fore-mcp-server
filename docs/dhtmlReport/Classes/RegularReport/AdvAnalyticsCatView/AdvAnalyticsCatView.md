...
Класс AdvAnalyticsCatView реализует
 представление вкладки «Расширенная аналитика»
 ленты инструментов.
...
Вкладка может выглядеть следующим образом:
...
PP.initClass(PP.Ui.AdvAnalyticsCatView, PP.Ui.[RibbonCategory](dhtmlRibbon.chm::/Classes/RibbonCategory/ribboncategory.htm),
 "AdvAnalyticsCatView");
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [DataView](AdvAnalyticsCatView.DataView.htm)
		 Свойство DataView определяет
		 представление данных, связанное с вкладкой.


		 ![](../../../Property_Image.gif)
		 [Source](AdvAnalyticsCatView.Source.htm)
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getCanGetWbk](AdvAnalyticsCatView.getCanGetWbk.htm)
		 Метод getCanGetWbk
		 определяет доступность функций, требующих базу данных временных
		 рядов.


		 ![](../../../Sub_Image.gif)
		 [getContentRendered](AdvAnalyticsCatView.getContentRendered.htm)
		 Метод getContentRendered
		 определяет, отрисованы ли элементы вкладки.


		 ![](../../../Sub_Image.gif)
		 [getOptions](AdvAnalyticsCatView.getOptions.htm)
		 Метод getOptions возвращает
		 настройки вкладки.


		 ![](../../../Sub_Image.gif)
		 [refresh](AdvAnalyticsCatView.refresh.htm)
		 Метод refresh обновляет
		 вкладку.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](AdvAnalyticsCatView.refreshAll.htm)
		 Метод refreshAll обновляет
		 вкладку.


		 ![](../../../Sub_Image.gif)
		 [renderContent](AdvAnalyticsCatView.renderContent.htm)
		 Метод renderContent
		 отрисовывает элементы вкладки.


		 ![](../../../Sub_Image.gif)
		 [setPropertyValue](AdvAnalyticsCatView.setPropertyValue.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ControlsCreated](AdvAnalyticsCatView.ControlsCreated.htm)
		 Событие ControlsCreated
		 наступает при создании элементов управления.


		 ![](../../../Event_Image.gif)
		 [MetadataChanged](AdvAnalyticsCatView.MetadataChanged.htm)
		 Событие MetadataChanged
		 наступает при изменении метаданных.


		 ![](../../../Event_Image.gif)
		 [ModelingGenerated](AdvAnalyticsCatView.ModellingGenerated.htm)
		 Событие ModelingGenerated
		 наступает после создания объекта, используя кнопку «Моделирование
		 и прогнозирование».


		 ![](../../../Event_Image.gif)
		 [OnGetDataMiningResult](AdvAnalyticsCatView.OnGetDataMiningResult.htm)
		 Событие OnGetDataMiningResult
		 наступает после получения результата интеллектуального анализа
		 данных.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](AdvAnalyticsCatView.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает после изменения элемента управления вкладки.


		 ![](../../../Event_Image.gif)
		 [PropertyChanging](AdvAnalyticsCatView.PropertyChanging.htm)
		 Событие PropertyChanging
		 наступает перед изменением элемента управления вкладки.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](AdvAnalyticsCatView.RequestMetadata.htm)
		 Событие RequestMetadata
		 наступает при запросе метаданных с сервера.


		 ![](../../../Event_Image.gif)
		 [TimeSeriesGenerated](AdvAnalyticsCatView.TimeSeriesGenerated.htm)
