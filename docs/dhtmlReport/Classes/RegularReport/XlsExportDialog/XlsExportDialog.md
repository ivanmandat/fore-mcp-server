...
PP.Prx.Ui.XlsExportDialog


## Описание


Класс XlsExportDialog реализует [диалог экспорта отчета в формат *.xls](../../../Components/RegularReport/Dialogs/XlsExportDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.XlsExportDialog, PP.Prx.Ui.[ExportDialog](../ExportDialog/ExportDialog.htm), "XlsExportDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [XlsExportDialog](dhtmlReport.chm::/classes/regularreport/xlsexportdialog/consructor_xlsexportdialog.htm)
		 Конструктор XlsExportDialog
		 создает экземпляр компонента XlsExportDialog.
