...
Класс SimpleControlView реализует
 представление компонентов [CheckBox](dhtmlUi.chm::/Components/CheckBox/CheckBox.htm),
 EditBox и IdentEdit, которые являются элементами управления регламентного
 отчета.
...
[CheckBox](dhtmlUi.chm::/Components/CheckBox/CheckBox.htm),
 EditBox и IdentEdit - базовые классы для класса SimpleControlView.
 Доступ к свойствам, методам и событиям классов [CheckBox](dhtmlUi.chm::/Components/CheckBox/CheckBox.htm),
 EditBox и IdentEdit осуществляется при помощи метода [getControl](../ControlBarView/ControlBarView.getControl.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.SimpleControlView, PP.Prx.Ui.[PrxControl](../PrxControl/PrxControl.htm), "SimpleControlView");
