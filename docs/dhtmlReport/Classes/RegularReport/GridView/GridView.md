...
[PP.Ui.SourceView](dhtmlUi.chm::/Classes/SourceView/SourceView.htm)
...
Класс GridView реализует электронную
...
Класс GridView является родительским
 классом компонента [GridBox](../../../Components/RegularReport/GridBox/GridBox.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.GridView, [PP.Mb.Ui.GridView](dhtmlMetabase.chm::/Classes/Metabase/GridView/GridView.htm),
 "PP.Prx.Ui.GridView", PP.ISourceView);
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [GridView](Constructor_GridView.htm)
			 Конструктор GridView создает
			 экземпляр класса GridView.
