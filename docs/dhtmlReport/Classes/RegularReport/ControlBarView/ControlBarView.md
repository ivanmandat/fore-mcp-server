...
Класс ControlBarView реализует представление [панели элементов управления](../../../Components/RegularReport/ControlBar/ControlBar.htm) регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.ControlBarView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "ControlBarView", PP.Ui.IPropertyView);
