...
Класс DataSaveDialog реализует [диалог для сохранения отчета](../../../Components/RegularReport/Dialogs/DataSaveDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.DataSaveDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "DataSaveDialog");
