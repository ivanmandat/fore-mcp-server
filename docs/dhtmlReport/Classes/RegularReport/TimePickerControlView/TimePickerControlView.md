...
Класс TimePickerControlView
 реализует модель редактора времени, который является элементом управления
...
[DateTimePicker](dhtmlUi.chm::/Classes/DateTimePicker/DateTimePicker.htm)
 - базовый класс для класса TimePickerControlView.
...
PP.initClass(PP.Prx.Ui.TimePickerControlView, PP.Prx.Ui.[PrxControl](../PrxControl/PrxControl.htm), "TimePickerControlView");
