...
Класс TreeComboControlView реализует
 иерархический раскрывающийся список, который является элементом управления
...
[TreeCombo](dhtmlUiTree.chm::/Classes/TreeCombo/TreeCombo.htm)
 - базовый класс для класса TreeComboControlView.
 Доступ к свойствам, методам и событиям класса [TreeCombo](dhtmlUiTree.chm::/Classes/TreeCombo/TreeCombo.htm)
...
PP.initClass(PP.Prx.Ui.TreeComboControlView, PP.Prx.Ui.[PrxControl](../PrxControl/PrxControl.htm), "TreeComboControlView");
