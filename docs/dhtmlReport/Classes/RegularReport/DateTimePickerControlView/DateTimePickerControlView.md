...
[PrxControl](../PrxControl/PrxControl.htm)
...
Класс DateTimePickerControlView
 реализует представление [редактора
 даты и времени](dhtmlUi.chm::/Classes/DateTimePicker/DateTimePicker.htm), который является элементом управления регламентного
 отчета.
...
[DateTimePicker](dhtmlUi.chm::/Classes/DateTimePicker/DateTimePicker.htm)
 - базовый класс для класса DateTimePickerControlView.
 Доступ к свойствам, методам и событиям класса [DateTimePicker](dhtmlUi.chm::/Classes/DateTimePicker/DateTimePicker.htm)
 осуществляется при помощи метода [getControl](../ControlBarView/ControlBarView.getControl.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.DateTimePickerControlView,
 PP.Prx.Ui.[PrxControl](../PrxControl/PrxControl.htm), "DateTimePickerControlView");


## Свойства, унаследованные от класса [PrxControl](../PrxControl/PrxControl.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [LabelPosition](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.LabelPosition.htm)
		 Свойство LabelPosition
		 определяет позиционирование подписи элемента управления регламентного
		 отчета.


		 ![](../../../Property_Image.gif)
		 [Name](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.Name.htm)
		 Свойство Name устанавливает
		 имя элемента управления регламентного отчета.


		 ![](../../../Property_Image.gif)
		 [Report](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.Report.htm)
		 Свойство Report устанавливает
		 регламентный отчет, который является источником для элемента управления.


		 ![](../../../Property_Image.gif)
		 [Service](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.Service.htm)
		 Свойство Service устанавливает
		 сервис для работы с регламентными отчетами для элемента управления.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.Source.htm)
		 Свойство Source определяет
		 отчет-источник для элемента управления.


## Методы, унаследованные от класса [PrxControl](../PrxControl/PrxControl.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getControl](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.getControl.htm)
		 Метод getControl возвращает
		 модель элемента управления регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [getLabel](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.getLabel.htm)
		 Метод getLabel возвращает
		 подпись элемента управления регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [getMetadata](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.getMetadata.htm)
		 Метод getMetadata возвращает
		 метаданные элемента управления в формате сервиса.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.refresh.htm)
		 Метод refresh обновляет
		 элемент управления регламентного отчета. Аналог метода [PrxControl.refreshAll](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.refreshAll.htm).


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.refreshAll.htm)
		 Метод refreshAll обновляет
		 элемент измерения регламентного отчета.


## События, унаследованные от класса [PrxControl](../PrxControl/PrxControl.htm)
		 ...
		 наступает при изменении элемента управления регламентного отчета.


		 ![](../../../Event_Image.gif)
		 [MetadataChanged](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.MetadataChanged.htm)
		 Событие MetadataChanged
		 наступает при измерении метаданных элемента управления регламентного
		 отчета.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении свойств элемента управления регламентного
		 отчета.
