...
Класс PrxDocument реализует представление текстового листа регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.PrxDocument, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.Prx.Ui.PrxDocument", PP.ISourceView);
...
## Свойства
 ...
 ![](../../../Property_Image.gif)
 [DocumentHtml](PrxDocument.DocumentHtml.htm)
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [refresh](PrxDocument.refresh.htm)
 Метод refresh осуществляет полное или частичное обновление текстового листа регламентного отчета.


 ![](../../../Sub_Image.gif)
 [refreshAll](PrxDocument.refreshAll.htm)
 Метод refreshAll обновляет весь текстовый лист регламентного отчета.
...
## События
 ...
 ![](../../../Event_Image.gif)
 [MetadataChanged](PrxDocument.MetadataChanged.htm)
