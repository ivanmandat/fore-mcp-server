...
Класс MaskEditControlView реализует
 представление [редактора
 маски](dhtmlUi.chm::/Components/MaskEdit/MaskEdit.htm), который является элементом управления регламентного отчета.


## Комментарии


[MaskEdit](dhtmlUi.chm::/Classes/MaskEdit/MaskEdit.htm)
 - базовый класс для класса MaskEditControlView.
 Доступ к свойствам, методам и событиям класса [MaskEdit](dhtmlUi.chm::/Classes/MaskEdit/MaskEdit.htm)
...
PP.initClass(PP.Prx.Ui.MaskEditControlView, PP.Prx.Ui.[PrxControl](../PrxControl/PrxControl.htm), "MaskEditControlView");
