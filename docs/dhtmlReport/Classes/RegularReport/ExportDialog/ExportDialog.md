...
PP.Prx.Ui.ExportDialog


## Описание


Класс ExportDialog реализует [базовый диалог](../../../Components/RegularReport/Dialogs/ExportDialog.htm) для всех диалогов экспорта регламентного отчета.


## Комментарии


Классы-наследники ExportDialog:


-
[EmfExportDialog](../EmfExportDialog/EmfExportDialog.htm);


-
[HtmlExportDialog](../HtmlExportDialog/HtmlExportDialog.htm);


-
[PdfExportDialog](../PdfExportDialog/PdfExportDialog.htm);


-
[RtfExportDialog](../RtfExportDialog/RtfExportDialog.htm);


-
[XlsExportDialog](../XlsExportDialog/XlsExportDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.ExportDialog, PP.Ui.ExportDialog, "ExportDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ExportDialog](dhtmlReport.chm::/classes/regularreport/exportdialog/constructor_exportdialog.htm)
		 Конструктор ExportDialog
		 создает экземпляр компонента ExportDialog.
