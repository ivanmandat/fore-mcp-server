...
PP.Prx.Ui.[HtmlExportDialog](../HtmlExportDialog/HtmlExportDialog.htm)


PP.Prx.Ui.MhtExportDialog


## Описание


Класс MhtExportDialog реализует [диалог экспорта отчета в формат *.mht](../../../Components/RegularReport/Dialogs/MhtExportDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.EmfExportDialog, PP.Prx.Ui.[HtmlExportDialog](../HtmlExportDialog/HtmlExportDialog.htm) "EmfExportDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MhtExportDialog](dhtmlReport.chm::/classes/regularreport/mhtexportdialog/constructor_mhtexportdialog.htm)
		 Конструктор HtmlExportDialog
		 создает экземпляр класса HtmlExportDialog.
