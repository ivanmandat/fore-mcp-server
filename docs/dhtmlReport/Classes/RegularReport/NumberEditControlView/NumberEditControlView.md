...
Класс NumberEditControlView
 реализует представление [числового
 редактора](dhtmlUi.chm::/Components/NumberEdit/NumberEdit.htm), который является элементом управления регламентного отчета.


## Комментарии


[NumberEdit](dhtmlUi.chm::/Classes/NumberEdit/NumberEdit.htm)
 - базовый класс для класса NumberEditControlView.
 Доступ к свойствам, методам и событиям класса [NumberEdit](dhtmlUi.chm::/Classes/NumberEdit/NumberEdit.htm)
...
PP.initClass(PP.Prx.Ui.NumberEditControlView, PP.Prx.Ui.[PrxControl](../PrxControl/PrxControl.htm), "NumberEditControlView");
