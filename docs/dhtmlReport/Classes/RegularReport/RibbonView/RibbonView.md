...
Класс RibbonView реализует ленту
 инструментов регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.RibbonView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm),
 "RibbonView", PP.Prx.Ui.IRibbonView);
