...
Класс PrxControl реализует представление
 элемента управления регламентного отчета.


## Комментарии


Классы-наследники PrxControl:


	- [ComboBoxControlView](../ComboBoxControlView/ComboBoxControlView.htm);


	- [DateTimePickerControlView](../DateTimePickerControlView/DateTimePickerControlView.htm);


	- [DimComboControlView](../DimComboControlView/DimComboControlView.htm);


	- [MaskEditControlView](../MaskEditControlView/MaskEditControlView.htm);


	- [NumberEditControlView](../NumberEditControlView/NumberEditControlView.htm);


	- [SimpleControlView](../SimpleControlView/SimpleControlView.htm);


	- [TimePickerControlView](../TimePickerControlView/TimePickerControlView.htm);


	- [TreeComboControlView](../TreeComboControlView/TreeComboControlView.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.PrxControl, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Prx.Ui.PrxControl");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [create](dhtmlReport.chm::/Classes/RegularReport/PrxControl/PrxControl.create.htm)
		 Конструктор create
		 создает экземпляр класса PrxControl.
