...
Класс ComboBoxControlView реализует
 представление [раскрывающегося
 списка](dhtmlUi.chm::/Components/ComboBox/ComboBox.htm), который является элементом управления регламентного отчета.
...
[ComboBox](dhtmlUi.chm::/Classes/ComboBox/ComboBox.htm)
 - базовый класс для класса ComboBoxControlView.
 Доступ к свойствам, методам и событиям класса [ComboBox](dhtmlUi.chm::/Classes/ComboBox/ComboBox.htm)
...
PP.initClass(PP.Prx.Ui.ComboBoxControlView, PP.Prx.Ui.[PrxControl](../PrxControl/PrxControl.htm), "ComboBoxControlView");
