...
Класс ReportBox реализует контейнер
 для отображения регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.ReportBox, PP.Prx.Ui.[ReportView](../ReportView/ReportView.htm),
 "ReportBox");
...
## Свойства, унаследованные от класса [ReportView](../ReportView/ReportView.htm)
...
## Методы, унаследованные от класса [ReportView](../ReportView/ReportView.htm)
...
## События, унаследованные от класса [ReportView](../ReportView/ReportView.htm)
