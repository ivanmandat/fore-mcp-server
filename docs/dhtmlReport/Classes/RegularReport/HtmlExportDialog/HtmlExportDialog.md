...
[PP.Prx.Ui.ExportDialog](../ExportDialog/ExportDialog.htm)


PP.Prx.Ui.HtmlExportDialog


## Описание


Класс HtmlExportDialog реализует [диалог для экспорта регламентного отчета в формат *.html](../../../Components/RegularReport/Dialogs/HtmlExportDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.HtmlExportDialog, PP.Prx.Ui.[ExportDialog](../ExportDialog/ExportDialog.htm), "HtmlExportDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [HtmlExportDialog](dhtmlReport.chm::/classes/regularreport/htmlexportdialog/constructor_htmlexportdialog.htm)
		 Конструктор HtmlExportDialog
		 создает экземпляр компонента HtmlExportDialog.
