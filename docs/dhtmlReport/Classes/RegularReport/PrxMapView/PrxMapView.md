...
Класс PrxMapView реализует представление
 карты регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.PrxMapView, PP.Ui.SourceView,
 "PP.Prx.Ui.PrxMapView", [PP.Ui.IDataView]);
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [ToolTipMaskText](PrxMapView.ToolTipMaskText.htm)
		 Свойство ToolTipMaskText
		 устанавливает маску для всплывающих подсказок территорий карты.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getMapDHTML](PrxMapView.getMapDHTML.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RegionClick](PrxMapView.RegionClick.htm)
		 Событие RegionClick
		 наступает при нажатии на территорию карты.
