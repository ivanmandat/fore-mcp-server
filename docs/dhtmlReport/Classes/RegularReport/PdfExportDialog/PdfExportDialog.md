...
PP.Prx.Ui.PdfExportDialog


## Описание


Класс PdfExportDialog реализует [диалог экспорта отчета в формат *.pdf](../../../Components/RegularReport/Dialogs/PdfExportDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.PdfExportDialog, PP.Prx.Ui.[ExportDialog](../ExportDialog/ExportDialog.htm), "PdfExportDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [PdfExportDialog](dhtmlReport.chm::/classes/regularreport/pdfexportdialog/constructor_pdfexportdialog.htm)
		 Конструктор PdfExportDialog
		 создает экземпляр класса PdfExportDialog.
