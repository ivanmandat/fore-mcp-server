...
PP.Prx.Ui.RtfExportDialog


## Описание


Класс RtfExportDialog реализует [диалог экспорта отчета в формат *.rtf](../../../Components/RegularReport/Dialogs/RtfExportDialog.htm).


## Синтаксис


PP.initClass(PP.Prx.Ui.RtfExportDialog, PP.Prx.Ui.[ExportDialog](../ExportDialog/ExportDialog.htm), "RtfExportDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RtfExportDialog](dhtmlReport.chm::/classes/regularreport/rtfexportdialog/constructor_rtfexportdialog.htm)
		 Конструктор RtfExportDialog
		 создает экземпляр класса RtfExportDialog.
