...
[PP.Prx.Ui.GridView](../GridView/GridView.htm)
...
Класс GridBox реализует компонент
 [GridBox](../../../Components/RegularReport/GridBox/GridBox.htm),
 представляющий собой таблицу регламентного отчета.


## Синтаксис


PP.initClass(PP.Prx.Ui.GridBox, PP.Prx.Ui.[GridView](../GridView/GridView.htm),
 "GridBox");
...
## Свойства, унаследованные от класса [PP.Prx.Ui.GridView](../GridView/GridView.htm)
...
## Методы, унаследованные от класса [PP.Prx.Ui.GridView](../GridView/GridView.htm)
...
## События, унаследованные от класса [PP.Prx.Ui.GridView](../GridView/GridView.htm)
