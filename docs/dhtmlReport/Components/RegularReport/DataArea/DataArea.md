...
Компонент DataArea представляет
 собой область данных регламентного отчета.


Область данных включает в себя [панель
 элементов управления](../ControlBar/ControlBar.htm) и [электронную
 таблицу](../GridBox/GridBox.htm).


Примечание.
 Если в отчете нет элементов управления, панель элементов управления не
 будет отображаться на области данных.


Чтобы вернуть электронную таблицу используйте метод [DataAreaView.getGridView](../../../Classes/RegularReport/DataAreaView/DataAreaView.getGridView.htm).


Чтобы вернуть панель элементов управления используйте метод [DataAreaView.getControlBar](../../../Classes/RegularReport/DataAreaView/DataAreaView.getControlBar.htm).


Чтобы скрыть/показать панель элементов управления используйте метод
 [DataAreaView.showControlBar](../../../Classes/RegularReport/DataAreaView/DataAreaView.showControlBar.htm).


Основное событие компонента - [смена
 активного (открытого) листа отчета](../../../Classes/RegularReport/DataAreaView/DataAreaView.ActiveSheetChanged.htm).


## Комментарии


Компонент реализован классом [DataArea](../../../Classes/RegularReport/DataArea/DataArea.htm).
...
[Пример размещения компонента DataArea](DataArea_Example.htm)
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [DataArea](dhtmlReport.chm::/classes/regularreport/dataarea/constructor_dataarea.htm)
			 Конструктор DataArea
			 создает экземпляр класса DataArea.


## Свойства, унаследованные от класса [DataAreaView](../../../Classes/RegularReport/DataAreaView/DataAreaView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [ControlBarPosition](dhtmlReport.chm::/Classes/RegularReport/DataAreaView/DataAreaView.ControlBarPosition.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.source.htm)
		 Свойство Source определяет
		 источник регламентного отчета.


## Методы, унаследованные от класса [DataAreaView](../../../Classes/RegularReport/DataAreaView/DataAreaView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getControlBar](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.getcontrolbarview.htm)
		 Метод getControlBar
		 возвращает панель управления регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [getDocument](dhtmlReport.chm::/Classes/RegularReport/DataAreaView/DataAreaView.getDocument.htm)
		 Метод getDocument возвращает
		 представление текстового листа отчета.


		 ![](../../../Sub_Image.gif)
		 [getGridView](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.getgridview.htm)
		 Метод getGridView возвращает
		 таблицу регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [getStackPanel](dhtmlReport.chm::/Classes/RegularReport/DataAreaView/DataAreaView.getStackPanel.htm)
		 Метод getStackPanel
		 возвращает контейнер, содержащий объекты области данных и настройки
		 их расположения.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.refresh.htm)
		 Метод refresh обновляет
		 область данных в соответствии с произведенными изменениями.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.refreshall.htm)
		 Метод refreshAll последовательно
		 обновляет таблицу и панель элементов управления регламентного
		 отчета.


		 ![](../../../Sub_Image.gif)
		 [setActiveSheet](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.setactivesheet.htm)
		 Метод setActiveSheet
		 устанавливает активный лист регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [showControlBar](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.showcontrolbar.htm)
		 Метод showControlBar
		 отображает панель элементов управления регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [showTabControl](dhtmlReport.chm::/Classes/RegularReport/DataAreaView/DataAreaView.showTabControl.htm)
		 Метод showTabControl
		 определяет, отображается ли панель выбора листов регламентного
		 отчета.


## События, унаследованные от класса [DataAreaView](../../../Classes/RegularReport/DataAreaView/DataAreaView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [ActiveSheetChanged](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.activesheetchanged.htm)
		 Событие ActiveSheetChanged
		 наступает после смены активного листа отчета.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlReport.chm::/classes/regularreport/dataareaview/dataareaview.propertychanged.htm)
		 Событие PropertyChanged
		 наступает при изменении данных отчета.
