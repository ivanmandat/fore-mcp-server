...
Компонент ReportBox
 служит для отображения регламентного отчета.


## Комментарии


Компонент реализован классом [ReportView](../../../Classes/RegularReport/ReportView/ReportView.htm).


## Пример


Компонент ReportBox может иметь
 следующий вид:
...
[Пример размещения компонента ReportBox](ReportBox_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ReportBox](dhtmlReport.chm::/classes/regularreport/reportbox/constructor_reportbox.htm)
		 Конструктор ReportBox
		 создает экземпляр компонента ReportBox.


## Свойства, унаследованные от класса [ReportView](../../../Classes/RegularReport/ReportView/ReportView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [RibbonView](dhtmlReport.chm::/classes/regularreport/reportview/reportview.ribbonview.htm)
		 Свойство RibbonView
		 возвращает ленту инструментов регламентного отчета.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlReport.chm::/classes/regularreport/reportview/reportview.source.htm)
		 Свойство Source определяет
		 объект репозитория, отображаемый в ReportBox.


## Методы, унаследованные от класса [ReportView](../../../Classes/RegularReport/ReportView/ReportView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getDataAreaView](dhtmlReport.chm::/classes/regularreport/reportview/reportview.getdataareaview.htm)
		 Устарело. Используйте
		 метод [ReportView.getDataView](dhtmlReport.chm::/classes/regularreport/reportview/reportview.getdataview.htm).


		 ![](../../../Sub_Image.gif)
		 [getDataView](dhtmlReport.chm::/classes/regularreport/reportview/reportview.getdataview.htm)
		 Метод getDataAreaView
		 возвращает представление области данных регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlReport.chm::/classes/regularreport/reportview/reportview.refresh.htm)
		 Метод refresh обновляет
		 ленту инструментов и область данных регламентного отчета.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlReport.chm::/classes/regularreport/reportview/reportview.refreshall.htm)
		 Метод refreshAll обновляет
		 все элементы регламентного отчета.


## События, унаследованные от класса [ReportView](../../../Classes/RegularReport/ReportView/ReportView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlReport.chm::/classes/regularreport/reportview/reportview.propertychanged.htm)
		 Событие PropertyChanged наступает
		 при сохранении измененных данных отчета.
