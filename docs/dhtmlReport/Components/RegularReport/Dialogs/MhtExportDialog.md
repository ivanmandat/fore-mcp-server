...
Компонент MhtExportDialog представляет
 собой диалог для экспорта отчета в формат *.mht.


## Комментарии


Компонент реализован классом [MhtExportDialog](../../../Classes/RegularReport/MhtExportDialog/MhtExportDialog.htm)
...
![](../../../Classes/RegularReport/MhtExportDialog/MhtExportDialog.gif)


Пример создания компонента приведен в описании конструктора [MhtExportDialog](../../../Classes/RegularReport/MhtExportDialog/Constructor_MhtExportDialog.htm).
