...
Компонент HtmlExportDialog представляет
 собой диалог для экспорта регламентного отчета в формат *.html.


## Комментарии


Компонент реализован классом [HtmlExportDialog](../../../Classes/RegularReport/HtmlExportDialog/HtmlExportDialog.htm)
...
![](../../../Classes/RegularReport/HtmlExportDialog/HtmlExportDialog.gif)


Пример создания компонента приведен в описании конструктора [HtmlExportDialog](HtmlExportDialog.htm).
