...
Компонент XlsExportDialog представляет
 собой диалог экспорта отчета в формат *.xls.


## Комментарии


Компонент реализован классом [XlsExportDialog](../../../Classes/RegularReport/XlsExportDialog/XlsExportDialog.htm).
...
![](../../../Classes/RegularReport/XlsExportDialog/XlsExportDialog.gif)


Пример создания компонента приведен в описании конструктора [XlsExportDialog](../../../Classes/RegularReport/XlsExportDialog/Consructor_XlsExportDialog.htm).
