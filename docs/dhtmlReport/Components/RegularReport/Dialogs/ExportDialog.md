...
Компонент ExportDialog реализует
 базовый диалог экспорта регламентного отчета.
...
![](../../../Classes/RegularReport/ExportDialog/ExportDialog.gif)


Пример создания компонента приведен в описании конструктора [ExportDialog](../../../Classes/RegularReport/ExportDialog/Constructor_ExportDialog.htm).
