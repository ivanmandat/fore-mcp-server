...
Компонент RtfExportDialog представляет
 собой диалог экспорта отчета в формат *.rtf.


## Комментарии


Компонент реализован классом [RtfExportDialog](../../../Classes/RegularReport/RtfExportDialog/RtfExportDialog.htm).
...
![](../../../Classes/RegularReport/RtfExportDialog/RtfExportDialog.gif)


Пример создания компонента приведен в описании конструктора [RtfExportDialog](../../../Classes/RegularReport/RtfExportDialog/Constructor_RtfExportDialog.htm).
