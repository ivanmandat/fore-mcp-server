...
Компонент EmfExportDialog представляет
 собой диалог для экспорта в формат *.emf.
...
![](../../../Classes/RegularReport/EmfExportDialog/EmfExportDialog.gif)


Пример создания компонента приведен в описании конструктора [EmfExportDialog](../../../Classes/RegularReport/EmfExportDialog/Constructor_EmfExportDialog.htm).
