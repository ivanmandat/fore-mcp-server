...
Компонент PdfExportDialog представляет
 собой диалог для экспорта отчета в формат *.pdf.


## Комментарии


Компонент реализован классом [PdfExportDialog](../../../Classes/RegularReport/PdfExportDialog/PdfExportDialog.htm).
...
![](../../../Classes/RegularReport/PdfExportDialog/PdfExportDialog.gif)


Пример создания компонента приведен в описании конструктора [PdfExportDialog](../../../Classes/RegularReport/PdfExportDialog/Constructor_PdfExportDialog.htm).
