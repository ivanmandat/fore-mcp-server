...
Компонент ParamsDialog представляет
 собой диалог для изменения параметров отчета.
...
![](../../../Classes/RegularReport/ParamsDialog/ParamsDialog.gif)


[Пример
 создания компонента ParamsDialog](../../../Classes/RegularReport/ParamsDialog/ParamsDialog.Params.htm)
