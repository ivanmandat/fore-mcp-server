...
Компонент DataSaveDialog представляет
 собой диалог для сохранения измененных данных отчета.


## Комментарии


Компонент реализован классом [DataSaveDialog](../../../Classes/RegularReport/DataSaveDialog/DataSaveDialog.htm).


## Пример


Диалог для сохранения данных имеет следующий вид:


![](../../../Classes/RegularReport/DataSaveDialog/DataSaveDialog.gif)


Пример создания компонента приведен в описании конструктора [DataSaveDialog](../../../Classes/RegularReport/DataSaveDialog/Constructor_DataSaveDialog.htm).
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [DataSaveDialog](dhtmlReport.chm::/Classes/RegularReport/DataSaveDialog/Constructor_DataSaveDialog.htm)
		 Конструктор DataSaveDialog
		 создает экземпляр класса DataSaveDialog.
