...
Компонент RibbonView представляет
 собой ленту инструментов регламентного отчета.


Лента инструментов входит в состав компонента [ReportBox](../ReportBox/ReportBox.htm).
...
Лента включает в себя:
	...
	- Кнопку ![](../../../Classes/RegularReport/RibbonView/collapse_button.gif) для сворачивания/разворачивания
	 ленты;
...
Основные события компонента:
	...
	- [Сворачивание](../../../Classes/RegularReport/RibbonView/RibbonView.Collapsed.htm)/[разворачивание](../../../Classes/RegularReport/RibbonView/RibbonView.Expanded.htm)
	 ленты;


	- Выбор пункта главного меню «[Выход](../../../Classes/RegularReport/RibbonView/RibbonView.Exited.htm)»;


	- Выбор пункта главного меню «[Открыть](../../../Classes/RegularReport/RibbonView/RibbonView.Opened.htm)»;


	- [Изменение
	 состояния кнопок ленты](../../../Classes/RegularReport/RibbonView/RibbonView.PropertyChanged.htm).


При нажатии на кнопки «Сохранить изменения» и «Отменить изменения» открывается
 диалог [DataSaveDialog](../Dialogs/DataSaveDialog.htm). Также
 открыть этот диалог и изменить его вид можно при помощи метода [RibbonView.showDataSaveDialog](../../../Classes/RegularReport/RibbonView/RibbonView.showDataSaveDialog.htm).


Чтобы открыть окно предпросмотра отчета используйте метод [RibbonView.showPrintPreview](../../../Classes/RegularReport/RibbonView/RibbonView.showPrintPreview.htm)
 или выберите пункт главного меню «Печать».


Чтобы активировать/деактивировать кнопки ленты инструментов используйте
 метод [RibbonView.setPropertyValue](../../../Classes/RegularReport/RibbonView/RibbonView.setPropertyValue.htm).


Базовым компонентом для RibbonView
 является компонент [Ribbon](dhtmlRibbon.chm::/Classes/Ribbon/Ribbon.htm).
 Чтобы изменять настройки компонента [Ribbon](dhtmlRibbon.chm::/Classes/Ribbon/Ribbon.htm),
...
Компонент реализован классом [RibbonView](../../../Classes/RegularReport/RibbonView/RibbonView.htm).
...
[Пример размещения компонента RibbonView](RibbonView_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RibbonView](dhtmlReport.chm::/classes/regularreport/ribbonview/constructor_ribbonview.htm)
		 Конструктор RibbonView
		 создает экземпляр компонента RibbonView.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.source.htm)
		 Свойство Source определяет
		 источник ленты инструментов регламентного отчета.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.refresh.htm)
		 Метод refresh обновляет
		 содержимое ленты инструментов.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.refresh.htm)
		 Метод refreshAll обновляет
		 содержимое ленты инструментов.


		 ![](../../../Sub_Image.gif)
		 [setPropertyValue](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.setpropertyvalue.htm)
		 Метод setPropertyValue
		 устанавливает значения для свойств ленты инструментов регламентного
		 отчета.


		 ![](../../../Sub_Image.gif)
		 [showDataSaveDialog](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.showdatasavedialog.htm)
		 Метод showDataSaveDialog
		 открывает диалог для сохранения измененных данных отчета.


		 ![](../../../Sub_Image.gif)
		 [showPrintPreview](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.showprintpreview.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Closed](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.closed.htm)
		 Событие Closed наступает
		 при выборе пункта главного меню регламентного отчета «Закрыть».


		 ![](../../../Event_Image.gif)
		 [Collapsed](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.collapsed.htm)
		 Событие Collapsed наступает
		 при сворачивании ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [Discuss](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.discuss.htm)
		 Событие Discuss наступает
		 после того, как выбран один из элементов пункта главного меню
		 «Поделиться».


		 ![](../../../Event_Image.gif)
		 [Exited](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.exited.htm)
		 Событие Exited наступает
		 при выборе пункта главного меню регламентного отчета «Выход».


		 ![](../../../Event_Image.gif)
		 [Expanded](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.expanded.htm)
		 Событие Expanded наступает
		 при разворачивании ленты.


		 ![](../../../Event_Image.gif)
		 [Exported](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.exported.htm)
		 Событие Exported наступает
		 при сохранении отчета в файл внешнего формата.


		 ![](../../../Event_Image.gif)
		 [Opened](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.opened.htm)
		 Событие Opened наступает
		 при выборе пункта главного меню регламентного отчета «Открыть».


		 ![](../../../Event_Image.gif)
		 [Printing](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.printing.htm)
		 Событие Printing наступает
		 при выборе пункта главного меню регламентного отчета «Печать».


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.propertychanged.htm)
		 Событие PropertyChanged
		 наступает после нажатия на кнопки ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [PropertyChanging](dhtmlReport.chm::/classes/regularreport/ribbonview/ribbonview.propertychanging.htm)
		 Событие PropertyChanging
		 наступает при нажатии на кнопки ленты инструментов.


## Методы, унаследованный от класса [ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm)
