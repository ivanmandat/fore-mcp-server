...
SubjectEncoding: [CodePage](ForeSys.chm::/Enums/CodePage.htm);


## Описание


Свойство SubjectEncoding определяет
 кодовую страницу, используемую для кодировки заголовка письма.
