...
Value — значение даты или времени, которое необходимо записать.
...
После выполнения примера в двоичный файл «1.dat» будет записана текущая
 дата и время.
