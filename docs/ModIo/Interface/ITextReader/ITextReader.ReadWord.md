...
Метод ReadWord осуществляет
 считывание слов с учетом разделителя, установленного свойством [ITextReader.WordDelimiters](ITextReader.WordDelimiters.htm).
...
После выполнения примера в переменной «s» будет содержаться первое слово,
 считанное из текстового файла «1.txt». При работе с файлом будет использоваться
 кодировка UTF-8.
