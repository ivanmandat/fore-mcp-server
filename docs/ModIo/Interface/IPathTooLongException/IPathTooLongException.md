...
Интерфейс IPathTooLongException
 содержит свойства исключительной ситуации, возникающей, когда путь или
 имя файла больше, чем максимальная длина, определенная системой.
...
## Иерархия наследования
 ...
           [IIOException](../IIOException/IIOException.htm)
