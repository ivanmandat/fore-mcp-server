...
Класс EtlBox реализует компонент
 среды разработки - [EtlBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EtlBox.htm).


## Свойства объекта класса, унаследованные от [IEtlBox](../../Interface/IEtlBox/IEtlBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveTool](../../Interface/IEtlBox/IEtlBox.ActiveTool.htm)
		 Свойство ActiveTool
		 определяет активный инструмент рабочей области задачи ETL.


		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IEtlBox/IEtlBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [DefaultHandlers](../../Interface/IEtlBox/IEtlBox.DefaultHandlers.htm)
		 Свойство DefaultHandlers
		 определяет признак выполнения установленного по умолчанию действия
		 над фигурой в задаче ETL.


		 ![](../../Property_Image.gif)
		 [DefaultMenu](../../Interface/IEtlBox/IEtlBox.DefaultMenu.htm)
		 Свойство DefaultMenu
		 определяет признак доступности системного контекстного меню у
		 объектов и рабочей области задачи ETL.


		 ![](../../Property_Image.gif)
		 [DisplayConnectionPoints](../../Interface/IEtlBox/IEtlBox.DisplayConnectionPoints.htm)
		 Свойство DisplayConnectionPoints
		 определяет признак отображения точек соединения.


		 ![](../../Property_Image.gif)
		 [DisplayFocusFrame](../../Interface/IEtlBox/IEtlBox.DisplayFocusFrame.htm)
		 Свойство DisplayFocusFrame
		 определяет признак отображения фокуса.


		 ![](../../Property_Image.gif)
		 [DisplayGrid](../../Interface/IEtlBox/IEtlBox.DisplayGrid.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayIntersections](../../Interface/IEtlBox/IEtlBox.DisplayIntersections.htm)
		 Свойство DisplayIntersections
		 определяет признак отображения пересечений линий.


		 ![](../../Property_Image.gif)
		 [DisplayScrollBars](../../Interface/IEtlBox/IEtlBox.DisplayScrollBars.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplaySelections](../../Interface/IEtlBox/IEtlBox.DisplaySelections.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](../../Interface/IEtlBox/IEtlBox.Source.htm)
		 Свойство Source определяет
		 источник данных для компонента.


		 ![](../../Property_Image.gif)
		 [View](../../Interface/IEtlBox/IEtlBox.View.htm)
...
## Методы объекта класса, унаследованные от [IEtlBox](../../Interface/IEtlBox/IEtlBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ConvertPtToView](../../Interface/IEtlBox/IEtlBox.ConvertPtToView.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ExecuteTask](../../Interface/IEtlBox/IEtlBox.ExecuteTask.htm)
		 Метод ExecuteTask запускает
		 задачу ETL на выполнение.


		 ![](../../Sub_Image.gif)
		 [GetShapeByPt](../../Interface/IEtlBox/IEtlBox.GetShapeByPt.htm)
		 Метод GetShapeByPt
		 ...
		 ![](../../Sub_Image.gif)
		 [OrderOperations](../../Interface/IEtlBox/IEtlBox.OrderOperations.htm)
		 Метод OrderOperations
		 вызывает диалог настройки [очерёдности
		 выполнения операций](UiETL.chm::/Desktop/05_PropertyETL/UiETL_Property_queue.htm).


		 ![](../../Sub_Image.gif)
		 [UpdateObjectsState](../../Interface/IEtlBox/IEtlBox.UpdateObjectsState.htm)
		 Метод UpdateObjectsState
		 обновляет отображение состояния активности цепочек расчёта.
...
## События объекта класса
		 ...
		 ![](../../Event_Image.gif)
		 [OnAfterMoveCP](EtlBox.OnAfterMoveCP.htm)
		 Событие OnAfterMoveCP
		 наступает после перемещения точки соединения линии.


		 ![](../../Event_Image.gif)
		 [OnBeforeMoveCP](EtlBox.OnBeforeMoveCP.htm)
		 Событие OnBeforeMoveCP наступает
		 перед перемещением точки соединения линии.


		 ![](../../Event_Image.gif)
		 [OnSelectionChanged](EtlBox.OnSelectionChanged.htm)
		 Событие OnSelectionChanged
		 наступает при смене выделенного объекта в рабочей области компонента.


		 ![](../../Event_Image.gif)
		 [OnShapeChanged](EtlBox.OnShapeChanged.htm)
