...
Класс EtlObjectPanelBox реализует
 компонент среды разработки [EtlObjectPanelBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EtlObjectPanelBox.htm).


## Свойства объекта класса, унаследованные от [IEtlObjectPanelBox](../../Interface/IEtlObjectPanelBox/IEtlObjectPanelBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveTab](../../Interface/IEtlObjectPanelBox/IEtlObjectPanelBox.ActiveTab.htm)
		 Свойство ActiveTab
		 определяет активную вкладку компонента.


		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IEtlObjectPanelBox/IEtlObjectPanelBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [EtlBox](../../Interface/IEtlObjectPanelBox/IEtlObjectPanelBox.EtlBox.htm)
		 Свойство EtlBox определяет
		 компонент, с которым будет взаимодействовать текущий компонент
		 [EtlObjectPanelBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EtlObjectPanelBox.htm).


		 ![](../../Property_Image.gif)
		 [ShowDestinations](../../Interface/IEtlObjectPanelBox/IEtlObjectPanelBox.ShowDestinations.htm)
		 Свойство ShowDestinations
		 определяет, будет ли в компоненте отображаться вкладка «Приёмники».


		 ![](../../Property_Image.gif)
		 [ShowOthers](../../Interface/IEtlObjectPanelBox/IEtlObjectPanelBox.ShowOthers.htm)
		 Свойство ShowOthers
		 определяет, будет ли в компоненте отображаться вкладка «Другие».


		 ![](../../Property_Image.gif)
		 [ShowSources](../../Interface/IEtlObjectPanelBox/IEtlObjectPanelBox.ShowSources.htm)
...
## События объекта класса
		 ...
		 ![](../../Event_Image.gif)
		 [OnNewEtlObject](EtlObjectPanelBox.OnNewEtlObject.htm)
