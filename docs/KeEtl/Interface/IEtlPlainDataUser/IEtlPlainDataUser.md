...
Интерфейс IEtlPlainDataUser
 содержит свойства и методы объекта преобразования - Алгоритм пользователя.
...
## Иерархия наследования
 ...
           [IEtlPlainDataTransformer](../IEtlPlainDataTransformer/IEtlPlainDataTransformer.htm)
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ForeSub](IEtlPlainDataUser.ForeSub.htm)
		 Свойство ForeSub определяет
		 макрос, который будет использоваться для преобразования данных
		 в задаче ETL.


		 ![](../../Property_Image.gif)
		 [Module](IEtlPlainDataUser.Module.htm)
		 Свойство Module определяет
		 модуль с макросами.


		 ![](../../Property_Image.gif)
		 [PlainInputs](IEtlPlainDataUser.PlainInputs.htm)
		 Свойство PlainInputs
		 возвращает объект, содержащий входящие источники данных.


		 ![](../../Property_Image.gif)
		 [PlainOutputs](IEtlPlainDataUser.PlainOutputs.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Edit](IEtlPlainDataUser.Edit.htm)
		 Метод Edit создает
		 копию объекта для редактирования.


		 ![](../../Sub_Image.gif)
		 [Save](IEtlPlainDataUser.Save.htm)
