...
Интерфейс IEtlPlainDataUnion
 содержит свойства и методы объекта преобразования - Объединение.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Edit](IEtlPlainDataUnion.Edit.htm)
		 Метод Edit создает
		 копию объекта для редактирования.


		 ![](../../Sub_Image.gif)
		 [Save](IEtlPlainDataUnion.Save.htm)
