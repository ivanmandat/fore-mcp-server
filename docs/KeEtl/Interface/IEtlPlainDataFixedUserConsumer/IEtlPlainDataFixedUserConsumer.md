...
Интерфейс IEtlPlainDataFixedUserConsumer
 используется для работы с приёмником пользователя на основе шаблона.
...
## Иерархия наследования
 ...
           [IEtlPlainDataUserConsumer](../IEtlPlainDataUserConsumer/IEtlPlainDataUserConsumer.htm)
...
Для создания приёмника пользователя на основе шаблона используйте метод
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Template](IEtlPlainDataFixedUserConsumer.Template.htm)
		 Свойство Template определяет
		 шаблон для приёмника пользователя.
...
## Свойства, унаследованные от [IEtlPlainDataUserConsumer](../IEtlPlainDataUserConsumer/IEtlPlainDataUserConsumer.htm)
