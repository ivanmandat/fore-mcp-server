...
Интерфейс IEtlPlainDataGroup
 содержит свойства и методы объекта преобразования - Группировка.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Formula](IEtlPlainDataGroup.Formula.htm)
		 Свойство Formula определяет
		 агрегационную формулу для любого поля не входящего в индекс.


		 ![](../../Property_Image.gif)
		 [Index](IEtlPlainDataGroup.Index.htm)
		 Свойство Index возвращает
		 объект, содержащий индекс по которому осуществляется группировка.


		 ![](../../Property_Image.gif)
		 [PlainInput](IEtlPlainDataGroup.PlainInput.htm)
		 Свойство PlainInput
		 возвращает объект, содержащий входящий источник данных.


		 ![](../../Property_Image.gif)
		 [PlainOutput](IEtlPlainDataGroup.PlainOutput.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Edit](IEtlPlainDataGroup.Edit.htm)
		 Метод Edit создает
		 копию объекта для редактирования.


		 ![](../../Sub_Image.gif)
		 [Save](IEtlPlainDataGroup.Save.htm)
