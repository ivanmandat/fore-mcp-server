...
Интерфейс IEtlObjectPanelBox
 содержит свойства и методы компонента среды разработки - [EtlObjectPanelBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EtlObjectPanelBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveTab](IEtlObjectPanelBox.ActiveTab.htm)
		 Свойство ActiveTab
		 определяет активную вкладку компонента.


		 ![](../../Property_Image.gif)
		 [BorderStyle](IEtlObjectPanelBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [EtlBox](IEtlObjectPanelBox.EtlBox.htm)
