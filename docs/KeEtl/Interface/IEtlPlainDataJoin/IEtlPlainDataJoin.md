...
Интерфейс IEtlPlainDataJoin
 содержит свойства и методы объекта преобразования - Соединение.


## Комментарии


При использовании в задаче ETL преобразователя соединение будет игнорироваться
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Index](IEtlPlainDataJoin.Index.htm)
		 Свойство Index возвращает
		 объект, содержащий индекс объекта.


		 ![](../../Property_Image.gif)
		 [Mapper](IEtlPlainDataJoin.Mapper.htm)
		 Свойство Mapper возвращает
		 объект, содержащий связь полей между приёмником и источником.


		 ![](../../Property_Image.gif)
		 [PlainInputs](IEtlPlainDataJoin.PlainInputs.htm)
		 Свойство PlainInputs
		 возвращает объект, содержащий входящие источники данных.


		 ![](../../Property_Image.gif)
		 [PlainOutput](IEtlPlainDataJoin.PlainOutput.htm)
		 Свойство PlainOutput
		 возвращает объект, содержащий выход объекта.


		 ![](../../Property_Image.gif)
		 [PrimaryInput](IEtlPlainDataJoin.PrimaryInput.htm)
		 Свойство PrimaryInput
		 определяет вход, который будет являться основным, при внешнем
		 типе соединения.


		 ![](../../Property_Image.gif)
		 [Type](IEtlPlainDataJoin.Type.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Edit](IEtlPlainDataJoin.Edit.htm)
		 Метод Edit создает
		 копию объекта для редактирования.


		 ![](../../Sub_Image.gif)
		 [Save](IEtlPlainDataJoin.Save.htm)
