...
Интерфейс IEtlPlainDataFixedUserProvider
 используется для работы с источником пользователя на основе шаблона.
...
## Иерархия наследования
 ...
           [IEtlPlainDataUserProvider](../IEtlPlainDataUserProvider/IEtlPlainDataUserProvider.htm)
...
Для создания источника пользователя на основе шаблона используйте метод
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Template](IEtlPlainDataFixedUserProvider.Template.htm)
...
## Свойства, унаследованные от [IEtlPlainDataUserProvider](../IEtlPlainDataUserProvider/IEtlPlainDataUserProvider.htm)
