...
Интерфейс IEtlPlainDataSort
 содержит свойства и методы объекта преобразования - Сортировка.


## Комментарии


При использовании в задаче ETL преобразователя сортировка будет игнорироваться
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Index](IEtlPlainDataSort.Index.htm)
		 Свойство Index возвращает
		 объект, содержащий индекс, по которому осуществляется сортировка.


		 ![](../../Property_Image.gif)
		 [IsFieldAscending](IEtlPlainDataSort.IsFieldAscending.htm)
		 Свойство IsFieldAscending
		 определяет направление сортировки по выбранному полю.


		 ![](../../Property_Image.gif)
		 [PlainInput](IEtlPlainDataSort.PlainInput.htm)
		 Свойство PlainInput
		 возвращает объект, содержащий входящий источник данных.


		 ![](../../Property_Image.gif)
		 [PlainOutput](IEtlPlainDataSort.PlainOutput.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [Edit](IEtlPlainDataSort.Edit.htm)
		 Метод Edit создает
		 копию объекта для редактирования.


		 ![](../../Sub_Image.gif)
		 [Save](IEtlPlainDataSort.Save.htm)
