...
Класс ImagePreloader предназначен
...
PP.initClass(PP.Ui.ImagePreloader, PP.Ui.[Control](../Control/Control.htm),
 "PP.Ui.ImagePreloader");
...
## Конструктор
		 ...
		 создает экземпляр класса ImagePreloader.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AllowTaint](ImagePreloader.AllowTaint.htm)
		 Свойство AllowTaint
		 определяет, будет ли использоваться прокси-сервер для загрузки
		 изображений.


		 ![](../../Property_Image.gif)
		 [Proxy](ImagePreloader.Proxy.htm)
		 Свойство Proxy определяет
		 адрес прокси-сервера для загрузки изображений с другого домена.


		 ![](../../Property_Image.gif)
		 [Timeout](ImagePreloader.Timeout.htm)
		 Свойство Timeout определяет
		 время ожидания загрузки изображений (в миллисекундах).


		 ![](../../Property_Image.gif)
		 [UseCORS](ImagePreloader.UseCORS.htm)
		 Свойство UseCORS определяет
		 использование технологии CORS для загрузки изображений с другого
		 домена.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getImageBySrc](ImagePreloader.getImageBySrc.htm)
		 Метод getImageBySrc
		 возвращает изображение по его адресу.


		 ![](../../Sub_Image.gif)
		 [getImages](ImagePreloader.getImages.htm)
		 Метод getImages возвращает
		 массив загружаемых изображений.


		 ![](../../Sub_Image.gif)
		 [getIsCORSSupported](ImagePreloader.getIsCORSSupported.htm)
		 Метод getIsCORSSupported
		 возвращает признак поддержки технологии CORS.


		 ![](../../Sub_Image.gif)
		 [preload](ImagePreloader.preload.htm)
		 Метод preload загружает
		 все изображения.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Preloaded](ImagePreloader.Preloaded.htm)
		 Событие Preloaded наступает
