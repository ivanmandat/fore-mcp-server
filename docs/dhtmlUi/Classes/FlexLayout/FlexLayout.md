...
Класс FlexLayout реализует компонент
 [FlexLayout](../../Components/FlexLayout/FlexLayout.htm), представляющий
...
PP.initClass(PP.Ui.FlexLayout, PP.Ui.[Control](../Control/Control.htm),
 "PP.Ui.FlexLayout");
