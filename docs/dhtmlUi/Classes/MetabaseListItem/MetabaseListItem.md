...
Класс MetabaseListItem реализует
 элемент списка объектов репозитория.


## Синтаксис


PP.initClass(PP.Ui.MetabaseListItem, PP.Ui.[ListItem](dhtmlList.chm::/Classes/listitem/listitem.htm),
 "PP.Ui.MetabaseListItem");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 MetabaseListItem
			 Конструктор MetabaseListItem
			 создает экземпляр класса MetabaseListItem.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [HasPrv](MetabaseListItem.HasPrv.htm)
		 Свойство HasPrv определяет,
		 включен ли предварительный просмотр для элемента.


		 ![](../../Property_Image.gif)
		 [IconType](MetabaseListItem.IconType.htm)
		 Свойство IconType определяет
