...
[SliderItem](../SliderItem/SliderItem.htm)
...
Класс **SliderItemColor**
 реализует бегунок для компонента [GradientSlider](../../Components/GradientSlider/GradientSlider.htm).


## Синтаксис


PP.initClass(PP.Ui.SliderItemColor,  [PP.Ui.SliderItem](../SliderItem/SliderItem.htm),
 "PP.Ui.SliderItemColor");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [SliderItemColor](dhtmlUi.chm::/Classes/SliderItemColor/Constructor_SliderItemColor.htm)
			 Конструктор SliderItemColor
			 создает экземпляр класса SliderItemColor
			 .
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Color](dhtmlUi.chm::/Classes/SliderItemColor/SliderItemColor.Color.htm)
		 Свойство **Color определяет цвет **бегунка
		 с возможностью выбора цвета.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ColorChanged](dhtmlUi.chm::/Classes/SliderItemColor/SliderItemColor.ColorChanged.htm)
		 Событие **ColorChanged **наступает
		 при изменении цвета бегунка с возможностью выбора цвета.


		 ![](../../Event_Image.gif)
		 [PaletteOpened](dhtmlUi.chm::/Classes/SliderItemColor/SliderItemColor.PaletteOpened.htm)
		 Событие **PaletteOpened**
		 наступает при открытии палитры выбора цвета бегунка с возможностью
		 выбора цвета.


## Свойства, унаследованные от класса [SliderItem](../SliderItem/SliderItem.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IsStatic](dhtmlUi.chm::/Classes/SliderItem/SliderItem.IsStatic.htm)
		 Свойство **IsStatic**
		 определяет возможность перемещения бегунка.


		 ![](../../Property_Image.gif)
		 [MaxValue](dhtmlUi.chm::/Classes/SliderItem/SliderItem.MaxValue.htm)
		 Свойство **MaxValue**
		 определяет максимальное значение бегунка.


		 ![](../../Property_Image.gif)
		 [MinValue](dhtmlUi.chm::/Classes/SliderItem/SliderItem.MinValue.htm)
		 Свойство **MinValue**
		 определяет минимальное значение бегунка.


		 ![](../../Property_Image.gif)
		 [Position](dhtmlUi.chm::/classes/slideritem/slideritem.position.htm)
		 Свойство Position определяет
		 координаты бегунка.


## События, унаследованные от класса [SliderItem](../SliderItem/SliderItem.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [Moved](dhtmlUi.chm::/Classes/SliderItem/SliderItem.Moved.htm)
		 Событие **Moved**
		 наступает при окончании изменения положения бегунка.


		 ![](../../Event_Image.gif)
		 [Moving](dhtmlUi.chm::/Classes/SliderItem/SliderItem.Moving.htm)
		 Событие **Moving**
		 наступает при изменении положения бегунка.


		 ![](../../Event_Image.gif)
		 [ValueChange](dhtmlUi.chm::/Classes/SliderItem/SliderItem.ValueChange.htm)
		 Событие **ValueChange**
		 наступает при корректировке значений при изменении значения бегунка.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/SliderItem/SliderItem.ValueChanged.htm)
		 Событие **ValueChanged**
		 наступает при окончании изменения значения бегунка.


		 ![](../../Event_Image.gif)
		 [ValueChanging](dhtmlUi.chm::/Classes/SliderItem/SliderItem.ValueChanging.htm)
		 Событие **ValueChanging**
		 наступает при изменении значения бегунка.
