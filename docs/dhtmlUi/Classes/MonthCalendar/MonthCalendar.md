...
Класс MonthCalendar реализует
 компонент [MonthCalendar](../../Components/MonthCalendar/MonthCalendar.htm),
 представляющий собой календарь для выбора даты и времени.


## Синтаксис


PP.initClass(PP.Ui.MonthCalendar, PP.Ui.[Control](../Control/Control.htm),
 "MonthCalendar");
...
## Методы, унаследованные от класса [DateTimeEdit](../DateTimeEdit/DateTimeEdit.htm)
