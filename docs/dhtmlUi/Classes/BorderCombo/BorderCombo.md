...
Класс BorderCombo реализует компонент [BorderCombo](../../Components/BorderCombo/BorderCombo.htm), представляющий собой раскрывающийся список для выбора типа границ.


## Синтаксис


PP.initClass(PP.Ui.BorderCombo, PP.Ui.[Control](../Control/Control.htm), "BorderCombo");
