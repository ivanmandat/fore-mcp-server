...
Класс Separator реализует разделитель
 между пунктами [меню](../../Components/Menu/Menu.htm).


## Комментарии


Разделитель добавляется в меню динамически при помощи свойства [Items](../Menu/Menu.Items.htm)
 и статически при помощи метода [addItem](../Menu/Menu.addItem.htm).


## Синтаксис


PP.initClass(PP.Ui.Separator, PP.Ui.[MenuItem](../MenuItem/MenuItem.htm),
 "Separator");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Separator](Separator_constructor.htm)
		 Конструктор Separator
		 создает экземпляр класса Separator.
