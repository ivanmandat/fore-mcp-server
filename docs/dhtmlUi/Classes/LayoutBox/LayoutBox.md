...
Класс LayoutBox реализует компонент
 [LayoutBox](../../Components/LayoutBox/LayoutBox.htm), представляющий
 собой контейнер для компонентов в виде таблицы.


## Синтаксис


PP.initClass(PP.Ui.LayoutBox, PP.Ui.[Container](../Container/Container.htm),
 "PP.Ui.LayoutBox");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [LayoutBox](dhtmlUi.chm::/Classes/LayoutBox/Constructor_LayoutBox.htm)
		 Конструктор LayoutBox
		 создает экземпляр компонента [LayoutBox](dhtmlUi.chm::/Components/LayoutBox/LayoutBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Orientation](dhtmlUi.chm::/Classes/LayoutBox/LayoutBox.Orientation.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [add](dhtmlUi.chm::/Classes/LayoutBox/LayoutBox.add.htm)
		 Метод add добавляет
		 элемент в конец таблицы.


		 ![](../../Sub_Image.gif)
		 [insert](dhtmlUi.chm::/Classes/LayoutBox/LayoutBox.insert.htm)
		 Метод insert добавляет
		 элемент в таблицу по индексу.


		 ![](../../Sub_Image.gif)
		 [removeByIndex](dhtmlUi.chm::/Classes/LayoutBox/LayoutBox.removeByIndex.htm)
		 Метод removeByIndex
		 удаляет элемент из таблицы по индексу.
