...
Класс SliderItem реализует бегунок
 для компонента [Slider](../../Components/Slider/Slider.htm).


## Синтаксис


PP.initClass(PP.Ui.SliderItem, PP.Ui.[Control](../Control/Control.htm),
 "SliderItem");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [SliderItem](dhtmlUi.chm::/classes/slideritem/constructor_slideritem.htm)
			 Конструктор SliderItem
			 создает экземпляр класса SliderItem.
