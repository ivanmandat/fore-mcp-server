...
Класс VerticalBreadCrumb является
 базовым классом для цепочки навигации комбинированной иерархии.


## Синтаксис


PP.initClass(PP.Ui.VerticalBreadCrumb, PP.Ui.[Control](../Control/Control.htm), "ToolVerticalBreadCrumbTip");
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [NeedEditSelectedItems](VerticalBreadCrumb.NeedEditSelectedItems.htm)
		 Свойство NeedEditSelectedItems
		 определяет доступность кнопки меню настроек.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [deleteItem](VerticalBreadCrumb.deleteItem.htm)
		 Метод deleteItem удаляет
		 выбранный элемент цепочки навигации.


		 ![](../../Sub_Image.gif)
		 [drawItems](VerticalBreadCrumb.drawItems.htm)
		 Метод drawItems отрисовывает
		 элементы цепочки навигации.


		 ![](../../Sub_Image.gif)
		 [getAddItemMenu](VerticalBreadCrumb.getAddItemMenu.htm)
		 Метод getAddItemMenu
		 возвращает меню добавления нового элемента.


		 ![](../../Sub_Image.gif)
		 [getAddSelectedItemsBtn](VerticalBreadCrumb.getAddSelectedItemsBtn.htm)
		 Метод getAddSelectedItemsBtn
		 возвращает кнопку добавления атрибута.


		 ![](../../Sub_Image.gif)
		 [getItems](VerticalBreadCrumb.getItems.htm)
		 Метод getItems возвращает
		 элементы цепочки навигации.


		 ![](../../Sub_Image.gif)
		 [getSelectedItems](VerticalBreadCrumb.getSelectedItems.htm)
		 Метод getSelectedItems
		 возвращает выделенные элементы цепочки навигации.


		 ![](../../Sub_Image.gif)
		 [getSettingsMenuItems](VerticalBreadCrumb.getSettingsMenuItems.htm)
		 Метод getSettinsMenuItems
		 возвращает кнопку с настройками атрибута.


		 ![](../../Sub_Image.gif)
		 [moveItem](VerticalBreadCrumb.moveItem.htm)
		 Метод moveItem меняет
		 позицию элемента.


		 ![](../../Sub_Image.gif)
		 [replaceItem](VerticalBreadCrumb.replaceItem.htm)
		 Метод replaceItem заменяет
		 элемент на новый.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [AddItem](VerticalBreadCrumb.AddItem.htm)
		 Событие AddItem наступает
		 после добавления нового элемента.


		 ![](../../Event_Image.gif)
		 [BeforeAddItem](VerticalBreadCrumb.BeforeAddItem.htm)
		 Событие BeforeAddItem
		 наступает перед добавлением нового элемента.


		 ![](../../Event_Image.gif)
		 [BeforeRemoveItem](VerticalBreadCrumb.BeforeRemoveItem.htm)
		 Событие BeforeRemoveItem
		 наступает перед удалением элемента.


		 ![](../../Event_Image.gif)
		 [itemClick](VerticalBreadCrumb.itemClick.htm)
		 Событие itemClick наступает
		 при щелчке мышью по элементу.


		 ![](../../Event_Image.gif)
		 [RemoveItem](VerticalBreadCrumb.RemoveItem.htm)
		 Событие RemoveItem
		 наступает после удаления элемента.


		 ![](../../Event_Image.gif)
		 [SelectedItemsChanged](VerticalBreadCrumb.SelectedItemsChanged.htm)
		 Событие SelectedItemsChanged
		 наступает при изменении выделенных элементов.
