...
Класс ToolBar реализует компонент
 [ToolBar](../../Components/ToolBar/ToolBar.htm), представляющий
 из себя панель инструментов.


## Синтаксис


PP.initClass(PP.Ui.ToolBar, PP.Ui.[Control](../Control/Control.htm),
 "ToolBar");
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [StateChanged](dhtmlUi.chm::/Classes/ToolBar/ToolBar.StateChanged.htm)
		 Событие StateChanged
		 наступает при смене состояния элемента панели инструмента.
