...
Класс SlidePanel реализует компонент [SlidePanel](../../Components/SlidePanel/SlidePanel.htm), который представляет собой элемент управления, состоящий из трех связанных панелей - Header, Details и View.


## Синтаксис


PP.initClass(PP.Ui.SlidePanel, PP.Ui.[Control](../Control/Control.htm), "SlidePanel");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [SlidePanel](dhtmlUi.chm::/classes/slidepanel/constructor_slidepanel.htm)
		 Конструктор SlidePanel создает
		 экземпляр компонента SlidePanel.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](dhtmlUi.chm::/classes/slidepanel/slidepanel.alignment.htm)
		 Свойство Alignment
		 устанавливает выравнивание консоли относительно центра панели.


		 ![](../../Property_Image.gif)
		 [CloseToolTip](dhtmlUi.chm::/classes/slidepanel/slidepanel.closetooltip.htm)
		 Свойство CloseToolTip
		 устанавливает текст всплывающей подсказки для кнопки закрытия
		 консоли.


		 ![](../../Property_Image.gif)
		 [CollapseConsoleToolTip](dhtmlUi.chm::/classes/slidepanel/slidepanel.collapseconsoletooltip.htm)
		 Свойство CollapseConsoleToolTip
		 устанавливает текст для всплывающей подсказки кнопки сворачивания
		 консоли.


		 ![](../../Property_Image.gif)
		 [DetailsContent](dhtmlUi.chm::/classes/slidepanel/slidepanel.detailscontent.htm)
		 Свойство DetailsContent
		 устанавливает содержимое для панели Details.


		 ![](../../Property_Image.gif)
		 [DetailsTitleContent](dhtmlUi.chm::/classes\slidepanel\slidepanel.detailstitlecontent.htm)
		 Свойство DetailsTitleContent
		 устанавливает текст заголовка панели Details.


		 ![](../../Property_Image.gif)
		 [DetailsTitleHeight](dhtmlUi.chm::/Classes/SlidePanel/SlidePanel.DetailsTitleHeight.htm)
		 Свойство DetailsTitleHeight
		 определяет высоту заголовка панели Details.


		 ![](../../Property_Image.gif)
		 [EnableResize](dhtmlUi.chm::/Classes/SlidePanel/SlidePanel.EnableResize.htm)
		 Свойство EnableResize
		 определяет возможность изменения размера панелей Header
		 и Details.


		 ![](../../Property_Image.gif)
		 [ExpandConsoleToolTip](dhtmlUi.chm::/classes/slidepanel/slidepanel.expandconsoletooltip.htm)
		 Свойство ExpandConsoleToolTip
		 устанавливает всплывающую подсказку для кнопки, при нажатии на
		 которую раскрывается консоль.


		 ![](../../Property_Image.gif)
		 [HeaderContent](dhtmlUi.chm::/classes/slidepanel/slidepanel.headercontent.htm)
		 Свойство HeaderContent
		 устанавливает содержимое панели Header.


		 ![](../../Property_Image.gif)
		 [HeaderToolTip](dhtmlUi.chm::/classes/slidepanel/slidepanel.headertooltip.htm)
		 Свойство HeaderToolTip
		 устанавливает всплывающую подсказку для панели заголовка.


		 ![](../../Property_Image.gif)
		 [IsConsoleClosable](dhtmlUi.chm::/classes/slidepanel/slidepanel.isconsoleclosable.htm)
		 Свойство IsConsoleClosable
		 определяет, отображается ли кнопка закрытия консоли.


		 ![](../../Property_Image.gif)
		 [IsConsoleClosed](dhtmlUi.chm::/classes/slidepanel/slidepanel.isconsoleclosed.htm)
		 Свойство IsConsoleClosed
		 определяет, закрыта ли консоль.


		 ![](../../Property_Image.gif)
		 [IsConsoleCollapsed](dhtmlUi.chm::/classes/slidepanel/slidepanel.isconsolecollapsed.htm)
		 Свойство IsConsoleCollapsed
		 определяет, свернута ли консоль.


		 ![](../../Property_Image.gif)
		 [IsConsoleExpandable](dhtmlUi.chm::/classes/slidepanel/slidepanel.isconsoleexpandable.htm)
		 Свойство IsConsoleExpandable
		 определяет, отображается ли кнопка сворачивания консоли.


		 ![](../../Property_Image.gif)
		 [LeftPanelWidth](dhtmlUi.chm::/classes/slidepanel/slidepanel.leftpanelwidth.htm)
		 Свойство LeftPanelWidth
		 определяет ширину консоли (левой панели).


		 ![](../../Property_Image.gif)
		 [MinLeftPanelWidth](dhtmlUi.chm::/Classes/SlidePanel/SlidePanel.MinLeftPanelWidth.htm)
		 Свойство MinLeftPanelWidth
		 определяет минимальную ширину панелей Header
		 и Details.


		 ![](../../Property_Image.gif)
		 [ViewContent](dhtmlUi.chm::/classes/slidepanel/slidepanel.viewcontent.htm)
		 Свойство ViewContent
		 устанавливает содержимое панели View.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getButtonsPanelDomNode](dhtmlUi.chm::/classes/slidepanel/slidepanel.getbuttonspaneldomnode.htm)
		 Метод getButtonsPanelDomNode
		 возвращает DOM-вершину, в которой содержатся кнопки для закрытия
		 и сворачивания/разворачивания консоли.


		 ![](../../Sub_Image.gif)
		 [getConsoleCollapsedWidth](dhtmlUi.chm::/Classes/SlidePanel/SlidePanel.getConsoleCollapsedWidth.htm)
		 Метод getConsoleCollapsedWidth
		 возвращает значение расстояния между содержимым панели Details
		 и заголовком панели Details.


		 ![](../../Sub_Image.gif)
		 [getHeaderHeight](dhtmlUi.chm::/classes/slidepanel/slidepanel.getheaderheight.htm)
		 Метод getHeaderHeight
		 возвращает высоту панели заголовка.


		 ![](../../Sub_Image.gif)
		 [getViewHeight](dhtmlUi.chm::/classes/slidepanel/slidepanel.getviewheight.htm)
		 Метод getViewHeight
		 возвращает высоту панели View.


		 ![](../../Sub_Image.gif)
		 [getViewWidth](dhtmlUi.chm::/classes/slidepanel/slidepanel.getviewwidth.htm)
		 Метод getViewWidth
		 возвращает ширину панели View.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ConsoleClosed](dhtmlUi.chm::/classes/slidepanel/slidepanel.consoleclosed.htm)
		 Событие ConsoleClosed наступает
		 при закрытии консоли.


		 ![](../../Event_Image.gif)
		 [ConsoleOpened](dhtmlUi.chm::/classes/slidepanel/slidepanel.consoleopened.htm)
		 Событие ConsoleOpened наступает
		 при открытии консоли.


		 ![](../../Event_Image.gif)
		 [ConsoleToggled](dhtmlUi.chm::/classes/slidepanel/slidepanel.consoletoggled.htm)
		 Событие ConsoleToggled
		 наступает после сворачивания или разворачивания консоли.


		 ![](../../Event_Image.gif)
		 [Resized](dhtmlUi.chm::/Classes/SlidePanel/SlidePanel.Resized.htm)
		 Событие Resized наступает
		 после изменения размера панели Details.


		 ![](../../Event_Image.gif)
		 [Resizing](dhtmlUi.chm::/Classes/SlidePanel/SlidePanel.Resizing.htm)
		 Событие Resizing наступает
		 во время изменения размера панели Details.
