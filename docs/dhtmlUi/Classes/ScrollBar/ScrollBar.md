...
Класс ScrollBar реализует компонент
 [ScrollBar](../../Components/ScrollBar/ScrollBar.htm), представляющий
 собой полосу прокрутки.


## Синтаксис


PP.initClass(PP.Ui.ScrollBar, PP.Ui.[Control](../Control/Control.htm),
 "ScrollBar");
