...
[Combo](../Combo/Combo.htm)


[ComboBox](../ComboBox/ComboBox.htm)
...
Класс FontComboBox реализует
 компонент [FontComboBox](../../Components/FontComboBox/FontComboBox.htm),
 представляющий собой раскрывающийся список для выбора шрифта.


## Синтаксис


PP.initClass(PP.Ui.FontComboBox, PP.Ui.[ComboBox](../ComboBox/ComboBox.htm),
 "FontComboBox");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [FontComboBox](dhtmlUi.chm::/Classes/FontComboBox/FontComboBox_constructor.htm)
			 Конструктор FontComboBox
			 создает экземпляр компонента FontComboBox.


## Свойства, унаследованные от [ComboBox](../ComboBox/ComboBox.htm)
...
## Методы, унаследованные от [ComboBox](../ComboBox/ComboBox.htm)
...
## Свойства, унаследованные от [Combo](../Combo/Combo.htm)
...
## Методы, унаследованные от [Combo](../Combo/Combo.htm)
...
## События, унаследованные от [Combo](../Combo/Combo.htm)
...
## Свойства, унаследованные от [Control](../Control/Control.htm)
...
## Методы, унаследованные от [Control](../Control/Control.htm)
