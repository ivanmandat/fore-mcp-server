...
Класс WizardStep - абстрактный
 класс, инкапсулирующий в себе логику каждого отдельного шага мастера.
...
Классы-наследники:
	...
	- [BindingsStep](dhtmlMetabase.chm::/Classes/Metabase/BindingsStep/BindingsStep.htm);


	- [ImportColumnsStep](dhtmlMetabase.chm::/Classes/Metabase/ImportColumnsStep/ImportColumnsStep.htm);


	- [SetValueColumnsStep](dhtmlMetabase.chm::/Classes/Metabase/SetValueColumnsStep/SetValueColumnsStep.htm).


## Синтаксис


PP.initClass(PP.Ui.WizardStep, PP.Ui.[Control](../Control/Control.htm),
 "WizardStep");
