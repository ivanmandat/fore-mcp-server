...
Класс Waiter реализует компонент [Waiter](../../Components/Waiter/Waiter.htm), представляющий собой индикатор загрузки.


## Синтаксис


PP.initClass(PP.Ui.Waiter, PP.Ui.[Control](../Control/Control.htm), "Waiter");
