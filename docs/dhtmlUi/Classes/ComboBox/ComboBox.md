...
Класс ComboBox реализует компонент
 [ComboBox](../../Components/ComboBox/ComboBox.htm), представляющий
 собой раскрывающийся список.


## Синтаксис


PP.initClass(PP.Ui.ComboBox, PP.Ui.[Combo](../Combo/Combo.htm),
 "ComboBox");
