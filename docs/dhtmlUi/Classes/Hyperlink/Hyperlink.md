...
Класс Hyperlink реализует компонент [Hyperlink](../../Components/Hyperlink/Hyperlink.htm), представляющий собой ссылку.


## Синтаксис


PP.initClass(PP.Ui.Hyperlink, PP.Ui.[Label](../Label/Label.htm), "Hyperlink");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Hyperlink](dhtmlUi.chm::/Classes/Hyperlink/Constructor_Hyperlink.htm)
		 Конструктор Hyperlink
		 создает экземпляр класса Hyperlink.
