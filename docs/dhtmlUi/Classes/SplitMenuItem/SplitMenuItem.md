...
Класс SplitMenuItem реализует
 пункт меню компонента [SplitButton](../SplitButton/SplitButton.htm).


## Синтаксис


PP.initClass(PP.Ui.SplitMenuItem, PP.Ui.MenuItem,
 "PP.Ui.SplitMenuItem");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [SplitMenuItem](Constrictor_SplitMenuItem.htm)
		 Конструктор SplitMenuItem
		 создает экземпляр класса SplitMenuItem.
