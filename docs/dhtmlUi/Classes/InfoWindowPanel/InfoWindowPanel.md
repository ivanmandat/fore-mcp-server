...
Класс InfoWindowPanel реализует
 панель [информационного
 окна](../../Components/InfoWindow/InfoWindow.htm).


## Комментарии


Панель добавляется в информационное окно при помощи метода [InfoWindow.addPanel](../InfoWindow/InfoWindow.addPanel.htm),
 удаляется при помощи [InfoWindow.removePanel](../InfoWindow/InfoWindow.removePanel.htm),
 скрывается и отображается при помощи [InfoWindow.hidePanel](../InfoWindow/InfoWindow.hidePanel.htm)
 и [InfoWindow.showPanel](../InfoWindow/InfoWindow.showPanel.htm)
 соответственно.
...
PP.initClass(PP.Ui.InfoWindowPanel, PP.Ui.[Control](../Control/Control.htm),
 "InfoWindowPanel");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [InfoWindowPanel](Constructor_InfoWindowPanel.htm)
		 Конструктор InfoWindowPanel
		 создает экземпляр класса InfoWindowPanel.
