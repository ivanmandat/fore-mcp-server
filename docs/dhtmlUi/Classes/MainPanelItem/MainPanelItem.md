...
[Button](../Button/Button.htm)


[RibbonButton](dhtmlRibbon.chm::/Classes/RibbonButton/RibbonButton.htm)
...
PP.initClass(PP.Ui.MainPanelItem, PP.Ui.[RibbonButton](dhtmlRibbon.chm::/Classes/RibbonButton/RibbonButton.htm),
 "PP.Ui.MainPanelItem");
...
Класс MainPanelItem реализует
 компонент [MainPanelItem](../../Components/MainPanelItem/MainPanelItem.htm),
 представляющий собой элемент [меню
 в раскрывающейся панели](../MainPanel/MainPanel.htm).
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [MainPanelItem](Constructor_MainPanelItem.htm)
		 Конструктор MainPanelItem
		 создает экземпляр компонента [MainPanelItem](../../Components/MainPanelItem/MainPanelItem.htm).
