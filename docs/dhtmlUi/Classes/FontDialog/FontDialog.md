...
Класс FontDialog реализует компонент [FontDialog](../../Components/FontDialog/FontDialog.htm), представляющий собой стандартный диалог выбора шрифта.


## Синтаксис


PP.initClass(PP.Ui.FontDialog, PP.Ui.[Dialog](../Dialog/Dialog.htm), "FontDialog");
...
## Методы, унаследованные от класса [Dialog](../Dialog/Dialog.htm)
...
## События, унаследованные от класса [Dialog](../Dialog/Dialog.htm)
