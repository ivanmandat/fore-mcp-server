...
Класс ColorCombo реализует компонент
 [ColorCombo](../../Components/ColorCombo/ColorCombo.htm),
 представляющий сбой раскрывающийся список для выбора цвета.


## Синтаксис


PP.initClass(PP.Ui.ColorCombo, [PP.Ui.Control](../Control/Control.htm),
 "ColorCombo");
...
## Методы, унаследованные от класса [Combo](../Combo/Combo.htm)
