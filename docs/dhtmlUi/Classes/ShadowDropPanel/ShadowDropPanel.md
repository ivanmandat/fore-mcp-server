...
Класс ShadowDropPanel реализует
 компонент [ShadowDropPanel](../../Components/ShadowDropPanel/ShadowDropPanel.htm),
 представляющий собой всплывающую панель с тенью.


## Синтаксис


PP.initClass(PP.Ui.ShadowDropPanel, PP.Ui.[DropPanel](../DropPanel/DropPanel.htm),
 "ShadowDropPanel");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ShadowDropPanel](dhtmlUi.chm::/Classes/ShadowDropPanel/Constructor_ShadowDropPanel.htm)
		 Конструктор ShadowDropPanel
		 создает экземпляр компонента [ShadowDropPanel](dhtmlUi.chm::/Components/ShadowDropPanel/ShadowDropPanel.htm).
