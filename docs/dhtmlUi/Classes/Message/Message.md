...
Класс Message реализует компонент
 [Message](../../Components/Message/Message.htm), представляющий
 собой окно с пиктограммой.


## Синтаксис


PP.initClass(PP.Ui.Message, PP.Ui.[Dialog](../Dialog/Dialog.htm),
 "PP.Ui.Message");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Message](dhtmlUi.chm::/Classes/Message/Constructor_Message.htm)
		 Конструктор Message
		 создает экземпляр компонента [Message](dhtmlUi.chm::/Components/Message/Message.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ImageUrl](dhtmlUi.chm::/Classes/Message/Message.ImageUrl.htm)
		 Свойство ImageUrl определяет
		 путь к пиктограмме окна.


		 ![](../../Property_Image.gif)
		 [Type](dhtmlUi.chm::/Classes/Message/Message.Type.htm)
		 Свойство Type определяет
		 тип окна и его пиктограмму.
