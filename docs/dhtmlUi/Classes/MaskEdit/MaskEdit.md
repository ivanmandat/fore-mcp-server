...
Класс MaskEdit реализует компонент [MaskEdit](../../Components/MaskEdit/MaskEdit.htm), представляющий собой редактор для ввода данных, соответствующих определенному шаблону.


## Синтаксис


PP.initClass(PP.Ui.MaskEdit, PP.Ui.[Control](../Control/Control.htm), "MaskEdit");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [MaskEdit](dhtmlUi.chm::/classes/maskedit/constructor_maskedit.htm)
		 Конструктор MaskEdit
		 создает экземпляр компонента MaskEdit.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AllowedSymbols](dhtmlUi.chm::/Classes/MaskEdit/MaskEdit.AllowedSymbols.htm)
		 Свойство AllowedSymbols
		 устанавливает массив символов, допустимых для ввода в редактор.


		 ![](../../Property_Image.gif)
		 [Mask](dhtmlUi.chm::/classes/maskedit/maskedit.mask.htm)
		 Свойство Mask устанавливает
		 маску.


		 ![](../../Property_Image.gif)
		 [RegExpContent](dhtmlUi.chm::/classes/maskedit/maskedit.regexpcontent.htm)
		 Свойство RegExpContent
		 устанавливает регулярное выражение для редактора маски.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [applyNotValidCSS](dhtmlUi.chm::/Classes/MaskEdit/MaskEdit.applyNotValidCSS.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [applyValidCSS](dhtmlUi.chm::/Classes/MaskEdit/MaskEdit.applyValidCSS.htm)
		 Метод **applyValidCSS**
		 ...
		 ![](../../Sub_Image.gif)
		 [getEditorValue](dhtmlUi.chm::/classes/maskedit/maskedit.geteditorvalue.htm)
		 Метод getEditorValue
		 возвращает значение редактора маски.


		 ![](../../Sub_Image.gif)
		 [getLastValidValue](dhtmlUi.chm::/classes/maskedit/maskedit.getlastvalidvalue.htm)
		 Метод getLastValidValue
		 возвращает последнее допустимое значение редактора маски.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Change](dhtmlUi.chm::/Classes/MaskEdit/MaskEdit.Change.htm)
		 Событие Change
		 наступает при смене значения в редакторе маски.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/MaskEdit/MaskEdit.ValueChanged.htm)
		 Событие ValueChanged
		 наступает после изменения значения редактора ввода.
