...
Класс Combo реализует компонент
 [Combo](../../Components/Combo/Combo.htm), представляющий собой
 редактор с раскрывющейся панелью.


## Синтаксис


PP.initClass(PP.Ui.Combo, PP.Ui.[Control](../Control/Control.htm),
 "Combo");
...
## Конструкторы
			 ...
			 ![](../../Sub_Image.gif)
			 [Combo](dhtmlUi.chm::/classes\combo\constructor_combo.htm)
			 Конструктор Combo
			 создает экземпляр компонента Combo.
...
## События, унаследованные от класса [Control](ModForms.chm::/Interface/IControl/IControl.htm)
