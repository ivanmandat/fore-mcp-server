...
[MenuItem](../MenuItem/MenuItem.htm)
...
Класс ShortSeparator реализует
 короткий разделитель между пунктами [меню](../../Components/Menu/Menu.htm).


## Комментарии


Короткий разделитель добавляется в меню динамически при помощи свойства
 [Items](../Menu/Menu.Items.htm) и статически при помощи метода
 [addItem](../Menu/Menu.addItem.htm).


## Синтаксис


PP.initClass(PP.Ui.ShortSeparator, PP.Ui.[MenuItem](../MenuItem/MenuItem.htm),
 "ShortSeparator");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ShortSeparator](Costructor_ShortSeparator.htm)
		 Конструктор ShortSeparator
		 создает экземпляр класса ShortSeparator.


## Свойства, унаследованные от класса [MenuItem](../MenuItem/MenuItem.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Checked](dhtmlUi.chm::/classes/menuitem/menuitem.checked.htm)


		 Свойство Checked
		 определяет, установлен ли флаг или переключатель для пункта меню.


		 ![](../../Property_Image.gif)
		 [CloseOnChecked](dhtmlUi.chm::/classes/menuitem/menuitem.closeonchecked.htm)
		 Свойство CloseOnChecked
		 определяет, закрывается ли меню при выборе указанного элемента.


		 ![](../../Property_Image.gif)
		 [ColumnIndex](dhtmlUi.chm::/classes/menuitem/menuitem.columnindex.htm)
		 Свойство ColumnIndex
		 устанавливает индекс столбца в [спрайте](dhtmlUi.chm::/components/imagelist/imagelist.htm).


		 ![](../../Property_Image.gif)
		 [GroupName](dhtmlUi.chm::/Classes/MenuItem/MenuItem.GroupName.htm)
		 Свойство GroupName
		 определяет имя группы для элемента меню.


		 ![](../../Property_Image.gif)
		 [HotKey](dhtmlUi.chm::/Classes/MenuItem/MenuItem.HotKey.htm)
		 Свойство HotKey
		 устанавливает название «горячих клавиш» для пункта меню.


		 ![](../../Property_Image.gif)
		 [ImageUrl](dhtmlUi.chm::/Classes/MenuItem/MenuItem.ImageUrl.htm)
		 Свойство ImageUrl
		 устанавливает путь до изображения для элемента меню.


		 ![](../../Property_Image.gif)
		 [IsHovered](dhtmlUi.chm::/Classes/MenuItem/MenuItem.IsHovered.htm)
		 Свойство IsHovered
		 определяет, отображается ли пункт меню как при наведении на него
		 курсора.


		 ![](../../Property_Image.gif)
		 [Menu](dhtmlUi.chm::/Classes/MenuItem/MenuItem.Menu.htm)
		 Свойство Menu устанавливает
		 подменю для элемента меню.


		 ![](../../Property_Image.gif)
		 [RowIndex](dhtmlUi.chm::/Classes/MenuItem/MenuItem.RowIndex.htm)
		 Свойство RowIndex устанавливает
		 индекс строки в [спрайте](dhtmlUi.chm::/components/imagelist/imagelist.htm).


		 ![](../../Property_Image.gif)
		 [Visible](dhtmlUi.chm::/Classes/MenuItem/MenuItem.Visible.htm)
		 Свойство Visible
		 определяет видимость элемента меню.


## Методы, унаследованные от класса [MenuItem](../MenuItem/MenuItem.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [getHotKey](dhtmlUi.chm::/classes/menuitem/menuitem.gethotkey.htm)


		 Метод getHotKey возвращает
		 название «горячих клавиш» для пункта меню.


		 ![](../../Sub_Image.gif)
		 [setShowIcon](dhtmlUi.chm::/classes/menuitem/menuitem.setshowicon.htm)
		 Метод setShowIcon определяет,
		 отображается ли пиктограмма для пункта меню


## События, унаследованные от класса [MenuItem](../MenuItem/MenuItem.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [CheckedChanged](dhtmlUi.chm::/classes/menuitem/menuitem.checkedchanged.htm)
		 Событие CheckedChanged
		 наступает при установке/снятии [флажка](dhtmlUi.chm::/components/checkbox/checkbox.htm)
		 или [переключателя](dhtmlUi.chm::/components/radiobutton/radiobutton.htm).
