...
Класс BreadcrumbItem реализует
 составной элемент компонента [Breadcrumb](../../Components/Breadcrumb/Breadcrumb.htm).
...
![](../../Components/Breadcrumb/bread11.gif)


Данный элемент состоит из:


	- [заголовка](../Breadcrumb/Breadcrumb.ItemClick.htm);


	- [кнопки фильтрации](BreadcrumbItem.FilterButton.htm);


	- [кнопки сортировки](BreadcrumbItem.SortButton.htm);


	- [кнопки вызова раскрывающегося
	 меню](BreadcrumbItem.MenuButton.htm).


Элементы компонента [Breadcrumb](../../Components/Breadcrumb/Breadcrumb.htm)
 объединены в коллекцию, реализованную классом [BreadcrumbItemsList](../BreadcrumbItemsList/BreadcrumbItemsList.htm).


Элементы можно разместить в цепочке навигации, где коллекция элементов
 реализована классом [BreadcrumbSelectedItemsList](../BreadcrumbSelectedItemsList/BreadcrumbSelectedItemsList.htm).


## Синтаксис


PP.initClass(PP.Ui.BreadcrumbItem, PP.Ui.[Control](../Control/Control.htm),
 "BreadcrumbItem");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [BreadcrumbItem](Constructor_BreadcrumbItem.htm)
		 Конструктор BreadcrumbItem
		 создает экземпляр класса BreadcrumbItem.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Breadcrumb](BreadcrumbItem.Breadcrumb.htm)
		 Свойство Breadcrumb
		 возвращает родительский компонент для элемента компонента [Breadcrumb](../../Components/Breadcrumb/Breadcrumb.htm).


		 ![](../../Property_Image.gif)
		 [DropForm](BreadcrumbItem.DropForm.htm)
		 Свойство DropForm устанавливает
		 раскрывающуюся часть для элемента компонента [Breadcrumb](../../Components/Breadcrumb/Breadcrumb.htm).


		 ![](../../Property_Image.gif)
		 [FilterButton](BreadcrumbItem.FilterButton.htm)
		 Свойство FilterButton
		 устанавливает кнопку фильтрации.


		 ![](../../Property_Image.gif)
		 [IsFilterOn](BreadcrumbItem.IsFilterOn.htm)
		 Свойство IsFilterOn
		 определяет, активна ли [кнопка
		 фильтрации](BreadcrumbItem.FilterButton.htm).


		 ![](../../Property_Image.gif)
		 [MenuButton](BreadcrumbItem.MenuButton.htm)
		 Свойство MenuButton
		 возвращает кнопку вызова раскрывающегося меню элемента компонента
		 [Breadcrumb](../../Components/Breadcrumb/Breadcrumb.htm).


		 ![](../../Property_Image.gif)
		 [SortButton](BreadcrumbItem.SortButton.htm)
		 Свойство SortButton
		 устанавливает кнопку сортировки.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [FilterClick](BreadcrumbItem.FilterClick.htm)
		 Событие FilterClick
		 наступает при нажатии на [кнопку
		 фильтрации](BreadcrumbItem.FilterButton.htm).
