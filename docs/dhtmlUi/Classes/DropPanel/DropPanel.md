...
Класс DropPanel реализует компонент [DropPanel](../../Components/DropPanel/DropPanel.htm), представляющий собой раскрывающуюся панель с произвольным содержимым.


## Синтаксис


PP.initClass(PP.Ui.DropPanel, PP.Ui.[Control](../Control/Control.htm), "DropPanel");
