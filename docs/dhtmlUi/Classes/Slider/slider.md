...
Класс Slider реализует [элемент управления](../../Components/Slider/Slider.htm), позволяющий пользователю сделать выбор из диапазона значений, передвигая [бегунок](../SliderItem/SliderItem.htm) вдоль его контейнера.


## Синтаксис


PP.initClass(PP.Ui.Slider, PP.Ui.[Control](../Control/Control.htm), "Slider");
...
## Конструктор
		 ...
		 *
		 [Slider](dhtmlUi.chm::/classes/slider/constructor_slider.htm)
		 Конструктор Slider
		 создает экземпляр компонента Slider.
