...
Класс TextEditor реализует компонент [TextEditor](../../Components/TextEditor/TextEditor.htm), предназначенный для редактирования текста.


## Синтаксис


PP.initClass(PP.Ui.TextEditor, [PP.Ui.Control](../Control/Control.htm), "TextEditor");
