...
Класс TabControl реализует компонент
 [TabControl](../../Components/TabControl/TabControl.htm)
 - элемент управления, содержащий несколько элементов, использующих
...
PP.initClass(PP.Ui.TabControl, PP.Ui.[Control](../Control/Control.htm), "TabControl");
