...
Класс Autocomplete реализует компонент Autocomplete, предназначенный для автозавершения ввода текста.


## Синтаксис


PP.initClass(PP.Ui.Autocomplete, PP.Ui.[Control](../Control/Control.htm), "Autocomplete");
