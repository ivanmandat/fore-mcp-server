...
Класс CheckBox реализует компонент [CheckBox](../../Components/CheckBox/CheckBox.htm), представляющий сбой флажок, используемый для индикации состояния или для включения и выключения каких-либо опций.


## Синтаксис


PP.initClass(PP.Ui.CheckBox, PP.Ui.[Control](../Control/Control.htm), "CheckBox");
