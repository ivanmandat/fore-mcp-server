...
[ProxyControl](../ProxyControl/proxycontrol.htm)
...
Классы-наследники:
	...
	- [EaxDimBarMaster](dhtmlExpress.chm::/Classes/Express/EaxDimBarMaster/EaxDimBarMaster.htm);


	- [GaugeMaster](dhtmlGauge.chm::/Classes/Speedometer/GaugeMaster/GaugeMaster.htm).


## Синтаксис


PP.initClass(PP.Ui.Master,
 PP.Ui.[ProxyControl](../ProxyControl/proxycontrol.htm), "Master");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [Master](dhtmlUi.chm::/Classes/Master/Constructor_Master.htm)
			 Конструктор Master
			 создает экземпляр класса Master.
...
## Методы, унаследованные от класса [ProxyControl](../ProxyControl/proxycontrol.htm)
