...
Класс Dialog реализует окно.


## Комментарии


Класс является базовым для класса [FontDialog](../../Components/FontDialog/FontDialog.htm).


## Синтаксис


PP.initClass(PP.Ui.Dialog, PP.Ui.[Window](../Window/Window.htm),
 "Dialog");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [Dialog](dhtmlUi.chm::/classes/dialog/dialog_constructor.htm)
			 Конструктор Dialog
			 создает экземпляр класса Dialog.
