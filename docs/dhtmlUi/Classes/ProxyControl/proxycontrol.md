...
ProxyControl - это класс-обертка над произвольным наследником PP.Ui.Control.


## Синтаксис


PP.initClass(PP.Ui.ProxyControl, PP.Ui.[Control](../Control/Control.htm), "ProxyControl");
