...
Класс WebGLControl является
 элементом управления WebGL.


## Синтаксис


PP.initClass(PP.Ui.WebGLControl, PP.Ui.[Control](../Control/Control.htm),
 "PP.Ui.WebGLControl");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [WebGLControl](dhtmlUi.chm::/Classes/WebGLControl/Constructor_WebGLControl.htm)
		 Конструктор WebGLControl
		 создает экземпляр компонента WebGLControl.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Context](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.Context.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [clear](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.clear.htm)
		 Метод clear очищает
		 область отрисовки объектов.


		 ![](../../Sub_Image.gif)
		 [createTextTexture](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.createTextTexture.htm)
		 Метод createTextTexture
		 создает текстуру с текстом.


		 ![](../../Sub_Image.gif)
		 [getMesh](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.getMesh.htm)
		 Метод getMesh возвращает
		 поверхность многогранного объекта по индексу или идентификатору.


		 ![](../../Sub_Image.gif)
		 [loadTexture](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.loadTexture.htm)
		 Метод loadTexture загружает
		 текстуру.


		 ![](../../Sub_Image.gif)
		 [renderMesh](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.renderMesh.htm)
		 Метод renderMesh отрисовывает
		 поверхность многогранного объекта.


		 ![](../../Sub_Image.gif)
		 [setAmbientLight](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.setAmbientLight.htm)
		 Метод setAmbientLight
		 устанавливает цвет окружающего света.


		 ![](../../Sub_Image.gif)
		 [setDepthTestEnabled](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.setDepthTestEnabled.htm)
		 Метод setDepthTestEnabled
		 включает или выключает тест глубины.


		 ![](../../Sub_Image.gif)
		 [setDirectLight](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.setDirectLight.htm)
		 Метод setDirectLight
		 устанавливает цвет прямого света.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [TextureLoaded](dhtmlUi.chm::/Classes/WebGLControl/WebGLControl.TextureLoaded.htm)
		 Событие TextureLoaded
		 наступает после загрузки текстуры.
