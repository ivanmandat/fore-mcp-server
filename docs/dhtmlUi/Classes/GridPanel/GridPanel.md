...
Класс GridPanel реализует компонент [GridPanel](../../Components/GridPanel/GridPanel.htm), представляющий собой таблицу для размещения компонентов.


## Синтаксис


PP.initClass(PP.Ui.GridPanel, PP.Ui.[Container](../Container/Container.htm), "GridPanel");
