...
Класс ToolBarButton реализует
 компонент [ToolBarButton](../../Components/ToolBarButton/ToolBarButton.htm),
 представляющий собой кнопку, которая является дочерним элементом панели
 инструментов.
...
PP.initClass(PP.Ui.ToolBarButton, PP.Ui.[RibbonButton](dhtmlRibbon.chm::/Classes/RibbonButton/RibbonButton.htm),
 "ToolBarButton");
...
## Свойства, унаследованные от класса [Button](../Button/Button.htm)
...
Примечание.
 Для свойства [UseWrapping](../Button/Button.UseWrapping.htm)
 по умолчанию установлено значение true.


## Методы, унаследованные от класса [Button](../Button/Button.htm)
...
Примечание.
 Свойство [Height](../Control/Control.Height.htm) неактуально.
