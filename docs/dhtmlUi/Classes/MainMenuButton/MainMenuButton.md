...
Класс MainMenuButton реализует
 дочерний элемент [главного
 меню](../../Components/MainMenu/MainMenu.htm) - кнопку.


## Комментарии


[Главное меню](../../Components/MainMenu/MainMenu.htm) реализовано
 классом [MainMenu](../MainMenu/MainMenu.htm).


Кнопка добавляется в главное меню динамически при помощи метода [MainMenu.addItem](../MainMenu/MainMenu.addItem.htm),
 статически - при помощи свойства MainMenu.Items.


## Синтаксис


PP.initClass(PP.Ui.MainMenuButton, PP.Ui.[RibbonButton](dhtmlRibbon.chm::/Classes/ribbonbutton/ribbonbutton.htm),
 "MainMenuButton");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [MainMenuButton](MainMenuButton_constructor.htm)
		 Конструктор MainMenu
		 создает экземпляр класса MainMenuButton.
...
Примечание.
 ...
 (в отличие от [RibbonButton](dhtmlRibbon.chm::/Classes/ribbonbutton/ribbonbutton.htm)).
