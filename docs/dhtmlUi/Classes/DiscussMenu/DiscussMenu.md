...
[DropPanel](../DropPanel/DropPanel.htm)
...
Класс DiscussMenu реализует
 [меню «Поделиться»](../../Components/DiscussMenu/DiscussMenu.htm)
 для публикациии ссылки на объект репозитория в социальных сетях.


## Синтаксис


PP.initClass(PP.Ui.DiscussMenu, PP.Ui.[Menu](../Menu/Menu.htm),
 "DiscussMenu");
...
## Свойства, унаследованные от класса [Menu](../Menu/Menu.htm)
...
## Методы, унаследованные от класса [Menu](../Menu/Menu.htm)
...
## Событие, унаследованные от класса [Menu](../Menu/Menu.htm)
...
## Свойства, унаследованные от класса [DropPanel](../DropPanel/DropPanel.htm)
...
## Методы, унаследованные от класса [DropPanel](../DropPanel/DropPanel.htm)
...
## События, унаследованные от класса [DropPanel](../DropPanel/DropPanel.htm)
