...
Класс FontTools реализует панель
 настройки параметров текста.
...
PP.initClass(PP.Ui.FontTools, PP.Ui.[Control](../Control/Control.htm),
 "FontTools");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 FontTools
			 Конструктор FontTools
			 создает экземпляр класса FontTools.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [FamilyLabelVisible](FontTools.FamilyLabelVisible.htm)
		 Свойство FamilyLabelVisible
		 определяет отображение надписи «Шрифт» элемента выбора шрифта.


		 ![](../../Property_Image.gif)
		 [FamilyVisible](FontTools.FamilyVisible.htm)
		 Свойство FamilyVisible
		 определяет отображение элемента выбора шрифта.


		 ![](../../Property_Image.gif)
		 [Font](FontTools.Font.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [init](FontTools.init.htm)
		 Метод init устанавливает
		 настройки шрифта.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [PropertyChanged](FontTools.PropertyChanged.htm)
