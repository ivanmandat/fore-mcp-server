...
Класс MainPanel реализует компонент
 [MainPanel](../../Components/MainPanel/MainPanel.htm), представляющий
...
PP.initClass(PP.Ui.MainPanel, PP.Ui.[DropPanel](../DropPanel/DropPanel.htm),
 "PP.Ui.MainPanel");
