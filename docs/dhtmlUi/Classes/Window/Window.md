...
Класс Window реализует компонент
 [Window](../../Components/Window/Window.htm), представляющий
 собой окно для размещения произвольного содержимого.


## Синтаксис


PP.initClass(PP.Ui.Window, PP.Ui.[DropPanel](../DropPanel/DropPanel.htm),
 "Window");
