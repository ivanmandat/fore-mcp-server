...
Класс SplitButton реализует компонент [SplitButton](../../Components/SplitButton/SplitButton.htm), представляющий собой кнопку, состоящую из двух частей: верхняя часть - кнопка с картинкой, нижняя - кнопка с раскрывающимся меню.


## Синтаксис


PP.initClass(PP.Ui.SplitButton, PP.Ui.[Control](../Control/Control.htm), "SplitButton");
...
Примечание. Значение свойства Height для компонента SplitButton изменить нельзя, так как высота кнопки предопределена.
