...
PP.initClass(PP.Ui.Control, PP.[Object](dhtmlCommon.chm::/Classes/object/object.htm),
 "Control");
...
Класс Control - базовый класс
 визуальных компонентов, общий класс для визуальных и невизуальных компонентов.
