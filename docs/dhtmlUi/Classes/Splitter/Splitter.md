...
Класс Splitter реализует компонент [Splitter](../../Components/Splitter/Splitter.htm), представляющий собой разделитель между двумя панелями.


## Синтаксис


PP.initClass(PP.Ui.Splitter, PP.Ui.[Control](../Control/Control.htm), "Splitter");
