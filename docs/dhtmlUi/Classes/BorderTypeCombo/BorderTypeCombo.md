...
Класс BorderTypeCombo реализует
 базовые настройки редактора границ.


## Синтаксис


PP.initClass(PP.Ui.BorderTypeCombo, PP.Ui.[Control](../Control/Control.htm),
 'PP.Ui.BorderTypeCombo);
