...
Класс SignaturesEditor реализует
 панель редактирования маски подписей.


## Комментарии


В веб-приложении панель редактирования маски по умолчанию создается
 на панели редактирования подсказок, например [TreeTooltipsPanel](dhtmlUiTree.chm::/Classes/TreeTooltipsPanel/TreeTooltipsPanel.htm).


Для добавления шаблонов необходимо добавить элементы в свойство [Items](SignaturesEditor.Items.htm).
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 SignaturesEditor
		 Конструктор SignaturesEditor
		 создает экземпляр компонента SignaturesEditor.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Currencies](SignaturesEditor.Currencies.htm)
		 Свойство Currencies
		 определяет массив используемых единиц в денежном формате.


		 ![](../../Property_Image.gif)
		 [DecimalPlaces](SignaturesEditor.DecimalPlaces.htm)
		 Свойство DecimalPlaces
		 определяет число знаков после запятой.


		 ![](../../Property_Image.gif)
		 [DefaultCurrency](SignaturesEditor.DefaultCurrency.htm)
		 Свойство DefaultCurrency
		 определяет денежный формат по умолчанию.


		 ![](../../Property_Image.gif)
		 [DefaultDecimalPlaces](SignaturesEditor.DefaultDecimalPlaces.htm)
		 Свойство DefaultDecimalPlaces
		 определяет число знаков после запятой по умолчанию.


		 ![](../../Property_Image.gif)
		 [DefaultDelimeter](SignaturesEditor.DefaultDelimeter.htm)
		 Свойство DefaultDelimeter
		 определяет признак добавления разделителя разрядов по умолчанию.


		 ![](../../Property_Image.gif)
		 [DefaultFormatType](SignaturesEditor.DefaultFormatType.htm)
		 Свойство DefaultFormatType
		 определяет формат по умолчанию.


		 ![](../../Property_Image.gif)
		 [Delimeter](SignaturesEditor.Delimeter.htm)
		 Свойство Delimeter
		 определяет признак добавления разделителя разрядов.


		 ![](../../Property_Image.gif)
		 [FormatDelimeter](SignaturesEditor.FormatDelimeter.htm)
		 Свойство FormatDelimeter
		 определяет разделитель форматов.


		 ![](../../Property_Image.gif)
		 [Formats](SignaturesEditor.Formats.htm)
		 Свойство Formats определяет
		 массив используемых форматов.


		 ![](../../Property_Image.gif)
		 [Formula](SignaturesEditor.Formula.htm)
		 Свойство Formula определяет
		 содержание текстового поля.


		 ![](../../Property_Image.gif)
		 [Items](SignaturesEditor.Items.htm)
		 Свойство Items определяет
		 массив пунктов меню.


		 ![](../../Property_Image.gif)
		 [Menu](SignaturesEditor.Menu.htm)
		 Свойство Menu определяет
		 меню компонента.


		 ![](../../Property_Image.gif)
		 [MenuButton](SignaturesEditor.MenuButton.htm)
		 Свойство MenuButton
		 определяет кнопку меню.


		 ![](../../Property_Image.gif)
		 [TextArea](SignaturesEditor.TextArea.htm)
		 Свойство TextArea определяет
		 текстовое поле.


		 ![](../../Property_Image.gif)
		 [VariablePostfix](SignaturesEditor.VariablePostfix.htm)
		 Свойство VariablePostfix
		 определяет постфикс переменных.


		 ![](../../Property_Image.gif)
		 [VariablePrefix](SignaturesEditor.VariablePrefix.htm)
		 Свойство VariablePrefix
		 определяет префикс переменных.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [AfterTimeout](SignaturesEditor.AfterTimeout.htm)
		 Событие AfterTimeout
		 наступает после таймаута, при изменении значения поля ввода.


		 ![](../../Event_Image.gif)
		 [TextChanged](SignaturesEditor.TextChanged.htm)
		 Событие TextChanged
		 наступает после изменения текста.
