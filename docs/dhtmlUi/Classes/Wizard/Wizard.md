...
Класс-наследник - [ImportDataWizard](dhtmlMetabase.chm::/Classes/Metabase/ImportDataWizard/ImportDataWizard.htm).


Шаги мастера реализованы классом [WizardStep](../WizardStep/WizardStep.htm).


## Синтаксис


PP.initClass(PP.Ui.Wizard, PP.Ui.[Window](../Window/Window.htm),
 "Wizard");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Wizard](Constructor_Wizard.htm)
		 Конструктор Wizard
		 создает экземпляр класса Wizard.
...
## Свойства, унаследованные от класса [Window](../Window/Window.htm)
...
## Методы, унаследованные от класса [Window](../Window/Window.htm)
...
## События, унаследованные от класса [Window](../Window/Window.htm)
