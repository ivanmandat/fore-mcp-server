...
Класс ProgressBar реализует компонент [ProgressBar](../../Components/ProgressBar/ProgressBar.htm), предназначенный для индикации процесса выполнения длительных операций.


## Синтаксис


PP.initClass(PP.Ui.ProgressBar, PP.Ui.[Control](../Control/Control.htm), "ProgressBar");
