...
[CheckBox](../CheckBox/CheckBox.htm)
...
Класс RadioButton реализует
 компонент [RadioButton](dhtmlRibbon.chm::/components/ribbonbutton/ribbonbutton.htm),
 представляющий собой переключатель для выбора одной из нескольких взаимоисключающих
 альтернатив.
...
PP.initClass(PP.Ui.RadioButton, PP.Ui.[CheckBox](../CheckBox/CheckBox.htm),
 "RadioButton");
...
## Конструктор
		 ...
		 Конструктор RadioButton создает
		 экземпляр компонента RadioButton.
...
## Свойства, унаследованные от класса [CheckBox](../CheckBox/CheckBox.htm)
...
## События, унаследованные от класса [CheckBox](../CheckBox/CheckBox.htm)
