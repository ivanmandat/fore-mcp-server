...
Класс ToolBarSeparator реализует компонент [ToolBarSeparator](../../Components/ToolBarSeparator/ToolBarSeparator.htm), представляющий собой разделитель между элементами [панели инструментов](../ToolBar/ToolBar.htm).


## Синтаксис


PP.initClass(PP.Ui.ToolBarSeparator, PP.Ui.[Control](../Control/Control.htm), "ToolBarSeparator");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ToolBarSeparator](dhtmlUi.chm::/Classes/ToolBarSeparator/Constructor_ToolBarSeparator.htm)
		 Конструктор ToolBarSeparator
		 создает экземпляр компонента ToolBarSeparator.
