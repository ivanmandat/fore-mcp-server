...
Класс Breadcrumb реализует компонент [Breadcrumb](../../Components/Breadcrumb/Breadcrumb.htm), предназначенный для создания цепочки навигации по объектам.


## Синтаксис


PP.initClass(PP.Ui.Breadcrumb, PP.Ui.[Control](../Control/Control.htm), "Breadcrumb");
