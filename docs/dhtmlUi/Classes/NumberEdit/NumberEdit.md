...
Класс NumberEdit реализует компонент
 [NumberEdit](../../Components/NumberEdit/NumberEdit.htm), представляющий
...
Класс NumberEdit является наследником
 класса [SpinEdit](dhtmlCommon.chm::/Classes/spinedit/spinedit.htm),
 реализующего редактор с кнопками прокрутки.


Значения свойств задаются в конструкторе [NumberEdit](Constructor_NumberEdit.htm)
 или с помощью метода set<имя свойства>, а возвращаются с помощью метода
 get<имя
 свойства>.
...
PP.initClass(PP.Ui.NumberEdit, PP.Ui.[SpinEdit](dhtmlCommon.chm::/Classes/spinedit/spinedit.htm),
 "NumberEdit");
