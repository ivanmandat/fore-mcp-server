...
Класс **DataVisualizer**
 представляет собой базовый класс для визуализаторов продукта «Форсайт. Аналитическая платформа».


## Синтаксис


PP.initClass(PP.Ui.DataVisualizer, [PP.Ui.Control](../Control/Control.htm),
 "PP.Ui.DataVisualizer");
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [DataVisualizer](dhtmlUi.chm::/Classes/DataVisualizer/Constructor_DataVisualizer.htm)
			 Конструктор **DataVisualizer**
			 создаёт экземпляр класса **DataVisualizer**.
