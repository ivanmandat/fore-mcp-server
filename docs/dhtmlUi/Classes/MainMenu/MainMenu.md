...
Класс MainMenu реализует компонент
 [MainMenu](../../Components/MainMenu/MainMenu.htm), представляющий
 собой главное меню.
...
PP.initClass(PP.Ui.MainMenu, PP.Ui.[Control](../Control/Control.htm),
 "MainMenu");
