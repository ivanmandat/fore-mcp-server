...
Класс MenuHeader реализует заголовок
 [меню](../../Components/Menu/Menu.htm).


## Комментарии


Заголовок в меню может добавляться динамически при помощи свойства [Items](../Menu/Menu.Items.htm) или статически при помощи
 метода [addItem](../Menu/Menu.addItem.htm).


## Синтаксис


PP.initClass(PP.Ui.MenuHeader, PP.Ui.[MenuItem](../MenuItem/MenuItem.htm),
 "MenuHeader");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [MenuHeader](MenuHeader_constructor.htm)
		 Конструктор MenuHeader
		 создает экземпляр класса MenuHeader.
