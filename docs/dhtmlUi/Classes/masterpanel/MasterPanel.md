...
Класс MasterPanel - абстрактный
 класс панели [мастера](../master/Master.htm).
...
Классы-наследники:
	...
	- [AnalysisPanel](dhtmlExpress.chm::/Classes/Express/AnalysisPanel/AnalysisPanel.htm);


	- [BubbleChartMasterSize](../BubbleChartMasterSize/BubbleChartMasterSize.htm);


	- [DataPanel](dhtmlExpress.chm::/Classes/Express/DataPanel/DataPanel.htm);


	- [DataSourceParamsPanel](dhtmlExpress.chm::/Classes/Express/DataSourceParamsPanel/DataSourceParamsPanel.htm);


	- [DataSourceParamsPanel](dhtmlExpress.chm::/Classes/Express/DataSourceParamsPanel/DataSourceParamsPanel.htm);


	- [DimIndicatorMP](dhtmlExpress.chm::/Classes/Express/DimIndicatorMP/DimIndicatorMP.htm);


	- [EaxDimBarMasterPanel](dhtmlExpress.chm::/Classes/Express/EaxDimBarMasterPanel/EaxDimBarMasterPanel.htm)
	 и др.
...
PP.initClass(PP.Ui.MasterPanel, PP.Ui.[NavigationItem](dhtmlCommon.chm::/Classes/NavigationItem/NavigationItem.htm),
 "MasterPanel");
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [PropertyChanged](dhtmlUi.chm::/Classes/masterpanel/MasterPanel.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает после изменения настроек панели мастера.
