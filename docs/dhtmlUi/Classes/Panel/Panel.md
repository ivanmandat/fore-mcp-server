...
Класс Panel реализует компонент
 [Panel](../../Components/Panel/Panel.htm), представляющий собой
...
PP.initClass(PP.Ui.Panel, PP.Ui.[Container](../Container/Container.htm),
 "PP.Ui.Panel", PP.Ui.ICtrlItems);
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Panel](dhtmlUi.chm::/Classes/Panel/Constructor_Panel.htm)
		 Конструктор Panel создает
		 экземпляр компонента [Panel](dhtmlUi.chm::/Components/Panel/Panel.htm).
