...
[MasterPanel](../masterpanel/MasterPanel.htm)
...
Класс **BubbleChartMasterSize**
 реализует вкладку «Размер» в [мастере
 управления пузырьковой диаграммой](dhtmlExpress.chm::/Classes/Express/EaxBubbleChartMaster/EaxBubbleChartMaster.htm) экспресс-отчета.


## Комментарии


Вкладка «Размер» в мастере управления пузырьковой диаграммой экспресс-отчета
...
Данная вкладка активна, если для какого-либо показателя экспресс-отчета
 выбрано измерение «Размер»:


![](BubbleChartMasterSize.png)


## Синтаксис


PP.initClass(PP.Ui.BubbleChartMasterSize, [PP.Ui.MasterPanel](../masterpanel/MasterPanel.htm),
 «BubbleChartMasterSize», PP.Ui.INotifySettingsChanged);
...
## Конструктор
				 ...
				 ![](../../Sub_Image.gif)
				 [BubbleChartMasterSize](Constructor_BubbleChartMasterSize.htm)
				 Конструктор **BubbleChartMasterSize**
				 создает экземпляр класса **BubbleChartMasterSize**.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DataView](dhtmlUi.chm::/Classes/BubbleChartMasterSize/BubbleChartMasterSize.DataView.htm)
		 Свойство **DataView**
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [setCurrentState](dhtmlUi.chm::/Classes/BubbleChartMasterSize/BubbleChartMasterSize.setCurrentState.htm)
		 Метод **setCurrentState**
		 устанавливает настройки вкладки «Легенда» у мастера управления
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [SettingChanged](dhtmlUi.chm::/Classes/BubbleChartMasterSize/BubbleChartMasterSize.SettingChanged.htm)
		 Событие **SettingChanged
		 **наступает после изменения настроек вкладки «Размер»
		 в мастере управления пузырьковой диаграммой экспресс-отчета.
