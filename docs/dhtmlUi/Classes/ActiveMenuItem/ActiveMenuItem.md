...
Класс ActiveMenuItem реализует
 пункт меню, который не подсвечивается при наведении на него курсора и
 при нажатии на который не закрывается меню.


## Синтаксис


PP.initClass(PP.Ui.ActiveMenuItem, PP.Ui.[MenuItem](../MenuItem/MenuItem.htm),
 "ActiveMenuItem");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ActiveMenuItem](Constructor_ActiveMenuItem.htm)
		 Конструктор ActiveMenuItem
		 создает экземпляр класса ActiveMenuItem.
