...
Класс MenuItem реализует пункт
...
Класс MenuItem - базовый класс
 для всех элементов меню: пунктов меню (MenuItem), заголовков ([MenuHeader](../MenuHeader/MenuHeader.htm)),
 разделителей между пунктами меню ([Separator](../Separator/Separator.htm)).


## Синтаксис


PP.initClass(PP.Ui.MenuItem, PP.Ui.[Control](../Control/Control.htm),
 "MenuItem");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [MenuItem](MenuItem_constructor.htm)


		 Конструктор MenuItem
		 создает экземпляр класса MenuItem.
