...
Класс BCList - базовый класс
 для работы с коллекциями элементов компонента [Breadcrumb](../../Components/Breadcrumb/Breadcrumb.htm).


## Комментарии


Класс BCList является наследником
 класса [List](dhtmlList.chm::/Classes/list/list.htm).


Классы [BreadcrumbItemsList](../BreadcrumbItemsList/BreadcrumbItemsList.htm)
 и [BreadcrumbSelectedItemsList](../BreadcrumbSelectedItemsList/BreadcrumbSelectedItemsList.htm)
 наследуются от класса BCList.


## Синтаксис


PP.initClass(PP.Ui.BCList, PP.[List](dhtmlList.chm::/Classes/list/list.htm),
 "BCList");
