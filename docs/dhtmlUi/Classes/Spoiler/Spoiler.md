...
Класс Spoiler реализует компонент
 [Spoiler](../../Components/Spoiler/Spoiler.htm), представляющий
 собой раскрывающуюся панель с элементами.


## Синтаксис


PP.initClass(PP.Ui.Spoiler, PP.Ui.[Panel](../Panel/Panel.htm),
 "PP.Ui.Spoiler");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Spoiler](dhtmlUi.chm::/Classes/Spoiler/Constructor_Spoiler.htm)
		 Конструктор Spoiler
		 создает экземпляр компонента [Spoiler](dhtmlUi.chm::/Components/Spoiler/Spoiler.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DefaultContentMargin](dhtmlUi.chm::/Classes/Spoiler/Spoiler.DefaultContentMargin.htm)
		 Свойство DefaultContentMargin
		 определяет отступ содержимого от края панели.


		 ![](../../Property_Image.gif)
		 [DefaultResizerSize](dhtmlUi.chm::/Classes/Spoiler/Spoiler.DefaultResizerSize.htm)
		 Свойство DefaultResizerSize
		 определяет минимальный отступ содержимого от края панели.


		 ![](../../Property_Image.gif)
		 [EnableCollapse](dhtmlUi.chm::/Classes/Spoiler/Spoiler.EnableCollapse.htm)
		 Свойство EnableCollapse
		 определяет, можно ли свернуть панель.


		 ![](../../Property_Image.gif)
		 [EnableResize](dhtmlUi.chm::/Classes/Spoiler/Spoiler.EnableResize.htm)
		 Свойство EnableResize
		 определяет, можно ли изменить размер панели.


		 ![](../../Property_Image.gif)
		 [IsExpanded](dhtmlUi.chm::/Classes/Spoiler/Spoiler.IsExpanded.htm)
		 Свойство IsExpanded
		 определяет состояние панели.


		 ![](../../Property_Image.gif)
		 [MaxPanelSize](dhtmlUi.chm::/Classes/Spoiler/Spoiler.MaxPanelSize.htm)
		 Свойство MaxPanelSize
		 определяет максимальный размер панели.


		 ![](../../Property_Image.gif)
		 [MinPanelSize](dhtmlUi.chm::/Classes/Spoiler/Spoiler.MinPanelSize.htm)
		 Свойство MinPanelSize
		 определяет минимальный размер панели.


		 ![](../../Property_Image.gif)
		 [Position](dhtmlUi.chm::/Classes/Spoiler/Spoiler.Position.htm)
		 Свойство Position определяет
		 направление раскрытия панели.


		 ![](../../Property_Image.gif)
		 [Title](dhtmlUi.chm::/Classes/Spoiler/Spoiler.Title.htm)
		 Свойство Title определяет
		 текст панели, который будет отображаться в свернутом состоянии.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Collapsed](dhtmlUi.chm::/Classes/Spoiler/Spoiler.Collapsed.htm)
		 Событие Collapsed наступает
		 после сворачивания панели.


		 ![](../../Event_Image.gif)
		 [Expanded](dhtmlUi.chm::/Classes/Spoiler/Spoiler.Expanded.htm)
		 Событие Expanded наступает
		 после разворачивания панели.


		 ![](../../Event_Image.gif)
		 [Resized](dhtmlUi.chm::/Classes/Spoiler/Spoiler.Resized.htm)
		 Событие Resized наступает
		 после изменения размера панели.


		 ![](../../Event_Image.gif)
		 [Resizing](dhtmlUi.chm::/Classes/Spoiler/Spoiler.Resizing.htm)
		 Событие Resizing наступает
		 во время изменения размера панели.


## Свойства, унаследованные от класса [Panel](../Panel/Panel.htm)
...
## Методы, унаследованные от класса [Panel](../Panel/Panel.htm)
