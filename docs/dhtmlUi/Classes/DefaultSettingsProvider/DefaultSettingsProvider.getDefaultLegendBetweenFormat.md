# DefaultSettingsProvider.getDefaultLegendBetweenFormat
...
getDefaultLegendBetweenFormat();


## Описание


Метод getDefaultLegendBetweenFormat
 возвращает формат текста легенды «между» по умолчанию.
