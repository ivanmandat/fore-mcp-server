...
[BorderTypeCombo](../BorderTypeCombo/BorderTypeCombo.htm)
...
Класс MasterBorderTypeCombo
 реализует редактор границы подписей карты на боковой панели.
...
PP.initClass(PP.Ui.MasterBorderTypeCombo, PP.Ui.[BorderTypeCombo](../BorderTypeCombo/BorderTypeCombo.htm),
 'PP.Ui.MasterBorderTypeCombo');
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 MasterBorderTypeCombo
			 Конструктор MasterBorderTypeCombo
			 создает экземпляр MasterBorderTypeCombo.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [IsColorExternal](MasterBorderTypeCombo.IsColorExternal.htm)
		 Свойство IsColorExternal
		 определяет метод определения цвета границы.


		 ![](../../Property_Image.gif)
		 [IsColorExternalResourceKey](MasterBorderTypeCombo.getIsColorExternalResourceKey.htm)
		 Свойство IsColorExternalResourceKey
		 определяет ресурс, используемый мастером редактора границ.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [IsColorExternalChanged](MasterBorderTypeCombo.IsColorExternalChanged.htm)
		 Событие IsColorExternalChanged
		 наступает после изменения метода определения цвета границы.


## Свойства, унаследованные от класса [BorderTypeCombo](../BorderTypeCombo/BorderTypeCombo.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderColor](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderColor.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderEnabled](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderEnabled.htm)

		 Свойство BorderEnabled
		 определяет доступность редактора границ.


		 ![](../../Property_Image.gif)
		 [BorderType](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderType.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderWidth](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderWidth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ColorControlVisible](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.ColorControlVisible.htm)

		 Свойство ColorControlVisible
		 определяет видимость элемента управления цветом.


		 ![](../../Property_Image.gif)
		 [EnabledControlVisible](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.EnabledControlVisible.htm)

		 Свойство EnabledControlVisible
		 определяет видимость чекбокса включения редактора границ.


		 ![](../../Property_Image.gif)
		 [MaxBorderWidth](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.MaxBorderWidth.htm)

		 Свойство MaxBorderWidth
		 определяет максимальную ширину границы.


		 ![](../../Property_Image.gif)
		 [MinBorderWidth](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.MinBorderWidth.htm)

		 Свойство MinBorderWidth
		 определяет минимальную ширину границы.


		 ![](../../Property_Image.gif)
		 [SplitLines](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.SplitLines.htm)

		 Свойство SplitLines
		 определяет отображение редактора в две строки.


		 ![](../../Property_Image.gif)
		 [TypeControlVisible](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.TypeControlVisible.htm)

		 Свойство TypeControlVisible
		 определяет видимость редактора типа границ.


		 ![](../../Property_Image.gif)
		 [TypeControlWidth](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.TypeControlWidth.htm)

		 Свойство TypeControlWidth
		 определяет ширину элемента управления типом границы.


		 ![](../../Property_Image.gif)
		 [TypesMode](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.TypesMode.htm)

		 Свойство TypesMode
		 определяет технологию отображения линии.


		 ![](../../Property_Image.gif)
		 [WidthControlSuffix](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.WidthControlSuffix.htm)

		 Свойство WidthControlSuffix
		 определяет суффикс в элементе редактирования ширины линии.


		 ![](../../Property_Image.gif)
		 [WidthControlVisible](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.WidthControlVisible.htm)

		 Свойство WidthControlVisible
		 определяет видимость элемента редактирования шириной линии.


		 ![](../../Property_Image.gif)
		 [WidthControlWidth](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.WidthControlWidth.htm)

		 Свойство WidthControlWidth
		 определяет ширину элемента редактирования шириной линии.


## События, унаследованные от класса [BorderTypeCombo](../BorderTypeCombo/BorderTypeCombo.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [BorderColorChanged](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderColorChanged.htm)

		 Событие BorderColorChanged
		 наступает при изменении цвета границы.


		 ![](../../Event_Image.gif)
		 [BorderEnabledChanged](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderEnabledChanged.htm)

		 Событие BorderEnabledChanged
		 наступает при изменении доступности редактора границы.


		 ![](../../Event_Image.gif)
		 [BorderTypeChanged](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderTypeChanged.htm)

		 Событие BorderTypeChanged
		 наступает при изменении типа границы.


		 ![](../../Event_Image.gif)
		 [BorderValueChanged](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderValueChanged.htm)

		 Событие BorderValueChanged
		 наступает при изменении границы.


		 ![](../../Event_Image.gif)
		 [BorderWidthChanged](dhtmlUi.chm::/Classes/BorderTypeCombo/BorderTypeCombo.BorderWidthChanged.htm)

		 Событие BorderWidthChanged
		 наступает при изменении ширины границы.
