...
Класс TabItem реализует компонент [TabItem](../../Components/TabItem/TabItem.htm), представляющий собой вкладку, дочерний элемент компонента [TabControl](../../Components/TabControl/TabControl.htm).


## Синтаксис


PP.initClass(PP.Ui.TabItem, PP.Ui.[Control](../Control/Control.htm), "TabItem");
