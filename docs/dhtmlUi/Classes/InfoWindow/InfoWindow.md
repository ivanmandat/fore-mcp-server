...
Класс InfoWindow реализует [информационное окно](../../Components/InfoWindow/InfoWindow.htm).


## Синтаксис


PP.initClass(PP.Ui.InfoWindow, PP.Ui.[DropPanel](../DropPanel/DropPanel.htm),
 "InfoWindow");
