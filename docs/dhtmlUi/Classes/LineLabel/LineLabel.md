...
Класс LineLabel реализует компонент
 [LineLabel](../../Components/LineLabel/LineLabel.htm), представляющий
 собой подпись с линией.


## Синтаксис


PP.initClass(PP.Ui.LineLabel, PP.Ui.[Control](../Control/Control.htm),
 "PP.Ui.LineLabel");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [LineLabel](dhtmlUi.chm::/Classes/LineLabel/Constructor_LineLabel.htm)
		 Конструктор LineLabel
		 создает экземпляр компонента [LineLabel](dhtmlUi.chm::/Components/LineLabel/LineLabel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [IsLineBlur](dhtmlUi.chm::/Classes/LineLabel/LineLabel.IsLineBlur.htm)
		 Свойство IsLineBlur
		 определяет размытость линии.


		 ![](../../Property_Image.gif)
		 [LineBlurWidth](dhtmlUi.chm::/Classes/LineLabel/LineLabel.LineBlurWidth.htm)
		 Свойство LineBlurWidth
		 определяет ширину размытости по краям линии.


		 ![](../../Property_Image.gif)
		 [LineColor](dhtmlUi.chm::/Classes/LineLabel/LineLabel.LineColor.htm)
		 Свойство LineColor
		 определяет цвет линии.


		 ![](../../Property_Image.gif)
		 [LineHeight](dhtmlUi.chm::/Classes/LineLabel/LineLabel.LineHeight.htm)
		 Свойство LineHeight
		 определяет высоту линии.
