...
Класс ToolTip реализует компонент
 [ToolTip](../../Components/ToolTip/ToolTip.htm), представляющий
 собой всплывающую подсказку.


## Синтаксис


PP.initClass(PP.Ui.ToolTip, PP.Ui.[DropPanel](../DropPanel/DropPanel.htm),
 "ToolTip");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ToolTip](dhtmlUi.chm::/classes/tooltip/tooltip_constructor.htm)
		 Конструктор ToolTip создает экземпляр компонента ToolTip.
