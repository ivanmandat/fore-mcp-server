...
Класс BorderLayout реализует
 компонент [BorderLayout](../../Components/BorderLayout/BorderLayout.htm),
 представляющий собой макет для размещения компонентов внутри контейнера
...
PP.initClass(PP.Ui.BorderLayout, PP.Ui.[Control](../Control/Control.htm),
 "PP.Ui.BorderLayout");
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [BorderLayout](dhtmlUi.chm::/Classes/BorderLayout/Constructor_BorderLayout.htm)
		 Конструктор BorderLayout
		 создает экземпляр компонента [BorderLayout](dhtmlUi.chm::/Components/BorderLayout/BorderLayout.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BottomRegion](dhtmlUi.chm::/Classes/BorderLayout/Borderlayout.BottomRegion.htm)
		 Свойство BottomRegion
		 содержит компонент нижней области макета.


		 ![](../../Property_Image.gif)
		 [CenterRegion](dhtmlUi.chm::/Classes/BorderLayout/Borderlayout.CenterRegion.htm)
		 Свойство CenterRegion
		 содержит компонент центральной области макета.


		 ![](../../Property_Image.gif)
		 [LeftRegion](dhtmlUi.chm::/Classes/BorderLayout/Borderlayout.LeftRegion.htm)
		 Свойство LeftRegion
		 содержит компонент левой области макета.


		 ![](../../Property_Image.gif)
		 [Region](dhtmlUi.chm::/Classes/BorderLayout/BorderLayout.Region.htm)
		 Свойство Region устанавливает
		 заданную область макета.


		 ![](../../Property_Image.gif)
		 [RightRegion](dhtmlUi.chm::/Classes/BorderLayout/Borderlayout.RightRegion.htm)
		 Свойство RightRegion
		 содержит компонент правой области макета.
