...
Класс FontBox реализует компонент [FontBox](../../Components/FontBox/FontBox.htm), предназначенный для настройки параметров текста.


## Синтаксис


PP.initClass(PP.Ui.FontBox, PP.Ui.[Control](../Control/Control.htm), "FontBox");
