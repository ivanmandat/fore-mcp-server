...
[TextBox](../TextBox/TextBox.htm)


[SpinEdit](dhtmlCommon.chm::/Classes/spinedit/spinedit.htm)
...
Класс DateTimeEdit реализует
 компонент [DateTimeEdit](../../Components/DateTimeEdit/DateTimeEdit.htm),
 представляющий собой редактор даты и времени.


## Синтаксис


PP.initClass(PP.Ui.DateTimeEdit, PP.Ui.[SpinEdit](dhtmlCommon.chm::/Classes/spinedit/spinedit.htm),
 "DateTimeEdit");
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [DateTimeEdit](dhtmlUi.chm::/classes\datetimeedit\constructor_datetimeedit.htm)
		 Конструктор DateTimeEdit создает экземпляр компонента DateTimeEdit.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CurrentDate](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.currentdate.htm)
		 Свойство CurrentDate
		 устанавливает значение даты и времени.


		 ![](../../Property_Image.gif)
		 [MaxDate](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.maxdate.htm)
		 Свойство MaxDate
		 устанавливает максимальное возможное значение даты и времени.


		 ![](../../Property_Image.gif)
		 [MinDate](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.mindate.htm)
		 Свойство MinDate устанавливает
		 минимальное возможное значение даты и времени.


		 ![](../../Property_Image.gif)
		 [Mode](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.mode.htm)
		 Свойство Mode устанавливает
		 режим отображения даты и времени.


		 ![](../../Property_Image.gif)
		 [MonthNames](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.monthnames.htm)
		 Свойство MonthNames
		 задаёт массив с наименованиями месяцев.


		 ![](../../Property_Image.gif)
		 [ShowDate](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.showdate.htm)
		 Свойство ShowDate
		 определяет, отображается ли дата в компоненте.


		 ![](../../Property_Image.gif)
		 [ShowTime](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.showtime.htm)
		 Свойство ShowTime
		 определяет, отображается ли время в компоненте.


		 ![](../../Property_Image.gif)
		 [TextAfterHalfYear](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.textafterhalfyear.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TextAfterMonth](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.textaftermonth.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TextAfterQuarter](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.textafterquarter.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TextAfterWeek](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.textafterweek.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [TextAfterYear](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.textafteryear.htm)
...
## Свойство, унаследованное от класса [SpinEdit](dhtmlCommon.chm::/Classes/spinedit/spinedit.htm)
...
## Свойства, унаследованные от класса [TextBox](../TextBox/TextBox.htm)
...
## Методы, унаследованные от класса [TextBox](../TextBox/TextBox.htm)
...
## События, унаследованные от класса [TextBox](../TextBox/TextBox.htm)
