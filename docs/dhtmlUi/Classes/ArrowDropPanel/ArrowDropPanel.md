...
Класс ArrowDropPanel реализует
 компонент [ArrowDropPanel](../../Components/ArrowDropPanel/ArrowDropPanel.htm),
 представляющий собой раскрывающуюся, относительно другого компонента,
 панель со стрелкой и произвольным содержимым.


## Синтаксис


PP.initClass(PP.Ui.ArrowDropPanel, PP.Ui.[DropPanel](../DropPanel/DropPanel.htm),
 "PP.Ui.ArrowDropPanel");
