...
Класс SourceView представляет
 собой базовый класс, предназначенный для работы с представлениями данных.


## Синтаксис


PP.initClass(PP.Ui.SourceView, [PP.Ui.Control](../Control/Control.htm),
 "PP.Ui.SourceView", PP.ISourceView);
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [SourceView](dhtmlUi.chm::/Classes/SourceView/Constructor_SourceView.htm)
			 Конструктор SourceView
			 создает экземпляр класса SourceView.
