...
[ListItem](dhtmlList.chm::/Classes/listitem/listitem.htm)
...
Класс IconListItem реализует
 компонент [IconListItem](../../Components/IconListItem/IconListItem.htm),
 представляющий собой элемент списка, состоящий из пиктограмм.


## Комментарии


Класс IconListItem является
...
PP.initClass(PP.Ui.IconListItem, PP.Ui.[ListItem](dhtmlList.chm::/Classes/listitem/listitem.htm),
 "IconListItem");
