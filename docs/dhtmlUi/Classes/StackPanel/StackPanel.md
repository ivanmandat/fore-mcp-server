...
[Container](../Container/Container.htm)
...
Класс StackPanel реализует компонент
 [StackPanel](../../Components/StackPanel/StackPanel.htm), представляющий
 собой контейнер, предназначенный для размещения элементов один за другим
 в вертикальном столбце или горизонтальной строке.


## Синтаксис


PP.initClass(PP.Ui.StackPanel, [PP.Ui.Container](../Container/Container.htm),
 "StackPanel");
...
## Свойства, унаследованные от класса [Container](../Container/Container.htm)
...
## Методы, унаследованные от класса [Container](../Container/Container.htm)
