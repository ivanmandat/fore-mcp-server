...
Компонент Hyperlink представляет собой ссылку.


## Комментарии


Компонент реализован классом [Hyperlink](../../Classes/Hyperlink/Hyperlink.htm).
...
![](../../Classes/Hyperlink/Hyperlink1.gif)


[Пример создания компонента Hyperlink](../../Classes/Hyperlink/Constructor_Hyperlink.htm)
