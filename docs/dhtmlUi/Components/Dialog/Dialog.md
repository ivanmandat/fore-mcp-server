...
Компонент Dialog реализует окно.


## Комментарии


Компонент реализован классом [Dialog](../../Classes/Dialog/Dialog.htm).
...
![](../../Classes/Dialog/Dialog1.gif)


Пример создания компонента приведен в описании [конструктора Dialog](../../Classes/Dialog/Dialog_constructor.htm).
