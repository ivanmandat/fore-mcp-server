...
Компонент TextEditor представляет
 собой редактор текста.


## Комментарии


TextEditor включает в себя компонент
 для настройки параметров текста - [FontBox](../FontBox/FontBox.htm)
 и текстовую область, в которую вводится текст, предназначенный для редактирования.


С помощью элементов управления компонента [FontBox](../FontBox/FontBox.htm)
 настраиваются параметры выделенного фрагмента текста.
...
[Пример
 создания компонента TextEditor](../../Classes/TextEditor/Constructor_TextEditor.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [TextEditor](dhtmlUi.chm::/Classes/TextEditor/Constructor_TextEditor.htm)
		 Конструктор TextEditor
		 создает экземпляр компонента TextEditor.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](dhtmlUi.chm::/Classes/TextEditor/TextEditor.Alignment.htm)
		 Свойство Alignment
		 определяет горизонтальное выравнивание текста.


		 ![](../../Property_Image.gif)
		 [BackgroundColor](dhtmlUi.chm::/Classes/TextEditor/TextEditor.BackgroundColor.htm)
		 Свойство BackgroundColor
		 определяет цвет фона выделенного текста.


		 ![](../../Property_Image.gif)
		 [EnableResize](dhtmlUi.chm::/Classes/TextEditor/TextEditor.EnableResize.htm)
		 Свойство EnableResize
		 определяет возможность изменять размеры текстовой области.


		 ![](../../Property_Image.gif)
		 [FontColor](dhtmlUi.chm::/Classes/TextEditor/TextEditor.FontColor.htm)
		 Свойство FontColor
		 определяет цвет шрифта выделенного текста.


		 ![](../../Property_Image.gif)
		 [FontFamily](dhtmlUi.chm::/Classes/TextEditor/TextEditor.FontFamily.htm)
		 Свойство FontFamily
		 определяет семейство шрифта выделенного текста.


		 ![](../../Property_Image.gif)
		 [FontSize](dhtmlUi.chm::/Classes/TextEditor/TextEditor.FontSize.htm)
		 Свойство FontSize определяет
		 размер шрифта выделенного текста.


		 ![](../../Property_Image.gif)
		 [IsBold](dhtmlUi.chm::/Classes/TextEditor/TextEditor.IsBold.htm)
		 Свойство IsBold определяет,
		 используется ли полужирное начертание.


		 ![](../../Property_Image.gif)
		 [IsItalic](dhtmlUi.chm::/Classes/TextEditor/TextEditor.IsItalic.htm)
		 Свойство IsItalic определяет,
		 используется ли курсивное начертание.


		 ![](../../Property_Image.gif)
		 [IsUnderline](dhtmlUi.chm::/Classes/TextEditor/TextEditor.IsUnderline.htm)
		 Свойство IsUnderline
		 определяет, применяется ли подчеркивание к выделенному тексту.


		 ![](../../Property_Image.gif)
		 [ReadOnly](dhtmlUi.chm::/Classes/TextEditor/TextEditor.ReadOnly.htm)
		 Свойство ReadOnly определяет
		 признак доступности редактирования текста.


		 ![](../../Property_Image.gif)
		 [Text](dhtmlUi.chm::/Classes/TextEditor/TextEditor.Text.htm)
		 Свойство Text определяет
		 текст, который отображается в текстовой области редактора.


		 ![](../../Property_Image.gif)
		 [TextAreaHeight](dhtmlUi.chm::/Classes/TextEditor/TextEditor.TextAreaHeight.htm)
		 Свойство TextAreaHeight
		 определяет высоту текстовой области редактора.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [focus](dhtmlUi.chm::/Classes/TextEditor/TextEditor.focus.htm)
		 Метод focus устанавливает
		 курсор в текстовой области.


		 ![](../../Sub_Image.gif)
		 [getFontBox](dhtmlUi.chm::/Classes/TextEditor/TextEditor.getFontBox.htm)
		 Метод getFontBox возвращает
		 компонент [FontBox](dhtmlUi.chm::/Components/FontBox/FontBox.htm),
		 входящий в состав компонента [TextEditor](dhtmlUi.chm::/Components/TextEditor/TextEditor.htm).


		 ![](../../Sub_Image.gif)
		 [getFormattedText](dhtmlUi.chm::/Classes/TextEditor/TextEditor.getFormattedText.htm)
		 Метод getFormattedText
		 возвращает html-строку из текстовой области.


		 ![](../../Sub_Image.gif)
		 [getHyperlinkUrl](dhtmlUi.chm::/Classes/TextEditor/TextEditor.getHyperlinkUrl.htm)
		 Метод getHyperlinkUrl
		 возвращает адрес выделенной гиперссылки.


		 ![](../../Sub_Image.gif)
		 [getTextArea](dhtmlUi.chm::/Classes/TextEditor/TextEditor.getTextArea.htm)
		 Метод getTextArea возвращает
		 текстовую область редактора.


		 ![](../../Sub_Image.gif)
		 [insertHyperlink](dhtmlUi.chm::/Classes/TextEditor/TextEditor.insertHyperlink.htm)
		 Метод insertHyperlink
		 создает гиперссылку в выделенном тексте.


		 ![](../../Sub_Image.gif)
		 [insertNode](dhtmlUi.chm::/Classes/TextEditor/TextEditor.insertNode.htm)
		 Метод insertNode вставляет
		 DOM-вершину в текстовую область.


		 ![](../../Sub_Image.gif)
		 [removeHyperlink](dhtmlUi.chm::/Classes/TextEditor/TextEditor.removeHyperlink.htm)
		 Метод removeHyperlink
		 удаляет гиперссылку в выделенном тексте.


		 ![](../../Sub_Image.gif)
		 [selectAll](dhtmlUi.chm::/Classes/TextEditor/TextEditor.selectAll.htm)
		 Метод selectAll выделяет
		 все содержимое текстовой области компонента.


		 ![](../../Sub_Image.gif)
		 [updateControls](dhtmlUi.chm::/Classes/TextEditor/TextEditor.updateControls.htm)
		 Метод updateControls
		 обновляет компонент [FontBox](dhtmlUi.chm::/Components/FontBox/FontBox.htm)
		 в соответствии с текущими настройками текста.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Blur](dhtmlUi.chm::/Classes/TextEditor/TextEditor.Blur.htm)
		 Событие Blur наступает
		 при потере фокуса элемента, входящего в состав компонента [TextEditor](dhtmlUi.chm::/Components/TextEditor/TextEditor.htm).


		 ![](../../Event_Image.gif)
		 [PropertyChanged](dhtmlUi.chm::/Classes/TextEditor/TextEditor.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении настроек [текстового
		 редактора](dhtmlUi.chm::/Classes/TextEditor/TextEditor.htm).


		 ![](../../Event_Image.gif)
		 [SelectionChanged](dhtmlUi.chm::/Classes/TextEditor/TextEditor.SelectionChanged.htm)
		 Событие SelectionChanged
		 наступает при выделении содержимого текстовой области редактора.


		 ![](../../Event_Image.gif)
		 [TextChanged](dhtmlUi.chm::/Classes/TextEditor/TextEditor.TextChanged.htm)
		 Событие TextChanged
		 наступает при изменении текста в текстовой области редактора.
