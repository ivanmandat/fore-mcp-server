...
Компонент TextArea представляет
 собой текстовую область.


## Комментарии


Компонент TextArea реализован
 классом [TextArea](../../Classes/TextArea/TextArea.htm).


## Пример


Компонент TextArea может иметь
 следующий вид:
...
[Пример создания компонента TextArea](TextArea_Example.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [TextArea](dhtmlUi.chm::/Classes/TextArea/Constructor_TextArea.htm)
		 Конструктор TextArea
		 создает экземпляр компонента TextArea.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ReadOnly](dhtmlUi.chm::/Classes/TextArea/TextArea.ReadOnly.htm)
		 Свойство ReadOnly**
		 определяет, доступен ли компонент для редактирования.


		 ![](../../Property_Image.gif)
		 [TextSelectable](dhtmlUi.chm::/Classes/TextArea/TextArea.TextSelectable.htm)
		 Свойство TextSelectable
		 определяет возможность выделения текста [текстовой области](dhtmlUi.chm::/Classes/TextArea/TextArea.htm).
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getContentNode](dhtmlUi.chm::/Classes/TextArea/TextArea.getContentNode.htm)
		 Метод getContentNode
		 возвращает DOM-вершину содержимого [текстовой области](dhtmlUi.chm::/Classes/TextArea/TextArea.htm).


		 ![](../../Sub_Image.gif)
		 [getFormattedText](dhtmlUi.chm::/Classes/TextArea/TextArea.getFormattedText.htm)
		 Метод **getFormattedText**
		 возвращает форматированный текст компонента.


		 ![](../../Sub_Image.gif)
		 [scrollTo](dhtmlUi.chm::/Classes/TextArea/TextArea.scrollTo.htm)
		 Метод **scrollTo**
		 устанавливает позицию прокрутки.


		 ![](../../Sub_Image.gif)
		 [selectAll](dhtmlUi.chm::/Classes/TextArea/TextArea.selectAll.htm)
		 Метод selectAll выделяет
		 все содержимое [текстовой
		 области](dhtmlUi.chm::/Classes/TextArea/TextArea.htm).
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Blur](dhtmlUi.chm::/Classes/TextArea/TextArea.Blur.htm)
		 Событие **Blur**
		 наступает при потере фокуса компонентом.


		 ![](../../Event_Image.gif)
		 [Focus](dhtmlUi.chm::/Classes/TextArea/TextArea.Focus.htm)
		 Событие **Focus**
		 наступает при получении фокуса компонентом.


		 ![](../../Event_Image.gif)
		 [TextChanged](dhtmlUi.chm::/Classes/TextArea/TextArea.TextChanged.htm)
		 Событие **TextChanged**
		 наступает при потере фокуса компонентом при измененном текстовом
		 содержимом.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/TextArea/TextArea.ValueChanged.htm)
		 Событие ValueChanged
		 наступает после изменения значения [текстовой области](dhtmlUi.chm::/Classes/TextArea/TextArea.htm).
