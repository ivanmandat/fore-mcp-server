...
Компонент MonthCalendar представляет
 собой календарь для выбора даты и времени.


## Комментарии


Компонент реализован классом [MonthCalendar](../../Classes/MonthCalendar/MonthCalendar.htm).


Компонент работает с локальным временем, поправки на часовой пояс нужно
...
В компоненте есть возможность [выбора
 режима отображения календаря](../../Classes/MonthCalendar/MonthCalendar.Mode.htm) с помощью кнопок «Дни», «Недели», «Месяцы»,
 «Кварталы», «Полугодия», расположенных в верхней части календаря.


Под кнопками выбора режима отображения календаря расположены кнопки
 перехода к следующему/предыдущему периоду. Кнопки перехода к следующему/предыдущему
 году доступны во всех режимах, кроме режима месяцев. В режиме месяцев
 доступны кнопки перехода к следующему/предыдущему полугодию. Кнопки перехода
 к следующему/предыдущему месяцу доступны в режиме дней.


Дата выбирается из календаря в подходящем для пользователя режиме.


Время устанавливается в полях ввода с кнопками прокрутки «Часы» и «Минуты».
 Значение минут и часов может быть введено с клавиатуры или выбрано с помощью
 кнопок прокрутки или клавиш UP/DOWN (курсор должен быть установлен
 в поле ввода).


Текущие дату и время можно установить нажатием на кнопку «Сегодня».


[Пример создания компонента MonthCalendar](Example_MonthCalendar.htm).
...
## Конструкторы
			 ...
			 ![](../../Sub_Image.gif)
			 [MonthCalendar](dhtmlUi.chm::/Classes\MonthCalendar\Constructor_MonthCalendar.htm)

			 Конструктор MonthCalendar
			 создает экземпляр компонента [MonthCalendar](dhtmlUi.chm::/Components/MonthCalendar/MonthCalendar.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CurrentDate](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.currentdate.htm)
		 Свойство CurrentDate
		 устанавливает дату в календаре.


		 ![](../../Property_Image.gif)
		 [MaxDate](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.maxdate.htm)
		 Свойство MaxDate устанавливает
		 максимальное допустимое значение даты в календаре.


		 ![](../../Property_Image.gif)
		 [MinDate](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.mindate.htm)
		 Свойство MinDate устанавливает
		 минимальное допустимое значение даты для календаря.


		 ![](../../Property_Image.gif)
		 [Mode](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.mode.htm)
		 Свойство Mode устанавливает
		 режим отображения календаря.


		 ![](../../Property_Image.gif)
		 [ShowDaysButton](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.showdaysbutton.htm)
		 Свойство ShowDaysButton
		 устанавливает видимость кнопки «Дни».


		 ![](../../Property_Image.gif)
		 [ShowHalfYearsButton](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.showhalfyearsbutton.htm)
		 Свойство ShowHalfYearsButton
		 устанавливает видимость кнопки «Полугодия».


		 ![](../../Property_Image.gif)
		 [ShowNowButton](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.shownowbutton.htm)
		 Свойство ShowNowButton
		 устанавливает видимость кнопки «Сегодня».


		 ![](../../Property_Image.gif)
		 [ShowMonthsButton](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.showmonthsbutton.htm)
		 Свойство ShowMonthsButton
		 устанавливает видимость кнопки «Месяцы».


		 ![](../../Property_Image.gif)
		 [ShowQuartersButton](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.showquartersbutton.htm)
		 Свойство ShowQuartersButton
		 устанавливает видимость кнопки «Кварталы».


		 ![](../../Property_Image.gif)
		 [ShowTime](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.showtime.htm)
		 Свойство ShowTime устанавливает
		 видимость элементов для ввода времени.


		 ![](../../Property_Image.gif)
		 [ShowWeeksButton](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.showweeksbutton.htm)
		 Свойство ShowWeeksButton
		 устанавливает видимость кнопки «Недели».
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getCurrentDay](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrentday.htm)
		 Метод getCurrentDay
		 возвращает значение дня.


		 ![](../../Sub_Image.gif)
		 [getCurrentHalfYear](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrenthalfyear.htm)
		 Метод getCurrentHalfYear
		 возвращает значение полугодия.


		 ![](../../Sub_Image.gif)
		 [getCurrentHour](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrenthour.htm)
		 Метод getCurrentHour
		 возвращает значение часа.


		 ![](../../Sub_Image.gif)
		 [getCurrentMinute](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrentminute.htm)
		 Метод getCurrentMinute возвращает
		 значение минуты.


		 ![](../../Sub_Image.gif)
		 [getCurrentMonth](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrentmonth.htm)
		 Метод getCurrentMonth
		 возвращает значение месяца.


		 ![](../../Sub_Image.gif)
		 [getCurrentQuarter](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrentquarter.htm)
		 Метод getCurrentQuarter
		 возвращает значение квартала.


		 ![](../../Sub_Image.gif)
		 [getCurrentWeek](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrentweek.htm)
		 Метод getCurrentWeek
		 возвращает значение недели.


		 ![](../../Sub_Image.gif)
		 [getCurrentYear](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.getcurrentyear.htm)
		 Метод getCurrentYear
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [CurrentDateChanged](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.currentdatechanged.htm)
		 Событие CurrentDateChanged
		 наступает при смене текущей даты с помощью свойства [CurrentDate](dhtmlUi.chm::/Classes/MonthCalendar/MonthCalendar.CurrentDate.htm).


		 ![](../../Event_Image.gif)
		 [ModeChanged](dhtmlUi.chm::/classes\monthcalendar\monthcalendar.modechanged.htm)
		 Событие ModeChanged
		 наступает при смене режима отображения календаря.


## Методы, унаследованные от класса [DateTimeEdit](../../Classes/DateTimeEdit/DateTimeEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [getCurrentDay](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrentday.htm)
		 Метод getCurrentDay
		 возвращает значение дня.


		 ![](../../Sub_Image.gif)
		 [getCurrentHalfYear](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrenthalfyear.htm)
		 Метод getCurrentHalfYear
		 возвращает значение полугодия.


		 ![](../../Sub_Image.gif)
		 [getCurrentHour](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrenthour.htm)
		 Метод getCurrentHour
		 возвращает значение часа.


		 ![](../../Sub_Image.gif)
		 [getCurrentMinute](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrentminute.htm)
		 Метод getCurrentMinute возвращает
		 значение минуты.


		 ![](../../Sub_Image.gif)
		 [getCurrentMonth](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrentmonth.htm)
		 Метод getCurrentMonth
		 возвращает значение месяца.


		 ![](../../Sub_Image.gif)
		 [getCurrentQuarter](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrentquarter.htm)
		 Метод getCurrentQuarter
		 возвращает значение квартала.


		 ![](../../Sub_Image.gif)
		 [getCurrentWeek](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrentweek.htm)
		 Метод getCurrentWeek
		 возвращает значение недели.


		 ![](../../Sub_Image.gif)
		 [getCurrentYear](dhtmlUi.chm::/classes\datetimeedit\datetimeedit.getcurrentyear.htm)
		 Метод getCurrentYear
		 возвращает значение года.
