...
Компонент BorderLayout представляет
 собой макет для размещения компонентов внутри контейнера относительно
 его границ.
...
Компонент реализован классом [BorderLayout](../../Classes/BorderLayout/BorderLayout.htm).
...
[Пример создания компонента BorderLayout](Example_BorderLayout.htm)
