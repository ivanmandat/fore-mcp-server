...
Компонент реализован классом [BorderCombo](../../Classes/BorderCombo/BorderCombo.htm).
...
![](BorderCombo_default.gif)


По умолчанию доступны режимы для выбора цвета (на рисунке выше) и для выбора типа линии (ниже):


![](BorderCombo_LineType.gif)


На кнопке, при нажатии на которую раскрывается панель, отображается установленный тип размещения линий границы ([BorderCombo.BorderType](../../Classes/BorderCombo/BorderCombo.BorderType.htm)). Панель для выбора типа размещения линий границ отображается, если для свойства [BorderCombo.BorderTypeOnlt](../../Classes/BorderCombo/BorderCombo.BorderTypeOnlt.htm) установлено значение true, по умолчанию она скрыта:


![](BorderCombo_BorderTypeOnIt.gif)


Также может отображаться вкладка для настройки толщины линии, если для свойства [BorderCombo.BorderWidthVisible](../../Classes/BorderCombo/BorderCombo.BorderWidthVisible.htm) установлено значение true:


![](BorderCombo_Width.gif)


[Пример создания компонента BorderCombo](BorderCombo_example.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [BorderCombo](dhtmlUi.chm::/classes/bordercombo/bordercombo_constructor.htm)
		 Конструктор BorderCombo
		 создает экземпляр компонента BorderCombo.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderType](dhtmlUi.chm::/classes/bordercombo/bordercombo.bordertype.htm)
		 Свойство BorderType
		 определяет вариант расположения линий границы.


		 ![](../../Property_Image.gif)
		 [BorderTypeOnlt](dhtmlUi.chm::/classes/bordercombo/bordercombo.bordertypeonlt.htm)
		 Свойство BorderTypeOnlt
		 определяет, отображается ли в раскрывающейся части компонента
		 панель для выбора варианта расположения границ.


		 ![](../../Property_Image.gif)
		 [BorderWidthVisible](dhtmlUi.chm::/classes/bordercombo/bordercombo.borderwidthvisible.htm)
		 Свойство BorderWidthVisible
		 определяет, отображается ли вкладка для настройки толщины линии.


		 ![](../../Property_Image.gif)
		 [Color](dhtmlUi.chm::/classes/bordercombo/bordercombo.color.htm)
		 Свойство Color определяет
		 цвет линии границы.


		 ![](../../Property_Image.gif)
		 [LineColorVisible](dhtmlUi.chm::/classes/bordercombo/bordercombo.linecolorvisible.htm)
		 Свойство LineColorVisible
		 определяет, отображается ли вкладка для выбора цвета линии.


		 ![](../../Property_Image.gif)
		 [LineType](dhtmlUi.chm::/classes/bordercombo/bordercombo.linetype.htm)
		 Свойство LineType определяет
		 тип линии границы.


		 ![](../../Property_Image.gif)
		 [LineWidth](dhtmlUi.chm::/classes/bordercombo/bordercombo.linewidth.htm)
		 Свойство LineWidth
		 определяет значение в числовом редакторе на вкладке «Толщина».


		 ![](../../Property_Image.gif)
		 [Mode](dhtmlUi.chm::/classes/bordercombo/bordercombo.mode.htm)
		 Свойство Mode определяет
		 активный режим для выбора типа границ.


		 ![](../../Property_Image.gif)
		 [TypesMode](dhtmlUi.chm::/classes/bordercombo/bordercombo.typesmode.htm)
		 Свойство TypesMode
		 определяет технологию, в которой будут отображаться типы границ.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getDropPanel](dhtmlUi.chm::/Classes/BorderCombo/BorderCombo.getDropPanel.htm)
		 Метод getDropPanel
		 возвращает раскрывающуюся панель.


		 ![](../../Sub_Image.gif)
		 [showDropPanel](dhtmlUi.chm::/classes/bordercombo/bordercombo.showdroppanel.htm)
		 Метод showDropPanel
		 раскрывает панель для выбора типа границы.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [BorderTypeChanged](dhtmlUi.chm::/classes/bordercombo/bordercombo.bordertypechanged.htm)
		 Событие BorderTypeChanged
		 наступает при выборе типа размещения границы.


		 ![](../../Event_Image.gif)
		 [ColorChanged](dhtmlUi.chm::/classes/bordercombo/bordercombo.colorchanged.htm)
		 Событие ColorChanged
		 наступает при выборе цвета линии.


		 ![](../../Event_Image.gif)
		 [LineTypeChanged](dhtmlUi.chm::/classes/bordercombo/bordercombo.linetypechanged.htm)
		 Событие LineTypeChanged
		 наступает при выборе типа линии.


		 ![](../../Event_Image.gif)
		 [LineWidthChanged](dhtmlUi.chm::/classes/bordercombo/bordercombo.linewidthchanged.htm)
		 Событие LineWidthChanged
		 наступает при изменении толщины линии.


		 ![](../../Event_Image.gif)
		 [ModeChanged](dhtmlUi.chm::/classes/bordercombo/bordercombo.modechanged.htm)
		 Событие ModeChanged
		 наступает при смене режима отображения раскрывающаяся панели для
		 выбора типа границы.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/BorderCombo/BorderCombo.ValueChanged.htm)
		 Событие ValueChanged
		 наступает после изменения свойства границы.
