...
Компонент MainPanel представляет
 собой раскрывающуюся панель с меню.


## Комментарии


Компонент реализован классом [MainPanel](../../Classes/MainPanel/MainPanel.htm).
...
Пример создания раскрывающейся панели с меню описан на странице «[Пример создания компонента MainPanel](Example_MainPanel.htm)».
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [MainPanel](dhtmlUi.chm::/Classes/MainPanel/Constructor_MainPanel.htm)
		 Конструктор MainPanel
		 создает экземпляр компонента [MainPanel](dhtmlUi.chm::/Components/MainPanel/MainPanel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [SearchVisible](dhtmlUi.chm::/Classes/MainPanel/MainPanel.SearchVisible.htm)
		 Свойство SearchVisible
		 определяет видимость строки поиска элементов.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [addItem](dhtmlUi.chm::/Classes/MainPanel/MainPanel.addItem.htm)
		 Метод addItem добавляет
		 элемент в конец меню.


		 ![](../../Sub_Image.gif)
		 [getItem](dhtmlUi.chm::/Classes/MainPanel/MainPanel.getItem.htm)
		 Метод getItem возвращает
		 элемент меню по индексу.


		 ![](../../Sub_Image.gif)
		 [getItems](dhtmlUi.chm::/Classes/MainPanel/MainPanel.getItems.htm)
		 Метод getItems возвращает
		 массив элементов меню.


		 ![](../../Sub_Image.gif)
		 [insertItem](dhtmlUi.chm::/Classes/MainPanel/MainPanel.insertItem.htm)
		 Метод insertItem добавляет
		 элемент в указанную позицию.


		 ![](../../Sub_Image.gif)
		 [removeItem](dhtmlUi.chm::/Classes/MainPanel/MainPanel.removeItem.htm)
		 Метод removeItem удаляет
		 элемент из меню панели по индексу.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ItemClick](dhtmlUi.chm::/Classes/MainPanel/MainPanel.ItemClick.htm)
		 Событие ItemClick наступает
		 после нажатия кнопки мыши по элементу меню.


		 ![](../../Event_Image.gif)
		 [Search](dhtmlUi.chm::/Classes/MainPanel/MainPanel.Search.htm)
		 Событие Search наступает
		 после нажатия клавиши ENTER в строке поиска.
