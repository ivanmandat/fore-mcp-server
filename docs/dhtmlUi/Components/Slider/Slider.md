...
Компонент Slider представляет собой элемент управления, позволяющий пользователю сделать выбор из диапазона значений, передвигая бегунок вдоль его контейнера.


## Комментарии


Компонент Slider реализован классом [Slider](../../Classes/Slider/slider.htm).
...
[Пример создания компонента Slider](Example_Slider.htm)
