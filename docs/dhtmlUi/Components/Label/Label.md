...
Компонент реализован классом [Label](../../Classes/Label/Label.htm).


Текст подписи задается в свойстве [Control.Content](../../Classes/Control/Control.Content.htm).
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Label](dhtmlUi.chm::/Classes/Label/Constructor_Label.htm)
		 Конструктор Label создает
		 экземпляр компонента Label.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Edit](dhtmlUi.chm::/classes/label/label.edit.htm)
		 Свойство Edit определяет,
		 находится ли подпись в режиме редактирования.


		 ![](../../Property_Image.gif)
		 [ReadOnly](dhtmlUi.chm::/classes/label/label.readonly.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Edited](dhtmlUi.chm::/classes/label/label.edited.htm)
		 Событие Edited наступает
		 после завершения редактирования подписи.


		 ![](../../Event_Image.gif)
		 [Editing](dhtmlUi.chm::/classes/label/label.editing.htm)
		 Событие Editing наступает
		 во время изменения подписи.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/classes/label/label.valuechanged.htm)
		 Событие ValueChanged наступает
		 после изменения значения подписи.
