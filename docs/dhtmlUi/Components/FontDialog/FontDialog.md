...
Компонент FontDialog представляет
 собой стандартный диалог для выбора шрифта.


Текущие настройки шрифта задаются свойством [Font](../../Classes/FontDialog/FontDialog.Font.htm).


Текст примера для проверки настроек задается свойством [SampleTextString](../../Classes/FontDialog/FontDialog.SampleTextString.htm).


## Комментарии


Компонент реализован классом [FontDialog](../../Classes/FontDialog/FontDialog.htm)


## Пример


Компонент FontDialog имеет следующий
 вид:
...
[Пример создания компонента FontDialog](FontDialog_example.htm)
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [FontDialog](dhtmlUi.chm::/classes/fontdialog/fontdialog_constructor.htm)
			 Конструктор FontDialog
			 создает экземпляр компонента [FontDialog](dhtmlUi.chm::/components/fontdialog/fontdialog.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Font](dhtmlUi.chm::/classes/fontdialog/fontdialog.font.htm)
		 Свойство Font устанавливает
		 текущие настройки шрифта.


		 ![](../../Property_Image.gif)
		 [SampleTextString](dhtmlUi.chm::/classes/fontdialog/fontdialog.sampletextstring.htm)
		 Свойство SampleTextString
		 устанавливает текст строки, используемой для примера настройки
		 шрифта.


## Методы, унаследованные от класса [Dialog](../../Classes/Dialog/Dialog.htm)
...
## События, унаследованные от класса [Dialog](../../Classes/Dialog/Dialog.htm)
...
## Свойства, унаследованные от класса [Window](../../Classes/Window/Window.htm)
...
## Методы, унаследованные от класса [Window](../../Classes/Window/Window.htm)
...
## События, унаследованные от класса [Window](../../Classes/Window/Window.htm)
