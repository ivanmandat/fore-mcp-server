...
Компонент TabItem представляет
 собой вкладку, которая является дочерним элементом компонента [TabControl](../TabControl/TabControl.htm).


## Комментарии


Компонент реализован классом [TabItem](../../Classes/TabItem/TabItem.htm).


## Пример


В данном примере представлен компонент [TabControl](../TabControl/TabControl.htm),
 состоящий из четырех вкладок. Расположение вкладок определяется значением
 свойства [Position](../../Classes/TabItem/TabItem.Position.htm).
 С помощью свойства [Caption](../../Classes/TabItem/TabItem.Caption.htm)
 задается заголовок вкладки, а с помощью свойства [Content](../../Classes/Control/Control.Content.htm)
 - ее содержимое. Содержимое вкладки может быть произвольным. Для вкладки
 можно установить изображение, задав в значении свойства [ImageUrl](../../Classes/TabItem/TabItem.ImageUrl.htm)
 путь к файлу с картинкой.


![](../TabControl/TabControl1.gif)


Вкладка создается при [создании
 компонента TabControl](../TabControl/Example_TabControl.htm).
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [TabItem](dhtmlUi.chm::/classes/tabitem/constructor_tabitem.htm)
			 Конструктор TabItemсоздает
			 экземпляр компонента TabItem.
