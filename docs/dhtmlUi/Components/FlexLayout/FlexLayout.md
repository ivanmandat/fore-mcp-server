...
Компонент FlexLayout представляет
 собой макет для гибкого размещения компонентов внутри контейнера.


## Комментарии


Компонент реализован классом [FlexLayout](../../Classes/FlexLayout/FlexLayout.htm).


Гибкое размещение - это возможность ориентировать элементы контейнера
...
Пример создания компонента описан на странице «[Пример
 создания компонента FlexLayout](Example_FlexLayout.htm)».
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [FlexLayout](dhtmlUi.chm::/Classes/FlexLayout/Constructor_FlexLayout.htm)
		 Конструктор FlexLayout
		 создает экземпляр компонента [FlexLayout](dhtmlUi.chm::/Components/FlexLayout/FlexLayout.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Position](dhtmlUi.chm::/Classes/FlexLayout/FlexLayout.Position.htm)
...
## Методы
		 ...
		 ![](../../Property_Image.gif)
		 [updateLayout](dhtmlUi.chm::/Classes/FlexLayout/FlexLayout.updateLayout.htm)
		 Метод updateLayout
