...
Компонент ScrollBox представляет собой горизонтальную и вертикальную полосы прокрутки, предназначенные для просмотра содержимого, размеры которого превышают размеры контейнера.


## Комментарии


Компонент реализован классом [ScrollBox](../../Classes/ScrollBox/ScrollBox.htm).


## Пример


Компонент ScrollBox может быть добавлен к произвольному содержимому тега div:


![](ScrollBox1.gif)


[Добавление полос прокрутки к содержимому тега div](Example_div_ScrollBox.htm)


Полосы прокрутки автоматически появляются при создании раскрывающейся панели, размеры которой меньше размеров содержимого:


![](ScrollBox2.gif)


[Созданиe раскрывающейся панели с полосами прокрутки](DropPanel_and_ScrollBox.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ScrollBox](dhtmlUi.chm::/classes/scrollbox/constructor_scrollbox.htm)
		 Конструктор ScrollBox
		 создает экземпляр компонента ScrollBox.
...
## Свойства
		 ...
		 ![](../../Sub_Image.gif)
		 [getHorisontalScrollPosition](dhtmlUi.chm::/Classes/ScrollBox/ScrollBox.getHorisontalScrollPosition.htm)
		 Метод getHorisontalScrollPosition
		 возвращает позицию бегунка горизонтальной полосы прокрутки.


		 ![](../../Sub_Image.gif)
		 [getHorizontalScroll](dhtmlUi.chm::/classes/scrollbox/scrollbox.gethorizontalscroll.htm)
		 Метод getHorizontalScroll
		 возвращает горизонтальную полосу прокрутки компонента ScrollBox.


		 ![](../../Sub_Image.gif)
		 [getScrollHeight](dhtmlUi.chm::/Classes/ScrollBox/ScrollBox.getScrollHeight.htm)
		 Метод getScrollHeight
		 возвращает высоту вертикальной полосы прокрутки.


		 ![](../../Sub_Image.gif)
		 [getScrollWidth](dhtmlUi.chm::/Classes/ScrollBox/ScrollBox.getScrollWidth.htm)
		 Метод getScrollWidth
		 возвращает ширину горизонтальной полосы прокрутки.


		 ![](../../Sub_Image.gif)
		 [getVerticalScroll](dhtmlUi.chm::/classes/scrollbox/scrollbox.getverticalscroll.htm)
		 Метод getVerticalScroll
		 возвращает вертикальную полосу прокрутки.


		 ![](../../Sub_Image.gif)
		 [getVerticalScrollPosition](dhtmlUi.chm::/Classes/ScrollBox/ScrollBox.getVerticalScrollPosition.htm)
		 Метод getVerticalScrollPosition
		 возвращает позицию бегунка вертикальной полосы прокрутки.


		 ![](../../Sub_Image.gif)
		 [scrollTo](dhtmlUi.chm::/classes/scrollbox/scrollbox.scrollto.htm)
		 Метод scrollTo устанавливает
		 позиции бегунков горизонтальной и вертикальной полос прокрутки.
