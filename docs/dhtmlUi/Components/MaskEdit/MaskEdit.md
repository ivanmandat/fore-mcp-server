...
Компонент MaskEdit представляет собой редактор для ввода данных, соответствующих заданному шаблону.


## Комментарии


Компонент реализован классом [MaskEdit](../../Classes/MaskEdit/MaskEdit.htm).


## Пример


Редакторы для ввода различных данных:


![](MaskEdit2.gif)


[Пример создания компонента MaskEdit](Example_MaskEdit.htm)
