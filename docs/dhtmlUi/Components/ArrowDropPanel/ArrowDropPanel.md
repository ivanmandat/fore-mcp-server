...
Компонент ArrowDropPanel представляет
 собой раскрывающуюся, относительно другого компонента, панель со стрелкой
 и произвольным содержимым.


## Комментарии


Компонент реализован классом [ArrowDropPanel](../../Classes/ArrowDropPanel/ArrowDropPanel.htm).
...
Пример создания раскрывающейся панели со стрелкой и произвольным содержимым
 приведен на странице «[Пример создания
 компонента ArrowDropPanel](Example_ArrowDropPanel.htm)».
...
## Конструкторы
			 ...
			 ![](../../Sub_Image.gif)
			 [ArrowDropPanel](dhtmlUi.chm::/Classes/ArrowDropPanel/Constructor_ArrowDropPanel.htm)
			 Конструктор ArrowDropPanel
			 создает экземпляр компонента [ArrowDropPanel](dhtmlUi.chm::/Components/ArrowDropPanel/ArrowDropPanel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ArrowPosition](dhtmlUi.chm::/Classes/ArrowDropPanel/ArrowDropPanel.ArrowPosition.htm)
		 Свойство ArrowPosition
		 определяет позицию стрелки относительно панели.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [correctPosition](dhtmlUi.chm::/Classes/ArrowDropPanel/ArrowDropPanel.correctPosition.htm)
		 Метод correctPosition
		 удаляет информацию о положении стрелки на панели.


		 ![](../../Sub_Image.gif)
		 [showNextControl](dhtmlUi.chm::/Classes/ArrowDropPanel/ArrowDropPanel.showNextControl.htm)
		 Метод showNextControl
		 отображает панель рядом с указанными элементом управления, DOM-вершиной
		 или точкой.
