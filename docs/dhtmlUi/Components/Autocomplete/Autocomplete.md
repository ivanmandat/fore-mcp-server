...
Компонент Autocomplete представляет
 собой невизуальный компонент, предназначенный для подсказки пользователю
 возможных значений при вводе текста.


## Комментарии


Компонент реализован классом PP.Ui.[Autocomplete](../../Classes/Autocomplete/Autocomplete.htm).


Основные возможности:


1. Позволяет настраивать подсказки на произвольные редакторы текста
 ([Autocomplete.addTarget](../../Classes/Autocomplete/Autocomplete.addTarget.htm));


2. Возможность изменения размеров всплывающей подсказки ([Autocomplete.MaxHeight](../../Classes/Autocomplete/Autocomplete.MaxHeight.htm)
 и [Autocomplete.MaxWidth](../../Classes/Autocomplete/Autocomplete.MaxWidth.htm));


3. При выборе элемента из списка в редакторе текста этот элемент добавляется
 в текущую позицию курсора;


4. Возможность использования подсветки совпадающих символов в всплывающей
 подсказке ([Autocomplete.EnableHighlight](../../Classes/Autocomplete/Autocomplete.EnableHighlight.htm));


5. Возможность измерения цвета подсказки с помощью переопределения на
 странице CSS-стиля background-color
 для класса .PPMenuItem .PPHighlightAutocomplete.


## Пример


Пример компонента [TextBox](../TextBox/TextBox.htm), для
 которого настроена всплывающая подсказка:


![](../../Classes/Autocomplete/autocomplete1.gif)


[Пример
 использования компонента Autocomplete](../../Classes/Autocomplete/Constructor_Autocomplete.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Autocomplete](dhtmlUi.chm::/Classes/Autocomplete/Constructor_Autocomplete.htm)
		 Конструктор Autocomplete
		 создает экземпляр компонента Autocomplete.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Active](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.Active.htm)
		 Свойство Active определяет,
		 является ли автозавершение активным для указанного элемента управления.


		 ![](../../Property_Image.gif)
		 [EnableHighlight](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.EnableHighlight.htm)
		 Свойство EnableHighlight
		 управляет возможностью подсветки совпадающих символов в подсказке
		 для автозавершения ввода текста.


		 ![](../../Property_Image.gif)
		 [MatchCase](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.MatchCase.htm)
		 Свойство MatchCase
		 определяет, нужно ли при поиске вариантов автозавершения учитывать
		 регистр.


		 ![](../../Property_Image.gif)
		 [MaxHeight](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.MaxHeight.htm)
		 Свойство MaxHeight
		 устанавливает и возвращает максимальную высоту меню с вариантами
		 автозавершения для указанного элемента управления.


		 ![](../../Property_Image.gif)
		 [MaxWidth](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.MaxWidth.htm)
		 Метод MaxWidth устанавливает
		 и возвращает максимальную ширину меню с вариантами автозавершения
		 для указанного элемента управления.


		 ![](../../Property_Image.gif)
		 [MinAutoFindSymbolsCount](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.minautofindsymbolscount.htm)
		 Свойство MinAutoFindSymbolsCount
		 устанавливает минимальную длину строки, для которой будет показана
		 подсказка.


		 ![](../../Property_Image.gif)
		 [Suggestions](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.Suggestions.htm)
		 Свойство Suggestions
		 устанавливает список вариантов автозавершения для указанного элемента
		 управления.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [addTarget](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.addTarget.htm)
		 Метод addTarget добавляет
		 элемент управления в систему автозавершения.


		 ![](../../Sub_Image.gif)
		 [getTargets](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.getTargets.htm)
		 Метод getTargets возвращает
		 объект типа Targets - набор структур [Target](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.addTarget.htm).


		 ![](../../Sub_Image.gif)
		 [hideSuggestion](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.hideSuggestion.htm)
		 Метод hideSuggestion
		 скрывает меню, в котором отображаются подсказки.


		 ![](../../Sub_Image.gif)
		 [removeTarget](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.removeTarget.htm)
		 Метод removeTarget
		 удаляет указанный элемент управления из системы автозавершения.


		 ![](../../Sub_Image.gif)
		 [showSuggestion](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.showSuggestion.htm)
		 Метод showSuggestion
		 отображает меню с подсказками, настроенными для указанного элемента
		 управления.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [Opened](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.Opened.htm)
		 Событие Opened наступает
		 при открытии меню для выбора подсказки.


		 ![](../../Event_Image.gif)
		 [Selected](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.Selected.htm)
		 Событие Selected наступает
		 после выбора подсказки из меню.


		 ![](../../Event_Image.gif)
		 [SelectionChanged](dhtmlUi.chm::/Classes/Autocomplete/Autocomplete.SelectionChanged.htm)
		 Событие SelectionChanged
		 наступает при выборе варианта автозаполнения из раскрывающегося
		 меню при помощи клавиш UP, DOWN.
