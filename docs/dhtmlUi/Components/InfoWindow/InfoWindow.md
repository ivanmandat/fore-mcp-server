...
Компонент InfoWindow представляет собой информационное окно.


## Комментарии


Компонент реализован классом [InfoWindow](../../Classes/InfoWindow/InfoWindow.htm).


В информационное окно можно добавлять панели (экземпляры класса PP.Ui.InfoWindowPanel) и элементы управления (наследники PP.Ui.[Control](../../Classes/Control/Control.htm)).
...
[Пример создания компонента InfoWindow](../../Classes/InfoWindow/Constructor_InfoWindow.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [InfoWindow](dhtmlUi.chm::/Classes/InfoWindow/Constructor_InfoWindow.htm)
		 Конструктор InfoWindow
		 создает экземпляр компонента [InfoWindow](dhtmlUi.chm::/Components/InfoWindow/InfoWindow.htm).
