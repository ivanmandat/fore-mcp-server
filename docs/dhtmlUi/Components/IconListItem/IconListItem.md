...
Компонент IconListItem представляет
 собой элемент списка, состоящий из пиктораммы.


## Комментарии


Компонент реализован классом [IconListItem](../../Classes/IconListItem/IconListItem.htm),
 наследником класса [ListItem](dhtmlList.chm::/Classes/ListItem/ListItem.htm).


Данный компонент может использоваться при создании компонента [ListBox](dhtmlList.chm::/Classes/ListBox/ListBox.htm).
 Для создания элементов списка, состоящего из пиктограмм, необходимо наличие
 невизуального компонента [ImageList](../ImageList/ImageList.htm),
 содержащего ссылку на файл с набором пиктограмм.


## Пример


Список, состоящий из компонентов IconListItem
 может выглядеть следующим образом:


![](../../Classes/IconListItem/IconListItem2.gif)


[Пример
 создания элементов списка.](../../Classes/IconListItem/Constructor_IconListItem.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [IconListItem](dhtmlUi.chm::/classes/iconlistitem/constructor_iconlistitem.htm)
		 Конструктор IconListItem
		 создает экземпляр компонента IconListItem.


## Свойства, унаследованные от класса [ListItem](dhtmlList.chm::/Classes/ListItem/ListItem.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ColumnIndex](dhtmlList.chm::/classes/listitem/listitem.columnindex.htm)
		 Свойство ColumnIndex
		 определяет индекс столбца с пиктограммой.


		 ![](../../Property_Image.gif)
		 [ImageURL](dhtmlList.chm::/Classes/ListItem/ListItem.ImageURL.htm)
		 Свойство ImageURL определяет
		 путь к изображению предварительного просмотра.


		 ![](../../Property_Image.gif)
		 [RowIndex](dhtmlList.chm::/classes/listitem/listitem.rowindex.htm)
		 Свойство RowIndex устанавливает
		 индекс строки с пиктограммой.


		 ![](../../Property_Image.gif)
		 [Selected](dhtmlList.chm::/classes/listitem/listitem.selected.htm)
		 Свойство Selected устанавливает
		 признак того, является ли элемент выделенным.


## Методы, унаследованные от класса [ListItem](dhtmlList.chm::/Classes/ListItem/ListItem.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [getParent](dhtmlList.chm::/classes/listitem/listitem.getparent.htm)
		 Метод getParent возвращает
		 родительский компонент строки списка.


		 ![](../../Sub_Image.gif)
		 [setIsHovered](dhtmlList.chm::/classes/listitem/listitem.setishovered.htm)
		 Метод IsHovered устанавливает
		 признак того, что мышь наведена на указанную строку списка.


		 ![](../../Sub_Image.gif)
		 [toString](dhtmlList.chm::/classes/listitem/listitem.tostring.htm)
		 Метод toString возвращает
		 содержимое компонента [ListItem](dhtmlList.chm::/components/listitem/listitem.htm)
		 в виде строки.
