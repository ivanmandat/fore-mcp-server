...
Компонент LineLabel представляет
...
Компонент реализован классом [LineLabel](../../Classes/LineLabel/LineLabel.htm).
...
Пример создания подписи с линией описан на странице «[Пример
 создания компонента LineLabel](Example_LineLabel.htm)».
