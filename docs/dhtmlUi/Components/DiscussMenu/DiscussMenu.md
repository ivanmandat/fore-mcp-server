...
Компонент DiscussMenu представляет
 собой меню «Поделиться», предназначенное для публикации ссылки на страницу
 в социальных сетях.
...
Компонент реализован классом [DiscussMenu](../../Classes/DiscussMenu/DiscussMenu.htm).
...
[Пример создания компонента DiscussMenu](Example_DiscussMenu.htm)
 (Компания Meta Platforms Inc., владеющая
 социальной сетью Facebook, признана экстремистской организацией, её деятельность
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [DiscussMenu](dhtmlUi.chm::/Classes/DiscussMenu/Constructor_DiscussMenu.htm)
			 Конструктор DiscussMenu
			 создает экземпляр компонента [DiscussMenu](dhtmlUi.chm::/Components/DiscussMenu/DiscussMenu.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AutoShare](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.AutoShare.htm)
		 Свойство AutoShare
		 определяет, будет ли при выборе пункта меню осуществляться переход
		 на соответствующий веб-сайт.


		 ![](../../Property_Image.gif)
		 [Title](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.Title.htm)
		 Свойство Title определяет
		 заголовок сообщения, которое будет размещено в социальной сети.


		 ![](../../Property_Image.gif)
		 [Url](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.Url.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [appendGPlusLink](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.appendGPlusLink.htm)
		 Метод appendGPlusLink
		 размещает ссылку на plusone.js на странице.


		 ![](../../Sub_Image.gif)
		 [appendPluseoneContent](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.appendPluseoneContent.htm)
		 Метод appendPluseoneContent
		 вставляет кнопку Google+1 в указанную DOM-вершину.


		 ![](../../Sub_Image.gif)
		 [getFacebookItem](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.getFacebookItem.htm)
		 Метод getFacebookItem
		 возвращает пункт меню «Facebook» (Компания
		 Meta Platforms Inc., владеющая социальной сетью Facebook, признана
		 экстремистской организацией, её деятельность на территории России
		 запрещена).


		 ![](../../Sub_Image.gif)
		 [getGooglePlusItem](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.getGooglePlusItem.htm)
		 Метод getGooglePlusItem
		 возвращает пункт меню «Google+».


		 ![](../../Sub_Image.gif)
		 [getLinkedInItem](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.getLinkedInItem.htm)
		 Метод getLinkedInItem
		 возвращает пункт меню «LinkedIn».


		 ![](../../Sub_Image.gif)
		 [getLiveJournalItem](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.getLiveJournalItem.htm)
		 Метод getLiveJournalItem
		 возвращает пункт меню «LiveJournal».


		 ![](../../Sub_Image.gif)
		 [getTwitterItem](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.getTwitterItem.htm)
		 Метод getTwitterItem
		 возвращает пункт меню «Twitter».


		 ![](../../Sub_Image.gif)
		 [goPlusone](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.goPlusone.htm)
		 Метод goPlusone выполняет
		 отрисовку кнопки Google+1.


		 ![](../../Sub_Image.gif)
		 [share](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.share.htm)
		 Метод share публикует
		 ссылку на указанную страницу в выбранной социальной сети.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [BeforeDiscuss](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.BeforeDiscuss.htm)
		 Событие BeforeDiscuss
		 наступает перед публикацией, то есть при выборе пункта меню.


		 ![](../../Event_Image.gif)
		 [Discuss](dhtmlUi.chm::/Classes/DiscussMenu/DiscussMenu.Discuss.htm)
		 Событие Discuss наступает
		 при переходе на страницу выбранной социальной сети.


## Свойства, унаследованные от класса [Menu](../../Classes/Menu/Menu.htm)
...
## Методы, унаследованные от класса [Menu](../../Classes/Menu/Menu.htm)
...
## Событие, унаследованные от класса [Menu](../../Classes/Menu/Menu.htm)
...
## Свойства, унаследованные от класса [DropPanel](../../Classes/DropPanel/DropPanel.htm)
...
## Методы, унаследованные от класса [DropPanel](../../Classes/DropPanel/DropPanel.htm)
...
## События, унаследованные от класса [DropPanel](../../Classes/DropPanel/DropPanel.htm)
