...
Компонент ColorPanel представляет
 собой панель для выбора цвета.


## Комментарии


Компонент реализован классом [ColorPanel](../../Classes/ColorPanel/ColorPanel.htm).
...
![](../../Classes/ColorPanel/colorPanel.gif)


[Пример
 создания компонента ColorPanel](../../Classes/ColorPanel/Constructor_ColorPanel.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ColorPanel](dhtmlUi.chm::/Classes/ColorPanel/Constructor_ColorPanel.htm)
		 Конструктор ColorCombo
		 создает экземпляр компонента ColorCombo.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Color](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.Color.htm)
		 Свойство **Color
		 устанавливает выбранный цвет.


		 ![](../../Property_Image.gif)
		 [Mode](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.Mode.htm)
		 Свойство Mode устанавливает
		 режим отображения компонента [ColorCombo](dhtmlUi.chm::/components/colorcombo/colorcombo.htm).


		 ![](../../Property_Image.gif)
		 [PresentedColors](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.PresentedColors.htm)
		 Свойство PresentedColors
		 устанавливает набор стандартных цветов в палитре.


		 ![](../../Property_Image.gif)
		 [SpectrumMode](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.SpectrumMode.htm)
		 Свойство SpectrumMode
		 определяет режим отображения спектра компонента ColorPanel.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [updateUsedColors](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.updateUsedColors.htm)


		 **Метод **updateUsedColors обновляет
		 список недавно использованных цветов.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ColorChange](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.ColorChange.htm)
		 Событие **ColorChange**
		 наступает при смене цвета в панели.


		 ![](../../Event_Image.gif)
		 [PaletteSelected](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.PaletteSelected.htm)
		 Событие **PaletteSelected**
		 наступает после выбора цвета из палитры.


		 ![](../../Event_Image.gif)
		 [UpdateSize](dhtmlUi.chm::/Classes/ColorPanel/ColorPanel.UpdateSize.htm)
		 Событие **UpdateSize**
		 наступает при обновлении размеров компонента.


## Свойства, унаследованные от класса
 [Control](../../Classes/Control/Control.htm)
