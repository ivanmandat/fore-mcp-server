...
Компонент реализован классом [Menu](../../Classes/Menu/Menu.htm).
...
Меню может состоять из [заголовков](../../Classes/MenuHeader/MenuHeader.htm), [разделителей](../../Classes/Separator/Separator.htm) и [пунктов меню](../../Classes/MenuItem/MenuItem.htm). Пункт меню реализован классами [MenuItem](../../Classes/MenuItem/MenuItem.htm) и [ActiveMenuItem](../../Classes/ActiveMenuItem/ActiveMenuItem.htm). Экземпляры класса [ActiveMenuItem](../../Classes/ActiveMenuItem/ActiveMenuItem.htm), в отличие от [MenuItem](../../Classes/MenuItem/MenuItem.htm), не выделяются при наведении на них курсора, и при нажатии на них не закрывается меню.


В левой части пункта меню может быть установлен [флажок](../CheckBox/CheckBox.htm), [переключатель](../RadioButton/RadioButton.htm) или [изображение](../../Classes/Menu/Menu.ImageList.htm).


Изображение может быть установлено для всех пунктов меню из [спрайта](../ImageList/ImageList.htm) при помощи свойства [ImageList](../../Classes/Menu/Menu.ImageList.htm). Для отдельного пункта меню изображение устанавливается при помощи свойства [MenuItem.ImageUrl](../../Classes/MenuItem/MenuItem.ImageUrl.htm).


[Флажок](../CheckBox/CheckBox.htm) устанавливается в том случае, если задано значение для свойства [MenuItem.Checked](../../Classes/MenuItem/MenuItem.Checked.htm).


[Переключатель](../RadioButton/RadioButton.htm) устанавливается для пунктов меню с общим [именем группы](../../Classes/MenuItem/MenuItem.GroupName.htm).


Для каждого пункта меню можно установить подменю при помощи свойства [MenuItem.Menu](../../Classes/MenuItem/MenuItem.Menu.htm).


Меню отображается при вызове метода [show](../../Classes/DropPanel/DropPanel.show.htm).


[Пример статического создания меню](Menu_example.htm)


[Пример динамического создания меню](../../Classes/Menu/Menu.ImageList.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Menu](dhtmlUi.chm::/classes/menu/menu_constructor.htm)
		 Конструктор Menu создает
		 экземпляр компонента [Menu](dhtmlUi.chm::/components/menu/menu.htm).
