...
Компонент ShadowDropPanel представляет
 собой всплывающую панель с тенью.


## Комментарии


Компонент реализован классом [ShadowDropPanel](../../Classes/ShadowDropPanel/ShadowDropPanel.htm).
...
[Пример создания компонента ShadowDropPanel](Example_ShadowDropPanel.htm).
