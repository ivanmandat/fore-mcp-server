...
Компонент TagCloud представляет
 собой облако меток.
...
Компонент реализован классом [TagCloud](../../Classes/TagCloud/TagCloud.htm).
...
Пример создания облака меток описан на странице «[Пример
 создания компонента TagCloud](Example_TagCloud.htm)».
...
## Свойства, унаследованные от класса [DataVisualizer](../../Classes/DataVisualizer/DataVisualizer.htm)
...
## Методы, унаследованные от класса [DataVisualizer](../../Classes/DataVisualizer/DataVisualizer.htm)
...
## События, унаследованные от класса [DataVisualizer](../../Classes/DataVisualizer/DataVisualizer.htm)
