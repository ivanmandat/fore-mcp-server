...
Компонент FontComboBox представляет собой раскрывающийся список для выбора шрифта.


## Комментарии


Компонент реализован классом [FontComboBox](../../Classes/FontComboBox/FontComboBox.htm).
...
[Пример создания компонента FontComboBox](../../Classes/FontComboBox/FontComboBox_constructor.htm)
...
## Конструктор
		 ...
		 Конструктор FontComboBox создает
		 экземпляр компонента FontComboBox.


## Свойства, унаследованные от класса [ComboBox](../../Classes/ComboBox/ComboBox.htm)
...
## Методы, унаследованные от класса [ComboBox](../../Classes/ComboBox/ComboBox.htm)
