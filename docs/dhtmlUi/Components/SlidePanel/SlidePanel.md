...
Компонент SlidePanel представляет
 собой элемент управления, состоящий из трех связанных панелей - Header, Details
 и View.
...
Компонент реализован классом [SlidePanel](../../Classes/SlidePanel/slidepanel.htm).


Данный элемент управления используется в качестве контейнера для [панели
 свойств](dhtmlCommon.chm::/Classes/navigationbar/navigationbar.htm).
