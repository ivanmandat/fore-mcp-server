...
Компонент Breadcrumb предназначен для создания цепочки навигации по объектам.
...
-
кнопки для удаления выбранных элементов;


-
[кнопки для добавления элементов](../../Classes/Breadcrumb/Breadcrumb.StartMenuButton.htm);


-
кнопки для открытия истории элементов.


## Комментарии


Компонент реализован классом [Breadcrumb](../../Classes/Breadcrumb/Breadcrumb.htm).


Элементы, которые добавляются в цепочку навигации, реализованы классом [BreadcrumbItem](../../Classes/BreadcrumbItem/BreadcrumbItem.htm).
...
[Пример создания компонента Breadcrumb](example_Breadcrumb.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Breadcrumb](dhtmlUi.chm::/classes/breadcrumb/constructor_breadcrumb.htm)
		 Конструктор Breadcrumb
		 создает экземпляр компонента [Breadcrumb](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Items](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.items.htm)
		 Свойство Items устанавливает
		 коллекцию дочерних элементов компонента [Breadcrumb](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm).


		 ![](../../Property_Image.gif)
		 [SelectedItems](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.selecteditems.htm)
		 Свойство SelectedItems
		 устанавливает коллекцию элементов, выбранных в компоненте.


		 ![](../../Property_Image.gif)
		 [StartMenuButton](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.startmenubutton.htm)
		 Свойство StartMenuButton
		 определяет, отображается ли в [компоненте](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getContentDomNode](dhtmlUi.chm::/Classes/Breadcrumb/Breadcrumb.getContentDomNode.htm)
		 Метод getContentDomNode
		 возвращает DOM-вершину для содержимого компонента [Breadcrumb](dhtmlUi.chm::/Components/Breadcrumb/Breadcrumb.htm).


		 ![](../../Sub_Image.gif)
		 [getItems](dhtmlUi.chm::/Classes/Breadcrumb/Breadcrumb.getItems.htm)
		 Метод getItems возвращает
		 коллекцию элементов компонента.


		 ![](../../Sub_Image.gif)
		 [getSelectedItems](dhtmlUi.chm::/Classes/Breadcrumb/Breadcrumb.getSelectedItems.htm)
		 Метод getSelectedItems
		 возвращает коллекцию элементов, выбранных в компоненте.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [AddItem](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.additem.htm)
		 Событие AddItem наступает
		 во время добавления элемента в компонент [Breadcrumb](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm).


		 ![](../../Event_Image.gif)
		 [BeforeAddItem](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.beforeadditem.htm)
		 Событие BeforeAddItem
		 наступает перед добавлением элемента в компонент [Breadcrumb](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm).


		 ![](../../Event_Image.gif)
		 [BeforeRemoveItem](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.beforeremoveitem.htm)
		 Событие BeforeRemoveItem
		 наступает перед удалением элемента из компонента [Breadcrumb](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm).


		 ![](../../Event_Image.gif)
		 [ItemClick](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.itemclick.htm)
		 Событие ItemClick наступает
		 при нажатии на заголовок элемента компонента [Breadcrumb](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm).


		 ![](../../Event_Image.gif)
		 [ItemFilterClick](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.itemfilterclick.htm)
		 Событие ItemFilterClick
		 наступает при нажатии на кнопку фильтрации.


		 ![](../../Event_Image.gif)
		 [ItemSortClick](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.itemsortclick.htm)
		 Событие ItemSortClick
		 наступает при нажатии на кнопку сортировки.


		 ![](../../Event_Image.gif)
		 [RemoveItem](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.removeitem.htm)
		 Событие RemoveItem
		 наступает при удалении элемента из компонента [Breadcrumb](dhtmlUi.chm::/components/breadcrumb/breadcrumb.htm).


		 ![](../../Event_Image.gif)
		 [SelectedItemsChanged](dhtmlUi.chm::/classes/breadcrumb/breadcrumb.selecteditemschanged.htm)
		 Событие SelectedItemsChanged
		 наступает при изменении состава [коллекции
		 выбранных элементов](dhtmlUi.chm::/classes/breadcrumbselecteditemslist/breadcrumbselecteditemslist.htm).
