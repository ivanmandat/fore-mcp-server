...
Компонент MainMenu представляет
 собой главное меню.
...
Компонент реализован классом [MainMenu](MainMenu.htm).
...
На главном меню располагаются кнопки - экземпляры класса [MainMenuButton](../../Classes/MainMenuButton/MainMenuButton.htm).
 Для каждой кнопки может быть установлено [меню](../Menu/Menu.htm).


[Пример создания компонента MainMenu](MainMenu_example.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [MainMenu](dhtmlUi.chm::/Classes/MainMenu/MainMenu_constructor.htm)
		 Конструктор MainMenu
		 создает экземпляр компонента [MainMenu](dhtmlUi.chm::/components/mainmenu/mainmenu.htm).
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [addItem](dhtmlUi.chm::/Classes/MainMenu/MainMenu.addItem.htm)
		 Метод addItem добавляет
		 дочерний элемент главного меню.


		 ![](../../Sub_Image.gif)
		 [getItemById](dhtmlUi.chm::/Classes/MainMenu/MainMenu.getItemById.htm)
		 Метод getItemById
		 возвращает элемент главного меню по его идентификатору.


		 ![](../../Sub_Image.gif)
		 [removeItem](dhtmlUi.chm::/Classes/MainMenu/MainMenu.removeItem.htm)
