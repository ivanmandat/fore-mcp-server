...
Компонент Button реализован
 классом [Button](../../Classes/Button/Button.htm).


## Пример компонента Button


Компонент Button может быть
 представлен следующими разновидностями:
...
Пример создания простой кнопки описан на
 странице «[Пример создания простой кнопки](Example_SimpleButton.htm)».
...
Пример создания кнопки с изображением описан
 на странице «[Пример создания кнопки с
 изображением](ImageButtonExample.htm)».
...
Пример создания кнопки с раскрывающимся меню
 описан на странице «[Пример создания кнопки
 с раскрывающимся меню](MenuButtonExample.htm)».
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [Button](dhtmlUi.chm::/Classes\Button\Constructor_Button.htm)
		 Конструктор Button
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ContentChanged](dhtmlUi.chm::/classes/button/button.contentchanged.htm)
		 Событие ContentChanged
		 наступает после редактирования содержимого кнопки при условии,
