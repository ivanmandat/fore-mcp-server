...
Компонент SpinEdit представляет
 собой редактор с кнопками прокрутки.


## Комментарии


Компонент реализован классом [SpinEdit](SpinEdit.htm).


Параметры обработчиков событий компонента [SpinEdit](SpinEdit.htm)
 реализованы классом [SpinEventArgs](dhtmlCommon.chm::/Classes/SpinEventArgs/SpinEventArgs.htm).
...
Редактор может отображаться как с кнопками прокрутки, так и без них,
 в зависимости от значения свойства [SpinEdit.ShowButtons](dhtmlCommon.chm::/Classes/SpinEdit/SpinEdit.ShowButtons.htm).


В поле ввода редактора может быть установлено как текстовое, так и числовое
 значение. Ограничение на ввод числовых значений может быть установлено
 с помощью свойства [SpinEventArgs.Cancel](dhtmlCommon.chm::/Classes/SpinEventArgs/SpinEventArgs.Cancel.htm).


[Пример создания компонента SpinEdit](Example_SpinEdit.htm).
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [SpinEdit](dhtmlCommon.chm::/classes\spinedit\constructor_spinedit.htm)
		 Конструктор SpinEdit
		 создает экземпляр компонента SpinEdit.
