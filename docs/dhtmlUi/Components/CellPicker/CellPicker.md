...
Компонент CellPicker предназначен для выбора количества строк и столбцов в таблице. Используется в ленте приложения.


## Комментарии


Компонент реализован классом [CellPicker](../../Classes/CellPicker/cellpicker.htm).
...
При наведении курсора на область компонента ячейки выделяются.


[Пример создания компонента CellPicker](Example_CellPicker.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [CellPicker](dhtmlUi.chm::/classes/cellpicker/constructor_cellpicker.htm)
		 Конструктор CellPicker
		 создает экземпляр компонента [CellPicker](dhtmlUi.chm::/components/cellpicker/cellpicker.htm).
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [clearSelection](dhtmlUi.chm::/classes/cellpicker/cellpicker.clearselection.htm)
		 Метод clearSelection
		 отменяет выделение ячеек.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [SelectionChanged](dhtmlUi.chm::/classes/cellpicker/cellpicker.selectionchanged.htm)
		 Событие SelectionChanged
		 наступает при выборе ячеек.


		 ![](../../Event_Image.gif)
		 [TableSelected](dhtmlUi.chm::/classes/cellpicker/cellpicker.tableselected.htm)
		 Событие TableSelected
		 наступает после выбора количества строк и столбцов в таблице.
