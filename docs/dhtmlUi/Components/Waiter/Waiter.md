...
Компонент Waiter представляет
 собой индикатор загрузки.


## Комментарии


Компонент реализован классом PP.Ui.[Waiter](../../Classes/Waiter/Waiter.htm).
...
![](../../Classes/Waiter/Waiter.gif)


[Пример
 использования компонента Waiter](dhtmlReport.chm::/Components/RegularReport/ReportBox/ReportBox_Example.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Waiter](dhtmlUi.chm::/Classes/Waiter/Constructor_Waiter.htm)
		 Конструктор Waiter
		 создает экземпляр компонента Waiter.
