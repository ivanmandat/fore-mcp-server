...
Компонент FontBox представляет
 собой элемент управления для настроек параметров текста.


## Комментарии


Компонент реализован классом [FontBox](../../Classes/FontBox/FontBox.htm)
...
![](../../Classes/FontBox/FontBox.png)


[Пример создания
 компонента FontBox](../../Classes/FontBox/Constructor_FontBox.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [FontBox](dhtmlUi.chm::/Classes/FontBox/Constructor_FontBox.htm)
		 Конструктор FontBox
		 создает экземпляр класса FontBox.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Alignment](dhtmlUi.chm::/Classes/FontBox/FontBox.Alignment.htm)
		 Свойство Alignment
		 определяет вариант выравнивания текста.


		 ![](../../Property_Image.gif)
		 [Font](dhtmlUi.chm::/Classes/FontBox/FontBox.Font.htm)
		 Свойство Font определяет
		 настройки текста.


		 ![](../../Property_Image.gif)
		 [IsSizeExtend](dhtmlUi.chm::/Classes/FontBox/FontBox.IsSizeExtend.htm)
		 Свойство IsSizeExtend
		 определяет отображение размера больше 36 в раскрывающемся списке
		 размеров текста.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getColorCombo](dhtmlUi.chm::/Classes/FontBox/FontBox.getColorCombo.htm)
		 Метод getColorCombo
		 возвращает компонент [ColorCombo](dhtmlUi.chm::/Classes/ColorCombo/ColorCombo.htm),
		 который используется для выбора цвета текста.


		 ![](../../Sub_Image.gif)
		 [getFontFamilyComboBox](dhtmlUi.chm::/Classes/FontBox/FontBox.getFontFamilyComboBox.htm)
		 Метод getFontFamilyComboBox возвращает
		 компонент [FontComboBox](dhtmlUi.chm::/Classes/FontComboBox/FontComboBox.htm),
		 который используется для выбора типа шрифта.


		 ![](../../Sub_Image.gif)
		 [getFontSizeComboBox](dhtmlUi.chm::/Classes/FontBox/FontBox.getFontSizeComboBox.htm)
		 Метод getFontSizeComboBox
		 возвращает компонент [NumberEdit](dhtmlUi.chm::/Classes/NumberEdit/NumberEdit.htm),
		 который используется для выбора размера шрифта.


		 ![](../../Sub_Image.gif)
		 [getToolbar](dhtmlUi.chm::/Classes/FontBox/FontBox.getToolbar.htm)
		 Метод getToolbar возвращает
		 компонент [ToolBar](dhtmlUi.chm::/Components/ToolBar/ToolBar.htm),
		 который используется для выбора варианта выравнивания текста и
		 начертания шрифта.


		 ![](../../Sub_Image.gif)
		 [setControlsGroupVisibility](dhtmlUi.chm::/Classes/FontBox/FontBox.setControlsGroupVisibility.htm)
		 Метод setControlsGroupVisibility
		 определяет видимость определенной группы элементов управления
		 в компоненте FontBox.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [PropertyChanged](dhtmlUi.chm::/Classes/FontBox/FontBox.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении настроек отображения текста.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/FontBox/FontBox.ValueChanged.htm)
		 Событие ValueChanged
		 наступает при изменении значения параметров текста.
