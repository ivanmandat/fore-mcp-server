...
Компонент DateTimeEdit представляет
 собой редактор даты и времени.


## Комментарии


Компонент реализован классом [DateTimeEdit](../../Classes/DateTimeEdit/DateTimeEdit.htm).
...
Значение даты и времени можно изменять при помощи кнопок прокрутки или
 клавиш UP/DOWN, а также можно вводить значение с клавиатуры. Для
 этого необходимо выделить число, которое нужно изменить.


[Пример создания компонента DateTimeEdit](Example_DateTimeEdit.htm).
...
## Свойства, унаследованные о класса [Object](dhtmlCommon.chm::/Classes/object/object.htm)
