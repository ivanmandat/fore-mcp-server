...
Компонент Combo представляет собой редактор ввода с раскрывающейся панелью.


## Комментарии


Компонент Combo реализован классом [Combo](../../Classes/Combo/Combo.htm).


## Пример


Компонент Combo имеет следующий вид:


![](Combo1.gif)


[Пример создания компонента Combo](Example_Combo.htm)
...
## Конструкторы
		 ...
		 Конструктор Combo создает
		 экземпляр компонента Combo.
