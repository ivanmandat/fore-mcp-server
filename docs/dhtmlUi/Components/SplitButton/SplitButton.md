...
Компонент SplitButton представляет собой кнопку, состоящую из двух частей: верхняя часть - кнопка с картинкой, нижняя - кнопка с раскрывающимся меню.


## Комментарии


Кнопка с картинкой возвращается при помощи метода [SplitButton.getImageButton](../../Classes/SplitButton/SplitButton.getImageButton.htm), кнопка с раскрывающимся меню - при помощи метода [SplitButton.getContentButton](../../Classes/SplitButton/SplitButton.getContentButton.htm).


## Пример


Кнопка имеет следующий вид:


![](../../Classes/SplitButton/SplitButton1.gif)


[Пример создания компонента SplitButton](../../Classes/SplitButton/Constructor_SplitButton.htm)


Кнопка может размещаться горизонтально:


![](../../Classes/SplitButton/SplitButton_horizontal.gif)


[Пример создания горизонтальной кнопки](../../Classes/SplitButton/SplitButton.getColumnIndex.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [SplitButton](dhtmlUi.chm::/Classes/SplitButton/Constructor_SplitButton.htm)
		 Конструктор SplitButton
		 создает экземпляр компонента SplitButton.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ImageList](dhtmlUi.chm::/Classes/SplitButton/SplitButton.ImageList.htm)
		 Свойство ImageList
		 определяет спрайт, откуда будет выбрана пиктограмма для верхней
		 части кнопки.


		 ![](../../Property_Image.gif)
		 [ImageUrl](dhtmlUi.chm::/Classes/SplitButton/SplitButton.ImageUrl.htm)
		 Свойство ImageUrl определяет
		 путь к изображению верхней части кнопки.


		 ![](../../Property_Image.gif)
		 [IsPressed](dhtmlUi.chm::/Classes/SplitButton/SplitButton.IsPressed.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [IsToggleButton](dhtmlUi.chm::/Classes/SplitButton/SplitButton.IsToggleButton.htm)
		 Свойство IsToggleButton
		 определяет, можно ли переключать состояния верхней части кнопки
		 (нажать/отжать).


		 ![](../../Property_Image.gif)
		 [Menu](dhtmlUi.chm::/Classes/SplitButton/SplitButton.Menu.htm)
		 Свойство Menu определяет
		 дочернее меню компонента.


		 ![](../../Property_Image.gif)
		 [MenuDropPosition](dhtmlUi.chm::/Classes/SplitButton/SplitButton.MenuDropPosition.htm)
		 Свойство MenuDropPosition
		 устанавливает позицию открытия дочернего меню компонента.


		 ![](../../Property_Image.gif)
		 [UseWrapping](dhtmlUi.chm::/Classes/SplitButton/SplitButton.UseWrapping.htm)
		 Свойство UseWrapping
		 осуществляет перенос слов по строкам.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getColumnIndex](dhtmlUi.chm::/Classes/SplitButton/SplitButton.getColumnIndex.htm)
		 Метод getColumnIndex
		 возвращает индекс столбца с пиктограммой, выбранной из [спрайта](dhtmlUi.chm::/Classes/SplitButton/SplitButton.ImageList.htm).


		 ![](../../Sub_Image.gif)
		 [getContentButton](dhtmlUi.chm::/Classes/SplitButton/SplitButton.getContentButton.htm)
		 Метод getContentButton
		 возвращает нижнюю часть кнопки (с раскрывающимся меню).


		 ![](../../Sub_Image.gif)
		 [getImageButton](dhtmlUi.chm::/Classes/SplitButton/SplitButton.getImageButton.htm)
		 Метод getImageButton
		 возвращает верхнюю часть кнопки (с картинкой).


		 ![](../../Sub_Image.gif)
		 [getIsHorizontal](dhtmlUi.chm::/Classes/SplitButton/SplitButton.getIsHorizontal.htm)
		 Метод getIsHorizontal
		 возвращает признак того, что для кнопки применяется горизонтальное
		 размещение.


		 ![](../../Sub_Image.gif)
		 [getRowIndex](dhtmlUi.chm::/Classes/SplitButton/SplitButton.getRowIndex.htm)
		 Метод getRowIndex возвращает
		 индекс строки с пиктограммой, выбранной из [спрайта](dhtmlUi.chm::/Classes/SplitButton/SplitButton.ImageList.htm).
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [DefaultAction](dhtmlUi.chm::/Classes/SplitButton/SplitButton.DefaultAction.htm)
		 Событие DefaultAction
		 наступает при нажатии на верхнюю часть кнопки (с картинкой).


## Свойства, унаследованные от класса [Control](../../Classes/Control/Control.htm)


Примечание. Значение свойства Height для компонента SplitButton изменить нельзя, так как высота компонента предопределена.
