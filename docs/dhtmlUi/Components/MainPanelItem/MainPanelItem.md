...
Компонент MainPanelItem представляет
 собой элемент [меню в раскрывающейся
 панели](../MainPanel/MainPanel.htm).


## Комментарии


Компонент реализован классом [MainPanelItem](../../Classes/MainPanelItem/MainPanelItem.htm).
 Используется при создании компонента [MainPanel](../MainPanel/MainPanel.htm).


## Пример


Компонент MainPanelItem является
 элементом меню в раскрывающейся панели, пример которого расположен на
 странице «[Пример создания
 компонента MainPanel](../MainPanel/Example_MainPanel.htm)».
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [MainPanelItem](../../Classes/MainPanelItem/Constructor_MainPanelItem.htm)
		 Конструктор MainPanelItem
		 создает экземпляр компонента [MainPanelItem](MainPanelItem.htm).
