...
Компонент TextBox представляет собой текстовое поле.


## Комментарии


Компонент TextBox реализован классом [TextBox](../../Classes/TextBox/TextBox.htm).


## Пример


Компонент TextBox может иметь следующий вид:


![](TextBox.png)


[Пример создания компонента TextBox](TextBox_Example.htm).
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [TextBox](dhtmlUi.chm::/Classes/TextBox/Constructor_TextBox.htm)
		 Конструктор TextBox создает
		 экземпляр компонента TextBox.
