...
Компонент Window представляет
 собой окно для отображения произвольного содержимого.


## Комментарии


Компонент реализован классом [Window](../../Classes/Window/Window.htm)
 - наследником класса [DropPanel](../../Classes/DropPanel/DropPanel.htm).
...
Заголовок окна задается при
 помощи свойства [Caption](../../Classes/Window/Window.Caption.htm),
 путь к изображению в заголовке
 окна определен в свойстве [CaptionIcon](../../Classes/Window/Window.CaptionIcon.htm).


В правом верхнем углу компонента располагаются [кнопка
 разворачивания](../../Classes/Window/Window.getExpandButton.htm) окна и [кнопка
 закрытия](../../Classes/Window/Window.getCloseButton.htm) окна.


При нажатии на кнопку ![](Window2.gif) окно
 увеличивается до размеров, указанных в атрибуте style
 тега div. При этом изменяется
 изображение кнопки на ![](Window4.gif).При нажатии
 на кнопку ![](Window4.gif) окно уменьшается до размеров
 указанных в свойствах [Height](../../Classes/Control/Control.Height.htm)
 и [Width](../../Classes/Control/Control.Width.htm).


При нажатии на кнопку ![](Window5.gif) закрывается
 окно.


Сворачивание компонента происходит
 при вызове метода collapse, при этом наступает событие Collapsed. При
 сворачивании окно располагается в нижней части страницы и часть окна скрыта.


Разворачивание компонента происходит
 при вызове метода [expand](../../Classes/Window/Window.expand.htm)
 и при нажатии на [кнопку
 разворачивания](../../Classes/Window/Window.getExpandButton.htm), при этом наступает событие [Expanded](../../Classes/Window/Window.Expanded.htm).
 При разворачивании окно полностью отображается на странице.


В зависимости от значения свойства [EnableMove](../../Classes/Window/Window.EnableMove.htm)
 окно можно перемещать по странице при помощи механизма Drag&Drop.
 При этом наступают события [Moved](../../Classes/Window/Window.Moved.htm)
 и [Moving](../../Classes/Window/Window.Moving.htm).


Размеры окна можно изменять путем перетаскивания его границ, если для
 свойства [EnableResize](../../Classes/DropPanel/DropPanel.EnableResize.htm)
 установлено значение true.


[Пример создания компонента Window](Example_Window.htm)


При использовании метода [showDialog](../../Classes/Window/Window.showDialog.htm)
 компонент отображается в виде окна:
...
[Пример создания
 окна](../../Classes/Window/Window.showDialog.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Window](dhtmlUi.chm::/classes/window/constructor_window.htm)
		 Конструктор Window
		 создает экземпляр компонента Window.
