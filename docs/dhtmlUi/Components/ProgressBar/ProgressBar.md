...
Компонент ProgressBar представляет собой элемент управления, предназначенный для индикации процесса выполнения длительных операций.


## Комментарии


Компонент реализован классом [ProgressBar](../../Classes/ProgressBar/ProgressBar.htm).


Основные возможности:


1. Вертикальное и горизонтальное расположение ([ProgressBar.IsVertical](../../Classes/ProgressBar/ProgressBar.IsVertical.htm));


2. Отображение текущего значения ([ProgressBar.DisplayValue](../../Classes/ProgressBar/ProgressBar.DisplayValue.htm));


3. Работа с тысячными долями ([ProgressBar.IsPrecision](../../Classes/ProgressBar/ProgressBar.IsPrecision.htm)).
...
![](../../Classes/ProgressBar/ProgressBar_DisplayValue.gif)


[Пример создания компонента ProgressBar](../../Classes/ProgressBar/Constructor_ProgressBar.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [ProgressBar](dhtmlUi.chm::/Classes/ProgressBar/Constructor_ProgressBar.htm)
		 Конструктор ProgressBar
		 создает экземпляр компонента ProgressBar.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayValue](dhtmlUi.chm::/Classes/ProgressBar/ProgressBar.DisplayValue.htm)
		 Свойство DisplayValue
		 определяет, будет ли отображаться значение на компоненте ProgressBar.


		 ![](../../Property_Image.gif)
		 [IsPrecision](dhtmlUi.chm::/Classes/ProgressBar/ProgressBar.IsPrecision.htm)
		 Свойство IsPrecision
		 определяет, будет ли осуществляться работа с тысячными долями.


		 ![](../../Property_Image.gif)
		 [IsVertical](dhtmlUi.chm::/Classes/ProgressBar/ProgressBar.IsVertical.htm)
		 Свойство IsVertical
		 определяет, размещается ли компонент вертикально.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [setValueAnimated](dhtmlUi.chm::/Classes/ProgressBar/ProgressBar.setValueAnimated.htm)
		 Метод setValueAnimated
		 используется для анимированого изменения значения.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [MaxValueReached](dhtmlUi.chm::/Classes/ProgressBar/ProgressBar.MaxValueReached.htm)
		 Событие MaxValueReached
		 наступает при достижении максимального значения (100).


		 ![](../../Event_Image.gif)
		 [MinValueReached](dhtmlUi.chm::/Classes/ProgressBar/ProgressBar.MinValueReached.htm)
		 Событие MinValueReached
		 наступает при достижении минимального значения (0).


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/ProgressBar/ProgressBar.ValueChanged.htm)
