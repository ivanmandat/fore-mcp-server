...
Компонент ColorCombo представляет
 собой раскрывающийся список для выбора цвета.


## Комментарии


Компонент реализован классом [ColorCombo](../../Classes/ColorCombo/ColorCombo.htm).


Цвет можно выбрать из [палитры
 готовых](../../Classes/ColorCombo/ColorCombo.PresentedColors.htm) цветов или из цветового спектра.


[Выбранный цвет](../../Classes/ColorCombo/ColorCombo.Color.htm)
 становится цветом кнопки вызова раскрывающегося списка.


Использованные цвета отображаются в нижней части раскрывающейся панели.


## Пример


Компонент ColorCombo имеет следующий
 вид:
...
[Пример создания компонента ColorCombo](Example_ColorCombo.htm)
...
## Конструкторы
			 ...
			 ![](../../Sub_Image.gif)
			 [ColorCombo](dhtmlUi.chm::/classes\colorcombo\constructor_colorcombo.htm)
			 Конструктор ColorCombo
			 создает экземпляр компонента [ColorCombo](dhtmlUi.chm::/components/colorcombo/colorcombo.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Color](dhtmlUi.chm::/classes\colorcombo\colorcombo.color.htm)
		 Свойство Color устанавливает
		 текущий цвет, который также является цветом кнопки вызова раскрывающегося
		 списка.


		 ![](../../Property_Image.gif)
		 [PresentedColors](dhtmlUi.chm::/classes\colorcombo\colorcombo.presentedcolors.htm)
		 Свойство PresentedColors
		 устанавливает набор стандартных цветов в палитре.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [getDropPanel](dhtmlUi.chm::/Classes/ColorCombo/ColorCombo.getDropPanel.htm)


		 Метод **getDropPanel возвращает раскрывающуюся
		 панель.


		 ![](../../Sub_Image.gif)
		 [showDropPanel](dhtmlUi.chm::/Classes/ColorCombo/ColorCombo.showDropPanel.htm)


		 **Метод **showDropPanel раскрывает
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ColorChange](dhtmlUi.chm::/classes\colorcombo\colorcombo.colorchange.htm)
		 Событие ColorChange
		 наступает при изменении цвета после закрытия раскрывающегося списка.


		 ![](../../Event_Image.gif)
		 [ColorChanged](dhtmlUi.chm::/classes\colorcombo\colorcombo.colorchanged.htm)
		 Событие ColorChanged
		 наступает при изменении цвета.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/ColorCombo/ColorCombo.ValueChanged.htm)
		 Событие ValueChanged
		 наступает при изменении значения компонента.
