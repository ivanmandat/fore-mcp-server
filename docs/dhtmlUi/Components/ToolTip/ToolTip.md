...
Компонент ToolTip представляет собой всплывающую подсказку.


## Комментарии


Компонент реализован классом [ToolTip](../../Classes/ToolTip/ToolTip.htm).
...
[Пример создания компонента ToolTip](../../Classes/ToolTip/ToolTip_constructor.htm)
