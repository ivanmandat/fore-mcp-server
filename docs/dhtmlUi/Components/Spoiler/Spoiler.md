...
Компонент Spoiler представляет
...
Компонент реализован классом [Spoiler](../../Classes/Spoiler/Spoiler.htm).
...
Пример создания панели описан на странице «[Пример
 создания компонента Spoiler](Example_Spoiler.htm)».
...
## Свойства, унаследованные от класса [Panel](../../Classes/Panel/Panel.htm)
...
## Методы, унаследованные от класса [Panel](../../Classes/Panel/Panel.htm)
