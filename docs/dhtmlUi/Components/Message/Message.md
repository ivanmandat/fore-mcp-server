...
Компонент Message представляет
...
Компонент реализован классом [Message](../../Classes/Message/Message.htm).
...
Пример создания окна описан на странице «[Пример
 создания компонента Message](Example_Message.htm)».
