...
Компонент RadioButton представляет
 собой переключатель, предназначенный для выбора одного значения из группы
 значений.
...
Компонент реализован классом [RadioButton](../../Classes/RadioButton/RadioButton.htm),
 наследником класса [CheckBox](../../Classes/CheckBox/CheckBox.htm).


Переключатели объединяются в группу при помощи свойства [RadioButton.GroupName](../../Classes/RadioButton/RadioButton.GroupName.htm).
 Из переключателей, объединённых в группу, может быть выбран только один.
 Текст рядом с переключателем устанавливается при помощи свойства [Control.Content](../../Classes/Control/Control.Content.htm).
 Отметка компонента устанавливается при помощи свойства [CheckBox.Checked](../../Classes/CheckBox/CheckBox.Checked.htm).
 По умолчанию отметка не установлена.


## Пример


Группа компонентов RadioButton
...
[Пример создания группы компонентов
 RadioButton](Example_RadioButton.htm)
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [RadioButton](dhtmlUi.chm::/classes/radiobutton/constructor_radiobutton.htm)
			 Конструктор RadioButton
			 создает экземпляр компонента RadioButton.
...
## Свойство
		 ...
		 ![](../../Property_Image.gif)
		 [GroupName](dhtmlUi.chm::/classes/radiobutton/radiobutton.groupname.htm)
		 Свойство GroupName
		 устанавливает имя группы компонентов RadioButton.


## Свойства, унаследованные от класса [CheckBox](../../Classes/CheckBox/CheckBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Checked](dhtmlUi.chm::/classes/checkbox/checkbox.checked.htm)
		 Свойство Checked определяет,
		 является ли компонент выделенным.


		 ![](../../Property_Image.gif)
		 [CheckedState](dhtmlUi.chm::/classes/checkbox/checkbox.checkedstate.htm)
		 Свойство CheckedState
		 определяет состояние отметки компонента.


		 ![](../../Property_Image.gif)
		 [ThreeState](dhtmlUi.chm::/classes/checkbox/checkbox.threestate.htm)
		 Свойство ThreeState
		 определяет, установлен ли режим трех состояний компонента.


## Событие, унаследованное от класса [CheckBox](../../Classes/CheckBox/CheckBox.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [CheckedChanged](dhtmlUi.chm::/Classes/CheckBox/CheckBox.CheckedChanged.htm)
		 Устарело. Событие CheckedChanged наступает
		 при смене состояния отметки компонента.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/CheckBox/CheckBox.ValueChanged.htm)
		 Событие ValueChanged
		 наступает при смене значения компонента.
