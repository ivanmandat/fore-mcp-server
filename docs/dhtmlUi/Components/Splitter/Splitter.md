...
Компонент Splitter представляет
 собой разделитель, предназначенный для регулирования положения панелей
 друг относительно друга, скрытия панелей и изменения их размеров.


При наведении курсора на разделитель появляется двусторонняя стрелка,
 с помощью которой можно изменять размеры панелей. Изменение размеров панелей
 возможно, если для свойства [Splitter.EnableResize](../../Classes/Splitter/Splitter.EnableResize.htm)
 установлено значение true.


Разделитель может регулировать положение двух панелей, [расположенных](../../Classes/Splitter/Splitter.Orientation.htm)
...
Компонент реализован классом [Splitter](../../Classes/Splitter/Splitter.htm).


Компонент Splitter может выглядеть
 следующим образом:
...
[Пример создания компонента Splitter](Example_Splitter.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Splitter](dhtmlUi.chm::/classes/splitter/constructor_splitter.htm)
		 Конструктор Splitter
		 создает экземпляр компонента Splitter.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [EnableResize](dhtmlUi.chm::/Classes/Splitter/Splitter.EnableResize.htm)
		 Свойство EnableResize
		 определяет, могут ли изменяться размеры панелей.


		 ![](../../Property_Image.gif)
		 [FixPanel](dhtmlUi.chm::/Classes/Splitter/Splitter.FixPanel.htm)
		 Свойство FixPanel определяет
		 индекс панели, размер которой не будет меняться при изменении
		 размеров всего компонента.


		 ![](../../Property_Image.gif)
		 [IsVertical](dhtmlUi.chm::/Classes/Splitter/Splitter.IsVertical.htm)
		 Свойство IsVertical
		 определяет ориентацию компонента с разделителем.


		 ![](../../Property_Image.gif)
		 [MinPanelSize](dhtmlUi.chm::/Classes/Splitter/Splitter.MinPanelSize.htm)
		 Свойство MinPanelSize
		 устанавливает минимальный допустимый размер панелей.


		 ![](../../Property_Image.gif)
		 [Orientation](dhtmlUi.chm::/Classes/Splitter/Splitter.Orientation.htm)
		 Свойство Orientation
		 определяет вариант размещения панелей, разделенных компонентом
		 Splitter.


		 ![](../../Property_Image.gif)
		 [ResizeHtmlContent](dhtmlUi.chm::/Classes/Splitter/Splitter.ResizeHtmlContent.htm)
		 Свойство ResizeHtmlContent
		 определяет, будет ли изменяться размер HTML-элемента, установленного
		 в свойстве [Content](dhtmlUi.chm::/Classes/Control/Control.Content.htm).


		 ![](../../Property_Image.gif)
		 [SplitterPosition](dhtmlUi.chm::/Classes/Splitter/Splitter.SplitterPosition.htm)
		 Свойство SplitterPosition
		 устанавливает позицию, в которой расположен разделитель.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [collapse](dhtmlUi.chm::/Classes/Splitter/Splitter.collapse.htm)
		 Метод collapse сворачивает
		 левую или верхнюю панель компонента Splitter.


		 ![](../../Sub_Image.gif)
		 [expand](dhtmlUi.chm::/Classes/Splitter/Splitter.expand.htm)
		 Метод expand разворачивает
		 свернутую панель компонента Splitter.


		 ![](../../Sub_Image.gif)
		 [getCollapsed](dhtmlUi.chm::/Classes/Splitter/Splitter.getCollapsed.htm)
		 Метод getCollapsed
		 возвращает индекс свернутой панели.


		 ![](../../Sub_Image.gif)
		 [getResizerSize](dhtmlUi.chm::/Classes/Splitter/Splitter.getResizerSize.htm)
		 Метод getResizerSize
		 возвращает размер области, с помощью которой изменяются размеры
		 панелей.


		 ![](../../Sub_Image.gif)
		 [getPanel](dhtmlUi.chm::/classes/splitter/splitter.getpanel.htm)
		 Метод getPanel возвращает
		 панель по индексу.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [SplitterPositionChanged](dhtmlUi.chm::/Classes/Splitter/Splitter.SplitterPositionChanged.htm)
		 Событие SplitterPositionChanged
		 наступает после изменения позиции разделителя.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/Splitter/Splitter.ValueChanged.htm)
		 Событие ValueChanged
		 наступает после изменения значения разделителя.
