...
Компонент GridPanel представляет собой таблицу, которая служит контейнером для элементов управления.


## Комментарии


Компонент реализован классом [GridPanel](../../Classes/GridPanel/GridPanel.htm), наследником класса [Container](../../Classes/Container/Container.htm).
...
[Пример создания компонента GridPanel](GridPanel_example.htm)


Настроить отображение html-таблицы (например, границы) можно при помощи атрибутов тега <table>, вызванных методом [getTable](../../Classes/GridPanel/GridPanel.getTable.htm). Элементы в таблицу могут быть добавлены динамически в свойстве [Items](../../Classes/Container/Container.Items.htm) или статически при помощи метода [add](../../Classes/GridPanel/GridPanel.add.htm).
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [GridPanel](dhtmlUi.chm::/classes/gridpanel/gridpanel_constructor.htm)
		 Конструктор GridPanel
		 создает компонент GridPanel.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [add](dhtmlUi.chm::/classes/gridpanel/gridpanel.add.htm)
		 Метод add добавляет
		 компонент, наследник класса [Control](dhtmlUi.chm::/classes/control/control.htm),
		 в таблицу.


		 ![](../../Sub_Image.gif)
		 [getItemFromTable](dhtmlUi.chm::/classes/gridpanel/gridpanel.getitemfromtable.htm)
		 Метод getItemFromTable
		 возвращает элемент, входящий в состав таблицы.


		 ![](../../Sub_Image.gif)
		 [getRowsCount](dhtmlUi.chm::/classes/gridpanel/gridpanel.getrowscount.htm)
		 Метод getRowsCount
		 возвращает количество строк таблицы.


		 ![](../../Sub_Image.gif)
		 [getTable](dhtmlUi.chm::/classes/gridpanel/gridpanel.gettable.htm)
		 Метод getTable возвращает
		 таблицу.


		 ![](../../Sub_Image.gif)
		 [removeLastRow](dhtmlUi.chm::/classes/gridpanel/gridpanel.removelastrow.htm)
		 Метод removeLastRow
		 удаляет нижнюю строку таблицы.


		 ![](../../Sub_Image.gif)
		 [setColumnWidth](dhtmlUi.chm::/classes/gridpanel/gridpanel.setcolumnwidth.htm)
		 Метод setColumnWidth
		 устанавливает ширину столбца таблицы.


		 ![](../../Sub_Image.gif)
		 [setRowHeight](dhtmlUi.chm::/classes/gridpanel/gridpanel.setrowheight.htm)
		 Метод setRowHeight
		 устанавливает высоту строки таблицы.


		 ![](../../Sub_Image.gif)
		 [setRowVisibility](dhtmlUi.chm::/classes/gridpanel/gridpanel.setrowvisibility.htm)
		 Метод setRowVisibility
		 определяет, отображается ли указанная строка таблицы.
