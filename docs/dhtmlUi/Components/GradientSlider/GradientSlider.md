...
Компонент GradientSlider представляет собой компонент [Slider](../Slider/Slider.htm) с градиентной заливкой.


## Комментарии


Компонент GradientSlider реализован классом [GradientSlider](../../Classes/GradientSlider/GradientSlider.htm).


При нажатии на [бегунок](../../Classes/SliderItemColor/SliderItemColor.htm) компонента раскрывается меню для выбора цвета.
...
Меню выбора цвета [бегунка](../../Classes/SliderItemColor/SliderItemColor.htm) имеет следующий вид:


![](GradientSlider_2.png)


[Пример создания компонента GradientSlider](Example_GradientSlider.htm).
