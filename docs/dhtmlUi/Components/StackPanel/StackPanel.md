...
Компонент StackPanel представляет собой контейнер для размещения элементов один за другим – в вертикальном столбце/горизонтальной строке.


## Комментарии


Компонент реализован классом [StackPanel](../../Classes/StackPanel/StackPanel.htm).


Высота строк/ширина столбцов регулируется автоматически, в зависимости от высоты/ширины элемента. В одной строке/столбце размещается только один элемент.
...
![](StackPanel_vertical.gif)


Горизонтальное расположение:


![](StackPanel_horisontal.gif)


[Пример размещения компонента StackPanel](../../Classes/StackPanel/Constructor_StackPanel.htm)
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [StackPanel](dhtmlUi.chm::/Classes/StackPanel/Constructor_StackPanel.htm)
		 Конструктор StackPanel
		 создает экземпляр компонента StackPanel.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [DeferredResize](dhtmlUi.chm::/Classes/StackPanel/StackPanel.DeferredResize.htm)
		 Свойство DeferredResize
		 определяет признак изменения размера элементов после освобождения
		 указателя мыши.


		 ![](../../Property_Image.gif)
		 [IsContentResizable](dhtmlUi.chm::/Classes/StackPanel/StackPanel.IsContentResizable.htm)
		 Свойство IsContentResizable
		 определяет, доступно ли будет изменение размеров панелей компонента.


		 ![](../../Property_Image.gif)
		 [IsHorisontal](dhtmlUi.chm::/Classes/StackPanel/StackPanel.IsHorisontal.htm)
		 Свойство IsHorisontal
		 определяет, будут компоненты размещаться горизонтально или вертикально.


		 ![](../../Property_Image.gif)
		 [MinControlSize](dhtmlUi.chm::/Classes/StackPanel/StackPanel.MinControlSize.htm)
		 Свойство MinControlSize
		 определяет минимальный размер элемента в контейнере.


		 ![](../../Property_Image.gif)
		 [ScrollVisible](dhtmlUi.chm::/Classes/StackPanel/StackPanel.ScrollVisible.htm)
		 Свойство ScrollVisible
		 определяет признак видимости полос прокрутки.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [add](dhtmlUi.chm::/Classes/StackPanel/StackPanel.add.htm)
		 Метод add добавляет
		 элемент на панель.


		 ![](../../Sub_Image.gif)
		 [beginUpdate](dhtmlUi.chm::/Classes/StackPanel/StackPanel.beginUpdate.htm)
		 Метод beginUpdate прекращает
		 отрисовку компонента.


		 ![](../../Sub_Image.gif)
		 [endUpdate](dhtmlUi.chm::/Classes/StackPanel/StackPanel.endUpdate.htm)
		 Метод endUpdate возобновляет
		 отрисовку компонента.


		 ![](../../Sub_Image.gif)
		 [getItemByPoint](dhtmlUi.chm::/Classes/StackPanel/StackPanel.getItemByPoint.htm)
		 Метод getItemByPoint
		 возвращает элемент контейнера по заданным координатам.


		 ![](../../Sub_Image.gif)
		 [sendToItems](dhtmlUi.chm::/Classes/StackPanel/Constructor_StackPanel.htm)
		 Метод sendToItems
		 вызывает указанный метод для всех элементов компонента.


		 ![](../../Sub_Image.gif)
		 [supportAnchors](dhtmlUi.chm::/Classes/StackPanel/StackPanel.supportAnchors.htm)
		 Метод supportAnchors
		 возвращает признак поддержки якорей.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ItemSizeChanged](dhtmlUi.chm::/Classes/StackPanel/StackPanel.ItemSizeChanged.htm)
		 Событие ItemSizeChanged
		 наступает после изменения размера панели компонента StackPanel.


		 ![](../../Event_Image.gif)
		 [ItemSizeChanging](dhtmlUi.chm::/Classes/StackPanel/StackPanel.ItemSizeChanging.htm)
		 Событие ItemSizeChanging
		 наступает при изменении размеров панелей компонента StackPanel.


## Свойства, унаследованные от класса [Container](../../Classes/Container/Container.htm)
...
## Методы, унаследованные от класса [Container](../../Classes/Container/Container.htm)
