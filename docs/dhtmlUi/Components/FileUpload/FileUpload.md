...
Компонент FileUpload представляет
 поле ввода и кнопку для выбора файла, который будет загружен на сервер.


## Комментарии


Компонент реализован классом PP.Ui.[FileUpload](../../Classes/FileUpLoad/FileUpload.htm).


Реализована возможность при загрузке следующего файла отображать дополнительное
 поле ввода ([FileUpload.AutoExpandable](../../Classes/FileUpLoad/FileUpload.AutoExpandable.htm)).
...
![](../../Classes/FileUpLoad/FileUpload.png)


[Пример
 создания компонента FileUpload](../../Classes/FileUpLoad/Constructor_FileUpload.htm)
...
## Конструктор
			 ...
			 ![](../../Sub_Image.gif)
			 [FileUpload](dhtmlUi.chm::/Classes/FileUpLoad/Constructor_FileUpload.htm)
			 Конструктор FileUpload
			 создает экземпляр компонента FileUpload.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [AutoExpandable](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.AutoExpandable.htm)
		 Свойство AutoExpandable
		 определяет, будет ли при загрузке файла появляться дополнительное
		 поле.


		 ![](../../Property_Image.gif)
		 [FileButton](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.FileButton.htm)
		 Свойство FileButton
		 устанавливает настройки кнопки для выбора файла из файловой системы.


		 ![](../../Property_Image.gif)
		 [FileName](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.FileName.htm)
		 Свойство FileName содержит
		 имя последнего загруженного файла.


		 ![](../../Property_Image.gif)
		 [MaxInputsCount](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.MaxInputsCount.htm)
		 Свойство MaxInputsCount
		 устанавливает количество полей ввода для файлов.


		 ![](../../Property_Image.gif)
		 [PostUrl](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.PostUrl.htm)
		 Свойство PostUrl указывает
		 ссылку на обработчик, который будет обрабатывать загружаемый файл.
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [clearAllInputs](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.clearAllInputs.htm)
		 Метод clearAllInputs
		 осуществляет очистку всех загрузок.


		 ![](../../Sub_Image.gif)
		 [clearInput](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.clearInput.htm)
		 Метод clearInput очищает
		 загрузку по индексу.


		 ![](../../Sub_Image.gif)
		 [clearInputs](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.clearInputs.htm)
		 Метод clearInputs осуществляет
		 очистку полей ввода загрузчика.


		 ![](../../Sub_Image.gif)
		 [getBase64Image](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.getBase64Image.htm)
		 Метод getBase64Image
		 загружает изображение.


		 ![](../../Sub_Image.gif)
		 [getFiles](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.getFiles.htm)
		 Метод getFiles возвращает
		 массив загружаемых файлов.


		 ![](../../Sub_Image.gif)
		 [send](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.send.htm)
		 Метод send используется
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [FileInputChanged](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.FileInputChanged.htm)
		 Событие FileInputChanged
		 наступает при выборе файла, который будет загружен.


		 ![](../../Event_Image.gif)
		 [FileUploaded](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.FileUploaded.htm)
		 Событие FileUploaded
		 наступает после загрузки файла.


		 ![](../../Event_Image.gif)
		 [ValueChanged](dhtmlUi.chm::/Classes/FileUpLoad/FileUpload.ValueChanged.htm)
		 Событие ValueChanged
		 наступает после изменения значения загрузчика.
