...
Компонент LayoutBox представляет
 собой контейнер в виде таблицы для размещения элементов.


## Комментарии


Компонент реализован классом [LayoutBox](../../Classes/LayoutBox/LayoutBox.htm).
...
Пример создания контейнера в виде таблицы, описан на странице [«Пример
 создания компонента LayoutBox»](Example_LayoutBox.htm).
