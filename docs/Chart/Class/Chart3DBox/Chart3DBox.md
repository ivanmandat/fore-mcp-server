...
Класс Chart3DBox реализует свойства
 и события компонента [Chart3DBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/Chart3DBox.htm),
 который предназначен для отображения трехмерных сцен.


## Свойства объекта класса, унаследованные от [IChart3DBox](../../Interface/IChart3DBox/IChart3DBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IChart3DBox/IChart3DBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Scene](../../Interface/IChart3DBox/IChart3DBox.Scene.htm)
		 Свойство Scene возвращает
		 интерфейс, реализующий свойства и методы трехмерной сцены.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnSeriesDoubleClick](IChart3DBoxEvents.OnSeriesDoubleClick.htm)
