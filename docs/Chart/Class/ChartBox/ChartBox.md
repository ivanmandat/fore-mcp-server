...
Класс ChartBox реализует свойства
 и события компонента [ChartBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ChartBox.htm),
 который предназначен для отображения диаграмм.


## Свойства объекта класса, унаследованные от [IChartBox](../../Interface/IChartBox/IChartBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IChartBox/IChartBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Chart](../../Interface/IChartBox/IChartBox.Chart.htm)
		 Свойство Chart определяет
		 диаграмму, отображаемую в компоненте [ChartBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ChartBox.htm).


		 ![](../../Property_Image.gif)
		 [Source](../../Interface/IChartBox/IChartBox.Source.htm)
		 Свойство Source определяет
		 источник данных для компонента [ChartBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ChartBox.htm).
...
## Свойства объекта класса, унаследованные от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
		 ...
		 Свойство PopupMenu
		 определяет контекстное меню, которое будет появляться при нажатии
		 на компонент.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnSerieClick](ChartBox.OnSerieClick.htm)
		 Событие OnSerieClick
		 наступает при щелчке кнопкой мыши по ряду диаграммы.
