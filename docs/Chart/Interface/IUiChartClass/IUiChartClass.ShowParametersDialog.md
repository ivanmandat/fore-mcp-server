# IUiChartClass.ShowParametersDialog
...
ShowParametersDialog(Chart: [IChart](../IChart/IChart.htm); Parent: [IWin32Window](ModForms.chm::/Interface/IWin32Window/IWin32Window.htm));
...
Метод ShowParametersDialog вызывает окно «Параметры диаграммы» для указанной диаграммы.
...
Данный пример является макросом для регламентного отчета. При выполнении макроса будет выведен диалог «Параметры диаграммы» для указанной диаграммы.
