...
ViewPoint: [IScene3DViewPoint](../IScene3DViewPoint/IScene3DViewPoint.htm);


## Описание


Свойство ViewPoint определяет
 положение камеры. Работа с доступными параметрами осуществляется посредством
 интерфейса IScene3DViewPoint.
