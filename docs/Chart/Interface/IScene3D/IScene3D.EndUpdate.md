...
Метод EndUpdate снимает установленный
 запрет на обновление сцены. Установка запрета осуществляется методом [IScene3D.BeginUpdate](IScene3D.BeginUpdate.htm).
