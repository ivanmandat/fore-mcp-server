...
Интерфейс IChartBox определяет
 параметры компонента [ChartBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ChartBox.htm),
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IChartBox.BorderStyle.htm)
