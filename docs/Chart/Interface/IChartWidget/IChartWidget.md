...
Интерфейс IChartWidget используется
 для работы с базовыми свойствами компонента ChartWidget.
...
## Иерархия наследования
 ...
           [IWidget](ModForms.chm::/Interface/IWidget/IWidget.htm)
...
Для активации компонента ChartWidget
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Source](IChartWidget.Source.htm)


		 Свойство Source
		 определяет источник данных для компонента ChartWidget.


## Свойства, унаследованные от [IWidget](ModForms.chm::/Interface/IWidget/IWidget.htm)
...
[Интерфейсы
 сборки Chart](../Interface_build_Chart.htm)
