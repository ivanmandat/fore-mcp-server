...
Интерфейс IChart3DBox содержит
 свойства и методы для определения параметров трехмерной сцены.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IChart3DBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Scene](IChart3DBox.Scene.htm)
