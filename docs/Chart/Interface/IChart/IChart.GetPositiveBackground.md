...
GetPositiveBackground: [IChartBackgroundInfo](../IChartBackgroundInfo/IChartBackgroundInfo.htm);


## Описание


Метод GetPositiveBackground
 возвращает цвет заливки положительных столбцов диаграммы.
...
При нажатии на кнопку для компонента Panel будет установлен цвет положительных
