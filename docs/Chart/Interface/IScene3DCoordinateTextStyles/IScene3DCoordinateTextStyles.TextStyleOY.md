# IScene3DCoordinateTextStyles.TextStyleOY
...
TextStyleOY: [IScene3DTextStyle](../IScene3DTextStyle/IScene3DTextStyle.htm);


## Описание


Свойство TextStyleOY определяет
 стиль надписей для оси OY.
...
После выполнения примера цвет надписей по оси OY будет изменен на синий.
