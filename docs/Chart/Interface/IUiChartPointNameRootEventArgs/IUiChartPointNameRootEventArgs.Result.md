...
Result: [IChartPointNameNode](../IChartPointNameNode/IChartPointNameNode.htm);


## Описание


Свойство Result определяет корневой
 элемент для иерархии наименований оси категорий.
...
В рассматриваемом примере предполагается существование объекта UiChart1 типа UiChart.
 [Описание класса
 CChartPointNameNode](../IChartPointNameNode/CChartPointNameNode.htm) приведено в интерфейсе [IChartPointNameNode](../IChartPointNameNode/IChartPointNameNode.htm).
...
[IUiChartPointNameRootEventArgs](IUiChartPointNameRootEventArgs.htm)
