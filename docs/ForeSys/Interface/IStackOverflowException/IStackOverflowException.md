...
Интерфейс IStackOverflowException
 содержит свойства исключительной ситуации, возникающей при переполнении
 стека.
...
Ошибка переполнения стека возникает, когда в стеке выполнения содержится
 слишком большое количество вызовов методов, ожидающих утверждения, обычно
 в случае очень глубокой или безграничной рекурсии.
