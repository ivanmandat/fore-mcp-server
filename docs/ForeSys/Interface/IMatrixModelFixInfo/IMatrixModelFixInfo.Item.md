...
DimIndex. Номер измерения,
 по которому необходимо установить фиксацию.


## Описание


Свойство Item определяет индекс
 элемента, по которому необходимо зафиксировать измерение с номером DimIndex.
...
После выполнения примера будет сгенерирована матрица
 случайных чисел размером 3х3х3. На базе данной матрицы будет получено
...
[IMatrixModelFixInfo](IMatrixModelFixInfo.htm)
