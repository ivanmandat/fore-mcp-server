...
TryParseDateTime(Value: String; Var: Result: DateTime):
 Boolean;
...
Метод TryParseDateTime осуществляет
 проверку на возможность преобразования указанного значения к формату даты
 со временем в соответствии с настройками региональных стандартов.
...
После выполнения примера в переменной «D» будет содержаться дата и время
 «25.07.2007 12:12:12», а в переменной «B» будет содержаться признак удачного
 преобразования.
