...
Интерфейс IArgumentNullException
 содержит свойства исключительной ситуации, возникающей при попытке передать
 нулевое значение (Null) свойству (методу), который не принимает его в
 качестве допустимого значения.


## Свойства, унаследованные от [IArgumentException](../IArgumentException/IArgumentException.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ParamName](../IArgumentException/IArgumentException.ParamName.htm)
