...
Класс ChartAreaFill представляет
 собой прямоугольную область заливки.
...
Пример прямоугольной области заливки:
...
PP.initClass(PP.Ui.ChartAreaFill, [PP.Ui.BubbleChartObject](../BubbleChartObject/BubbleChartObject.htm),
 "PP.Ui.ChartAreaFill");
