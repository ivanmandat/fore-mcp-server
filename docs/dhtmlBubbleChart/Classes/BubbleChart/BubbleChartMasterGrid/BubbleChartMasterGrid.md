...
Класс BubbleChartMasterGrid
 реализует вкладку для работы с осями X/Y в мастере для настройки
...
Для получения данной панели в запущенном веб-приложении включите пузырьковую
 диаграмму и выполните в консоли следующий код:


// Получим отчет
reportBox = PP.App.getModuleObject().getReportBox();
// Получим боковую панель управления
panel = reportBox.getPropertyBarView()
// Получим мастер пузырьковой диаграммы
bubbleMaster = panel.getBubbleChartMaster()
// Получим нужную вкладку
bubbleMaster.getItem(PP.Ui.BubbleChartMasterGrid);
// -> PP.Ui.BubbleChartMasterGrid {_ImagePath: "../build/img/", _AxisType: "X", _manualTextInitialized: false, _GroupName: "", _Events: Object…}

## Синтаксис


PP.initClass(PP.Ui.BubbleChartMasterGrid, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.BubbleChartMasterGrid");
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 BubbleChartMasterGrid
			 Конструктор BubbleChartMasterGrid
			 создает экземпляр класса BubbleChartMasterGrid.
