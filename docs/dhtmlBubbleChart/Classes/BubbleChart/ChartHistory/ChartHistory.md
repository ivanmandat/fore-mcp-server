...
Класс **ChartHistory** реализует
 отображение истории значений пузырьков [пузырьковой диаграммы](../../../Components/BubbleChart/BubbleChart.htm).


## Синтаксис


PP.initClass(PP.Ui.ChartHistory, [PP.Ui.BubbleChartObject](../BubbleChartObject/BubbleChartObject.htm),
 "PP.Ui.ChartHistory");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ChartHistory](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartHistory/Constructor_ChartHistory.htm)
		 Конструктор ChartHistory
		 создает экземпляр класса ChartHistory.
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [Point](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartHistory/ChartHistory.Point.htm)
		 Свойство **Point**
		 устанавливает точку ряда данных пузырьковой диаграммы, для которой необходимо
		 отобразить историю значений данного ряда.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [animate](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartHistory/ChartHistory.animate.htm)
		 Метод **animate**
		 рассчитывает положение истории значений пузырька на заданном шаге
		 анимации.


		 ![](../../../sub_image.gif)
		 [getPointUnderMouse](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartHistory/ChartHistory.getPointUnderMouse.htm)
		 Метод getPointUnderMouse
		 проверяет существование истории пузырька в заданной точке.


		 ![](../../../sub_image.gif)
		 [setIsRTL](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartHistory/ChartHistory.setIsRTL.htm)
