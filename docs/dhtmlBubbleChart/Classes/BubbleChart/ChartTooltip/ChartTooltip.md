...
[ChartLabel](dhtmlChart.chm::/Classes/ChartLabel/ChartLabel.htm)


[ChartTooltipBase](../ChartTooltipBase/ChartTooltipBase.htm)
...
Класс **ChartTooltip** представляет
 собой всплывающую подсказку в [пузырьковой
 диаграмме](../../../Components/BubbleChart/BubbleChart.htm).
...
PP.initClass(PP.Ui.ChartTooltip, [PP.Ui.ChartTooltipBase](../ChartTooltipBase/ChartTooltipBase.htm),
 "PP.Ui.ChartTooltip");
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 [ChartTooltip](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltip/Constructor_ChartTooltip.htm)
			 Конструктор ChartTooltip
			 создает экземпляр класса ChartTooltip.
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [HasMask](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltip/ChartTooltip.HasMask.htm)
		 Свойство HasMask
		 определяет, формируется ли текст всплывающей подсказки по шаблону.


## Свойства, унаследованные от [ChartTooltipBase](../ChartTooltipBase/ChartTooltipBase.htm)
		 ...
		 ![](../../../property_image.gif)
		 [HoverMode](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.HoverMode.htm)
		 Свойство HoverMode
		 определяет метод отображения всплывающей подсказки.


		 ![](../../../property_image.gif)
		 [TargetX](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.TargetX.htm)
		 Свойство TargetX
		 определяет координату X точки привязки всплывающей подсказки.


		 ![](../../../property_image.gif)
		 [TargetY](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.TargetY.htm)
		 Свойство TargetY определяет
		 координату Y точки привязки всплывающей подсказки.


## Методы, унаследованные от [ChartTooltipBase](../ChartTooltipBase/ChartTooltipBase.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [setPosition](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/ChartTooltipBase.setPosition.htm)
		 Метод setPosition
		 устанавливает новую позицию всплывающей подсказки.


## Свойства, унаследованные от класса [ChartLabel](dhtmlChart.chm::/Classes/ChartLabel/ChartLabel.htm)
		 ...
		 ![](../../../property_image.gif)
		 [Alignment](dhtmlChart.chm::/Classes\ChartLabel\ChartLabel.Alignment.htm)
		 Свойство **Alignment**
		 определяет выравнивание метки.


		 ![](../../../property_image.gif)
		 [Direction](dhtmlChart.chm::/Classes\ChartLabel\ChartLabel.Direction.htm)
		 Свойство **Direction**
		 определяет направление текста метки.


		 ![](../../../property_image.gif)
		 [MaskText](dhtmlChart.chm::/Classes\ChartLabel\ChartLabel.MaskText.htm)
		 Свойство **MaskText**
		 определяет маску текста метки.


		 ![](../../../property_image.gif)
		 [NoDataText](dhtmlChart.chm::/Classes\ChartLabel\ChartLabel.NoDataText.htm)
		 Свойство **NoDataText**
		 определяет текст, отображаемый меткой при отсутствии в ней текстового
		 содержимого.


		 ![](../../../property_image.gif)
		 [ShowHandCursor](dhtmlChart.chm::/Classes\ChartLabel\ChartLabel.ShowHandCursor.htm)
		 Свойство **ShowHandCursor**
		 определяет признак отображения курсора «Рука» при его наведении
		 на метку.


		 ![](../../../property_image.gif)
		 [Text](dhtmlChart.chm::/Classes\ChartLabel\ChartLabel.text.htm)
		 Свойство **Text** определяет текстовое содержимое метки.


		 ![](../../../property_image.gif)
		 [TextWrapping](dhtmlChart.chm::/Classes\ChartLabel\ChartLabel.TextWrapping.htm)
		 Свойство **TextWrapping**
		 определяет признак переноса текста метки.
