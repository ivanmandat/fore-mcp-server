...
Класс BubbleChartMasterTooltips
 реализует страницу «Подсказки» в мастере для настройки пузырьковой диаграммы.


## Комментарии


Страница «Подсказки» в мастере для настройки пузырьковой диаграммы выглядит
 следующим образом:
...
PP.initClass(PP.Ui.BubbleChartMasterTooltips, PP.Ui.VisualizerMasterTooltipsPanel,
 "PP.Ui.BubbleChartMasterTooltips");
...
## Конструктор
			 ...
			 ![](../../../sub_image.gif)
			 BubbleChartMasterTooltips
			 Конструктор BubbleChartMasterTooltips
			 создает экземпляр класса BubbleChartMasterTooltips.
