...
Класс **ChartSVGLabel** представляет
 SVG-метку [пузырьковой диаграммы](../../../Components/BubbleChart/BubbleChart.htm).


## Синтаксис


PP.initClass(PP.Ui.ChartSVGLabel, [PP.Ui.ChartLabel](dhtmlChart.chm::/Classes/ChartLabel/ChartLabel.htm),
 "PP.Ui.ChartSVGLabel");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ChartSVGLabel](dhtmlBubbleChart.chm::/Classes\BubbleChart\ChartSVGLabel\Constructor_ChartSVGLabel.htm)
		 Конструктор ChartSVGLabel
		 создает экземпляр класса ChartSVGLabel.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [setPosition](dhtmlBubbleChart.chm::/Classes\BubbleChart\ChartSVGLabel\ChartSVGLabel.setPosition.htm)
		 Метод setPosition
		 устанавливает новое положение текстовой метки SVG-элемента пузырьковой диаграммы.
