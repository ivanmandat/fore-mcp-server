...
Класс ChartTooltipBase представляет
 собой базовый класс всплывающей подсказки.


## Синтаксис


PP.initClass(PP.Ui.ChartTooltipBase, [PP.Ui.ChartLabel](dhtmlChart.chm::/Classes/ChartLabel/ChartLabel.htm),
 "PP.Ui.ChartTooltipBase");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ChartTooltipBase](dhtmlBubbleChart.chm::/Classes/BubbleChart/ChartTooltipBase/Constructor_ChartTooltipBase.htm)
		 Конструктор ChartTooltipBase
		 создает экземпляр класса ChartTooltipBase.
