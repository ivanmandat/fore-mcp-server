...
Класс ReportBox предоставляет
 компонент среды разработки, позволяющий отображать данные регламентных
 отчетов.


## Свойства, унаследованные от [IReportBox](../../Interface/IReportBox/IReportBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IReportBox/IReportBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ControlPanelAllowed](../../Interface/IReportBox/IReportBox.ControlPanelAllowed.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayNumericColumnNames](../../Interface/IReportBox/IReportBox.DisplayNumericColumnNames.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DisplayTabs](../../Interface/IReportBox/IReportBox.DisplayTabs.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Report](../../Interface/IReportBox/IReportBox.Report.htm)


		 Свойство Report определяет
		 компонент [UiReport](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiReport.htm),
...
## Методы, унаследованные от [IReportBox](../../Interface/IReportBox/IReportBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ClientToTab](../../Interface/IReportBox/IReportBox.ClientToTab.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [FindReplaceEx](../../Interface/IReportBox/IReportBox.FindReplaceEx.htm)


		 Метод FindReplaceEx
		 вызывает окно поиска/замены в регламентном отчете.


		 ![](../../Sub_Image.gif)
		 [ShowBasicDataDialog](../../Interface/IReportBox/IReportBox.ShowBasicDataDialog.htm)


		 Метод ShowBasicDataDialog
		 вызывает окно «Исходные
		 данные» для выбранной диаграммы регламентного отчета.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnAfterDeleteRange](ReportBox.OnAfterDeleteRange.htm)


		 Событие OnAfterDeleteRange
		 наступает после удаления диапазонов/строк/столбцов.


		 ![](../../Event_Image.gif)
		 [OnAfterEdit](ReportBox.OnAfterEdit.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnAfterInsertRange](ReportBox.OnAfterInsertRange.htm)


		 Событие OnAfterInsertRange
		 наступает после добавления диапазонов/строк/столбцов.


		 ![](../../Event_Image.gif)
		 [OnAfterObjectChange](ReportBox.OnAfterObjectChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnAutoFilter](ReportBox.OnAutoFilter.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeCellChange](ReportBox.OnBeforeCellChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeColumnResize](ReportBox.OnBeforeColumnResize.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeDeleteRange](ReportBox.OnBeforeDeleteRange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeEdit](ReportBox.OnBeforeEdit.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeExpanderChanged](ReportBox.OnBeforeExpanderChanged.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeInsertRange](ReportBox.OnBeforeInsertRange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeObjectChange](ReportBox.OnBeforeObjectChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeforeRowResize](ReportBox.OnBeforeRowResize.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnBeginInteractiveSelectionChange](ReportBox.OnBeginInteractiveSelectionChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnCellChange](ReportBox.OnCellChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnCellClick](ReportBox.OnCellClick.htm)
		 ...
		 наступает при щелчке кнопки мыши по рисунку, расположенному
		 в ячейке таблицы.


		 ![](../../Event_Image.gif)
		 [OnChangeCellContent](ReportBox.OnChangeCellContent.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnColumnClick](ReportBox.OnColumnClick.htm)


		 Событие OnColumnClick
		 наступает при щелчке кнопки мыши по заголовку одного
		 из столбцов таблицы.


		 ![](../../Event_Image.gif)
		 [OnColumnResize](ReportBox.OnColumnResize.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnColumnResizing](ReportBox.OnColumnResizing.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnEditorTextChanged](ReportBox.OnEditorTextChanged.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnEndInteractiveSelectionChange](ReportBox.OnEndInteractiveSelectionChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnExpanderChanged](ReportBox.OnExpanderChanged.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnHyperlinkClick](ReportBox.OnHyperlinkClick.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnInteractiveSelectionChange](ReportBox.OnInteractiveSelectionChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnObjectActivate](ReportBox.OnObjectActivate.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnObjectMoving](ReportBox.OnObjectMoving.htm)


		 Событие OnObjectMoving
		 наступает во время перемещения объекта.


		 ![](../../Event_Image.gif)
		 [OnObjectResizing](ReportBox.OnObjectResizing.htm)


		 Событие OnObjectResizing
		 наступает во время изменения размеров объекта.


		 ![](../../Event_Image.gif)
		 [OnRowClick](ReportBox.OnRowClick.htm)


		 Событие OnRowClick
		 наступает при щелчке кнопки мыши по заголовку одной из
		 строк таблицы.


		 ![](../../Event_Image.gif)
		 [OnRowResize](ReportBox.OnRowResize.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnRowResizing](ReportBox.OnRowResizing.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnScaleChange](ReportBox.OnScaleChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnSelectionChange](ReportBox.OnSelectionChange.htm)
		 ...
		 ![](../../Event_Image.gif)
		 [OnTableClick](ReportBox.OnTableClick.htm)


		 Событие OnTableClick
		 наступает при щелчке кнопки мыши по области, расположенной
		 на пересечении заголовков строк и столбцов, осуществляющей выделение
		 всей таблицы.
