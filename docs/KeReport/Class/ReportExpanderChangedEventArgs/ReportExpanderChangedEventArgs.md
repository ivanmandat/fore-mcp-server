...
Класс ReportExpanderChangedEventArgs
 реализует аргумент события, наступающего при изменении состояния экспандера
 в ячейке таблицы.
...
## Конструкторы
		 ...
		 ![](../../Sub_Image.gif)
		 [CreateReportExpanderArgs](ReportExpanderChangedEventArgs.CreateReportExpanderArgs.htm)
		 Конструктор CreateReportExpanderArgs
		 создает аргумент события, наступающего при изменении состояния
...
## Свойства объекта класса, унаследованные от [IReportExpanderChangedEventArgs](../../Interface/IReportExpanderChangedEventArgs/IReportExpanderChangedEventArgs.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [State](../../Interface/IReportExpanderChangedEventArgs/IReportExpanderChangedEventArgs.State.htm)
