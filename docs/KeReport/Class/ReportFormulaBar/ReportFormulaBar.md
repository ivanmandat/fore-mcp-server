...
Класс ReportFormulaBar предназначен
 для работы с компонентом среды разработки [ReportFormulaBar](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ReportFormulaBar.htm).


## Комментарии


Строка формул используется для
 ввода или изменения значений/формул в ячейках.


## Свойства класса, унаследованные от [IReportFormulaBar](../../Interface/IReportFormulaBar/IReportFormulaBar.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Report](../../Interface/IReportFormulaBar/IReportFormulaBar.Report.htm)
		 Свойство Report определяет
		 компонент среды разработки [UiReport](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiReport.htm),
		 который будет использоваться как источник данных.


## Свойства, унаследованные от [IUiBar](ModForms.chm::/Interface/IUiBar/IUiBar.htm)
...
## Методы, унаследованные от [IUiBar](ModForms.chm::/Interface/IUiBar/IUiBar.htm)
...
## Методы класса, унаследованные от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
...
## События объекта класса ReportFormulaBar
		 ...
		 ![](../../Event_Image.gif)
		 [OnGetDataAreaHint](ReportFormulaBar.OnGetDataAreaHint.htm)
		 Событие OnGetDataAreaHint
		 наступает при изменении типа метаданных содержимого ячейки.
