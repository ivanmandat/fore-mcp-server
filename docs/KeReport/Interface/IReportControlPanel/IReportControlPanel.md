...
Интерфейс IReportControlPanel
 содержит свойства и методы компонента среды разработки - [ReportControlPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ReportControlPanel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IReportControlPanel.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет вид (стиль) границы компонента [ReportControlPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ReportControlPanel.htm).


		 ![](../../Property_Image.gif)
		 [Object](IReportControlPanel.Object.htm)
		 Свойство Object определяет
		 компонент [UiReport](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/UiReport.htm), который
		 будет использоваться в качестве источника данных для компонента
		 ...
		 ![](../../Property_Image.gif)
		 [Orientation](IReportControlPanel.Orientation.htm)
		 Свойство Orientation
		 определяет вариант расположения элементов управления на компоненте
		 среды разработки [ReportControlPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ReportControlPanel.htm).


		 ![](../../Property_Image.gif)
		 [Report](IReportControlPanel.Report.htm)
		 Свойство Report определяет
		 регламентный отчет, реализуемый интерфейсом [IPrxReport](../IPrxReport/IPrxReport.htm).
