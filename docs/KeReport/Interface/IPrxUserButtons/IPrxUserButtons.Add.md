...
Add(Key: Integer; Id: String; Name: String: [Type:
 [PrxUserButtonType](../../Enums/PrxUserButtonType.htm) = 0]):
...
Key. Ключ создаваемой пользовательской
 кнопки.


Id. Идентификатор создаваемой
...
Метод Add создаёт пользовательскую
 кнопку с заданным описанием и типом.
...
При выполнении примера в регламентном отчёте будет создана пользовательская
 кнопка. Для кнопки будут заданы описание, изображение и обработчики всех
 действий. В качестве обработчиков выступают Fore-методы.
