...
Интерфейс IReportObjectMovingEventArgs
...
Данный аргумент используется при обработке следующих событий:
	...
	- [ReportBox.OnObjectMoving](../../Class/ReportBox/ReportBox.OnObjectMoving.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Cancel](IReportObjectMovingEventArgs.Cancel.htm)
		 Свойство Cancel определяет,
		 отменять ли перемещение объекта.


		 ![](../../Property_Image.gif)
		 [Object](IReportObjectMovingEventArgs.Object.htm)
		 Свойство Object возвращает
		 изменяемый объект.


		 ![](../../Property_Image.gif)
		 [Rect](IReportObjectMovingEventArgs.Rect.htm)
