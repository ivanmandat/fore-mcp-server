...
EventOnAfterAddDataIsland(Args: [IUiPrxDataIslandEventArgs](../IUiPrxDataIslandEventArgs/IUiPrxDataIslandEventArgs.htm));
...
Метод EventOnAfterAddDataIsland
 реализует событие, которое наступает после добавления области данных.


## Комментарии


Метод предназначен для работы с [областью
