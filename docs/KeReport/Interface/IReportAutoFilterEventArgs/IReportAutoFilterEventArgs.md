...
Интерфейс IReportAutoFilterEventArgs
 содержит свойства аргумента события, возникающего при установке автофильтра
 на листе регламентного отчета: [ReportBox.OnAutoFilter](../../Class/ReportBox/ReportBox.OnAutoFilter.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Action](IReportAutoFilterEventArgs.Action.htm)
		 Свойство Action возвращает
		 тип выбранного условия автофильтра.
