# IPrxReportRecalcContext.ParamValuesChanged
...
ParamValuesChanged: [TriState](ForeSys.chm::/Enums/TriState.htm);


## Описание


Свойство ParamValuesChanged
 определяет, изменились ли значения параметров.
