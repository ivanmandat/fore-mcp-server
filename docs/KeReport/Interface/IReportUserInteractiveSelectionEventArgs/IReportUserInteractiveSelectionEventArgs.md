...
Интерфейс IReportUserInteractiveSelectionEventArgs
 содержит свойства аргумента событий, наступающих перед и после изменением
 интерактивного диапазона ячеек в компоненте ReportBox.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Selection](IReportUserInteractiveSelectionEventArgs.Selection.htm)
		 Свойство Selection
		 возвращает настройки интерактивного диапазонов ячеек.


		 ![](../../Property_Image.gif)
		 [Type](IReportUserInteractiveSelectionEventArgs.Type.htm)
