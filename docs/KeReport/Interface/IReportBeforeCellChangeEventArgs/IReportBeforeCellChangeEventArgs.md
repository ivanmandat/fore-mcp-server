...
Интерфейс IReportBeforeCellChangeEventArgs
 содержит свойства аргумента события, наступающего непосредственно перед
 изменением значения в ячейке: [ReportBox.OnBeforeCellChange](../../Class/ReportBox/ReportBox.OnBeforeCellChange.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Value](IReportBeforeCellChangeEventArgs.Value.htm)
