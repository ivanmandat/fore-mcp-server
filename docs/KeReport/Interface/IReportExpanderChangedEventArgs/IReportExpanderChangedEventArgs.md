...
Интерфейс IReportExpanderChangedEventArgs
...
Данный аргумент используется при обработке следующих событий:
	...
	- [OnExpanderChanged](../../Class/ReportBox/ReportBox.OnExpanderChanged.htm)
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [State](IReportExpanderChangedEventArgs.State.htm)
