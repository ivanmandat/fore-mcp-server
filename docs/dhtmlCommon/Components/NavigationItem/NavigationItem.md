...
Компонент NavigationItem представляет
 собой дочерний элемент компонента [NavigationBar](../NavigationBar/NavigationBar.htm),
 вкладку, которая состоит из заголовка и раскрывающейся панели.


Панель раскрывается при нажатии на заголовок. Для заголовка [может
 быть установлен элемент управления](../../Classes/NavigationItem/NavigationItem.HeaderControl.htm). По умолчанию установлен компонент
 [CheckBox](dhtmlUi.chm::/Classes/CheckBox/CheckBox.htm).
 Этот элемент управления по желанию [может
 быть скрыт](../../Classes/NavigationItem/NavigationItem.IsHeaderControlVisible.htm).


В компоненте реализованы события, наступающие при [сворачивании](../../Classes/NavigationItem/NavigationItem.Collapsing.htm)
 и [разворачивании](../../Classes/NavigationItem/NavigationItem.Expanding.htm)
 панели. [Содержимое](dhtmlUi.chm::/Classes/Control/Control.Content.htm)
 панели является произвольным.


## Комментарии


Компонент реализован классом [NavigationItem](../../Classes/NavigationItem/NavigationItem.htm).


## Пример


Пример создания компонента приведен на странице «[Пример
 создания компонента NavigationBar](../NavigationBar/Example_NavigationBar.htm)».
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [NavigationItem](dhtmlCommon.chm::/classes/navigationitem/constructor_navigationitem.htm)
		 Конструктор NavigationItem
		 создает экземпляр компонента NavigationItem.
