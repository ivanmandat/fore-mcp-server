...
Класс NavigationItem реализует
 компонент [NavigationItem](../../Components/NavigationItem/NavigationItem.htm),
 представляющий собой дочерний элемент компонента [NavigationBar](../../Components/NavigationBar/NavigationBar.htm)
 - вкладку с раскрывающейся панелью.


## Синтаксис


PP.initClass(PP.Ui.NavigationItem, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "NavigationItem");
