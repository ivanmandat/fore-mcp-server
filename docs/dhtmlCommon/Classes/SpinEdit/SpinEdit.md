...
## Иерархия наследования
 ...
           [TextBox](dhtmlUi.chm::/Classes/TextBox/TextBox.htm)
...
Класс SpinEdit реализует компонент
 [SpinEdit](dhtmlUi.chm::/components/spinedit/spinedit.htm),
 представляющий собой редактор с кнопками прокрутки.


## Комментарии


Параметры обработчиков событий компонента [SpinEdit](dhtmlUi.chm::/components/spinedit/spinedit.htm)
 реализованы классом [SpinEventArgs](../SpinEventArgs/SpinEventArgs.htm).
...
## Свойства, унаследованные от класса [TextBox](dhtmlUi.chm::/Classes/TextBox/TextBox.htm)
...
## Методы, унаследованные от класса [TextBox](dhtmlUi.chm::/Classes/TextBox/TextBox.htm)
...
## События, унаследованные от класса [TextBox](dhtmlUi.chm::/Classes/TextBox/TextBox.htm)
