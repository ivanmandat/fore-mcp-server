...
addBezierCurve(p0x: Number, p0y: Number, p1x: Number,
 p1y: Number, p2x: Number, p2y: Number, p3x: Number, p3y: Number);
...
p3x. Координата x четвертой
 точки;


p3y. Координата y четвертой
 точки.
...
Метод addBezierCurve растягивает
 прямоугольник при добавлении в него кубической кривой Безье.
...
Добавим кубическую кривую Безье, которая строится по 4 точкам со следующими
 координатами: (10, 20), (20, 10), (20, 20), (30, 10):
