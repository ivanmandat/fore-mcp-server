...
[PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm)


[PP.Ui.DropPanel](dhtmlUi.chm::/Classes/DropPanel/DropPanel.htm)


[PP.Ui.Window](dhtmlUi.chm::/Classes/Window/Window.htm)
...
Класс WelcomeScreen реализует
 окно приветствия, отображаемое после входа в веб-приложение.


## Комментарии


[Пример создания](WelcomeScreen_Example.htm) окна приветствия.


## Синтаксис


PP.initClass(PP.Ui.WelcomeScreen, [PP.Ui.Window](dhtmlUi.chm::/Classes/Window/Window.htm),
 "PP.Ui.WelcomeScreen");
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [addAction](WelcomeScreen.addAction.htm)
		 Метод addAction добавляет
		 элемент в список действий в окне приветствия.


		 ![](../../Sub_Image.gif)
		 [addActions](WelcomeScreen.addActions.htm)
		 Метод addAction добавляет
		 элементы в список действий в окне приветствия.


		 ![](../../Sub_Image.gif)
		 [addLastDocument](WelcomeScreen.addLastDocument.htm)
		 Метод addLastDocument
		 добавляет элемент в список последних открытых объектов в окне
		 приветствия.


		 ![](../../Sub_Image.gif)
		 [addLastDocuments](WelcomeScreen.addLastDocuments.htm)
		 Метод addLastDocuments
		 добавляет элементы в список последних открытых объектов в окне
		 приветствия.


		 ![](../../Sub_Image.gif)
		 [addToolItem](WelcomeScreen.addToolItem.htm)
		 Метод addToolItem добавляет
		 элемент в список инструментов в окне приветствия.


		 ![](../../Sub_Image.gif)
		 [addToolItems](WelcomeScreen.addToolItems.htm)
		 Метод addToolItems
		 добавляет элементы в список инструментов в окне приветствия.


		 ![](../../Sub_Image.gif)
		 [getMaxActions](WelcomeScreen.getMaxActions.htm)
		 Метод getMaxActions
		 возвращает максимальное количество действий в списке в окне приветствия.


		 ![](../../Sub_Image.gif)
		 [getMaxDocuments](WelcomeScreen.getMaxDocuments.htm)
		 Метод getMaxDocuments
		 возвращает максимальное количество документов в списке последних
		 документов в окне приветствия.


		 ![](../../Sub_Image.gif)
		 [showCenter](WelcomeScreen.showCenter.htm)
		 Метод showCenter отрисовывает
		 окно приветствия по центру страницы.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [ActionSelected](WelcomeScreen.ActionSelected.htm)
		 Событие ActionSelected
		 наступает после выбора действия в окне приветствия.


		 ![](../../Event_Image.gif)
		 [DocumentSelected](WelcomeScreen.DocumentSelected.htm)
		 Событие DocumentSelected
		 наступает после выбора последнего открытого документа в окне приветствия.


		 ![](../../Event_Image.gif)
		 [Exit](WelcomeScreen.Exit.htm)
		 Событие Exit наступает
		 при выходе из окна приветствия.


		 ![](../../Event_Image.gif)
		 [ToolChanged](WelcomeScreen.ToolChanged.htm)
		 Событие ToolChanged
		 наступает после смены инструмента в окне приветствия.


		 ![](../../Event_Image.gif)
		 [ToolSelected](WelcomeScreen.ToolSelected.htm)
		 Событие ToolSelected
		 наступает после повторного выбора инструмента в окне приветствия.
