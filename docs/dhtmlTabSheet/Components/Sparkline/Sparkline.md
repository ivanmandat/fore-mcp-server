...
Компонент Sparkline представляет
 собой небольшую диаграмму, которая располагается в отдельной ячейке таблицы
 и предназначена для отображения данных строк или столбцов таблицы.


## Комментарии


Компонент реализован классом [Sparkline](../../Classes/Sparkline/Sparkline.htm).
...
Пример создания спарклайн-графика описан на странице «[Пример
 создания компонента Sparkline](Example_Sparkline.htm)».
...
## Конструктор
		 ...
		 ![](../../Sub_Image.gif)
		 [Sparkline](dhtmlTabSheet.chm::/Classes/Sparkline/Constructor_Sparkline.htm)
		 Конструктор Sparkline
		 создает экземпляр компонента [Sparkline](dhtmlTabSheet.chm::/Components/Sparkline/Sparkline.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BackgroundColor](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.BackgroundColor.htm)
		 Свойство BackgroundColor
		 определяет цвет фона спарклайна.


		 ![](../../Property_Image.gif)
		 [FillColor](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.FillColor.htm)
		 Свойство FillColor
		 определяет цвет заливки столбцов спарклайна.


		 ![](../../Property_Image.gif)
		 [LineColor](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.LineColor.htm)
		 Свойство LineColor
		 определяет цвет линии спарклайна.


		 ![](../../Property_Image.gif)
		 [LineThickness](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.LineThickness.htm)
		 Свойство LineThickness
		 определяет толщину линии спарклайна.


		 ![](../../Property_Image.gif)
		 [Padding](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.Padding.htm)
		 Свойство Padding определяет
		 величину отступа по краям спарклайна.


		 ![](../../Property_Image.gif)
		 [StrokeColor](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.StrokeColor.htm)
		 Свойство StrokeColor
		 определяет цвет границ столбцов спарклайна.


		 ![](../../Property_Image.gif)
		 [StrokeThickness](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.StrokeThickness.htm)
		 Свойство StrokeThickness
		 определяет толщину границ столбцов спарклайна.


		 ![](../../Property_Image.gif)
		 [UsePeakValuesToColumns](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.UsePeakValuesToColumns.htm)
		 Свойство UsePeakValuesToColumns
		 определяет отрисовку столбцов спарклайна.


		 ![](../../Property_Image.gif)
		 [Values](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.Values.htm)
		 Свойство Values определяет
		 массив значений спарклайна.


		 ![](../../Property_Image.gif)
		 [ViewMode](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.ViewMode.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [beginUpdate](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.beginUpdate.htm)
		 Метод beginUpdate отключает
		 перерисовку спарклайна, пока не будет вызван метод [endUpdate](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.endUpdate.htm).


		 ![](../../Sub_Image.gif)
		 [draw](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.draw.htm)
		 Метод draw отрисовывает
		 спарклайн.


		 ![](../../Sub_Image.gif)
		 [endUpdate](dhtmlTabSheet.chm::/Classes/Sparkline/Sparkline.endUpdate.htm)
		 Метод endUpdate включает
		 перерисовку спарклайна и обновляет его.
