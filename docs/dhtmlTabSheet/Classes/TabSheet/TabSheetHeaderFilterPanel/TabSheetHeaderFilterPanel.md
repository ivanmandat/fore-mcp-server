...
[TabSheetTableFilterPanel](../TabSheetTableFilterPanel/TabSheetTableFilterPanel.htm)


abSheetHeaderFilterPanel


## Описание


Класс TabSheetHeaderFilterPanel представляет
 фильтрацию в группе мастера для шапки таблицы.


## Синтаксис


PP.initClass(PP.Ui.TabSheetHeaderFilterPanel, PP.Ui.TabSheetTableFilterPanel,
 "PP.Ui.TabSheetHeaderFilterPanel");
...
## Конструктор
				 ...
				 ![](../../../Sub_Image.gif)
				 [TabSheetHeaderFilterPanel](Constructor_TabSheetHeaderFilterPanel.htm)
				 Конструктор TabSheetHeaderFilterPanel
				 создает экземпляр класса TabSheetHeaderFilterPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getLeftHeaderFilterPanel](TabSheetHeaderFilterPanel.getLeftHeaderFilterPanel.htm)
		 Метод getLeftHeaderFilterPanel
		 возвращает данные группы мастера для боковика таблицы.


		 ![](../../../Sub_Image.gif)
		 [getTopHeaderFilterPanel](TabSheetHeaderFilterPanel.getTopHeaderFilterPanel.htm)
		 Метод getTopHeaderFilterPanel
		 возвращает данные группы мастера для шапки таблицы.


## Методы унаследованные от класса [TabSheetTableFilterPanel](../TabSheetTableFilterPanel/TabSheetTableFilterPanel.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getLevelFilterPanel](../TabSheetTableFilterPanel/TabSheetTableFilterPanel.getLevelFilterPanel.htm)
		 Метод getLevelFilterPanel
		 возвращает данные группы мастера для уровней.


		 ![](../../../Sub_Image.gif)
		 [getTableFilterPanel](../TabSheetTableFilterPanel/TabSheetTableFilterPanel.getTableFilterPanel.htm)
		 Метод getTableFilterPanel
		 возвращает данные группы мастера для данных таблицы.
