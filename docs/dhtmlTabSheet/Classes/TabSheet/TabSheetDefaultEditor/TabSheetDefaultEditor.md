...
Класс TabSheetDefaultEditor представляет базовый редактор таблицы.


## Синтаксис


PP.initClass(PP.Ui.TabSheetDefaultEditor, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "TabSheetDefaultEditor");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TabSheetDefaultEditor](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetDefaultEditor/Conctructor_TabSheetDefaultEditor.htm)
		 Конструктор TabSheetDefaultEditor
		 создает экземпляр класса TabSheetDefaultEditor.
...
## Методы
		 ...
		 Метод getCell
		 возвращает ячейку, содержащую базовый редактор таблицы.


		 ![](../../../Sub_Image.gif)
		 [getCoord](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetDefaultEditor/TabSheetDefaultEditor.getCoord.htm)
		 Метод getCoord
		 возвращает координаты ячейки, содержащей базовый редактор таблицы.


		 ![](../../../Sub_Image.gif)
		 [getTabSheet](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetDefaultEditor/TabSheetDefaultEditor.getTabSheet.htm)
		 Метод getTabSheet
		 возвращает таблицу.


		 ![](../../../Sub_Image.gif)
		 [getTextBox](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetDefaultEditor/TabSheetDefaultEditor.getTextBox.htm)
		 Метод getTextBox
		 возвращает текстовое поле базового редактора таблицы.
