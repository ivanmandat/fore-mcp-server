...
Класс TabSheetObject представляет объект в таблице.


## Синтаксис


PP.initClass(PP.Ui.TabSheetObject, PP.Ui.TabSheetSerializableControl, 'TabSheetObject');
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TabSheetObject](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/Constructor_TabSheetObject.htm)
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [ClassName](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.ClassName.htm)
		 Свойство ClassName
		 определяет имя класса объекта таблицы.


		 ![](../../../Property_Image.gif)
		 [Ident](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.Ident.htm)
		 Свойство Ident
		 определяет идентификатор объекта.


		 ![](../../../Property_Image.gif)
		 [LeftColumn](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.LeftColumn.htm)
		 Свойство LeftColumn
		 определяет индекс столбца, к которому привязан верхний левый
		 угол объекта.


		 ![](../../../Property_Image.gif)
		 [MinHeight](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.MinHeight.htm)
		 Свойство MinHeight
		 определяет минимальную высоту объекта.


		 ![](../../../Property_Image.gif)
		 [MinWidth](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.MinWidth.htm)
		 Свойство MinWidth определяет
		 минимальную ширину объекта.


		 ![](../../../Property_Image.gif)
		 [MovementMode](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.MovementMode.htm)
		 Свойство MovementMode
		 определяет способ перемещения объекта в таблице.


		 ![](../../../Property_Image.gif)
		 [ObjectType](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.ObjectType.htm)
		 Свойство ObjectType
		 определяет тип объекта в таблице.


		 ![](../../../Property_Image.gif)
		 [TabSheet](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.TabSheet.htm)
		 Свойство TabSheet
		 определяет базовый компонент - таблицу.


		 ![](../../../Property_Image.gif)
		 [TopLeftCoord](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.TopLeftCoord.htm)
		 Свойство TopLeftCoord
		 определяет координаты верхнего левого угла объекта в таблице.


		 ![](../../../Property_Image.gif)
		 [TopRow](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.TopRow.htm)
		 Свойство TopRow
		 определяет индекс строки, к которой привязан верхний левый угол
		 объекта.


		 ![](../../../Property_Image.gif)
		 [Url](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.Url.htm)
		 Свойство Url
		 определяет источник данных объекта в таблице.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getContainer](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getContainer.htm)
		 Метод getContainer
		 возвращает DOM-элемент контейнера, в котором расположен объект.


		 ![](../../../Sub_Image.gif)
		 [getCoord](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getCoord.htm)
		 Метод getCoord
		 возвращает координаты ячейки, в пределах которой расположен левый
		 верхний угол объекта в таблице.


		 ![](../../../Sub_Image.gif)
		 [getITabObject](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getITabObject.htm)
		 Метод getITabObject возвращает пользовательский
		 объект.


		 ![](../../../Sub_Image.gif)
		 [getObject](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getObject.htm)
		 Метод getObject возвращает
		 DOM-элемент объекта.


		 ![](../../../Sub_Image.gif)
		 [getRange](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getRange.htm)
		 Метод getRange
		 возвращает диапазон ячеек, охватываемый объектом в таблице.


		 ![](../../../Sub_Image.gif)
		 [getSizeCoord](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getSizeCoord.htm)
		 Метод getSizeCoord
		 возвращает количество строк и столбцов, которые охватывает объект
		 в таблице.


		 ![](../../../Sub_Image.gif)
		 [getTabSheet](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getTabSheet.htm)
		 Метод getTabSheet возвращает таблицу,
		 в которой расположен объект.


		 ![](../../../Sub_Image.gif)
		 [getVisibleSize](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.getVisibleSize.htm)
		 Метод getVisibleSize
		 определяет видимый размер объекта в таблице.


		 ![](../../../Sub_Image.gif)
		 [isHorizontallyFixedLineCrossed](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.isHorizontallyFixedLineCrossed.htm)
		 Метод isHorizontallyFixedLineCrossed
		 определяет, пересекает ли объект в таблице горизонтальную линию
		 фиксации.


		 ![](../../../Sub_Image.gif)
		 [isUnderCoordAndMouse](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.isUnderCoordAndMouse.htm)
		 Метод isUnderCoordAndMouse
		 определяет, соответствуют ли указанные координаты объекту в таблице,
		 и находится ли он под курсором мыши.


		 ![](../../../Sub_Image.gif)
		 [isVerticallyFixedLineCrossed](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.isVerticallyFixedLineCrossed.htm)
		 Метод isVerticallyFixedLineCrossed
		 определяет, пересекает ли объект в таблице вертикальную линию
		 фиксации.


		 ![](../../../Sub_Image.gif)
		 [remove](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.remove.htm)
		 Метод remove
		 удаляет объект из таблицы.


		 ![](../../../Sub_Image.gif)
		 [setLeftOffset](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.setLeftOffset.htm)
		 Метод setLeftOffset
		 устанавливает отступ слева для объекта в таблице.


		 ![](../../../Sub_Image.gif)
		 [setTopOffset](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.setTopOffset.htm)
		 Метод setTopOffset
		 устанавливает отступ сверху для объекта в таблице.


		 ![](../../../Sub_Image.gif)
		 [setUrl](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.setUrl.htm)
		 Метод setUrl устанавливает
		 адрес источника данных объекта в таблице.


		 ![](../../../Sub_Image.gif)
		 [toJSON](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObject/TabSheetObject.toJSON.htm)
