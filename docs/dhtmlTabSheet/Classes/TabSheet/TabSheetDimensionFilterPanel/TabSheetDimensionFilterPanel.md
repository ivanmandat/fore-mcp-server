...
Класс TabSheetDimensionFilterPanel
 представляет фильтрацию в группе мастера для измерений таблицы.


## Синтаксис


PP.initClass(PP.Ui.TabSheetDimensionFilterPanel, PP.Ui.MasterPanel, "PP.Ui.TabSheetDimensionFilterPanel");
...
## Конструктор
				 ...
				 ![](../../../Sub_Image.gif)
				 [TabSheetDimensionFilterPanel](Constructor_TabSheetDimensionFilterPanel.htm)
				 Конструктор TabSheetDimensionFilterPanelсоздает
				 экземпляр класса TabSheetDimensionFilterPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getDimensionFilterPanel](TabSheetDimensionFilterPanel.getDimensionFilterPanel.htm)
		 Метод getDimensionFilterPanel
		 возвращает данные в группе мастера для измерений таблицы.
