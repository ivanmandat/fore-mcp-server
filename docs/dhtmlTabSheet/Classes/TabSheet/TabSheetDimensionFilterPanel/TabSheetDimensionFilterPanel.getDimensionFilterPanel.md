# TabSheetDimensionFilterPanel.getDimensionFilterPanel
...
        var tab = tabMaster.getDimensionFilterPanel();
//Получим Id панели
tab.getId();
...
[TabSheetDimensionFilterPanel](TabSheetDimensionFilterPanel.htm)
