...
Класс **TabSheetObjectSelection**
 представляет выделение объекта в таблице.


## Синтаксис


PP.initClass(PP.Ui.TabSheetObjectSelection, PP.Ui.[Control](dhtmlReport.chm::/Classes/RegularReport/Control/Control.htm),
 "PP.Ui.TabSheetObjectSelection");
...
## Конструктор
				 ...
				 ![](../../../Sub_Image.gif)
				 [TabSheetObjectSelection](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/Constructor_TabSheetObjectSelection.htm)
				 Конструктор TabSheetObjectSelection
				 создает экземпляр класса TabSheetObjectSelection.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [clear](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.clear.htm)
		 Метод clear
		 убирает все выделения объектов в таблице.


		 ![](../../../Sub_Image.gif)
		 [getActiveObject](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.getActiveObject.htm)
		 Метод getActiveObject
		 возвращает активный выделенный объект.


		 ![](../../../Sub_Image.gif)
		 [getSelectedObjects](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.getSelectedObjects.htm)
		 Метод getSelectedObjects
		 возвращает массив выделенных объектов.


		 ![](../../../Sub_Image.gif)
		 [getTabSheet](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.getTabSheet.htm)
		 Метод getTabSheet
		 возвращает таблицу.


		 ![](../../../Sub_Image.gif)
		 [initEvents](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.initEvents.htm)
		 Метод initEvents инициализирует
		 базовое событие.


		 ![](../../../Sub_Image.gif)
		 [reset](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.reset.htm)
		 Метод reset
		 сбрасывает выделение объекта в таблице.


		 ![](../../../Sub_Image.gif)
		 [select](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.select.htm)
		 Метод select
		 выделяет указанный объект в таблице.


		 ![](../../../Sub_Image.gif)
		 [update](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetObjectSelection/TabSheetObjectSelection.update.htm)
		 Метод update
		 обновляет выделение объекта в таблице.
