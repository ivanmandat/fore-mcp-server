# TabSheetMeasures.getLastRowFullyVisible
...
getLastRowFullyVisible();


## Описание


Метод getLastRowFullyVisible** возвращает индекс последней полностью видимой строки в таблице.
