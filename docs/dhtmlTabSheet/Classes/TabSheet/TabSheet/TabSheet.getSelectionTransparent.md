# TabSheet.getSelectionTransparent
...
Метод getSelectionTransparent
 возвращает значение степени прозрачности цвета заливки выделенных ячеек
 таблицы.
...
Для установки степени прозрачности цвета заливки выделенных ячеек таблицы
 используйте метод [TabSheet.setSelectionTransparent](TabSheet.setSelectionTransparent.htm).
