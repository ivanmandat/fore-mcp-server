...
Класс TabSheetExpander представляет группировку ячеек таблицы.


## Синтаксис


PP.initClass(PP.Ui.TabSheetExpander, PP.Ui.TabSheetSerializableControl, "PP.Ui.TabSheetExpander");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TabSheetExpander](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/Conctructor_TabSheetExander.htm)
		 Конструктор TabSheetExpander
		 создает экземпляр класса TabSheetExpander.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [IsCollapsed](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.IsCollapsed.htm)
		 Свойство IsCollapsed
		 определяет, свёрнута ли группировка ячеек таблицы.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [collapse](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.collapse.htm)
		 Метод collapse
		 сворачивает группировку ячеек таблицы.


		 ![](../../../Sub_Image.gif)
		 [contains](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.contains.htm)
		 Метод contains
		 проверяет, является ли указанная группировка ячеек таблицы вложенной
		 в текущую группировку.


		 ![](../../../Sub_Image.gif)
		 [equals](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.equals.htm)
		 Метод equals
		 сравнивает указанную группировку ячеек таблицы с текущей.


		 ![](../../../Sub_Image.gif)
		 [expand](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.expand.htm)
		 Метод expand
		 разворачивает группировку ячеек таблицы.


		 ![](../../../Sub_Image.gif)
		 [getCoord](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.getCoord.htm)
		 Метод getCoord
		 возвращает координаты левой верхней ячейки в группировке.


		 ![](../../../Sub_Image.gif)
		 [getIndexesToExpand](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.getIndexesToExpand.htm)
		 Метод getIndexesToExpand
		 возвращает индексы строк и столбцов, которые скрываются при сворачивании
		 группировки.


		 ![](../../../Sub_Image.gif)
		 [getInnerExpanders](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.getInnerExpanders.htm)
		 Метод getInnerExpanders
		 возвращает группировки ячеек таблицы, вложенные в текущую группировку.


		 ![](../../../Sub_Image.gif)
		 [getSizeCoord](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.getSizeCoord.htm)
		 Метод getSizeCoord
		 возвращает размер группировки, выраженный в количестве входящих
		 в неё строк и столбцов таблицы.


		 ![](../../../Sub_Image.gif)
		 [getTabSheet](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.getTabSheet.htm)
		 Метод getTabSheet
		 возвращает таблицу.


		 ![](../../../Sub_Image.gif)
		 [isCoordInside](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.isCoordInside.htm)
		 Метод isCoordInside
		 определяет, входят ли указанные координаты в группировку ячеек.


		 ![](../../../Sub_Image.gif)
		 [isCrossWith](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.isCrossWith.htm)
		 Метод isCrossWith
		 определяет, пересекается ли указанная группировка с текущей.


		 ![](../../../Sub_Image.gif)
		 [remove](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.remove.htm)
		 Метод remove
		 удаляет группировку ячеек таблицы.


		 ![](../../../Sub_Image.gif)
		 [toJSON](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetExpander/TabSheetExpander.toJSON.htm)
		 Метод toJSON
		 возвращает JSON объект с настройками экспандера.
