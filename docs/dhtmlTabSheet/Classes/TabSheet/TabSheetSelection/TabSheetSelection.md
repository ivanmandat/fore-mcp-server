...
Класс TabSheetSelection
 представляет выделение в таблице.


## Синтаксис


PP.initClass(PP.Ui.TabSheetSelection, PP.Ui.[Control](dhtmlUi.chm::/Classes/Control/Control.htm),
 "PP.Ui.TabSheetSelection");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TabSheetSelection](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/Constructor_TabSheetSelection.htm)
		 Конструктор TabSheetSelection
		 создает экземпляр класса TabSheetSelection.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [addRange](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.addRange.htm)
		 Метод addRange
		 создает новую область выделения по заданному диапазону ячеек.


		 ![](../../../Sub_Image.gif)
		 [clear](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.clear.htm)
		 Метод clear
		 снимает выделение в таблице.


		 ![](../../../Sub_Image.gif)
		 [eachSelectedArea](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.eachSelectedArea.htm)
		 Метод eachSelectedArea
		 выполняет указанную функцию для каждой выделенной области.


		 ![](../../../Sub_Image.gif)
		 [eachSelectedRange](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.eachSelectedRange.htm)
		 Метод eachSelectedRange
		 выполняет указанную функцию для каждого выделенного диапазона.


		 ![](../../../Sub_Image.gif)
		 [ensureExistence](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.ensureExistence.htm)
		 Метод ensureExistence
		 изменяет объект выделения таким образом, чтобы он гарантированно
		 существовал.


		 ![](../../../Sub_Image.gif)
		 [ensureSelectionValid](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.ensureSelectionValid.htm)
		 Метод ensureSelectionValid
		 изменяет текущее выделение в таблице так, чтобы оно было корректным.


		 ![](../../../Sub_Image.gif)
		 [getIsCellActivated](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.getIsCellActivated.htm)
		 Метод getIsCellActivated
		 проверяет, является ли какая-либо ячейка таблицы активной.


		 ![](../../../Sub_Image.gif)
		 [getRange](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.getRange.htm)
		 Метод getRange
		 возвращает диапазон выделенных ячеек в таблице.


		 ![](../../../Sub_Image.gif)
		 [getSelectedAreas](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.getSelectedAreas.htm)
		 Метод getSelectedAreas
		 возвращает массив выделенных в таблице областей.


		 ![](../../../Sub_Image.gif)
		 [getSelectedRanges](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.getSelectedRanges.htm)
		 Метод getSelectedRanges
		 возвращает массив выделенных в таблице диапазонов ячеек.


		 ![](../../../Sub_Image.gif)
		 [getSelectionType](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.getSelectionType.htm)
		 Метод getSelectionType
		 возвращает тип текущего выделения.


		 ![](../../../Sub_Image.gif)
		 [getStartCoord](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.getStartCoord.htm)
		 Метод getStartCoord
		 возвращает начальные координаты выделения в таблице.


		 ![](../../../Sub_Image.gif)
		 [getTabSheet](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.getTabSheet.htm)
		 Метод getTabSheet
		 возвращает таблицу.


		 ![](../../../Sub_Image.gif)
		 [removeArea](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.removeArea.htm)
		 Метод removeArea
		 убирает выделенные области в таблице.


		 ![](../../../Sub_Image.gif)
		 [reset](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.reset.htm)
		 Метод reset
		 сбрасывает выделение в таблице.


		 ![](../../../Sub_Image.gif)
		 [select](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.select.htm)
		 Метод select
		 выделяет заданный диапазон ячеек.


		 ![](../../../Sub_Image.gif)
		 [selectAll](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetSelection/TabSheetSelection.selectAll.htm)
		 Метод selectAll
