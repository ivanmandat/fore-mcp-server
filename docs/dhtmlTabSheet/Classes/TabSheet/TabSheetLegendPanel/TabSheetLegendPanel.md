...
Класс TabSheetLegendPanel представляет
 [легенду
 метрик](UiAnalyticalArea.chm::/TableView/Legend.htm) в группе мастера для данных таблицы.


## Синтаксис


PP.initClass(PP.Ui.TabSheetLegendPanel, PP.Ui.VisualizerMasterLegendPanel,
 "PP.Ui.TabSheetLegendPanel");
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [MetadataSection](TabSheetLegendPanel.MetadataSection.htm)
		 Свойство MetadataSection
		 устанавливает идентификатор у [легенды метрик](UiAnalyticalArea.chm::/TableView/Legend.htm) таблицы.
