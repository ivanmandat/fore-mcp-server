...
Класс TabSheetAdjustmentMgr управляет изменением размеров строк и столбцов таблицы.


## Синтаксис


PP.initClass(PP.Ui.TabSheetAdjustmentMgr, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.Ui.TabSheetAdjustmentMgr");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TabSheetAdjustmentMgr](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetAdjustmentMgr/Constructor_TabSheetAdjustmentMgr.htm)
		 Конструктор TabSheetAdjustmentMgr
		 создает экземпляр класса TabSheetAdjustmentMgr.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [autoAdjustColumnWidth](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetAdjustmentMgr/TabSheetAdjustmentMgr.autoAdjustColumnWidth.htm)
		 Метод autoAdjustColumnWidth
		 осуществляет автоподгонку ширины столбца таблицы.


		 ![](../../../Sub_Image.gif)
		 [autoAdjustRowHeight](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetAdjustmentMgr/TabSheetAdjustmentMgr.autoAdjustRowHeight.htm)
		 Метод autoAdjustRowHeight
		 осуществляет автоподгонку высоты строки таблицы.


		 ![](../../../Sub_Image.gif)
		 [getProcessResizeCells](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetAdjustmentMgr/TabSheetAdjustmentMgr.getProcessResizeCells.htm)
		 Метод getProcessResizeCells
		 определяет, происходит ли изменение размера ячеек в данный момент.


		 ![](../../../Sub_Image.gif)
		 [getTabSheet](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetAdjustmentMgr/TabSheetAdjustmentMgr.getTabSheet.htm)
		 Метод getTabSheet
		 возвращает таблицу.


		 ![](../../../Sub_Image.gif)
		 [reset](dhtmlTabSheet.chm::/Classes/TabSheet/TabSheetAdjustmentMgr/TabSheetAdjustmentMgr.reset.htm)
		 Метод reset
		 cбрасывает текущие значения параметров указателя мыши на исходные.
