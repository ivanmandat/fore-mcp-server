...
Класс TabSheetTableFilterPanel
 представляет фильтрацию в группе мастера для данных таблицы.


## Синтаксис


PP.initClass(PP.Ui.TabSheetTableFilterPanel, PP.Ui.MasterPanel, "PP.Ui.TabSheetTableFilterPanel");
...
## Конструктор
				 ...
				 ![](../../../Sub_Image.gif)
				 [TabSheetTableFilterPanel](Constructor_TabSheetTableFilterPanel.htm)
				 Конструктор TabSheetTableFilterPanel
				 создает экземпляр класса TabSheetTableFilterPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getLevelFilterPanel](TabSheetTableFilterPanel.getLevelFilterPanel.htm)
		 Метод getLevelFilterPanel
		 возвращает данные группы мастера для уровней.


		 ![](../../../Sub_Image.gif)
		 [getTableFilterPanel](TabSheetTableFilterPanel.getTableFilterPanel.htm)
