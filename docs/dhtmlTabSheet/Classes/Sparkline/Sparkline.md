...
Класс Sparkline реализует компонент
 [Sparkline](../../Components/Sparkline/Sparkline.htm), представляющий
...
PP.initClass(PP.Ui.Sparkline, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.Sparkline");
