...
Класс DescStatsBox реализует компонент среды разработки [DescStatsBox](DescStatsBox.htm), содержащий набор панелей для расчета [описательных статистик](UiModelling.chm::/2_Container_of_Modeling/2_3_Work_object/2_3_5_Descriptive_Value/uimodelling_work_object_descriptive.htm) переменных моделирования.


## Свойства, унаследованные от [IDescStatsBox](../../Interface/IDescStatsBox/IDescStatsBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IDescStatsBox/IDescStatsBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [ModelSpace](../../Interface/IDescStatsBox/IDescStatsBox.ModelSpace.htm)
		 Свойство ModelSpace
		 определяет контейнер моделирования, к которому подключён компонент.


		 ![](../../Property_Image.gif)
		 [Pads](../../Interface/IDescStatsBox/IDescStatsBox.Pads.htm)
		 Свойство Pads возвращает
		 коллекцию панелей компонента.


		 ![](../../Property_Image.gif)
		 [VariablesCount](../../Interface/IDescStatsBox/IDescStatsBox.VariablesCount.htm)
...
## Методы, унаследованные от [IDescStatsBox](../../Interface/IDescStatsBox/IDescStatsBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [AddVariableStub](../../Interface/IDescStatsBox/IDescStatsBox.AddVariableStub.htm)
		 Метод AddVariableStub
		 осуществляет добавление в компонент переменной.


		 ![](../../Sub_Image.gif)
		 [AddVariableStubFixedSlice](../../Interface/IDescStatsBox/IDescStatsBox.AddVariableStubFixedSlice.htm)
		 Метод AddVariableStubFixedSlice
		 осуществляет добавление в компонент переменной с указанием отметки
		 по её дополнительным измерениям.


		 ![](../../Sub_Image.gif)
		 [ClearVariables](../../Interface/IDescStatsBox/IDescStatsBox.ClearVariables.htm)
		 Метод ClearVariables
		 осуществляет очистку списка переменных компонента.


		 ![](../../Sub_Image.gif)
		 [RemoveByIndex](../../Interface/IDescStatsBox/IDescStatsBox.RemoveByIndex.htm)
		 Метод RemoveByIndex
