...
Класс TableDataSource предназначен для работы с табличным источником данных для интеллектуального анализа.


## Комментарии


Если данные для интеллектуального анализа расположены в регламентном отчёте, то используйте класс [ReportDataSource](../ReportDataSource/ReportDataSource.htm).


## Свойства объекта класса, унаследованные от [IDmTableDataSource](../../Interface/IDmTableDataSource/IDmTableDataSource.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Table](../../Interface/IDmTableDataSource/IDmTableDataSource.Table.htm)
		 Свойство Table
