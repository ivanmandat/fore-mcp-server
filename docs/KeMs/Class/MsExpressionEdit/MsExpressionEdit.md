...
Класс MsExpressionEdit реализует
 компонент среды разработки [MsExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MsExpressionEdit.htm).
...
## Иерархия наследования
 ...
           [IMsExpressionEdit](../../Interface/IMsExpressionEdit/IMsExpressionEdit.htm)
...
Компонент MsExpressionEdit предназначен
 для редактирования выражения и содержит всплывающую подсказку для используемых
 функций и методов.


## Свойства, унаследованные от [IMsExpressionEdit](../../Interface/IMsExpressionEdit/IMsExpressionEdit.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](../../Interface/IMsExpressionEdit/IMsExpressionEdit.Expression.htm)


		 Свойство Expression
		 определяет выражение, редактируемое в компоненте [MsExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MsExpressionEdit.htm).


		 ![](../../Property_Image.gif)
		 [FormulaTermList](../../Interface/IMsExpressionEdit/IMsExpressionEdit.FormulaTermList.htm)


		 Свойство FormulaTermList
		 определяет коллекцию термов, доступных в компоненте [MsExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MsExpressionEdit.htm).


		 ![](../../Property_Image.gif)
		 [FormulaTransform](../../Interface/IMsExpressionEdit/IMsExpressionEdit.FormulaTransform.htm)


		 Свойство FormulaTransform
		 определяет параметры модели, на которую настроен компонент [MsExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MsExpressionEdit.htm).


		 ![](../../Property_Image.gif)
		 [HeavyDelimiters](../../Interface/IMsExpressionEdit/IMsExpressionEdit.HeavyDelimiters.htm)


		 Свойство HeavyDelimiters определяет
		 разделитель выражений.


		 ![](../../Property_Image.gif)
		 [LightDelimiters](../../Interface/IMsExpressionEdit/IMsExpressionEdit.LightDelimiters.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxTermWordCount](../../Interface/IMsExpressionEdit/IMsExpressionEdit.MaxTermWordCount.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Rubricator](../../Interface/IMsExpressionEdit/IMsExpressionEdit.Rubricator.htm)


		 Свойство Rubricator
		 определяет базу данных временных рядов, с атрибутами которой можно
		 работать в компоненте [MsExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MsExpressionEdit.htm).


		 ![](../../Property_Image.gif)
		 [SelectionSet](../../Interface/IMsExpressionEdit/IMsExpressionEdit.SelectionSet.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [UseFullVariableNames](../../Interface/IMsExpressionEdit/IMsExpressionEdit.UseFullVariableNames.htm)


		 Свойство UseFullVariableNames
		 определяет признак использования полных наименований операндов.


## Свойства, унаследованные от [ITermEdit](ModForms.chm::/Interface/ITermEdit/ITermEdit.htm)
...
## Свойства, унаследованные от [ICustomEdit](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.htm)
...
## Свойства, унаследованные от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
		 ...
		 Свойство Cursor
		 определяет вид курсора, отображаемого при наведении курсора мыши
		 на компонент, во время выполнения формы.
		 ...
		 Свойство Focused
		 возвращает True, если фокус установлен на данном компоненте.
		 ...
		 Свойство Scrolls
		 возвращает параметры полос прокрутки компонента.


		 ![](../../Property_Image.gif)
		 [ShowHint](ModForms.chm::/Interface/IControl/IControl.ShowHint.htm)
		 Свойство ShowHint
		 определяет, будет ли показываться всплывающая подсказка при задержке
...
## Методы, унаследованные от [IMsExpressionEdit](../../Interface/IMsExpressionEdit/IMsExpressionEdit.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [AddStub](../../Interface/IMsExpressionEdit/IMsExpressionEdit.AddStub.htm)
		 Метод AddStub добавляет
		 куб в качестве источника данных MsExpressionEdit.


		 ![](../../Sub_Image.gif)
		 [AddAttribute](../../Interface/IMsExpressionEdit/IMsExpressionEdit.AddAttribute.htm)


		 Метод AddAttribute
		 добавляет атрибут, значения которого будут использованы для составления
		 рядов в компоненте.


		 ![](../../Sub_Image.gif)
		 [ClearAttributes](../../Interface/IMsExpressionEdit/IMsExpressionEdit.ClearAttributes.htm)


		 Метод ClearAttributes
		 удаляет все атрибуты, добавленные для использования в компоненте.


		 ![](../../Sub_Image.gif)
		 [GetAttributeCount](../../Interface/IMsExpressionEdit/IMsExpressionEdit.GetAttributeCount.htm)


		 Метод GetAttributeCount
		 возвращает число атрибутов, доступных для использования в компоненте.


		 ![](../../Sub_Image.gif)
		 [RemoveAttribute](../../Interface/IMsExpressionEdit/IMsExpressionEdit.RemoveAttribute.htm)


		 Метод RemoveAttribute
		 удаляет указанный атрибут из списка атрибутов, значения которых
		 используются в компоненте.


## Методы, унаследованные от [ITermEdit](ModForms.chm::/Interface/ITermEdit/ITermEdit.htm)
		 ...
		 Метод BeginUpdate
		 отключает набор внутренних механизмов для ускорения вставки термов
		 в компонент.
		 ...
		 размещение пользовательского выражения в указанную позицию.
		 ...
		 преобразование текста редактора и перераспределение термов в компонента.


## Методы, унаследованные от [ICustomEdit](ModForms.chm::/Interface/ICustomEdit/ICustomEdit.htm)
...
## Методы, унаследованные от [IControl](ModForms.chm::/Interface/IControl/IControl.htm)
		 ...
		 Метод GetImage
		 возвращает графическое изображение компонента со всеми дочерними
		 компонентами.
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnUpdateFormula](MsExpressionEdit.OnUpdateFormula.htm)
		 Событие OnUpdateFormula
		 возникает при преобразовании внешнего представления выражения
		 во внутреннее.


		 ![](../../Event_Image.gif)
		 [OnUpdateText](MsExpressionEdit.OnUpdateText.htm)
		 Событие OnUpdateText
		 возникает при преобразовании внутреннего представления выражения
		 во внешнее.
