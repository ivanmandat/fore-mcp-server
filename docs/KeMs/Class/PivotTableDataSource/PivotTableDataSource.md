...
Класс PivotTableDataSource предназначен
 для работы с таблицей данных, являющейся источником данных для интеллектуального
 анализа.
...
## Свойства объекта класса, унаследованные от [IDmPivotTableDataSource](../../Interface/IDmPivotTableDataSource/IDmPivotTableDataSource.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [PivotTable](../../Interface/IDmPivotTableDataSource/IDmPivotTableDataSource.PivotTable.htm)
		 Свойство PivotTable
		 определяет таблицу данных, содержащую данные для интеллектуального
		 анализа.
