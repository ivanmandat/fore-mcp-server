...
Метод следует вызвать после задания выражения сравнения в правиле валидации.
 Сопоставления будут сделаны на основе заданного выражения и только для
 тех атрибутов, идентификаторы которых совпадают.
...
        Debug.WriteLine("Сопоставление №" + (i + 1).ToString);
