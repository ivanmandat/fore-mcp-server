...
Интерфейс IMsSpliceTransform
 содержит свойства и методы для работы с параметрами модели, осуществляющей
 совмещение рядов.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [MethodType](IMsSpliceTransform.MethodType.htm)


		 Свойство MethodType
		 определяет метод совмещения рядов.


		 ![](../../Property_Image.gif)
		 [Operands](IMsSpliceTransform.Operands.htm)


		 Свойство Operands возвращает
		 коллекцию совмещаемых рядов.


		 ![](../../Property_Image.gif)
		 [Result](IMsSpliceTransform.Result.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SpliceDirection](IMsSpliceTransform.SpliceDirection.htm)


		 Свойство SpliceDirection
		 определяет направление совмещения рядов.
