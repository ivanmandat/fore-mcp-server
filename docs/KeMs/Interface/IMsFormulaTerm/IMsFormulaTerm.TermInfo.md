...
Для выполнения примера в репозитории предполагается наличие контейнера
 ...
 VAR_!, которая в дальнейшем будет использоваться как моделируемая, а также
...
В результате выполнения примера в контейнере моделирования будет создана
 ...
 одна входная переменная. Для составления уравнения создаётся терм, ссылающийся
 на срез входной переменной. Для терма будет изменён способ начального
...
[IMsFormulaTerm](IMsFormulaTerm.htm)
