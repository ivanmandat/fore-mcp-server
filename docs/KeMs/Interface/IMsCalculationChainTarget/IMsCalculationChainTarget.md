...
Интерфейс IMsCalculationChainTarget
 предназначен для работы с целевой функцией, содержащейся в [цепочке
...
Для получения целевой функции приведите объект интерфейса [IMsCalculationChainEntry](../IMsCalculationChainEntry/IMsCalculationChainEntry.htm)
 к интерфейсу IMsCalculationChainTarget.
 Операция допустима, если [IMsCalculationChainEntry.Type](../IMsCalculationChainEntry/IMsCalculationChainEntry.Type.htm) = [MsCalculationChainEntryType.Target](../../Enums/MsCalculationChainEntryType.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [TargetProblem](IMsCalculationChainTarget.TargetProblem.htm)
		 Свойство TargetProblem
		 определяет целевую задачу, которой принадлежит целевая функция.


		 ![](../../Property_Image.gif)
		 [UseCustomName](IMsCalculationChainTarget.UseCustomName.htm)
		 Свойство UseCustomName
		 определяет признак использования пользовательского наименования
		 целевой функции.
