...
## Синтаксис
		...
		Residuals(Object: [IMsResultObject](../IMsResultObject/IMsResultObject.htm)):
		 Variant;
...
Метод Residuals возвращает ряд
 остатков.
...
Добавьте ссылки на системные сборки: Metabase, Ms.
		...
		    Expr.AsString := "(MovAvg(" + TermInfo.TermInnerText + ", Null) As ms.IMsResultObject).Residuals";
...
В результате выполнения примера модель будет возвращать ряд остатков
...
Результат: для метода «Скользящее
 среднее» будут получены значения ряда остатков.
