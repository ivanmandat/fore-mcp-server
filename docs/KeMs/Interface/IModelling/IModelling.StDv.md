...
Метод StDv возвращает стандартное
 отклонение для указанной переменной.
...
Добавьте ссылки на системные сборки: Metabase, Ms.
		...
		    Expr.AsString := TermInfo.TermInnerText + "+StDv(" + Inp_1 + ")";
...
В результате выполнения примера модель будет рассчитывать значения второй
 входной переменной, увеличенные на стандартное отклонение для первой входной
 переменной.
...
Результат: рассчитано стандартное отклонение наблюдений ряда «Brazil|BCA».
...
Результат: рассчитано стандартное отклонение соответствующих точек факторов
 «X1» и «X2»
...
[IModelling](IModelling.htm)
 | [Стандартное
 отклонение](Lib.chm::/05_Statistics/UiModelling_Stddev.htm) | База данных временных рядов: [калькулятор](UiDw.chm::/Workbook/CalculatedSeries/UiDw_cs_Calculator.htm) |
