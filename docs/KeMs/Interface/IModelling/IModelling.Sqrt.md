...
В результате выполнения примера модель будет рассчитывать квадратный
 корень точек первой входной переменной.
...
Результат: рассчитан квадратный корень наблюдений показателя «Brazil|BCA».
...
Результат: рассчитан квадратный корень точек фактора «X1».
