...
    Expr.AsString := "Ln(" + TermInfo.TermInnerText + ")";
...
В результате выполнения примера модель будет рассчитывать натуральный
...
Результат: рассчитан натуральный логарифм наблюдений показателя «Brazil|BCA».
...
Результат: рассчитан натуральный логарифм точек фактора «X1».
...
База данных временных
 ...
 [Ln](UiDw.chm::/Workbook/CalculatedSeries/Arithmetic/UiDw_cs_Ln.htm)
