...
Average(Parameters: Array): Variant;
...
Если в Parameters указано
 больше одной переменной, то будет вычисляться среднее значение соответствующих
...
Добавьте ссылки на системные сборки: Metabase, Ms.
	...
	    Expr.AsString := TermInfo.TermInnerText + "+Average(" + Inp_1 + ", False)";
...
В результате выполнения примера модель будет рассчитывать значения первой
 входной переменной c учётом пустых значений, увеличенные на значения второй
 входной переменной.
...
Результат: рассчитано среднее значение наблюдений ряда «Brazil|BCA» за
...
Результат: рассчитано среднее значение точек факторов «X1»
