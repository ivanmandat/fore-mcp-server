...
Приближённое значение константы «Пи»: 3,14159265358979.
...
    Expr.AsString := TermInfo.TermInnerText + " * Pi";
...
После выполнения примера модель будет осуществлять умножение точек первой
 входной переменной на константу «Пи».
