...
Метод Sum возвращает сумму соответствующих
...
Добавьте ссылки на системные сборки: Metabase, Ms.
		...
		    Expr.AsString := "Sum(" + Inp_1 + "," + Inp_2 + ", SetPeriod(2000,2010))";
...
В результате выполнения примера модель будет рассчитывать сумму соответствующих
 точек для первой и второй входных переменных за период с 2000 по
 2010 год.
