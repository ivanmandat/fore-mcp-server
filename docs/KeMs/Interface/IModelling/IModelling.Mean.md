...
Добавьте ссылки на системные сборки: Metabase, Ms.
		...
		    Expr.AsString := TermInfo.TermInnerText + "+Mean(" + Inp_1 + ", SetPeriod(2000,2010))";
...
В результате выполнения примера модель будет рассчитывать значения второй
 входной переменной, увеличенные на математическое ожидание для первой
 входной переменной, за период с 2000 по 2010 год.
...
Результат: математическое ожидание соответствующих наблюдений рядов
...
Результат: математическое ожидание точек фактора «X1».
...
[IModelling](IModelling.htm)
 ...
 | Контейнер моделирования: [Редактирование регрессора](UiNav.Chm::/GUI/ExpressionEditor.htm)/[формулы](UiNav.Chm::/GUI/ExpressionEditor.htm)
