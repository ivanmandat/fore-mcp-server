...
Inputs. Переменные, сумму квадратов
...
Метод SumSq возвращает сумму
 квадратов для соответствующих точек для двух и более переменных.
...
Добавьте ссылки на системные сборки: Metabase, Ms.
		...
		    Expr.AsString := "SumSq(" + Inp_1 + "," + Inp_2 + ", True, SetPeriod(2000,2010))";
...
В результате выполнения примера модель будет рассчитывать сумму квадратов
 для соответствующих точек для первой и второй входных переменных без
 учёта пустых значений за период с 2000 по 2010 год.
...
Результат: сумма квадратов соответствующих наблюдений рядов «Brazil|BCA»,
...
Результат: сумма квадратов соответствующих точек факторов «X1»
 и «X2».
