...
PchX(Input: [ITimeSeries](../ITimeSeries/ITimeSeries.htm);
...
Метод PchX
 осуществляет расчёт темпа прироста точек переменной к указанному периоду.
...
В результате выполнения примера модель будет осуществлять расчёт темпа
 прироста точек первой входной переменной к периоду, сдвинутому от текущего
 на три точки.
...
Результат: рассчитан темп прироста наблюдений показателя «Brazil|BCA»
 к периоду, сдвинутому от текущего на три точки.
...
Результат:рассчитан темп прироста точек фактора «X1»
 к предыдущему периоду, сдвинутому от текущего на две точки.
