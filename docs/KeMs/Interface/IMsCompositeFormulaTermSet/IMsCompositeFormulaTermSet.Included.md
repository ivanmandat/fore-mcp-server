...
Свойство Included
 определяет признак использования данного набора в расчётах.
...
Добавьте ссылки на системные сборки: Metabase, Ms.
		...
		        Debug.WriteLine(" Набор " + (i + 1).ToString + ":");
		...
		            Debug.WriteLine("   Используется в расчетах: " + TermSet.Included.ToString);

		            If TermSet.SingleTerm <> Null Then

		                Debug.WriteLine("   Ведущий терм:" + TermSet.SingleTerm.ExpressionText);
...
В результате выполнения примера наборы термов объясняющих рядов будут
 выведены в окно консоли. Для каждого набора будут выведены признак его
 участия в расчётах и ведущий составной терм.


См. также:


[IMsCompositeFormulaTermSet](IMsCompositeFormulaTermSet.htm)
