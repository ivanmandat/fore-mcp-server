...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Explained](IMsMedianSmoothingTransform.Explained.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MissingData](IMsMedianSmoothingTransform.MissingData.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Width](IMsMedianSmoothingTransform.Width.htm)
