...
LMOrder должно принимать неотрицательное
 значение.
...
В примере описана настройка параметров диагностического теста (критерий
 функциональной формы). Тестироваться будет модель авторегрессией второго
 порядка. После выполнения тестирования результаты выводятся в окно консоли.


См. также:


[IMsSerialCorellationLMTestSettings](IMsSerialCorellationLMTestSettings.htm)
