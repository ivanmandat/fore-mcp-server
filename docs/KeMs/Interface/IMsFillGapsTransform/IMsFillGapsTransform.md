...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Explained](IMsFillGapsTransform.Explained.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MissingData](IMsFillGapsTransform.MissingData.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Specified](IMsFillGapsTransform.Specified.htm)


		 Свойство Specified
		 определяет образцовый ряд для методов обработки пропусков Pattern
		 (по шаблону) и Overlay (значениями другого ряда).
