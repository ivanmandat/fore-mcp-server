# IMsTransformObjectList.AddSelection
...
Add(Selection: [IDimSelection](KeDims.chm::/interface/IDimSelection/IDimSelection.htm)):
 [IMsTransformObject](../IMsTransformObject/IMsTransformObject.htm);


## Параметры


Selection. Добавляемая отметка.


## Описание


Метод AddSelection добавляет
 отметку в коллекцию.
...
Для добавления объекта в коллекцию используйте метод [IMsTransformObjectList.Add](IMsTransformObjectList.Add.htm).
