...
Интерфейс IMsHodrickPrescottFilterTransform
 содержит свойства и методы, определяющие параметры модели, использующей
 для расчета фильтр Ходрика-Прескотта.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Explained](IMsHodrickPrescottFilterTransform.Explained.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MissingData](IMsHodrickPrescottFilterTransform.MissingData.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Power](IMsHodrickPrescottFilterTransform.Power.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SmoothingParameter](IMsHodrickPrescottFilterTransform.SmoothingParameter.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SmoothingParameterMode](IMsHodrickPrescottFilterTransform.SmoothingParameterMode.htm)
