...
## Синтаксис
		...
		LowerConfidenceLevelTermSet: [IMsFormulaTermSet](../IMsFormulaTermSet/IMsFormulaTermSet.htm);
...
Свойство LowerConfidenceLevelTermSet
 возвращает набор рядов, в которые будут выгружаться данные нижней доверительной
...
Для выполнения примера в репозитории предполагается наличие контейнера
 ...
 в данном контейнере присутствует переменная LOWER_CONF_LEVEL.
...
В результате выполнения примера при расчёте задачи данные нижней доверительной
 границы будут выгружаться в переменную LOWER_CONF_LEVEL.
