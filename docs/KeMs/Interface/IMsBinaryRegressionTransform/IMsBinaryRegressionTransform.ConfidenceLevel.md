# IMsBinaryRegressionTransform.ConfidenceLevel
...
В результате выполнения примера значимость доверительных границ модели
 будет равна «0,9». После идентификации уравнения массив оцененных коэффициентов
 модели будет выведен в окно консоли.
