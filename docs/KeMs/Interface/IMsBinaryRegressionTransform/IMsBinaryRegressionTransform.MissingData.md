...
В результате выполнения примера для модели будет задан новый метод обработки
 пропусков: среднее по выборке. После идентификации уравнения массив оценённых
 коэффициентов модели будет выведен в окно консоли.
