...
Интерфейс IMsRFormulaTerm
 предназначен для работы с элементом выражения, используемым в модели «R».
...
Для настройки параметров модели «R»
 используйте интерфейс [IMsRTransform](../IMsRTransform/IMsRTransform.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Name](IMsRFormulaTerm.Name.htm)
		 Свойство Name
		 определяет наименование элемента выражения.
