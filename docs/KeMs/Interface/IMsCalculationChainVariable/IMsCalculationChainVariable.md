...
Интерфейс IMsCalculationChainVariable
 предназначен для работы с переменной, содержащейся в [цепочке
...
Для получения переменной приведите объект интерфейса [IMsCalculationChainEntry](../IMsCalculationChainEntry/IMsCalculationChainEntry.htm)
 к интерфейсу IMsCalculationChainVariable.
 Операция допустима, если [IMsCalculationChainEntry.Type](../IMsCalculationChainEntry/IMsCalculationChainEntry.Type.htm) = [MsCalculationChainEntryType.Variable](../../Enums/MsCalculationChainEntryType.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [FullName](IMsCalculationChainVariable.FullName.htm)
		 Свойство FullName возвращает
		 полное наименование переменной.


		 ![](../../Property_Image.gif)
		 [IsInternal](IMsCalculationChainVariable.IsInternal.htm)
		 Свойство IsInternal
		 определяет признак внутренности переменной по отношению
		 к [цепочке
		 расчёта](UiModelling.chm::/2_Container_of_Modeling/2_3_Work_object/2_3_3_MetaModel/uimodelling_metamodel_2.htm).


		 ![](../../Property_Image.gif)
		 [OriginalName](IMsCalculationChainVariable.OriginalName.htm)
		 Свойство OriginalName
		 возвращает исходное наименование переменной.


		 ![](../../Property_Image.gif)
		 [Slice](IMsCalculationChainVariable.Slice.htm)
