...
StartDate: [DateTime](ForeSys.chm::/Class/DateTime/DateTime.htm);
...
Метод возвращает натуральный логарифм ряда, если его начальная календарная
 точка меньше текущей даты.
