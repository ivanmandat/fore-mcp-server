...
Интерфейс IMsExpressionEdit
 предназначен для работы со свойствами и методами компонента среды разработки
 [MsExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MsExpressionEdit.htm).
...
События компонента [MsExpressionEdit](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MsExpressionEdit.htm)
 реализует класс [MsExpressionEdit](IMsExpressionEdit.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Expression](IMsExpressionEdit.Expression.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FormulaTermList](IMsExpressionEdit.FormulaTermList.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [FormulaTransform](IMsExpressionEdit.FormulaTransform.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [HeavyDelimiters](IMsExpressionEdit.HeavyDelimiters.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [LightDelimiters](IMsExpressionEdit.LightDelimiters.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MaxTermWordCount](IMsExpressionEdit.MaxTermWordCount.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Rubricator](IMsExpressionEdit.Rubricator.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [SelectionSet](IMsExpressionEdit.SelectionSet.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [UseFullVariableNames](IMsExpressionEdit.UseFullVariableNames.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [AddStub](IMsExpressionEdit.AddStub.htm)
		 Метод AddStub добавляет
		 куб в качестве источника данных MsExpressionEdit.


		 ![](../../Sub_Image.gif)
		 [AddAttribute](IMsExpressionEdit.AddAttribute.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ClearAttributes](IMsExpressionEdit.ClearAttributes.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetAttributeCount](IMsExpressionEdit.GetAttributeCount.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [RemoveAttribute](IMsExpressionEdit.RemoveAttribute.htm)
