...
Интерфейс IModelBox содержит
 свойства и методы компонента среды разработки - [ModelBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ModelBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ResultsViewScenario](IModelBox.ResultsViewScenario.htm)
		 Свойство ResultsViewScenario
		 определяет ключ сценария, по которому рассчитывается модель.


		 ![](../../Property_Image.gif)
		 [ResultsViewSelectionSet](IModelBox.ResultsViewSelectionSet.htm)
