...
Интерфейс IMsSlideSmoothingTransform
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CenterMovingAverage](IMsSlideSmoothingTransform.CenterMovingAverage.htm)


		 Свойство CenterMovingAverage
		 определяет, будет ли использоваться метод центрирования для расчета
		 средних значений.


		 ![](../../Property_Image.gif)
		 [Explained](IMsSlideSmoothingTransform.Explained.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MissingData](IMsSlideSmoothingTransform.MissingData.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Width](IMsSlideSmoothingTransform.Width.htm)
