...
Интерфейс IPCABox содержит свойства
 и методы компонента среды разработки - [PCABox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/PCABox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IPCABox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ModelSpace](IPCABox.ModelSpace.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [VariablesCount](IPCABox.VariablesCount.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [AddVariableStub](IPCABox.AddVariableStub.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ClearVariables](IPCABox.ClearVariables.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ExtractResults](IPCABox.ExtractResults.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [RemoveByIndex](IPCABox.RemoveByIndex.htm)
