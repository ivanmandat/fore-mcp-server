...
## Синтаксис
		...
		IterateByData: [IMsDimIterateByDataOptions](../IMsDimIterateByDataOptions/IMsDimIterateByDataOptions.htm);
...
Для настройки итераций по измерениям используйте свойство [IMsCalculationChainMultiDimIterator.Dimensions](IMsCalculationChainMultiDimIterator.Dimensions.htm).
...
Для выполнения примера в репозитории предполагается наличие контейнера
 ...
 на справочник». Справочник, на который ссылается атрибут CITY,
 должен содержать параметр логического типа с идентификатором ISCAPITAL.
