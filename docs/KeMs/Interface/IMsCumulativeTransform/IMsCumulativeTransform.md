...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CumulativeMethod](IMsCumulativeTransform.CumulativeMethod.htm)
		 Свойство CumulativeMethod
		 определяет метод накопления.


		 ![](../../Property_Image.gif)
		 [Input](IMsCumulativeTransform.Input.htm)
		 Свойство Input определяет
		 терм, соответствующий входной переменной.


		 ![](../../Property_Image.gif)
		 [Result](IMsCumulativeTransform.Result.htm)
