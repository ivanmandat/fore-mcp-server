...
Интерфейс IMsCalculationChainTargetConstraint
 предназначен для работы с ограничением целевой функции, содержащимся в
 [цепочке
...
Для получения целевой функции приведите объект интерфейса [IMsCalculationChainEntry](../IMsCalculationChainEntry/IMsCalculationChainEntry.htm)
 к интерфейсу IMsCalculationChainTargetConstraint.
 Операция допустима, если [IMsCalculationChainEntry.Type](../IMsCalculationChainEntry/IMsCalculationChainEntry.Type.htm) = [MsCalculationChainEntryType.TargetConstraint](../../Enums/MsCalculationChainEntryType.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Constraint](IMsCalculationChainTargetConstraint.Constraint.htm)
		 Свойство Constraint
		 возвращает параметры ограничения целевой функции.


		 ![](../../Property_Image.gif)
		 [TargetEntry](IMsCalculationChainTargetConstraint.TargetEntry.htm)
		 Свойство TargetEntry
		 возвращает из [цепочки
		 расчёта](UiModelling.chm::/2_Container_of_Modeling/2_3_Work_object/2_3_3_MetaModel/uimodelling_metamodel_2.htm) целевую функцию, которой
		 принадлежит ограничение.
