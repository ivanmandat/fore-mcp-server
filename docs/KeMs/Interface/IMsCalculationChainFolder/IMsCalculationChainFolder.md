...
Интерфейс IMsCalculationChainFolder
 содержит свойства папки в [цепочке
...
Для добавления папки в цепочку расчёта используйте метод [IMsCalculationChainEntries.AddFolder](../IMsCalculationChainEntries/IMsCalculationChainEntries.AddFolder.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Contents](IMsCalculationChainFolder.Contents.htm)
