# IMsErrorCorrectionModelTransform
...
Интерфейс IMsErrorCorrectionModelTransform
 содержит свойства и методы, определяющие параметры векторной модели коррекции
 ошибок.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [CointegralCount](IMsErrorCorrectionModelTransform.CointegralCount.htm)
		 Свойство CointegralCount
		 определяет число коинтеграционных связей модели.


		 ![](../../Property_Image.gif)
		 [MissingData](IMsErrorCorrectionModelTransform.MissingData.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ModelType](IMsErrorCorrectionModelTransform.ModelType.htm)
		 Свойство ModelType
...
[Интерфейсы сборки Ms](../KeMs_Interface.htm)
 | [IMsECMEquation](../IMsECMEquation/IMsECMEquation.htm)
