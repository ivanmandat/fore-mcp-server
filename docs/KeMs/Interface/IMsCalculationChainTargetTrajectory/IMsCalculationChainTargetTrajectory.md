...
Интерфейс IMsCalculationChainTargetTrajectory
 предназначен для работы с траекторией целевой функции, содержащейся в
 [цепочке
...
Для получения траектории целевой функции приведите объект интерфейса
 [IMsCalculationChainEntry](../IMsCalculationChainEntry/IMsCalculationChainEntry.htm)
 к интерфейсу IMsCalculationChainTargetTrajectory.
 Операция допустима, если [IMsCalculationChainEntry.Type](../IMsCalculationChainEntry/IMsCalculationChainEntry.Type.htm) = [MsCalculationChainEntryType.TargetTrajectory](../../Enums/MsCalculationChainEntryType.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [TargetEntry](IMsCalculationChainTargetTrajectory.TargetEntry.htm)
		 Свойство TargetEntry
		 возвращает целевую функцию, содержащуюся в [цепочке
		 расчёта](UiModelling.chm::/2_Container_of_Modeling/2_3_Work_object/2_3_3_MetaModel/uimodelling_metamodel_2.htm) метамодели, которой принадлежит траектория.
