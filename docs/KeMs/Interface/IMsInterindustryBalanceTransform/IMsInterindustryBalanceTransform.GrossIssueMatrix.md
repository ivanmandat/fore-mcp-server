# IMsInterindustryBalanceTransform.GrossIssueMatrix
...
GrossIssueMatrix: [IMsFormulaTerm](../IMsFormulaTerm/IMsFormulaTerm.htm);


## Описание


Свойство GrossIssueMatrix определяет
 терм, соответствующий переменной, на основе которой будет производиться
 расчет структуры конечного национального дохода.


## Комментарии


Используется при расчете III квадранта.
...
После выполнения примера в контейнере моделирования будет создана новая
 ...
 А. Также будет настроен расчет третьего квадранта. Структура конечного
 национального дохода будет рассчитываться на основе переменной с идентификатором
 VAR_11.
...
[IMsInterindustryBalanceTransform](IMsInterindustryBalanceTransform.htm)
 | [IMsInterindustryBalanceTransform.ThirdQuadrant](IMsInterindustryBalanceTransform.ThirdQuadrant.htm)
 | [IMsInterindustryBalanceTransform.NewGrossIssueMatrix](IMsInterindustryBalanceTransform.NewGrossIssueMatrix.htm)
