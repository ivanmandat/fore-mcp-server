...
Интерфейс IMsOptimizationFormulaTerm
...
Для настройки задачи оптимизации используйте интерфейс [IMsOptimizationProblem](../IMsOptimizationProblem/IMsOptimizationProblem.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [InitApproximation](IMsOptimizationFormulaTerm.InitApproximation.htm)
