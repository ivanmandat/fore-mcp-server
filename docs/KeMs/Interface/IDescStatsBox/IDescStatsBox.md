...
Интерфейс IDescStatsBox содержит
 свойства и методы компонента среды разработки - [DescStatsBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/DescStatsBox.htm).
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [AddVariableStub](IDescStatsBox.AddVariableStub.htm)
		 Метод AddVariableStub
		 осуществляет добавление в компонент переменной.


		 ![](../../Sub_Image.gif)
		 [AddVariableStubFixedSlice](IDescStatsBox.AddVariableStubFixedSlice.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [ClearVariables](IDescStatsBox.ClearVariables.htm)
		 Метод ClearVariables
		 осуществляет очистку списка переменных компонента.


		 ![](../../Sub_Image.gif)
		 [RemoveByIndex](IDescStatsBox.RemoveByIndex.htm)
		 Метод RemoveByIndex
