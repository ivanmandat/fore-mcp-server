...
Интерфейс IDmPivotTableDataSource
 предназначен для работы с таблицей данных, являющейся источником данных
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [PivotTable](IDmPivotTableDataSource.PivotTable.htm)
		 Свойство PivotTable
