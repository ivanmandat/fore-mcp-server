...
Интерфейс IMsChowTestSettings
 предназначен для работы с параметрами диагностического теста «Тесты Чоу».
...
«Тесты Чоу» применяется для проверки регрессионной однородности двух
 выборок данных. Для работы с параметрами данного теста приведите значение,
 возвращаемое свойством [IMsDiagnosticTest.Settings](../IMsDiagnosticTest/IMsDiagnosticTest.Settings.htm),
 к интерфейсу IMsChowTestSettings.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [GroupSeparator](IMsChowTestSettings.GroupSeparator.htm)
		 Свойство GroupSeparator
		 определяет разделение наблюдений объясняемого ряда на группы.


		 ![](../../Property_Image.gif)
		 [TestType](IMsChowTestSettings.TestType.htm)
