# IMsCalculationChainUserOptimization
...
Интерфейс IMsCalculationChainUserOptimization
 предназначен для работы с элементом цепочки расчёта метамодели, который
 соответствует пользовательской задаче оптимизации.
...
Элемент цепочки расчёта можно получить, используя свойства и методы
 интерфейса [IMsCalculationChainEntries](../IMsCalculationChainEntries/IMsCalculationChainEntries.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [UserOptimizationProblem](IMsCalculationChainUserOptimization.UserOptimizationProblem.htm)


		 Свойство UserOptimizationProblem
		 возвращает пользовательскую задачу оптимизации, которой соответствует
		 текущий элемент цепочки расчёта.
