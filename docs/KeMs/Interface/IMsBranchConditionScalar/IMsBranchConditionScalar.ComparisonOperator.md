# IMsBranchConditionScalar.ComparisonOperator
...
## Синтаксис
		...
		ComparisonOperator: [MsBranchConditionComparisonOperator](../../Enums/MsBranchConditionComparisonOperator.htm);


## Описание


Свойство ComparisonOperator
 определяет оператор сравнения в условии.
...
[IMsBranchConditionScalar](IMsBranchConditionScalar.htm)
