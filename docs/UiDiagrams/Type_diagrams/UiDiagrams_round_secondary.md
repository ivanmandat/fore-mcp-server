...
Вторичная круговая диаграмма
 - [круговая диаграмма](UiDiagrams_round.htm) с частью значений,
 вынесенных во вторую диаграмму.


![](Type%20pics/Type_4_Round_1.gif)


Примечание.
 В веб-приложении вторичная круговая диаграмма отображается в виде картинки.


В режиме редактирования доступно изменение следующих параметров диаграммы:
...
[Типы диаграмм](UiDiagrams_Type_diagrams.htm)
 | [Круговая
 диаграмма](UiDiagrams_round.htm) | [Настройка
 вторичной диаграммы](../Params_diagram/UiDiagrams_secondary_diagram.htm) | [Настройка
