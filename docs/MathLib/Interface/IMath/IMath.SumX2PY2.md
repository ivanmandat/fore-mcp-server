...
Метод SumX2PY2 возвращает сумму
 сумм квадратов соответствующих значений в двух массивах.


## Комментарии


Массивы X и Y должны быть одинаковой размерности.
