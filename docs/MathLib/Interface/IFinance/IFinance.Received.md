...
Received(Settlement: DateTime; Maturity:
DateTime; Investment: Double; Discount: Double; [Basis: Integer
= 0]): Double;
...
Discount. Скидка на ценную бумагу. Должен принадлежать промежутку [0, B/DIM],
 где B - количество дней в году
 и DIM - количество дней от даты
 выпуска до даты погашения;
...
Метод Received возвращает сумму,
 полученную к сроку погашения полностью обеспеченных ценных бумаг.


## Комментарии


Recieved вычисляется следующим
 образом:
