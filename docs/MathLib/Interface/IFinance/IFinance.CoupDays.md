...
CoupDays(Settlement: DateTime; Maturity:
...
Метод CoupDays возвращает число
 дней в периоде купона, который содержит дату расчета.
...
В результате выполнения примера в окно консоли будет выведено количество
 дней в периоде купона, равное 90.
