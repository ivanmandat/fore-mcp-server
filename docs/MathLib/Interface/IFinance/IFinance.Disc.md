...
Disc(Settlement: DateTime; Maturity: DateTime;
NominalCost: Double; Redemption: Double; [Basis: Integer = 0]):
Double;
...
Метод Disc возвращает ставку
 дисконтирования для ценных бумаг.
...
Дата соглашения является датой продажи покупателю купона, например,
 ...
 датой соглашения - 1 июля 2008, а сроком погашения такой облигации - 1
 января 2038 года, то есть через 30 лет после даты выпуска.
...
где:
	...
	- DSM. Число дней между
	 датами Settlement и Maturity.
...
В результате выполнения примера в окно консоли будет выведена ставка
 дисконтирования, равная -2.4.
