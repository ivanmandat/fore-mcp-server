...
Класс SpeedometerBox реализует
 компонент среды разработки [SpeedometerBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/SpeedometerBox.htm),
 используемый для отображения какой-либо информации на панели, оформленной
 в виде спидометра.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/ISpeedometerBox/ISpeedometerBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Speedometer](../../Interface/ISpeedometerBox/ISpeedometerBox.Speedometer.htm)
		 Свойство Speedometer
		 возвращает параметры спидометра, отображаемого в компоненте.
...
[Классы сборки Speedometer](../Speedometer_Classes.htm)
