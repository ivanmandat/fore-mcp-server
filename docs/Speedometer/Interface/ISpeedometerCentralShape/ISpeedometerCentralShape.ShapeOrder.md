...
ShapeOrder: [SpeedometerArrowCircleOrder](../../Enums/SpeedometerArrowCircleOrder.htm);


## Описание


Свойство ShapeOrder определяет
 порядок расположения круга относительно стрелки.
...
После выполнения примера при нажатии на кнопку будет настроено оформление
 ...
 Для круга будет настроено градиентная заливка фона, сам круг будет расположен
