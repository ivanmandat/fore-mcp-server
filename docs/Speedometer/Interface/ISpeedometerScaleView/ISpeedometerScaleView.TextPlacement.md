...
TextPlacement: [SpeedometerTextPlacementType](../../Enums/SpeedometerTextPlacementType.htm);


## Описание


Свойство TextPlacement определяет
 размещение текста значений делений шкалы относительно самих делений.
