# ISpeedometerScaleView.MinorTickInfo
...
MinorTickInfo: [ISpeedometerTickInfo](../ISpeedometerTickInfo/ISpeedometerTickInfo.htm);


## Описание


Свойство MinorTickInfo возвращает
 параметры дополнительных делений шкалы.
...
После выполнения примера при нажатии на кнопку будет изменено оформление
 дополнительных делений шкалы спидометра, отображаемого в компоненте «SpeedometerBox1».


![](ISpeedometerScaleView_MinorTickInfo.gif)
