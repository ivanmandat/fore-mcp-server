...
Item(Index: Integer): [ISpeedometerBar](../ISpeedometerBar/ISpeedometerBar.htm);


## Параметры


Index - индекс сегмента, параметры
...
Свойство Item возвращает параметры
 сегмента, индекс которого передается посредством параметра Index.
...
[ISpeedometerBars](ISpeedometerBars.htm)
