...
Item(Index: Integer): [ISpeedometerScale](../ISpeedometerScale/ISpeedometerScale.htm);


## Параметры


Index - индекс шкалы, параметры
...
Свойство Item возвращает параметры
 шкалы, индекс которой передается посредством параметра Index.
