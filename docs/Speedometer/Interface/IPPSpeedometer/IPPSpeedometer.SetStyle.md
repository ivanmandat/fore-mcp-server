...
SetStyle(style: [PPSpeedometerStyle](../../Enums/PPSpeedometerStyle.htm));


## Параметры


style. Стиль оформления спидометра.


## Описание


Метод SetStyle применяет указанный
 стиль оформления спидометра.
...
Добавьте ссылки на системные сборки: Adhoc, Express, Metabase и Speedometer.
	...
	    Speedometer.SetStyle(PPSpeedometerStyle.Style3);
...
В результате выполнения примера будет применен указанный стиль оформления
 спидометра.
