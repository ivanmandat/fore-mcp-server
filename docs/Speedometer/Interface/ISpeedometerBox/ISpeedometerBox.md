...
Интерфейс ISpeedometerBox содержит
 свойства и методы компонента среды разработки - [SpeedometerBox](UiDevEnv.chm::/02_Components_constructor_forms/02_Additional_components/SpeedometerBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](ISpeedometerBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Speedometer](ISpeedometerBox.Speedometer.htm)
...
[Интерфейсы сборки Speedometer](../Speedometer_InterfaseList.htm)
