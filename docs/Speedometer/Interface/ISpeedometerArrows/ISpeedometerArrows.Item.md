...
Item(Index: Integer): [ISpeedometerArrow](../ISpeedometerArrow/ISpeedometerArrow.htm);


## Параметры


Index - индекс стрелки, параметры
...
Свойство Item возвращает параметры
 стрелки, индекс которой передается посредством параметра Index.
