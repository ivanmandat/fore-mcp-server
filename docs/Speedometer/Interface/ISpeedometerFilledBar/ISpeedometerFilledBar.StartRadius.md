# ISpeedometerFilledBar.StartRadius
...
Свойство StartRadius определяет
 начальный ограничивающий радиус полосы.


## Комментарии


Это относительная величина (отношение текущего радиуса к расстоянию
 от внутренней границы шкалы до центра сектора, описывающего шкалу). Значение
 радиус задается в интервале [0, 1].
...
[ISpeedometerFilledBar](ISpeedometerFilledBar.htm)
