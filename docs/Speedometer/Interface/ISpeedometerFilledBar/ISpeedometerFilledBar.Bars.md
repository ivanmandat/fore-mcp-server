...
Bars: [ISpeedometerBars](../ISpeedometerBars/ISpeedometerBars.htm);


## Описание


Свойство Bars возвращает коллекцию
 сегментов цветной интервальной полосы спидометра.
