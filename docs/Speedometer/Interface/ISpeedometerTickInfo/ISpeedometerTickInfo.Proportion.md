# ISpeedometerTickInfo.Proportion
...
Свойство Proportion определяет
 отношение высоты к ширине деления.


Примечание.
 В зависимости от выбранной формы делений, данное свойство определяет соотношение
 различных элементов формы. Более подробно смотрите в описании определенных
 форм перечислимого типа [SpeedometerTickShapes](../../Enums/SpeedometerTickShapes.htm).
