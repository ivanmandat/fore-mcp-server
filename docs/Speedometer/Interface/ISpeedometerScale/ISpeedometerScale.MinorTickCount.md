# ISpeedometerScale.MinorTickCount
...
Свойство MinorTickCount определяет
 количество дополнительных делений шкалы.


## Комментарии


Данное свойство определяет количество делений, отображаемых между любыми
 двумя основными делениями.
