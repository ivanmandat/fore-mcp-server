...
CreateSourceCoord(Source: [ICubeInstanceSource](../ICalculatedCubeSource/ICalculatedCubeSource.htm)):
 [ICalculatedCubeInstanceCoord](../ICalculatedCubeInstanceCoord/ICalculatedCubeInstanceCoord.htm);


## Параметры


Source. Куб-источник, для которого
 необходимо создать координату.


## Описание


Метод CreateSourceCoord создаёт
 объект, представляющий собой координату в кубе-источнике данных для вычисляемого
 куба.
