# IMDCalculationInstance.Sources
...
Sources: [IMDCalculationSourcesInstance](../IMDCalculationSourcesInstance/IMDCalculationSourcesInstance.htm);
...
Свойство Sources возвращает
 данные отстроенных источников данных, участвующих в многомерном расчете
 на сервере БД.
