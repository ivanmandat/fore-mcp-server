# IMDCalculationInstance.Destination
...
Destination: [IMDCalculationDestinationInstance](../IMDCalculationDestinationInstance/IMDCalculationDestinationInstance.htm);
...
Свойство Destination возвращает
 данные отстроенного приёмника данных, участвующего в многомерном расчёте
 на сервере БД.
...
После выполнения примера будет задана формула для элемента, соответствующего
 первым элементам измерений приёмника данных. Значение по координате в
