# IMDCalculationFormulaElement.Key
...
Свойство Key определяет уникальный
 ключ, соответствующий элементу, который используется в качестве операнда
 в формуле.
...
После выполнения примера будет задана формула для элемента, соответствующего
 ...
 на 3,14. Данные будут сохраняться по первому показателю приёмника.
