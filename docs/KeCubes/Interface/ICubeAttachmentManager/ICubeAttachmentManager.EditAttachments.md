# ICubeAttachmentManager.EditAttachments
...
EditAttachments(Iterator: [IMatrixModelIterator](ForeSys.chm::/Interface/IMatrixModelIterator/IMatrixModelIterator.htm)):
 [ICubeAttachmentsEdited](../ICubeAttachmentsEdited/ICubeAttachmentsEdited.htm);
...
Метод EditAttachments открывает
 список вложений на редактирование.
...
При выполнении примера будет вычислена результирующая матрица куба и
 ...
 по матрице. По первой доступной координате будут созданы три различных
