...
SupportedDataRights: [CubeDataRights](../../Enums/CubeDataRights.htm);


## Описание


Свойство SupportedDataRights
 возвращает запрошенные права доступа на данные.
...
После выполнения примера будут получены данные показателя с ключом «125616»,
 на которые есть доступ для чтения и записи. Если запрашиваемые и фактические
 права на доступ к точке совпадают, то её данные будут изменены и сохранены.
