...
CreateItem(Kind: [MDCalculationFormulaOperandKind](../../Enums/MDCalculationFormulaOperandKind.htm)):
 [IMDCalculationFormulaOperand](../IMDCalculationFormulaOperand/IMDCalculationFormulaOperand.htm);


## Параметры


Kind. Вид операнда, который
 необходимо создать.
...
Метод CreateItem создает новый
 операнд формулы.
...
[IMDCalculationFormulaExpression](IMDCalculationFormulaExpression.htm)
