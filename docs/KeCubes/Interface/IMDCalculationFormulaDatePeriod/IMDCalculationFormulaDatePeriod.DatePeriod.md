# IMDCalculationFormulaDatePeriod.DatePeriod
...
DatePeriod: [MDCalculationFormulaDatePeriod](../../Enums/MDCalculationFormulaDatePeriod.htm);


## Описание


Свойство DatePeriod определяет
 период в календаре, по которому будет осуществляться смещение с помощью
 функции [Shift](UiMd.chm::/Cube/Work_Cube/UiMd_CubeWork_MultivariateAccount_Functions.htm).
...
[IMDCalculationFormulaDatePeriod](IMDCalculationFormulaDatePeriod.htm)
