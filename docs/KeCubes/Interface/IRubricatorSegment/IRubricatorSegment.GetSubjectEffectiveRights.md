...
Метод GetSubjectEffectiveRights
 возвращает эффективные права указанного пользователя.
...
После выполнения примера эффективные права пользователя ADMIN на первый
 сегмент данных будут выведены в окно консоли в десятичной форме.
