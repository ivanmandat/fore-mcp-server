...
Свойство CalendarLevel определяет
 тип динамики данных временного ряда.
...
После выполнения примера для указанного показателя будут изменены календарная
 динамика и единицы измерения. В окно консоли будет выведена информация
 о временном ряде.
