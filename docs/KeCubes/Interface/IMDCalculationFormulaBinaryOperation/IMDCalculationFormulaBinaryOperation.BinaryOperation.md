# IMDCalculationFormulaBinaryOperation.BinaryOperation
...
BinaryOperation: [MDCalculationFormulaBinaryOperation](../../Enums/MDCalculationFormulaBinaryOperation.htm);


## Описание


Свойство BinaryOperation определяет
 вид бинарной операции, которая используется как операнд в формуле.
...
[IMDCalculationFormulaBinaryOperation](IMDCalculationFormulaBinaryOperation.htm)
