...
Свойство DateEnd определяет
 дату окончания периода расчёта.
...
Для выполнения примера предполагается наличие в репозитории многомерного
 расчёта на сервере БД с идентификатором "MDCalc_1". Календарные
 измерения источников данных зафиксированы.
