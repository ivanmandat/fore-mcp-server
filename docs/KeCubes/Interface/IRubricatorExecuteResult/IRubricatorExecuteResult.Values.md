# IRubricatorExecuteResult.Values
...
Values: [IMatrix](KeMatrix.chm::/Interface/IMatrix/IMatrix.htm);


## Описание


Свойство Values возвращает матрицу
 значений базы данных временных рядов.
...
После выполнения примера в переменной MatRes будет находиться матрица,
 содержащая значения показателей базы.
