...
Item(Index: Integer): [IRubricatorSegment](../IRubricatorSegment/IRubricatorSegment.htm);


## Параметры


Index. Индекс сегмента данных
 в коллекции.
