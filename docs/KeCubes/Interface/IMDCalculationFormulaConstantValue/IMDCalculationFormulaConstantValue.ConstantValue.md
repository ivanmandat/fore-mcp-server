# IMDCalculationFormulaConstantValue.ConstantValue
...
Свойство ConstantValue определяет
 вещественное значение, которое используется как операнд в формуле.
...
[IMDCalculationFormulaConstantValue](IMDCalculationFormulaConstantValue.htm)
