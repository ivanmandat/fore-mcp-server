...
Для выбора режима загрузки временных рядов используйте свойство [ICubeMetaLoader.LoadType](ICubeMetaLoader.LoadType.htm).
...
Для выполнения примера в репозитории предполагается наличие базы данных
 временных рядов с идентификатором «TSDB_IMP», содержащей обязательные
 пользовательские атрибуты с идентификаторами «CITY» и «INDICATOR». Данные
 атрибуты должны являться ссылками на справочник. В дочернем контейнере
 моделирования базы данных временных рядов должно быть создано несколько
 сценариев.
...
В результате выполнения примера в базу данных временных рядов будут
 импортированы данные из файла «D:\res_export.txt» на первый сценарий,
 дублирующие данные будут исключены.
