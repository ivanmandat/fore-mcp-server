# IMDCalculationFormulaDelimiter.Delimiter
...
Delimiter: [MDCalculationFormulaDelimiter](../../Enums/MDCalculationFormulaDelimiter.htm);


## Описание


Свойство Delimiter определяет
 вид разделителя, который используется как операнд в формуле.
...
[IMDCalculationFormulaDelimiter](IMDCalculationFormulaDelimiter.htm)
