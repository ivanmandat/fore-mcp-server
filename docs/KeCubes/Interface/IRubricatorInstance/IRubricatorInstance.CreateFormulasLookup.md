# IRubricatorInstance.CreateFormulasLookup
...
CreateFormulasLookup: [IRubricatorFormulasLookup](../IRubricatorFormulasLookup/IRubricatorFormulasLookup.htm);


## Описание


Метод CreateFormulasLookup создает
 объект, осуществляющий поиск формул.
