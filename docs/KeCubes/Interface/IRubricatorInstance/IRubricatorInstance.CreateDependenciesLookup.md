# IRubricatorInstance.CreateDependenciesLookup
...
CreateDependenciesLookup: [IRubricatorFactorDependenciesLookup](../IRubricatorFactorDependenciesLookup/IRubricatorFactorDependenciesLookup.htm);
...
Метод CreateDependenciesLookup
 создает объект, осуществляющий поиск зависимостей показателей в базе данных
 временных рядов.
...
Для выполнения примера в репозитории должна присутствовать базы данных
