# IRubricatorInstance.CreateObservationsLookup
...
CreateObservationsLookup(FactData: [IRubricatorFactData](../IRubricatorFactData/IRubricatorFactData.htm)):
...
FactData. Данные показателей,
 среди которых должен быть осуществлен поиск.
