# IVariableStubExecuteResult.Origin
...
Свойство Origin возвращает ключ
 объекта, инициирующего изменения матрицы с загруженными данными источника.
...
Пример обработчика процесса сохранения данных в куб с использованием
 свойства [ICubeCallbackSaveArgument.Origin](../ICubeCallbackSaveArgument/ICubeCallbackSaveArgument.Origin.htm):
