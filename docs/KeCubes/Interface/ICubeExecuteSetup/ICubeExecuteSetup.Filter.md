...
Filter: [ICubeExecuteFilterSetup](../ICubeExecuteFilterSetup/ICubeExecuteFilterSetup.htm);
...
Свойство Filter возвращает коллекцию
 фильтров по измерениям, которые будут применяться при расчете куба.
...
Для выполнения примера предполагается наличие в репозитории каталога
 ...
 ADOMD с идентификаторами DATE и COUNTRY, в измерении фактов имеется показатель
