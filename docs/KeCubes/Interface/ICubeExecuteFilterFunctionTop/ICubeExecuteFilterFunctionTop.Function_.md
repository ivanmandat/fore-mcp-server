...
Свойство Function_ определяет
 функцию, осуществляющую фильтрацию путем отбора наибольших/наименьших
 значений.
...
Описание указанных функций доступно в документации по языку многомерных
 запросов MDX.
...
При выполнении примера будет осуществлена подготовка и расчет указанного
 ...
 в набор попадут только максимальные значения, сумма которых составляет
 не менее 10000.
...
[ICubeExecuteFilterFunctionTop](ICubeExecuteFilterFunctionTop.htm)
