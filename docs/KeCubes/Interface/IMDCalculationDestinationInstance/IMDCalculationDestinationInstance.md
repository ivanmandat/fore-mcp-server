# IMDCalculationDestinationInstance
...
Интерфейс IMDCalculationDestinationInstance
 содержит свойства и методы для работы с отстроенным приёмником данных
 многомерного расчёта на сервере БД.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [FixedSlices](IMDCalculationDestinationInstance.FixedSlices.htm)
		 Свойство FixedSlices
		 возвращает коллекцию фиксированных срезов приёмника данных.
