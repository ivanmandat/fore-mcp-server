# IStandardCubeInstance.CreateAggregator
...
CreateAggregator: [IStandardCubeServerAggregator](../IStandardCubeServerAggregator/IStandardCubeServerAggregator.htm);


## Описание


Метод CreateAggregator создает
 объект, позволяющий настроить параметры расчета агрегации на сервере.
...
[IStandardCubeInstance](IStandardCubeInstance.htm)
