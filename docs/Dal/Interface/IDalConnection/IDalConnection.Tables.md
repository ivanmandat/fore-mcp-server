...
Tables(TableName: String): [IDalTables](../IDalTables/IDalTables.htm);
...
Свойство Tables возвращает курсор,
 содержащий системную информацию об указанной таблице.
...
При выполнении примера будет осуществлено подключение к репозиторию
 ...
 курсор с параметрами таблицы «DataTable». Информация о параметрах и их
