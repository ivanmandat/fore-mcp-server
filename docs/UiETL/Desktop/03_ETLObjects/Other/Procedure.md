# Процедура: Задача ETL, настольное приложение
...
«Процедура» - объект, предназначенный
 для выполнения процедур/функций, реализованных на языке Fore в модулях/формах/сборках
 репозитория.
...
На странице мастера «Настройка выполнения»
 выполните следующие действия:


	- Укажите объект текущего репозитория «Форма»,
	 «Модуль» или «Сборка»,
	 который необходимо выполнить.


	- Выберите процедуру/функцию, которая будет выполняться.


![](Procedure.gif)


В списке доступных будут процедуры и функции без параметров или с параметрами
 простых типов. Кнопка «Обновить список
 параметров» позволяет обновить список доступных параметров в соответствии
 с сигнатурой выбранной процедуры/функции. Для каждого параметра будет
 доступен редактор, позволяющий задать значение. Значения параметров будут
 переданы в процедуру/функцию при выполнении.
