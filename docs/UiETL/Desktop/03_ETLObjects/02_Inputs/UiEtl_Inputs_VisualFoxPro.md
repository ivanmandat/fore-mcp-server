# Источник данных «Visual FoxPro»: Задача ETL, настольное приложение
...
# Visual FoxPro
	...
	Коннектор «Visual FoxPro» -
     объект, предназначенный для извлечения данных из базы данных Visual FoxPro.
...
## Настройка импорта
	...
	![](UiEtl_Inputs_VisualFoxPro.gif)


	Переключатели «База данных Visual FoxPro»
     и «Каталог со свободными файлами Visual
     FoxPro» определяют тип источника.


	Выберите файл из базы данных Visual FoxPro, либо из каталога свободных
	 файлов Visual FoxPro.
