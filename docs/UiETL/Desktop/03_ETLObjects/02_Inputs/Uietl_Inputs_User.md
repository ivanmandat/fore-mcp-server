# Источник данных «Источник пользователя»: Задача ETL, настольное приложение
...
# Источник пользователя
	...
	Коннектор «Источник пользователя»
	 ...
	 [Fore](../../04_Work/Templates/Provider_Template.htm)
	 и содержаться в модуле в текущем репозитории.
...
## Класс пользователя
	...
	Для указания объекта среды разработки, в котором реализован импортёр
	 данных, используйте страницу «Класс
	 пользователя».


	![](Uietl_Inputs_User.gif)
