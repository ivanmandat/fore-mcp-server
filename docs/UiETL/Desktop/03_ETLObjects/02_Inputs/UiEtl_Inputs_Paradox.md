# Источник данных «Paradox»: Задача ETL, настольное приложение
...
# Paradox
	...
	Коннектор «Paradox» - объект
	 предназначенный для извлечения данных из базы данных «Paradox».
...
## Настройка импорта
	...
	![](UiEtl_Inputs_Paradox.gif)


	Укажите каталог с файлами Paradox и драйвер для соответствующей версии
     Paradox.
