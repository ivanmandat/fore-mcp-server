# Приёмник данных «Приёмник пользователя»: Задача ETL, настольное приложение

Приёмник данных «Приёмник пользователя»: Задача ETL, настольное приложение
-


# Приёмник пользователя


	Коннектор «Приёмник пользователя»
	...
	После добавления коннектора на рабочее пространство задачи ETL задайте
	 базовые свойства и класс с реализацией экспорта данных. Также можно
	 отредактировать вход и выход коннектора.
...
## Класс пользователя
	...
	![](../UiEtl_Outputs_User.gif)


	В раскрывающемся списке «Модуль»
	 выберите модуль/форму/сборку, а в раскрывающемся списке «Класс»
	 выберите класс, в котором содержится реализация пользовательского
	 алгоритма получения данных. Класс должен быть унаследован и содержать
	 реализацию интерфейса [IDtRecordsetConsumer](KeDt.chm::/Interface/IDtRecordsetConsumer/IDtRecordsetConsumer.htm)
