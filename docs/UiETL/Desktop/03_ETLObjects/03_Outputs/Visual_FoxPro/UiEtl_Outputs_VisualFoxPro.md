# Приёмник данных «Visual FoxPro»: Задача ETL, настольное приложение
...
# Visual FoxPro
	...
	Коннектор «Visual FoxPro»
	 - объект, предназначенный для экспорта данных в базу данных Visual
	 FoxPro.
	...
	После добавления коннектора на рабочее пространство задачи ETL задайте
	 ...
	 вход, выход коннектора и задать параметры обработки ошибок.
...
## Настройка экспорта
	...
	На странице «Настройка экспорта»
	 указываются файлы для экспорта данных.


	![](../UiEtl_Outputs_VisualFoxPro.gif)


	Установите переключатель, соответствующий типу приёмника: «База данных Visual FoxPro» или «Каталог со свободными файлами Visual FoxPro».


	Укажите путь к базе данных или каталогу с файлами Visual FoxPro.


	В раскрывающемся списке «Таблица»
	 укажите одну из таблиц Visual FoxPro, которая будет являться приёмником
	 данных.


	Установка флажка «Очищать приёмник
	 перед загрузкой» позволяет удалить всю информация из таблицы-приёмника
