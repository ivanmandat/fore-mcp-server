# Приёмник данных «Dbase»: Задача ETL, настольное приложение
...
# Dbase
	...
	Коннектор «Dbase» - объект,
	 предназначенный для экспорта данных в файлы форматов DBase III, DBase
	 IV, DBase 5 и VFPOLEDB.1 (*.dbf).
...
## Настройка экспорта
	...
	![](../UiEtl_outputs_Dbase.gif)


	Укажите каталог-приёмник с файлами Dbase и драйвер для соответствующей
	 версии Dbase.
