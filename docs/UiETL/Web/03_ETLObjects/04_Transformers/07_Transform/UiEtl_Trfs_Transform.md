# Преобразователь «Преобразование»: Задача ETL, веб-приложение
...
# Преобразование
	...
	Объект «Преобразование»
	 из группы «[Преобразователи](../UiEtl_Trfs.htm)»
	 предназначен для преобразования данных с использованием формул, задаваемых
	 пользователем. Объект «Преобразование»
	 имеет один вход и один выход.


	При использовании преобразователя «Преобразование»
	 из таблицы:
	...
	Таким образом, значение поля «Value»
...
## Преобразование данных
	...
	Для сопоставления полей входа и выхода и настройки формул преобразования
	 данных:
		...
		- На панели дополнительных настроек преобразователя перейдите
		 на вкладку «Преобразование данных».


	После выполнения действий будет отображена вкладка «Преобразование
	 данных»:


	![](UiETL_Trsf_Trsf_Link.png)
	...
	Действия со связями полей:
		...
		- Автоматическое создание
		 ...
		 всеми входными и выходными полями, имеющими одинаковые идентификаторы.
		 Для автоматического создания связей нажмите кнопку «Автоматически»;
		...
		- Создание связи полей.
		 ...
		 поле входа в область необходимого поля выхода.


		- Редактирование связи полей.
		 Позволяет редактировать формулу преобразования выходного значения
		 с помощью редактора выражения. Для редактирования формулы наведите
		 курсор мыши на поле выхода и нажмите кнопку ![](../button_edit_formula.png)
		 «Редактировать выражение».
		 При нажатии на кнопку откроется окно .


		- Удаление связей.
		 Для удаления связи между входным и выходным полями наведите курсор
		 мыши на поле выхода и нажмите кнопку ![](../button_delete.png) «Очистка выражения». Для удаления
		 всех связей между всеми полями нажмите кнопку «Очистить
		 все».
