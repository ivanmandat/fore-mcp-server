...
Класс AdmBox реализует контейнер
...
PP.initClass(PP.Ui.AdmBox, [Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.AdmBox");
...
## Конструктор
			 ...
			 AdmBox
			 Конструктор AdmBox**
			 создаёт экземпляр класса **AdmBox**. Находится в разработке.
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [Repository](AdmBox.Repository.htm)
		 Свойство Repository
		 определяет репозиторий, используемый в менеджере безопасности.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Close](AdmBox.Close.htm)
		 Событие Close наступает
		 при закрытии менеджера безопасности.


		 ![](../../../Event_Image.gif)
		 [Exit](AdmBox.Exit.htm)
		 Событие Exit наступает
		 при выходе из менеджера безопасности.


		 ![](../../../Event_Image.gif)
		 [Open](AdmBox.Open.htm)
		 Событие Open наступает
		 при входе в менеджер безопасности.
