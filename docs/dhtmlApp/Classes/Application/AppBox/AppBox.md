...
Класс AppBox реализует контейнер
...
PP.initClass(PP.Application.AppBox, [PP.Ui.Container](dhtmlUi.chm::/Classes/Container/Container.htm),
 "PP.Application.AppBox");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [AppBox](Constructor_AppBox.htm)
		 Конструктор AppBox**
		 создаёт экземпляр класса **AppBox**.
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [ModuleHeight](dhtmlApp.chm::/Classes/Application/AppBox/AppBox.ModuleHeight.htm)
		 Свойство ModuleHeight
		 определяет высоту контейнера веб-приложения «Форсайт. Аналитическая платформа».


		 ![](../../../property_image.gif)
		 [ShowAddressBar](dhtmlApp.chm::/Classes/Application/AppBox/AppBox.ShowAddressBar.htm)
		 Свойство ShowAddressBar
		 определяет признак отображения адресной строки веб-приложения
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getAddressBar](dhtmlApp.chm::/Classes/Application/AppBox/AppBox.getAddressBar.htm)
		 Метод getAddressBar
		 возвращает адресную строку веб-приложения «Форсайт. Аналитическая платформа».


		 ![](../../../sub_image.gif)
		 [getModuleContainer](dhtmlApp.chm::/Classes/Application/AppBox/AppBox.getModuleContainer.htm)
		 Метод getModuleContainer
		 возвращает панель контейнера веб-приложения «Форсайт. Аналитическая платформа».
