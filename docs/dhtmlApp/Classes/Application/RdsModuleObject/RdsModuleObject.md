...
Класс RdsModuleObject реализует
 объект модуля с загруженным в него контейнером для отображения и редактирования
 справочников НСИ.
...
PP.initClass(PP.Application.RdsModuleObject, [PP.Application.ModuleObject](../ModuleObject/ModuleObject.htm),
 "PP.Application.RdsModuleObject");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [RdsModuleObject](Constructor_RdsModuleObject.htm)
		 Конструктор RdsModuleObject
		 создает экземпляр класса RdsModuleObject.
