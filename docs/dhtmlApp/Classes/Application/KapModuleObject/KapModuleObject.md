...
Класс KapModuleObject реализует
 объект модуля с загруженной в него аналитической панелью.


## Синтаксис


PP.initClass(PP.Application.KapModuleObject, [PP.Application.ModuleObject](../ModuleObject/ModuleObject.htm),
 "PP.Application.KapModuleObject");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [KapModuleObject](Constructor_KapModuleObject.htm)
		 Конструктор KapModuleObject
		 создает экземпляр класса KapModuleObject.
