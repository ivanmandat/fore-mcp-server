...
[InfoWindow](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.htm)
...
Класс LoginForm реализует окно
 входа в систему.
...
Страница со входом в систему выглядит следующим образом:
...
PP.initClass(PP.Application.LoginForm, [PP.Ui.InfoWindow](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.htm),
 "PP.Application.LoginForm");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [LoginForm](Constructor_LoginForm.htm)
		 Конструктор LoginForm
		 создает экземпляр класса LoginForm.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [checkPwdPolicy](dhtmlApp.chm::/Classes/Application/LoginForm/LoginForm.checkPwdPolicy.htm)
		 Метод checkPwdPolicy
		 проверяет, удовлетворяет ли пароль требованиям политики безопасности.


		 ![](../../../sub_image.gif)
		 [getMetabaseConfig](dhtmlApp.chm::/Classes/Application/LoginForm/LoginForm.getMetabaseConfig.htm)
		 Метод getMetabaseConfig
		 возвращает параметры конфигурации репозитория.


		 ![](../../../sub_image.gif)
		 [setError](dhtmlApp.chm::/Classes/Application/LoginForm/LoginForm.setError.htm)
		 Метод setError отображает
		 сообщение об ошибке в окне входа в систему.


## Методы, унаследованные от класса [InfoWindow](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.htm)
		 ...
		 ![](../../../sub_image.gif)
		 [addPanel](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.addPanel.htm)
		 Метод addPanel добавляет
		 панель в информационное окно.


		 ![](../../../sub_image.gif)
		 [addToButtonContent](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.addToButtonContent.htm)
		 Метод addToButtonContent
		 добавляет элемент управления в информационное окно на место, отведенное
		 для кнопок.


		 ![](../../../sub_image.gif)
		 [getPanels](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.getPanels.htm)
		 Метод getPanels возвращает
		 панели информационного окна.


		 ![](../../../sub_image.gif)
		 [hidePanel](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.hidePanel.htm)
		 Метод hidePanel скрывает
		 панель в информационном окне.


		 ![](../../../sub_image.gif)
		 [removePanel](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.removePanel.htm)
		 Метод removePanel удаляет
		 панель информационного окна.


		 ![](../../../sub_image.gif)
		 [showCenter](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.showCenter.htm)
		 Метод showCenter открывает
		 информационное окно в центре экрана.


		 ![](../../../sub_image.gif)
		 [showPanel](dhtmlUi.chm::/Classes/InfoWindow/InfoWindow.showPanel.htm)
		 Метод showPanel отображает
		 панель в информационном окне.
