...
[EaxModuleObject](../EaxModuleObject/EaxModuleObject.htm)
...
Класс TSModuleObject реализует
 объект модуля с загруженной в неё рабочей книгой.


## Синтаксис


PP.initClass(PP.Application.TSModuleObject, [PP.Application.EaxModuleObject](../EaxModuleObject/EaxModuleObject.htm),
 "PP.Application.TSModuleObject");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [TSModuleObject](Constructor_TSModuleObject.htm)
		 Конструктор TSModuleObject
		 создает экземпляр класса TSModuleObject.
