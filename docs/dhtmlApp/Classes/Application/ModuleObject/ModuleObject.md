...
Класс ModuleObject представляет
 собой базовый класс объекта модуля.


## Синтаксис


PP.initClass(PP.Application.ModuleObject, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Application.ModuleObject");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [ModuleObject](Constructor_ModuleObject.htm)
		 Конструктор ModuleObject
		 создаёт экземпляр класса ModuleObject.
