...
Класс NavModuleObject реализует
 объект модуля с загруженным в него навигатором объектов репозитория.


## Синтаксис


PP.initClass(PP.Application.NavModuleObject, [PP.Application.ModuleObject](../ModuleObject/ModuleObject.htm),
 "PP.Application.NavModuleObject");
...
## Конструктор
				 ...
				 ![](../../../sub_image.gif)
				 [NavModuleObject](Constructor_NavModuleObject.htm)
				 Конструктор NavModuleObject
				 создает экземпляр класса NavModuleObject.
