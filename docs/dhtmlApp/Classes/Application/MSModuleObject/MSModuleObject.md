...
Класс MSModuleObject реализует
 объект модуля с загруженным в него контейнером моделирования.


## Синтаксис


PP.initClass(PP.Application.MSModuleObject, [PP.Application.ModuleObject](../ModuleObject/ModuleObject.htm),
 "PP.Application.MSModuleObject");
...
## Конструктор
		 ...
		 ![](../../../sub_image.gif)
		 [MSModuleObject](Constructor_MSModuleObject.htm)
		 Конструктор MSModuleObject
		 создает экземпляр класса MSModuleObject.
...
## Методы
		 ...
		 ![](../../../sub_image.gif)
		 [getReport](dhtmlApp.chm::/Classes/Application/MSModuleObject/MSModuleObject.getReport.htm)
		 Метод getReport возвращает
		 источник данных контейнера моделирования.
