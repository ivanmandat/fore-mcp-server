...
Компонент AboutBox представляет
 собой диалог «О программе».


## Комментарии


Компонент реализован классом [AboutBox](../../Classes/Application/AboutBox/AboutBox.htm)
...
Пример создания диалога приведен на странице «[Пример
 создания компонента AboutBox](AboutBox_Example.htm)».
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [AboutBox](../../Classes/Application/AboutBox/Constructor_AboutBox.htm)
			 Конструктор AboutBox
			 создает экземпляр класса AboutBox.


## Свойства,
 унаследованные от класса [Window](dhtmlUi.chm::/Classes/Window/Window.htm)
