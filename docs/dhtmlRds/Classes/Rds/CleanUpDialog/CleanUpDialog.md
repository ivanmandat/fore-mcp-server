# CleanUpDialog: класс DHTML-компонента
...
Диалог для очистки справочника НСИ может иметь выглядеть следующий вид:
...
PP.initClass(PP.Rds.Ui.CleanUpDialog, [PP.Ui.Window](dhtmlUi.chm::/Classes/Window/Window.htm),
 "PP.Rds.Ui.CleanUpDialog");
