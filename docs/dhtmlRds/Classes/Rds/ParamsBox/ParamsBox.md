# ParamsBox: класс DHTML-компонента
...
Класс ParamsBox реализует контейнер параметров справочника.


## Синтаксис


PP.initClass(PP.Rds.Ui.ParamsBox, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.Rds.Ui.ParamsBox");
