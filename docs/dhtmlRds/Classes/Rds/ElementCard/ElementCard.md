# ElementCard: класс DHTML-компонента
...
Класс ElementCard реализует карточку элемента дерева справочника НСИ.


## Синтаксис


PP.initClass(PP.Rds.Ui.ElementCard, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.Rds.Ui.ElementCard");
