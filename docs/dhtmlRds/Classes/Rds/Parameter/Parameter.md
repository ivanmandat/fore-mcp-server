...
Класс Parameter реализует визуальное представление параметров справочника.


## Синтаксис


PP.initClass(PP.Rds.Ui.Parameter, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.Rds.Ui.Parameter");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [Parameter](dhtmlRds.chm::/Classes/Rds/Parameter/Constructor_Parameter.htm)
		 Конструктор Parameter создает
		 экземпляр класса [Parameter](dhtmlRds.chm::/Classes/Rds/Parameter/Parameter.htm).
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [Key](dhtmlRds.chm::/Classes/Rds/Parameter/Parameter.Key.htm)
		 Свойство Key
		 определяет ключ параметра справочника.


		 ![](../../../property_image.gif)
		 [Source](dhtmlRds.chm::/Classes/Rds/Parameter/Parameter.Source.htm)
		 Свойство Source
		 определяет источник данных параметра справочника.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getInstance](dhtmlRds.chm::/Classes/Rds/Parameter/Parameter.getInstance.htm)
		 Метод getInstance
		 возвращает тип экземпляра параметра справочника.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlRds.chm::/Classes/Rds/Parameter/Parameter.refreshAll.htm)
		 Метод refreshAll
		 обновляет параметр справочника.


		 ![](../../../Sub_Image.gif)
		 [reopenLink](dhtmlRds.chm::/Classes/Rds/Parameter/Parameter.reopenLink.htm)
		 Метод reopenLink переоткрывает
		 справочник по связи с заданными параметрами открытия.
