# DictionaryTree: класс DHTML-компонента
...
Класс DictionaryTree реализует дерево элементов справочника НСИ.


## Синтаксис


PP.initClass(PP.Rds.Ui.DictionaryTree, [PP.Ui.ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/proxycontrol.htm), "PP.Rds.Ui.DictionaryTree");
