# FindSettingsDialog: класс DHTML-компонента
...
Класс FindSettingsDialog реализует диалог настроек параметров поиска по справочнику.


## Синтаксис


PP.initClass(PP.Rds.Ui.FindSettingsDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.Rds.Ui.FindSettingsDialog");
