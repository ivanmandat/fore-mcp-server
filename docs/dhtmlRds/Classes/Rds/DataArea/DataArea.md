# PP.Rds.Ui.DataArea: класс DHTML-компонента
...
Класс DataArea реализует область
...
PP.initClass(PP.Rds.Ui.DataArea, [PP.Ui.ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/proxycontrol.htm),
 "PP.Rds.Ui.DataArea");
