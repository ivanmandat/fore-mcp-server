...
Класс DictionaryBox реализует [контейнер для справочника НСИ](../../../Components/Rds/DictionaryBox/DictionaryBox.htm).


## Синтаксис


PP.initClass(PP.Rds.Ui.DictionaryBox, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.Rds.Ui.DictionaryBox");
