...
Диалог для выбора схемы экспорта/импорта справочника НСИ может иметь
 выглядеть следующий вид:
...
PP.initClass(PP.Rds.Ui.SchemaDialog, [PP.Ui.Window](dhtmlUi.chm::/Classes/Window/Window.htm),
 "PP.Rds.Ui.SchemaDialog");
...
## Конструктор
				 ...
				 ![](../../../Sub_Image.gif)
				 [SchemaDialog](Constructor_SchemaDialog.htm)
				 Конструктор SchemaDialog
				 создаёт диалог для выбора схемы экспорта/импорта.
...
## Свойства
		 ...
		 ![](../../../Sub_Image.gif)
		 [IsImport](SchemaDialog.IsImport.htm)
		 Свойство IsImport определяет,
		 будет ли диалог использован для выбора схемы импорта.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Canceled](SchemaDialog.Canceled.htm)
		 Событие Canceled генерируется
		 после нажатия на кнопку «Отмена» в диалоге для выбора схемы экспорта/импорта.


		 ![](../../../Event_Image.gif)
		 [Confirmed](SchemaDialog.Confirmed.htm)
		 Событие Confirmed генерируется
		 после нажатия на кнопку «Ок» в диалоге для выбора схемы экспорта/импорта.
