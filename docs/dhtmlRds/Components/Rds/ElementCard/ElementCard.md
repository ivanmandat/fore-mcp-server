...
Компонент ElementCard реализует
 карточку элемента дерева справочника НСИ.


## Комментарии


Компонент реализован классом [ElementCard](../../../Classes/Rds/ElementCard/ElementCard.htm).


## Пример


Карточка элемента дерева справочника НСИ может выглядеть следующим образом:


![](../../../Classes/Rds/ElementCard/ElementCard_Locale.png)


Пример создания компонента приведён на странице описания [конструктора
 ElementCard](../../../Classes/Rds/ElementCard/Constructor_ElementCard.htm).
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ElementCard](dhtmlRds.chm::/Classes/Rds/ElementCard/Constructor_ElementCard.htm)
		 Конструктор ElementCard создает
		 экземпляр класса [ElementCard](dhtmlRds.chm::/Classes/Rds/ElementCard/ElementCard.htm).
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [Locale](dhtmlRds.chm::/Classes/Rds/ElementCard/ElementCard.Locale.htm)
		 Свойство Locale
		 определяет код локали карточки элемента дерева.


		 ![](../../../property_image.gif)
		 [Mode](dhtmlRds.chm::/Classes/Rds/ElementCard/ElementCard.Mode.htm)
		 Свойство Mode
		 определяет режим работы карточки элемента.


		 ![](../../../property_image.gif)
		 [Source](dhtmlRds.chm::/Classes/Rds/ElementCard/ElementCard.Source.htm)
		 Свойство Source
		 определяет источник данных карточки элемента.


		 ![](../../../property_image.gif)
		 [UpdElKey](dhtmlRds.chm::/Classes/Rds/ElementCard/ElementCard.UpdElKey.htm)
		 Свойство UpdElKey определяет
		 ключ редактируемого элемента.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [checkValues](dhtmlRds.chm::/Classes/Rds/ElementCard/ElementCard.checkValues.htm)
		 Свойство checkValues
