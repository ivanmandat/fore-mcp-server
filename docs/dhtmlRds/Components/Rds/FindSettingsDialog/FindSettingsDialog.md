# FindSettingsDialog: DHTML-компонент
...
Компонент FindSettingsDialog
 реализует диалог настроек параметров поиска по справочнику НСИ.


## Комментарии


Компонент реализован классом [FindSettingsDialog](../../../Classes/Rds/FindSettingsDialog/FindSettingsDialog.htm).


## Пример


Диалог настроек параметров поиска по справочнику НСИ может иметь следующий
 вид:


![](../../../Classes/Rds/FindSettingsDialog/FindSettingsDialog_FilterSettings.png)


Пример использования компонента приведён на странице описания [конструктора
 FindSettingsDialog](../../../Classes/Rds/FindSettingsDialog/Constructor_FindSettingsDialog.htm).
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [FindSettingsDialog](dhtmlRds.chm::/Classes/Rds/FindSettingsDialog/Constructor_FindSettingsDialog.htm)
		 Конструктор FindSettingsDialog
		 создает экземпляр класса FindSettingsDialog.
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [FilterSettings](dhtmlRds.chm::/Classes/Rds/FindSettingsDialog/FindSettingsDialog.FilterSettings.htm)
		 Свойство FilterSettings
		 определяет настройки окна поиска.


		 ![](../../../property_image.gif)
		 [Source](dhtmlRds.chm::/Classes/Rds/FindSettingsDialog/FindSettingsDialog.Source.htm)
		 Свойство Source
		 определяет источник данных диалога настроек поиска.
