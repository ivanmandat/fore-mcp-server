...
Компонент CleanUpDialog реализует
 диалог для очистки справочника НСИ.


## Комментарии


Компонент реализован классом [CleanUpDialog](../../../Classes/Rds/CleanUpDialog/CleanUpDialog.htm).


## Пример


Диалог для очистки справочника НСИ может выглядеть следующим образом:


![](../../../Classes/Rds/CleanUpDialog/CleanUpDialog.png)


Пример создания компонента приведён на странице описания [конструктора
 CleanUpDialog](../../../Classes/Rds/CleanUpDialog/Constructor_CleanUpDialog.htm).
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [CleanUpDialog](dhtmlRds.chm::/Classes/Rds/CleanUpDialog/Constructor_CleanUpDialog.htm)
		 Конструктор CleanUpDialog
		 создаёт диалог для очистки справочника НСИ.
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [Source](dhtmlRds.chm::/Classes/Rds/CleanUpDialog/CleanUpDialog.Source.htm)
		 Свойство Source определяет
		 справочник НСИ для диалога.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [CleanCanceled](dhtmlRds.chm::/Classes/Rds/CleanUpDialog/CleanUpDialog.CleanCanceled.htm)
		 Событие CleanCanceled
		 генерируется после нажатия на кнопку «Отмена» в диалоге для очистки
		 справочника.


		 ![](../../../Event_Image.gif)
		 [CleanConfirmed](dhtmlRds.chm::/Classes/Rds/CleanUpDialog/CleanUpDialog.CleanConfirmed.htm)
		 Событие CleanConfirmed
		 генерируется после нажатия на кнопку «Очистить» в диалоге для
		 очистки справочника.
