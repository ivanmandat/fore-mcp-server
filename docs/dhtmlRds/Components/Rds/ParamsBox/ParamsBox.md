...
Компонент ParamsBox реализует
 контейнер параметров справочника.


## Комментарии


Компонент реализован классом [ParamsBox](../../../Classes/Rds/ParamsBox/ParamsBox.htm).
...
[Пример совместного
 создания компонентов DictionaryTree, ParamsBox и FindBox](../DictionaryTree/DictionaryTree_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ParamsBox](dhtmlRds.chm::/Classes/Rds/ParamsBox/Constructor_ParamsBox.htm)
		 Конструктор ParamsBox создает
		 экземпляр класса [ParamsBox](dhtmlRds.chm::/Classes/Rds/ParamsBox/ParamsBox.htm).
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlRds.chm::/Classes/Rds/ParamsBox/ParamsBox.refreshAll.htm)
		 Метод refreshAll
		 обновляет контейнер параметров справочника.


		 ![](../../../Sub_Image.gif)
		 [setSource](dhtmlRds.chm::/Classes/Rds/ParamsBox/ParamsBox.setSource.htm)
		 Метод setSource
		 устанавливает источник данных контейнера параметров справочника.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ParamChanged](dhtmlRds.chm::/Classes/Rds/ParamsBox/ParamsBox.ParamChanged.htm)
		 Событие ParamChanged
		 наступает после изменения параметра справочника.


		 ![](../../../Event_Image.gif)
		 [SourceCleaned](dhtmlRds.chm::/Classes/Rds/ParamsBox/ParamsBox.SourceCleaned.htm)
		 Событие SourceCleaned
		 наступает после очистки источника данных.


		 ![](../../../Event_Image.gif)
		 [SourceReopened](dhtmlRds.chm::/Classes/Rds/ParamsBox/ParamsBox.SourceReopened.htm)
		 Событие SourceReopened
		 наступает после повторного открытия источника данных.
