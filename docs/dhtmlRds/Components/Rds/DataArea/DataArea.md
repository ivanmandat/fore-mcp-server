# PP.Rds.Ui.DataArea: DHTML-компонент
...
Компонент DataArea реализует
 область данных справочника НСИ.


## Комментарии


Компонент реализован классом [DataArea](../../../Classes/Rds/DataArea/DataArea.htm).


## Пример


Область данных справочника НСИ может выглядеть следующим образом:


![](DataArea.png)


[Пример создания компонента DataArea](DataArea_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [DataArea](dhtmlRds.chm::/Classes/Rds/DataArea/Constructor_DataArea.htm)
		 Конструктор DataArea создаёт
		 область данных для контейнера справочника НСИ.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [addItem](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.addItem.htm)
		 Метод addItem добавляет
		 вкладку с указанным справочником НСИ, либо обновляет справочник
		 с таким же ключом на существующей вкладке.


		 ![](../../../Sub_Image.gif)
		 [clear](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.clear.htm)
		 Метод clear очищает
		 область данных контейнера для справочника НСИ.


		 ![](../../../Sub_Image.gif)
		 [collapseHistory](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.collapseHistory.htm)
		 Метод collapseHistory
		 сворачивает панель с историей значений атрибутов.


		 ![](../../../Sub_Image.gif)
		 [deleteItemByKey](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.deleteItemByKey.htm)
		 Метод deleteItemByKey
		 удаляет вкладку по указанному ключу справочника НСИ, который в
		 ней лежит.


		 ![](../../../Sub_Image.gif)
		 [expandHistory](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.expandHistory.htm)
		 Метод expandHistory
		 разворачивает панель с историей значений атрибутов.


		 ![](../../../Sub_Image.gif)
		 [getActiveDictTree](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.getActiveDictTree.htm)
		 Метод getActiveDictTree
		 возвращает дерево элементов активного справочника НСИ.


		 ![](../../../Sub_Image.gif)
		 [getActiveFindBox](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.getActiveFindBox.htm)
		 Метод getActiveFindBox
		 возвращает контейнер для поиска элементов справочника НСИ на активной
		 вкладке.


		 ![](../../../Sub_Image.gif)
		 [getActiveHistoryBox](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.getActiveHistoryBox.htm)
		 Метод getActiveHistoryBox
		 возвращает дерево c историей значений атрибутов справочника НСИ
		 на активной вкладке.


		 ![](../../../Sub_Image.gif)
		 [getActiveParamBox](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.getActiveParamBox.htm)
		 Метод getActiveParamBox
		 возвращает контейнер для параметров справочника НСИ на активной
		 вкладке.


		 ![](../../../Sub_Image.gif)
		 [getActiveSource](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.getActiveSource.htm)
		 Метод getActiveSource
		 возвращает справочник НСИ на текущей вкладке.


		 ![](../../../Sub_Image.gif)
		 [getIsHistoryCollapsed](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.getIsHistoryCollapsed.htm)
		 Метод getIsHistoryCollapsed
		 проверяет, свёрнута ли панель с историей значений атрибутов.


		 ![](../../../Sub_Image.gif)
		 [getItemByKey](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.getItemByKey.htm)
		 Метод getItemByKey
		 возвращает содержимое вкладки с указанным справочником НСИ.


		 ![](../../../Sub_Image.gif)
		 [hideFindBox](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.hideFindBox.htm)
		 Метод hideFindBox скрывает
		 контейнер для поиска элементов справочника НСИ на текущей вкладке.


		 ![](../../../Sub_Image.gif)
		 [showFindBox](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.showFindBox.htm)
		 Метод showFindBox отображает
		 контейнер для поиска элементов справочника НСИ на текущей вкладке.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ActiveTabChanged](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.ActiveTabChanged.htm)
		 Событие ActiveTabChanged
		 генерируется при смене активной вкладки в области данных контейнера
		 со справочника НСИ.


		 ![](../../../Event_Image.gif)
		 [ActiveTreeEdited](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.ActiveTreeEdited.htm)
		 Событие ActiveTreeEdited
		 наступает после изменения дерева элементов активного справочника
		 НСИ.


		 ![](../../../Event_Image.gif)
		 [ActiveTreeSelectionChanged](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.ActiveTreeSelectionChanged.htm)
		 Событие ActiveTreeSelectionChanged
		 наступает после изменения выделения элементов в дереве активного
		 справочника НСИ.


		 ![](../../../Event_Image.gif)
		 [TabClosed](dhtmlRds.chm::/Classes/Rds/DataArea/DataArea.TabClosed.htm)
		 Событие TabClosed наступает
		 после закрытия вкладки контейнера для справочника НСИ.
