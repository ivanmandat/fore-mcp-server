...
Компонент DictionaryBox реализует
 контейнер для справочника НСИ.


## Комментарии


Компонент реализован классом [DictionaryBox](../../../Classes/Rds/DictionaryBox/DictionaryBox.htm).


## Пример


Контейнер со справочником НСИ может выглядеть следующим образом:


![](DictionaryBox.png)


[Пример создания компонента DictionaryBox](DictionaryBox_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [DictionaryBox](dhtmlRds.chm::/Classes/Rds/DictionaryBox/Constructor_DictionaryBox.htm)
		 Конструктор DictionaryBox
		 создаёт экземпляр контейнера для справочника НСИ.
...
## Свойства
		 ...
		 ![](../../../property_image.gif)
		 [Source](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.Source.htm)
		 Свойство Source определяет
		 для контейнера справочник НСИ.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [excludeSource](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.excludeSource.htm)
		 Метод excludeSource
		 удаляет из контейнера указанный справочник НСИ.


		 ![](../../../Sub_Image.gif)
		 [getDataArea](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.getDataArea.htm)
		 Метод getDataArea возвращает
		 область данных контейнера для справочника НСИ.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.refreshAll.htm)
		 Метод refreshAll обновляет
		 содержимое контейнера для справочника НСИ.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Close](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.Close.htm)
		 Событие Close генерируется
		 при закрытии контейнера для справочника НСИ.


		 ![](../../../Event_Image.gif)
		 [Open](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.Open.htm)
		 Событие Open генерируется
		 при открытии контейнера для справочника НСИ.


		 ![](../../../Event_Image.gif)
		 [Save](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.Save.htm)
		 Событие Save генерируется
		 при сохранении данных справочника НСИ.


		 ![](../../../Event_Image.gif)
		 [SaveAs](dhtmlRds.chm::/Classes/Rds/DictionaryBox/DictionaryBox.SaveAs.htm)
		 Событие SaveAs генерируется
		 при сохранении данных справочника НСИ с новым именем.
