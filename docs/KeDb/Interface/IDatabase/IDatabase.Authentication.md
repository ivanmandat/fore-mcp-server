...
Authentication: [AuthenticationMode](KeSom.chm::/Enums/AuthenticationMode.htm);


## Описание


Свойство Authentication определяет тип аутентификации, используемый при подключении к базе данных.
