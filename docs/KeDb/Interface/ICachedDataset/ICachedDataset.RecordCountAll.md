...
RecordCountAll: Integer;


## Описание


Свойство RecordCountAll возвращает
 общее количество записей в источнике данных, которое может быть помещено
 в кеш.
...
При получении значения данного свойства в кеш будут загружены все записи
 источника данных.
