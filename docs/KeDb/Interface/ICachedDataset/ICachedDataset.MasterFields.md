...
Свойство MasterFields определяет
 список полей главного источника данных, по которым будет осуществляться
 фильтрация данных в привязанном источнике данных.
