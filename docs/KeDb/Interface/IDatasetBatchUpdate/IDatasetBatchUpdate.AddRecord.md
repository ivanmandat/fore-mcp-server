...
FieldValues –
 массив новых значений записи. Значения элементов в массиве должны соответствовать
 полям в источнике данных.


## Описание


Метод AddRecord добавляет обновленные
 значения записи в буфер. Обновление записей из буфера в источнике осуществляется
 при вызове метода [Commit](IDatasetBatchUpdate.Commit.htm).
