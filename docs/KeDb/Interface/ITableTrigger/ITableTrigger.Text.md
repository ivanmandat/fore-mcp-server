...
После выполнения примера в таблице будет создан триггер с идентификатором
 «TriggerX». Данный триггер будет
 срабатывать перед вставкой новой строки в таблицу. При срабатывании триггера
 в таблицу будет добавляться еще одна новая строка и будет заполняться
 значение поля «Field_1».
