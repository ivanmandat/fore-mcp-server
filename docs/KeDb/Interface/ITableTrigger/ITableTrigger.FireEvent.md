...
FireEvent: [TableTriggerFireEvent](../../Enums/TableTriggerFireEvent.htm);


## Описание


Свойство FireEvent определяет события, при которых будет срабатывать триггер.
