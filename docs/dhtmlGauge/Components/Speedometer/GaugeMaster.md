...
Компонент GaugeMaster представляет
 собой мастер для настройки [спидометра](Speedometer.htm).


## Комментарии


Компонент реализован классом PP.Ui.[GaugeMaster](../../Classes/Speedometer/GaugeMaster/GaugeMaster.htm).
