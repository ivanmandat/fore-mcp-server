...
Класс LightBrushPanel реализует
 панель мастера спидометра для динамической подсветки.


## Комментарии


Панель «Динамическая подсветка» может иметь следующий вид:
...
PP.initClass(PP.Ui.LightBrushPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.LightBrushPanel", PP.Ui.INotifySettingsChanged);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [LightBrushPanel](Constructor_LightBrushPanel.htm)
		 Конструктор LightBrushPanel
		 создает экземпляр класса LightBrushPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setEnabledSettings](LightBrushPanel.setEnabledSettings.htm)
		 Метод setEnabledSettings
		 устанавливает настройки доступности панели «Динамическая подсветка»
		 в мастере спидометра.
...
[Speedometer](../Speedometer_Class.htm)
