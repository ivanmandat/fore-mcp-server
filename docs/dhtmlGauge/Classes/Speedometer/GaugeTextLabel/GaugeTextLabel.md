...
Класс GaugeTextLabel реализует
 текстовые метки спидометра.


## Синтаксис


PP.initClass(PP.Ui.GaugeTextLabel, PP.Ui.[GaugeObject](../GaugeObject/GaugeObject.htm),
 "GaugeTextLabel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [GaugeTextLabel](dhtmlGauge.chm::/Classes/Speedometer/GaugeTextLabel/Constructor_GaugeTextLabel.htm)
		 Конструктор GaugeTextLabel
		 создает экземпляр класса GaugeTextLabel.
