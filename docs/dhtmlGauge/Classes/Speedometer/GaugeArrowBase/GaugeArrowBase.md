...
Класс GaugeArrowBase реализует
 базовый объект для стрелок на спидометре.


## Комментарии


Наследники класса GaugeArrowBase:


	- [LineArrow](../LineArrow/LineArrow.htm);


	- [SectorArrow](../SectorArrow/SectorArrow.htm);


	- [TriangleArrow](../TriangleArrow/TriangleArrow.htm).


## Синтаксис


PP.initClass(PP.Ui.GaugeArrowBase, PP.Ui.[GaugeObject](../GaugeObject/GaugeObject.htm),
 "GaugeArrowBase");
