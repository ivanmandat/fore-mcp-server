...
Класс GaugeObject является
 базовым для визуальных элементов спидометра.


## Синтаксис


PP.initClass(PP.Ui.GaugeObject, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "GaugeObject");
