...
[GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm)
...
Класс TriangleMarker реализует
 отображение маркера в виде треугольника.


## Синтаксис


PP.initClass(PP.Ui.TriangleMarker, PP.Ui.[GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm),
 "TriangleMarker");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TriangleMarker](Constructor_TriangleMarker.htm)
		 Конструктор TriangleMarker
		 создает экземпляр класса TriangleMarker.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Flip](TriangleMarker.Flip.htm)
		 Свойство Flip устанавливает
		 способ отрисовки в виде прямого или зеркального отображения.


## Свойства, унаследованные от класса [GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Size](dhtmlGauge.chm::/Classes/Speedometer/GaugeMarkerBase/GaugeMarkerBase.Size.htm)
		 Свойство Size определяет
		 размер маркера.


## Методы, унаследованные от класса [GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm)
