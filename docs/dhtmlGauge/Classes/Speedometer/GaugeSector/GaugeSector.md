...
Класс GaugeSector реализует
 элементы спидометра в виде сектора.


## Комментарии


На данном рисунке сектор выделен синим цветом.
...
PP.initClass(PP.Ui.GaugeSector, PP.Ui.[GaugeObject](../GaugeObject/GaugeObject.htm),
 "GaugeSector");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [GaugeSector](dhtmlGauge.chm::/Classes/Speedometer/GaugeSector/Constructor_GaugeSector.htm)
		 Конструктор GaugeSector
		 создает экземпляр класса GaugeSector.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [EndSize](dhtmlGauge.chm::/Classes/Speedometer/GaugeSector/GaugeSector.EndSize.htm)
		 Свойство EndSize определяет
		 толщину сектора в конце.


		 ![](../../../Property_Image.gif)
		 [EndValue](dhtmlGauge.chm::/Classes/Speedometer/GaugeSector/GaugeSector.EndValue.htm)
		 Свойство EndValue
		 определяет значение на шкале, где находится конец сектора.


		 ![](../../../Property_Image.gif)
		 [StartSize](dhtmlGauge.chm::/Classes/Speedometer/GaugeSector/GaugeSector.Startsize.htm)
		 Свойство StartSize
		 определяет толщину сектора в начале.


		 ![](../../../Property_Image.gif)
		 [StartValue](dhtmlGauge.chm::/Classes/Speedometer/GaugeSector/GaugeSector.StartValue.htm)
		 Свойство StartValue
		 определяет значение на шкале, где находится начало сектора.


		 ![](../../../Property_Image.gif)
		 [ZIndex](dhtmlGauge.chm::/Classes/Speedometer/GaugeSector/GaugeSector.Zindex.htm)
		 Свойство ZIndex определяет
