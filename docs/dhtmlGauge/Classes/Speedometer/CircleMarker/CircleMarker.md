...
Класс CircleMarker реализует
 отображение маркера в виде окружности.


## Синтаксис


PP.initClass(PP.Ui.CircleMarker, PP.Ui.[GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm),
 "CircleMarker");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [CircleMarker](Constructor_CircleMarker.htm)
		 Конструктор CircleMarker
		 создает экземпляр класса CircleMarker.
