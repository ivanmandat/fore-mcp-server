...
Класс CenterPanel реализует панель мастера спидометра для настройки центра.
...
Панель можно получить из мастера спидометра при помощи метода [GaugeMaster](GaugeMaster/GaugeMaster.htm).getItem(1).


## Синтаксис


PP.initClass(PP.Ui.CenterPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "PP.Ui.CenterPanel", PP.Ui.INotifySettingsChanged);
