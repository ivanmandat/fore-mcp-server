...
Класс GaugeMaster реализует
 компонент [GaugeMaster](../../../Components/Speedometer/GaugeMaster.htm),
 представляющий собой мастер для настройки [спидометра](../../../Components/Speedometer/Speedometer.htm).


## Комментарии


Панели мастера реализованы следующими классам:


	- PP.Ui.[SpeedometerPanel](../SpeedometerPanel.htm)
	 - панель «Спидометр»;


	- PP.Ui.[CenterPanel](../CenterMarkerPanel.htm) - панель
	 «Центр»;


	- PP.Ui.[ScalePanel](../ScalePanel/ScalePanel.htm)
	 - панель «Шкала»;


	- PP.Ui.[ColorSectorsPanel](../ColorSectorsPanel.htm)
	 - панель «Секторы»;


	- PP.Ui.[ArrowPanel](../ArrowPanel.htm) - панель «Стрелка»;


	- PP.Ui.[LightBrushPanel](../LightBrushPanel/LightBrushPanel.htm)
	 - панель «Динамическая подсветка».


## Синтаксис


PP.initClass(PP.Ui.GaugeMaster, PP.Ui.[Master](dhtmlUi.chm::/Classes/Master/Master.htm),
 "GaugeMaster");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [GaugeMaster](dhtmlGauge.chm::/Classes/Speedometer/GaugeMaster/Constructor_GaugeMaster.htm)
		 Конструктор GaugeMaster создает
		 экземпляр класса GaugeMaster.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [DataView](dhtmlGauge.chm::/Classes/Speedometer/GaugeMaster/GaugeMaster.DataView.htm)
		 Свойство DataView определяет
		 спидометр, который будет настраиваться при помощи мастера.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlGauge.chm::/Classes/Speedometer/GaugeMaster/GaugeMaster.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении настроек мастера.
