...
Класс GaugeProperties реализует
 вкладку для настройки шкалы спидометра.


## Синтаксис


PP.initClass(PP.Ui.GaugeProperties, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "GaugeProperties");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [GaugeProperties](Constructor_GaugeProperties.htm)
		 Конструктор GaugeProperties
		 создает экземпляр класса GaugeProperties.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [IntervalEnd](GaugeProperties.IntervalColor.htm)
		 Свойство IntervalEnd
		 определяет точку окончания сектора.


		 ![](../../../Property_Image.gif)
		 [IntervalColor](GaugeProperties.IntervalColor.htm)
		 Свойство IntervalColor
		 определяет цвет сектора.


		 ![](../../../Property_Image.gif)
		 [IntervalsCount](GaugeProperties.IntervalsCount.htm)
		 Свойство IntervalsCount
		 определяет количество секторов шкалы.


		 ![](../../../Property_Image.gif)
		 [MaxValue](GaugeProperties.MaxValue.htm)
		 Свойство MaxValue определяет
		 максимальное значение шкалы.


		 ![](../../../Property_Image.gif)
		 [MinValue](GaugeProperties.MinValue.htm)
		 Свойство MinValue определяет
		 минимальное значение шкалы.


		 ![](../../../Property_Image.gif)
		 [ScaleMode](GaugeProperties.ScaleMode.htm)
		 Свойство ScaleMode
		 определяет режим шкалы.


		 ![](../../../Property_Image.gif)
		 [TrendEnabled](GaugeProperties.TrendEnabled.htm)
		 Свойство TrendEnabled
		 определяет доступность линии тренда.


		 ![](../../../Property_Image.gif)
		 [TrendLabel](GaugeProperties.TrendLabel.htm)
		 Свойство TrendLabel
		 определяет надпись тренда.


		 ![](../../../Property_Image.gif)
		 [TrendValue](GaugeProperties.TrendValue.htm)
		 Свойство TrendValue
		 определяет позицию тренда.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [update](GaugeProperties.update.htm)
		 Метод update применяет
		 для спидометра текущие настройки мастера шкалы.
