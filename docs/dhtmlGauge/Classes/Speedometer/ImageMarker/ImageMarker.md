...
Класс ImageMarker реализует
 отображение маркера в виде изображения.


## Синтаксис


PP.initClass(PP.Ui.ImageMarker, PP.Ui.[GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm),
 "ImageMarker");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ImageMarker](Constructor_ImageMarker.htm)
		 Конструктор ImageMarker
		 создает экземпляр класса ImageMarker.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Src](ImageMarker.Src.htm)
		 Свойство Src определяет
