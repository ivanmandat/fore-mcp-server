...
Класс LineMarker реализует отображение
 маркера в виде отрезка.


## Синтаксис


PP.initClass(PP.Ui.LineMarker, PP.Ui.[GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm),
 "LineMarker");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [LineMarker](Constructor_LineMarker.htm)
		 Конструктор LineMarker
		 создает экземпляр класса LineMarker.
