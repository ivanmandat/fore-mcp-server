...
Класс GaugeMarkerBase реализует
 базовый абстрактный объект для маркеров на спидометре.


## Комментарии


Наследники класса GaugeMarkerBase:


	- [CircleMarker](../CircleMarker/CircleMarker.htm);


	- [ImageMarker](../ImageMarker/ImageMarker.htm);


	- [LineMarker](../LineMarker/LineMarker.htm);


	- [RhombMarker](../RhombMarker/RhombMarker.htm);


	- [TriangleMarker](../TriangleMarker/TriangleMarker.htm).


## Синтаксис


PP.initClass(PP.Ui.GaugeMarkerBase, PP.Ui.[GaugeObject](../GaugeObject/GaugeObject.htm),
 "GaugeMarkerBase");
