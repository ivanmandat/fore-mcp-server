...
[GaugeTextLabel](../GaugeTextLabel/GaugeTextLabel.htm)
...
Класс GaugeCenterLabel реализует
 центральную текстовую метку спидометра.


## Комментарии


На следующем рисунке представлен спидометр с центральной текстовой меткой:


![](GaugeCenterLabel_1.png)


## Синтаксис


PP.initClass(PP.Ui.GaugeCenterLabel, [PP.Ui.GaugeTextLabel](../GaugeTextLabel/GaugeTextLabel.htm),
 "PP.Ui.GaugeCenterLabel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [GaugeCenterLabel](Constructor_GaugeCenterLabel.htm)
		 Конструктор GaugeCenterLabel
		 создает экземпляр класса GaugeCenterLabel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Arrow](GaugeCenterLabel.Arrow.htm)
		 Свойство Arrow
		 определяет стрелку шкалы для центральной текстовой метки.


		 ![](../../../Property_Image.gif)
		 [AutoSize](GaugeCenterLabel.AutoSize.htm)
		 Свойство AutoSize
		 определяет признак автоматической установки размеров для
		 центральной текстовой метки.


		 ![](../../../Property_Image.gif)
		 [MaskLabel](GaugeCenterLabel.MaskLabel.htm)
		 Свойство MaskLabel
		 определяет формат вывода значений в подписи центральной
		 текстовой метки.


		 ![](../../../Property_Image.gif)
		 [RealHeight](GaugeCenterLabel.RealHeight.htm)
		 Свойство RealHeight
		 определяет фактическую высоту центральной текстовой метки
		 спидометра.


		 ![](../../../Property_Image.gif)
		 [RealWidth](GaugeCenterLabel.RealWidth.htm)
		 Свойство RealWidth
		 определяет фактическую ширину центральной текстовой метки
		 спидометра.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [animate](GaugeCenterLabel.animate.htm)
		 Метод animate
		 перерисовывает центральную текстовую метку спидометра.


## Свойства, унаследованные от класса [GaugeTextLabel](../GaugeTextLabel/GaugeTextLabel.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Font](dhtmlGauge.chm::/Classes/Speedometer/GaugeTextLabel/GaugeTextLabel.Font.htm)
		 Свойство Font определяет
		 шрифт текстовой метки.


		 ![](../../../Property_Image.gif)
		 [Text](dhtmlGauge.chm::/Classes/Speedometer/GaugeTextLabel/GaugeTextLabel.Text.htm)
		 Свойство Text определяет
		 текст, отображаемый на текстовой метке.


		 ![](../../../Property_Image.gif)
		 [TextAlign](dhtmlGauge.chm::/Classes/Speedometer/GaugeTextLabel/GaugeTextLabel.TextAlign.htm)
		 Свойство TextAlign
		 определяет выравнивание текста меток шкалы спидометра.


## Методы, унаследованные от класса [GaugeTextLabel](../GaugeTextLabel/GaugeTextLabel.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [setPosition](dhtmlGauge.chm::/Classes/Speedometer/GaugeTextLabel/GaugeTextLabel.setPosition.htm)
