...
Класс GaugeTrendPoint реализует
 отображение отметки на шкале спидометра.


## Комментарии


Пример отметки на шкале спидометра:
...
PP.initClass(PP.Ui.GaugeTrendPoint, PP.Ui.[GaugeObject](../GaugeObject/GaugeObject.htm),
 "GaugeTrendPoint");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [GaugeTrendPoint](Constructor_GaugeTrendPoint.htm)
		 Конструктор GaugeTrendPoint
		создает экземпляр компонента GaugeTrendPoint.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Label](GaugeTrendPoint.Label.htm)
		 Свойство Label определяет
		 параметры подписи.


		 ![](../../../Property_Image.gif)
		 [Marker](GaugeTrendPoint.Marker.htm)
...
## Методы
		 ...
		 пересчитывает центр (позицию) отметок.


		 ![](../../../Sub_Image.gif)
		 [calcOuterRadius](GaugeTrendPoint.calcOuterRadius.htm)
		 Метод calcOuterRadius
		 пересчитывает радиус отметок на шкале.
