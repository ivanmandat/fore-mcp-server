...
Класс SpeedometerPanel реализует
 панель «Спидометр» мастера спидометра.


## Комментарии


Панель «Спидометр» выглядит следующим образом:


![](SpeedometerPanel.gif)


Панель можно получить из мастера спидометра при помощи метода [GaugeMaster](GaugeMaster/GaugeMaster.htm).getItem(0).


## Синтаксис


PP.initClass(PP.Ui.SpeedometerPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.SpeedometerPanel", PP.Ui.INotifySettingsChanged);
