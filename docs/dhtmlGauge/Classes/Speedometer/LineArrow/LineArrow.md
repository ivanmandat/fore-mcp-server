...
Класс LineArrow реализует указатель
 в виде линии.
...
PP.initClass(PP.Ui.LineArrow, PP.Ui.[GaugeArrowBase](../GaugeArrowBase/GaugeArrowBase.htm),
 "LineArrow");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [LineArrow](Constructor_LineArrow.htm)
		 Конструктор LineArrow
		 создает экземпляр класса LineArrow.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Size](LineArrow.Size.htm)
		 Свойство Size определяет
		 толщину линии.


		 ![](../../../Property_Image.gif)
		 [Tail](LineArrow.Tail.htm)
