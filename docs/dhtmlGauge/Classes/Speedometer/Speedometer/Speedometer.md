...
Класс Speedometer реализует
 компонент [Speedometer](../../../Components/Speedometer/Speedometer.htm),
 представленный в виде визуального компонента, служащего для наглядного
...
PP.initClass(PP.Ui.Speedometer, PP.Ui.[GaugeObject](../GaugeObject/GaugeObject.htm),
 "Speedometer");
