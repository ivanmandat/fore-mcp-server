...
Класс RhombMarker реализует
 отображение маркера в виде ромба.


## Синтаксис


PP.initClass(PP.Ui.RhombMarker, PP.Ui.[GaugeMarkerBase](../GaugeMarkerBase/GaugeMarkerBase.htm),
 "RhombMarker");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RhombMarker](Constructor_RhombMarker.htm)
		 Конструктор RhombMarker
		 создает экземпляр класса RhombMarker.
