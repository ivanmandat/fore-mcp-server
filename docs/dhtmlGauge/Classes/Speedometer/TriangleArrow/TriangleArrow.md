...
Класс TriangleArrow реализует
 указатель в виде треугольника.


## Синтаксис


PP.initClass(PP.Ui.TriangleArrow, PP.Ui.[GaugeArrowBase](../GaugeArrowBase/GaugeArrowBase.htm),
 "TriangleArrow");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TriangleArrow](Constructor_TriangleArrow.htm)
		 Конструктор TriangleArrow
		 создает экземпляр класса TriangleArrow.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Size](TriangleArrow.Size.htm)
		 Свойство Size определяет
		 размер стрелки в широкой части.


		 ![](../../../Property_Image.gif)
		 [Tail](TriangleArrow.Tail.htm)
		 Свойство Tail определяет
		 длину хвоста стрелки.
