...
[GaugeArrowBase](../GaugeArrowBase/GaugeArrowBase.htm)
...
На данном рисунке указатель в виде сектора выделен оранжевым цветом:
...
PP.initClass(PP.Ui.SectorArrow, PP.Ui.[GaugeArrowBase](../GaugeArrowBase/GaugeArrowBase.htm),
 "SectorArrow");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [SectorArrow](Constructor_SectorArrow.htm)
		 Конструктор SectorArrow
		 создает экземпляр класса SectorArrow.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [EndValue](SectorArrow.EndValue.htm)
		 Свойство EndValue определяет
		 значение на шкале, где находится конец сектора.


		 ![](../../../Property_Image.gif)
		 [StartValue](SectorArrow.StartValue.htm)
		 Свойство StartValue
		 определяет значение, соответствующее началу сектора.


## Свойства, унаследованные от класса [GaugeArrowBase](../GaugeArrowBase/GaugeArrowBase.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Radius](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.Radius.htm)
		 Свойство Radius определяет
		 радиус (длину) указателя.


## Методы, унаследованные от класса [GaugeArrowBase](../GaugeArrowBase/GaugeArrowBase.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [animate](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.animate.htm)
		 Метод animate
		 переводит параметры стрелки к указанному шагу анимации.


		 ![](../../../Sub_Image.gif)
		 [calcRadius](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.calcRadius.htm)
		 Метод calcRadius вычисляет
		 радиус (длину) указателя.


		 ![](../../../Sub_Image.gif)
		 [getAutoResKoef](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.getAutoResKoef.htm)
		 Метод getAutoResKoef
		 возвращает отношение радиуса указателя спидометра к радиусу самого
		 спидометра.


		 ![](../../../Sub_Image.gif)
		 [getDimAttributeId](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.getDimAttributeId.htm)
		 Метод getDimAttributeId
		 возвращает идентификатор атрибута измерения, по которому выбираются
		 данные из источника данных.


		 ![](../../../Sub_Image.gif)
		 [getIsValid](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.getIsValid.htm)
		 Метод getIsValid
		 возвращает результат проверки значения указателя на корректность.


		 ![](../../../Sub_Image.gif)
		 [getScale](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.getScale.htm)
		 Метод getScale
		 возвращает шкалу, в которой находится текущий указатель.


		 ![](../../../Sub_Image.gif)
		 [setAnimationValues](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.setAnimationValues.htm)
		 Метод setAnimationValues
		 устанавливает значение следующего шага анимации.


		 ![](../../../Sub_Image.gif)
		 [setRadiusUnit](dhtmlGauge.chm::/Classes/Speedometer/GaugeArrowBase/GaugeArrowBase.setRadiusUnit.htm)
		 Метод setRadiusUnit
		 устанавливает тип измерения радиуса (длины) указателя.
