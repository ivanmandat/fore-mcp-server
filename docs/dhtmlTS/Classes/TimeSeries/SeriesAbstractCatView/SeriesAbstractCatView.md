...
Класс SeriesAbstractCatView реализует абстрактную вкладку [ленты инструментов рабочей книги](../../../Components/TimeSeries/WbkRibbon/WbkRibbon.htm) с кнопками управления временными рядами.


## Комментарии


Под абстрактной вкладкой понимается вкладка, которая визуально не отображается на ленте инструментов, но существует в виде объекта и предоставляет возможность выполнять действия, соответствующие её абстрактным кнопкам-объектам.


На следующем рисунке отображены кнопки управления временными рядами, по своей функциональности соответствующие кнопкам, содержащиеся на рассматриваемой абстрактной вкладке ленты инструментов:


![](SeriesAbstractCatView.png)


## Синтаксис


PP.initClass(PP.TS.Ui.SeriesAbstractCatView, [PP.TS.Ui.WbkCategoryView](../WbkCategoryView/WbkCategoryView.htm), "PP.TS.Ui.SeriesAbstractCatView");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [SeriesAbstractCatView](dhtmlTS.chm::/Classes/TimeSeries/SeriesAbstractCatView/Constructor_SeriesAbstractCatView.htm)
		 Конструктор SeriesAbstractCatView
		 создает экземпляр класса SeriesAbstractCatView.
