...
Класс MainSeriesPanel реализует панель «Основные», предназначенную для настройки базовых параметров временного ряда, отображаемого в таблице данных.


## Синтаксис


PP.initClass(PP.TS.Ui.MainSeriesPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "MainSeriesPanel");


## Комментарии


Мастер настройки преобразований имеет следующий вид:


![](MSP.PNG)


Для отображения панели необходимо на вкладке панели свойств «Ряд» раскрыть панель «Основные».
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MainSeriesPanel](dhtmlTS.chm::/Classes/TimeSeries/MainSeriesPanel/Constructor_MainSeriesPanel.htm)
		 Конструктор MainSeriesPanel
		 создает экземпляр класса MainSeriesPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setSource](dhtmlTS.chm::/Classes/TimeSeries/MainSeriesPanel/MainSeriesPanel.setSource.htm)
		 Метод setSource устанавливает
		 рабочую книгу данные которой отображаются в компоненте.


		 ![](../../../Sub_Image.gif)
		 [updateViewAsMenu](dhtmlTS.chm::/Classes/TimeSeries/MainSeriesPanel/MainSeriesPanel.updateViewAsMenu.htm)
		 Метод updateViewAsMenu
		 обновляет раскрывающийся список выбора применяемых преобразований.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/MainSeriesPanel/MainSeriesPanel.RequestMetadata.htm)
