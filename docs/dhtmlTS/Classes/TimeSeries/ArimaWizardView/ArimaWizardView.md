...
Класс ArimaWizardView реализует
 панель мастера настройки параметров метода расчёта «ARIMA».


## Синтаксис


PP.initClass(PP.TS.Ui.ArimaWizardView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "ArimaWizardView");
...
Панель мастера настройки параметров метода расчёта «ARIMA» имеет следующий
 вид:
...
Для отображения панели необходимо на вкладке ленты «Вычисления» нажать
 на кнопку «Прогнозирование», в раскрывающемся списке выбрать «ARIMA» и
 на вкладке панели свойств «Ряд» раскрыть панель «Параметры».
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](ArimaWizardView.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущее состояние мастера расчета «ARIMA».
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ControlChanged](ArimaWizardView.ControlChanged.htm)
		 Событие ControlChanged
		 генерируется после изменения настроек мастера.


		 ![](../../../Event_Image.gif)
		 [FormulaEditBlur](ArimaWizardView.FormulaEditBlur.htm)
		 Событие FormulaEditBlur
		 генерируется после потери фокуса поля ввода мастера.


		 ![](../../../Event_Image.gif)
		 [FormulaEditFocus](ArimaWizardView.FormulaEditFocus.htm)
		 Событие FormulaEditFocus
		 генерируется после наведения фокуса на поле ввода мастера.
