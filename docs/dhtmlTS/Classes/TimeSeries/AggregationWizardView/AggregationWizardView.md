...
Класс AggregationWizardView
 реализует панель параметров агрегации.


## Комментарии


Панель параметров агрегации имеет следующий вид:
...
Для отображения панели необходимо выбрать на вкладке ленты инструментов
 «Вычисления», нажать на кнопку «Агрегация» и в раскрывающемся списке выбрать
 «Интерполяция по времени (повторная)» или «Интерполяция по времени (пропорциональная)»,
...
PP.initClass(PP.TS.Ui.AggregationWizardView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "AggregationWizardView");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [AggregationWizardView](dhtmlTS.chm::/Classes/TimeSeries/AggregationWizardView/Constructor_AggregationWizardView.htm)
		 Конструктор AggregationWizardView
		 создает экземпляр класса AggregationWizardView.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](AggregationWizardView.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущее состояние панели параметров агрегации.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getMethodType](AggregationWizardView.getMethodType.htm)
		 Метод getMethodType
		 возвращает тип агрегации по времени.
