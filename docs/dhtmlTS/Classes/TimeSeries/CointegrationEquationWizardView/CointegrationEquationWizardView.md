...
Класс CointegrationEquationWizardView
 реализует панель настроек метода «Модель коррекции ошибок».


## Синтаксис


PP.initClass(PP.TS.Ui.CointegrationEquationWizardView,
...
 Панель настроек метода «Модель коррекции ошибок» имеет следующий
 вид:
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](CointegrationEquationWizardView.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущее состояние компонента панели настроек метода
