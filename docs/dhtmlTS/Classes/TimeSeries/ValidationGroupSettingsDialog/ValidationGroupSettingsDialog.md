...
Класс ValidationGroupSettingsDialog представляет собой [диалог для редактирования группы правил валидации](../../../Components/TimeSeries/ValidationGroupSettingsDialog/ValidationGroupSettingsDialog.htm) в [рабочей книге](../Workbook/Workbook.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.ValidationGroupSettingsDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.TS.Ui.ValidationGroupSettingsDialog");
