...
Класс SerieAttributesPanel реализует панель для редактирования значений атрибутов выделенных рядов.


## Синтаксис


PP.initClass(PP.TS.Ui.SerieAttributesPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "SerieAttributesPanel");


## Комментарии


Панель для редактирования значений атрибутов выделенных рядов имеет следующий вид:


![](SAP.PNG)


Панель расположена на вкладке «Ряд» панели свойств.
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [SerieAttributesPanel](dhtmlTS.chm::/Classes/TimeSeries/SerieAttributesPanel/Constructor_SerieAttributesPanel.htm)
		 Конструктор SerieAttributesPanel
		 создает экземпляр класса SerieAttributesPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/SerieAttributesPanel/SerieAttributesPanel.Source.htm)
		 Свойство Source
		 определяет источник данных установленный для
		 панели атрибутов.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [captionText](dhtmlTS.chm::/Classes/TimeSeries/SerieAttributesPanel/SerieAttributesPanel.captionText.htm)
		 Метод captionText
		 возвращает текст, который нужно выводить в раскрывающемся
		 списке для атрибута с указанным индексом.


		 ![](../../../Sub_Image.gif)
		 [clearAttrs](dhtmlTS.chm::/Classes/TimeSeries/SerieAttributesPanel/SerieAttributesPanel.clearAttrs.htm)
		 Метод clearAttrs
		 удаляет список рядов.


		 ![](../../../Sub_Image.gif)
		 [getCurrentState](dhtmlTS.chm::/Classes/TimeSeries/SerieAttributesPanel/SerieAttributesPanel.getCurrentState.htm)
