...
Класс WbkCategoryView реализует базовую категорию [ленты инструментов рабочей книги](../../../Components/TimeSeries/WbkRibbon/WbkRibbon.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.WbkCategoryView, PP.Ui.[RibbonCategory](dhtmlRibbon.chm::/Classes/RibbonCategory/RibbonCategory.htm), "WbkCategoryView", [PP.TS.Ui.IWbkView, PP.Ui.IMasterView]);
