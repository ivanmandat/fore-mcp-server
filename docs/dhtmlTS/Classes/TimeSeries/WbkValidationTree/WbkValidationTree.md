...
[MetabaseTreeList](dhtmlMetabase.chm::/Classes/Metabase/MetabaseTreeList/MetabaseTreeList.htm)
...
Класс WbkValidationTree
 реализует [дерево
 валидации](../../../Components/TimeSeries/WbkValidationTree/WbkValidationTree.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.WbkValidationTree, [PP.Mb.Ui.MetabaseTreeList](dhtmlMetabase.chm::/Classes/Metabase/MetabaseTreeList/MetabaseTreeList.htm),
 "PP.TS.Ui.WbkValidationTree");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [WbkValidationTree](dhtmlTS.chm::/Classes/TimeSeries/WbkValidationTree/Constructor_WbkValidationTree.htm)
		 Конструктор WbkValidationTree
		 создает экземпляр класса WbkValidationTree.
...
## Свойства
			 ...
			 ![](../../../Property_Image.gif)
			 [Source](dhtmlTS.chm::/Classes/TimeSeries/WbkValidationTree/WbkValidationTree.Source.htm)
			 Свойство Source
			 устанавливает источник данных для дерева валидации.
...
## События
			 ...
			 ![](../../../Event_Image.gif)
			 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/WbkValidationTree/WbkValidationTree.RequestMetadata.htm)
			 Событие RequestMetadata
			 генерируется при отсутствии метаданных в источнике дерева
			 валидации.


## Свойства, унаследованные от класса [MetabaseTreeList](dhtmlMetabase.chm::/Classes/Metabase/MetabaseTreeList/MetabaseTreeList.htm)
...
## Методы, унаследованные от класса [MetabaseTreeList](dhtmlMetabase.chm::/Classes/Metabase/MetabaseTreeList/MetabaseTreeList.htm)
...
## События, унаследованные от класса [MetabaseTreeList](dhtmlMetabase.chm::/Classes/Metabase/MetabaseTreeList/MetabaseTreeList.htm)
