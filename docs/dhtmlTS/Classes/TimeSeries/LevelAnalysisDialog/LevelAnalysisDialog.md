...
Класс LevelAnalysisDialog реализует [диалог правила валидации данных путём сравнения их с числом](../../../Components/TimeSeries/LevelAnalysisDialog/LevelAnalysisDialog.htm) в [рабочей книге](../Workbook/Workbook.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.LevelAnalysisDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.TS.Ui.LevelAnalysisDialog");
