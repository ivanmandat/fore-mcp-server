...
[WbkRibbonView](../WbkRibbonView/WbkRibbonView.htm)
...
Класс WbkRibbon реализует [ленту
 инструментов рабочей книги](../../../Components/TimeSeries/WbkRibbon/WbkRibbon.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.WbkRibbon, PP.TS.Ui.[WbkRibbonView](../WbkRibbonView/WbkRibbonView.htm),
 "WbkRibbon");
...
## Конструктор
			 ...
			 Конструктор
			 WbkRibbon создает экземпляр класса WbkRibbon.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [MetadataChanged](WbkRibbon.MetadataChanged.htm)
		 Событие MetadataChanged
		 наступает при изменении метаданных компонента.


## Свойства, унаследованные от класса [WbkRibbonView](../WbkRibbonView/WbkRibbonView.htm)
...
## Методы, унаследованные от класса [WbkRibbonView](../WbkRibbonView/WbkRibbonView.htm)
...
## События, унаследованные от класса [WbkRibbonView](../WbkRibbonView/WbkRibbonView.htm)
