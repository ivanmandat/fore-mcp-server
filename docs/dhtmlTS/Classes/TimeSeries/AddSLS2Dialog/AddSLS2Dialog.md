...
Класс AddSLS2Dialog реализует диалог добавления линейной регрессии (оценка методом инструментальных переменных).


## Синтаксис


PP.initClass(PP.TS.Ui.AddSLS2Dialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "AddSLS2Dialog");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [AddSLS2Dialog](Constructor_AddSLS2Dialog.htm)
