...
Класс TablePanel реализует панель настроек таблицы в [панели свойств рабочей книги](../../../Components/TimeSeries/WbkPropertyBar/WbkPropertyBar.htm).


## Комментарии


Панель настроек таблицы имеет наименование «Данные», расположена на панели свойств рабочей книги и может выглядеть следующим образом:
...
PP.initClass(PP.TS.Ui.TablePanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "TablePanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TablePanel](dhtmlTS.chm::/Classes/TimeSeries/TablePanel/Constructor_TablePanel.htm)
		 Конструктор TablePanel
		 создает экземпляр класса TablePanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Mode](dhtmlTS.chm::/Classes/TimeSeries/TablePanel/TablePanel.Mode.htm)
		 Свойство Mode определяет
		 режим отображения панели настроек таблицы в рабочей книге.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/TablePanel/TablePanel.Source.htm)
		 Свойство Source определяет
		 источник данных для панели настроек таблицы в рабочей книге.
