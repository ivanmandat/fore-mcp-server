...
[WbkDataView](../WbkDataView/WbkDataView.htm)
...
Класс WbkDataBox служит для отображения и управления данными рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.WbkDataBox, PP.TS.Ui.[WbkDataView](../WbkDataView/WbkDataView.htm), "WbkDataBox");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [WbkDataBox](Constructor_WbkDataBox.htm)
 Конструктор WbkDataBox создает экземпляр класса WbkDataBox.


## Свойства, унаследованные от класса [WbkDataView](../WbkDataView/WbkDataView.htm)
...
## Методы, унаследованные от класса [WbkDataView](../WbkDataView/WbkDataView.htm)
...
## События, унаследованные от класса [WbkDataView](../WbkDataView/WbkDataView.htm)
