...
Класс NonLinearRegressionEquationWizardView реализует мастер настройки параметров нелинейной регрессии.


## Синтаксис


PP.initClass(PP.TS.Ui.NonLinearRegressionEquationWizardView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "NonLinearRegressionEquationWizardView");


## Комментарии


Панель настройки параметров нелинейной регрессии имеет следующий вид:


![](NLREWV1.PNG)


Для отображения панели необходимо в таблице выделить несколько рядов, выбрать на вкладке ленты инструментов «Вычисления», нажать на кнопку «Регрессия» и в раскрывающемся списке выбрать «Нелинейная регрессия», на вкладке панели свойств «Ряд» раскрыть панель «Параметры».
...
## Свойства
 ...
 ![](../../../Property_Image.gif)
 [CurrentState](NonLinearRegressionEquationWizardView.CurrentState.htm)
