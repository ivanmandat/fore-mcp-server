...
Класс EquationSmoothingSlidingPanel реализует панель «Скользящее среднее» метода X11.


## Синтаксис


PP.initClass(PP.TS.Ui.EquationSmoothingSlidingPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "EquationSmoothingSlidingPanel");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [EquationSmoothingSlidingPanel](constructor_equationsmoothingslidingpanel.htm)
 Конструктор EguationSmoothingSlidingPanel создает экземпляр класса EguationSmoothingSlidingPanel.
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [setSource](equationsmoothingslidingpanel.setsource.htm)
