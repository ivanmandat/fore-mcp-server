...
Класс EquationWeightCoefficientsPanel
 реализует панель «Весовые коэффициенты» метода X11.


## Синтаксис


PP.initClass(PP.TS.Ui.EquationWeightCoefficientsPanel,
 PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "EquationWeightCoefficientsPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [EquationWeightCoefficientsPanel](Constructor_EquationWeightCoefficientsPanel.htm)
		 Конструктор EquationWeightCoefficientsPanel
		 создает экземпляр класса EquationWeightCoefficientsPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setSource](EquationWeightCoefficientsPanel.setSource.htm)
