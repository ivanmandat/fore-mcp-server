...
Класс MissingDataWizard реализует мастер для валидации типа «Пропуски в данных».


## Синтаксис


PP.initClass(PP.TS.Ui.MissingDataWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.MissingDataWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MissingDataWizard](dhtmlTS.chm::/Classes/TimeSeries/MissingDataWizard/Constructor_MissingDataWizard.htm)
		 Конструктор MissingDataWizard
		 создает экземпляр класса MissingDataWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/MissingDataWizard/MissingDataWizard.CurrentState.htm)
