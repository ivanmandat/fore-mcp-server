...
[WbkToolBarView](../WbkToolBarView/WbkToolBarView.htm)
...
Класс WbkToolBar реализует панель инструментов для управления видимостью представлений данных рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.WbkToolBar, PP.TS.Ui.[WbkToolBarView](../WbkToolBarView/WbkToolBarView.htm), "WbkToolBar");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/Constructor_WbkToolBar.htm)
		 Конструктор WbkToolBar
		 создаёт экземпляр класса WbkToolBar.


## Свойства, унаследованные от класса [WbkToolBarView](../WbkToolBarView/WbkToolBarView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [IsRadio](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.IsRadio.htm)
		 Свойство IsRadio определяет,
		 являются ли кнопки компонента [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm)
		 переключателями.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.Source.htm)
		 Свойство Source устанавливает
		 источник данных для компонента [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm).


## Методы, унаследованные от класса [WbkToolBarView](../WbkToolBarView/WbkToolBarView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getChartButton](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.getChartButton.htm)
		 Метод getChartButton возвращает
		 кнопку «Диаграмма» компонента [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm).


		 ![](../../../Sub_Image.gif)
		 [getGridButton](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.getGridButton.htm)
		 Метод getGridButton возвращает
		 кнопку «Таблица» компонента [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm).


		 ![](../../../Sub_Image.gif)
		 [getItems](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.getItems.htm)
		 Метод getItems возвращает
		 массив кнопок компонента [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm).


		 ![](../../../Sub_Image.gif)
		 [getMapButton](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.getMapButton.htm)
		 Метод getMapButton возвращает
		 кнопку «Карта» компонента [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm).


		 ![](../../../Sub_Image.gif)
		 [getToolBarState](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.getToolBarState.htm)
		 Метод getToolBarState возвращает
		 состояние компонента [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm).


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.refresh.htm)
		 Метод refresh обновляет
		 представление рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.refreshAll.htm)
		 Метод refreshAll обновляет
		 компонент [WbkToolBar](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBar/WbkToolBar.htm).


		 ![](../../../Sub_Image.gif)
		 [setActiveObject](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.setActiveObject.htm)
		 Метод setActiveObject активирует
		 представление рабочей книги.


## События, унаследованные от класса [WbkToolBarView](../WbkToolBarView/WbkToolBarView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [ObjectStateChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/WbkToolBarView.ObjectStateChanged.htm)
		 Событие ObjectStateChanged
		 наступает после изменения состояния представления рабочей
		 книги.
