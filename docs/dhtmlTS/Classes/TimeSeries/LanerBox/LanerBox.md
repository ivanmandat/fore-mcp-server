...
[LanerBoxView](../LanerBoxView/LanerBoxView.htm)
...
Класс LanerBox реализует компонент
 [LanerBox](../../../Components/TimeSeries/LanerBox/LanerBox.htm)
 для отображения таблицы рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.LanerBox, PP.TS.Ui.[LanerBoxView](../LanerBoxView/LanerBoxView.htm),
 "LanerBox");
...
## Конструктор
			 ...
			 Конструктор
			 LanerBox создает экземпляр класса LanerBox.


## Свойства, унаследованные от класса [LanerBoxView](../LanerBoxView/LanerBoxView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [EnableTabSheetActions](../LanerBoxView/LanerBoxView.EnableTabSheetActions.htm)
		 Свойство EnableTabSheetActions
		 определяет возможность выделения элементов таблицы.


## Методы, унаследованные от класса [LanerBoxView](../LanerBoxView/LanerBoxView.htm)
...
## События, унаследованные от класса [LanerBoxView](../LanerBoxView/LanerBoxView.htm)
