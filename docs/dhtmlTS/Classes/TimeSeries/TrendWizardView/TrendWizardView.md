...
Класс TrendWizardView реализует мастер настройки параметров тренда.


## Синтаксис


PP.initClass(PP.TS.Ui.TrendWizardView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "TrendWizardView");


## Комментарии


Панель настройки параметров тренда имеет следующий вид:


![](TWV1.PNG)


Для отображения панели необходимо выбрать на вкладке ленты инструментов «Вычисления», нажать на кнопку «Прогнозирование» и в раскрывающемся списке выбрать любой из доступных видов тренда, на вкладке панели свойств «Ряд» раскрыть панель «Параметры».
...
## Свойства
 ...
 ![](../../../Property_Image.gif)
 [CurrentState](TrendWizardView.CurrentState.htm)
 Свойство CurrentState определяет текущее состояние параметров тренда.
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [getMethodType](TrendWizardView.getMethodType.htm)
 Метод getMethodType возвращает тип формулы расчета выбранного вычисляемого ряда.
