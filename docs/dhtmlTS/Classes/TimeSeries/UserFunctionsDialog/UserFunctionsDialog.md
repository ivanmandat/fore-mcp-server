...
Класс **UserFunctionsDialog**
 реализует [диалог
 настройки пользовательских функций](../../../Components/TimeSeries/UserFunctionsDialog/UserFunctionsDialog.htm) в [рабочей
...
PP.initClass(PP.TS.Ui.UserFunctionsDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "PP.TS.Ui.UserFunctionsDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [UserFunctionsDialog](Constructor_UserFunctionsDialog.htm)
