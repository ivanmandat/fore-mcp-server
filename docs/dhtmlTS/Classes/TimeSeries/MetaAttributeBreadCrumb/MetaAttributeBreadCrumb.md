...
         [MetaAttributeBreadCrumbView](../MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm)
...
Класс MetaAttributeBreadCrumb
 реализует компонент для отображения и управления атрибутами рабочей книги,
 основанный на компоненте PP.Ui.[Breadcrumb](dhtmlUi.chm::/Components/Breadcrumb/Breadcrumb.htm).
...
PP.initClass(PP.TS.Ui.NavBreadcrumbView, PP.Ui.Master,
 "[NavBreadcrumbView](../NavBreadcrumbView/NavBreadcrumbView.htm)",
 PP.TS.Ui.IMetaAttributeBreadCrumbView);
...
## Свойства, унаследованные от класса [MetaAttributeBreadCrumbView](../MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm)
...
## Методы, унаследованные от класса [MetaAttributeBreadCrumbView](../MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm)
...
## События, унаследованные от класса [MetaAttributeBreadCrumbView](../MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm)
