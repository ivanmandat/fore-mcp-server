...
[WorkbookView](../WorkbookView/WorkbookView.htm)
...
Класс WorkbookBox реализует отображение рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.WorkbookBox, PP.TS.Ui.[WorkbookView](../WorkbookView/WorkbookView.htm), "WorkbookBox");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [WorkbookBox](Constructor_WorkbookBox.htm)
...
## Свойства, унаследованные от класса [WorkbookView](../WorkbookView/WorkbookView.htm)
...
## Методы, унаследованные от класса [WorkbookView](../WorkbookView/WorkbookView.htm)
...
## События, унаследованные от класса [WorkbookView](../WorkbookView/WorkbookView.htm)
