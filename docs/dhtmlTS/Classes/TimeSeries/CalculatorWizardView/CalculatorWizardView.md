...
Класс **CalculatorWizardView** реализует представление мастера калькулятора [на панели «Параметры»](../ParametersPanel/ParametersPanel.htm).


## Комментарии


Мастер калькулятора, реализуемый классом CalculatorWizardView и расположенный на панели «Параметры» боковой панели рабочей книги, может иметь следующий вид:
...
PP.initClass(PP.TS.Ui.CalculatorWizardView, [[PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), PP.TS.Ui.CalculatorMixin], "PP.TS.Ui.CalculatorWizardView");
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/CalculatorWizardView/CalculatorWizardView.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера калькулятора на [панели
		 параметров](dhtmlTS.chm::/Classes/TimeSeries/ParametersPanel/ParametersPanel.htm).
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ControlChanged](dhtmlTS.chm::/Classes/TimeSeries/CalculatorWizardView/CalculatorWizardView.ControlChanged.htm)
		 Событие ControlChanged
		 генерируется после изменения настроек мастера калькулятора на
		 [панели
		 «Параметры»](dhtmlTS.chm::/Classes/TimeSeries/ParametersPanel/ParametersPanel.htm).


		 ![](../../../Event_Image.gif)
		 [FormulaEditBlur](dhtmlTS.chm::/Classes/TimeSeries/CalculatorWizardView/CalculatorWizardView.FormulaEditBlur.htm)
		 Событие FormulaEditBlur
		 генерируется после потери фокуса окном ввода выражения в мастере
		 калькулятора.


		 ![](../../../Event_Image.gif)
		 [FormulaEditFocus](dhtmlTS.chm::/Classes/TimeSeries/CalculatorWizardView/CalculatorWizardView.FormulaEditFocus.htm)
		 Событие FormulaEditFocus
		 генерируется после установки фокуса в окно ввода выражения в мастере
		 калькулятора.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/CalculatorWizardView/CalculatorWizardView.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при запросе данных с сервера.
