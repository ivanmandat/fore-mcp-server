...
Класс CrossFrequencyWizard реализует мастер для валидации данных путём сравнения уровней динамики их временных рядов.


## Синтаксис


PP.initClass(PP.TS.Ui.CrossFrequencyWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.CrossFrequencyWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [CrossFrequencyWizard](dhtmlTS.chm::/Classes/TimeSeries/CrossFrequencyWizard/Constructor_CrossFrequencyWizard.htm)
		 Конструктор CrossFrequencyWizard
		 создает экземпляр класса CrossFrequencyWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/CrossFrequencyWizard/CrossFrequencyWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для валидации данных путём
		 сравнения уровней динамики их временных рядов.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [selLevels](dhtmlTS.chm::/Classes/TimeSeries/CrossFrequencyWizard/CrossFrequencyWizard.selLevels.htm)
		 Метод selLevels
		 устанавливаем список календарных уровней.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/CrossFrequencyWizard/CrossFrequencyWizard.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике мастера для
		 валидации данных путём сравнения уровней динамики их временных
		 рядов.
