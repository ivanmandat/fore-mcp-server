...
Класс StatisticalOutliersWizard реализует мастер для валидации путём анализа статистических выбросов данных временных рядов.


## Синтаксис


PP.initClass(PP.TS.Ui.StatisticalOutliersWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.StatisticalOutliersWizard");
...
## Комментарии
		 ...
		 ![](../../../Sub_Image.gif)
		 [StatisticalOutliersWizard](dhtmlTS.chm::/Classes/TimeSeries/StatisticalOutliersWizard/Constructor_StatisticalOutliersWizard.htm)
		 Конструктор StatisticalOutliersWizard
		 создает экземпляр класса StatisticalOutliersWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/StatisticalOutliersWizard/StatisticalOutliersWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для валидации путём анализа
