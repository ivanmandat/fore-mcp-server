...
Класс MetaAttributeBreadCrumbView
 реализует представление компонента [MetaAttributeBreadCrumb](../../../Components/TimeSeries/MetaAttributeBreadCrumb/MetaAttributeBreadCrumb.htm).
...
PP.initClass(PP.TS.Ui.MetaAttributeBreadCrumbView,
 PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm),
 "MetaAttributeBreadCrumb", PP.TS.Ui.IMetaAttributeBreadCrumbView);
