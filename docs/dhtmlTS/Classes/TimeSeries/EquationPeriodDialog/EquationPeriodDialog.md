...
Класс EquationPeriodDialog реализует
 диалог метода «Усечение».


## Комментарии


Диалог используется методом «Усечение», для преобразования ряда.
...
PP.initClass(PP.TS.Ui.EquationPeriodDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "PP.TS.Ui.EquationPeriodDialog");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [EquationPeriodDialog](Constructor_EquationPeriodDialog.htm)
			 Конструктор EquationPeriodDialog
			 создает экземпляр класса EquationPeriodDialog.
