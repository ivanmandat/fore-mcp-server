...
Метод getLastErrorButton** возвращает кнопку «Последняя ошибка» на вкладке «Валидация» ленты инструментов рабочей книги.
...
При нажатии на данную кнопку в таблице рабочей книги будет выделена ячейка, соответствующая последней ошибке валидации.
