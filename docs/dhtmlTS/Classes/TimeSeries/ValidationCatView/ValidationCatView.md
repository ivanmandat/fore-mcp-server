...
Класс ValidationCatView
 реализует вкладку «Валидация» [ленты
...
Вкладка «Валидация» ленты инструментов рабочей книги выглядит следующим
 образом:


![](ValidationCatView.png)


Данная вкладка отображается при условии, что выполнено какое-либо правило
 валидации.
...
PP.initClass(PP.TS.Ui.ValidationCatView, [PP.TS.Ui.WbkCategoryView](../WbkCategoryView/WbkCategoryView.htm),
 "PP.TS.Ui.ValidationCatView");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ValidationCatView](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/Constructor_ValidationCatView.htm)
		 Конструктор ValidationCatView
		 создает экземпляр класса ValidationCatView.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getClearButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getClearButton.htm)
		 Метод getClearButton
		 возвращает кнопку «Очистить» на вкладке «Валидация» ленты инструментов
		 рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getExplainButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getExplainButton.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getFirstErrorButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getFirstErrorButton.htm)
		 Метод getFirstErrorButton
		 возвращает кнопку «Первая ошибка» на вкладке «Валидация» ленты
		 инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getHideExplanationButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getHideExplanationButton.htm)
		 Метод getHideExplanationButton
		 возвращает кнопку «Скрыть объяснённые» на вкладке «Валидация»
		 ленты инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getLastErrorButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getLastErrorButton.htm)
		 Метод getLastErrorButton
		 возвращает кнопку «Последняя ошибка» на вкладке «Валидация» ленты
		 инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getLegendButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getLegendButton.htm)
		 Метод getLegendButton
		 возвращает кнопку «Легенда» на вкладке «Валидация» ленты инструментов
		 рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getNextErrorButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getNextErrorButton.htm)
		 Метод getNextErrorButton
		 возвращает кнопку «Следующая ошибка» на вкладке «Валидация» ленты
		 инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getPreviousErrorButton](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.getPreviousErrorButton.htm)
		 Метод getPreviousErrorButton
		 возвращает кнопку «Предыдущая ошибка» на вкладке «Валидация» ленты
		 инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.refresh.htm)
		 Метод refresh
		 обновляет вкладку «Валидация» на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [setExplanation](dhtmlTS.chm::/Classes/TimeSeries/ValidationCatView/ValidationCatView.setExplanation.htm)
		 Метод setExplanation
		 устанавливает в диалоге текст объяснения для выбранной ошибки
		 валидации.
