...
Класс NewRevisionDlg реализует диалог добавления метки.


## Синтаксис


PP.initClass(PP.TS.Ui.NewRevisionDlg, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "NewRevisionDlg");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [NewRevisionDlg](Constructor_NewRevisionDlg.htm)
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [getDescription](NewRevisionDlg.getDescription.htm)
 Метод getDescription возвращает комментарий метки (ревизии).


 ![](../../../Sub_Image.gif)
 [getName](NewRevisionDlg.getName.htm)
 Метод getName возвращает наименование метки (ревизии).
