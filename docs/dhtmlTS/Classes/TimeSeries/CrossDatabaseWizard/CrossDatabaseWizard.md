...
Класс CrossDatabaseWizard реализует мастер для валидации данных путём их сравнения с базой данных временных рядов.


## Синтаксис


PP.initClass(PP.TS.Ui.CrossDatabaseWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.CrossDatabaseWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [CrossDatabaseWizard](dhtmlTS.chm::/Classes/TimeSeries/CrossDatabaseWizard/Constructor_CrossDatabaseWizard.htm)
		 Конструктор CrossDatabaseWizard
		 создает экземпляр класса CrossDatabaseWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/CrossDatabaseWizard/CrossDatabaseWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера правила валидации данных
		 путём их сравнения с базой данных временных рядов.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/CrossDatabaseWizard/CrossDatabaseWizard.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике мастера правила
