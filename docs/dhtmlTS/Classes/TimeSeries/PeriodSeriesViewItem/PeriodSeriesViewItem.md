...
Класс PeriodSeriesViewItem реализует [панель «Ряды»](../../../Components/TimeSeries/PeriodSeriesViewItem/PeriodSeriesViewItem.htm) на [панели свойств рабочей книги](../../../Components/TimeSeries/WbkPropertyBar/WbkPropertyBar.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.PeriodSeriesViewItem, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "PP.TS.Ui.PeriodSeriesViewItem");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [PeriodSeriesViewItem](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewItem/Constructor_PeriodSeriesViewItem.htm)
		 Конструктор PeriodSeriesViewItem
		 создает экземпляр класса PeriodSeriesViewItem.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Selected](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewItem/PeriodSeriesViewItem.Selected.htm)
		 Свойство Selected
		 устанавливает и возвращает признак того, что атрибут «Ряды» отмечен.
...
## Методы
			 ...
			 ![](../../../Sub_Image.gif)
			 [getSeriesTreeView](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewItem/PeriodSeriesViewItem.getSeriesTreeView.htm)
...
## События
			 ...
			 ![](../../../Event_Image.gif)
			 [DerivedVisibleChanged](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewItem/PeriodSeriesViewItem.DerivedVisibleChanged.htm)
			 Событие DerivedVisibleChanged
			 наступает при изменении позиции размещения данных временных
			 рядов в рабочей книге.


			 ![](../../../Event_Image.gif)
			 [RootLoaded](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewItem/PeriodSeriesViewItem.RootLoaded.htm)
			 Событие RootLoaded
			 наступает при загрузке временных рядов в источник панели «Ряды»
			 на панели свойств рабочей книги.
