...
Класс MetaDataViewerPanel реализует
 панель атрибутов вкладки «Ряд» боковой панели.


## Комментарии


Класс реализует компонент [MetaDataViewerPanel](../../../Components/MetaDataViewerPanel/MetaDataViewerPanel.htm).


Панель предназначена для редактирования значений атрибутов выделенных
 рядов, может выглядеть следующим образом:
...
PP.initClass(PP.TS.Ui.MetaDataViewrePanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "MetaDataViewerPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MetaDataViewerPanel](Constructor_MetaDataViewerPanel.htm)
		 Конструктор MetaDataViewerPanel
		 создает экземпляр класса MetaDataViewerPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](MetaDataViewerPanel.Source.htm)
		 Свойство Source
		 определяет источник данных для панели атрибутов в рабочей книге.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](MetaDataViewerPanel.RequestMetadata.htm)
