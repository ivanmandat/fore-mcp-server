...
Класс ComponentMismatchWizard реализует [мастер для выделения изменённых значений данных временных рядов](../../../Components/TimeSeries/ComponentMismatchWizard/ComponentMismatchWizard.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.ComponentMismatchWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.ComponentMismatchWizard");
