...
Класс CustomAnalysisWizard реализует мастер для валидации данных путём пользовательского анализа временных рядов.


## Синтаксис


PP.initClass(PP.TS.Ui.CustomAnalysisWizard, [[PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), PP.TS.Ui.ExpressionEditorMixin], "PP.TS.Ui.CustomAnalysisWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [CustomAnalysisWizard](dhtmlTS.chm::/Classes/TimeSeries/CustomAnalysisWizard/Constructor_CustomAnalysisWizard.htm)
		 Конструктор CustomAnalysisWizard
		 создает экземпляр класса CustomAnalysisWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/CustomAnalysisWizard/CustomAnalysisWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для валидации данных путём
		 пользовательского анализа временных рядов.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getExpressionEditorDialog](dhtmlTS.chm::/Classes/TimeSeries/CustomAnalysisWizard/CustomAnalysisWizard.getExpressionEditorDialog.htm)
		 Метод getExpressionEditorDialog
		 возвращает редактор выражения.


		 ![](../../../Sub_Image.gif)
		 [setHierarchy](dhtmlTS.chm::/Classes/TimeSeries/CustomAnalysisWizard/CustomAnalysisWizard.setHierarchy.htm)
		 Метод setHierarchy
		 устанавливает иерархию репозитория в редакторе выражения рабочей
		 книги.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/CustomAnalysisWizard/CustomAnalysisWizard.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике мастера для
