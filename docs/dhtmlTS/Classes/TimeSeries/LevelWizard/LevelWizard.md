...
Класс LevelWizard реализует мастер правила валидации данных путём их сравнения с числом.


## Комментарии


Мастер правила валидации данных путём их сравнения с числом, размещённый в отдельном диалоге, по внешнему виду схож с компонентом [LevelAnalysisDialog](../../../Components/TimeSeries/LevelAnalysisDialog/LevelAnalysisDialog.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.LevelWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.LevelWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [LevelWizard](dhtmlTS.chm::/Classes/TimeSeries/LevelWizard/Constructor_LevelWizard.htm)
		 Конструктор LevelWizard
		 создает экземпляр класса LevelWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/LevelWizard/LevelWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера правила валидации данных
		 путём их сравнения с числом.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getIfValueLabel](dhtmlTS.chm::/Classes/TimeSeries/LevelWizard/LevelWizard.getIfValueLabel.htm)
		 Метод getIfValueLabel
		 возвращает текст раскрывающегося списка для выбора условия сравнения
		 данных с числом в мастере валидации.
