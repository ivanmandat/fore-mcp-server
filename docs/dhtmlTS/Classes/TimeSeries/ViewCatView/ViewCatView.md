...
Класс ViewCatView реализует вкладку «Вид» ленты инструментов рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.ViewCatView, PP.TS.Ui.[WbkCategoryView](../WbkCategoryView/WbkCategoryView.htm), "ViewCatView");
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [getAutoUpdateButton](ViewCatView.getAutoUpdateButton.htm)
 Метод getAutoUpdateButton возвращает кнопку «Обновлять автоматически».


 ![](../../../Sub_Image.gif)
 [getLayoutButton](ViewCatView.getLayoutButton.htm)
 Метод getLayoutButton возвращает кнопку «Раскладка».


 ![](../../../Sub_Image.gif)
 [refresh](ViewCatView.refresh.htm)
 Метод refresh обновляет вкладку «Вид» ленты инструментов рабочей книги.
