...
Событие MetadataChangeStart наступает во время изменения метаданных иерархии рядов.
...
После выполнения примера будут изменены метаданные иерархии рядов и в консоли браузера будет выведено следующее сообщение:
