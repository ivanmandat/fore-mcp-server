...
Класс HieService служит для
 работы с иерархией базы данных временных рядов продукта «Форсайт. Аналитическая платформа».


## Синтаксис


PP.initClass(PP.TS.HieService, PP.Mb.[PPService](dhtmlMetabase.chm::/Classes/Metabase/PPService/PPService.htm),
 "HieService");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [HieService](Constructor_HieService.htm)
		 Конструктор HieService
		 создает экземпляр класса HieService.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [open](HieService.open.htm)
		 Метод open посылает
		 запрос на открытие иерархии рабочей книги по одному из параметров.
