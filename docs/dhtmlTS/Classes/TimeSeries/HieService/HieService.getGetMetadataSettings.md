...
Метод getGetMetadataSettings возвращает тело запроса получения метаданных иерархии рядов.
...
После выполнения примера в консоль браузера будет выведено тело запроса получения метаданных иерархии рядов:


Получаем тело запроса получения метаданных иерархии рядов
