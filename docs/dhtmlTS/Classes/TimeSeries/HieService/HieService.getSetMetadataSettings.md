...
Метод getSetMetadataSettings возвращает тело запроса сохранения метаданных иерархии рядов.
...
После выполнения примера в консоль браузера будет выведено тело запроса сохранения метаданных иерархии рядов:


Получаем тело запроса сохранения метаданных иерархии рядов
