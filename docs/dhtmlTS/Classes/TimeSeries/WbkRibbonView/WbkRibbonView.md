...
Класс WbkRibbonView реализует
 представление [ленты
 инструментов](../../../Components/TimeSeries/WbkRibbon/WbkRibbon.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.WbkRibbonView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm)
	, "WbkRibbonView");
...
## Свойства, унаследованные от класса [ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm)
...
## События, унаследованные от класса [ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm)
