...
Класс SpliceMethodWizard реализует [мастер настройки сращивания временных рядов](../../../Components/TimeSeries/SpliceMethodWizard/SpliceMethodWizard.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.SpliceMethodWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.SpliceMethodWizard");
