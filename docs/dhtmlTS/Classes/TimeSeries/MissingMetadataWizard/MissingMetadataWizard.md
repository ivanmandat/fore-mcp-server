...
Класс MissingMetadataWizard реализует мастер для валидации типа «Пропуски в метаданных».


## Синтаксис


PP.initClass(PP.TS.Ui.MissingMetadataWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.MissingMetadataWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MissingMetadataWizard](dhtmlTS.chm::/Classes/TimeSeries/MissingMetadataWizard/Constructor_MissingMetadataWizard.htm)
		 Конструктор **MissingMetadataWizard** создаёт экземпляр
		 класса **MissingMetadataWizard**.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/MissingMetadataWizard/MissingMetadataWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для валидации типа «Пропуски
		 в метаданных».
