...
[HieTreeView](../HieTreeView/HieTreeView.htm)
...
Класс MetaAttributeTree реализует
 компонент для отображения иерархии каталога показателей BI-сервера продукта
...
PP.initClass(PP.TS.Ui.MetaAttributeTree, PP.TS.Ui.[HieTreeView](../HieTreeView/HieTreeView.htm), "MetaAttributeTree");
...
## Свойства, унаследованные от класса [HieTreeView](../HieTreeView/HieTreeView.htm)
...
## Методы, унаследованные от класса [HieTreeView](../HieTreeView/HieTreeView.htm)
...
## События, унаследованные от класса [HieTreeView](../HieTreeView/HieTreeView.htm)
