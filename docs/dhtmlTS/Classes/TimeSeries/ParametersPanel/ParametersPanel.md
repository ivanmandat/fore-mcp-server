...
Класс ParametersPanel реализует панель параметров в панели свойств.


## Комментарии


Для отображения панель параметров необходимо в таблице выделить вычисляемый ряд и на вкладке панели свойств «Ряд» раскрыть панель «Параметры». В зависимости от метода расчета ряда на панели доступны различные настройки.


## Синтаксис


PP.initClass(PP.TS.Ui.ParametersPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "ParametersPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ParametersPanel](dhtmlTS.chm::/Classes/TimeSeries/ParametersPanel/Constructor_ParametersPanel.htm)
		 Конструктор ParametersPanel
		 создает экземпляр класса ParametersPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setSource](dhtmlTS.chm::/Classes/TimeSeries/ParametersPanel/ParametersPanel.setSource.htm)
		 Метод setSource
		 устанавливает рабочую книгу, данные которой
		 отображаются в компоненте.
