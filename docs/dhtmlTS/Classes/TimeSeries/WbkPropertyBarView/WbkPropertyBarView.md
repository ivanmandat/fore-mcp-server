...
Класс WbkPropertyBarView реализует компонент «Панель свойств рабочей книги».


## Синтаксис


PP.initClass(PP.TS.Ui.WbkPropertyBarView, PP.Ui.[Master](dhtmlUi.chm::/Classes/Master/Master.htm), "WbkPropertyBarView", PP.TS.Ui.IWbkPropertyBarView);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [WbkPropertyBarView](dhtmlTS.chm::/Classes/TimeSeries/WbkPropertyBarView/Constructor_WbkPropertyBarView.htm)
		 Конструктор WbkPropertyBarView
		 создает экземпляр класса WbkPropertyBarView.
