...
Класс RevisionsPanel реализует
 панель ревизии для базы данных временных рядов.


## Комментарии


Панель «Ревизии» для базы данных временных рядов может иметь следующий
 вид:
...
Панель находится на вкладке данные и ее заголовок совпадает с наименованием
...
PP.initClass(PP.TS.Ui.RevisionsPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "RevisionsPanel");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [RevisionsPanel](dhtmlTS.chm::/Classes/TimeSeries/RevisionsPanel/Constructor_RevisionsPanel.htm)
			 Конструктор RevisionsPanel
			 создает экземпляр класса RevisionsPanel.
