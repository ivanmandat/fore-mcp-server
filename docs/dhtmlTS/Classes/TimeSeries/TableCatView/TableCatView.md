...
Класс TableCatView реализует вкладку «Таблица» [ленты инструментов](../../../Components/TimeSeries/WbkRibbon/WbkRibbon.htm) рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.TableCatView, PP.TS.Ui.[WbkCategoryView](../WbkCategoryView/WbkCategoryView.htm), "TableCatView");
