...
Класс SlideSmoothingWizardView реализует панель параметров скользящего среднего.


## Синтаксис


PP.initClass(PP.TS.Ui.SlideSmoothingWizardView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "SlideSmoothingWizardView");


## Комментарии


Панель параметров скользящего среднего имеет следующий вид:


![](SSWV1.PNG)


Для отображения панели необходимо выбрать на вкладке ленты инструментов «Вычисления», нажать на кнопку «Сглаживание» и в раскрывающемся списке выбрать «Скользящее среднее», на вкладке панели свойств «Ряд» раскрыть панель «Параметры».
...
## Свойства
 ...
 ![](../../../Property_Image.gif)
 [CurrentState](SlideSmoothingWizardView.CurrentState.htm)
 Свойство CurrentState возвращает параметры скользящего среднего.
