...
Класс StatTabSheet реализует
 [электронную
 таблицу рабочей книги](../../../Components/TimeSeries/StatTabSheet/StatTabSheet.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.StatTabSheet, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "StatTabSheet");
