...
Класс BaxterKingFilterWizardView
 реализует панель мастера настройки параметров фильтра Бакстера-Кинга.


## Синтаксис


PP.initClass(PP.TS.Ui.BaxterKingFilterWizardView,
...
Панель параметров фильтра Бакстера-Кинга имеет следующий вид:


![](BKFWV2.PNG)


Для отображения панели необходимо нажать на кнопку «Сглаживание» на
 вкладке ленты «Вычисления», в раскрывающемся списке выбрать «Фильтр Бакстера-Кинга»
 и на вкладке панели свойств «Ряд» раскрыть панель «Параметры».
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](BaxterKingFilterWizardView.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущее состояние компонента мастера настройки
		 параметров фильтра Бакстера-Кинга.
