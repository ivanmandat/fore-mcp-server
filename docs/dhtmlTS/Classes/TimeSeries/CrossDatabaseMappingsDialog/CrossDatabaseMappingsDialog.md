...
Класс CrossDatabaseMappingsDialog реализует [диалог сопоставления атрибутов](../../../Components/TimeSeries/CrossDatabaseMappingsDialog/CrossDatabaseMappingsDialog.htm) в [рабочей книге](../../../Components/TimeSeries/WorkbookBox/WorkbookBox.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.CrossDatabaseMappingsDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.TS.Ui.CrossDatabaseMappingsDialog");
