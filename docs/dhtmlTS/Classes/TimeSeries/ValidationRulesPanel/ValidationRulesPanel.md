...
Класс ValidationRulesPanel реализует панель правил валидации в рабочей книге.


## Комментарии


Панель правил валидации расположена на панели свойств рабочей книги и может выглядеть следующим образом:
...
PP.initClass(PP.TS.Ui.ValidationRulesPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "PP.TS.Ui.ValidationRulesPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ValidationRulesPanel](dhtmlTS.chm::/Classes/TimeSeries/ValidationRulesPanel/Constructor_ValidationRulesPanel.htm)
		 Конструктор ValidationRulesPanel
		 создает экземпляр класса ValidationRulesPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getValidationGroupSettingsDialog](dhtmlTS.chm::/Classes/TimeSeries/ValidationRulesPanel/ValidationRulesPanel.getValidationGroupSettingsDialog.htm)
		 Метод getValidationGroupSettingsDialog
		 возвращает диалог с настройками группы правил валидации.


		 ![](../../../Sub_Image.gif)
		 [getValidationSettingsDialog](dhtmlTS.chm::/Classes/TimeSeries/ValidationRulesPanel/ValidationRulesPanel.getValidationSettingsDialog.htm)
		 Метод getValidationSettingsDialog
		 возвращает диалог с настройками правила валидации.


		 ![](../../../Sub_Image.gif)
		 [setSource](dhtmlTS.chm::/Classes/TimeSeries/ValidationRulesPanel/ValidationRulesPanel.setSource.htm)
		 Метод setSource
		 устанавливает источник данных для панели правил валидации в рабочей
		 книге.


		 ![](../../../Sub_Image.gif)
		 [setValidation](dhtmlTS.chm::/Classes/TimeSeries/ValidationRulesPanel/ValidationRulesPanel.setValidation.htm)
		 Метод setValidation
		 устанавливает настройки правила валидации в рабочей книге.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/ValidationRulesPanel/ValidationRulesPanel.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике панели правил
		 валидации в рабочей книге.
