...
Класс TabStatPanel реализует
 [TabControl](dhtmlUi.chm::/Components/TabControl/TabControl.htm)
 со вкладками для отображения статистик.


## Синтаксис


PP.initClass(PP.TS.Ui.TabStatPanel, PP.Ui[.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "ModelStatView", PP.IView);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TabStatPanel](Constructor_TabStatPanel.htm)
		 Конструктор TabStatPanel
		 создает экземпляр класса TabStatPanel.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](TabStatPanel.Source.htm)
		 Свойство Source возвращает
		 источник данных статистик.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [clear](TabStatPanel.clear.htm)
		 Метод clear очищает
		 дерево характеристик панели статистик.


		 ![](../../../Sub_Image.gif)
		 [collapse](TabStatPanel.collapse.htm)
		 Метод collapse сворачивает
		 панель статистик.


		 ![](../../../Sub_Image.gif)
		 [expand](TabStatPanel.expand.htm)
		 Метод expand разворачивает
		 панель статистик.


		 ![](../../../Sub_Image.gif)
		 [getlsCollapsed](TabStatPanel.getIsCollapsed.htm)
		 Метод getlsCollapsed
		 возвращает признак, свернута ли панель статистик.


		 ![](../../../Sub_Image.gif)
		 [refresh](TabStatPanel.refresh.htm)
		 Метод refresh обновляет
		 компонент в соответствии с метаданными.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](TabStatPanel.refreshAll.htm)
		 Метод refreshAll обновляет
		 весь компонент в соответствии с метаданными.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Toogled](TabStatPanel.Toogled.htm)
		 Событие Toolget наступает
		 после сворачивания/разворачивания панели статистик.
