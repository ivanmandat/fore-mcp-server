...
Класс ExponentialSmoothingWizardView
 реализует мастер настройки параметров расчёта метода «Экспоненциальное
 сглаживание».
...
![](ExponentialSmoothingWizardView_ex.png)


Мастер расположен на панели «Параметры» (на вкладке панели свойств «Ряд»).
 Мастер доступен, если в таблице выделен ряд, рассчитанный по методу «Экспоненциальное
 сглаживание».
...
PP.initClass(PP.TS.Ui.ExponentialSmoothingWizardView,
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](ExponentialSmoothingWizardView.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие параметры [модели
		 сезонности](../../../Enums/StatSeasonalityType.htm).
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getAutoFitPanelEnabled](ExponentialSmoothingWizardView.getAutoFitPanelEnabled.htm)
