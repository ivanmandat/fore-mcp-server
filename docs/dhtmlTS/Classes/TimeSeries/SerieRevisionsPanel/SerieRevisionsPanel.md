...
          [RevisionsPanel](../RevisionsPanel/RevisionsPanel.htm)
...
Класс SerieRevisionsPanel реализует панель «Ревизии» для конкретного ряда.


## Комментарии


Панель ревизии имеет следующий вид:


![](SRP.PNG)


Для отображения панели необходимо выбрать в таблице один ряд данных, на [панели свойств рабочей книги](../WbkPropertyBarView/WbkPropertyBarView.htm) выбрать вкладку «Ряд», раскрыть панель «Ревизии».


## Синтаксис


PP.initClass(PP.TS.Ui.SerieRevisionsPanel, PP.TS.Ui.[RevisionsPanel](../RevisionsPanel/RevisionsPanel.htm), "SerieRevisionsPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [SerieRevisionsPanel](dhtmlTS.chm::/Classes/TimeSeries/SerieRevisionsPanel/Constructor_SerieRevisionsPanel.htm)
		 Конструктор SerieRevisionsPanel
		 создает экземпляр класса SerieRevisionsPanel.
...
## Свойства
		 ...
		 ![](../../../Sub_Image.gif)
		 [NeedRefresh](dhtmlTS.chm::/Classes/TimeSeries/SerieRevisionsPanel/SerieRevisionsPanel.NeedRefresh.htm)
		 Свойство NeedRefresh
		 определяет, необходимо ли получать запросы с сервера нового списка
		 ревизий и обновления панели.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [updateSerieListSelection](dhtmlTS.chm::/Classes/TimeSeries/SerieRevisionsPanel/SerieRevisionsPanel.updateSerieListSelection.htm)
		 Метод updateSerieListSelection
		 обновляет выделение в списке ревизий.


## Свойства, унаследованные от класса [RevisionsPanel](../RevisionsPanel/RevisionsPanel.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Revisions](dhtmlTS.chm::/Classes/TimeSeries/RevisionsPanel/RevisionsPanel.Revisions.htm)
		 Свойство Revisions
		 возвращает массив ревизий, которые отображаются в компоненте.


		 ![](../../../Property_Image.gif)
		 [RubKey](dhtmlTS.chm::/Classes/TimeSeries/RevisionsPanel/RevisionsPanel.RubKey.htm)
		 Свойство RubKey определяет ключ каталога показателей, ревизии
		 которого отображаются в компоненте.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/RevisionsPanel/RevisionsPanel.Source.htm)
		 Свойство Source
		 возвращает рабочую книгу, данные которой отображаются в
		 компоненте.


## Методы, унаследованные от класса [RevisionsPanel](../RevisionsPanel/RevisionsPanel.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [refreshListBox](dhtmlTS.chm::/Classes/TimeSeries/RevisionsPanel/RevisionsPanel.refreshListBox.htm)
		 Метод refreshListBox
		 обновляет список в соответствии с коллекцией
		 ревизий this._Revisions.


## События, унаследованные от класса [RevisionsPanel](../RevisionsPanel/RevisionsPanel.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/RevisionsPanel/RevisionsPanel.RequestMetadata.htm)
		 Событие RequestMetadata наступает
		 при запросе метаданных
		 для панели «Ревизии» на панели свойств рабочей книги.
