...
Класс RevisionMetadataComparisonWizard реализует мастер для валидации данных путём сравнения версий метаданных в рабочей книге.


## Синтаксис


PP.initClass(PP.TS.Ui.RevisionMetadataComparisonWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.RevisionMetadataComparisonWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RevisionMetadataComparisonWizard](dhtmlTS.chm::/Classes/TimeSeries/RevisionMetadataComparisonWizard/Constructor_RevisionMetadataComparisonWizard.htm)
		 Конструктор RevisionMetadataComparisonWizard
		 создает экземпляр класса RevisionMetadataComparisonWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/RevisionMetadataComparisonWizard/RevisionMetadataComparisonWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для валидации данных путём
		 сравнения версий метаданных.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/RevisionMetadataComparisonWizard/RevisionMetadataComparisonWizard.RequestMetadata.htm)
