...
Класс ValidationErrorsPanel реализует панель ошибок валидации в рабочей книге.


## Комментарии


Панель ошибок валидации расположена на панели свойств рабочей книги и может выглядеть следующим образом:
...
PP.initClass(PP.TS.Ui.ValidationErrorsPanel,  [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "PP.TS.Ui.ValidationErrorsPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ValidationErrorsPanel](dhtmlTS.chm::/classes/TimeSeries/ValidationErrorsPanel/constructor_ValidationErrorsPanel.htm)
		 Конструктор ValidationErrorsPanel
		 создает экземпляр класса ValidationErrorsPanel.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getValidationSettingsDialog](dhtmlTS.chm::/Classes/TimeSeries/ValidationErrorsPanel/ValidationErrorsPanel.getValidationSettingsDialog.htm)
		 Метод getValidationSettingsDialog
		 возвращает диалог для редактирования правила валидации данных
		 в рабочей книге.


		 ![](../../../Sub_Image.gif)
		 [setSource](dhtmlTS.chm::/Classes/TimeSeries/ValidationErrorsPanel/ValidationErrorsPanel.setSource.htm)
		 Метод setSource
		 устанавливает источник данных для панели ошибок валидации.


		 ![](../../../Sub_Image.gif)
		 [setValidation](dhtmlTS.chm::/Classes/TimeSeries/ValidationErrorsPanel/ValidationErrorsPanel.setValidation.htm)
		 Метод setValidation
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/ValidationErrorsPanel/ValidationErrorsPanel.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике панели ошибок
