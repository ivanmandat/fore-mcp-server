...
Класс ValidationSettingsDialog реализует [диалог для редактирования правила валидации данных](../../../Components/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.htm) в [рабочей книге](../../../Components/TimeSeries/WorkbookBox/WorkbookBox.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.ValidationSettingsDialog, [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.TS.Ui.ValidationSettingsDialog");
