...
Класс PeriodSeriesViewMaster реализует [мастер для отображения и управления атрибутами рабочей книги](../../../Components/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.htm) на [панели свойств](../../../Components/TimeSeries/WbkPropertyBar/WbkPropertyBar.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.PeriodSeriesViewMaster, [PP.Ui.Master](dhtmlUi.chm::/Classes/Master/Master.htm), "PP.TS.Ui.PeriodSeriesViewMaster");
