...
Класс Workbook описывает модель
 данных рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Workbook, PP.Exp.[EaxAnalyzer](dhtmlExpress.chm::/Classes/Express/EaxAnalyzer/EaxAnalyzer.htm),
 "Workbook", PP.Exp.IStatistics);
