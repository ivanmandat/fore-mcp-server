...
Класс ExplainValidationErrorDialog реализует [диалог для объяснения ошибки валидации данных](../../../Components/TimeSeries/ExplainValidationErrorDialog/ExplainValidationErrorDialog.htm) в [рабочей книге](../Workbook/Workbook.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.ExplainValidationErrorDialog,  [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.TS.Ui.ExplainValidationErrorDialog");
