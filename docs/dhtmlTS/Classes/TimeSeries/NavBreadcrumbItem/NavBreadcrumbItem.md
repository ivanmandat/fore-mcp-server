...
Класс NavBreadcrumbItem реализует панель, содержащую дерево измерения атрибута.


## Комментарии


Компонент предназначен для отображения и управления атрибутами рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.NavBreadcrumbItem, PP.TS.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "NavBreadcrumbItem");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [NavBreadcrumbItem](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbItem/Constructor_NavBreadcrumbItem.htm)
		 Конструктор NavBreadcrumbItem
		 создает экземпляр класса NavBreadcrumbItem**.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Selected](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbItem/NavBreadcrumbItem.Selected.htm)
		 Свойство Selected
		 возвращает признак, что атрибут отмечен.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getDimTreeView](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbItem/NavBreadcrumbItem.getDimTreeView.htm)
		 Метод getDimTreeView
		 возвращает дерево измерения атрибута, расположенное
		 в панели.
