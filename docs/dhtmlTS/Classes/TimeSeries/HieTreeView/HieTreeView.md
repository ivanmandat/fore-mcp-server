...
Класс HieTreeView реализует компонент для отображения объекта [MetaHierarchy](../MetaHierarchy/MetaHierarchy.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.HieTreeView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm), "HieTreeView", PP.TS.Ui.IHieTreeView);
