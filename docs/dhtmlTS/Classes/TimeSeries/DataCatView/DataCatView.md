...
Класс DataCatView реализует
 вкладку ленты инструментов «Данные».


## Синтаксис


PP.initClass(PP.TS.Ui.DataCatView, PP.TS.Ui.[WbkCategoryView](../WbkCategoryView/WbkCategoryView.htm),
 "DataCatView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getConsolidateButton](DataCatView.getConsolidateButton.htm)
		 Метод getConsolidateButton
		 возвращает кнопку «Блокировать».


		 ![](../../../Sub_Image.gif)
		 [getDataEditCancelButton](DataCatView.getDataEditCancelButton.htm)
		 Метод getDataEditCancelButton
		 возвращает кнопку «Отменить изменения».


		 ![](../../../Sub_Image.gif)
		 [getDataEditSaveButton](DataCatView.getDataEditSaveButton.htm)
		 Метод getDataEditSaveButton
		 возвращает кнопку «Сохранить изменения».


		 ![](../../../Sub_Image.gif)
		 [getUnbindButton](DataCatView.getUnbindButton.htm)
		 Метод getUnbindButton
		 возвращает кнопку «Отвязать».


		 ![](../../../Sub_Image.gif)
		 [refresh](DataCatView.refresh.htm)
		 Метод refresh обновляет
		 вкладку «Данные» ленты инструментов рабочей книги.
