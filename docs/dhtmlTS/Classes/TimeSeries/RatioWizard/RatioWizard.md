...
Класс atioWizard реализует мастер для валидации данных временных рядов путём сравнения отношения наблюдений.


## Синтаксис


PP.initClass(PP.TS.Ui.RatioWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.RatioWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RatioWizard](dhtmlTS.chm::/Classes/TimeSeries/RatioWizard/Constructor_RatioWizard.htm)
		 Конструктор RatioWizard
		 создает экземпляр класса RatioWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/RatioWizard/RatioWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для валидации данных путём
		 сравнения отношения наблюдений.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getAttrCombo](dhtmlTS.chm::/Classes/TimeSeries/RatioWizard/RatioWizard.getAttrCombo.htm)
		 Метод getAttrCombo
		 возвращает раскрывающийся список сравниваемых рядов.


		 ![](../../../Sub_Image.gif)
		 [getTreeCombo](dhtmlTS.chm::/Classes/TimeSeries/RatioWizard/RatioWizard.getTreeCombo.htm)
		 Метод getTreeCombo
		 возвращает раскрывающийся список с измерениями выбранного ряда.


		 ![](../../../Sub_Image.gif)
		 [setAttributes](dhtmlTS.chm::/Classes/TimeSeries/RatioWizard/RatioWizard.setAttributes.htm)
		 Метод setAttributes
		 устанавливает список идентификаторов атрибутов рядов в мастере
		 для валидации данных путём сравнения отношения наблюдений.
