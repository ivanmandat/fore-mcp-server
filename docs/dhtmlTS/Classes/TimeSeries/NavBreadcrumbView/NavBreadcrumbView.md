...
Класс NavBreadcrumbView реализует представление компонента [NavBreadcrumb](../../../Components/TimeSeries/NavBreadcrumb/NavBreadcrumb.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.NavBreadcrumbView, PP.TS.Ui.[Master](dhtmlUi.chm::/Classes/Master/Master.htm), "NavBreadcrumbView");
