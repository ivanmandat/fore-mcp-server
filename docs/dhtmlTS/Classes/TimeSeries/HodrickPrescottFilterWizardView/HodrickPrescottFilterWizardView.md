...
Класс HodrickPrescottFilterWizardView реализует панель параметров фильтра Ходрика-Прескотта.


## Синтаксис


PP.initClass(PP.TS.Ui.HodrickPrescottFilterWizardView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "HodrickPrescottFilterWizardView");


## Комментарии


 Панель настройки параметров фильтра Ходрика-Прескотта имеет следующий вид:


![](HPFWV1.PNG)


Для отображения панели необходимо выбрать на вкладке ленты инструментов «Вычисления», нажать на кнопку «Сглаживание» и в раскрывающемся списке выбрать «Фильтра Ходрика-Прескотта», на вкладке панели свойств «Ряд» раскрыть панель «Параметры».
...
## Свойства
 ...
 ![](../../../Property_Image.gif)
 [CurrentState](HodrickPrescottFilterWizardView.CurrentState.htm)
