...
Класс RevisionComparisonWizard реализует мастер для валидации данных путём сравнения их версий в рабочей книге.


## Комментарии


Мастер для валидации данных путём сравнения их версий, размещённый в отдельном диалоге, по внешнему виду схож с компонентом [RevisionComparisonDialog](../../../Components/TimeSeries/RevisionComparisonDialog/RevisionComparisonDialog.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.RevisionComparisonWizard, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.RevisionComparisonWizard");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RevisionComparisonWizard](dhtmlTS.chm::/Classes/TimeSeries/RevisionComparisonWizard/Constructor_RevisionComparisonWizard.htm)
		 Конструктор RevisionComparisonWizard
		 создает экземпляр класса RevisionComparisonWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/RevisionComparisonWizard/RevisionComparisonWizard.CurrentState.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/RevisionComparisonWizard/RevisionComparisonWizard.RequestMetadata.htm)
