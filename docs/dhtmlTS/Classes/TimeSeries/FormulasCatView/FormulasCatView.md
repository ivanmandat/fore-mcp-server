...
Класс FormulasCatView реализует
 вкладку «Вычисления» ленты инструментов рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.FormulasCatView, PP.TS.Ui.[WbkCategoryView](../WbkCategoryView/WbkCategoryView.htm),
 "FormulasCatView");
...
Вкладка «Вычисления» ленты инструментов может иметь следующий вид:
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [FormulasCatView](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/Constructor_FormulasCatView.htm)
			 Конструктор FormulasCatView
			 создает экземпляр класса FormulasCatView.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [IsRExist](FormulasCatView.IsRExist.htm)
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getAggregationButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getAggregationButton.htm)
		 Метод getAggregationButton
		 возвращает кнопку «Агрегация».


		 ![](../../../Sub_Image.gif)
		 [getArithmeticButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getArithmeticButton.htm)
		 Метод getArithmeticButton
		 возвращает кнопку «Арифметика».


		 ![](../../../Sub_Image.gif)
		 [getCalculatorButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getCalculatorButton.htm)
		 Метод getCalculatorButton
		 возвращает кнопку «Калькулятор».


		 ![](../../../Sub_Image.gif)
		 [getConversionsButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getConversionsButton.htm)
		 Метод getConversionsButton
		 возвращает кнопку «Преобразования».


		 ![](../../../Sub_Image.gif)
		 [getFlatteningButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getFlatteningButton.htm)
		 Метод getFlatteningButton
		 возвращает кнопку «Сглаживание».


		 ![](../../../Sub_Image.gif)
		 [getPredictionButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getPredictionButton.htm)
		 Метод getPredictionButton
		 возвращает кнопку «Прогнозирование».


		 ![](../../../Sub_Image.gif)
		 [getRegressionButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getRegressionButton.htm)
		 Метод getRegressionButton
		 возвращает кнопку «Регрессия».


		 ![](../../../Sub_Image.gif)
		 [getUserFunctionsButton](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.getUserFunctionsButton.htm)
		 Метод getUserFunctionsButton
		 возвращает кнопку «Пользовательские функции».


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/FormulasCatView/FormulasCatView.refresh.htm)
