...
Класс **TsSpliceDateEditor**
 представляет [редактор
 даты](../../../Components/TimeSeries/TsSpliceDateEditor/TsSpliceDateEditor.htm) в [рабочей
...
PP.initClass(PP.Ui.TsSpliceDateEditor,  PP.Ui.DataEditor,
 "PP.Ui.TsSpliceDateEditor");
