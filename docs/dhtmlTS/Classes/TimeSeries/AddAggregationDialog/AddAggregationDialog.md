...
Класс AddAggregationDialog реализует
 [диалог
 добавления ряда, вычисленного методом агрегации](../../../Components/TimeSeries/AddAggregationDialog/AddAggregationDialog.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.AddAggregationDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "AddAggregationDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [AddAggregationDialog](dhtmlTS.chm::/Classes/TimeSeries/AddAggregationDialog/Constructor_AddAggregationDialog.htm)
		 Конструктор AddAggregationDialog
		 создает экземпляр компонента AddAggregationDialog.
