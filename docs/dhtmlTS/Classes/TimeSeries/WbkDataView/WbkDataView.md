...
Класс WbkDataView реализует представление [компонента для отображения данных рабочей книги](../../../Components/TimeSeries/WbkDataBox/WbkDataBox.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.WbkDataView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "WbkDataView");
