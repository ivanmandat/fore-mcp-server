...
Класс RollbackRevisionDlg реализует
 [диалог
 отката ревизии](../../../Components/TimeSeries/RollbackRevisionDlg/RollbackRevisionDlg.htm) в рабочей книге.


## Синтаксис


PP.initClass(PP.TS.Ui.RollbackRevisionDlg, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "RollbackRevisionDlg");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RollbackRevisionDlg](dhtmlTS.chm::/Classes/TimeSeries/RollbackRevisionDlg/Constructor_RollbackRevisionDlg.htm)
		 Конструктор RollbackRevisionDlg
		 создает экземпляр класса RollbackRevisionDlg.
...
## Свойства
		 ...
		 ![](../../../Sub_Image.gif)
		 [RubName](dhtmlTS.chm::/Classes/TimeSeries/RollbackRevisionDlg/RollbackRevisionDlg.RubName.htm)
		 Свойство RubName определяет
		 наименование каталога показателей.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getComment](dhtmlTS.chm::/Classes/TimeSeries/RollbackRevisionDlg/RollbackRevisionDlg.getComment.htm)
		 Метод getComment возвращает
		 комментарий в диалоге отката ревизии.
