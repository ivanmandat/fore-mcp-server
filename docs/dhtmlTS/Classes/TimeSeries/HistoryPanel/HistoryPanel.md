...
[SerieRevisionsPanel](../SerieRevisionsPanel/SerieRevisionsPanel.htm)
...
Класс HistoryPanel реализует
 панель истории изменений ряда.


## Синтаксис


PP.initClass(PP.TS.Ui.HistoryPanel, PP.TS.Ui.[SerieRevisionsPanel](../SerieRevisionsPanel/SerieRevisionsPanel.htm),
 "HistoryPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [HistoryPanel](dhtmlTS.chm::/Classes/TimeSeries/HistoryPanel/Constructor_HistoryPanel.htm)
		 Конструктор HistoryPanel
		 реализует панель истории изменений ряда.


## Свойства, унаследованные от класса [SerieRevisionsPanel](../SerieRevisionsPanel/SerieRevisionsPanel.htm)
...
## Методы, унаследованные от класса [SerieRevisionsPanel](../SerieRevisionsPanel/SerieRevisionsPanel.htm)
