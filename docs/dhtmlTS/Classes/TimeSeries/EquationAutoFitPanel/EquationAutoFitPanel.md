...
Класс EquationAutoFitPanel реализует панель автоподбора параметров экспоненциального сглаживания.


## Комментарии


Панель автоподбора параметров экспоненциального сглаживания имеет следующий вид:


![](EAFP.PNG)


Для отображения панели необходимо выбрать на вкладке ленты инструментов «Вычисления», нажать на кнопку «Прогнозирование» и в раскрывающемся списке выбрать «Экспоненциальное сглаживание», на вкладке панели свойств «Ряд» раскрыть панель «Автободбор параметров».


## Синтаксис


PP.initClass(PP.TS.Ui.EquationAutoFitPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "EquationAutoFitPanel");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [EquationAutoFitPanel](Constructor_EquationAutoFitPanel.htm)
 Конструктор EquationAutoFitPanel создает экземпляр EquationAutoFitPanel.
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [setSource](EquationAutoFitPanel.setSource.htm)
