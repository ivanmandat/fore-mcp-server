...
Класс ObserveAttributesPanel
 реализует панель атрибутов наблюдения на [панели
...
Панель «Атрибуты наблюдения», расположенная на панели свойств рабочей
 книги, может выглядеть следующим образом:


![](../WbkPropertyBarView/WbkPropertyBarView_getObserveAttributesPanel.png)


## Синтаксис


PP.initClass(PP.TS.Ui.ObserveAttributesPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "ObserveAttributesPanel");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ObserveAttributesPanel](dhtmlTS.chm::/Classes/TimeSeries/ObserveAttributesPanel/Constructor_ObserveAttributesPanel.htm)
		 Конструктор ObserveAttributesPanel
		 создает экземпляр класса ObserveAttributesPanel.
...
## Свойства
		 ...
		 ![](../../../Sub_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/ObserveAttributesPanel/ObserveAttributesPanel.Source.htm)
		 Свойство Source
		 устанавливает источник данных для панели атрибутов наблюдения
		 в рабочей книге.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [clearAttrs](dhtmlTS.chm::/Classes/TimeSeries/ObserveAttributesPanel/ObserveAttributesPanel.clearAttrs.htm)
		 Метод clearAttrs
		 удаляет все атрибуты наблюдения из соответствующей панели
		 в рабочей книге.
