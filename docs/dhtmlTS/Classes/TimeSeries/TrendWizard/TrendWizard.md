...
Класс TrendWizard реализует мастер для валидации данных путём сравнения трендов временных рядов.


## Синтаксис


PP.initClass(PP.TS.Ui.TrendWizardView,  [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.TS.Ui.TrendWizardView");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TrendWizard](dhtmlTS.chm::/Classes/TimeSeries/TrendWizard/Constructor_TrendWizard.htm)
		 Конструктор TrendWizard
		 создает экземпляр класса TrendWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/TrendWizard/TrendWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для валидации данных путём
		 сравнения трендов временных рядов.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setHierarchy](dhtmlTS.chm::/Classes/TimeSeries/TrendWizard/TrendWizard.setHierarchy.htm)
		 Метод setHierarchy
		 устанавливает иерархию репозитория в мастере для валидации данных
		 путём сравнения трендов временных рядов.
