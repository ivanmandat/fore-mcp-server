...
Класс NavBreadcrumb реализует
 компонент для отображения и управления атрибутами рабочей книги, основанный
 на компоненте PP.Ui.[Master](dhtmlUi.chm::/Classes/Master/Master.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.NavBreadcrumbView, PP.Ui.[Master](dhtmlUi.chm::/Classes/Master/Master.htm), "[NavBreadcrumbView](../NavBreadcrumbView/NavBreadcrumbView.htm)",
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [NavBreadcrumb](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumb/Constructor_NavBreadcrumb.htm)
		 Конструктор NavBreadcrumb
		 создает экземпляр класса NavBreadcrumb**.


## Свойства, унаследованные от класса [NavBreadcrumbView](../NavBreadcrumbView/NavBreadcrumbView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.Source.htm)
		 Свойство Source
		 реализует текущую иерархию.


## Методы, унаследованные от класса [NavBreadcrumbView](../NavBreadcrumbView/NavBreadcrumbView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.refreshAll.htm)
		 Метод refreshAll
		 обновляет весь компонент в соответствии с
		 метаданными.


		 ![](../../../Sub_Image.gif)
		 [refreshSelections](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.refreshSelections.htm)
		 Метод refreshSelections
		 обновляет выделение в деревьях измерений всех атрибутов.


		 ![](../../../Sub_Image.gif)
		 [updateItemContent](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.updateItemContent.htm)
		 Метод updateItemContent
		 обновляет надпись на элементе навигационной
		 цепочки (в зависимости от отметки в измерении атрибута).


## События, унаследованные от класса  [NavBreadcrumbView](../NavBreadcrumbView/NavBreadcrumbView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [AltHierarchyChanged](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.AltHierarchyChanged.htm)
		 Событие AltHierarchyChanged
		 наступает после изменения альтернативной иерархии
		 измерения на сервере.


		 ![](../../../Event_Image.gif)
		 [AttributeFilterChanged](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.AttributeFilterChanged.htm)
		 Событие AttributeFilterChanged
		 наступает после вкл/откл фильтра в аттрибуте.


		 ![](../../../Event_Image.gif)
		 [AttributeSortChanged](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.AttributeSortChanged.htm)
		 Событие AttributeSortChanged
		 наступает после изменения сортировки в дереве
		 измерения.


		 ![](../../../Event_Image.gif)
		 [DimSelectionChanged](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.DimSelectionChanged.htm)
		 Событие DimSelectionChanged
		 наступает после изменения отметки измерения
		 на сервере.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении свойств экземпляра класса [NavBreadcrumbView](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.htm).


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.RequestMetadata.htm)
		 Событие RequestMetadata
		 наступает после запроса метаданных.


		 ![](../../../Event_Image.gif)
		 [RequestSelectedItemsChanged](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.RequestSelectedItemsChanged.htm)
		 Событие RequestSelectedItemsChanged
		 наступает после перемещения аттрибутов в навигационной
		 цепочке.


		 ![](../../../Event_Image.gif)
		 [TreeNameAttrChanged](dhtmlTS.chm::/Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.TreeNameAttrChanged.htm)
		 Событие TreeNameAttrChanged
		 наступает после изменения атрибута наименования
		 уровней.
