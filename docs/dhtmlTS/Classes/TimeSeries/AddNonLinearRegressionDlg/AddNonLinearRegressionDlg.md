...
Класс AddNonLinearRegressionDlg реализует диалог добавления нелинейной регрессии.


## Синтаксис


PP.initClass(PP.TS.Ui.AddNonLinearRegressionDlg, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "AddNonLinearRegressionDlg");


## Комментарии


Диалог добавления нелинейной регрессии имеет следующий вид:
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [AddNonLinearRegressionDlg](Constructor_AddNonLinearRegressionDlg.htm)
 Конструктор AddNonLinearRegressionDlg создает экземпляр класса AddNonLinearRegressionDlg.
...
## Свойства
 ...
 ![](../../../Property_Image.gif)
 [Series](AddNonLinearRegressionDlg.Series.htm)
 Свойство Series устанавливает ряды на которых вычисляется регрессия.
