...
Класс HistoryWindow реализует
 [окно
 с историей изменений](../../../Components/TimeSeries/HistoryWindow/HistoryWindow.htm) для выделенного ряда.


## Синтаксис


PP.initClass(PP.TS.Ui.HistoryWindow, PP.Ui.[Window](dhtmlUi.chm::/Classes/Window/Window.htm),
 "HistoryWindow");
