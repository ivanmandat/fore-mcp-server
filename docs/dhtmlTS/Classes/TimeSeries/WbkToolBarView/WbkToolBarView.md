...
Класс WbkToolBarView реализует компонент для отображения панели инструментов управления видимостью представлений рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.WbkToolBarView, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm), "WbkToolBarView");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [WbkToolBarView](dhtmlTS.chm::/Classes/TimeSeries/WbkToolBarView/Constructor_WbkToolBarView.htm)

		 Конструктор WbkToolBarView
		 создает экземпляр класса WbkToolBarView.
