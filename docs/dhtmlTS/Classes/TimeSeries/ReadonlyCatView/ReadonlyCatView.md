...
Класс ReadonlyCatView реализует
 вкладку [ленты
 инструментов](../../../Components/TimeSeries/WbkRibbon/WbkRibbon.htm) «Главная» в режиме просмотра.


## Комментарии


Вкладка «Главная» в режиме просмотра имеет следующий вид:


![](ReadonlyCatView_Ex.png)


Вкладку можно получить при помощи метода [getReadonlyCategory](../WbkRibbonView/WbkRibbonView.getReadonlyCategory.htm),
 если отчет открыт в режиме просмотра.


## Синтаксис


PP.initClass(PP.TS.Ui.ReadonlyCatView, PP.TS.Ui.[WbkCategoryView](../WbkCategoryView/WbkCategoryView.htm),
 "ReadonlyCatView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getDiscussButton](ReadonlyCatView.getDiscussButton.htm)
		 Метод getDiscussButton
		 возвращает кнопку «Обсудить в SharePoint».


		 ![](../../../Sub_Image.gif)
		 [getExportButton](ReadonlyCatView.getExportButton.htm)
		 Метод getExportButton
		 возвращает кнопку «Экспорт».


		 ![](../../../Sub_Image.gif)
		 [getSharePointButton](ReadonlyCatView.getSharePointButton.htm)
		 Метод getSharePointButton
		 возвращает кнопку «Поделиться».


		 ![](../../../Sub_Image.gif)
		 [refresh](ReadonlyCatView.refresh.htm)
