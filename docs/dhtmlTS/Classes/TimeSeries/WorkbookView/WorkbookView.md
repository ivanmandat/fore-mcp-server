...
Класс WorkbookView реализует представление рабочей книги.


## Синтаксис


PP.initClass(PP.TS.Ui.WorkbookView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "WorkbookView", PP.TS.Ui.IWorkbookView);
