...
Класс EquationProcessPanel реализует панель «Обработка пропусков».


## Комментарии


Навигационная панель «Обработка пропусков» имеет следующий вид:


![](EquationProcessPanel.png)


Для отображения панели необходимо в таблице выделить вычисляемый ряд, на вкладке панели свойств «Ряд» раскрыть панель «Обработка пропусков».


## Синтаксис


PP.initClass(PP.TS.Ui.EquationProcessPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "EquationProcessPanel");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [EquationProcessPanel](Constructor_EquationProcessPanel.htm)
 Конструктор EquationProcessPanel создает экземпляр класса EquationProcessPanel.
...
## События
 ...
 ![](../../../Event_Image.gif)
 [NeedFillSpecifiedVector](EquationProcessPanel.NeedFillSpecifiedVector.htm)
 Событие NeedFillSpecifiedVector наступает при запросе загрузки данных из раскрывающегося списка на панели «Обработка пропусков».
