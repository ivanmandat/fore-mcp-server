...
Класс RevisionComparisonDialog реализует [диалог правила валидации данных путём сравнения их версий](../../../Components/TimeSeries/RevisionComparisonDialog/RevisionComparisonDialog.htm) в [рабочей книге](../Workbook/Workbook.htm).


## Синтаксис


PP.initClass(PP.TS.Ui.RevisionComparisonDialog,  [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "PP.TS.Ui.RevisionComparisonDialog");
