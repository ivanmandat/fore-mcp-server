...
Класс EquationPeriodPanel реализует панель «Периоды расчета».


## Комментарии


Панель «Периоды расчета» имеет следующий вид:


![](EPP2.PNG)


Для отображения панели необходимо на вкладке панели свойств «Ряд» раскрыть панель «Периоды расчета». Панель доступна, только если в таблице выделен вычисляемый ряд.


## Синтаксис


PP.initClass(PP.TS.Ui.EquationPeriodPanel, PP.Ui.[MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm), "EquationPeriodPanel");
...
## Методы
 ...
 ![](../../../Sub_Image.gif)
 [getCurrentState](EquationPeriodPanel.getCurrentState.htm)
 Метод getCurrentState возвращает объект текущего состояния компонента панели «Периоды расчета».


 ![](../../../Sub_Image.gif)
 [setSource](EquationPeriodPanel.setSource.htm)
