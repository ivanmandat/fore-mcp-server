...
Компонент ValidationGroupSettingsDialog
 представляет собой диалог для редактирования группы правил валидации в
 [рабочей книге](../../../Classes/TimeSeries/Workbook/Workbook.htm).


## Комментарии


Компонент ValidationGroupSettingsDialog реализован
 с помощью класса [ValidationGroupSettingsDialog](../../../Classes/TimeSeries/ValidationGroupSettingsDialog/ValidationGroupSettingsDialog.htm).


Он предназначен для создания и редактирования
 группы правил валидации в рабочей книге.
...
[Пример создания
 компонента ValidationGroupSettingsDialog](ValidationGroupSettingsDialog_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ValidationGroupSettingsDialog](dhtmlTS.chm::/Classes/TimeSeries/ValidationGroupSettingsDialog/Constructor_ValidationGroupSettingsDialog.htm)
		 Конструктор ValidationGroupSettingsDialog
		 создает экземпляр класса ValidationGroupSettingsDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setCurrentState](dhtmlTS.chm::/Classes/TimeSeries/ValidationGroupSettingsDialog/ValidationGroupSettingsDialog.setCurrentState.htm)
		 Метод setCurrentState
		 устанавливает настройки для диалога редактирования группы правил
		 валидации в [рабочей
		 книге](dhtmlTS.chm::/Classes/TimeSeries/Workbook/Workbook.htm).
