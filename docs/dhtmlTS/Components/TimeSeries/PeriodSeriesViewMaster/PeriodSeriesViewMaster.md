...
Компонент PeriodSeriesViewMaster
 представляет собой мастер для отображения и управления атрибутами рабочей
 книги на [панели свойств](../WbkPropertyBar/WbkPropertyBar.htm).


## Комментарии


Компонент PeriodSeriesViewMaster реализован
 с помощью класса [PeriodSeriesViewMaster](../../../Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.htm).
...
[Пример
 создания компонента PeriodSeriesViewMaster](PeriodSeriesViewMaster_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [PeriodSeriesViewMaster](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/Constructor_PeriodSeriesViewMaster.htm)
		 Конструктор PeriodSeriesViewMaster
		 создает экземпляр класса PeriodSeriesViewMaster.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.Source.htm)
		 Свойство Source
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.refreshAll.htm)
		 Метод refreshAll
		 обновляет всё содержимое компонента PeriodSeriesViewMaster.


		 ![](../../../Sub_Image.gif)
		 [refreshSelections](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.refreshSelections.htm)
		 Метод refreshSelections
		 обновляет выделения элементов в деревьях измерений всех атрибутов
		 мастера PeriodSeriesViewMaster.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [AttributeFilterChanged](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.AttributeFilterChanged.htm)
		 Событие AttributeFilterChanged
		 наступает при изменении фильтра измерений атрибутов мастера PeriodSeriesViewMaster.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.PropertyChanged.htm)
		 Событие PropertyChanged
		 генерируется при изменении свойства компонента PeriodSeriesViewMaster.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике компонента
		 PeriodSeriesViewMaster.


		 ![](../../../Event_Image.gif)
		 [RequestSelectedItemsChanged](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.RequestSelectedItemsChanged.htm)
		 Событие RequestSelectedItemsChanged
		 генерируется при изменении выделения индикаторов в дереве атрибутов
		 компонента [PeriodSeriesViewMaster](dhtmlTS.chm::/Components/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.htm).


		 ![](../../../Event_Image.gif)
		 [RootLoaded](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.RootLoaded.htm)
		 Событие RootLoaded
		 генерируется при изменении выделения индикаторов в дереве атрибутов
		 компонента PeriodSeriesViewMaster.


		 ![](../../../Event_Image.gif)
		 [SelectionChanged](dhtmlTS.chm::/Classes/TimeSeries/PeriodSeriesViewMaster/PeriodSeriesViewMaster.SelectionChanged.htm)
		 Событие SelectionChanged
		 наступает при изменении выделения элемента в деревьях измерений
		 всех атрибутов мастера PeriodSeriesViewMaster.
