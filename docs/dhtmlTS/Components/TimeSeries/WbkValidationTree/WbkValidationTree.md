...
Компонент WbkValidationTree
 представляет собой дерево валидации данных в [рабочей
 книге](../WorkbookBox/WorkbookBox.htm).


## Комментарии


Компонент WbkValidationTree реализован
 с помощью класса [WbkValidationTree](../../../Classes/TimeSeries/WbkValidationTree/WbkValidationTree.htm)
 и располагается на вкладке «Правила
 валидации» панели свойств рабочей книги.
...
[Пример создания компонента WbkValidationTree](WbkValidationTree_Example.htm)
