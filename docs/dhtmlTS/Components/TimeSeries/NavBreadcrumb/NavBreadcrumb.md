...
Компонент NavBreadcrumb
 - визуальный компонент, который реализует мастер управления атрибутами
 рабочей книги.
...
Пример создания компонента NavBreadcrumb
 показан на странице «[Пример создания
 компонента NavBreadcrumb](NavBreadcrumb_Example.htm)».
...
## Свойства, унаследованные от класса [NavBreadcrumbView](../../../Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.htm)
...
## Методы, унаследованные от класса [NavBreadcrumbView](../../../Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.htm)
...
## События, унаследованные от класса [NavBreadcrumbView](../../../Classes/TimeSeries/NavBreadcrumbView/NavBreadcrumbView.htm)
