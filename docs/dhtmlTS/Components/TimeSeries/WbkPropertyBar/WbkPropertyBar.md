...
Компонент WbkPropertyBar
 служит для представления и управления свойствами рабочей книги через навигационную
 панель.
...
Компонент реализован классом [WbkPropertyBar](../../../Classes/TimeSeries/WbkPropertyBar/WbkPropertyBar.htm).
...
![](../../../Classes/TimeSeries/WbkPropertyBar/WbkPropertyBar.png)


Пример создания компонента показан на странице «[Конструктор
 WbkPropertyBar](../../../Classes/TimeSeries/WbkPropertyBar/Constructor_WbkPropertyBar.htm)».
...
## Конструктор
		 ...
		 Конструктор WbkPropertyBarсоздает экземпляр класса WbkPropertyBar.


## Свойства, унаследованные от класса [WbkPropertyBarView](../../../Classes/TimeSeries/WbkPropertyBarView/WbkPropertyBarView.htm)
...
## Методы, унаследованные от класса [WbkPropertyBarView](../../../Classes/TimeSeries/WbkPropertyBarView/WbkPropertyBarView.htm)
...
## События, унаследованные от класса [WbkPropertyBarView](../../../Classes/TimeSeries/WbkPropertyBarView/WbkPropertyBarView.htm)
