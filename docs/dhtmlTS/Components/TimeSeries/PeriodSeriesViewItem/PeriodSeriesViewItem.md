...
Компонент PeriodSeriesViewItem
 представляет собой панель «Ряды» на [панели
 свойств рабочей книги](../WbkPropertyBar/WbkPropertyBar.htm).


## Комментарии


Компонент PeriodSeriesViewItem реализован
 с помощью класса [PeriodSeriesViewItem](../../../Classes/TimeSeries/PeriodSeriesViewItem/PeriodSeriesViewItem.htm).


Он соответствует атрибуту «Ряды» и предназначен для управления отображением
 временных рядов в рабочей книге.


## Пример


Компонент может иметь следующий вид:
...
[Пример создания компонента
 PeriodSeriesViewItem](PeriodSeriesViewItem_Example.htm)
