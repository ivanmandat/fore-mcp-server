...
Компонент MetaAttributeBreadCrumb
 отображает и управляет атрибутами рабочей книги.


## Комментарии


Компонент реализован классом [MetaAttributeBreadCrumb](../../../Classes/TimeSeries/MetaAttributeBreadCrumb/MetaAttributeBreadCrumb.htm).


Вся работа с временными рядами выполняется в рабочей книге. Рабочая
 книга может содержать один или несколько листов с представлениями данных.
 Каждый лист имеет свою вкладку, на которой отображено наименование листа.


Для базы данных временных рядов предусмотрены две группы системных атрибутов,
 расположенных на отдельных вкладках:


	- Атрибуты показателей. Набор характеристик, совокупность значений
	 которых однозначно идентифицирует показатель;


	- Атрибуты наблюдений. Набор характеристик, который будет иметь
	 каждое наблюдение показателя.
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [MetaAttributeBreadCrumb](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumb/Constructor_MetaAttributeBreadCrumb.htm)
		 Конструктор MetaAttributeBreadCrumb
		 создает экземпляр класса MetaAttributeBreadCrumb.


## Свойства, унаследованные от класса [MetaAttributeBreadCrumbView](../../../Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Hierarchy](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.Hierarchy.htm)
		 Свойство Hierarchy
		 устанавливает текущую иерархию.


		 ![](../../../Property_Image.gif)
		 [ItemsCaptionType](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.ItemsCaptionType.htm)
		 Свойство ItemsCaptionType
		 определяет тип надписи у элемента цепочки навигации в компоненте
		 [MetaAttributeBreadCrumb](dhtmlTS.chm::/Components/TimeSeries/MetaAttributeBreadCrumb/MetaAttributeBreadCrumb.htm).


		 ![](../../../Property_Image.gif)
		 [LocalStorageKey](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.LocalStorageKey.htm)
		 Свойство LocalStorageKey
		 устанавливает ключ, под которым в локальном
		 хранилище будут храниться настройки первоначального отображения.


		 ![](../../../Property_Image.gif)
		 [Options](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.Options.htm)
		 Свойство Options
		 устанавливает настройки первоначального отображения.


## Методы, унаследованные от класса [MetaAttributeBreadCrumbView](../../../Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getMetaAttributes](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.getMetaAttributes.htm)
		 Метод getMetaAttributes
		 возвращает список метаатрибутов.


		 ![](../../../Sub_Image.gif)
		 [getMetaAttributeByld](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.getMetaAttributeById.htm)
		 Метод getMetaAttributeByld
		 возвращает объект PP.TS.Ui.[MetaAttribute](dhtmlTS.chm::/Classes/TimeSeries/MetaAttribute/MetaAttribute.htm)
		 по идентификатору атрибута.


		 ![](../../../Sub_Image.gif)
		 [getSource](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.getSource.htm)
		 Метод getSource возвращает
		 источник данных компонента [MetaAttributeBreadCrumb](dhtmlTS.chm::/Components/TimeSeries/MetaAttributeBreadCrumb/MetaAttributeBreadCrumb.htm).


		 ![](../../../Sub_Image.gif)
		 [onBreadcrumbSelectedltemsChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.onBreadcrumbSelecteditemsChanged.htm)
		 Метод onBreadcrumbSelectedltemsChanged
		 создает обработчик события изменения выделенных элементов в навигационной
		 цепочке.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.refresh.htm)
		 Метод refresh вычисляет
		 пункты навигационной цепочки в соответствии с моделью или сохраненным
		 состоянием [Options](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.Options.htm),
		 если оно есть.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.refreshAll.htm)
		 Метод refreshAll является
		 аналогом метода [refresh](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.refresh.htm).


		 ![](../../../Sub_Image.gif)
		 [refreshSelections](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.refreshSelections.htm)
		 Метод refreshSelections
		 обновляет выделение в деревьях измерений всех атрибутов.


## События, унаследованные от класса [MetaAttributeBreadCrumbView](../../../Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [AltHierarchyChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.AlthierarchyChanged.htm)
		 Событие AltHierarchyChanged
		 наступает после изменения альтернативной иерархии измерения на
		 сервере.


		 ![](../../../Event_Image.gif)
		 [AttributeFilterChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.AttributeFilterChanged.htm)
		  Событие AttributeFilterChanged
		 наступает после включения/отключения фильтра в атрибуте.


		 ![](../../../Event_Image.gif)
		 [AttributeSortChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.AttributeSortChanged.htm)
		 Событие AttributeSortChanged
		 наступает после изменения сортировки в атрибуте.


		 ![](../../../Event_Image.gif)
		 [DimSelectionChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.DimSelectionChanged.htm)
		 Событие DimSelectionChanged
		 наступает после изменения отметки на сервере.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении свойств экземпляра класса MetaAttributeBreadCrumbView.


		 ![](../../../Event_Image.gif)
		 [RequestSelectedltemsChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.RequestSelectedItemsChanged.htm)
		 Событие RequestSelectedltemsChanged
		 наступает после перемещения атрибутов в цепочке навигации.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.RequestMetadata.htm)
		 Событие RequestMetadata
		 наступает после запроса метаданных.


		 ![](../../../Event_Image.gif)
		 [TreeNameAttrChanged](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.TreeNameAttrChanged.htm)
		 Событие TreeNameAttrChanged
		 наступает после изменения типа наименования уровней элементов
		 измерения.
