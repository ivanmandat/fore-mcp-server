...
Компонент LanerBox - это визуальный
 компонент, который отображает таблицу рабочей книги.


## Комментарии


Компонент LanerBox реализован
 с помощью класса [LanerBox](../../../Classes/TimeSeries/LanerBox/LanerBox.htm).


Рабочая книга является основной функциональной
 областью БД и предназначена для работы с временными рядами. Для рабочей
 книги используется таблица, которая позволяет проводить различные операции
 с временными рядами, например:


	- редактировать, добавлять или удалять
	 данные;
	...
	- добавлять в рабочую книгу новые
	 столбцы, ряды.
...
Таблица данных содержит открытые ряды данных. Заголовок ряда содержит
 значения его атрибутов, разделенные знаком «|». В следующей колонке отображается
 цветовое обозначение ряда данных на диаграмме.


Пример создания компонента LanerBox
 показан на странице [Конструктор
 LanerBox](../../../Classes/TimeSeries/LanerBox/Constructor_LanerBox.htm).
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [LanerBox](dhtmlTS.chm::/Classes/TimeSeries/LanerBox/Constructor_LanerBox.htm)
			 Конструктор LanerBox создает экземпляр класса LanerBox.


## Свойства, унаследованные от класса [LanerBoxView](../../../Classes/TimeSeries/LanerBoxView/LanerBoxView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [EnableTabSheetActions](../../../Classes/TimeSeries/LanerBoxView/LanerBoxView.EnableTabSheetActions.htm)
		 Свойство EnableTabSheetActions
		 определяет возможность выделения элементов таблицы.


## Методы, унаследованные от класса [LanerBoxView](../../../Classes/TimeSeries/LanerBoxView/LanerBoxView.htm)
...
## События, унаследованные от класса [LanerBoxView](../../../Classes/TimeSeries/LanerBoxView/LanerBoxView.htm)
