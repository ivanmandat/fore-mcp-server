...
Компонент NewRevisionDlg представляет собой стандартный диалог для добавления метки к ревизии.


## Комментарии


Компонент NewRevisionDlg реализован классом [NewRevisionDlg](../../../Classes/TimeSeries/NewRevisionDlg/NewRevisionDlg.htm).


## Пример


Компонент NewRevisionDlg может иметь следующий вид:


![](NewRevisionDlg1.PNG)


[Пример создания компонента NewRevisionDlg](../../../Classes/TimeSeries/NewRevisionDlg/Constructor_NewRevisionDlg.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [NewRevisionDlg](dhtmlTS.chm::/Classes/TimeSeries/NewRevisionDlg/Constructor_NewRevisionDlg.htm)
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getDescription](dhtmlTS.chm::/Classes/TimeSeries/NewRevisionDlg/NewRevisionDlg.getDescription.htm)
		 Метод getDescription
		 .


		 ![](../../../Sub_Image.gif)
		 [getName](dhtmlTS.chm::/Classes/TimeSeries/NewRevisionDlg/NewRevisionDlg.getName.htm)
		 Метод getName
		 .
