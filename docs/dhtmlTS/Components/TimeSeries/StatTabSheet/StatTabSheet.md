...
StatTabSheet - визуальный компонент, который отображает электронную таблицу [рабочей книги](../WorkbookBox/WorkbookBox.htm).


## Комментарии


Компонент реализован с помощью класса [StatTabSheet](../../../Classes/TimeSeries/StatTabSheet/StatTabSheet.htm).


## Пример


Электронная таблица рабочей книги имеет следующий вид:


![](StatTabSheet.png)


Пример создания компонента показан на странице «[Конструктор StatTabSheet](../../../Classes/TimeSeries/StatTabSheet/Constructor_StatTabSheet.htm)».
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [StatTabSheet](dhtmlTS.chm::/Classes/TimeSeries/StatTabSheet/Constructor_StatTabSheet.htm)
		 Конструктор StatTabSheet
		 создает экземпляр класса StatTabSheet.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/StatTabSheet/StatTabSheet.refresh.htm)
		 Метод refresh обновляет
		 электронную таблицу.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/StatTabSheet/StatTabSheet.refreshAll.htm)
		 Метод refreshAll является
		 аналогом метода [StatTabSheet.refresh](dhtmlTS.chm::/Classes/TimeSeries/StatTabSheet/StatTabSheet.refresh.htm).


		 ![](../../../Sub_Image.gif)
		 [setSource](dhtmlTS.chm::/Classes/TimeSeries/StatTabSheet/StatTabSheet.setSource.htm)
