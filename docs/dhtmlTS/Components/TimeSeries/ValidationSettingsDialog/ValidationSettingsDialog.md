...
Компонент ValidationSettingsDialog представляет собой диалог для редактирования правила валидации данных в [рабочей книге](../../../Classes/TimeSeries/Workbook/Workbook.htm).


## Комментарии


Компонент ValidationSettingsDialog реализован с помощью класса [ValidationSettingsDialog](../../../Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.htm).
...
[Пример создания компонента ValidationSettingsDialog](ValidationSettingsDialog_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ValidationSettingsDialog](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.htm)
		 Конструктор ValidationSettingsDialog
		 создает экземпляр класса ValidationSettingsDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getComponentMismatchWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getComponentMismatchWizard.htm)
		 Метод getComponentMismatchWizard
		 возвращает [мастер
		 для выделения изменённых значений данных временных рядов](dhtmlTS.chm::/Components/TimeSeries/ComponentMismatchWizard/ComponentMismatchWizard.htm).


		 ![](../../../Sub_Image.gif)
		 [getCorrelationWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getCorrelationWizard.htm)
		 Метод getCorrelationWizard
		 возвращает мастер для валидации данных путём анализа их корреляционной
		 зависимости.


		 ![](../../../Sub_Image.gif)
		 [getCrossDatabaseWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getCrossDatabaseWizard.htm)
		 Метод getCrossDatabaseWizard
		 возвращает мастер для валидации данных путём сравнения с базой
		 данных временных рядов.


		 ![](../../../Sub_Image.gif)
		 [getCrossFrequencyWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getCrossFrequencyWizard.htm)
		 Метод getCrossFrequencyWizard
		 возвращает мастер для валидации данных путём сравнения уровней
		 динамики временных рядов.


		 ![](../../../Sub_Image.gif)
		 [getCustomAnalysisWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getCustomAnalysisWizard.htm)
		 Метод getCustomAnalysisWizard
		 возвращает мастер для валидации данных путём пользовательского
		 анализа временных рядов.


		 ![](../../../Sub_Image.gif)
		 [getGrowthRateWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getGrowthRateWizard.htm)
		 Метод getGrowthRateWizard
		 возвращает мастер для валидации данных путём анализа темпа роста
		 временных рядов.


		 ![](../../../Sub_Image.gif)
		 [getLevelWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getLevelWizard.htm)
		 Метод getLevelWizard
		 возвращает мастер для валидации данных путём их сравнения с числом.


		 ![](../../../Sub_Image.gif)
		 [getMissingDataWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getMissingDataWizard.htm)
		 Метод getMissingDataWizard
		 возвращает мастер для валидации типа «Пропуски в данных».


		 ![](../../../Sub_Image.gif)
		 [getMissingMetadataWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getMissingMetadataWizard.htm)
		 Метод getMissingMetadataWizard
		 возвращает мастер для валидации типа «Пропуски в метаданных».


		 ![](../../../Sub_Image.gif)
		 [getOkButtonClicked](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getOkButtonClicked.htm)
		 Метод getOkButtonClicked
		 определяет, была ли нажата кнопка «OK» в диалоге для редактирования
		 правила валидации данных в рабочей книге.


		 ![](../../../Sub_Image.gif)
		 [getRatioWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getRatioWizard.htm)
		 Метод getRatioWizard
		 возвращает мастер для валидации данных временных рядов путём сравнения
		 отношения наблюдений.


		 ![](../../../Sub_Image.gif)
		 [getRevisionComparisonWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getRevisionComparisonWizard.htm)
		 Метод getRevisionComparisonWizard
		 возвращает мастер для валидации путём сравнения версий данных
		 временных рядов.


		 ![](../../../Sub_Image.gif)
		 [getRevisionMetadataComparisonWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getRevisionMetadataComparisonWizard.htm)
		 Метод getRevisionMetadataComparisonWizard
		 возвращает мастер для валидации путём сравнения версий метаданных
		 временных рядов.


		 ![](../../../Sub_Image.gif)
		 [getStatisticalOutliersWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getStatisticalOutliersWizard.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getTrendWizard](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.getTrendWizard.htm)
		 Метод getTrendWizard
		 возвращает мастер для валидации данных путём сравнения трендов
		 временных рядов.


		 ![](../../../Sub_Image.gif)
		 [setCurrentState](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.setCurrentState.htm)
		 Метод setCurrentState
		 определяет настройки диалога для редактирования правила валидации
		 данных в рабочей книге.


		 ![](../../../Sub_Image.gif)
		 [setMode](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.setMode.htm)
		 Метод setMode
		 устанавливает режим отображения диалога для редактирования правила
		 валидации данных в рабочей книге.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/ValidationSettingsDialog/ValidationSettingsDialog.RequestMetadata.htm)
