...
Компонент TsSpliceDateEditor представляет редактор даты в [рабочей книге](../WorkbookBox/WorkbookBox.htm).


## Комментарии


Компонент TsSpliceDateEditor реализован с помощью класса [TsSpliceDateEditor](../../../Classes/TimeSeries/TsSpliceDateEditor/TsSpliceDateEditor.htm).


## Пример


Компонент в раскрытом виде может выглядеть следующим образом:


![](TsSpliceDateEditor2.png)


[Пример создания компонента TsSpliceDateEditor](TsSpliceDateEditor_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [TsSpliceDateEditor](dhtmlTS.chm::/Classes/TimeSeries/TsSpliceDateEditor/Constructor_TsSpliceDateEditor.htm)
		 Конструктор TsSpliceDateEditor
		 создает экземпляр класса TsSpliceDateEditor.
