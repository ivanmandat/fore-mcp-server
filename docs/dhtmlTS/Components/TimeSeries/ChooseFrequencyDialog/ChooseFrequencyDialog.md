...
Класс ChooseFrequencyDialog
 реализует диалог «Добавить ряд».


## Комментарии


Диалог «Добавить ряд» имеет следующий вид:


![](CFDgSK.PNG)


Для отображения диалога нажмите на кнопку «Добавить ряд» на вкладке
 ленты «Главная».
...
PP.initClass(PP.TS.Ui.ChooseFrequencyDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm), "ChooseFrequencyDialog");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ChooseFrequencyDialog](dhtmlTS.chm::/Classes/TimeSeries/ChooseFrequencyDialog/Constructor_ChooseFrequencyDialog.htm)
		 Конструктор ChooseFrequencyDialog создает
		 экземпляр класса ChooseFrequencyDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getSelectedKey](dhtmlTS.chm::/Classes/TimeSeries/ChooseFrequencyDialog/ChooseFrequencyDialog.getSelectedKey.htm)
