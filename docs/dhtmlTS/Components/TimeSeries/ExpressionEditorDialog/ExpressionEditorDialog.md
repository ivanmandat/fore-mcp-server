...
Компонент ExpressionEditorDialog
 представляет собой редактор выражения в [рабочей
...
Компонент ExpressionEditorDialog реализован
 с помощью класса [ExpressionEditorDialog](../../../Classes/TimeSeries/ExpressionEditorDialog/ExpressionEditorDialog.htm).


Он предназначен для составления выражения
 в рабочей книге.
...
[Пример создания компонента
 ExpressionEditorDialog](ExpressionEditorDialog_Example.htm)
