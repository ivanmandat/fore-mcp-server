...
Компонент SpliceMethodWizard представляет собой мастер настройки сращивания временных рядов.


## Комментарии


Компонент SpliceMethodWizard реализован классом [SpliceMethodWizard](../../../Classes/TimeSeries/SpliceMethodWizard/SpliceMethodWizard.htm). Он располагается на [вкладке «Параметры»](../../../Classes/TimeSeries/ParametersPanel/ParametersPanel.htm) [боковой панели](../WbkPropertyBar/WbkPropertyBar.htm) рабочей книги.


## Пример


Компонент SpliceMethodWizard может иметь следующий вид:


![](SpliceMethodWizard.png)


[Пример создания компонента SpliceMethodWizard](Constructor_SpliceMethodWizard.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [SpliceMethodWizard](dhtmlTS.chm::/classes/TimeSeries/SpliceMethodWizard/constructor_SpliceMethodWizard.htm)
		 Конструктор SpliceMethodWizard
		 создает экземпляр компонента SpliceMethodWizard.
...
## Свойства
		 ...
		 ![](../../../Sub_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/SpliceMethodWizard/SpliceMethodWizard.CurrentState.htm)
