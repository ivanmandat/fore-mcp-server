...
Компонент AddSLS2Dialog реализует диалог добавления линейной регрессии (оценка методом инструментальных переменных).


## Комментарии


Компонент реализован классом [AddSLS2Dialog](../../../Classes/TimeSeries/AddSLS2Dialog/AddSLS2Dialog.htm).
...
![](../../../Classes/TimeSeries/AddSLS2Dialog/AddSLSDialog_ex.png)


Пример создания диалога приведен в описании конструктора [AddSLS2Dialog](../../../Classes/TimeSeries/AddSLS2Dialog/Constructor_AddSLS2Dialog.htm).
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [AddSLS2Dialog](../../../Classes/TimeSeries/AddSLS2Dialog/Constructor_AddSLS2Dialog.htm)
 Конструктор AddSLS2Dialog создает экземпляр класса AddSLS2Dialog.
