...
Компонент WorkbookBox отображает
 рабочую книгу.
...
Компонент реализован классом [WorkbookBox](../../../Classes/TimeSeries/WorkbookBox/WorkbookBox.htm).


Представлен в виде основного окна приложения, содержащего следующие
 элементы:


	- Главное меню. Содержит
	 основные команды для работы с базой данных временных рядов;


	- Лента инструментов.
	 Содержит кнопки для работы с областью представления;


	- Боковая панель. Панель
	 предназначена для работы с данными БД временных рядов;


	- Рабочая книга. Основная
	 функциональная область БД временных рядов, предназначенная для работы
	 с временными рядами данных.
...
Пример создания компонента WorkbookBox
 ...
 компонента WorkbookBox](Component_WorkbookBox.htm)».
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [WorkbookBox](dhtmlTS.chm::/Classes/TimeSeries/WorkbookBox/Constructor_WorkbookBox.htm)
			 Конструктор WorkbookBox создает экземпляр класса WorkbookBox.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [Saved](dhtmlTS.chm::/Classes/TimeSeries/WorkbookBox/WorkbookBox.Saved.htm)
		 Событие Saved
		 наступает после сохранения отчёта на сервере
		 .


## Свойства, унаследованные от класса [WorkbookView](../../../Classes/TimeSeries/WorkbookView/WorkbookView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [PropertyBarVisible](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.PropertyBarVisible.htm)
		 Свойство PropertyBarVisible
		 определяет видимость боковой панели.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.Source.htm)
		 Свойство Source
		 определяет рабочую книгу, данные которой отображаются в
		 компоненте.


		 ![](../../../Property_Image.gif)
		 [ViewMode](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.ViewMode.htm)
		 Свойство ViewMode
		 определяет значение флага в режиме просмотра.


## Методы, унаследованные от класса [WorkbookView](../../../Classes/TimeSeries/WorkbookView/WorkbookView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [cultureChanged](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.cultureChanged.htm)
		 Метод cultureChanged
		 обрабатывает события смены культуры.


		 ![](../../../Sub_Image.gif)
		 [getDataView](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.getDataView.htm)
		 Метод getDataView
		 возвращает компонент для отображения данных рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getPropertyBarView](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.getPropertyBarView.htm)
		 Метод getPropertyBarView
		 возвращает компонент «Панель свойств рабочей книги».


		 ![](../../../Sub_Image.gif)
		 [getRibbonView](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.getRibbonView.htm)
		 Метод getRibbonView
		 возвращает ленту инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.refresh.htm)
		 Метод refresh
		 обновляет компонент в соответствии с метаданными.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.refreshAll.htm)
		 Метод refreshAll
		 обновляет весь компонент.


		 ![](../../../Sub_Image.gif)
		 [refreshHeader](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.refreshHeader.htm)
		 Метод refreshHeader
		 обновляет надпись и картинку в заголовке в панели свойств.


## События, унаследованные от класса [WorkbookView](../../../Classes/TimeSeries/WorkbookView/WorkbookView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [NeedRevisions](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.NeedRevisions.htm)
		 Событие NeedRevisions
		 наступает при запросе ревизий.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении свойств в ленте инструментов или
		 панели свойств.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/WorkbookView/WorkbookView.RequestMetadata.htm)
