...
Компонент ComponentMismatchWizard представляет собой мастер для выделения изменённых значений данных временных рядов.


## Комментарии


Компонент ComponentMismatchWizard реализован классом [ComponentMismatchWizard](../../../Classes/TimeSeries/ComponentMismatchWizard/ComponentMismatchWizard.htm).


## Пример


Компонент ComponentMismatchWizard может иметь следующий вид:


![](ComponentMismatchWizard.png)


[Пример создания компонента ComponentMismatchWizard](ComponentMismatchWizard_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ComponentMismatchWizard](dhtmlTS.chm::/Classes/TimeSeries/ComponentMismatchWizard/Constructor_ComponentMismatchWizard.htm)
		 Конструктор ComponentMismatchWizard
		 создает экземпляр класса ComponentMismatchWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CurrentState](dhtmlTS.chm::/Classes/TimeSeries/ComponentMismatchWizard/ComponentMismatchWizard.CurrentState.htm)
		 Свойство CurrentState
		 определяет текущие настройки мастера для выделения изменённых
		 значений данных временных рядов.
