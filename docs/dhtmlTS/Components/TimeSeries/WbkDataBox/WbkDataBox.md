...
Компонент WbkDataBox
 служит для отображения и управления данными рабочей книги.
...
Пример создания компонента приведен на странице [Конструктор
 WbkDataBox](../../../Classes/TimeSeries/WbkDataBox/Constructor_WbkDataBox.htm).
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [WbkDataBox](dhtmlTS.chm::/Classes/TimeSeries/WbkDataBox/Constructor_WbkDataBox.htm)
			 Конструктор
			 WbkDataBox создает экземпляр класса WbkDataBox.


## Свойства, унаследованные от класса [WbkDataView](../../../Classes/TimeSeries/WbkDataView/WbkDataView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [IsBreadcrumbVisible](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.IsBreadcrumbVisible.htm)
		 Свойство IsBreadcrumbVisible
		 определяет видимость навигационной цепочки и дерева рядов.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.Source.htm)
		 Свойство Source
		 определяет источник данных для рабочей книги анализа временных
		 рядов.


## Методы, унаследованные от класса [WbkDataView](../../../Classes/TimeSeries/WbkDataView/WbkDataView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [createTabControl](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.createTabControl.htm)
		 Метод createTabControl
		 создает панель управления листами.


		 ![](../../../Sub_Image.gif)
		 [getBreadcrumb](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getBreadcrumb.htm)
		 Метод getBreadcrumb
		 возвращает экземпляр класса [MetaAttributeBreadCrumbView](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumbView/MetaAttributeBreadCrumbView.htm).


		 ![](../../../Sub_Image.gif)
		 [getChartView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getChartView.htm)
		 Метод getChartView
		 возвращает компонент для отображения диаграммы.


		 ![](../../../Sub_Image.gif)
		 [getGaugeView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getGaugeView.htm)
		 Метод getGaugeView
		 возвращает контейнер для спидометра.


		 ![](../../../Sub_Image.gif)
		 [getGridView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getGridView.htm)
		 Метод getGridView
		 возвращает компонент для отображения таблицы.


		 ![](../../../Sub_Image.gif)
		 [getMapView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getMapView.htm)
		 Метод getMapView возвращает
		 компонент для отображения карты.


		 ![](../../../Sub_Image.gif)
		 [getMetaAttrTree](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getMetaAttrTree.htm)
		 Метод getMetaAttrTree
		 возвращает дерево рядов.


		 ![](../../../Sub_Image.gif)
		 [getModeSelectorView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getModeSelectorView.htm)
		 Метод getModeSelectorView
		 возвращает компонент для управления расположением представлений
		 рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getStatPanelVisible](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getStatPanelVisible.htm)
		 Метод getStatPanelVisible
		 возвращает признак, видна ли панель статистик.


		 ![](../../../Sub_Image.gif)
		 [getTitleView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getTitleView.htm)
		 Метод getTitleView
		 возвращает компонент для отображения заголовка
		 рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getToolBarView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getToolBarView.htm)
		 Метод getToolBarView
		 возвращает группу кнопок для выбора варианта представления данных.


		 ![](../../../Sub_Image.gif)
		 [getViews](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.getViews.htm)
		 Метод getViews возвращает
		 массив представлений визуализаторов.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.refresh.htm)
		 Метод refresh
		 обновляет указанные элементы рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.refreshAll.htm)
		 Метод refreshAll
		 обновляет всё содержимое рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [refreshMetaAttribute](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.refreshMetaAttribute.htm)
		 Метод refreshMetaAttribute
		 обновляет компоненты, отображающие информацию об атрибутах
		 ([дерево
		 рядов](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeTree/MetaAttributeTree.htm) и [навигационную
		 цепочку](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeBreadCrumb/MetaAttributeBreadCrumb.htm)).


		 ![](../../../Sub_Image.gif)
		 [refreshView](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.refreshView.htm)
		 Метод refreshView обновляет
		 указанные элементы рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [setActiveSheet](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.setActiveSheet.htm)
		 Метод setActiveSheet
		 определяет ключ активного листа.


		 ![](../../../Sub_Image.gif)
		 [setMainElementsVisible](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.setMainElementsVisible.htm)
		 Метод setMainElementsVisible
		 определяет видимость разделителя, навигационной
		 цепочки и панели инструментов.


		 ![](../../../Sub_Image.gif)
		 [setSourcesCaption](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.setSourcesCaption.htm)
		 Метод setSourcesCaption
		 устанавливает название источника данных, которое будет
		 отображаться в цепочке навигации.


		 ![](../../../Sub_Image.gif)
		 [setSplitterStatPanelHeight](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.setSplitterStatPanelHeight.htm)
		 Метод setSplitterStatPanelHeight
		 определяет высоту панели разделителя, в которой
		 расположена панель статистик.


		 ![](../../../Sub_Image.gif)
		 [showCannotOpenCube](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.showCannotOpenCube.htm)
		 Метод showCannotOpenCube
		 отображает окно с предупреждением о том, что
		 выбранный куб не может быть выбран в качестве источника.


		 ![](../../../Sub_Image.gif)
		 [updateSourcesCaptionSize](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.updateSourcesCaptionSize.htm)
		 Метод updateSourcesCaptionSize
		 обновляет размер части навигационной цепочки,
		 в которой отображено имя источника данных.


## События, унаследованные от класса [WbkDataView](../../../Classes/TimeSeries/WbkDataView/WbkDataView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [ActiveSheetChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.ActiveSheetChanged.htm)
		 Событие ActiveSheetChanged
		 наступает после изменения активного листа.


		 ![](../../../Event_Image.gif)
		 [DocDataChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.DocDataChanged.htm)
		 Событие DocDataChanged
		 наступает после изменения параметров документа рабочей
		 книги.


		 ![](../../../Event_Image.gif)
		 [ObjSizeChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.ObjSizeChanged.htm)
		 Событие ObjSizeChanged
		 наступает после изменения размеров элементов компонента
		 [StackPanel](dhtmlUi.chm::/Components/StackPanel/StackPanel.htm),
		 содержащего карту, диаграмму и таблицу.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает после изменения параметра рабочей книги.


		 ![](../../../Event_Image.gif)
		 [Refreshed](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.Refreshed.htm)
		 Событие Refreshed наступает
		 после завершения обновления компонента.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.RequestMetadata.htm)
		 Событие RequestMetadata
		 наступает при запросе метаданных.


		 ![](../../../Event_Image.gif)
		 [SheetClick](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.SheetClick.htm)
		 Событие SheetClick наступает при нажатии на заголовок листа.


		 ![](../../../Event_Image.gif)
		 [TreeVisibleChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkDataView/WbkDataView.TreeVisibleChanged.htm)
		 Событие TreeVisibleChanged
		 наступает после изменения видимости дерева рядов.
