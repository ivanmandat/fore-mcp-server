...
Компонент WbkSaveDataDialog представляет собой диалог для добавления комментария перед сохранением данных.


## Комментарии


Компонент реализован с помощью класса [WbkSaveDataDialog](../../../Classes/TimeSeries/WbkSaveDataDialog/WbkSaveDataDialog.htm).


## Пример


Компонент WbkSaveDataDialog имеет следующий вид:


![](../../../Classes/TimeSeries/WbkSaveDataDialog/savedata.PNG)


Пример создания компонента показан на странице «[Конструктор WbkSaveDataDialog](../../../Classes/TimeSeries/WbkSaveDataDialog/Constructor_WbkSaveDataDialog.htm)». Диалог можно открыть нажав на кнопку «Сохранить изменения» на вкладке «Данные» ленты инструментов (кнопка доступна, если в рабочую книгу были внесены изменения).
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [WbkSaveDataDialog](dhtmlTS.chm::/Classes/TimeSeries/WbkSaveDataDialog/Constructor_WbkSaveDataDialog.htm)
		 Конструктор WbkSaveDataDialog
		 создает экземпляр класса WbkSaveDataDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getComment](dhtmlTS.chm::/Classes/TimeSeries/WbkSaveDataDialog/WbkSaveDataDialog.getComment.htm)
		 Метод getComment возвращает
		 комментарий.
