...
HistoryWindow - визуальный компонент, который отображает окно с историей изменений для выделенного ряда.


## Комментарии


Компонент HistoryWindow реализован с помощью класса [HistoryWindow](../../../Classes/TimeSeries/HistoryWindow/HistoryWindow.htm).
...
![](../../../Classes/TimeSeries/HistoryWindow/ex_2.PNG)


Пример создания компонента HistoryWindow показан на странице «[Конструктор HistoryWindow](../../../Classes/TimeSeries/HistoryWindow/Constructor_HistoryWindow.htm)».
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [HistoryWindow](dhtmlTS.chm::/Classes/TimeSeries/HistoryWindow/Constructor_HistoryWindow.htm)
		 Конструктор HistoryWindow
		 реализует окно с историей изменений для точки.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getRevisionsListBox](dhtmlTS.chm::/Classes/TimeSeries/HistoryWindow/HistoryWindow.getRevisionsListBox.htm)
		 Метод getRevisionsListBox
		 возвращает компонент со списком ревизий.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/HistoryWindow/HistoryWindow.refresh.htm)
		 Метод refresh
		 обновляет компонент, является аналогом метода [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/HistoryWindow/HistoryWindow.refreshAll.htm).


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/HistoryWindow/HistoryWindow.refreshAll.htm)
		 Метод refreshAll
		 обновляет компонент.
