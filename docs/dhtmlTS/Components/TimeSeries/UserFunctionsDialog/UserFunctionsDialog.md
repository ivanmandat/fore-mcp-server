...
Компонент UserFunctionsDialog
 представляет собой диалог настройки пользовательских функций в [рабочей
 книге](../../../Classes/TimeSeries/Workbook/Workbook.htm).


## Комментарии


Компонент UserFunctionsDialog реализован
 с помощью класса [UserFunctionsDialog](../../../Classes/TimeSeries/UserFunctionsDialog/UserFunctionsDialog.htm).
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [UserFunctionsDialog](../../../Classes/TimeSeries/UserFunctionsDialog/Constructor_UserFunctionsDialog.htm)
		 Конструктор UserFunctionsDialog**
		 создает экземпляр класса **UserFunctionsDialog**.
