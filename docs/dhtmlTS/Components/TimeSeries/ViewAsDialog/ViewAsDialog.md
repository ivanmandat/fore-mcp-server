...
Компонент ViewAsDialog
 представляет собой диалог «Редактирование преобразования».


## Комментарии


Компонент реализован с помощью класса [ViewAsDialog](../../../Classes/TimeSeries/ViewAsDialog/ViewAsDialog.htm).


## Пример


Диалог «Редактирование преобразования» имеет следующий вид:


![](../../../Classes/TimeSeries/ViewAsDialog/ViewAsDialog1.png)


Пример создания компонента показан на странице «[Конструктор
 ViewAsDialog](../../../Classes/TimeSeries/ViewAsDialog/Constructor_ViewAsDialog.htm)». Диалог можно открыть нажав на кнопку «Отобразить как»
 на вкладке «Главная» ленты инструментов и выбрав в раскрывающемся списке
 пункт «Другое преобразование...».
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ViewAsDialog](dhtmlTS.chm::/Classes/TimeSeries/ViewAsDialog/Constructor_ViewAsDialog.htm)
		 Конструктор ViewAsDialog
		 создает экземпляр класса ViewAsDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getInversionInformation](dhtmlTS.chm::/Classes/TimeSeries/ViewAsDialog/ViewAsDialog.getInversionInformation.htm)
		 Метод getInversionInformation
		 возвращает информацию о введённых пользователем данных в диалоге.
