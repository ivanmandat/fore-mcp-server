...
Компонент WbkRibbon служит
 для реализации ленты инструментов рабочей книги.


## Комментарии


Компонент реализован классом [WbkRibbon](../../../Classes/TimeSeries/WbkRibbon/WbkRibbon.htm).


Рабочая книга является основной функциональной областью базы данных
 и предназначена для работы с временными рядами.


Лента содержит команды, упорядоченные в логические группы и размещенные
 на вкладках. Каждая вкладка связана с видом выполняемого действия, например,
 работа с данными или разметкой страницы. Часть вкладок выводится на экран
 только по мере необходимости.


При изменении размеров окна базы данных временных рядов кнопки на ленте
 масштабируются.
...
Основные возможности и функции ленты:
	...
	- свёртывание/развертывание ленты;
...
Пример использования компонента приведен на странице «[Пример
 создания компонента WbkRibbon](Example_WbkRibbon.htm)».
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [WbkRibbon](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbon/Constructor_WbkRibbon.htm)
			 Конструктор
			 WbkRibbon создает компонент экземпляр
			 класса WbkRibbon.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [MetadataChanged](../../../Classes/TimeSeries/WbkRibbon/WbkRibbon.MetadataChanged.htm)
		 Событие MetadataChanged
		 наступает при изменении метаданных компонента.


## Свойства, унаследованные от класса [WbkRibbonView](../../../Classes/TimeSeries/WbkRibbonView/WbkRibbonView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [ChartDataView](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.ChartDataView.htm)
		 Свойство ChartDataView
		 определяет диаграмму, настройки которой будут изменяться
		 из ленты.


		 ![](../../../Property_Image.gif)
		 [Source](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Source.htm)
		 Свойство Source
		 определяет источник данных для ленты инструментов.


## Методы, унаследованные от класса [WbkRibbonView](../../../Classes/TimeSeries/WbkRibbonView/WbkRibbonView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getChartCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getChartCategory.htm)
		 Метод getChartCategory
		 возвращает вкладку «Диаграмма»
		 на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getDataCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getDataCategory.htm)
		 Метод getDataCategory
		  возвращает вкладку «Данные»
		 на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getFormulasCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getFormulasCategory.htm)
		 Метод getFormulasCategory
		 возвращает вкладку «Вычисления»
		 на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getMainCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getMainCategory.htm)
		 Метод getMainCategory
		 возвращает вкладку «Главная»
		 на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getReadonlyCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getReadonlyCategory.htm)
		 Метод getReadonlyCategory
		 возвращает вкладку ленты «Главная»
		 в режиме просмотра.


		 ![](../../../Sub_Image.gif)
		 [getTableCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getTableCategory.htm)
		 Метод getTableCategory
		 возвращает вкладку «Таблица»
		 на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getTitleCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getTitleCategory.htm)
		 Метод getTitleCategory
		 возвращает вкладку «Заголовок»
		 на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getTitleView](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getTitleView.htm)
		 Метод getTitleView
		 возвращает заголовок рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [getViewCategory](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.getViewCategory.htm)
		 Метод getViewCategory
		 возвращает вкладку «Вид»
		 на ленте инструментов рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.refresh.htm)
		 Метод refresh
		 обновляет указанный элемент управления на ленте инструментов
		 временных рядов.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.refreshAll.htm)
		 Метод refreshAll
		 обновляет содержимое ленты инструментов.


		 ![](../../../Sub_Image.gif)
		 [showPrintPreview](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.showPrintPreview.htm)
		 Метод showPrintPreview
		 отображает окно с предварительным просмотром рабочей книги.


		 ![](../../../Sub_Image.gif)
		 [setPropertyValue](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.setPropertyValue.htm)
		 Метод setPropertyValue
		 устанавливает значение свойств [ленты
		 инструментов](dhtmlTS.chm::/Components/TimeSeries/WbkRibbon/WbkRibbon.htm).


## События, унаследованные от класса [WbkRibbonView](../../../Classes/TimeSeries/WbkRibbonView/WbkRibbonView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [Closed](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Closed.htm)
		 Событие Closed
		 наступает при выборе пункта «Закрыть»
		 главного меню рабочей книги.


		 ![](../../../Event_Image.gif)
		 [Collapsed](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Collapsed.htm)
		 Событие Collapsed
		 наступает при сворачивании ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [CreatedReport](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.CreatedReport.htm)
		 Событие CreatedReport
		 наступает при выборе пункта «Новая
		 рабочая книга» главного меню рабочей книги.


		 ![](../../../Event_Image.gif)
		 [Discuss](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Discuss.htm)
		 Событие Discuss
		 наступает при выборе пункта «Поделиться»
		 главного меню рабочей книги.


		 ![](../../../Event_Image.gif)
		 [DisplayTreeChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.DisplayTreeChanged.htm)
		 Событие DisplayTreeChanged
		 наступает после изменения внешнего вида дерева рядов на
		 ленте инструментов рабочей книги.


		 ![](../../../Event_Image.gif)
		 [Exited](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Exited.htm)
		 Событие Exited
		 наступает при выборе пункта «Выход»
		 главного меню рабочей книги.


		 ![](../../../Event_Image.gif)
		 [Expanded](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Expanded.htm)
		 Событие Expanded
		 наступает при разворачивании ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [Exported](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Exported.htm)
		 Событие Exported
		 наступает при выборе пункта «Экспорт»
		 главного меню рабочей книги.


		 ![](../../../Event_Image.gif)
		 [Opened](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Opened.htm)
		 Событие Opened наступает
		 при выборе пункта главного меню «Открыть».


		 ![](../../../Event_Image.gif)
		 [Printing](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Printing.htm)
		 Событие Printing наступает
		 при выборе пункта «Печать»
		 главного меню рабочей книги.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.PropertyChanged.htm)
		 Событие PropertyChanged
		 генерируется после изменении свойства ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике
		 ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [SaveAs](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.SaveAs.htm)
		 Событие SaveAs наступает
		 при выборе пункта главного меню «Сохранить
		 как».


		 ![](../../../Event_Image.gif)
		 [Saved](dhtmlTS.chm::/Classes/TimeSeries/WbkRibbonView/WbkRibbonView.Saved.htm)
		 Событие Saved наступает
		 при выборе пункта главного меню «Сохранить».
