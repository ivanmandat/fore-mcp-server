...
Компонент AddAggregationDialog
 представляет собой диалог добавления ряда, вычисленного методом агрегации.
...
Компонент AddAggregationDialog
 реализован классом [AddAggregationDialog](../../../Classes/TimeSeries/AddAggregationDialog/AddAggregationDialog.htm).
...
[Пример создания компонента
 AddAggregationDialog](AddAggregationDialog_Example.htm)
