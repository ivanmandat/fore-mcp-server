...
Компонент MetaAttributeTree
 служит для отображения иерархии каталога показателей BI-сервера продукта
...
Компонент реализован классом [MetaAttributeTree](../../../Classes/TimeSeries/MetaAttributeTree/MetaAttributeTree.htm).
...
![](../../../Classes/TimeSeries/MetaAttributeTree/MAttrTree.png)


Пример создания компонента MetaAttributeTree
 показан на странице «[Конструктор
 MetaAttributeTree](../../../Classes/TimeSeries/MetaAttributeTree/Constructor_MetaAttributeTree.htm)».
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [MetaAttributeTree](dhtmlTS.chm::/Classes/TimeSeries/MetaAttributeTree/Constructor_MetaAttributeTree.htm)
			 Конструктор MetaAttributeTree
			 создает экземпляр класса MetaAttributeTree.


## Свойства, унаследованные от класса [HieTreeView](../../../Classes/TimeSeries/HieTreeView/HieTreeView.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [Hierarchy](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.Hierarchy.htm)
		 Свойство Hierarchy
		 устанавливает текущее отображаемое измерение
		 .


		 ![](../../../Property_Image.gif)
		 [IsBusy](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.IsBusy.htm)
		 Свойство IsBusy
		 устанавливает признак того, что в дереве выполняется перезагрузка
		 вершин.


## Методы, унаследованные от класса [HieTreeView](../../../Classes/TimeSeries/HieTreeView/HieTreeView.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [getSource](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.getSource.htm)
		 Метод getSource
		 определяет текущее отображаемое измерение.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.refresh.htm)
		 Метод refresh обновляет
		 дерево.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.refreshAll.htm)
		 Метод refreshAll обновляет
		 весь компонент.


		 ![](../../../Sub_Image.gif)
		 [reload](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.reload.htm)
		 Метод reload
		 перезагружает все элементы дерева.


## События, унаследованные от класса [HieTreeView](../../../Classes/TimeSeries/HieTreeView/HieTreeView.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [NodeDblClick](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.NodeDblClick.htm)
		 Событие NodeDblClick
		 наступает при двойном щелчке по вершине дерева.


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении свойств экземпляра класса HieTreeView.


		 ![](../../../Event_Image.gif)
		 [RequestChangeMetadata](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.RequestChangeMetadata.htm)
		 Событие RequestChangeMetadata
		 наступает при запросе на изменение метаданных иерархии рядов.


		 ![](../../../Event_Image.gif)
		 [RequestChild](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.RequestChild.htm)
		 Событие RequestChild
		 наступает при запросе дочерних вершин.


		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.RequestMetadata.htm)
		 Событие RequestMetadata
		 наступает при запросе метаданных экземпляра класса
		 HieTreeView.


		 ![](../../../Event_Image.gif)
		 [SelectionChanged](dhtmlTS.chm::/Classes/TimeSeries/HieTreeView/HieTreeView.SelectionChanged.htm)
		 Событие SelectionChanged
		 наступает при изменении отметки в дереве.
