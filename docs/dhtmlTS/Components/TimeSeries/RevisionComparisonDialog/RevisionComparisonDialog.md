...
Компонент RevisionComparisonDialog представляет собой диалог правила валидации данных путём сравнения их версий в [рабочей книге](../../../Classes/TimeSeries/Workbook/Workbook.htm).


## Комментарии


Компонент RevisionComparisonDialog реализован с помощью класса [RevisionComparisonDialog](../../../Classes/TimeSeries/RevisionComparisonDialog/RevisionComparisonDialog.htm).
...
[Пример создания компонента RevisionComparisonDialog](RevisionComparisonDialog_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [RevisionComparisonDialog](dhtmlTS.chm::/Classes/TimeSeries/RevisionComparisonDialog/Constructor_RevisionComparisonDialog.htm)
		 Конструктор RevisionComparisonDialog
		 создает экземпляр класса RevisionComparisonDialog.
