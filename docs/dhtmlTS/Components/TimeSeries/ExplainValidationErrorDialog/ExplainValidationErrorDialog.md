...
Компонент ExplainValidationErrorDialog представляет собой диалог для объяснения ошибки валидации данных в [рабочей книге](../../../Classes/TimeSeries/Workbook/Workbook.htm).


## Комментарии


Компонент ExplainValidationErrorDialog реализован с помощью класса [ExplainValidationErrorDialog](../../../Classes/TimeSeries/ExplainValidationErrorDialog/ExplainValidationErrorDialog.htm).
...
[Пример создания компонента ExplainValidationErrorDialog](ExplainValidationErrorDialog_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ExplainValidationErrorDialog](dhtmlTS.chm::/Classes/TimeSeries/ExplainValidationErrorDialog/Constructor_ExplainValidationErrorDialog.htm)
		 Конструктор ExplainValidationErrorDialog
		 создает экземпляр класса ExplainValidationErrorDialog.
