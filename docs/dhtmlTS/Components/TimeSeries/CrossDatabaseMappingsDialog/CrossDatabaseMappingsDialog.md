...
Компонент CrossDatabaseMappingsDialog представляет собой диалог сопоставления атрибутов в [рабочей книге](../../../Classes/TimeSeries/Workbook/Workbook.htm).


## Комментарии


Компонент CrossDatabaseMappingsDialog реализован с помощью класса [CrossDatabaseMappingsDialog](../../../Classes/TimeSeries/CrossDatabaseMappingsDialog/CrossDatabaseMappingsDialog.htm).


Он предназначен для сопоставления атрибутов рабочей книги объектам и значениям из эталонной базы данных временных рядов.
...
[Пример создания компонента CrossDatabaseMappingsDialog](CrossDatabaseMappingsDialog_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [CrossDatabaseMappingsDialog](dhtmlTS.chm::/Classes/TimeSeries/CrossDatabaseMappingsDialog/Constructor_CrossDatabaseMappingsDialog.htm)
		 Конструктор CrossDatabaseMappingsDialog
		 создает экземпляр класса CrossDatabaseMappingsDialog.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [setCurrentState](dhtmlTS.chm::/Classes/TimeSeries/CrossDatabaseMappingsDialog/CrossDatabaseMappingsDialog.setCurrentState.htm)
		 Метод setCurrentState
		 устанавливает в диалоге эталонную базу данных временных рядов
		 по её ключу.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestMetadata](dhtmlTS.chm::/Classes/TimeSeries/CrossDatabaseMappingsDialog/CrossDatabaseMappingsDialog.RequestMetadata.htm)
		 Событие RequestMetadata
		 генерируется при отсутствии метаданных в источнике диалога сопоставления
