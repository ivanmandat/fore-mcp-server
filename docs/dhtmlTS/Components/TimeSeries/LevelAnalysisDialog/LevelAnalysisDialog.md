...
Компонент LevelAnalysisDialog представляет собой диалог для валидации данных путём сравнения их с числом в [рабочей книге](../../../Classes/TimeSeries/Workbook/Workbook.htm).


## Комментарии


Компонент LevelAnalysisDialog реализован с помощью класса [LevelAnalysisDialog](../../../Classes/TimeSeries/LevelAnalysisDialog/LevelAnalysisDialog.htm).
...
[Пример создания компонента LevelAnalysisDialog](LevelAnalysisDialog_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [LevelAnalysisDialog](dhtmlTS.chm::/Classes/TimeSeries/LevelAnalysisDialog/Constructor_LevelAnalysisDialog.htm)
		 Конструктор LevelAnalysisDialog
		 создает экземпляр класса LevelAnalysisDialog.
