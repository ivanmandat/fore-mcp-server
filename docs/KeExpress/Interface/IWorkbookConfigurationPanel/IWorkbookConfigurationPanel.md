...
Интерфейс IWorkbookConfigurationPanel
 предназначен для работы компонентом среды разработки [WorkbookConfigurationPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/WorkbookConfigurationPanel.htm).
...
Компонент WorkbookConfigurationPanel
 представляет собой боковую панель, с помощью которой можно управлять
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveCategory](IWorkbookConfigurationPanel.ActiveCategory.htm)
		 Свойство ActiveCategory
		 определяет активную вкладку компонента.


		 ![](../../Property_Image.gif)
		 [Analyzer](IWorkbookConfigurationPanel.Analyzer.htm)
		 Свойство Analyzer определяет
		 источник данных для компонента.


		 ![](../../Property_Image.gif)
		 [Categories](IWorkbookConfigurationPanel.Categories.htm)
		 Свойство Categories
		 возвращает коллекцию вкладок компонента.


		 ![](../../Property_Image.gif)
		 [Context](IWorkbookConfigurationPanel.Context.htm)
...
## Методы
		 ...
		 ![](../../Property_Image.gif)
		 [GetActiveContext](IWorkbookConfigurationPanel.GetActiveContext.htm)
