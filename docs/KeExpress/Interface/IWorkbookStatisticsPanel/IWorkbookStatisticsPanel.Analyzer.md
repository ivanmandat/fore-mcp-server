...
Для выполнения примера предполагается наличие формы, расположенной на
 ней кнопки с наименованием «Button1», компонента WorkbookStatisticsPanel
 с наименованием «WorkbookStatisticsPanel1» и компонента UiErAnalyzer с
...
При нажатии на кнопку компонент «UiErAnalyzer1» будет установлен
 в качестве источника для «WorkbookStatisticsPanel1». В «WorkbookStatisticsPanel1»
 будут отображены рассчитанные статистики.


См. также:


[IWorkbookStatisticsPanel](IWorkbookStatisticsPanel.htm)
