# IEaxSelectionPadContext.HierarchyDeleteElement
...
HierarchyDeleteElement(Element: [IDimElement](KeDims.chm::/interface/IDimElement/IDimElement.htm));
...
Метод HierarchyDeleteElement
 удаляет текущий элемент иерархии.
...
Добавьте ссылку на системную сборку Dimensions.
	...
	    (sps As IEaxSelectionPadContext).HierarchyDeleteElement(Element);

	End Sub Button1OnClick;


На боковой панели перейдите в группу вкладок «Отметка»
 и в выбранном измерении выделите элемент. При нажатии на кнопку выбранный
 элемент измерения будет удален.
