...
Интерфейс IEaxBubbleChartBox
 содержит свойства и методы компонента среды разработки [EaxBubbleChartBox](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxBubbleChartBox.htm).
...
Для получения доступа к параметрам пузырьковой диаграммы используйте
 свойство [IUiEaxBubbleChart.Chart](../IUiEaxBubbleChart/IUiEaxBubbleChart.Chart.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IEaxBubbleChartBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](IEaxBubbleChartBox.Source.htm)
