...
Интерфейс IEaxConfigurationPadPanel
 содержит свойства и методы для работы с панелью, которая связана со вкладкой
 боковой панели.
...
Параметры панели могут быть получены с помощью свойства [IEaxConfigurationPad.Content](../IEaxConfigurationPad/IEaxConfigurationPad.Content.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [Constraints](IEaxConfigurationPadPanel.Constraints.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Form](IEaxConfigurationPadPanel.Form.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MetabaseObject](IEaxConfigurationPadPanel.MetabaseObject.htm)
