...
Свойство ImageAsBackground определяет
 использование изображения в заголовке/колонтитуле в качестве фона.
...
Допустимые значения:
	...
	- True. Использовать изображение
	 в заголовке/колонтитуле в качестве фона;


	- False. Не использовать
	 изображение в заголовке/колонтитуле в качестве фона.
...
После выполнения примера в центральной части верхнего колонтитула будет
 вставлено указанное изображение. Данное изображение будет использоваться
 как фон колонтитула.
