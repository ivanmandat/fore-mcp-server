...
Интерфейс IEaxMapBox содержит
 свойства и методы компонента среды разработки - [EaxMapBox](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxMapBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IEaxMapBox.BorderStyle.htm)
