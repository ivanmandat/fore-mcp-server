...
Метод FinishBatchCommand завершает
 пакетный экспорт данных в файл.


## Комментарии


Данный метод используется совместно с методом [IExAnalyzerExporter.StartBatchCommand](IExAnalyzerExporter.StartBatchCommand.htm).
