...
Интерфейс IEaxConfigurationPanel
 содержит свойства и методы компонента среды разработки - [EaxConfigurationPanel](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxConfigurationPanel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveCategory](IEaxConfigurationPanel.ActiveCategory.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](IEaxConfigurationPanel.Analyzer.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Categories](IEaxConfigurationPanel.Categories.htm)
...
## Методы
		 ...
		 ![](../../Sub_Image.gif)
		 [GetActiveContext](IEaxConfigurationPanel.GetActiveContext.htm)
