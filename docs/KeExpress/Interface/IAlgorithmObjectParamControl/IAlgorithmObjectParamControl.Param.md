# IAlgorithmObjectParamControl.Param
...
Свойство Param определяет параметр
 текущего объекта, значения которого будут передаваться в параметр алгоритма
 расчёта.
...
Параметр должен быть создан на основе справочника репозитория.
...
[IAlgorithmObjectParamControl](IAlgorithmObjectParamControl.htm)
