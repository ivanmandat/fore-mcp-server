...
Интерфейс IErAnalyzerDimPanel
 содержит свойства и методы компонента среды разработки - [ErAnalyzerDimPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ErAnalyzerDimPanel.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IErAnalyzerDimPanel.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ErAnalyzer](IErAnalyzerDimPanel.ErAnalyzer.htm)


		 Свойство ErAnalyzer
		 определяет экспресс-отчет, реализуемый интерфейсом [IEaxAnalyzer](../IEaxAnalyzer/IEaxAnalyzer.htm),
		 являющийся источником данных для панели измерений.


		 ![](../../Property_Image.gif)
		 [FixedStructure](IErAnalyzerDimPanel.FixedStructure.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Object](IErAnalyzerDimPanel.Object.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Orientation](IErAnalyzerDimPanel.Orientation.htm)
