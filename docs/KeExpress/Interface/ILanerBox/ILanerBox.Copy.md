...
Copy(Series: [ILanerSeriesSet](Laner.chm::/Interface/ILanerSeriesSet/ILanerSeriesSet.htm));
...
Series. Набор рядов рабочей
 книги, которые необходимо скопировать в буфер обмена.


## Описание


Метод Copy копирует набор рядов
