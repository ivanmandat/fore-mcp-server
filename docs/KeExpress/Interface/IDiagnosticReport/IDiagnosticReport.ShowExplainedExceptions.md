# IDiagnosticReport.ShowExplainedExceptions
...
Свойство ShowExplainedExceptions
 определяет, отображать ли объяснение для точек в виде примечания.
...
Допустимые значения:
	...
	- True. Отображать объяснение
	 для точек в виде примечания;


	- False. Не отображать
	 объяснение для точек в виде примечания.
...
Пример будет выполняться при нажатии на кнопку.
	...
	            Memo1.Lines.Add("  Наименование фильтра = " + (ValidationRules.Item(i) As IMetabaseObject).Name);
