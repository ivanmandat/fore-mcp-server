...
EaxAnalyzer: [IEaxAnalyzer](../IEaxAnalyzer/IEaxAnalyzer.htm);


## Описание


Свойство EaxAnalyzer определяет
 экспресс-отчет, отображающий данные.
...
Для выполнения примера предполагается наличие формы, расположенной на
 ней кнопки с наименованием «Button1», компонента Memo с идентификатором
