...
Exceptions(Row: Integer; Column: Integer): [IValidationRules](../IValidationRules/IValidationRules.htm);
...
Свойство Exceptions возвращает
 правила, выполняющиеся для заданной точки.
