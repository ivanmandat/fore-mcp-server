...
Rules: [IValidationRules](../IValidationRules/IValidationRules.htm);


## Описание


Свойство Rules возвращает правила,
 в результате выполнения которых получены данные отчета.
