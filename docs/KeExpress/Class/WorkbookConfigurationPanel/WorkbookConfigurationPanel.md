# WorkbookConfigurationPanel: Класс
...
Класс WorkbookConfigurationPanel
 реализует компонент среды разработки - [WorkbookConfigurationPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/WorkbookConfigurationPanel.htm).


## Комментарии


Компонент WorkbookConfigurationPanel
 представляет собой боковую панель, с помощью которой можно управлять параметрами
 рабочей книги базы данных временных рядов.


## Свойства объекта класса, унаследованные от [IWorkbookConfigurationPanel](../../Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveCategory](../../Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.ActiveCategory.htm)
		 Свойство ActiveCategory
		 определяет активную вкладку компонента.


		 ![](../../Property_Image.gif)
		 [Analyzer](../../Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.Analyzer.htm)
		 Свойство Analyzer определяет
		 источник данных для компонента.


		 ![](../../Property_Image.gif)
		 [Categories](../../Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.Categories.htm)
		 Свойство Categories
		 возвращает коллекцию вкладок компонента.


		 ![](../../Property_Image.gif)
		 [Context](../../Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.Context.htm)
...
## Методы объекта класса, унаследованные от [IWorkbookConfigurationPanel](../../Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [GetActiveContext](../../Interface/IWorkbookConfigurationPanel/IWorkbookConfigurationPanel.GetActiveContext.htm)
		 Метод GetActiveContext
		 возвращает контекст компонента WorkbookConfigurationPanel.
