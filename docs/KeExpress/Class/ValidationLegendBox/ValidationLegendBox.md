...
Класс ValidationLegendBox реализует
 компонент среды разработки [ValidationLegendBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ValidationLegendBox.htm),
 используемый для отображения списка правил валидаций, которые были применены
 в рабочей книге.


## Свойства объекта класса, унаследованные от [IValidationLegendBox](../../Interface/IValidationLegendBox/IValidationLegendBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](../../Interface/IValidationLegendBox/IValidationLegendBox.Analyzer.htm)
