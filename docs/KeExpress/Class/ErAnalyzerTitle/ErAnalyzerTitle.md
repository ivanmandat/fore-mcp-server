...
Класс ErAnalyzerTitle реализует
 компонент среды разработки [ErAnalyzerTitle](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ErAnalyzerTitle.htm),
 используемый для отображения заголовка экспресс-отчета.


## Свойства, унаследованные от [IErAnalyzerTitle](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [AutoEndEdit](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.AutoEndEdit.htm)


		 Свойство AutoEndEdit
		 определяет признак завершения редактирования заголовка при потере
		 фокуса.


		 ![](../../Property_Image.gif)
		 [AutoHeight](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.AutoHeight.htm)


		 Свойство AutoHeight
		 определяет, будет ли производиться автоматический подгон размеров
		 компонента.


		 ![](../../Property_Image.gif)
		 [BeginSel](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.BeginSel.htm)


		 Свойство BeginSel возвращает
		 текущую начальную позицию выделенного фрагмента в заголовке экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [Bold](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Bold.htm)


		 Свойство Bold определяет,
		 будет ли использоваться жирный шрифт заголовка экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.BorderStyle.htm)


		 Свойство BorderStyle
		 определяет стиль границы панели заголовка экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [EndSel](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.EndSel.htm)


		 Свойство EndSel возвращает
		 текущую конечную позицию выделенного фрагмента в заголовке экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [FontFamily](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.FontFamily.htm)


		 Свойство FontFamily
		 определяет семейство шрифтов заголовка экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [FontSize](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.FontSize.htm)


		 Свойство FontSize определяет
		 размер шрифта заголовка экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [Italic](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Italic.htm)


		 Свойство Italic определяет,
		 будет ли использоваться курсивный шрифт заголовка экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [Object](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Object.htm)


		 Свойство Object определяет
		 источник данных для панели заголовка экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [Underline](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Underline.htm)


		 Свойство Underline
		 определяет, будет ли использоваться подчеркнутый шрифт заголовка
		 экспресс-отчета.


		 ![](../../Property_Image.gif)
		 [VerticalAlignment](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.VerticalAlignment.htm)


		 Свойство VerticalAlignment
		 определяет способ выравнивания текста заголовка по вертикали.


		 ![](../../Property_Image.gif)
		 [Xaml](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Xaml.htm)


		 Свойство Xaml определяет
		 текст в заголовке экспресс-отчета, предназначенного для представления
		 в формате XAML.
...
## Методы, унаследованные от [IErAnalyzerTitle](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [Copy](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Copy.htm)
		 Метод Copy помещает
		 выделенный фрагмент заголовка экспресс-отчета в буфер обмена,
		 оставляя заголовок без изменений.


		 ![](../../Sub_Image.gif)
		 [Cut](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Cut.htm)
		 Метод Cut помещает
		 выделенный фрагмент заголовка экспресс-отчета в буфер обмена,
		 удаляя его из заголовка.


		 ![](../../Sub_Image.gif)
		 [EndEdit](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.EndEdit.htm)
		 Метод EndEdit выводит
		 компонент из режима редактирования с сохранением всех изменений.


		 ![](../../Sub_Image.gif)
		 [InsertDate](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.InsertDate.htm)
		 Метод InsertDate вставляет
		 текущую дату в заголовок экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [InsertName](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.InsertName.htm)
		 Метод InsertName вставляет
		 наименование текущего экспресс-отчета в заголовок.


		 ![](../../Sub_Image.gif)
		 [InsertSelection](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.InsertSelection.htm)
		 Метод InsertSelection
		 вставляет наименование текущего измерения в заголовок экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [InsertText](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.InsertText.htm)
		 Метод InsertText вставляет
		 текст, заданный пользователем, в заголовок экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [InsertTime](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.InsertTime.htm)
		 Метод InsertTime вставляет
		 текущее время в заголовок экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [Paste](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.Paste.htm)
		 Метод Paste вставляет
		 фрагмент, находящийся в буфере обмена, в заголовок экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [SelectAll](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.SelectAll.htm)
		 Метод SelectAll полностью
		 выделяет заголовок экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [SetSel](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.SetSel.htm)
		 Метод SetSel выделяет
		 необходимый фрагмент в заголовке экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [ShowFontDialog](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.ShowFontDialog.htm)
		 Метод ShowFontDialog
		 вызывает диалог настройки шрифта для заголовка.


		 ![](../../Sub_Image.gif)
		 [StartEdit](../../Interface/IErAnalyzerTitle/IErAnalyzerTitle.StartEdit.htm)
		 Метод StartEdit переводит
		 заголовок в режим редактирования.
