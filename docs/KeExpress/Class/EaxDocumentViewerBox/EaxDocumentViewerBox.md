...
Класс EaxDocumentViewerBox реализует
 компонент среды разработки - [EaxDocumentViewerBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxDocumentViewerBox.htm).


## Свойства, унаследованные от [IEaxDocumentViewerBox](../../Interface/IEaxDocumentViewerBox/IEaxDocumentViewerBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](../../Interface/IEaxDocumentViewerBox/IEaxDocumentViewerBox.Analyzer.htm)
