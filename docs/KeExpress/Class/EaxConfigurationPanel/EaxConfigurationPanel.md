...
Класс EaxConfigurationPanel
 реализует компонент среды разработки [EaxConfigurationPanel](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxConfigurationPanel.htm).


## Свойства объекта класса, унаследованные от [IEaxConfigurationPanel](../../Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ActiveCategory](../../Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.ActiveCategory.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](../../Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.Analyzer.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Categories](../../Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.Categories.htm)
...
## Методы объекта класса, унаследованные от [IEaxConfigurationPanel](../../Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [GetActiveContext](../../Interface/IEaxConfigurationPanel/IEaxConfigurationPanel.GetActiveContext.htm)
		 Метод GetActiveContext
		 возвращает контекст компонента EaxConfigurationPanel.
...
## События объекта класса
		 ...
		 ![](../../Event_Image.gif)
		 [OnActivePadChanged](EaxConfigurationPanel.OnActivePadChanged.htm)
		 Событие OnActivePadChanged
		 наступает при активации какой-либо вкладки компонента.


		 ![](../../Event_Image.gif)
		 [OnInternalWidgetChange](EaxConfigurationPanel.OnInternalWidgetChange.htm)
