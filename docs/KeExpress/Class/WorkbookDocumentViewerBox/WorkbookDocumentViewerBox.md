# WorkbookDocumentViewerBox: Класс
...
Класс WorkbookDocumentViewerBox
 реализует компонент среды разработки - [WorkbookDocumentViewerBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/WorkbookDocumentViewerBox.htm).


## Свойства, унаследованные от [IWorkbookDocumentViewerBox](../../Interface/IWorkbookDocumentViewerBox/IWorkbookDocumentViewerBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](../../Interface/IWorkbookDocumentViewerBox/IWorkbookDocumentViewerBox.Analyzer.htm)
		 Свойство Analyzer определяет
		 источник данных для компонента.


		 ![](../../Property_Image.gif)
		 [FactorsTreeVisible](../../Interface/IWorkbookDocumentViewerBox/IWorkbookDocumentViewerBox.FactorsTreeVisible.htm)
