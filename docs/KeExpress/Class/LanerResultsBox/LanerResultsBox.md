...
Класс LanerResultsBox содержит
 свойства и методы компонента среды разработки - LanerResultsBox.


## Свойства, унаследованные от [ILanerResultsBox](../../Interface/ILanerResultsBox/ILanerResultsBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/ILanerResultsBox/ILanerResultsBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ChartToolbarVisible](../../Interface/ILanerResultsBox/ILanerResultsBox.ChartToolbarVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [ContainerVisible](../../Interface/ILanerResultsBox/ILanerResultsBox.ContainerVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [DerivedSerieVisible](../../Interface/ILanerResultsBox/ILanerResultsBox.DerivedSerieVisible.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [NoShowErrors](../../Interface/ILanerResultsBox/ILanerResultsBox.NoShowErrors.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Object](../../Interface/ILanerResultsBox/ILanerResultsBox.Object.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Results](../../Interface/ILanerResultsBox/ILanerResultsBox.Results.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [UserForm](../../Interface/ILanerResultsBox/ILanerResultsBox.UserForm.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [UserFormControl](../../Interface/ILanerResultsBox/ILanerResultsBox.UserFormControl.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [UserFormReplacePanel](../../Interface/ILanerResultsBox/ILanerResultsBox.UserFormReplacePanel.htm)
...
## Методы, унаследованные от [ILanerResultsBox](../../Interface/ILanerResultsBox/ILanerResultsBox.htm)
		 ...
		 ![](../../Sub_Image.gif)
		 [LoadFromStream](../../Interface/ILanerResultsBox/ILanerResultsBox.LoadFromStream.htm)


		 Метод LoadFromStream
		 загружает параметры отображения компонента LanerResultsBox
		 из потока.


		 ![](../../Sub_Image.gif)
		 [Refresh](../../Interface/ILanerResultsBox/ILanerResultsBox.Refresh.htm)


		 Метод Refresh обновляет
		 панели компонента LanerResultsBox.


		 ![](../../Sub_Image.gif)
		 [RefreshContainer](../../Interface/ILanerResultsBox/ILanerResultsBox.RefreshContainer.htm)


		 Метод RefreshContainer
		 обновляет указанную панель компонента.


		 ![](../../Sub_Image.gif)
		 [SaveToStream](../../Interface/ILanerResultsBox/ILanerResultsBox.SaveToStream.htm)


		 Метод SaveToStream
		 сохраняет параметры отображения компонента LanerResultsBox
		 в поток.


		 ![](../../Sub_Image.gif)
		 [SetUserForm](../../Interface/ILanerResultsBox/ILanerResultsBox.SetUserForm.htm)
...
## События
		 ...
		 ![](../../Sub_Image.gif)
		 [OnChartChanged](LanerResultsBox.OnChartChanged.htm)
		 Событие OnChartChanged
		 наступает при изменении диаграммы экспресс-отчета.


		 ![](../../Sub_Image.gif)
		 [OnCopyStatistics](LanerResultsBox.OnCopyStatistics.htm)
		 Событие OnCopyStatistics
		 наступает при копировании данных со вкладки «Статистические
		 характеристики» на панели «Результаты
		 вычислений» компонента LanerResultsBox.
