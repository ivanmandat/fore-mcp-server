# EaxConfigurationPadPanel: Класс

EaxConfigurationPadPanel: Класс
-


# EaxConfigurationPadPanel
...
Класс EaxConfigurationPadPanel
 реализует панель вкладки компонента [EaxConfigurationPanel](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxConfigurationPanel.htm).


## Свойства класса, унаследованные от [IEaxConfigurationPadPanel](../../Interface/IEaxConfigurationPadPanel/IEaxConfigurationPadPanel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Constraints](../../Interface/IEaxConfigurationPadPanel/IEaxConfigurationPadPanel.Constraints.htm)


		 Свойство Constraints
		 определяет ограничения на размеры панели, начиная с которых будут
		 отображаться полосы прокрутки.


		 ![](../../Property_Image.gif)
		 [Form](../../Interface/IEaxConfigurationPadPanel/IEaxConfigurationPadPanel.Form.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [MetabaseObject](../../Interface/IEaxConfigurationPadPanel/IEaxConfigurationPadPanel.MetabaseObject.htm)


		 Свойство MetabaseObject
		 определяет идентификатор формы, содержимое которой будет отображено
		 в области панели, привязанной к данной вкладке.
