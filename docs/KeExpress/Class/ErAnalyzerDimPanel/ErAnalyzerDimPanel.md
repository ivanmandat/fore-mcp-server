...
Класс ErAnalyzerDimPanel реализует
 компонент среды разработки [ErAnalyzerDimPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/ErAnalyzerDimPanel.htm),
 содержащий панели измерений экспресс-отчета.


## Свойства, унаследованные от [IErAnalyzerDimPanel](../../Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.BorderStyle.htm)


		 Свойство BorderStyle
		 определяет стиль границы панели измерений.


		 ![](../../Property_Image.gif)
		 [ErAnalyzer](../../Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.ErAnalyzer.htm)


		 Свойство ErAnalyzer
		 определяет экспресс-отчет, реализуемый интерфейсом [IEaxAnalyzer](../../Interface/IEaxAnalyzer/IEaxAnalyzer.htm),
		 являющийся источником данных для панели измерений.


		 ![](../../Property_Image.gif)
		 [FixedStructure](../../Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.FixedStructure.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Object](../../Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.Object.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Orientation](../../Interface/IErAnalyzerDimPanel/IErAnalyzerDimPanel.Orientation.htm)


		 Свойство Orientation
		 определяет вариант расположения измерений на панели измерений.
