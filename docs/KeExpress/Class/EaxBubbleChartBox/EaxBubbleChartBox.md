...
Класс EaxBubbleChartBox реализует
 компонент среды разработки [EaxBubbleChartBox](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxBubbleChartBox.htm)
 , используемый для отображения пузырьковой диаграммы.
...
## Свойства объекта класса
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IEaxBubbleChartBox/IEaxBubbleChartBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](../../Interface/IEaxBubbleChartBox/IEaxBubbleChartBox.Source.htm)


		 Свойство Source определяет
		 источник данных для компонента [EaxBubbleChartBox](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxBubbleChartBox.htm).
