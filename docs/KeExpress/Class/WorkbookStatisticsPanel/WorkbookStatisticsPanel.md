...
Класс WorkbookStatisticsPanel
 реализует компонент среды разработки - [WorkbookStatisticsPanel](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/WorkbookStatisticsPanel.htm).


## Свойства, унаследованные от [IWorkbookStatisticsPanel](../../Interface/IWorkbookStatisticsPanel/IWorkbookStatisticsPanel.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Analyzer](../../Interface/IWorkbookStatisticsPanel/IWorkbookStatisticsPanel.Analyzer.htm)
