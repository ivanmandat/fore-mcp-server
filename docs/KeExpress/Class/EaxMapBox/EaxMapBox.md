...
Класс EaxMapBox реализует компонент
 среды разработки [EaxMapBox](uidevenv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/EaxMapBox.htm), используемый
 для отображения карт экспресс-отчетов.


## Свойства объекта класса, унаследованные от [IEaxMapBox](../../Interface/IEaxMapBox/IEaxMapBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IEaxMapBox/IEaxMapBox.BorderStyle.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](../../Interface/IEaxMapBox/IEaxMapBox.Source.htm)
...
## События объекта класса
		 ...
		 ![](../../Event_Image.gif)
		 [OnTerritoryClick](EaxMapBox.OnTerritoryClick.htm)
		 Событие OnTerritoryClick
		 наступает при щелчке кнопкой мыши по какому-либо региону карты.
