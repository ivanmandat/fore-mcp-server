...
Компонент DataMiningMaster представляет
 собой мастер «Интелектуального анализа
 данных».
...
Компонент реализован классом [DataMiningMaster](../../../Classes/Metabase/DataMiningMaster/DataMiningMaster.htm).


Шаги мастера реализованы классом [DMSettingsStep](../../../Classes/Metabase/DMSettingsStep/DMSettingsStep.htm).


В своей реализации использует сервис [DataMiningService](../../../Classes/Metabase/DataMiningService/DataMiningService.htm).


Внешний вид зависит от выбранного [метода](../../../Enums/DmMethodKind.htm),
 например: [AssociationRulesView](../../../Classes/Metabase/AssociationRulesView/AssociationRulesView.htm)
...
![](../../../Classes/Metabase/AssociationRulesView/AssRulesView.png)


[Пример создания компонента DataMiningMaster](DataMiningMaster_Example.htm).
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 DataMiningMaster
			 Конструктор DataMiningMaster
			 создает экземпляр класса DataMiningMaster.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [OnGetDataMiningResult](../../../Classes/Metabase/DataMiningMaster/DataMiningMaster.OnGetDataMiningResult.htm)
...
[Компоненты
 для работы с репозиторием](../../Components.htm)
