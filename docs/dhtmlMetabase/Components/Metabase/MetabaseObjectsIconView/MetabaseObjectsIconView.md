...
Компонент MetabaseObjectsIconView
 представляет собой контейнер для списка объектов репозитория в виде пиктограмм.


## Комментарии


Компонент реализован классом [MetabaseObjectsIconView](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.htm).
...
[Пример создания компонента
 MetabaseObjectsIconView](Example_MetabaseObjectsIconView.htm)
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [MetabaseObjectsIconView](../../../Classes/Metabase/MetabaseObjectsIconView/Constructor_MetabaseObjectsIconView.htm)
			 Конструктор MetabaseObjectsIconView
			 создает экземпляр класса MetabaseObjectsIconView.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [IconType](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.IconType.htm)
		 Свойство IconType определяет
		 вариант отображения списка объектов.


		 ![](../../../Property_Image.gif)
		 [ItemHeight](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.ItemHeight.htm)
		 Свойство ItemHeight
		 определяет высоту объектов.


		 ![](../../../Property_Image.gif)
		 [ItemWidth](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.ItemWidth.htm)
		 Свойство ItemWidth
		 определяет ширину объектов.


		 ![](../../../Property_Image.gif)
		 [Orientation](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.Orientation.htm)
		 Свойство Orientation
		 определяет тип ориентации объектов.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [deSelectAll](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.deSelectAll.htm)
		 Метод deSelectAll снимает
		 выделение со всех элементов контейнера.


		 ![](../../../Sub_Image.gif)
		 [getItems](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.getItems.htm)
		 Метод getItems возвращает
		 массив всех объектов списка.


		 ![](../../../Sub_Image.gif)
		 [invertSelection](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.invertSelection.htm)
		 Метод invertSelection
		 инвертирует отметку элементов контейнера.


		 ![](../../../Sub_Image.gif)
		 [selectAll](../../../Classes/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.selectAll.htm)
