...
Компонент NavigatorRibbon представляет
 собой ленту инструментов [навигатора
...
Компонент реализован классом [NavigatorRibbon](../../../Classes/Metabase/NavigatorRibbon/NavigatorRibbon.htm).
 Компонент входит в состав компонента [Navigator](../Navigator/Navigator.htm).


Компонент NavigatorRibbon может
 использовать функциональность базового компонента [Ribbon](dhtmlRibbon.chm::/Classes/Ribbon/Ribbon.htm).
 Доступ к свойствам, методам и событиям компонента [Ribbon](dhtmlRibbon.chm::/Classes/Ribbon/Ribbon.htm)
 осуществляется при помощи метода [ProxyControl.getControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.getControl.htm).
...
[Пример создания компонента NavigatorRibbon](NavigatorRibbon_Example.htm)
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [NavigatorRibbon](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/constructor_navigatorribbon.htm)
			 Конструктор NavigatorRibbon
			 создает экземпляр класса NavigatorRibbon.
...
## Свойство
		 ...
		 ![](../../../Property_Image.gif)
		 [SharepointEnabled](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/navigatorribbon.sharepointenabled.htm)
		 Свойство SharepointEnabled
		 определяет, отображается ли кнопка «Обсудить
		 в Sharepoint» на вкладке «Главная».
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getChangePassDialog](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/navigatorribbon.getchangepassdialog.htm)
		 Метод getChangePassDialog
		 возвращает диалог для смены пароля.


		 ![](../../../Sub_Image.gif)
		 [getControlById](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/navigatorribbon.getcontrolbyid.htm)
		 Метод getControlById
		 возвращает элемент управления, расположенный на ленте, по его
		 идентификатору.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlMetabase.chm::/Classes/Metabase/NavigatorRibbon/NavigatorRibbon.Refresh.htm)
		 Метод refresh
		 обновляет компонент.


		 ![](../../../Sub_Image.gif)
		 [setObjectListMode](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/navigatorribbon.setobjectlistmode.htm)
		 Метод setObjectListMode
		 определяет, какая из кнопок на вкладке «Вид»,
		 «Мелкие значки», «Обычные значки» или «Таблица»,
		 находится в нажатом состоянии.


		 ![](../../../Sub_Image.gif)
		 [setPasteButtonEnabled](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/navigatorribbon.setpastebuttonenabled.htm)
		 Метод setPasteButtonEnabled
		 определяет, активна ли кнопка «Вставить»
		 на вкладке «Главная».


		 ![](../../../Sub_Image.gif)
		 [setShowNavigationPanel](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/navigatorribbon.setshownavigationpanel.htm)
		 Метод setShowNavigationPanel
		 определяет, находится ли кнопка «Дерево
		 объектов» на вкладке «Вид»
		 в нажатом состоянии.


		 ![](../../../Sub_Image.gif)
		 [setViewEditButtonsStateByClass](dhtmlMetabase.chm::/classes/metabase/navigatorribbon/navigatorribbon.setvieweditbuttonsstatebyclass.htm)
		 Метод setViewEditButtonsStateByClass
		 устанавливает устанавливает активность элементов управления, расположенных
		 на ленте, в зависимости от класса объекта.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ChangedPassword](dhtmlMetabase.chm::/Classes/Metabase/NavigatorRibbon/NavigatorRibbon.ChangedPasswordClick.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [Collapsed](dhtmlMetabase.chm::/Classes/Metabase/NavigatorRibbon/NavigatorRibbon.Collapsed.htm)
		 Событие Collapsed наступает
		 при сворачивании ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [Exited](dhtmlMetabase.chm::/Classes/Metabase/NavigatorRibbon/NavigatorRibbon.Exited.htm)
		 Событие Exited наступает
		 при выборе пункта «Выход»
		 главного меню «Навигатор».


		 ![](../../../Event_Image.gif)
		 [Expanded](dhtmlMetabase.chm::/Classes/Metabase/NavigatorRibbon/NavigatorRibbon.Expanded.htm)
		 Событие Expanded наступает
		 при разворачивании ленты инструментов.


		 ![](../../../Event_Image.gif)
		 [ImportDataClick](dhtmlMetabase.chm::/Classes/Metabase/NavigatorRibbon/NavigatorRibbon.ImportDataClick.htm)
		 Событие ImportDataClick
		 наступает после нажатия на кнопку «Импорт
		 данных».


		 ![](../../../Event_Image.gif)
		 [PropertyChanged](dhtmlMetabase.chm::/Classes/Metabase/NavigatorRibbon/NavigatorRibbon.PropertyChanged.htm)
		 Событие PropertyChanged
		 наступает при изменении состояния кнопки или группы кнопок.
