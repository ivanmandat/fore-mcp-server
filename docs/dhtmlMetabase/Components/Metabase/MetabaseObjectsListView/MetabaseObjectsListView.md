...
Компонент MetabaseObjectsListView
 представляет собой контейнер для отображения [списка объектов](GetStarted.chm::/Interface/Interface_Navigator.htm)
...
Компонент реализован классом [MetabaseObjectsListView](../../../Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.htm).
...
[Пример создания компонента
 MetabaseObjectsListView](Example_MetabaseObjectsListView.htm)
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [MetabaseObjectsListView](../../../Classes/Metabase/MetabaseObjectsListView/Constructor_MetabaseObjectsListView.htm)
