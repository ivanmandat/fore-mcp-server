...
Компонент ServiceUnavailableDialog
 представляет собой диалог, в котором отображается статус состояния связи
...
Компонент реализован классом [PP.Mb.Ui.ServiceUnavailableDialog](../../../../Classes/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.htm).
...
## Конструктор
			 ...
			 ![](../../../../Sub_Image.gif)
			 [ServiceUnavailableDialog](../../../../Classes/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog_constructor.htm)
			 Конструктор ServiceUnavailableDialog
			 создает экземпляр компонента [ServiceUnavailableDialog](ServiceUnavailableDialog.htm).
