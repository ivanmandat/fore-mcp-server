...
Компонент ChangePasswordDialog
 представляет собой диалог для смены пароля.


## Комментарии


Компонент реализован классом [ChangePasswordDialog](../../../../Classes/Metabase/Dialogs/ChangePasswordDialog/ChangePasswordDialog.htm).


Диалог для смены вызывается из меню «Сервис» на [ленте
 навигатора объектов](../../NavigatorRibbon/NavigatorRibbon.htm): Сервис >
 Сменить пароль...
...
[Пример создания компонента
 ChangePasswordDialog](Example_ChangePasswordDialog.htm)
...
## Конструктор
		 ...
		 ![](../../../../Sub_Image.gif)
		 [ChangePasswordDialog](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ChangePasswordDialog/Constructor_ChangePasswordDialog.htm)
		 Конструктор ChangePasswordDialog
		 создает экземпляр компонента ChangePasswordDialog.
...
## Методы
		 ...
		 ![](../../../../Sub_Image.gif)
		 [checkConfirmPass](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ChangePasswordDialog/ChangePasswordDialog.checkConfirmPass.htm)
		 Метод checkConfirmPass
		 используется для проверки на совпадение нового пароля с подтвержденным.


		 ![](../../../../Sub_Image.gif)
		 [getConfirmPass](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ChangePasswordDialog/ChangePasswordDialog.getConfirmPass.htm)
		 Метод getConfirmPass
		 возвращает значение подтвержденного пароля.


		 ![](../../../../Sub_Image.gif)
		 [getNewPass](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ChangePasswordDialog/ChangePasswordDialog.getNewPass.htm)
		 Метод getNewPass возвращает
		 значение нового пароля.


		 ![](../../../../Sub_Image.gif)
		 [getOldPass](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ChangePasswordDialog/ChangePasswordDialog.getOldPass.htm)
		 Метод getOldPass
		 возвращает значение старого пароля.
