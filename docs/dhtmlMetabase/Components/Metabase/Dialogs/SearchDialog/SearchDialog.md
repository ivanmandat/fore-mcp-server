...
Компонент SearchDialog представляет
 собой диалог поиска объекта репозитория.


## Комментарии


Компонент SearchDialog реализован
 классом PP.Ui.[SearchDialog](../../../../Classes/Metabase/Dialogs/SearchDialog/SearchDialog.htm).


## Пример


Диалог поиска имеет следующий вид:


![](SearchDialog.gif)


[Пример создания компонента SearchDialog](SearchDialog_example.htm)
...
## Конструктор
		 ...
		 ![](../../../../Sub_Image.gif)
		 [SearchDialog](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/SearchDialog/Constructor_SearchDialog.htm)

		 Конструктор SearchDialog создает
		 экземпляр класса SearchDialog.
...
## Методы
		 ...
		 ![](../../../../Sub_Image.gif)
		 [getControls](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/SearchDialog/SearchDialog.getControls.htm)
		 Метод getControls возвращает
		 элементы управления, входящие в состав диалога.


		 ![](../../../../Sub_Image.gif)
		 [getSearchSettings](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/SearchDialog/SearchDialog.getSearchSettings.htm)
		 Метод getSearchSettings
		 возвращает настройки, заданные в диалоге.


		 ![](../../../../Sub_Image.gif)
		 [setCurrentFolder](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/SearchDialog/SearchDialog.setCurrentFolder.htm)
		 Метод setCurrentFolder
		 устанавливает папку, в которой будет осуществляться поиск.
...
## События
		 ...
		 ![](../../../../Event_Image.gif)
		 [Find](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/SearchDialog/SearchDialog.Find.htm)
		 Событие Find наступает
		 при нажатии на кнопку «Найти».


		 ![](../../../../Event_Image.gif)
		 [FindAll](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/SearchDialog/SearchDialog.FindAll.htm)
		 Событие FindAll наступает
