...
Компонент MetabaseDialogBase**
 представляет собой базовый диалог с репозиторием.


## Комментарии


Компонент реализован классом [MetabaseDialogBase](../../../../Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.htm).
 На основе данного компонента построены также другие диалоги с репозиторием
 - [MetabaseOpenDialog](../MetabaseOpenDialog/MetabaseOpenDialog.htm)
 и [MetabaseSaveDialog](../MetabaseSaveDialog/MetabaseSaveDialog.htm).
...
[Пример создания компонента
 MetabaseDialogBase](MetabaseDialogBase_Example.htm)
...
## Конструктор
				 ...
				 ![](../../../../Sub_Image.gif)
				 [MetabaseDialogBase](../../../../Classes/Navigator/MetabaseDialogBase/Constructor_MetabaseDialogBase.htm)
				 Конструктор **MetabaseDialogBase**
				 создает экземпляр класса **MetabaseDialogBase**.
