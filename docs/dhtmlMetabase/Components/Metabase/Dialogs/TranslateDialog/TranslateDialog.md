...
Компонент TranslateDialog представляет
 собой диалог для сохранения объекта с именами на разных языках.


## Комментарии


Компонент реализован классом PP.Mb.[TranslateDialog](../../../../Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.htm).
