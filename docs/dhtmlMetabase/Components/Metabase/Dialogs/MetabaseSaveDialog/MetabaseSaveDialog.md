...
Компонент MetabaseSaveDialog**
 представляет собой диалог сохранения объекта в репозитории.


## Комментарии


Компонент реализован классом [MetabaseSaveDialog](../../../../Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.htm).


Диалог для сохранения объекта в репозитории вызывается при выборе пункта
 главного меню «Сохранить как».
...
[Пример создания компонента
 MetabaseSaveDialog](MetabaseSaveDialog_Example.htm)
...
## Конструктор
				 ...
				 ![](../../../../Sub_Image.gif)
				 [MetabaseSaveDialog](../../../../Classes/Navigator/MetabaseSaveDialog/Constructor_MetabaseSaveDialog.htm)
				 Конструктор **MetabaseSaveDialog**
				 создает экземпляр класса **MetabaseSaveDialog**.
...
## Свойства
		 ...
		 ![](../../../../Property_Image.gif)
		 [DefaultId](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.DefaultId.htm)
		 Свойство **DefaultId**
		 устанавливает для сохраняемого в репозитории объекта идентификатор
		 по умолчанию.


		 ![](../../../../Property_Image.gif)
		 [DefaultName](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.DefaultName.htm)
		 Свойство **DefaultName**
		 устанавливает для сохраняемого в репозитории объекта имя по умолчанию.


		 ![](../../../../Property_Image.gif)
		 [Names](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.Names.htm)
		 Свойство **Names**
		 определяет имя сохраняемого в репозитории объекта в различных
		 переводах.


		 ![](../../../../Property_Image.gif)
		 [ShowTranslateButton](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.ShowTranslateButton.htm)
		 Свойство **ShowTranslateButton**
		 управляет видимостью кнопки, при нажатии на которую отображается
		 диалог для перевода имени сохраняемого объекта на различные языки.


		 ![](../../../../Property_Image.gif)
		 [TranslateDialog](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.TranslateDialog.htm)
		 Свойство **TranslateDialog**
		 устанавливает диалог для перевода имени сохраняемого объекта на
		 различные языки.
...
## Методы
		 ...
		 ![](../../../../Sub_Image.gif)
		 [getIdControl](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.getIdControl.htm)
		 Метод **getIdControl**
		 возвращает текстовое поле для ввода идентификатора сохраняемого
		 объекта.


		 ![](../../../../Sub_Image.gif)
		 [getNameControl](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.getNameControl.htm)
		 Метод **getNameControl**
		 возвращает текстовое поле для ввода имени сохраняемого объекта.
...
## События
		 ...
		 ![](../../../../Event_Image.gif)
		 [SaveAsObject](dhtmlMetabase.chm::/Classes/Navigator/MetabaseSaveDialog/MetabaseSaveDialog.SaveAsObject.htm)
		 Событие **SaveAsObject**
		 генерируется при сохранении объекта в репозиторий.


## Свойства, унаследованные от класса [MetabaseDialogBase](../../../../Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.htm)
		 ...
		 ![](../../../../Property_Image.gif)
		 [FiltersSet](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.FiltersSet.htm)
		 Свойство **FiltersSet**
		 определяет множество фильтров для диалога.


		 ![](../../../../Property_Image.gif)
		 [OpenToKey](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.OpenToKey.htm)
		 Свойство **OpenToKey**
		 устанавливает ключ каталога, который нужно раскрыть в базовом
		 диалоге с репозиторием.


## Методы, унаследованные от класса [MetabaseDialogBase](../../../../Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.htm)
		 ...
		 ![](../../../../Sub_Image.gif)
		 [addFilter](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.addFilter.htm)
		 Метод **addFilter**
		 добавляет фильтр в базовый диалог с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [changeObjectListMode](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.changeObjectListMode.htm)
		 Метод **changeObjectListMode**
		 устанавливает вид списка объектов в базовом диалоге с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [clearFiltersSet](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.clearFiltersSet.htm)
		 Метод **clearFiltersSet**
		 очищает массив фильтров в базовом диалоге с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [clearSelection](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.clearSelection.htm)
		 Метод **clearSelection**
		 снимает выделения в базовом диалоге с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [getCurrentFilter](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.getCurrentFilter.htm)
		 Метод **getCurrentFilter**
		 возвращает текущий фильтр в базовом диалоге с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [getImagePath](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.getImagePath.htm)
		 Метод **getImagePath**
		 возвращает путь к папке со значками.


		 ![](../../../../Sub_Image.gif)
		 [getNavigatorBox](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.getNavigatorBox.htm)
		 Метод **getNavigatorBox**
		 возвращает контейнер для дерева папок и списка объектов репозитория.


		 ![](../../../../Sub_Image.gif)
		 [getParentKey](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.getParentKey.htm)
		 Метод **getParentKey**
		 возвращает ключ текущей раскрытой папки в базовом диалоге с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [getParentMbObject](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.getParentMbObject.htm)
		 Метод **getParentMbObject**
		 возвращает родительский объект репозитория.


		 ![](../../../../Sub_Image.gif)
		 [getPathToRoot](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.getPathToRoot.htm)
		 Метод **getPathToRoot**
		 возвращает путь от корня репозитория до текущей раскрытой папки
		 в базовом диалоге с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [openFoldersTo](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.openFoldersTo.htm)
		 Метод **openFoldersTo**
		 раскрывает в базовом диалоге с репозиторием папку с указанным
		 ключом.


		 ![](../../../../Sub_Image.gif)
		 [recalcSize](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.recalcSize.htm)
		 Метод **recalcSize**
		 пересчитывает размер базового диалога с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [refresh](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.refresh.htm)
		 Метод **refresh**
		 обновляет содержимое папки по его ключу в базовом диалоге с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [refreshAll](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.refreshAll.htm)
		 Метод **refreshAll**
		 обновляет все элементы базового диалога с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [removeFilter](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.removeFilter.htm)
		 Метод **removeFilter**
		 удаляет фильтр по его позиции из базового диалога с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [selectFilter](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.selectFilter.htm)
		 Метод **selectFilter**
		 устанавливает указанный фильтр в качестве текущего в базовом диалоге
		 с репозиторием.


		 ![](../../../../Sub_Image.gif)
		 [setCollapsed](dhtmlMetabase.chm::/Classes/Navigator/MetabaseDialogBase/MetabaseDialogBase.setCollapsed.htm)
		 Метод **setCollapsed**
		 определяет признак свёрнутости содержимого базового диалога с
		 репозиторием.
