...
Компонент MetabaseOpenDialog**
 представляет собой диалог открытия объекта из репозитория.


## Комментарии


Компонент реализован классом [MetabaseOpenDialog](../../../../Classes/Metabase/Dialogs/MetabaseOpenDialog/MetabaseOpenDialog.htm).


Диалог для открытия объекта из репозитория вызывается при выборе пункта
 главного меню «Открыть из файла».
...
[Пример создания компонента
 MetabaseOpenDialog](MetabaseOpenDialog_Example.htm)
...
## Конструктор
				 ...
				 ![](../../../../Sub_Image.gif)
				 [MetabaseOpenDialog](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/MetabaseOpenDialog/Constructor_MetabaseOpenDialog.htm)
				 Конструктор **MetabaseOpenDialog**
				 создает экземпляр класса **MetabaseOpenDialog**.
...
## Методы
		 ...
		 ![](../../../../Sub_Image.gif)
		 [getObjectsToOpen](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/MetabaseOpenDialog/MetabaseOpenDialog.getObjectsToOpen.htm)
...
## События
		 ...
		 ![](../../../../Event_Image.gif)
		 [OpenObject](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/MetabaseOpenDialog/MetabaseOpenDialog.OpenObject.htm)
		 Событие **OpenObject**
		 наступает при открытии объекта репозитория в соответствующем диалоге.
