...
Компонент Navigator представляет
 собой навигатор объектов репозитория платформы.


## Комментарии


Компонент Navigator состоит
 из компонентов [NavigatorBox](../NavigatorBox/NavigatorBox.htm)
 и [NavigatorRibbon](../NavigatorRibbon/NavigatorRibbon.htm).


## Пример


Навигатор объектов имеет следующий вид:


![](Navigator.gif)


[Пример создания компонента Navigator](Navigator_Example.htm)
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [Navigator](dhtmlMetabase.chm::/classes/metabase/navigator/constructor_navigator.htm)
			 Конструктор Navigator
			 создает экземпляр компонента Navigator.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [MaxDocumentSize](dhtmlMetabase.chm::/Classes/Metabase/Navigator/Navigator.MaxDocumentSize.htm)
		 Свойство MaxDocumentSize
		 определяет максимальный размер загружаемого документа.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [fullscreen](dhtmlMetabase.chm::/classes/metabase/navigator/navigator.fullscreen.htm)
		 Метод fullscreen обновляет
		 размеры навигатора в соответствии с размерами окна.


		 ![](../../../Sub_Image.gif)
		 [getObjectListFilters](dhtmlMetabase.chm::/classes/metabase/navigator/navigator.getobjectlistfilters.htm)
		 Метод getObjectListFilters
		 возвращает типы объектов, которые отображаются в репозитории.


		 ![](../../../Sub_Image.gif)
		 [getSelectedObjects](dhtmlMetabase.chm::/Classes/Metabase/Navigator/Navigator.getSelectedObjects.htm)
		 Метод getSelectedObjects
		 возвращает массив выделенных объектов в списке объектов.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [CreateObject](dhtmlMetabase.chm::/classes/metabase/navigator/navigator.createobject.htm)
		 Событие CreateObject
		 наступает при выполнении команды ленты инструментов «Новый
		 объект > <Тип
		 объекта>».


		 ![](../../../Event_Image.gif)
		 [Discuss](dhtmlMetabase.chm::/classes/metabase/navigator/navigator.discuss.htm)
		 Событие Discuss
		 наступает при выборе одного из пунктов раскрывающегося меню, которое
		 вызывается при нажатии на кнопку ленты «Поделиться».


		 ![](../../../Event_Image.gif)
		 [Exit](dhtmlMetabase.chm::/classes/metabase/navigator/navigator.exit.htm)
		 Событие Exit наступает
		 при выполнении команды главного меню «Навигатор
		 > Выход».


		 ![](../../../Event_Image.gif)
		 [ObjectListModeChanged](dhtmlMetabase.chm::/Classes/Metabase/Navigator/Navigator.ObjectListModeChanged.htm)
		 Событие ObjectListModeChanged
		 наступает при изменении способа отображения значков в списке объектов.


		 ![](../../../Event_Image.gif)
		 [ObjectListObjectsLoaded](dhtmlMetabase.chm::/classes/metabase/navigator/navigator.objectlistobjectsloaded.htm)
		 Событие ObjectListObjectsLoaded
		 наступает при загрузке списка объектов репозитория.


		 ![](../../../Event_Image.gif)
		 [ObjectSelected](dhtmlMetabase.chm::/Classes/Metabase/Navigator/Navigator.ObjectSelected.htm)
		 Событие ObjectSelected
		 наступает при изменении отметки в списке объектов.


		 ![](../../../Event_Image.gif)
		 [OpenObjects](dhtmlMetabase.chm::/classes/metabase/navigator/navigator.openobjects.htm)
		 Событие OpenObjects
		 наступает при открытии объекта репозитория.


		 ![](../../../Event_Image.gif)
		 [PasswordChanged](dhtmlMetabase.chm::/Classes/Metabase/Navigator/Navigator.PasswordChanged.htm)
		 Событие PasswordChanged
		 наступает после смены пароля.


		 ![](../../../Event_Image.gif)
		 [PasswordChanging](dhtmlMetabase.chm::/Classes/Metabase/Navigator/Navigator.PasswordChanging.htm)
		 Событие PasswordChanging
		 наступает при смене пароля.
