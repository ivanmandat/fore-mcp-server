...
Компонент ImportDataWizard представляет
 собой мастер для импорта данных.


Мастер включает в себя три страницы:


	- [ImportColumnsStep](../../../Classes/Metabase/ImportColumnsStep/ImportColumnsStep.htm)
	 - шаг для загрузки данных и выбора импортируемых колонок;


	- [SetValueColumnsStep](../../../Classes/Metabase/SetValueColumnsStep/SetValueColumnsStep.htm)
	 - шаг для определения колонок, содержащих значения;


	- [BindingsStep](../../../Classes/Metabase/BindingsStep/BindingsStep.htm)
	 - шаг для установки соответствия.


## Комментарии


Компонент реализован классом [ImportDataWizard](../../../Classes/Metabase/ImportDataWizard/ImportDataWizard.htm).


Компонент используется для импорта данных в куб из файла внешнего формата.


## Пример


После выбора источника мастер выглядит следующим образом:


![](../../../Classes/Metabase/SetValueColumnsStep/SetValueColumnStep.gif)


[Пример создания компонента ImportDataWizard](ImportDataWizard_Example.htm)
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [ImportDataWizard](dhtmlMetabase.chm::/classes/metabase/importdatawizard/constructor_importdatawizard.htm)
		 Конструктор ImportDataWizard
		 создает экземпляр компонента ImportDataWizard.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CubeImport](dhtmlMetabase.chm::/Classes/Metabase/ImportDataWizard/ImportDataWizard.CubeImport.htm)
		 Свойство CubeImport
		 устанавливает модель объекта импорта - экземпляр класса PP.Mb.[CubeImport](dhtmlMetabase.chm::/Classes/Metabase/CubeImport/CubeImport.htm).


		 ![](../../../Property_Image.gif)
		 [DefaultImportFolderDesc](dhtmlMetabase.chm::/Classes/Metabase/ImportDataWizard/ImportDataWizard.DefaultImportFolderDesc.htm)
		 Свойство DefaultImportFolderDesc
		 устанавливает дескриптор папки для сохранения объектов импорта
		 по умолчанию.


## Методы, унаследованные от класса [Wizard](dhtmlUi.chm::/Classes/Wizard/Wizard.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [addStep](dhtmlUi.chm::/Classes/Wizard/Wizard.addStep.htm)
		 Метод addStep добавляет
		 [шаг](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm)
		 в мастер.


		 ![](../../../Sub_Image.gif)
		 [getWizardSettings](dhtmlUi.chm::/Classes/Wizard/Wizard.getWizardSettings.htm)
		 Метод getWizardSettings
		 возвращает объект с параметрами для мастера.


		 ![](../../../Sub_Image.gif)
		 [removeStep](dhtmlUi.chm::/Classes/Wizard/Wizard.removeStep.htm)
		 Метод removeStep удаляет
		 [шаг](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm)
		 из мастера.


## События, унаследованные от класса [Wizard](dhtmlUi.chm::/Classes/Wizard/Wizard.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [CancelButtonClicked](dhtmlUi.chm::/Classes/Wizard/Wizard.CancelButtonClicked.htm)
		 Событие CancelButtonClicked
		 наступает при нажатии на кнопку «Отмена».


		 ![](../../../Event_Image.gif)
		 [Closed](dhtmlUi.chm::/Classes/Wizard/Wizard.Closed.htm)
		 Событие Closed наступает
		 при закрытии мастера.


		 ![](../../../Event_Image.gif)
		 [CompleteButtonClicked](dhtmlUi.chm::/Classes/Wizard/Wizard.CompleteButtonClicked.htm)
		 Событие CompleteButtonClicked
		 наступает при нажатии на кнопку «Готово».
