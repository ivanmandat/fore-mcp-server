...
Пространство имен**: PP.Navigator;
...
[MetabaseDialogBase](../MetabaseDialogBase/MetabaseDialogBase.htm)
...
Класс **MetabaseSaveDialog**
 реализует [диалог
 сохранения объекта в репозитории](../../../Components/Metabase/Dialogs/MetabaseSaveDialog/MetabaseSaveDialog.htm).


## Синтаксис


PP.initClass(PP.Navigator.MetabaseSaveDialog, [PP.Navigator.MetabaseDialogBase](../MetabaseDialogBase/MetabaseDialogBase.htm),
 "PP.Navigator.MetabaseSaveDialog");
...
## Конструктор
				 ...
				 ![](../../../Sub_Image.gif)
				 [MetabaseSaveDialog](Constructor_MetabaseSaveDialog.htm)
...
## Свойства, унаследованные от класса [MetabaseDialogBase](../MetabaseDialogBase/MetabaseDialogBase.htm)
...
## Методы, унаследованные от класса [MetabaseDialogBase](../MetabaseDialogBase/MetabaseDialogBase.htm)
