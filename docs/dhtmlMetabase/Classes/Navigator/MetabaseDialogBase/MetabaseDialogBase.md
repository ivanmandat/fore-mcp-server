...
Класс **MetabaseDialogBase**
 реализует [базовый
 диалог с репозиторием](../../../Components/Metabase/Dialogs/MetabaseDialogBase/MetabaseDialogBase.htm).


## Синтаксис


PP.initClass(PP.Navigator.MetabaseDialogBase,  [PP.Ui.Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "PP.Navigator.MetabaseDialogBase");
...
## Конструктор
				 ...
				 ![](../../../Sub_Image.gif)
				 [MetabaseDialogBase](Constructor_MetabaseDialogBase.htm)
