...
Класс SetValueColumnsStep реализует страницу [мастера импорта данных](../ImportDataWizard/ImportDataWizard.htm) для определения колонок, содержащих значения.


## Комментарии


Страница для определения колонок, содержащих значения, - это второй шаг [мастера импорта данных](../ImportDataWizard/ImportDataWizard.htm):


![](../ImportColumnsStep/ImportColumnStep.gif)


## Синтаксис


PP.initClass(PP.Mb.Ui.SetValueColumnsStep, PP.Ui.[WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm), "SetValueColumnsStep");
