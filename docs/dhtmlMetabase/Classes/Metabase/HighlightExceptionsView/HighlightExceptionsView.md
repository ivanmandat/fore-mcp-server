...
Класс HighlightExceptionsView
 реализует представление диалога «Поиск
 исключений».
...
PP.initClass(PP.Mb.Ui.HighlightExceptionsView, PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Mb.Ui.HighlightExceptionsView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getStepData](HighlightExceptionsView.getStepData.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [StepCompleted](HighlightExceptionsView.StepCompleted.htm)
