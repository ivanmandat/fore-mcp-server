...
[WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm)
...
Класс DMSettingsStep - абстрактный
 класс, реализирующий в себе логику каждого отдельного шага мастера «Интелектуального анализа данных».


## Комментарии


Для получения класса используйте метод getSteps() для класса [DataMiningMaster](../DataMiningMaster/DataMiningMaster.htm).


## Синтаксис


PP.initClass(PP.Mb.Ui.DMSettingsStep, PP.Ui.[WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm),
 "DMSettingsStep");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getStepData](../AssociationRulesView/AssociationRulesView.getStepData.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestData](DMSettingStep.RequestData.htm)
		 Событие RequestData
		 наступает при запросе данных с сервера.


## Свойства, унаследованные от класса [WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm)
		 ...
		 ![](../../../Property_Image.gif)
		 [PendingState](dhtmlUi.chm::/Classes/WizardStep/WizardStep.PendingState.htm)
		 Свойство PendingState
		 определяет, завершена ли настройка на указанном шаге.


## Методы, унаследованные от класса [WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [accomplish](dhtmlUi.chm::/Classes/WizardStep/WizardStep.accomplish.htm)
		 Реализация метода accomplish может выполнять дополнительные
		 действия по инициализации настроек, которые хранятся по ссылке
		 PP.Ui.WizardStep._StepSettings.


		 ![](../../../Sub_Image.gif)
		 [getIsComplete](dhtmlUi.chm::/Classes/WizardStep/WizardStep.getIsComplete.htm)
		 Метод getIsComplete
		 определяет, была ли завершена настройка на определенном шаге.


		 ![](../../../Sub_Image.gif)
		 [getIsRequired](dhtmlUi.chm::/Classes/WizardStep/WizardStep.getIsRequired.htm)
		 Метод getIsRequired
		 возвращает признак того, является ли данный шаг обязательным для
		 выполнения.


		 ![](../../../Sub_Image.gif)
		 [getWereSettingsChanged](dhtmlUi.chm::/Classes/WizardStep/WizardStep.getWereSettingsChanged.htm)
		 Метод getWereSettingsChanged
		 определяет, были ли изменены настройки на шаге мастера.


		 ![](../../../Sub_Image.gif)
		 [rollback](dhtmlUi.chm::/Classes/WizardStep/WizardStep.rollback.htm)
		 Реализация метода rollback
		 может откатывать изменения, внесенные в рамках шага.


		 ![](../../../Sub_Image.gif)
		 [setStepSettings](dhtmlUi.chm::/Classes/WizardStep/WizardStep.setStepSettings.htm)
		 Метод setStepSettings
		 устанавливает ссылку на настройки [мастера](dhtmlUi.chm::/Classes/Wizard/Wizard.htm).


## События, унаследованные от класса [WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [StateToggled](dhtmlUi.chm::/Classes/WizardStep/WizardStep.StateToggled.htm)
		 Событие StateToggled
		 наступает, когда становится доступна кнопка мастера «Далее».
