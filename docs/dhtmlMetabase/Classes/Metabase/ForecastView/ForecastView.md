...
Класс ForecastView реализует
 представление диалога «Прогнозирование».


## Комментарии


Класс является внутренним, его нельзя получить другими методами. Класс
 реализован во внутреннем свойстве _currentView
 в объекте класса [DMSettingsStep](../DMSettingsStep/DMSettingsStep.htm).
...
PP.initClass(PP.Mb.Ui.ForecastView, PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Mb.Ui.ForecastView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getStepData](ForecastView.getStepData.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [RequestData](ForecastView.RequestData.htm)
		 Событие RequestData
		 наступает при запросе данных с сервера.


		 ![](../../../Event_Image.gif)
		 [StepCompleted](ForecastView.StepCompleted.htm)
		 Событие StepCompleted
		 наступает при завершении текущего шага.
...
## Методы, унаследованный от класса [Container](dhtmlUi.chm::/Classes/Container/Container.htm)
