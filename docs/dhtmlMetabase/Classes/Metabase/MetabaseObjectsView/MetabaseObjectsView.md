...
Класс MetabaseObjectsView реализует
 базовый класс для отображения списка объектов репозитория.


## Комментарии


Класс является родительским для классов:
...
PP.initClass(PP.Mb.Ui.MetabaseObjectsIconView, [PP.Ui.ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm),
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [MetabaseObjectsView](Constructor_MetabaseObjectsView.htm)
			 Конструктор MetabaseObjectsView
			 создает экземпляр класса MetabaseObjectsView.
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [CustomClasses](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.CustomClasses.htm)
		 Свойство CustomClasses
		 содержит массив пользовательских классов объектов.


		 ![](../../../Property_Image.gif)
		 [DisplayMode](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.DisplayMode.htm)
		 Свойство DisplayMode
		 определяет режим отображения имени объектов репозитория.


		 ![](../../../Property_Image.gif)
		 [EditOnLoad](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.EditOnLoad.htm)
		 Свойство EditOnLoad
		 определяет ключ объекта, который необходимо переименовать при
		 загрузке.


		 ![](../../../Property_Image.gif)
		 [Filter](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.Filter.htm)
		 Свойство Filter определяет
		 перечень объектов, которые будут отображены в компоненте.


		 ![](../../../Property_Image.gif)
		 [FolderTreeFilter](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.FolderTreeFilter.htm)
		 Свойство FolderTreeFilter
		 определяет фильтр для контейнеров.


		 ![](../../../Property_Image.gif)
		 [Metabase](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.Metabase.htm)
		 Свойство Metabase определяет
		 репозиторий, предоставляющий данные компоненту.


		 ![](../../../Property_Image.gif)
		 [MultiSelect](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.MultiSelect.htm)
		 Свойство MultiSelect
		 определяет возможность множественной отметки.


		 ![](../../../Property_Image.gif)
		 [RootKey](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.RootKey.htm)
		 Свойство RootKey определяет
		 корневой объект, объекты которого отображены в компоненте.


		 ![](../../../Property_Image.gif)
		 [SelectedKeys](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.SelectedKeys.htm)
		 Свойство SelectedKeys
		 содержит массив ключей выделенных объектов.


		 ![](../../../Property_Image.gif)
		 [ShowEmptyFolder](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.ShowEmptyFolder.htm)
		 Свойство ShowEmptyFolder
		 определяет признак отображения пустых папок.


		 ![](../../../Property_Image.gif)
		 [ShowOnlyContainers](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.ShowOnlyContainers.htm)
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [addObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.addObject.htm)
		 Метод addObject добавляет
		 объект репозитория в компонент.


		 ![](../../../Sub_Image.gif)
		 [beginUpdate](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.beginUpdate.htm)
		 Метод beginUpdate отключает
		 перерисовку компонента, используемого для отображения объектов.


		 ![](../../../Sub_Image.gif)
		 [clear](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.clear.htm)
		 Метод clear очищает
		 список от всех объектов.


		 ![](../../../Sub_Image.gif)
		 [deleteObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.deleteObject.htm)
		 Метод addObject удаляет
		 объект из списка отображения.


		 ![](../../../Sub_Image.gif)
		 [editObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.editObject.htm)
		 Метод editObject включает
		 режим редактирования для объекта.


		 ![](../../../Sub_Image.gif)
		 [endUpdate](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.endUpdate.htm)
		 Метод endUpdate включает
		 обратно перерисовку компонента, используемого для отображения
		 объектов.


		 ![](../../../Sub_Image.gif)
		 [getAllNodesLoaded](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.getAllNodesLoaded.htm)
		 Метод getAllNodesLoaded
		 возвращает признак загрузки всех вершин.


		 ![](../../../Sub_Image.gif)
		 [getCustomClassObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.getCustomClassObject.htm)
		 Метод getCustomClassObject
		 возвращает пользовательский класс объекта.


		 ![](../../../Sub_Image.gif)
		 [getFocusedObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.getFocusedObject.htm)
		 Метод getFocusedObject
		 возвращает сфокусированный объект репозитория.


		 ![](../../../Sub_Image.gif)
		 [getImageList](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.getImageList.htm)
		 Метод getImageList
		 возвращает объект спрайта.


		 ![](../../../Sub_Image.gif)
		 [getObjects](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.getObjects.htm)
		 Метод getObjects возвращает
		 все объекты репозитория.


		 ![](../../../Sub_Image.gif)
		 [getSelectedObjects](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.getSelectedObjects.htm)
		 Метод getSelectedObjects
		 возвращает выделенные объекты репозитория.


		 ![](../../../Sub_Image.gif)
		 [loadFrom](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.loadFrom.htm)
		 Метод loadFrom очищает
		 компонент и загружает только указанные объекты.


		 ![](../../../Sub_Image.gif)
		 [refresh](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.refresh.htm)
		 Метод refresh обновляет
		 состояние указанного объекта в компоненте.


		 ![](../../../Sub_Image.gif)
		 [refreshAll](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.refreshAll.htm)
		 Метод refreshAll обновляет
		 состояние всех объектов в компоненте.


		 ![](../../../Sub_Image.gif)
		 [removeFocus](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsView/MetabaseObjectsView.removeFocus.htm)
