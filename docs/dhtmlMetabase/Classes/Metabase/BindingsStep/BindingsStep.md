...
Класс BindingsStep реализует страницу [мастера импорта данных](../ImportDataWizard/ImportDataWizard.htm) для установки соответствия.


## Комментарии


Страница для установки соответствия - это третий шаг [мастера импорта данных](../ImportDataWizard/ImportDataWizard.htm):


![](BindingStep.gif)


При нажатии на кнопку «Дополнительно» открывается диалог - экземпляр класса [RepositoryDialog](../RepositoryDialog/RepositoryDialog.htm).


## Синтаксис


PP.initClass(PP.Mb.Ui.BindingsStep, PP.Ui.[WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm), "BindingsStep");
