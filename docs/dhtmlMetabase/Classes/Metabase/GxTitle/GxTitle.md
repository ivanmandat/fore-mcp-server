...
Класс GxTitle реализует заголовок
 экспресс-отчета.
...
PP.initClass(PP.Mb.Ui.GxTitle, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "GxTitle", [PP.Mb.Ui.IGxTitle, PP.Mb.Ui.IGxTitleOptions]);
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [GxTitle](dhtmlMetabase.chm::/Classes/Metabase/GxTitle/Constructor_GxTitle.htm)
			 Конструктор GxTitle
			 создает экземпляр класса GxTitle.
