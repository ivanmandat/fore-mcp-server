...
Класс SearchResultBox является
 базовым для контейнеров с результатами поиска.


## Комментарии


Является базовым для класса [BISearchResultBox](../BISearchResultBox/BISearchResultBox.htm).


## Синтаксис


PP.initClass(PP.Mb.Ui.SearchResultBox, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "SearchResultBox");
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [ResultItemClick](SearchResultBox.ResultItemClick.htm)
		 Событие ResultItemClick
		 происходит при нажатии на найденный элемент.


		 ![](../../../Event_Image.gif)
		 [SearchFailed](SearchResultBox.SearchFailed.htm)
		 Событие SearchFailed
		 происходит при неудачном поиске.


		 ![](../../../Event_Image.gif)
		 [SearchSucceed](SearchResultBox.SearchSucceed.htm)
