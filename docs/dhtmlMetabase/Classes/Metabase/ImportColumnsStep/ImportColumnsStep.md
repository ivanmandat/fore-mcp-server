...
Класс ImportColumnsStep реализует страницу [мастера импорта данных](../ImportDataWizard/ImportDataWizard.htm) для выбора импортируемых колонок.


## Комментарии


Страница для выбора импортируемых колонок - это первый шаг [мастера импорта данных](../ImportDataWizard/ImportDataWizard.htm):


![](../SetValueColumnsStep/SetValueColumnStep.gif)


## Синтаксис


PP.initClass(PP.Mb.Ui.ImportColumnsStep, PP.Ui.[WizardStep](dhtmlUi.chm::/Classes/WizardStep/WizardStep.htm), "ImportColumnsStep");
