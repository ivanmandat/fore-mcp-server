...
[MetabaseObjectsView](../MetabaseObjectsView/MetabaseObjectsView.htm)
...
Класс MetabaseObjectsListView
 реализует компонент [MetabaseObjectsListView](../../../Components/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.htm),
 который представляет собой контейнер для отображения [списка объектов](GetStarted.chm::/Interface/Interface_Navigator.htm)
 выбранной папки в окне навигации репозитория.


## Комментарии


Каждый элемент контейнера является ссылкой на соответствующий объект
 репозитория.
...
PP.initClass(PP.Mb.Ui.MetabaseObjectsListView, [PP.Mb.Ui.MetabaseObjectsView](../MetabaseObjectsView/MetabaseObjectsView.htm),
 "MetabaseObjectsListView");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [MetabaseObjectsListView](Constructor_MetabaseObjectsListView.htm)
			 Конструктор MetabaseObjectsListView
			 создает экземпляр класса MetabaseObjectsListView.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [addObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.addObject.htm)
		 Метод addObject добавляет
		 объект репозитория в компонент.


		 ![](../../../Sub_Image.gif)
		 [adjustColumnsWidthByContent](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.adjustColumnsWidthByContent.htm)
		 ...
		 ![](../../../Sub_Image.gif)
		 [clear](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.clear.htm)
		 Метод clear очищает
		 список от всех объектов.


		 ![](../../../Sub_Image.gif)
		 [deleteObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.deleteObject.htm)
		 Метод deleteObject
		 удаляет объект из списка отображения.


		 ![](../../../Sub_Image.gif)
		 [deSelectAll](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.deSelectAll.htm)
		 Метод deSelectAll снимает
		 выделение со всех элементов контейнера.


		 ![](../../../Sub_Image.gif)
		 [invertSelection](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.invertSelection.htm)

		 Метод invertSelection
		 инвертирует отметку элементов контейнера.


		 ![](../../../Sub_Image.gif)
		 [editObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.editObject.htm)
		 Метод editObject включает
		 режим редактирования для объекта.


		 ![](../../../Sub_Image.gif)
		 [getClassName](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.getClassName.htm)
		 Метод getClassName
		 возвращает наименование класса объекта репозитория.


		 ![](../../../Sub_Image.gif)
		 [getFocusedObject](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.getFocusedObject.htm)
		 Метод getFocusedObject
		 возвращает сфокусированный объект репозитория.


		 ![](../../../Sub_Image.gif)
		 [getObjects](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.getObjects.htm)
		 Метод getObjects возвращает
		 все объекты репозитория.


		 ![](../../../Sub_Image.gif)
		 [getSelectedKeys](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.getSelectedKeys.htm)
		 Метод getSelectedKeys возвращает
		 массив ключей выделенных объектов.


		 ![](../../../Sub_Image.gif)
		 [getSelectedObjects](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.getSelectedObjects.htm)
		 Метод getSelectedObjects
		 возвращает выделенные объекты репозитория.


		 ![](../../../Sub_Image.gif)
		 [loadFrom](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.loadFrom.htm)
		 Метод loadFrom очищает
		 компонент и загружает только указанные объекты.


		 ![](../../../Sub_Image.gif)
		 [removeFocus](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.removeFocus.htm)
		 Метод removeFocus убирает
		 текущий фокус.


		 ![](../../../Sub_Image.gif)
		 [selectAll](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.selectAll.htm)
		 Метод selectAll выделяет
		 все элементы контейнера.


		 ![](../../../Sub_Image.gif)
		 [setFocused](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.setFocused.htm)
		 Метод setFocused
		 устанавливает фокус на объект с указанным ключом.


		 ![](../../../Sub_Image.gif)
		 [setSelectedKeys](dhtmlMetabase.chm::/Classes/Metabase/MetabaseObjectsListView/MetabaseObjectsListView.setSelectedKeys.htm)
