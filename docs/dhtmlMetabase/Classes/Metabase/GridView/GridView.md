...
Класс GridView представляет
 собой базовый класс, предназначенный для отображения таблицы.


## Комментарии


Таблица, реализующая класс GridView
...
Данный класс является базовым для следующих классов:


	- [PP.Exp.Ui.EaxGridView](dhtmlExpress.chm::/Classes/Express/EaxGridView/EaxGridView.htm);


	- [PP.Prx.Ui.GridView](dhtmlReport.chm::/Classes/RegularReport/GridView/GridView.htm).


## Синтаксис


PP.initClass(PP.Mb.Ui.GridView, [[PP.Ui.SourceView](dhtmlUi.chm::/Classes/SourceView/SourceView.htm),
 PP.Ui.BaseMView], "GridView", [PP.Mb.Ui.IGridView]);
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 [GridView](dhtmlMetabase.chm::/Classes/Metabase/GridView/Constructor_GridView.htm)
		 Конструктор GridView
		 создаёт экземпляр класса GridView.
