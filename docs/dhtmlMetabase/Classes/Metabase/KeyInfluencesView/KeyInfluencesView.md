...
Класс KeyInfluencesView реализует
 представление диалога «Ключевые факторы».
...
PP.initClass(PP.Mb.Ui.KeyInfluencesView, PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Mb.Ui.KeyInfluencesView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getStepData](KeyInfluencesView.getStepData.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [StepCompleted](KeyInfluencesView.StepCompleted.htm)
