...
Класс Navigator реализует навигатор
 объектов репозитория платформы.


## Синтаксис


PP.initClass(PP.Mb.Ui.Navigator, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "Navigator");
