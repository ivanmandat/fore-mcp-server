...
Класс MetaHierarchyTree реализует
 компонент для отображения объекта [MetaHierarchy](../MetaHierarchy/MetaHierarchy.htm).


## Синтаксис


PP.initClass(PP.Mb.Ui.MetaHierarchyTree, PP.Mb.Ui.HieTreeView,
 "MetaHierarchyTree", PP.Mb.Ui.IHieTreeView);


## Свойства, унаследованные от класса HieTreeView (аналогичен классу PP.TS.Ui.HieTreeView)
...
## Методы, унаследованные от класса HieTreeView (аналогичен классу PP.TS.Ui.HieTreeView)
...
## События, унаследованные от класса HieTreeView (аналогичен классу PP.TS.Ui.HieTreeView)
