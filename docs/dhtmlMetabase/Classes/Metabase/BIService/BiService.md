...
Класс BiService предназначен
 для работы с сервисами BI компонентов продукта «Форсайт. Аналитическая платформа».


## Комментарии


BiService - это объект в рамках
...
PP.initClass(PP.Mb.BiService, PP.Mb.[PPService](../PPService/PPService.htm),
 "BiService");
