...
[SearchResultBox](../SearchResultBox/SearchResultBox.htm)
...
Класс BISearchResultBox является
 контейнером с результатами BI-поиска.


## Комментарии


Класс используется в экспресс-отчете для BI-поиска при выборе источника
 данных.
...
PP.initClass(PP.Mb.Ui.BISearchResultBox, PP.Mb.Ui.[SearchResultBox](../SearchResultBox/SearchResultBox.htm),
 "BISearchResultBox");
...
## Конструктор
		 ...
		 создает экземпляр компонента BISearchResultBox.
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [formatData](BISearchResultBox.formatData.htm)
		 Метод formatData форматирует
		 полученные объекты поиска для отображения в компоненте.


		 ![](../../../Sub_Image.gif)
		 [search](BISearchResultBox.search.htm)
		 Метод search производит
		 поиск по данным репозитория.


		 ![](../../../Sub_Image.gif)
		 [searchNext](BISearchResultBox.searchNext.htm)
		 Метод searchNext повторяет
		 поиск, выводя следующие найденные элементы.


## События, унаследованные от класса [SearchResultBox](../SearchResultBox/SearchResultBox.htm)
		 ...
		 ![](../../../Event_Image.gif)
		 [ResultItemClick](../SearchResultBox/SearchResultBox.ResultItemClick.htm)
		 Событие ResultItemClick
		 происходит при нажатии на найденный элемент.


		 ![](../../../Event_Image.gif)
		 [SearchFailed](../SearchResultBox/SearchResultBox.SearchFailed.htm)
		 Событие SearchFailed
		 происходит при неудачном поиске.


		 ![](../../../Event_Image.gif)
		 [SearchSucceed](../SearchResultBox/SearchResultBox.SearchSucceed.htm)
		 Событие SearchSucceed
		 происходит при удачном поиске.
