...
Класс AssociationRulesView реализует
 представление диалога «Анализ ассоциаций».
...
PP.initClass(PP.Mb.Ui.AssociationRulesView, PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Mb.Ui.AssociationRulesView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getStepData](AssociationRulesView.getStepData.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [StepCompleted](AssociationRulesView.StepCompleted.htm)
