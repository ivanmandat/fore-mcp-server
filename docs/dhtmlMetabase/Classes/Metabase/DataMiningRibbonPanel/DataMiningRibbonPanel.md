...
[RibbonPanel](dhtmlRibbon.chm::/Classes/RibbonPanel/ribbonpanel.htm)
...
Класс DataMiningRibbonPanel
 реализует панель «Интеллектуальный анализ
...
PP.initClass(PP.Ui.DataMiningRibbonPanel, PP.Ui.[RibbonPanel](dhtmlRibbon.chm::/Classes/RibbonPanel/ribbonpanel.htm),
 "DataMiningRibbonPanel");
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [Source](DataMiningRibbonPanel.Source.htm)
		 Свойство Source определяет
		 источник анализа данных.
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [OnGetDataMiningResult](DataMiningRibbonPanel.OnGetDataMiningResult.htm)
		 Событие OnGetDataMiningResult
		 наступает при получении результата анализа данных.


## Свойства, унаследованные от класса [RibbonPanel](dhtmlRibbon.chm::/Classes/RibbonPanel/ribbonpanel.htm)
...
## Методы, унаследованные от класса [RibbonPanel](dhtmlRibbon.chm::/Classes/RibbonPanel/ribbonpanel.htm)
