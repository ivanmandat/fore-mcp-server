...
Класс CubeImport реализует модель
 объекта импорта данных.


## Синтаксис


PP.initClass(PP.Mb.CubeImport, PP.Mb.[Object](../Object/Object.htm),
 "CubeImport");
...
## Конструктор
		 ...
		 ![](../../../Sub_Image.gif)
		 CubeImport
		 Конструктор CubeImport
		 создает экземпляр класса CubeImport.
		 Используется для внутренней реализации компонента [ImportDataWizard](../../../Components/Metabase/ImportDataWizard/ImportDataWizard.htm).
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [FileName](CubeImport.FileName.htm)
		 Свойство FileName
		 определяет имя файла, который используется для импорта данных
		 в куб.
