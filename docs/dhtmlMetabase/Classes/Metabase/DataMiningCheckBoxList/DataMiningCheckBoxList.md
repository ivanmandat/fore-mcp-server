...
Класс DataMiningCheckBoxList
 реализует список с флажками и кнопками «Отметить
 все» и «Сбросить
 отметку».
...
Класс является внутренним, его нельзя получить другими методами. Класс
 реализован во внутреннем свойстве _chkList
 в объектах представлений метода интеллектуального анализа данных, например
 [KeyInfluencesView](../KeyInfluencesView/KeyInfluencesView.htm).
...
PP.initClass(PP.Mb.Ui.DataMiningCheckBoxList, PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Mb.Ui.DataMiningCheckBoxList");
