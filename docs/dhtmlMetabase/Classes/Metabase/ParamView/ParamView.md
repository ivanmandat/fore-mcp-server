...
Класс ParamView реализует элемент управления параметром отчета.


## Синтаксис


PP.initClass(PP.Mb.Ui.ParamView, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm), "PP.Mb.Ui.ParamView");
...
## Конструктор
 ...
 ![](../../../Sub_Image.gif)
 [ParamView](Constructor_ParamView.htm)
 Конструктор ParamView создает экземпляр класса ParamView.
