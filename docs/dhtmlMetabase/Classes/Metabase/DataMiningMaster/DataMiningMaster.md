...
Класс DataMiningMaster реализует
 мастер «Интелектуального анализа данных».


## Комментарии


Внешний вид мастера зависит от выбранного метода и может выглядеть следующим
 образом:


![](../AssociationRulesView/AssRulesView.png)


## Синтаксис


PP.initClass(PP.Mb.Ui.DataMiningMaster, PP.Ui.[Wizard](dhtmlUi.chm::/Classes/Wizard/Wizard.htm),
 "PP.Mb.Ui.DataMiningMaster");
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [OnGetDataMiningResult](DataMiningMaster.OnGetDataMiningResult.htm)
