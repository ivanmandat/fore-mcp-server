...
Класс MetabaseObjectsIconView
 реализует компонент [MetabaseObjectsIconView](../../../Components/Metabase/MetabaseObjectsIconView/MetabaseObjectsIconView.htm),
 который представляет собой контейнер для отображения списка объектов репозитория
 в виде пиктограмм.
...
PP.initClass(PP.Mb.Ui.MetabaseObjectsIconView, [PP.Mb.Ui.MetabaseObjectsView](../MetabaseObjectsView/MetabaseObjectsView.htm),
 "MetabaseObjectsIconView");
...
## Конструктор
			 ...
			 ![](../../../Sub_Image.gif)
			 [MetabaseObjectsIconView](Constructor_MetabaseObjectsIconView.htm)
...
## Свойства
		 ...
		 ![](../../../Property_Image.gif)
		 [IconType](MetabaseObjectsIconView.IconType.htm)
		 Свойство IconType определяет
		 вариант отображения списка объектов.


		 ![](../../../Property_Image.gif)
		 [ItemHeight](MetabaseObjectsIconView.ItemHeight.htm)
		 Свойство ItemHeight
		 определяет высоту объектов.


		 ![](../../../Property_Image.gif)
		 [ItemWidth](MetabaseObjectsIconView.ItemWidth.htm)
		 Свойство ItemWidth
		 определяет ширину объектов.


		 ![](../../../Property_Image.gif)
		 [Orientation](MetabaseObjectsIconView.Orientation.htm)
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [deSelectAll](MetabaseObjectsIconView.deSelectAll.htm)
		 Метод deSelectAll снимает
		 выделение со всех элементов контейнера.


		 ![](../../../Sub_Image.gif)
		 [getItems](MetabaseObjectsIconView.getItems.htm)
		 Метод getItems возвращает
		 массив всех объектов списка.


		 ![](../../../Sub_Image.gif)
		 [invertSelection](MetabaseObjectsIconView.invertSelection.htm)
		 Метод invertSelection
		 инвертирует отметку элементов контейнера.


		 ![](../../../Sub_Image.gif)
		 [selectAll](MetabaseObjectsIconView.selectAll.htm)
