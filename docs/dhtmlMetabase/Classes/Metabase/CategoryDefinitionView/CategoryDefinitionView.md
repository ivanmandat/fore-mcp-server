...
Класс CategoryDefinitionView
 реализует представление диалога «Кластеризация».
...
PP.initClass(PP.Mb.Ui.CategoryDefinitionView, PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Mb.Ui.CategoryDefinitionView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getStepData](CategoryDefinitionView.getStepData.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [StepCompleted](CategoryDefinitionView.StepCompleted.htm)
