...
[MetabaseDialogBase](../../../Navigator/MetabaseDialogBase/MetabaseDialogBase.htm)
...
Класс **MetabaseOpenDialog**
 реализует [диалог
 открытия объекта из репозитория](../../../../Components/Metabase/Dialogs/MetabaseOpenDialog/MetabaseOpenDialog.htm).


## Синтаксис


PP.initClass(PP.Ui.MetabaseOpenDialog,  [PP.Navigator.MetabaseDialogBase](../../../Navigator/MetabaseDialogBase/MetabaseDialogBase.htm),
 "PP.Ui.MetabaseOpenDialog");
...
## Конструктор
				 ...
				 ![](../../../../Sub_Image.gif)
				 [MetabaseOpenDialog](dhtmlMetabase.chm::/Classes/Navigator/MetabaseOpenDialog/Constructor_MetabaseOpenDialog.htm)
...
## Свойства, унаследованные от класса [MetabaseDialogBase](../../../Navigator/MetabaseDialogBase/MetabaseDialogBase.htm)
...
## Методы, унаследованные от класса [MetabaseDialogBase](../../../Navigator/MetabaseDialogBase/MetabaseDialogBase.htm)
