...
Класс ServiceUnavailableDialog
 реализует компонент [ServiceUnavailableDialog](../../../../Components/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.htm),
 представляющий собой диалог, в котором отображается статус состояния связи
 с сервером при разрыве соединения.
...
PP.initClass(PP.Mb.Ui.ServiceUnavailableDialog,
 PP.Ui.Dialog, "PP.Mb.Ui.ServiceUnavailableDialog");
...
## Конструктор
			 ...
			 ![](../../../../Sub_Image.gif)
			 [ServiceUnavailableDialog](ServiceUnavailableDialog_constructor.htm)
			 Конструктор ServiceUnavailableDialog
			 создает экземпляр компонента [ServiceUnavailableDialog](../../../../Components/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.htm).
...
## Методы
		 ...
		 ![](../../../../Sub_Image.gif)
		 [hideWithNotice](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.hideWithNotice.htm)
		 Метод hideWithNotice
		 скрывает диалог с сообщением о восстановлении соединения с сервером.


		 ![](../../../../Sub_Image.gif)
		 [showConnectionChecking](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.showConnectionChecking.htm)
		 Метод showConnectionChecking
		 отображает диалог с сообщением о проверке соединения с сервером.


		 ![](../../../../Sub_Image.gif)
		 [showConnectionNotRestored](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.showConnectionNotRestored.htm)
		 Метод showConnectionNotRestored
		 отображает диалог с сообщением о неуспешном восстановлении соединения
		 с сервером.
...
## События
		 ...
		 ![](../../../../Event_Image.gif)
		 [CheckConnectionClick](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.CheckConnectionClick.htm)
		 Событие CheckConnectionClick
		 наступает при нажатии на кнопку «[Проверить соединение](dhtmlMetabase.chm::/Components/Metabase/Dialogs/ServiceUnavailableDialog/ServiceUnavailableDialog.htm)».
