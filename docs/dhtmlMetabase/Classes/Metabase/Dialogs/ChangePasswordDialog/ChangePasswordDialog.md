...
Класс ChangePasswordDialog реализует
 [диалог
 для смены пароля](../../../../Components/Metabase/Dialogs/ChangePasswordDialog/ChangePasswordDialog.htm).
...
Диалог для смены вызывается из меню «Сервис» на [ленте
 навигатора объектов](../../../../Components/Metabase/NavigatorRibbon/NavigatorRibbon.htm): Сервис >
 Сменить пароль...
...
PP.initClass(PP.Ui.ChangePasswordDialog, PP.Ui.[Dialog](dhtmlUi.chm::/Classes/Dialog/Dialog.htm),
 "ChangePasswordDialog");
