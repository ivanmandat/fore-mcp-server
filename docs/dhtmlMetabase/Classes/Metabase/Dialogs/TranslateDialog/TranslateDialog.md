...
Класс TranslateDialog реализует
 компонент [TranslateDialog](../../../../Components/Metabase/Dialogs/TranslateDialog/TranslateDialog.htm),
 представляющий собой диалог для сохранения объекта с именами на разных
 языках.
...
PP.initClass(PP.Mb.Ui.TranslateDialog, PP.Ui.Dialog,
 "PP.Mb.Ui.TranslateDialog");
...
## Конструктор
		 ...
		 ![](../../../../Sub_Image.gif)
		 [TranslateDialog](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog_constructor.htm)
		 Конструктор TranslateDialog
		 создает экземпляр компонента TranslateDialog.
...
## Свойства
		 ...
		 ![](../../../../Property_Image.gif)
		 [AdditionalLanguages](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.AdditionalLanguages.htm)
		 Свойство AdditionalLanguages
		 устанавливает массив кодов языков, которые будут отображаться
		 при нажатии на кнопку «Еще язык».


		 ![](../../../../Property_Image.gif)
		 [CurrentLanguage](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.CurrentLanguage.htm)
		 Свойство CurrentLanguage
		 определяет текущий язык.


		 ![](../../../../Property_Image.gif)
		 [DefaultLanguage](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.DefaultLanguage.htm)
		 Свойство DefaultLanguage
		 определяет язык по умолчанию.


		 ![](../../../../Property_Image.gif)
		 [DisplayLanguages](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.DisplayLanguages.htm)
		 Свойство DisplayLanguages
		 устанавливает массив кодов языков, которые будут
		 отображаться в диалоге «Переводы».


		 ![](../../../../Property_Image.gif)
		 [Mode](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.Mode.htm)
		 Свойство Mode устанавливает
		 режим отображения строк ввода для перевода.


		 ![](../../../../Property_Image.gif)
		 [ShowLanguagesButton](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.ShowLanguagesButton.htm)
		 Свойство ShowLanguagesButton
		 определяет, будет ли доступна кнопка «Еще язык» для выбора дополнительных
		 языков.


		 ![](../../../../Property_Image.gif)
		 [Translations](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.Translations.htm)
		 Свойство Translations устанавливает
		 переводы для указанных языков.
...
## Методы
		 ...
		 ![](../../../../Sub_Image.gif)
		 [beginUpdate](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.beginUpdate.htm)
		 Метод beginUpdate начинает
		 обновление компонента.


		 ![](../../../../Sub_Image.gif)
		 [endUpdate](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.endUpdate.htm)
		 Метод endUpdate завершает обновление компонента.


		 ![](../../../../Sub_Image.gif)
		 [getAllLanguages](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.getAllLanguages.htm)
		 Метод getAllLanguages
		 возвращает массив [кодов
		 всех языков](http://msdn.microsoft.com/en-us/goglobal/bb964664.aspx), доступных в диалоге, в том числе [дополнительных](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.AdditionalLanguages.htm).


		 ![](../../../../Sub_Image.gif)
		 [update](dhtmlMetabase.chm::/Classes/Metabase/Dialogs/TranslateDialog/TranslateDialog.update.htm)
