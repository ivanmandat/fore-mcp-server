...
Класс SearchDialog реализует
 компонент [SearchDialog](../../../../Components/Metabase/Dialogs/SearchDialog/SearchDialog.htm),
 представляющий собой диалог поиска.


## Синтаксис


PP.initClass(PP.Ui.SearchDialog, PP.Ui.Dialog, "PP.Ui.SearchDialog");
