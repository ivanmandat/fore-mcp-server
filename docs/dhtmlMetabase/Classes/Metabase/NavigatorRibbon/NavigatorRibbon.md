...
Класс NavigatorRibbon реализует ленту инструментов [навигатора](../Navigator/Navigator.htm).


## Синтаксис


PP.initClass(PP.Mb.Ui.NavigatorRibbon, PP.Ui.[ProxyControl](dhtmlUi.chm::/Classes/ProxyControl/ProxyControl.htm), "NavigatorRibbon");
