...
Класс DataMiningService реализует
 работу с сервисами интеллектуального анализа данных.


## Комментарии


Пример использования сервиса приведен на странице «[Пример
...
PP.initClass(PP.Mb.DataMiningService, PP.Mb.[PPService](../PPService/PPService.htm)
 "DataMiningService");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [createObject](DataMiningService.createObject.htm)
		 Метод createObject
		 отправляет на сервер запрос о создании объекта, содержащего результаты
		 интеллектуального анализа данных.


		 ![](../../../Sub_Image.gif)
		 [getDataMining](DataMiningService.getDataMining.htm)
		 Метод getDataMining
		 отправляет на сервер запрос о расчете анализа данных.


		 ![](../../../Sub_Image.gif)
		 [getDataSourceFields](DataMiningService.getDataSourceFields.htm)
		 Метод getDataSourceFields
		 отправляет на сервер запрос о заголовках, используемых в интеллектуальном
		 анализе данных.
