...
Класс FillByTemplView реализует
 представление диалога «Заполнение по
 шаблону».
...
PP.initClass(PP.Mb.Ui.FillByTemplView, PP.Ui.[Panel](dhtmlUi.chm::/Classes/Panel/Panel.htm),
 "PP.Mb.Ui.FillByTemplView");
...
## Методы
		 ...
		 ![](../../../Sub_Image.gif)
		 [getStepData](FillByTemplView.getStepData.htm)
...
## События
		 ...
		 ![](../../../Event_Image.gif)
		 [StepCompleted](FillByTemplView.StepCompleted.htm)
