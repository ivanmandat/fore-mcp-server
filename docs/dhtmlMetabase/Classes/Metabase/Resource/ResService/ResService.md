...
[PP.Mb.PPService](../../PPService/PPService.htm)
...
Класс ResService используется
 для работы со строковыми ресурсами.


## Синтаксис


PP.initClass(PP.Mb.ResService, [[PP.Mb.PPService](../../PPService/PPService.htm),
 PP.Mb.PPSrvMixin], "PP.Mb.ResService");
...
## Методы
		 ...
		 ![](../../../../Property_Image.gif)
		 [Resource](ResService.Resource.htm)
		 Свойство Resource определяет
		 объект для работы со строковыми ресурсами в различных локализациях.
