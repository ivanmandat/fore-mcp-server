...
openFromRubOdId(rubOdId: String, rubKey: Number,
 wbk: [PP.TS.WbkDocument](dhtmlTS.chm::/Classes/TimeSeries/WbkDocument/WbkDocument.htm),
...
Метод возвращает объект типа [PP.Mb.MetaHierarchy](../MetaHierarchy/MetaHierarchy.htm).
...
Для выполнения примера необходимо наличие на html-странице компонента
 ...
 создания компонента WorkbookBox](dhtmlTS.chm::/Components/TimeSeries/WorkbookBox/Component_WorkbookBox.htm)»). Получим наименования
