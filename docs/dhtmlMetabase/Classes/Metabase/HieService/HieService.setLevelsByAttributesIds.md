...
attributesIds. Задает
 массив с идентификаторами метаатрибутов;
...
После выполнения примера на html-странице будет размещена кнопка с наименованием
 «Установить уровни». По нажатию на кнопку будут установлены уровни дерева
 в соответствии с порядком метаатрибутов.
