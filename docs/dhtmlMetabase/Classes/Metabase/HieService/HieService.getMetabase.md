...
Метод
 getMetabase возвращает экземпляр метабазы.
...
PP.Mb.Metabase {_Events: Object, Closed: PP.Delegate,
 Refreshed: PP.Delegate, Opened: PP.Delegate, FindObjectsLoaded: PP.Delegate…}
