...
Класс Object - базовый
 класс для открытых объектов репозитория.


## Синтаксис


PP.initClass(PP.Mb.Object, [PP.Mb.Descriptor](../Descriptor/Descriptor.htm),
 "Object");
...
Примечание.
 Свойства можно использовать в качестве методов set/get. Доступные методы
 указаны в описании конкретного свойства.
...
## Свойства, унаследованные от класса [Descriptor](../Descriptor/Descriptor.htm)
...
## Методы, унаследованные от класса [Descriptor](../Descriptor/Descriptor.htm)
