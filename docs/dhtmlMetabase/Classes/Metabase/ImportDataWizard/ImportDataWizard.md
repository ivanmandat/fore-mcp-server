...
[Wizard](dhtmlUi.chm::/Classes/Wizard/Wizard.htm)
...
Класс ImportDataWizard реализует
 [мастер
 для импорта данных](../../../Components/Metabase/ImportDataWizard/ImportDataWizard.htm).


## Комментарии


Шаги мастера реализованы классами [BindingsStep](../BindingsStep/BindingsStep.htm),
 [ImportColumnsStep](../ImportColumnsStep/ImportColumnsStep.htm)
 и [SetValueColumnsStep](../SetValueColumnsStep/SetValueColumnsStep.htm).


## Синтаксис


PP.initClass(PP.Mb.Ui.ImportDataWizard, PP.Ui.Wizard,
 "ImportDataWizard");
