# TableStyleSetup: Плагин Express
...
При нажатии на кнопку будет выведен стандартный диалог настройки стиля,
 используемого для оформления области данных таблицы для экспресс-отчета
