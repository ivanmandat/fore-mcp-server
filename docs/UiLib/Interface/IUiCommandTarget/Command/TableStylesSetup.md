...
При нажатии на кнопку будет выведен диалог настройки стилей для активного
 листа регламентного отчета, подключенного в «UiReport1». Если в регламентном
 отчете подключен какой-либо набор стилей репозитория, то стили данного
 набора будут доступны при настройке.
