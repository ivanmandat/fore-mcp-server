...
Вызов стандартного диалога настройки итогов.
...
Для выполнения примера предполагается наличие формы, расположенной на
 ...
 "UiErAnalyzer1", являющегося источником данных для TabSheetBox.
	...
	    Target.Execute("ParetoSetup", Context);

	End Sub Button1OnClick;


При нажатии на кнопку будет выведен стандартный диалог настройки анализа
 "80/20" для экспресс-отчета установленного в UiErAnalyzer1.
