...
Класс MapBox реализует компонент
 среды разработки [MapBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MapBox.htm),
 используемый для отображения карт.


## Свойства объекта класса, унаследованные от [IMapBox](../../Interface/IMapBox/IMapBox.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](../../Interface/IMapBox/IMapBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Source](../../Interface/IMapBox/IMapBox.Source.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [OnTerritoryClick](MapBox.OnTerritoryClick.htm)
