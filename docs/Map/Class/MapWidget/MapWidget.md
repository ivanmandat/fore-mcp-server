...
Класс MapWidget используется
 для работы с компонентом MapWidget.


## Комментарии


Для активации компонента MapWidget
 вручную установите в инспекторе объектов среды разработки свойству Active значение True.


## Свойства объекта класса, унаследованные от [IMapWidget](../../Interface/IMapWidget/IMapWidget.htm)
		 ...
		 ![](../../Property_Image.gif)
		 [Source](../../Interface/IMapWidget/IMapWidget.Source.htm)
		 Свойство Source определяет
		 источник данных для виджета карты.


## Свойства объекта класса, унаследованные от [IWidget](ModForms.chm::/Interface/IWidget/IWidget.htm)
		 ...
		 компонент, который будет использоваться для визуального отображения
		 вкладок.
		 ...
		 коллекцию вкладок, доступную для указанного источника.
