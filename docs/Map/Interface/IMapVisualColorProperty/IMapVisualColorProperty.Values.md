# IMapVisualColorProperty.Values
...
Values: [IMapColorCollection](../IMapColorCollection/IMapColorCollection.htm);


## Описание


Свойство Values определяет цвета
 заливки.
...
![](IMapVisualColorProperty_Values.gif)
