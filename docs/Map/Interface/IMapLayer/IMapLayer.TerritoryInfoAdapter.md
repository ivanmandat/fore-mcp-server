...
Свойство TerritoryInfoAdapter определяет источник данных для расшифровки территорий.


## Комментарии


В зависимости от необходимого содержания расшифровки, данное свойство должно быть приведено к одному из интерфейсов:


	- [IMapDataAdapter](../IMapDataAdapter/IMapDataAdapter.htm).
	 Возвращаемые значения будут устанавливать только идентификатор территории
	 в расшифровке;


	- [IMapDynamicDataAdapter](../IMapDynamicDataAdapter/IMapDynamicDataAdapter.htm).
	 Возвращаемые значения будут устанавливать идентификатор и наименование
	 территории в расшифровке.
...
После выполнения примера будет определен источник данных для расшифровки
 территорий. Элементы расшифровки будут выведены в окно консоли.
