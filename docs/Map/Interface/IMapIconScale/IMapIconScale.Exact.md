...
Exact(Index: Integer): [IGxImage](ModDrawing.chm::/Interface/IGxImage/IGxImage.htm);
...
Свойство Exact определяет пиктограмму
...
Добавьте ссылки на системные сборки: Drawing, ExtCtrls, Forms, Map.
	...
	    Scale.Exact(0) := GxImage.FromFile("C:\Exact.gif");
