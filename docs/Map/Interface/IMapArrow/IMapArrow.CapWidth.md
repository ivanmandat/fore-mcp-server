...
Свойство CapWidth определяет
 ширину указателя стрелки.


## Комментарии


Ширина указателя определяется как доля от длины отрезка между точками
...
После выполнения примера будет создана стрелка с заданной шириной указателя:


![](IMapArrow_CapWidth.gif)
