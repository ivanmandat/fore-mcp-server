...
Свойство TailWidth определяет
 ширину основания стрелки.


## Комментарии


Ширина основания определяется как доля от длины отрезка между точками
...
Примечание.
 ...
 имеет значение [MapArrowShap.Tailed](../../Enums/MapArrowShape.htm).
...
После выполнения примера будет создана стрелка с заданной шириной основания
 стрелки:


![](IMapArrow_TailWidth.gif)
