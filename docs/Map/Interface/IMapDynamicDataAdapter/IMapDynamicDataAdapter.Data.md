...
Data(Attribute: Variant; PartIndex: Integer): Variant;
...
Attribute.
 Параметр определяет, какие данные должен возвращать адаптер;


PartIndex.
 Индекс области данных.
