...
Fill(Index: Integer; Impact: [MapScaleSettingImpact](../../Enums/MapScaleSettingImpact.htm)):
 [GxHatchStyle](ModDrawing.chm::/Enums/GxHatchStyle.htm);
...
Свойство Fill определяет тип
 штриховки для заданного значения деления шкалы.
