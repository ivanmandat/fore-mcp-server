...
AddBarVisual: [IMapBarVisual](../IMapBarVisual/IMapBarVisual.htm);


## Описание


Метод AddBarVisual добавляет столбиковый показатель в коллекцию.
...
![](../IMapVisualFillProperty/IMapVisualFillProperty_Value.gif)
