# IMapLayerVisuals.AddAreaVisual
...
AddAreaVisual: [IMapAreaVisual](../IMapAreaVisual/IMapAreaVisual.htm);


## Описание


Метод AddAreaVisual добавляет картографический показатель в коллекцию.
...
После выполнения примера на слой «Regions» будет добавлен картографический
 показатель, заливка которого будет определяться цветовой шкалой:
