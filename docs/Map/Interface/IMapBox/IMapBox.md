...
Интерфейс IMapBox содержит свойства
 и методы компонента среды разработки - [MapBox](UiDevEnv.chm::/02_Components_constructor_forms/03_Components_of_the_access_to_data/MapBox.htm).
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [BorderStyle](IMapBox.BorderStyle.htm)
		 Свойство BorderStyle
		 определяет стиль границы компонента.


		 ![](../../Property_Image.gif)
		 [Source](IMapBox.Source.htm)
...
[Интерфейсы сборки Map](../Interface_build_Map.htm)
