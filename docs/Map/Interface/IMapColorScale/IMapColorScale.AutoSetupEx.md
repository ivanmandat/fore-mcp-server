...
Метод AutoSetupEx производит
 автонастройку цветовой шкалы: применяет градиентную заливку и производит
 расчет значений ([Value](../IMapScale/IMapScale.Value.htm))
 для делений шкалы.
...
В рассматриваемом примере предполагается существование объекта Report типа IPrxReport.
 ...
 создан картографичекий показатель.
