...
Fill: [IMapVisualFillProperty](../IMapVisualFillProperty/IMapVisualFillProperty.htm);


## Описание


Свойство Fill возвращает параметры
...
Добавьте ссылки на системные сборки:
 Drawing, ExtCtrls, Forms, Map.
	...
	    Fill.Value := GxHatchStyle.LightDownwardDiagonal;

	    Color := PieVisual.FillColor;
...
После выполнения примера на слой «Regions» будет добавлен круговой показатель,
 для штриховки которого будут использованы красный и синий цвета:


![](IMapPieVisual_Fill.gif)
