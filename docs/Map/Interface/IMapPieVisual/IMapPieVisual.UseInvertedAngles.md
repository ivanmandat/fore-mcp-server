# IMapPieVisual.UseInvertedAngles
...
Свойство UseInvertedAngles определяет,
 будут ли углы показателя отображаться в обратную сторону.
...
Допустимые значения:
	...
	- True. Углы показателя
	 будут отображаться в обратную сторону (изображение слева);


	- False. Направление углов
	 показателя не будет изменено (изображение справа).


![](IMapPieVisual_UseInvertedAngles.gif)
...
Добавьте ссылки на системные сборки: Drawing, ExtCtrls, Forms, Map.
	...
	    PieVisual.UseInvertedAngles:= True;

	End Sub Button1OnClick;


После выполнения примера на слой «Regions» будет добавлен круговой показатель,
 для штриховки которого будут использованы красный и синий цвета. Углы
 показателя будут отображаться в обратную сторону.
