...
ImageOriginOffset: [IGxPointF](ModDrawing.chm::/Interface/IGxPointF/IGxPointF.htm);


## Описание


Свойство ImageOriginOffset определяет
 параметры точки привязки пиктографического показателя.
...
Для выполнения примера предполагается наличие на форме компонентов Button,
 ...
 быть подключена карта. На карте должны быть настроены пиктографические
 показатели.
...
После выполнения примера, при нажатии на кнопку, пиктографический показатель
