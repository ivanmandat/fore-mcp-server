...
Допустимые значения:
	...
	- True. Значение по умолчанию.
	 В расчете используются нелинейные ограничения, заданные свойством
	 [ICpTargetAdjustment.Constraints](ICpTargetAdjustment.Constraints.htm);


	- False. В расчете не
	 используются нелинейные ограничения.
