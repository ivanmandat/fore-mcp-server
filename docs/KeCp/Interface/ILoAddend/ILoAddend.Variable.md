...
Свойство Variable возвращает
 наименование переменной, образующей слагаемое.
...
Добавьте ссылки на системные сборки: Cp.
	...
	        Debug.WriteLine("Переменная " + Addend.Variable + " добавлена в уравнение №1");
	...
	        Debug.WriteLine("Переменная " + Addend.Variable + " добавлена в уравнение №2");
...
После выполнения примера, будет рассчитана линейная система, в окно
 консоли будет выведено сообщение о ходе создания системы и имеющихся ошибках.


См. также:


[ILoAddend](ILoAddend.htm)
