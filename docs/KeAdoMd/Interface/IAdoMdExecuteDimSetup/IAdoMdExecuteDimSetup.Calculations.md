# IAdoMdExecuteDimSetup.Calculations
...
Calculations: [IAdoMdDimCalculations](../IAdoMdDimCalculations/IAdoMdDimCalculations.htm);


## Описание


Свойство Calculations возвращает
 коллекцию вычисляемых элементов измерения.
...
[IAdoMdExecuteDimSetup](IAdoMdExecuteDimSetup.htm)
