...
Класс **TreeChartMaster**
 реализует базовый класс для мастеров [TreeMapMaster](dhtmlBubbleTree.chm::/Components/TreeMapMaster/TreeMapMaster.htm)
...
PP.initClass(PP.Ui.TreeChartMaster, [[PP.Ui.Master](dhtmlUi.chm::/Classes/Master/Master.htm),
 PP.Ui.BaseMasterMixin], "PP.Ui.TreeChartMaster", [PP.Ui.IMasterView]);
