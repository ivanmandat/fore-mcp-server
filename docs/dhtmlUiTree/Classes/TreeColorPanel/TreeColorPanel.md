...
Класс **TreeColorPanel**
 реализует панель управления цветами в мастерах [TreeMapMaster](dhtmlBubbleTree.chm::/Components/TreeMapMaster/TreeMapMaster.htm)
 и [BubbleTreeMaster](dhtmlBubbleTree.chm::/Components/BubbleTreeMaster/BubbleTreeMaster.htm).


## Синтаксис


PP.initClass(PP.Ui.TreeColorPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.TreeColorPanel", PP.Ui.INotifyPropertyChanged);
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [TreeColorPanel](dhtmlUiTree.chm::/Classes/TreeColorPanel/Constructor_TreeColorPanel.htm)
			 Конструктор **TreeColorPanel**
			 создаёт экземпляр класса **TreeColorPanel**.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [getContentPanel](dhtmlUiTree.chm::/Classes/TreeColorPanel/TreeColorPanel.getContentPanel.htm)
		 Метод **getContentPanel**
		 возвращает элемент, в котором располагается содержимое панели
		 управления цветами.


		 ![](../../sub_image.gif)
		 [getTreeMaster](dhtmlUiTree.chm::/Classes/TreeColorPanel/TreeColorPanel.getTreeMaster.htm)
		 Метод **getTreeMaster**
		 возвращает мастер панели управления цветами.
