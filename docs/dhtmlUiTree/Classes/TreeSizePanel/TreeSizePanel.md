...
Класс **TreeColorPanel**
 реализует панель управления размерами в мастерах [TreeMapMaster](dhtmlBubbleTree.chm::/Components/TreeMapMaster/TreeMapMaster.htm)
...
PP.initClass(PP.Ui.TreeSizePanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.TreeSizePanel");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [TreeSizePanel](dhtmlUiTree.chm::/Classes/TreeSizePanel/Constructor_TreeSizePanel.htm)
			 Конструктор **TreeSizePanel**
			 создаёт экземпляр класса **TreeSizePanel**.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [getContentPanel](dhtmlUiTree.chm::/Classes/TreeSizePanel/TreeSizePanel.getContentPanel.htm)
		 ...
		 ![](../../sub_image.gif)
		 [getTreeMaster](dhtmlUiTree.chm::/Classes/TreeSizePanel/TreeSizePanel.getTreeMaster.htm)
		 Метод **getTreeMaster**
		 возвращает мастер панели управления размерами.
