...
Для выполнения примера предполагается наличие на странице компонента
 ...
 управления размерами, развернем панель, получим элемент, в котором располагается
...
// Развернем панель
sizePanel.expand();
// Получим контент панели управления размерами
...
Идентификатор панели: GridPanel5387
...
 [TreeSizePanel](TreeSizePanel.htm)
