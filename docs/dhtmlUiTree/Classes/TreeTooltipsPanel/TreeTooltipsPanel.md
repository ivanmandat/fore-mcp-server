...
Класс TreeTooltipsPanel реализует
 страницу «Подсказки» в [мастере
 для настройки деревьев](../TreeChartMaster/TreeChartMaster.htm).


## Комментарии


Страница «Подсказки» в мастере для настройки деревьев выглядит следующим
 образом:


![](TreeTooltipsPanel.png)


## Синтаксис


PP.initClass(PP.Ui.TreeTooltipsPanel, PP.Ui.VisualizerMasterTooltipsPanel,
 "PP.Ui.TreeTooltipsPanel");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 TreeTooltipsPanel
			 Конструктор TreeTooltipsPanel
			 создает экземпляр класса TreeTooltipsPanel.
...
[Классы
 для работы с деревьями](../Classes.htm)
