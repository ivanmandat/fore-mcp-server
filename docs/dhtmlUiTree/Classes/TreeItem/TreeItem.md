...
Класс **TreeItem** реализует
 элемент иерархической диаграммы.


## Синтаксис


PP.initClass(PP.Ui.TreeItem, [PP.Ui.Control](dhtmlUi.chm::/Classes/control/control.htm),
 "PP.Ui.TreeItem");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [TreeItem](dhtmlUiTree.chm::/Classes/TreeItem/Constructor_TreeItem.htm)
			 Конструктор **TreeItem**
			 создаёт экземпляр класса **TreeItem**.
