...
Класс **TreeLegendPanel**
 реализует панель управления легендой в мастерах [TreeMapMaster](dhtmlBubbleTree.chm::/Components/TreeMapMaster/TreeMapMaster.htm)
...
PP.initClass(PP.Ui.TreeLegendPanel, [PP.Ui.MasterPanel](dhtmlUi.chm::/Classes/MasterPanel/MasterPanel.htm),
 "PP.Ui.TreeLegendPanel");
...
## Конструктор
			 ...
			 ![](../../sub_image.gif)
			 [TreeLegendPanel](dhtmlUiTree.chm::/Classes/TreeLegendPanel/Constructor_TreeLegendPanel.htm)
			 Конструктор **TreeLegendPanel**
			 создаёт экземпляр класса **TreeLegendPanel**.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [getContentPanel](dhtmlUiTree.chm::/Classes/TreeLegendPanel/TreeLegendPanel.getContentPanel.htm)
		 ...
		 ![](../../sub_image.gif)
		 [getTreeMaster](dhtmlUiTree.chm::/Classes/TreeLegendPanel/TreeLegendPanel.getTreeMaster.htm)
		 Метод **getTreeMaster**
		 возвращает мастер панели управления легендой.
