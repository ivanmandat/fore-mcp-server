...
Класс ListCaption реализует
 заголовок столбца в деревьях.


## Комментарии


Является частью группы заголовков: [PP.Ui.ListCaptions](../ListCaptions/ListCaptions.htm).


Используется в качестве заголовка для следующих компонентов:


	- [PP.Ui.TreeListBox](../../Components/TreeListBox/TreeListBox.htm)


	- [PP.Ui.WrappedTreeList](../../Components/WrappedTreeList/WrappedTreeList.htm)


	- [PP.Ui.DynamicTreeList](../../Components/DynamicTreeList/DynamicTreeList.htm)


	- [PP.Ui.SimpleTreeList](../../Components/SimpleTreeList/SimpleTreeList.htm)


## Синтаксис


PP.initClass(PP.Ui.ListCaption, PP.Ui.[Control](dhtmlUi.chm::/Classes/control/control.htm),
 "ListCaption");
...
## Конструктор
		 ...
		 ![](../../sub_image.gif)
		 [ListCaption](Constructor_ListCaption.htm)
		 Конструктор ListCaption
		 создаёт экземпляр класса ListCaption.
...
## Свойства
		 ...
		 ![](../../Property_Image.gif)
		 [ColumnEditable](ListCaption.ColumnEditable.htm)
		 Свойство ColumnEditable
		 определяет возможность редактирования столбца заголовка.


		 ![](../../Property_Image.gif)
		 [IsAppended](ListCaptions.IsAppended.htm)
		 Свойство IsAppended
		 определяет признак добавления заголовка в DOM.


		 ![](../../Property_Image.gif)
		 [IsStretch](ListCaption.IsStretch.htm)
		 Свойство IsStretch
		 определяет признак растянутости заголовка.


		 ![](../../Property_Image.gif)
		 [MinWidth](ListCaption.MinWidth.htm)
		 Свойство MinWidth определяет
		 минимальную ширину заголовка.


		 ![](../../Property_Image.gif)
		 [Percent](ListCaption.Percent.htm)
		 Свойство Percent определяет
		 ширину в процентах.


		 ![](../../Property_Image.gif)
		 [Reduction](ListCaption.Reduction.htm)
		 Свойство Reduction
		 определяет уменьшение видимой ширины заголовка.


		 ![](../../Property_Image.gif)
		 [Resizable](ListCaption.Resizable.htm)
		 Свойство Resizable
		 определяет возможность заголовка менять размеры.


		 ![](../../Property_Image.gif)
		 [Hideable](ListCaptions.Hideable.htm)
		 Свойство Hideable определяет
		 возможность изменять видимость столбца.


		 ![](../../Property_Image.gif)
		 [SortMethod](ListCaptions.SortMethod.htm)
		 Свойство SortMethod
		 определяет метод сортировки в столбце заголовка.
...
## Методы
		 ...
		 ![](../../sub_image.gif)
		 [getOptimalWidth](ListCaption.getOptimalWidth.htm)
		 Метод getOptimalWidth
		 возвращает оптимальную ширину заголовка, при которой виден весь
		 текст заголовка.


		 ![](../../sub_image.gif)
		 [setSortDirectionClass](ListCaption.getSortDirectionClass.htm)
		 Метод setSortDirectionClass
		 устанавливает направление значка сортировки.


		 ![](../../sub_image.gif)
		 [updateWidth](ListCaption.updateWidth.htm)
...
## События
		 ...
		 ![](../../Event_Image.gif)
		 [AutoSize](ListCaption.AutoSize.htm)
		 Событие AutoSize наступает
		 перед авто-определением ширины столбца.


		 ![](../../Event_Image.gif)
		 [Changed](ListCaption.Changed.htm)
		 Событие Changed наступает
		 после изменения любых свойств заголовка, влияющих на отображение.


		 ![](../../Event_Image.gif)
		 [ResizeEnd](ListCaption.ResizeEnd.htm)
		 Событие ResizeEnd наступает
		 после смены ширины столбца мышью.


		 ![](../../Event_Image.gif)
		 [ResizeStart](ListCaption.ResizeStart.htm)
		 Событие ResizeStart
		 наступает перед сменой ширины столбца мышью.
