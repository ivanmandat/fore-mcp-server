...
[Combo](dhtmlUi.chm::/Classes/combo/combo.htm)
...
Класс TreeCombo реализует компонент
 [TreeCombo](../../Components/TreeCombo/TreeCombo.htm), служащий
 для отображения иерархий в виде раскрывающегося списка.


## Синтаксис


PP.initClass(PP.Ui.TreeCombo, PP.Ui.[Combo](dhtmlUi.chm::/Classes/combo/combo.htm),
 "TreeCombo");
