...
Компонент реализован классом [TreeList](../../Classes/TreeList/TreeList.htm).
 Вершины реализованы классом [TreeNode](../../Classes/TreeNode/TreeNode.htm),
 столбцы - классом [TreeColumn](../../Classes/TreeColumn/TreeColumn.htm).
 Коллекция столбцов реализована классом [TreeColumns](../../Classes/TreeColumns/TreeColumns.htm),
 коллекция вершин - классом [TreeNodes](../../Classes/TreeNodes/TreeNodes.htm).
 Классы [TreeColumns](../../Classes/TreeColumns/TreeColumns.htm)
 и [TreeNodes](../../Classes/TreeNodes/TreeNodes.htm) наследуются
 от базового класса [List](dhtmlList.chm::/Classes/List/List.htm).
...
Основные возможности компонента:
	...
	- [отображение
	 столбцов](../../Classes/TreeList/TreeList.ShowColumns.htm) в компоненте можно регулировать при помощи раскрывающегося
	 списка, расположенного в правом верхнем углу. Выбор столбцов, которые
	 будут отображаться, осуществляется за счет установки флажков напротив
...
![](treelist20.png)
	...
	- [отображение
	 линий](../../Classes/TreeList/TreeList.ShowLines.htm), соединяющих вершины дерева;


	- [перенос
	 текста](../../Classes/TreeList/TreeList.WordWrap.htm) вершин по словам;


	- [сворачивание](../../Classes/TreeNode/TreeNode.collapse.htm)/[разворачивание](../../Classes/TreeNode/TreeNode.expand.htm)
	 вершин;


	- [сортировка](../../Classes/TreeNodes/TreeNodes.Sort.htm)
	 ...
	 появляется пиктограмма ![](treelist17.gif),
	 значит была осуществлена сортировка по убыванию. Если появляется пиктограмма
	 ![](treelist18.gif), вершины отсортированы по возрастанию;


	- [фильтрация](../../Classes/TreeNodes/TreeNodes.filter.htm)
	 коллекции вершин;
	...
	- возможность установки [флажка](../../Classes/TreeList/TreeList.CheckBoxes.htm)
	 и [пиктограммы](../../Classes/TreeNode/TreeNode.ImageIndex.htm)
	 для каждой вершины;
	...
	- [перетаскивание
	 вершин](../../Classes/TreeNode/TreeNode.Draggable.htm) (в том числе между несколькими деревьями на одной странице);


	- появление [вертикальной](../../Classes/TreeList/TreeList.getVerticalScroll.htm)
	 и [горизонтальной](../../Classes/TreeList/TreeList.getHorizontalScroll.htm)
	 полос прокрутки при необходимости, режим виртуальной прокрутки;


	- [поиск вершины](../../Classes/TreeList/TreeList.find.htm);


	- [выделение
	 области дерева при помощи мыши](../../Classes/TreeList/TreeList.AreaSelect.htm) (с выделением входящих в эту область
	 вершин).
...
[Пример создания компонента TreeList](TreeList_example.htm)


[Пример динамического создания
 компонента TreeList](TreeList_dynamic_example.htm)
